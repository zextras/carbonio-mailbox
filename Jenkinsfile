...
pipeline {
    ...
    environment {
        ...
        LC_ALL='C.UTF-8'
        MAVEN_OPTS = "-Xms2g -Xmx4g -XX:+UseG1GC -XX:+AlwaysPreTouch -XX:+ParallelRefProcEnabled -XX:+UseStringDeduplication -XX:MetaspaceSize=256m -XX:MaxMetaspaceSize=512m"
    }
