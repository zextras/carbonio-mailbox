...
/**
 * Locking mechanism with logic similar to that of MailboxLock. It is simpler than MailboxLock,
 * since it does not differentiate between read and write locks.
 *
 * @author iraykin
 */
