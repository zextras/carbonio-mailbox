...
public abstract class ZFilterAction implements ToZJSONObject {
    ...
    public static MarkOp fromString(String s) throws ServiceException {
      try {
        ...
        throw ZClientException.CLIENT_ERROR(
            "invalid op: " + s + ", valid values: " + Arrays.asList(values()), null);
      }
    }
  }
  ...
  public static final class ZNotifyAction extends ZFilterAction {
    ...
    public ZNotifyAction(
      ...
      super(
          A_NOTIFY,
          emailAddr,
          Strings.nullToEmpty(subjectTemplate),
          Strings.nullToEmpty(bodyTemplate),
          Integer.toString(maxBodyBytes),
          Strings.nullToEmpty(origHeaders));
    }
  ...
  public static final class ZRFCCompliantNotifyAction extends ZFilterAction {
    ...
    public ZRFCCompliantNotifyAction(
        String from, String importance, String options, String message, String method) {
      super(
          A_RFCCOMPLIANTNOTIFY,
          Strings.nullToEmpty(from),
          Strings.nullToEmpty(importance),
          Strings.nullToEmpty(options),
    ...
    public String toActionString() {
      ...
      str.append(StringUtil.enclose(getMessage(), '"'))
          .append(" ")
