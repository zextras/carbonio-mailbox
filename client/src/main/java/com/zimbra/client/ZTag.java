...
public class ZTag implements Comparable<ZTag>, ZItem, ZimbraTag, ToZJSONObject {
  ...
  public enum Color {
    ...
    static {
      for (Color c : Color.values()) colorMap.put(c.toString(), c);
    }
  ...
  public void markRead() throws ServiceException {
    mMailbox.markTagRead(mId);
  }

  public void modifyColor(ZTag.Color color) throws ServiceException {
    mMailbox.modifyTagColor(mId, color);
  }

  public void rename(String newName) throws ServiceException {
    mMailbox.renameTag(mId, newName);
  }
