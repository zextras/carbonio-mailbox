...
public class ZPhone implements ToZJSONObject {
  ...
  public static final String INVALID_PHNUM_OWN_PHONE_NUMBER =
      "voice.INVALID_PHNUM_OWN_PHONE_NUMBER";
  public static final String INVALID_PHNUM_INTERNATIONAL_NUMBER =
      "voice.INVALID_PHNUM_INTERNATIONAL_NUMBER";
  ...
  public static final String INVALID_PHNUM_EMERGENCY_ASSISTANCE =
      "voice.INVALID_PHNUM_EMERGENCY_ASSISTANCE";
  public static final String INVALID_PHNUM_DIRECTORY_ASSISTANCE =
      "voice.INVALID_PHNUM_DIRECTORY_ASSISTANCE";
  ...
  public ZPhone(String name, String callerId) throws ServiceException {
    mName = name;
    mCallerId =
        callerId != null && (callerId.equals(name) || callerId.equalsIgnoreCase("Unavailable"))
            ? null
            : callerId;
  }
