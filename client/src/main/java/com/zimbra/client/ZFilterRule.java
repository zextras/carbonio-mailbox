    ...
    while (i < args.length) {
      ...
      if (a.equals("active")) {
        ...
        if (op.equals("exists")) {
          ...
          conditions.add(
              new ZHeaderCondition(headerName, HeaderOp.fromString(op), caseSensitive, nextArg));
        }
        ...
        conditions.add(
            new ZMimeHeaderCondition(headerName, HeaderOp.fromString(op), caseSensitive, nextArg));
        ...
        conditions.add(
            new ZAddressCondition(
                headerName,
                Sieve.AddressPart.fromString(part),
                HeaderOp.fromString(op),
                caseSensitive,
                nextArg));
        ...
        conditions.add(
            new ZFilterCondition.ZConversationCondition(
        ...
        conditions.add(
            new ZFilterCondition.ZImportanceCondition(
                SimpleOp.fromString(op), FilterTest.Importance.fromString(importance)));
        ...
        conditions.add(
            new ZFilterCondition.ZFlaggedCondition(op, Sieve.Flag.fromString(args[i++])));
