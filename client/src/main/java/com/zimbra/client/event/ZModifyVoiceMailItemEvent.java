...
public class ZModifyVoiceMailItemEvent implements ZModifyItemEvent {
  ...
  /**
   * Makes note that something actually changed. Used when marking (un)heard so that we can try to
   * keep track of the folder's unheard count, which is never updated by the server.
   */
