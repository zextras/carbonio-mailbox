...
public final class ProxyTarget {
   ...
   * @throws ServiceException
   */
  private void disableCsrfFlagInAuthToken(Element envelope, AuthToken authToken, QName qName)
      throws ServiceException {
    ...
    ZimbraLog.soap.debug(
        "Modified auth token in soap envelope, csrf token flag is disabled. The new envelope : %s",
        envelope);
  }
