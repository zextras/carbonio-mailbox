...
public abstract class SoapContextExtension {
  ...
  private static List<SoapContextExtension> sExtensions =
      Collections.synchronizedList(new ArrayList<SoapContextExtension>());
  ...
  public static void addExtensionHeaders(
      Element context, ZimbraSoapContext zsc, SoapSession session) throws ServiceException {
  ...
  public abstract void addExtensionHeader(
      Element context, ZimbraSoapContext zsc, SoapSession session) throws ServiceException;
}
