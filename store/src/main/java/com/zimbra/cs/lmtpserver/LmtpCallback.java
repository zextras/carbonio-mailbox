...
public interface LmtpCallback {
     ...
     */
    void afterDelivery(Account account, Mailbox mbox, String envelopeSender, String recipientEmail,
        Message newMessage);

    /**
     * Called when mail forwarding is set up for the account but delivery to mailbox is disabled.
     */
    void forwardWithoutDelivery(Account account, Mailbox mbox, String envelopeSender,
