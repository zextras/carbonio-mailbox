...
public class PropPatch extends DavMethod {
  ...
  public void handle(DavContext ctxt) throws DavException, IOException, ServiceException {
    ...
    if (!top.getName().equals(DavElements.P_PROPERTYUPDATE)) {
      throw new DavException(
          "msg " + top.getName() + " not allowed in PROPPATCH",
   ...
   * @throws IOException
   */
  public static Pair<List<Element>, List<Element>> getSetsAndRemoves(
      Element top, boolean isCreate, String method) throws DavException, IOException {
    ...
    for (Object obj : top.elements()) {
      ...
      if (e == null) {
        throw new DavException(
            "missing <D:prop> in " + method, HttpServletResponse.SC_BAD_REQUEST, null);
      }
   ...
   */
  public static Pair<List<Element>, List<QName>> processSetsAndRemoves(
      DavContext ctxt,
      DavResource resource,
      List<Element> setElems,
      List<Element> removeElems,
      boolean isCreate)
  ...
  public static void handlePropertyUpdate(
      DavContext ctxt, Element top, DavResource resource, boolean isCreate, String method)
      throws DavException, IOException {
    if (top == null) {
      return;
    }
    Pair<List<Element>, List<Element>> elemPair = getSetsAndRemoves(top, isCreate, method);
    Pair<List<Element>, List<QName>> pair =
        processSetsAndRemoves(ctxt, resource, elemPair.getFirst(), elemPair.getSecond(), isCreate);
