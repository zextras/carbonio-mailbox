...
public class DavElements {
  ...
  public static final String P_APPLY_TO_PRINCIPAL_COLLECTION_SET =
  ...
  public static final String P_SUPPORTED_CALENDAR_COMPONENT_SET =
      "supported-calendar-component-set";
  public static final String P_SUPPORTED_CALENDAR_COMPONENT_SETS =
  ...
  public static final QName E_ACL_PRINCIPAL_PROP_SET =
      QName.get(P_ACL_PRINCIPAL_PROP_SET, WEBDAV_NS);
  ...
  public static final QName E_APPLY_TO_PRINCIPAL_COLLECTION_SET =
      QName.get(P_APPLY_TO_PRINCIPAL_COLLECTION_SET, WEBDAV_NS);
  ...
  public static final QName E_CALENDAR_FREE_BUSY_SET =
      QName.get(P_CALENDAR_FREE_BUSY_SET, CALDAV_NS);
  ...
  public static final QName E_CALENDAR_PROXY_WRITE_FOR =
      QName.get(P_CALENDAR_PROXY_WRITE_FOR, CS_NS);
  ...
  public static final QName E_CALENDAR_USER_ADDRESS_SET =
      QName.get(P_CALENDAR_USER_ADDRESS_SET, CALDAV_NS);
  ...
  public static final QName E_CURRENT_USER_PRINCIPAL =
      QName.get(P_CURRENT_USER_PRINCIPAL, WEBDAV_NS);
  public static final QName E_CURRENT_USER_PRIVILEGE_SET =
      QName.get(P_CURRENT_USER_PRIVILEGE_SET, WEBDAV_NS);
  ...
  public static final QName E_MOUNTPOINT_TARGET_PRIVILEGE_SET =
      QName.get(P_MOUNTPOINT_TARGET_PRIVILEGE_SET, YAHOO_NS);
  ...
  public static final QName E_PRINCIPAL_COLLECTION_SET =
      QName.get(P_PRINCIPAL_COLLECTION_SET, WEBDAV_NS);
  ...
  public static final QName E_PRINCIPAL_PROPERTY_SEARCH =
      QName.get(P_PRINCIPAL_PROPERTY_SEARCH, WEBDAV_NS);
  public static final QName E_PRINCIPAL_SEARCH_PROPERTY =
      QName.get(P_PRINCIPAL_SEARCH_PROPERTY, WEBDAV_NS);
  public static final QName E_PRINCIPAL_SEARCH_PROPERTY_SET =
      QName.get(P_PRINCIPAL_SEARCH_PROPERTY_SET, WEBDAV_NS);
  ...
  public static final QName E_READ_CURRENT_USER_PRIVILEGE_SET =
      QName.get(P_READ_CURRENT_USER_PRIVILEGE_SET, WEBDAV_NS);
  ...
  public static final QName E_SAME_ORGANIZER_IN_ALL_COMPONENTS =
      QName.get(SAME_ORGANIZER_IN_ALL_COMPONENTS, CALDAV_NS);
  ...
  public static final QName E_SUPPORTED_CALENDAR_COMPONENT =
      QName.get(P_SUPPORTED_CALENDAR_COMPONENT, CALDAV_NS);
  public static final QName E_SUPPORTED_CALENDAR_COMPONENT_SET =
      QName.get(P_SUPPORTED_CALENDAR_COMPONENT_SET, CALDAV_NS);
  public static final QName E_SUPPORTED_CALENDAR_COMPONENT_SETS =
      QName.get(P_SUPPORTED_CALENDAR_COMPONENT_SETS, CALDAV_NS);
  public static final QName E_SUPPORTED_CALENDAR_DATA =
      QName.get(P_SUPPORTED_CALENDAR_DATA, CALDAV_NS);
  public static final QName E_SUPPORTED_COLLATION = QName.get(P_SUPPORTED_COLLATION, CALDAV_NS);
  public static final QName E_SUPPORTED_COLLATION_SET =
      QName.get(P_SUPPORTED_COLLATION_SET, CALDAV_NS);
  public static final QName E_SUPPORTED_PRIVILEGE = QName.get(P_SUPPORTED_PRIVILEGE, WEBDAV_NS);
  public static final QName E_SUPPORTED_PRIVILEGE_SET =
      QName.get(P_SUPPORTED_PRIVILEGE_SET, WEBDAV_NS);
  ...
  // errors
  public static final QName E_CANNOT_MODIFY_PROTECTED_PROPERTY =
      QName.get("cannot-modify-protected-property", WEBDAV_NS);
  ...
  public static final QName E_VALID_CALENDAR_OBJECT_RESOURCE =
      QName.get(P_VALID_CALENDAR_OBJECT_RESOURCE, CALDAV_NS);
  ...
  public static class CardDav {
    ...
    public static final QName E_ADDRESSBOOK_DESCRIPTION =
        QName.get(P_ADDRESSBOOK_DESCRIPTION, CARDDAV_NS);
    public static final QName E_ADDRESSBOOK_HOME_SET =
        QName.get(P_ADDRESSBOOK_HOME_SET, CARDDAV_NS);
    public static final QName E_ADDRESSBOOK_MULTIGET =
        QName.get(P_ADDRESSBOOK_MULTIGET, CARDDAV_NS);
    ...
    public static final QName E_MAX_RESOURCE_SIZE_ADDRESSBOOK =
        QName.get(P_MAX_RESOURCE_SIZE, CARDDAV_NS);
    ...
    public static final QName E_SUPPORTED_ADDRESS_DATA =
        QName.get(P_SUPPORTED_ADDRESS_DATA, CARDDAV_NS);
