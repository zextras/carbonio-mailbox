...
public class DavResponse {
  ...
  static {
    ...
    sStatusTextMap.put(
        HttpServletResponse.SC_SWITCHING_PROTOCOLS, "HTTP/1.1 101 Switching Protocols");
    ...
    sStatusTextMap.put(
        HttpServletResponse.SC_TEMPORARY_REDIRECT, "HTTP/1.1 307 Temporary Redirect");
    ...
    sStatusTextMap.put(
        HttpServletResponse.SC_METHOD_NOT_ALLOWED, "HTTP/1.1 405 Method Not Allowed");
    ...
    sStatusTextMap.put(
        HttpServletResponse.SC_PRECONDITION_FAILED, "HTTP/1.1 412 Precondition Failed");
    sStatusTextMap.put(
        HttpServletResponse.SC_REQUEST_ENTITY_TOO_LARGE, "HTTP/1.1 413 Reques Entity Too Large");
    sStatusTextMap.put(
        HttpServletResponse.SC_REQUEST_URI_TOO_LONG, "HTTP/1.1 414 Request-URI Too Large");
    sStatusTextMap.put(
        HttpServletResponse.SC_UNSUPPORTED_MEDIA_TYPE, "HTTP/1.1 415 Unsupported Media Type");
    sStatusTextMap.put(
        HttpServletResponse.SC_REQUESTED_RANGE_NOT_SATISFIABLE,
        "HTTP/1.1 416 Requested range not satisfiable");
    sStatusTextMap.put(
        HttpServletResponse.SC_EXPECTATION_FAILED, "HTTP/1.1 417 Expectation Failed");

    sStatusTextMap.put(
        HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "HTTP/1.1 500 Internal Server Error");
    ...
    sStatusTextMap.put(
        HttpServletResponse.SC_SERVICE_UNAVAILABLE, "HTTP/1.1 503 Service Unavailable");
    ...
    sStatusTextMap.put(
        DavProtocol.STATUS_UNPROCESSABLE_ENTITY, "HTTP/1.1 422 Unprocessable Entity");
    ...
    sStatusTextMap.put(
        DavProtocol.STATUS_INSUFFICIENT_STORAGE, "HTTP/1.1 507 Insufficient Storage");
  }
  ...
  public Element getTop(QName topName) {
    ...
    if (top == null) top = mResponse.addElement(topName);
    return top;
  }
