        ...
        if (type == MailItem.Type.FOLDER) {
          ...
          if (oldFolder == null) {
            ZimbraLog.datasource.warn(
                "Cannot determine the old folder name for %s.", entry.getKey());
            continue;
          }
          try {
            ZimbraLog.datasource.info(
                "Deleting datasources that reference %s.", oldFolder.getPath());
            ...
            ZimbraLog.datasource.warn(
                "Could not delete datasources for folder.", oldFolder.getPath());
          }
        }
      }
    }
