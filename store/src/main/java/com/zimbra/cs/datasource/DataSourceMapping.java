...
public class DataSourceMapping {
  ...
  public DataSourceMapping(DataSource ds, int itemId) throws ServiceException {
    ...
    if (dsi.remoteId == null) throw MailServiceException.NO_SUCH_ITEM(itemId);
    parseMetaData();
  }
  ...
  public DataSourceMapping(DataSource ds, String remoteId) throws ServiceException {
    ...
    if (dsi.itemId == 0) throw MailServiceException.NO_SUCH_ITEM(remoteId);
    parseMetaData();
  }
  ...
  public DataSourceMapping(DataSource ds, int folderId, int itemId, String remoteId, int localFlags)
      throws ServiceException {
    this.ds = ds;
    dsi = new DataSourceItem(folderId, itemId, remoteId, new Metadata(), localFlags);
  }
  ...
  public void setItemFlags(int itemFlags) {
    dsi.itemFlags = itemFlags;
  }

  public void setRemoteId(String remoteId) {
    dsi.remoteId = remoteId;
  }
