...
public class DataSourceFolderMapping extends DataSourceMapping {
  ...
  public DataSourceFolderMapping(DataSource ds, int itemId, String remoteId)
  ...
  public static Collection<DataSourceItem> getMappings(DataSource ds, int folderId)
      throws ServiceException {
    return DbDataSource.getAllMappingsInFolder(ds, folderId);
  }

  public static Collection<DataSourceItem> getMappingsAndFlags(DataSource ds, int folderId)
      throws ServiceException {
