...
class FolderChanges {
  ...
  public static FolderChanges getChanges(DataSource ds, int lastSync) throws ServiceException {
  ...
  public String toString() {
    ...
    return String.format(
        "{changeId=%d,added=%d,moved=%d,deleted=%d", lastChangeId, added, moved, deleted);
  }
}
