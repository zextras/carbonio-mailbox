...
public class ZimletFilter extends ZimbraServlet implements Filter {
  ...
  private static void addZimlet(
      List zimletList, String zimbraXZimletCompatibleWith, Zimlet zimlet) {
    if (zimbraXZimletCompatibleWith != null && zimlet.getZimbraXCompatibleSemVer() != null) {
      ...
      com.github.zafarkhaja.semver.Version v =
          com.github.zafarkhaja.semver.Version.valueOf(zimbraXZimletCompatibleWith);
      boolean result = v.satisfies(zimlet.getZimbraXCompatibleSemVer());
      if (result) {
        zimletList.add(zimlet);
      }
    } else if (zimbraXZimletCompatibleWith == null && zimlet.getZimbraXCompatibleSemVer() == null) {
