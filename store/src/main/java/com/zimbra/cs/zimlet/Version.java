 ...
 *
 * <p>The comparision of two versions are not the same as floating point arithmetics. Rather it is
 * done by iteratively comparing each version nodes as whole numbers.
 *
 * <p>1.0 < 1.1 1.0 < 2.0 1.0 < 1.0.1 1.2 < 1.15 (because 2 < 15) 1.31.5 < 1.135 (because 31 < 135)
 *
 * @author jylee
 */
