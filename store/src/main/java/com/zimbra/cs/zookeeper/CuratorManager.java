...
public class CuratorManager {
  ...
  private CuratorManager(String zkAddress) throws Exception {
    ...
    serviceDiscovery =
        ServiceDiscoveryBuilder.builder(Service.class)
            .client(client)
            .basePath(SERVICE)
            .serializer(serializer)
            .thisInstance(thisInstance)
            .build();
    ServiceCacheBuilder<Service> serviceCacheBuilder =
        serviceDiscovery.serviceCacheBuilder().name(Provisioning.SERVICE_MAILBOX);
