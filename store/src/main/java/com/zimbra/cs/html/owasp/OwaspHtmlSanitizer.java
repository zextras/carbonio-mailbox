...
public class OwaspHtmlSanitizer implements Callable<String> {
  ...
  public static final ThreadLocal<OwaspThreadLocal> zThreadLocal =
      new ThreadLocal<OwaspThreadLocal>();
  ...
  /**
   * Sanitizing email is treated as an expensive operation; this method should be called from a
   * background Thread.
   *
   * @return the sanitized form of the <code>html</code>; <code>null</code> if <code>html</code> was
   *     <code>null</code>
   */
