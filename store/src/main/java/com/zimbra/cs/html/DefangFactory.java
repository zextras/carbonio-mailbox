...
/**
 * This factory is used to determine the proper defanger based on content type for content that can
 * be natively displayed in most browsers and can have unsavory things added to it (mostly xss
 * script issues).
 *
 * @author jpowers
 */
public class DefangFactory {
  ...
  /** This defanger does nothing. Here for backwards compatibility */
