...
public final class NioUtil {
  ...
  /**
   * Ensure that specified buffer has at least enough capacity to accommodate 'minSize' additional
   * bytes, but not more than 'maxSize' additional bytes. If 'maxSize' is 0, then there is no limit.
   *
