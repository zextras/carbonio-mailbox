...
/**
 * Iterates a Sieve node tree and calls callbacks at various points. A subclass can override
 * whichever <tt>visitXXX()</tt> callbacks it is interested in.
 */
public abstract class SieveVisitor {

  protected enum VisitPhase {
    begin,
    end
  }
  ...
  @SuppressWarnings("unused")
  protected void visitVariable(
      Node node, VisitPhase phase, RuleProperties props, String name, String value)
      throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitIfControl(Node node, VisitPhase phase, RuleProperties props)
      throws ServiceException {
    // empty method
  }
  ...
  @SuppressWarnings("unused")
  protected void visitHeaderTest(
      Node node,
      VisitPhase phase,
  ...
  protected void visitHeaderTest(
      ...
      RuleProperties props,
      List<String> headers,
      Sieve.ValueComparison comparison,
  ...
  @SuppressWarnings("unused")
  protected void visitMimeHeaderTest(
      Node node,
      VisitPhase phase,
      RuleProperties props,
      List<String> headers,
  ...
  @SuppressWarnings("unused")
  protected void visitAddressTest(
      Node node,
      VisitPhase phase,
      RuleProperties props,
      List<String> headers,
  ...
  protected void visitEnvelopeTest(
      Node node,
      VisitPhase phase,
      RuleProperties props,
      List<String> headers,
  ...
  @SuppressWarnings("unused")
  protected void visitHeaderExistsTest(
      Node node, VisitPhase phase, RuleProperties props, String header) throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitSizeTest(
      Node node,
      VisitPhase phase,
      RuleProperties props,
  ...
  @SuppressWarnings("unused")
  protected void visitDateTest(
      Node node, VisitPhase phase, RuleProperties props, Sieve.DateComparison comparison, Date date)
      throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitCurrentTimeTest(
      Node node,
      VisitPhase phase,
      RuleProperties props,
  ...
  @SuppressWarnings("unused")
  protected void visitCurrentDayOfWeekTest(
      Node node, VisitPhase phase, RuleProperties props, List<String> days)
      throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitConversationTest(
      Node node, VisitPhase phase, RuleProperties props, String where) throws ServiceException {
    // empty method
  }
  ...
  @SuppressWarnings("unused")
  protected void visitAllOfTest(Node node, VisitPhase phase, RuleProperties props)
      throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitAnyOfTest(Node node, VisitPhase phase, RuleProperties props)
      throws ServiceException {
    // empty method
  }
  ...
  @SuppressWarnings("unused")
  protected void visitImportanceTest(
      Node node, VisitPhase phase, RuleProperties props, FilterTest.Importance importance)
      throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitFlaggedTest(
      Node node, VisitPhase phase, RuleProperties props, Sieve.Flag flag) throws ServiceException {
    // empty method
  }
  ...
  @SuppressWarnings("unused")
  protected void visitAddressBookTest(
      Node node, VisitPhase phase, RuleProperties props, String header) throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitContactRankingTest(
      Node node, VisitPhase phase, RuleProperties props, String header) throws ServiceException {
    // empty method
  }
  ...
  @SuppressWarnings("unused")
  protected void visitBodyTest(
      Node node, VisitPhase phase, RuleProperties props, boolean caseSensitive, String value)
      throws ServiceException {
    // empty method
  }
  ...
  @SuppressWarnings("unused")
  protected void visitInviteTest(
      Node node, VisitPhase phase, RuleProperties props, List<String> methods)
      throws ServiceException {
    // empty method
  }
  ...
  @SuppressWarnings("unused")
  protected void visitFileIntoAction(
      Node node, VisitPhase phase, RuleProperties props, String folderPath)
      throws ServiceException {
    // empty method
  }
  ...
  @SuppressWarnings("unused")
  protected void visitFileIntoAction(
      Node node, VisitPhase phase, RuleProperties props, String folderPath, boolean copy)
      throws ServiceException {
    // empty method
  }
  ...
  @SuppressWarnings("unused")
  protected void visitRedirectAction(
      Node node, VisitPhase phase, RuleProperties props, String address) throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitRedirectAction(
      Node node, VisitPhase phase, RuleProperties props, String address, boolean copy)
      throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitReplyAction(
      Node node, VisitPhase phase, RuleProperties props, String bodyTemplate)
      throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitNotifyAction(
      Node node,
      VisitPhase phase,
      RuleProperties props,
      String emailAddr,
  ...
  @SuppressWarnings("unused")
  protected void visitRFCCompliantNotifyAction(
      Node node,
      VisitPhase phase,
      RuleProperties props,
      String from,
  ...
  @SuppressWarnings("unused")
  protected void visitRejectAction(
      Node node, VisitPhase phase, RuleProperties props, String content) throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitErejectAction(
      Node node, VisitPhase phase, RuleProperties props, String content) throws ServiceException {
    // empty method
  }

  @SuppressWarnings("unused")
  protected void visitLogAction(
      Node node,
      VisitPhase phase,
      RuleProperties props,
      FilterAction.LogAction.LogLevel logLevel,
      String logText)
      throws ServiceException {
    // empty method
  }
  ...
  @SuppressWarnings("unused")
  protected void visitAddheaderAction(
      Node node,
      VisitPhase phase,
      RuleProperties props,
      String headerName,
  ...
  @SuppressWarnings("unused")
  protected void visitDeleteheaderAction(
      Node node,
      VisitPhase phase,
      RuleProperties props,
      Boolean last,
      Integer offset,
      String matchType,
      Boolean countComparision,
      Boolean valueComparision,
      String relationalComparator,
      String comparator,
      String headerName,
  ...
  private void accept(Node parent, RuleProperties props, boolean isAdminScript)
      throws ServiceException {
      ...
      if ("allof".equalsIgnoreCase(nodeName)) {
        ...
        if (firstTagArgNode.getValue() instanceof TagArgument) {
          ...
          try {
            if ("count".equals(argStr) || "value".equals(argStr)) {
              ...
              if (secondTagArgNode.getValue() instanceof TagArgument) {
                caseSensitive =
                    Sieve.Comparator.ioctet
                        == Sieve.Comparator.fromString(getValue(node, 0, 2, 0, 0));
                headersArgIndex += 2;
              }
            }
            ...
            caseSensitive =
                Sieve.Comparator.ioctet == Sieve.Comparator.fromString(getValue(node, 0, 1, 0, 0));
            headersArgIndex += 2;
            secondTagArgNode = (SieveNode) getNode(node, 0, 2);
            if (secondTagArgNode.getValue() instanceof TagArgument) {
        ...
        if ("header".equalsIgnoreCase(nodeName)) {
          if (valueComparison != null) {
            ...
            accept(node, props);
            visitHeaderTest(
                node, VisitPhase.end, props, headers, valueComparison, comparator, isCount, value);
          } else {
            visitHeaderTest(
                node, VisitPhase.begin, props, headers, comparison, caseSensitive, value);
            accept(node, props);
          ...
          accept(node, props);
          visitMimeHeaderTest(
              node, VisitPhase.end, props, headers, comparison, caseSensitive, value);
        }
        ...
        if (firstTagArgNode.getValue() instanceof TagArgument) {
          ...
          if (HeaderConstants.COUNT.equalsIgnoreCase(firstArgStr)
              || HeaderConstants.VALUE.equalsIgnoreCase(firstArgStr)) {
            if (HeaderConstants.COUNT.equalsIgnoreCase(firstArgStr)) {
              isCount = true;
            }
            valueComparison = Sieve.ValueComparison.valueOf(getValue(node, 0, 1, 0, 0));
        ...
        if ("envelope".equalsIgnoreCase(nodeName)) {
          if (valueComparison != null) {
            ...
            visitEnvelopeTest(
                node, VisitPhase.begin, props, headers, part, comparison, caseSensitive, value);
            accept(node, props);
            visitEnvelopeTest(
                node, VisitPhase.end, props, headers, part, comparison, caseSensitive, value);
          }
        } else {
          if (valueComparison != null) {
            visitAddressTest(
        ...
        if (getNode(node, 0, 1).jjtGetNumChildren() == 0) {
          ...
          caseSensitive =
              Sieve.Comparator.ioctet == Sieve.Comparator.fromString(getValue(node, 0, 2, 0, 0));
        ...
        FilterTest.Importance importance =
            FilterTest.Importance.fromString(getValue(node, 0, 0, 0, 0));
  ...
  private void acceptAction(Node node, RuleProperties props, boolean isAdminScript)
      throws ServiceException {
    ...
    if ("keep".equalsIgnoreCase(nodeName)) {
      ...
      if (!isRFCCompliantNotifyAction(node)) {
          ...
          if (isTag) {
            ...
            if (null == from && NotifyMailto.NOTIFY_FROM.equalsIgnoreCase(tag)) {
              ...
              throw ServiceException.PARSE_ERROR(
                  "Invalid notify tag: " + tag + ", valid values: " + value, null);
            }
          } else {
            value = getValue(node, 0, i, 0, 0);
            if (null == methodMailto
                && null != value
                && value.toLowerCase().startsWith(NotifyMailto.NOTIFY_METHOD_MAILTO)) {
              methodMailto = value;
            } else {
        ...
        visitRFCCompliantNotifyAction(
            node, VisitPhase.begin, props, from, importance, options, message, methodMailto);
        accept(node, props);
        visitRFCCompliantNotifyAction(
            node, VisitPhase.end, props, from, importance, options, message, methodMailto);
      }
      ...
      boolean isTag =
          getNode(node, 0, 0) == null
              ? false
              : getNode(node, 0, 0).jjtGetNumChildren() == 0 ? true : false;
      String logText = null;
      if (isTag) {
        ...
        if (!StringUtil.isNullOrEmpty(level)) {
          ...
          try {
            ...
            ZimbraLog.filter.info(
                "Invalid log level found: %s, reseting to %s",
                level, FilterAction.LogAction.LogLevel.info);
          }
      ...
      if (isAdminScript) {
        ...
        throw ServiceException.PARSE_ERROR(
            "Invalid addheader action: addheader action is not allowed in user scripts", null);
      }
      ...
      if (isAdminScript) {
        ...
        throw ServiceException.PARSE_ERROR(
            "Invalid deleteheader action: deleteheader action is not allowed in user scripts",
            null);
      }
      ...
      if (isAdminScript) {
        ...
        throw ServiceException.PARSE_ERROR(
            "Invalid replaceheader action: replaceheader action is not allowed in user scripts",
            null);
      }
    } else {
      accept(node, props);
  ...
  private Integer visitIndex(Node node, String tag, int i) throws ServiceException {
    ...
    if (tempValue == null) {
      ...
      try {
        ...
        throw ServiceException.PARSE_ERROR(
            "Invalid value \"" + tempValue + "\" received with \"" + tag + "\"", nfe);
      }
    }
  }
  ...
  private void validateRelationalComparator(String tempValue, String tag) throws ServiceException {
    if (!(tempValue.equals(HeaderConstants.GT_OP)
      ...
      throw ServiceException.PARSE_ERROR(
          "Invalid value \"" + tempValue + "\" received with \"" + tag + "\"", null);
    }
  }
  ...
  private void parseAddheader(Node node, RuleProperties props) throws ServiceException {
    ...
    if (isTag) {
      ...
      if (!StringUtil.isNullOrEmpty(value)) {
        ...
        throw ServiceException.PARSE_ERROR(
            "Invalid argument :" + value + " received with addheader", null);
      }
    ...
    if (!StringUtil.isNullOrEmpty(headerName) && !StringUtil.isNullOrEmpty(headerValue)) {
      ...
      throw ServiceException.PARSE_ERROR(
          "Invalid addheader action: Missing headerName or headerValue", null);
    }
  }
  ...
  private void parseDeleteheader(Node node, RuleProperties props) throws ServiceException {
    ...
    for (i = 0; i < argCount; i++) {
      boolean isTag =
          getNode(node, 0, i) == null
              ? false
              : getNode(node, 0, i).jjtGetNumChildren() == 0 ? true : false;
      if (isTag) {
          ...
          switch (tag) {
            ...
            case HeaderConstants.COUNT:
              if (valueComparision != null && valueComparision) {
                throw ServiceException.PARSE_ERROR(
                    ":count and :value, both can not be received with deleteheader", null);
              }
            ...
            case MatchTypeTags.MATCHES_TAG:
              if (matchType != null) {
                throw ServiceException.PARSE_ERROR(
                    "Multiple matchTypes received : \":" + matchType + "\" and \"" + tag + "\"",
                    null);
              }
            ...
            default:
              throw ServiceException.PARSE_ERROR(
                  "Invalid tag \"" + tag + "\" received with deleteheader", null);
          }
        } else {
          throw ServiceException.PARSE_ERROR(
              "Invalid argument :" + tag + " received with deleteheader", null);
        }
      } else {
        if (i < argCount) {
          ...
          switch (tag) {
            ...
            case HeaderConstants.NEW_NAME:
              ...
              if (StringUtil.isNullOrEmpty(newName)) {
                throw ServiceException.PARSE_ERROR(
                    "No value received with \"" + tag + "\" in replaceheader", null);
              }
              break;
            ...
            case HeaderConstants.COUNT:
              if (valueComparision != null && valueComparision) {
                throw ServiceException.PARSE_ERROR(
                    ":count and :value, both can not be received with replaceheader", null);
              }
              countComparision = true;
              i++;
              relationalComparator = visitRelationalComparator(node, tag, i);
            ...
            default:
              throw ServiceException.PARSE_ERROR(
                  "Invalid tag \"" + tag + "\" received with replaceheader", null);
          }
        } else {
          throw ServiceException.PARSE_ERROR(
              "Invalid argument :" + tag + " received with replaceheader", null);
        }
      } else {
        if (i < argCount) {
          headerName = getValue(node, 0, i, 0, 0);
  ...
  /** Returns <tt>true</tt> if the given node is the root of a rule node hierarchy. */
  ...
  /**
   * Returns <tt>true</tt> if the 'notify' action is formatted in RFC compliant. Otherwise (if the
   * 'notify' action is formatted in Zimbra-specific format), returns <tt>false</tt>
   *
   * <pre>
  ...
  private void validateCountComparator(boolean isCount, Sieve.Comparator comparator)
      throws ServiceException {
    if (isCount && comparator != null && !Sieve.Comparator.iasciinumeric.equals(comparator)) {
      throw ServiceException.PARSE_ERROR(
          "Invalid Comparator For Count: " + comparator.toString(), null);
    }
  }
}
