...
/**
 * For Bug 77287 Zimbra's own configuration manager which make it possible to use Zimbra's own
 * CommandManager.
 */
public class ZimbraConfigurationManager extends ConfigurationManager {
  ...
  /**
   * return an instance of Zimbra's own CommandManager, which loads classes with class name
   * registered in commandMap when getting sieve script processed.
   */
  @Override
