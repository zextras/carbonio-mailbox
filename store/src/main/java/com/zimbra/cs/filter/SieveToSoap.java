...
/** Converts a Sieve node tree to the SOAP representation of filter rules. */
public final class SieveToSoap extends SieveVisitor {
  ...
  private void initRule(RuleProperties props) {
    if (!isNestedRule()) {
      ...
      FilterTests tests =
          props.getCondition() != null
              ? new FilterTests(props.getCondition().toString())
  ...
  protected void visitVariable(
      Node ruleNode, VisitPhase phase, RuleProperties props, String name, String value) {
  ...
  protected void visitHeaderExistsTest(
      Node node, VisitPhase phase, RuleProperties props, String header) {
    if (phase == VisitPhase.begin) {
  ...
  protected void visitConversationTest(
      Node node, VisitPhase phase, RuleProperties props, String where) {
    if (phase == VisitPhase.begin) {
  ...
  protected void visitFlaggedTest(
      Node node, VisitPhase phase, RuleProperties props, Sieve.Flag flag) {
    if (phase == VisitPhase.begin) {
  ...
  @Override
  protected void visitFlagAction(
      Node node, VisitPhase phase, RuleProperties props, Sieve.Flag flag) {
    if (phase == VisitPhase.begin) {
  ...
  protected void visitRedirectAction(
      Node node, VisitPhase phase, RuleProperties props, String address) {
  ...
  protected void visitRFCCompliantNotifyAction(
    ...
    if (phase == VisitPhase.begin) {
      FilterAction.RFCCompliantNotifyAction action =
          addAction(new FilterAction.RFCCompliantNotifyAction());
    ...
    if (phase == VisitPhase.begin) {
      if (!StringUtil.isNullOrEmpty(headerName) && !StringUtil.isNullOrEmpty(headerValue)) {
        ...
        throw ServiceException.PARSE_ERROR(
            "Invalid addheader action: Missing headerName or headerValue - "
                + headerName
                + " : "
                + headerValue,
            null);
    ...
    if (phase == VisitPhase.begin) {
      EditheaderTest test =
          new EditheaderTest(
              ...
              headerName,
              headerValue);
      FilterAction.DeleteheaderAction action =
          new FilterAction.DeleteheaderAction(last, offset, test);
    ...
    if (phase == VisitPhase.begin) {
      EditheaderTest test =
          new EditheaderTest(
              ...
              headerName,
              headerValue);
      FilterAction.ReplaceheaderAction action =
          new FilterAction.ReplaceheaderAction(last, offset, test, newName, newValue);
