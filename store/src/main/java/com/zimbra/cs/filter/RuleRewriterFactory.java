    ...
    if (instance == null) {
      ...
      if (className != null && !className.equals("")) {
        try {
          ...
          ZimbraLog.filter.error(
              "could not instantiate RuleRewriterFactory interface of class '"
                  + className
                  + "'; defaulting to RuleRewriterFactory",
              e);
        }
      }
      if (instance == null) instance = new RuleRewriterFactory();
    }
    return instance;
  }
