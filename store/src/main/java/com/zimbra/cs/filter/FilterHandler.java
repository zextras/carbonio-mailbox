...
interface FilterHandler {
  ...
  /**
   * Discards the message. This method will only be called when there are no <tt>fileinto</tt> or
   * <tt>keep</tt> actions.
   */
  void discard() throws ServiceException;

  /**
   * Files the message into either the default folder or the spam folder. This method will not be
  ...
  /**
   * Files the message into the default folder without taking spam filtering into account. This
   * method will not be called multiple times for the same message.
   *
   * @return the new message, or <tt>null</tt> if it was a duplicate
   */
  ...
  /**
   * Files the message into the given folder. May be local or remote. This method will not be called
   * multiple times for the same path.
   *
   * @return the new message, or <tt>null</tt> if it was a duplicate
   */
  ItemId fileInto(String folderPath, Collection<ActionFlag> flagActions, String[] tags)
  ...
  abstract void reject(String reason, LmtpEnvelope envelope)
      throws ServiceException, MessagingException;
