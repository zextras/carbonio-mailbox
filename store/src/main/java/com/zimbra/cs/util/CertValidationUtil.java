...
public class CertValidationUtil {
  ...
  public static void validateCertificate(
      X509Certificate cert, boolean revocationCheckEnabled, Set<TrustAnchor> trustedCertsSet)
  ...
  public static Set<TrustAnchor> loadTrustedAnchors(char[] pass, String keystorePath)
    ...
    while (aliases.hasMoreElements()) {
      ...
      ZimbraLog.account.debug(
          "adding certificate with issuer DN: %s , signature name: %s",
          rootCACert.getIssuerDN().toString(), rootCACert.getSigAlgName());
    }
