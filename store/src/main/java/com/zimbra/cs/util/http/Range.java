...
public class Range {
  ...
  /**
   * Creates Range from supplied string. The string needs to contain properly formatted value of
   * Range header, containing one or more numeric ranges, e.g:
   *
   * <p>bytes=0-1000,2000-3000 bytes=100- bytes=-500
   *
   * @param header String with the header value
   * @return Range instance or null if header parameter was null
   * @throws RangeException If the supplied string is syntactically invalid; additionally if the
   *     range is reversed or contains negative values
   */
