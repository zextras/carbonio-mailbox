...
/**
 * The <code>TaskMode</code> class relates to the PidLidTaskMode MAPI Property which is documented
 * in MS-OXOTASK as specifying the assignment status of a task object.
 *
 * @author Gren Elliot
 */
