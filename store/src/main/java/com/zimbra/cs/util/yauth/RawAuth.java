...
/**
 * Implementation of Yahoo "Raw Auth" aka "Token Login v2" See
 * http://twiki.corp.yahoo.com/view/Membership/OpenTokenLogin
 */
  ...
  public String toString() {
    if (DEBUG) {
      return String.format(
          "{appid=%s,cookie=%s,wssId=%s,expiration=%d}", appId, cookie, wssId, expiration);
    } else {
