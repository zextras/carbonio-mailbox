...
public class ChangedInstanceInfo {
  ...
  public void readExtendedException(RawInputStream ris, boolean hasChangeHighlight)
      throws IOException {
  ...
  public String toString() {
    StringBuffer buf = new StringBuffer("    ChangedInstance:").append(exceptionNum).append("\n");
    this.infoOnLocalTimeSince1601Val(buf, "        StartDate:", startMinsSince1601);
    this.infoOnLocalTimeSince1601Val(buf, "        EndDate:", endMinsSince1601);
    this.infoOnLocalTimeSince1601Val(buf, "        OriginalStartDate:", origStartMinsSince1601);
    ...
    if (this.hasExtendedInfo) {
      ...
      this.infoOnLocalTimeSince1601Val(buf, "        ExtendedStartDate:", eeStartMinsSince1601);
      this.infoOnLocalTimeSince1601Val(buf, "        ExtendedEndDate:", eeEndMinsSince1601);
      this.infoOnLocalTimeSince1601Val(
          buf, "        ExtendedOriginalStartDate:", eeOrigStartMinsSince1601);
      if (overrideFlags.contains(ExceptionInfoOverrideFlag.ARO_SUBJECT)) {
