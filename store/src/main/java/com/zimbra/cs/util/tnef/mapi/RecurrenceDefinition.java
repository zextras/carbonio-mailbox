...
public class RecurrenceDefinition {
    ...
    private final TimeZoneDefinition tzDef;
    private final String oemCodePage;

    private final long readerVersion;
    private final long writerVersion;
    public RecurrenceFrequency recurrenceFrequency;
    public PatternType patternType;
    public MsCalScale calScale;
    private long firstDateTime;
    private final long period;
    private final long slidingFlag;
    ...
    private final long startTimeOffset;             // localtime minutes since start of current day
    private final long endTimeOffset;               // localtime minutes since start of current day
    ...
    private final List <ChangedInstanceInfo> changedInstances;
