...
/**
 * The <code>DayOfWeek</code> enum is used to represent days of the week. It is typically associated
 * with elements of MAPI properties which use the Sunday=0... convention. e.g. the MAPI SYSTEMTIME
 * structure dayOfWeek
 *
 * @author Gren Elliot
 */
