...
public class TNEFtoIcalendarServiceException extends ServiceException {
  ...
  /**
   * A public inner subclass whose purpose is to group various "TooComplex" exceptions into a common
   * type so that one can write a catch block to catch all such exceptions.
   */
  public static class UnsupportedTnefCalendaringMsgException
      extends TNEFtoIcalendarServiceException {
  ...
  TNEFtoIcalendarServiceException(
      String message, String code, boolean isReceiversFault, Throwable cause, Argument... args) {
    super(message, code, isReceiversFault, cause, args);
  }
  /** Creates a new instance of <code>TNEFtoIcalendarException</code>. */
  ...
  public static TNEFtoIcalendarServiceException RRULE_PARSING_PROBLEM(Throwable cause) {
    return new UnsupportedTnefCalendaringMsgException(
        "Internal error parsing RRULE generated to represent rule in TNEF",
        RRULE_PARSING_PROBLEM,
        RECEIVERS_FAULT,
        cause);
  }

  public static TNEFtoIcalendarServiceException NON_CALENDARING_CLASS(String msgClass) {
    return new UnsupportedTnefCalendaringMsgException(
        "TNEF represents non-Calendaring (or unrecognised) message class:" + msgClass,
        NON_CALENDARING_CLASS,
        RECEIVERS_FAULT);
  }

  public static TNEFtoIcalendarServiceException UNSUPPORTED_RECURRENCE_TYPE(String patt) {
    return new UnsupportedTnefCalendaringMsgException(
