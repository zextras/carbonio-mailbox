...
public class TZRule {
  ...
  public TZRule(RawInputStream ris) throws IOException {
    ...
    // If this rule represents the time zone rule that will be used to convert to and from UTC, both
    // of these
    // flags are set (for example, the value is 0x0003). If this is not the active time zone rule,
    // neither of
    // these flags are set. These flags are set on exactly one TZRule that is contained in this
    // property, and
  ...
  /**
   * @return The RRrule for use in an ICALENDAR STANDARD component or null if not applicable
   */
  ...
  /**
   * @return The RRrule for use in an ICALENDAR DAYLIGHT component or null if not applicable
   */
  ...
  /**
   * @return The RRULE String for use in an ICALENDAR STANDARD component or null if not applicable
   */
  ...
  /**
   * @return The RRULE String for use in an ICALENDAR DAYLIGHT component or null if not applicable
   */
  ...
  private String rruleDayInfo(DayOfWeek dow, int occurNum) {
    ...
    if (occurNum == 5) occurNum = -1; // Means "last"
