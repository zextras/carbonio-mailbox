...
public class IcalUtil {
  ...
  public static void addProperty(
      ContentHandler icalOutput, String propName, String propValue, boolean emptyIsOk)
      throws ParserException, URISyntaxException, IOException, ParseException {
  ...
  public static void addProperty(
      ContentHandler icalOutput, String propName, Object propValue, boolean emptyIsOk)
      throws ParserException, URISyntaxException, IOException, ParseException {
    if (propValue == null) {
  ...
  public static String iCalDateTimeValue(
      DateTime actualTime, java.util.TimeZone javaTZ, boolean useDateOnly) {
    if (!useDateOnly) {
  ...
  /**
   * Use when a UTC equivalent of a DateTime is required with the trailing Z indicating that it is
   * UTC
   *
   ...
   *
   * @param localTimeSince1601 is the number of minutes since the start of 1601 in <code>tzDef
   *     </code>
   * @param tzDef
   * @return
   */
  ...
  /**
   * Useful for handling date related properties based on MAPI properties whose value is specified
   * as the offset from the Microsoft EPOC in 1601 BUT adjusted for localtime. i.e. <code>
   * floatingDate</code> is not an accurate date but if it is treated as a UTC based date it will
  ...
  public static void addFloatingDateProperty(
      ContentHandler icalOutput, String propName, DateTime floatingDate)
      throws ParserException, URISyntaxException, ParseException, IOException {
  ...
  public static Long readI32(RawInputStream ris) throws IOException {
    return (ris.readU8() | (ris.readU8() << 8) | (ris.readU8() << 16) | (ris.readU8() << 24))
        & 0xFFFFFFFFFFFFFFFFL;
  }
