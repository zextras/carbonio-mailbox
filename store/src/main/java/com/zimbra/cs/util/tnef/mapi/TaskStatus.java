...
/**
 * The <code>TaskStatus</code> class relates to the PidLidTaskStatus MAPI Property which is
 * documented in MS-OXOTASK as specifying the status of the user's progress on the task.
 *
 * @author Gren Elliot
 */
