...
/**
 * The <code>MSGUID</code> class is a wrapper round the jtnef GUID class intended to address the
 * difference between the string representation of a GUID used in Microsoft literature like
 * MS-OXPROPS and the canonized GUID representation used in jtnef 1.6 Information gleaned from :
 * http://en.wikipedia.org/wiki/Globally_Unique_Identifier
 *
 * <p>GUIDs are 16 byte numbers split up as follows : 1st 4 bytes - native 32-bit 2nd 2 bytes -
 * native 16-bit 3rd 2 bytes - native 16-bit 4th 8 bytes - big-endian 64-bit
 *
 * <p>The native byte order used in TNEF is little-endian order. The string representation uses hex
 * digits, separating each component with '-' with an additional '-' after the first 2 bytes in the
 * 4th component. The canonized jtnef String representation reflects the underlying byte sequence
 * directly. The MS-OXPROPS form String representation reflects the underlying little-endian data
 * and typically encloses the whole string in curly brackets. e.g. for PSETID_Meeting : MS-OXPROPS
 * representation {6ED8DA90-450B-101B-98DA-00AA003F1305} jtnef representation
 * 90dad86e-0b45-1b10-98da-00aa003f1305
 *
 * @author Gren Elliot
 */
public class MSGUID {
  ...
  public static final MSGUID PSETID_Appointment =
      new MSGUID("{00062002-0000-0000-C000-000000000046}");
  ...
  public static final MSGUID PS_PUBLIC_STRINGS =
      new MSGUID("{00020329-0000-0000-C000-000000000046}");
