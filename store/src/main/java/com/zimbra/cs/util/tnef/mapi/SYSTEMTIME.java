...
/**
 * @author Gren Elliot
 *     <p>Represents MAPI SYSTEMTIME structure This can represent a time but is also used in
 *     timezone definition structures
 */
public class SYSTEMTIME {
  ...
  /**
   * For timezone definitions, normally 0. If not is absolute date that occurs once only.
   *
   * @return the Year
   */
  public int getYear() {
  ...
  /**
   * For timezone - the occurrence number of a particular day of the week (e.g. Monday) within the
   * month. 5 means last one in the month
   *
   * @return the day
   */
  public int getDay() {
  ...
  /**
   * @param other
   * @return true if <code>other</code> can be regarded as sufficiently similar if it is part of a
   *     timezone rule.
   */
