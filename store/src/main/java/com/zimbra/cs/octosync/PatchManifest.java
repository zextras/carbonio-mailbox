...
/**
 * Represents patch manifest, i.e. summary information about references to all files an indvidual
 * patch is making.
 *
 * @author grzes
 */
public class PatchManifest {
  ...
  /**
   * Writes the manifest in the binary format to the specified OutputStream
   *
