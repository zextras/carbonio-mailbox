...
/**
 * Registers {@link ExtensionHttpHandler} for extensions and dispatches HTTP requests to them. This
 * servlet accepts requests sent to /service/extension/&lt;ext name>/&lt;handler path> URI, where
 * &lt;ext name>/&lt;handler path> is used to locate the handler whose {@link
 * ExtensionHttpHandler#getPath() } has the same path.
 *
 * @author kchen
 */
