...
public final class DbVolumeBlobs {
  ...
  private static final String SELECT_BLOB_REFS =
      "SELECT "
          + CN_ID
          + ","
          + CN_VOLUME_ID
  ...
  public static void addBlobReference(DbConnection conn, Mailbox mbox, Volume vol, MailItem item)
  ...
  public static void addBlobReference(DbConnection conn, MailboxBlobInfo info)
      throws ServiceException {
  ...
  public static void updateProcessed(DbConnection conn, long id, boolean processed)
      throws ServiceException {
    PreparedStatement stmt = null;
    try {
      stmt =
  ...
  public static List<BlobReference> getBlobReferences(
      DbConnection conn, String digest, Volume volume) throws ServiceException {
    PreparedStatement stmt = null;
    ResultSet rs = null;
    try {
      stmt =
  ...
  private static SpoolingCache<String> fillBlobDigests(ResultSet rs)
  ...
  public static List<BlobReference> getBlobReferences(DbConnection conn, Volume vol)
      throws ServiceException {
    PreparedStatement stmt = null;
    ResultSet rs = null;
    try {
      stmt =
          conn.prepareStatement(
              SELECT_BLOB_REFS + CN_VOLUME_ID + " = ? ORDER BY " + CN_DIGEST + " ASC");
      int pos = 1;
      stmt.setShort(pos++, vol.getId());
      rs = stmt.executeQuery();
      return fillBlobReferences(rs);
  ...
  public static SpoolingCache<String> getUniqueDigests(DbConnection conn, Volume vol)
