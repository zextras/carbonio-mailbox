...
public class RetryConnection extends DebugConnection {
  ...
  public PreparedStatement prepareStatement(final String sql) throws SQLException {
    ...
    AbstractRetry<PreparedStatement> exec =
        new AbstractRetry<PreparedStatement>() {
          @Override
  ...
  public PreparedStatement prepareStatement(
    ...
    AbstractRetry<PreparedStatement> exec =
        new AbstractRetry<PreparedStatement>() {
          ...
          public ExecuteResult<PreparedStatement> execute() throws SQLException {
            return new ExecuteResult<PreparedStatement>(
                new RetryPreparedStatement(
                    conn, mConn.prepareStatement(sql, resultSetType, resultSetConcurrency), sql));
          }
        };
    return exec.doRetry().getResult();
  }
  ...
  public PreparedStatement prepareStatement(final String sql, final int[] columnIndexes)
    ...
    AbstractRetry<PreparedStatement> exec =
        new AbstractRetry<PreparedStatement>() {
          ...
          public ExecuteResult<PreparedStatement> execute() throws SQLException {
            return new ExecuteResult<PreparedStatement>(
                new RetryPreparedStatement(conn, mConn.prepareStatement(sql, columnIndexes), sql));
          }
        };
    return exec.doRetry().getResult();
  }
  ...
  public PreparedStatement prepareStatement(final String sql, final String[] columnNames)
    ...
    AbstractRetry<PreparedStatement> exec =
        new AbstractRetry<PreparedStatement>() {
          ...
          public ExecuteResult<PreparedStatement> execute() throws SQLException {
            return new ExecuteResult<PreparedStatement>(
                new RetryPreparedStatement(conn, mConn.prepareStatement(sql, columnNames), sql));
          }
        };
    return exec.doRetry().getResult();
  }
