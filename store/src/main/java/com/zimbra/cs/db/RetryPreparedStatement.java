...
/**
 * PreparedStatement wrapper that allows for retry on exception. Current implementation retries when
 * exception message matches 'SQLITE_BUSY' Retry occurs a maximum of 5 times with a delay of 250ms
 * between each attempt If retry limit is reached the last instance of the exception is wrapped and
 * thrown.
 */
public class RetryPreparedStatement extends DebugPreparedStatement {
  ...
  public boolean execute() throws SQLException {
    AbstractRetry<Boolean> exec =
        new AbstractRetry<Boolean>() {
          @Override
  ...
  public int[] executeBatch() throws SQLException {
    AbstractRetry<int[]> exec =
        new AbstractRetry<int[]>() {
          @Override
  ...
  public ResultSet executeQuery() throws SQLException {
    AbstractRetry<ResultSet> exec =
        new AbstractRetry<ResultSet>() {
          @Override
  ...
  public int executeUpdate() throws SQLException {
    AbstractRetry<Integer> exec =
        new AbstractRetry<Integer>() {
          @Override
