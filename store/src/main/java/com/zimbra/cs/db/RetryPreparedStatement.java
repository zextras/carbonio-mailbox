...
public class RetryPreparedStatement extends DebugPreparedStatement {
    ...
    public boolean execute() throws SQLException {
        AbstractRetry<Boolean> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<Boolean> execute() throws SQLException {
            return new ExecuteResult<>(superExecute());
          }
        };
    ...
    public boolean execute(final String sql, final int autoGeneratedKeys)
        ...
        AbstractRetry<Boolean> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<Boolean> execute() throws SQLException {
            return new ExecuteResult<>(superExecute(sql, autoGeneratedKeys));
          }
        };
        return exec.doRetry().getResult();
    }
    ...
    public boolean execute(final String sql, final int[] columnIndexes) throws SQLException {
        AbstractRetry<Boolean> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<Boolean> execute() throws SQLException {
            return new ExecuteResult<>(superExecute(sql, columnIndexes));
          }
        };
        return exec.doRetry().getResult();
    }
    ...
    public boolean execute(final String sql, final String[] columnNames)
        ...
        AbstractRetry<Boolean> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<Boolean> execute() throws SQLException {
            return new ExecuteResult<>(superExecute(sql, columnNames));
          }
        };
        return exec.doRetry().getResult();
    }
    ...
    public boolean execute(final String sql) throws SQLException {
        AbstractRetry<Boolean> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<Boolean> execute() throws SQLException {
            return new ExecuteResult<>(superExecute(sql));
          }
        };
        return exec.doRetry().getResult();
    }
    ...
    public int[] executeBatch() throws SQLException {
        AbstractRetry<int[]> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<int[]> execute() throws SQLException {
            return new ExecuteResult<>(superExecuteBatch());
          }
        };
        return exec.doRetry().getResult();
    }
    ...
    public ResultSet executeQuery() throws SQLException {
        AbstractRetry<ResultSet> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<ResultSet> execute() throws SQLException {
            return new ExecuteResult<>(superExecuteQuery());
          }
        };
        return exec.doRetry().getResult();
    }
    ...
    public ResultSet executeQuery(final String sql) throws SQLException {
        AbstractRetry<ResultSet> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<ResultSet> execute() throws SQLException {
            return new ExecuteResult<>(superExecuteQuery(sql));
          }
        };
        return exec.doRetry().getResult();
    }
    ...
    public int executeUpdate() throws SQLException {
        AbstractRetry<Integer> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<Integer> execute() throws SQLException {
            return new ExecuteResult<>(superExecuteUpdate());
          }
        };
        return exec.doRetry().getResult();
    }
    ...
    public int executeUpdate(final String sql, final int autoGeneratedKeys)
        ...
        AbstractRetry<Integer> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<Integer> execute() throws SQLException {
            return new ExecuteResult<>(superExecuteUpdate(sql, autoGeneratedKeys));
          }
        };
        return exec.doRetry().getResult();
    }
    ...
    public int executeUpdate(final String sql, final int[] columnIndexes)
        ...
        AbstractRetry<Integer> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<Integer> execute() throws SQLException {
            return new ExecuteResult<>(superExecuteUpdate(sql, columnIndexes));
          }
        };
        return exec.doRetry().getResult();
    }
    ...
    public int executeUpdate(final String sql, final String[] columnNames)
        ...
        AbstractRetry<Integer> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<Integer> execute() throws SQLException {
            return new ExecuteResult<>(superExecuteUpdate(sql, columnNames));
          }
        };
        return exec.doRetry().getResult();
    }
    ...
    public int executeUpdate(final String sql) throws SQLException {
        AbstractRetry<Integer> exec = new AbstractRetry<>() {
          @Override
          public ExecuteResult<Integer> execute() throws SQLException {
            return new ExecuteResult<>(superExecuteUpdate(sql));
          }
        };
        return exec.doRetry().getResult();
    }
