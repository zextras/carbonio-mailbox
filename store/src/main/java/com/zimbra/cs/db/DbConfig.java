...
public class DbConfig {
  ...
  public static DbConfig get(DbConnection conn, String name) throws ServiceException {
    ...
    try {
      ...
      if (rs.next()) return constructConfig(rs);
    } catch (SQLException e) {
  ...
  /**
   * Return all config items in a map, where name is the key and a Config object is the value.
   *
   * @param conn
   ...
   * @throws SQLException
   */
  public static Map<String, DbConfig> getAll(DbConnection conn, Timestamp ts)
