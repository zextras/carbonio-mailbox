...
public class Identity extends AccountProperty implements Comparable {
  ...
  /**
   * this should only be used internally by the server. it doesn't modify the real id, just the
   * cached one.
   *
   * @param id
   */
  ...
  public InternetAddress getFriendlyEmailAddress() {
    ...
    if (personalPart == null || personalPart.trim().equals("")) personalPart = null;
