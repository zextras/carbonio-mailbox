...
public enum TargetType {
  ...
  calresource(
      ...
      com.zimbra.soap.type.TargetType.calresource,
      "CalendarResource"),
  ...
  dl(
      ...
      com.zimbra.soap.type.TargetType.dl,
      "DistributionList"), // static group
  group(
      true,
      true,
      AttributeClass.group,
      com.zimbra.soap.type.TargetType.group,
  ...
  config(
      ...
      com.zimbra.soap.type.TargetType.config,
      "GlobalConfig"),
  global(
      false,
      false,
  ...
  public static Entry lookupTarget(
      ...
      throws ServiceException {
    return lookupTarget(
        prov, fromJaxb(targSel.getType()), targSel.getBy(), targSel.getValue(), mustFind);
  }
  ...
  static Map<String, Set<String>> getSearchBasesAndOCs(
    ...
    if (LdapDIT.isZimbraDefault(dit)) {
      if (leastCommonBaseInMailBranch != null && leastCommonBaseInConfigBranch != null) {
        // merge the two
        String commonBase =
            getCommonBase(leastCommonBaseInMailBranch, leastCommonBaseInConfigBranch);
