 ...
 *
 * <p>Provides a convinient way for setting object types.
 *
 * <p>Callsites can use SearchAccountsOptions.setIncludeType() instead of
 * SearchObjectsOptions.setTypes(). Default types for SearchAccountsOptions is acounts and calendar
 * resources,
 */
