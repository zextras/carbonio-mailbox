...
public class BUG_32557 extends UpgradeOp {
    ...
    private void visit(Domain domain) {
      ...
      try {
        upgradeOp.printer.format(
            "Updating domain %-30s: objectClass=amavisAccount\n", domain.getName());
  ...
  void doUpgrade() throws ServiceException {
    ...
    String attrs[] =
        new String[] {
          Provisioning.A_objectClass, Provisioning.A_zimbraId, Provisioning.A_zimbraDomainName
        };
    ...
    try {
      ...
      if (visitor != null) visitor.reportStat();
    }
  }
