...
public class BUG_66387 extends UpgradeOp {
  ...
  Description getDescription() {
    return new Description(
        ...
        "see notes",
        "see notes",
        "Any internal account or distribution list address listed in "
            + Provisioning.A_zimbraAllowFromAddress
            + " attribute is converted to a grant of sendAs (for account) or sendAsDistList (for"
            + " DL) right from the named account or DL.  The address is added to the "
            + Provisioning.A_zimbraPrefAllowAddressForDelegatedSender
  ...
  void doUpgrade() throws ServiceException {
    ...
    printer.println(
        "Number of accounts using " + Provisioning.A_zimbraAllowFromAddress + ": " + numInspected);
  ...
  private int searchAndFixAccounts() throws ServiceException {
    ...
    searchOpts.setFilterString(
        FilterId.LDAP_UPGRADE, "(" + Provisioning.A_zimbraAllowFromAddress + "=*)");
  ...
  private void doGrant(NamedEntry grantor, Account grantee, String address)
    ...
    String[] currAddrs =
        grantor.getMultiAttr(Provisioning.A_zimbraPrefAllowAddressForDelegatedSender);
    ...
    if (add) {
      ...
      StringUtil.addToMultiMap(
          attrs, "+" + Provisioning.A_zimbraPrefAllowAddressForDelegatedSender, address);
