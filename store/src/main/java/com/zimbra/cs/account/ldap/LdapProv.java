...
public abstract class LdapProv extends Provisioning {
  ...
  public abstract void renameDomain(String domainId, String newDomainName) throws ServiceException;

  public abstract void searchOCsForSuperClasses(Map<String, Set<String>> ocs);

  public abstract void getAttrsInOCs(String[] ocs, Set<String> attrsInOCs) throws ServiceException;
  ...
  public abstract void externalLdapAuth(
  ...
  /**
   * Authenticate to Zimbra LDAP server with bind DN and password. Used when stored password is not
   * SSHA.
   */
  ...
  @TODO // deprecate
  public abstract void searchLdapOnReplica(
      String base, String filter, String[] returnAttrs, SearchLdapOptions.SearchLdapVisitor visitor)
      throws ServiceException;
