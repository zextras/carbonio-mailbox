...
public class AccountServiceException extends ServiceException {
  ...
  public static final String TOO_MANY_ZIMLETUSERPROPERTIES =
  ...
  public static final String WEB_CLIENT_ACCESS_NOT_ALLOWED =
      "account.WEB_CLIENT_ACCESS_NOT_ALLOWED";
  ...
  public static class AuthFailedServiceException extends AccountServiceException {
    ...
    private AuthFailedServiceException(
        String acctName,
        String namePassedIn,
        String reason,
        String code,
        ...
        Throwable cause) {
      super(
          "authentication failed for [" + Strings.nullToEmpty(namePassedIn) + "]",
          code,
          isReceiversFault,
          cause);
      mReason = reason;
    ...
    public String getReason(String format) {
      if (mReason == null) return "";
      else return String.format(format, mReason);
    }
    ...
    public static AuthFailedServiceException AUTH_FAILED(
        String acctName, String namePassedIn, String reason) {
      return AUTH_FAILED(acctName, namePassedIn, reason, null);
    }

    public static AuthFailedServiceException AUTH_FAILED(
        String acctName, String namePassedIn, String reason, Throwable t) {
      return new AuthFailedServiceException(
          acctName, namePassedIn, reason, AUTH_FAILED, SENDERS_FAULT, t);
    }

    public static AuthFailedServiceException AUTH_FAILED(
        String namePassedIn, String reason, Throwable t) {
      return new AuthFailedServiceException(
          "N/A", namePassedIn, reason, AUTH_FAILED, SENDERS_FAULT, t);
    }
  ...
  public static AccountServiceException CHANGE_PASSWORD() {
    return new AccountServiceException(
        "must change password", CHANGE_PASSWORD, SENDERS_FAULT, null);
  }
  ...
  public static AccountServiceException PASSWORD_LOCKED() {
    return new AccountServiceException(
        "password is locked and can't be changed", PASSWORD_LOCKED, SENDERS_FAULT, null);
  }

  public static AccountServiceException MULTIPLE_ACCOUNTS_MATCHED(String desc) {
    return new AccountServiceException(
        "lookup returned multiple accounts: " + desc,
  ...
  public static AccountServiceException MULTIPLE_DOMAINS_MATCHED(String desc) {
    return new AccountServiceException(
        "lookup returned multiple domains: " + desc, MULTIPLE_DOMAINS_MATCHED, SENDERS_FAULT, null);
  }

  public static AccountServiceException MULTIPLE_ENTRIES_MATCHED(String desc, Throwable t) {
    return new AccountServiceException(
        "lookup returned multiple entries: " + desc, MULTIPLE_ENTRIES_MATCHED, SENDERS_FAULT, t);
  }

  public static AccountServiceException PASSWORD_CHANGE_TOO_SOON() {
    return new AccountServiceException(
        "password can't be changed yet", PASSWORD_CHANGE_TOO_SOON, SENDERS_FAULT, null);
  }

  public static AccountServiceException INVALID_PASSWORD(String desc) {
    return new AccountServiceException(
        "invalid password: " + desc, INVALID_PASSWORD, SENDERS_FAULT, null);
  }

  public static AccountServiceException INVALID_PASSWORD(String desc, Argument... arguments) {
    return new AccountServiceException(
        "invalid password: " + desc, INVALID_PASSWORD, SENDERS_FAULT, null, arguments);
  }
  ...
  public static AccountServiceException NO_SMIME_CONFIG(String desc) {
    return new AccountServiceException(
        "no SMIME config: " + desc, NO_SMIME_CONFIG, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_ACCOUNT(String name) {
    return new AccountServiceException(
        "no such account: " + name, NO_SUCH_ACCOUNT, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_ALIAS(String name) {
    return new AccountServiceException(
        "no such alias: " + name, NO_SUCH_ALIAS, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_DOMAIN(String name) {
    return new AccountServiceException(
        "no such domain: " + name, Constants.ERROR_CODE_NO_SUCH_DOMAIN, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_ORG_UNIT(String name) {
    return new AccountServiceException(
        "no such organizational unit: " + name, NO_SUCH_ORG_UNIT, SENDERS_FAULT, null);
  }

  public static AccountServiceException DOMAIN_NOT_EMPTY(String name, Exception e) {
    return new AccountServiceException(
        "domain not empty: " + name, DOMAIN_NOT_EMPTY, SENDERS_FAULT, e);
  }
  ...
  public static AccountServiceException NO_SUCH_SHARE_LOCATOR(String id) {
    return new AccountServiceException(
        "no such share locator: " + id, NO_SUCH_SHARE_LOCATOR, SENDERS_FAULT, null);
  }
  ...
  public static AccountServiceException NO_SUCH_SERVER(String name) {
    return new AccountServiceException(
        "no such server: " + name, NO_SUCH_SERVER, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_UC_SERVICE(String name) {
    return new AccountServiceException(
        "no such uc service: " + name, NO_SUCH_UC_SERVICE, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_IDENTITY(String name) {
    return new AccountServiceException(
        "no such identity: " + name, NO_SUCH_IDENTITY, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_SIGNATURE(String name) {
    return new AccountServiceException(
        "no such signature: " + name, NO_SUCH_SIGNATURE, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_DATA_SOURCE(String id) {
    return new AccountServiceException(
        "no such data source: " + id, NO_SUCH_DATA_SOURCE, SENDERS_FAULT, null);
  }
  ...
  public static AccountServiceException NO_SUCH_DISTRIBUTION_LIST(String name) {
    return new AccountServiceException(
        "no such distribution list: " + name, NO_SUCH_DISTRIBUTION_LIST, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_ADDRESS_LIST(String name) {
    return new AccountServiceException(
        "no such address list: " + name, NO_SUCH_ADDRESS_LIST, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_GROUP(String name) {
    return new AccountServiceException(
        "no such group: " + name, NO_SUCH_GROUP, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_CALENDAR_RESOURCE(String name) {
    return new AccountServiceException(
        "no such calendar resource: " + name, NO_SUCH_CALENDAR_RESOURCE, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_EXTERNAL_ENTRY(String name) {
    return new AccountServiceException(
        "no such external entry: " + name, NO_SUCH_EXTERNAL_ENTRY, SENDERS_FAULT, null);
  }

  public static AccountServiceException NO_SUCH_MEMBER(String dlName, String members) {
    return new AccountServiceException(
        "non-existent members: " + members + " in distribution list: " + dlName,
        NO_SUCH_MEMBER,
        SENDERS_FAULT,
        null);
  }
  ...
  public static AccountServiceException ACCOUNT_EXISTS(String name) {
    return new AccountServiceException(
        "email address already exists: " + name, ACCOUNT_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException ACCOUNT_EXISTS(String name, String atDn, Throwable t) {
    return new AccountServiceException(
        "email address already exists: " + name + ", at DN: " + atDn,
        ACCOUNT_EXISTS,
        SENDERS_FAULT,
        t);
  }
  ...
  public static AccountServiceException DOMAIN_EXISTS(String name) {
    return new AccountServiceException(
        "domain already exists: " + name, DOMAIN_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException COS_EXISTS(String name) {
    return new AccountServiceException(
        "cos already exists: " + name, COS_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException RIGHT_EXISTS(String name) {
    return new AccountServiceException(
        "right already exists: " + name, RIGHT_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException SERVER_EXISTS(String name) {
    return new AccountServiceException(
        "server already exists: " + name, SERVER_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException SHARE_LOCATOR_EXISTS(String id) {
    return new AccountServiceException(
        "share locator already exists: " + id, SHARE_LOCATOR_EXISTS, SENDERS_FAULT, null);
  }
  ...
  public static AccountServiceException ZIMLET_EXISTS(String name) {
    return new AccountServiceException(
        "zimlet already exists: " + name, ZIMLET_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException DISTRIBUTION_LIST_EXISTS(String name) {
    return new AccountServiceException(
        "email address already exists: " + name, DISTRIBUTION_LIST_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException IDENTITY_EXISTS(String name) {
    return new AccountServiceException(
        "identity already exists: " + name, IDENTITY_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException UC_SERVICE_EXISTS(String name) {
    return new AccountServiceException(
        "uc service already exists: " + name, UC_SERVICE_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException TOO_MANY_IDENTITIES() {
    return new AccountServiceException(
        "too many identities. can't create any more", TOO_MANY_IDENTITIES, SENDERS_FAULT, null);
  }

  public static AccountServiceException SIGNATURE_EXISTS(String name) {
    return new AccountServiceException(
        "signature already exists: " + name, SIGNATURE_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException TOO_MANY_SIGNATURES() {
    return new AccountServiceException(
        "too many signatures. can't create any more", TOO_MANY_SIGNATURES, SENDERS_FAULT, null);
  }

  public static AccountServiceException TOO_MANY_ZIMLETUSERPROPERTIES() {
    return new AccountServiceException(
        "too many user properties for zimlets. can't create any more",
        TOO_MANY_ZIMLETUSERPROPERTIES,
        SENDERS_FAULT,
        null);
  }
  ...
  public static AccountServiceException DATA_SOURCE_EXISTS(String name) {
    return new AccountServiceException(
        "data source already exists: " + name, DATA_SOURCE_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException TOO_MANY_DATA_SOURCES() {
    return new AccountServiceException(
        "too many data sources. can't create any more", TOO_MANY_DATA_SOURCES, SENDERS_FAULT, null);
  }

  public static AccountServiceException IM_COMPONENT_EXISTS(String name) {
    return new AccountServiceException(
        "IM Component already exists: " + name, IM_COMPONENT_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException MAINTENANCE_MODE() {
    return new AccountServiceException(
        "account is in maintenance mode", MAINTENANCE_MODE, RECEIVERS_FAULT, null);
  }

  public static AccountServiceException ACCOUNT_INACTIVE(String name) {
    return new AccountServiceException(
        "account is not active:" + name, ACCOUNT_INACTIVE, RECEIVERS_FAULT, null);
  }

  public static AccountServiceException PASSWORD_RECENTLY_USED() {
    return new AccountServiceException(
        "password was recently used", PASSWORD_RECENTLY_USED, SENDERS_FAULT, null);
  }

  public static AccountServiceException TOO_MANY_ACCOUNTS(String str) {
    return new AccountServiceException(
        "number of accounts reached the limit: " + str, TOO_MANY_ACCOUNTS, RECEIVERS_FAULT);
  }

  public static AccountServiceException TOO_MANY_SEARCH_RESULTS(String str, Exception e) {
    return new AccountServiceException(
        "number of results exceeded the limit: " + str,
  ...
  public static AccountServiceException TWO_FACTOR_SETUP_REQUIRED() {
    return new AccountServiceException(
        "two-factor authentication setup required", TWO_FACTOR_SETUP_REQUIRED, SENDERS_FAULT, null);
  }

  public static AccountServiceException INVALID_TRUSTED_DEVICE_TOKEN() {
    return new AccountServiceException(
        "invalid trusted device token", INVALID_TRUSTED_DEVICE_TOKEN, SENDERS_FAULT, null);
  }

  public static AuthFailedServiceException TWO_FACTOR_AUTH_FAILED(
      String acctName, String namePassedIn, String reason) {
    return new AuthFailedServiceException(
        acctName, namePassedIn, reason, TWO_FACTOR_AUTH_FAILED, SENDERS_FAULT, null);
  }

  public static AccountServiceException TWO_FACTOR_AUTH_REQUIRED() {
    return new AccountServiceException(
        "two-factor auth required", TWO_FACTOR_AUTH_REQUIRED, SENDERS_FAULT, null);
  }

  public static AccountServiceException ALIAS_EXISTS(String name) {
    return new AccountServiceException(
        "email address alias already exists: " + name, ALIAS_EXISTS, SENDERS_FAULT, null);
  }

  public static AccountServiceException WEB_CLIENT_ACCESS_NOT_ALLOWED(String name) {
    return new AccountServiceException(
        "web client access not allowed: " + name,
        WEB_CLIENT_ACCESS_NOT_ALLOWED,
        SENDERS_FAULT,
        null);
  }
}
