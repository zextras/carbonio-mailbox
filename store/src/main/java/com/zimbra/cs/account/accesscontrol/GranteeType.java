...
public enum GranteeType {
  ...
  GT_USER(
      ...
      (short) (GranteeFlag.F_ADMIN | GranteeFlag.F_INDIVIDUAL | GranteeFlag.F_IS_ZIMBRA_ENTRY)),
  GT_GROUP(
      "grp",
      com.zimbra.soap.type.GranteeType.grp,
      (short) (GranteeFlag.F_ADMIN | GranteeFlag.F_GROUP | GranteeFlag.F_IS_ZIMBRA_ENTRY)),
  GT_EXT_GROUP(
      "egp",
      com.zimbra.soap.type.GranteeType.egp,
      (short) (GranteeFlag.F_ADMIN | GranteeFlag.F_GROUP)),
  GT_AUTHUSER(
      "all",
      com.zimbra.soap.type.GranteeType.all,
      (GranteeFlag.F_AUTHUSER)), // all authenticated users
  GT_DOMAIN(
      "dom",
      com.zimbra.soap.type.GranteeType.dom,
      (short)
          (GranteeFlag.F_ADMIN
              | GranteeFlag.F_DOMAIN
              | GranteeFlag
                  .F_IS_ZIMBRA_ENTRY)), // only for the admin crossDomainAdmin right and user rights
  ...
  GT_GUEST(
      "gst",
      com.zimbra.soap.type.GranteeType.gst,
      (short) (GranteeFlag.F_INDIVIDUAL | GranteeFlag.F_HAS_SECRET)),
  GT_KEY(
      "key",
      com.zimbra.soap.type.GranteeType.key,
      (short) (GranteeFlag.F_INDIVIDUAL | GranteeFlag.F_HAS_SECRET)),
  ...
  /**
   * - code stored in the ACE. - code appear in XML - code displayed by CLI
   *
   * @return
   */
   ...
   */
  public static NamedEntry lookupGrantee(
      Provisioning prov,
    ...
    switch (granteeType) {
      ...
      case GT_GROUP:
        granteeEntry =
            prov.getGroupBasic(Key.DistributionListBy.fromString(granteeBy.name()), grantee);
        if (mustFind && granteeEntry == null) {
      ...
      default:
        throw ServiceException.INVALID_REQUEST(
            "invalid grantee type for lookupGrantee:" + granteeType.getCode(), null);
    }
  ...
  public static NamedEntry lookupGrantee(
      Provisioning prov, GranteeType granteeType, GranteeBy granteeBy, String grantee)
      throws ServiceException {
    return lookupGrantee(prov, granteeType, granteeBy, grantee, true);
  }

  public static NamedEntry lookupGrantee(
      Provisioning prov, GranteeSelector selector, boolean mustFind) throws ServiceException {
    return lookupGrantee(
        prov,
        GranteeType.fromJaxb(selector.getType()),
        selector.getBy(),
        selector.getKey(),
        mustFind);
  }
  ...
  public static GranteeType determineGranteeType(
      GranteeType granteeType, GranteeBy granteeBy, String grantee, String domainName)
      throws ServiceException {
    ...
    try {
      ...
      if (ExternalGroup.get(
              DomainBy.name,
              ExternalGroupInfo.encodeIfExtGroupNameMissingDomain(domainName, grantee),
              asAdmin)
          != null) {
