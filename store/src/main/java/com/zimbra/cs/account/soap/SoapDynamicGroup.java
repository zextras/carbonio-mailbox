...
public class SoapDynamicGroup extends DynamicGroup implements SoapEntry {
   ...
   */
  SoapDynamicGroup(DistributionListMembershipInfo dlInfo, Provisioning prov)
      throws ServiceException {
  ...
  SoapDynamicGroup(DistributionListInfo dlInfo, Provisioning prov) throws ServiceException {
    super(dlInfo.getName(), dlInfo.getId(), Attr.collectionToMap(dlInfo.getAttrList()), prov);
    addDlm(dlInfo.getMembers(), getRawAttrs());
  }

  SoapDynamicGroup(DLInfo dlInfo, Provisioning prov) throws ServiceException {
    super(dlInfo.getName(), dlInfo.getId(), Attr.collectionToMap(dlInfo.getAttrList()), prov);
