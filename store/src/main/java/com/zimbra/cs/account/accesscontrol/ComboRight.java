...
public class ComboRight extends AdminRight {
    ...
    private final Set<Right> mRights = new HashSet<>();

    // directly and indirectly contained rights
    private final Set<Right> mAllRights = new HashSet<>();

    // all preset rights contained in this combo right
    private final Set<Right> mPresetRights = new HashSet<>();

    // all attr rights contained in this combo right
    private final Set<AttrRight> mAttrRights = new HashSet<>();
