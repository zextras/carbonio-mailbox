...
public abstract class LdapSignatureBase extends Signature implements LdapEntry {
  ...
  protected LdapSignatureBase(
      Account acct, String name, String id, Map<String, Object> attrs, Provisioning prov) {
  ...
  public static Signature getAccountSignature(Provisioning prov, Account acct)
      throws ServiceException {
    if (!hasAccountSignature(acct)) return null;

    Map<String, Object> attrs = new HashMap<String, Object>();
    Set<String> signatureAttrs =
        AttributeManager.getInstance().getAttrsInClass(AttributeClass.signature);
    ...
    if (putbackAttrs.size() > 0) prov.modifyAttrs(acct, putbackAttrs);
  ...
  public static void modifyAccountSignature(
      Provisioning prov, Account acct, Map<String, Object> signatureAttrs) throws ServiceException {
    prov.modifyAttrs(acct, signatureAttrs);
  }

  public static void createAccountSignature(
      Provisioning prov, Account acct, Map<String, Object> signatureAttrs, boolean setAsDefault)
      throws ServiceException {
    if (setAsDefault) {
  ...
  public static void deleteAccountSignature(Provisioning prov, Account acct)
      throws ServiceException {
    Map<String, Object> attrs = new HashMap<String, Object>();
    Set<String> signatureAttrs =
        AttributeManager.getInstance().getAttrsInClass(AttributeClass.signature);
