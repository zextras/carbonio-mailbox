...
public abstract class ZAttrShareLocator extends NamedEntry {
   ...
   */
  @ZAttr(id = 1375)
  public void setShareOwnerAccountId(String zimbraShareOwnerAccountId)
   ...
   */
  @ZAttr(id = 1375)
  public Map<String, Object> setShareOwnerAccountId(
      String zimbraShareOwnerAccountId, Map<String, Object> attrs) {
    if (attrs == null) attrs = new HashMap<String, Object>();
    attrs.put(Provisioning.A_zimbraShareOwnerAccountId, zimbraShareOwnerAccountId);
    return attrs;
  }
