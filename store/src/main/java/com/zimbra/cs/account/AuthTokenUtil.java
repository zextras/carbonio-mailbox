...
public class AuthTokenUtil {
  ...
  public static void encodeAuthResp(AuthToken at, Element parent, boolean isAdmin)
      throws ServiceException {
    parent
        .addNonUniqueElement(isAdmin ? AdminConstants.E_AUTH_TOKEN : AccountConstants.E_AUTH_TOKEN)
        .setText(getOrigAuthData(at));
  }
  ...
  public static boolean isZimbraUser(String type) {
    return StringUtil.isNullOrEmpty(type)
        || AuthTokenProperties.C_TYPE_ZIMBRA_USER.equals(type)
        || AuthTokenProperties.C_TYPE_ZMG_APP.equals(type);
  }
