    ...
    try {
      if (o1 instanceof Account && o2 instanceof Account) {
        switch (iCompareField) {
          case 0:
            retVal = (((Account) o1).getId().compareTo(((Account) o2).getId()));
            break;
          case 1:
            retVal = ((Account) o1).getDomainName().compareTo(((Account) o2).getDomainName());
            break;
          case 2:
            retVal =
                ((Account) o1).getAttr(szAttrName).compareTo(((Account) o2).getAttr(szAttrName));
            break;
          default:
            retVal = 0;
            break;
