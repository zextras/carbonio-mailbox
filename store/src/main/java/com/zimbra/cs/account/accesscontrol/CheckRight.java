...
public abstract class CheckRight {
  ...
  protected CheckRight(Entry target, Right rightNeeded, boolean canDelegateNeeded)
    ...
    if ((target instanceof DistributionList)
        && !(target instanceof PseudoTarget.PseudoDistributionList)) {
   ...
   */
  static boolean rightApplicableOnTargetType(
      TargetType targetType, Right rightNeeded, boolean canDelegateNeeded) {
