...
public class LdapProvisioning extends LdapProv implements CacheAwareProvisioning {
  ...
  private static final String[] sInvalidAccountCreateModifyAttrs = {
    Provisioning.A_uid, Provisioning.A_zimbraMailAlias, Provisioning.A_zimbraMailDeliveryAddress,
  };
  ...
  public double getAccountCacheHitRate() {
    return accountCache.getHitRate();
  }

  @Override
  public int getCosCacheSize() {
    return cosCache.getSize();
  }

  @Override
  public double getCosCacheHitRate() {
    return cosCache.getHitRate();
  }

  @Override
  public int getDomainCacheSize() {
    return domainCache.getSize();
  }

  @Override
  public double getDomainCacheHitRate() {
    return domainCache.getHitRate();
  }

  @Override
  public int getServerCacheSize() {
    return serverCache.getSize();
  }
  ...
  /**
   * Modifies this entry. If any of the provided attributes are ephemeral, they will be stored in
   * LDAP instead of routed to EphemeralStore. Used by LdapEphemeralStore.
   *
   * @param e
   * @param attrs
  ...
  public void modifyEphemeralAttrsInLdap(Entry e, Map<String, ? extends Object> attrs)
    ...
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).preModify(attrs, e, callbackContext, false, true);
    modifyAttrsInternal(e, null, attrs, true);
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(attrs, e, callbackContext, true);
  }
   ...
   *
   * <ul>
   *   <li><code>null</code>, in which case the attr is removed
   *   <li>a single <code>Object</code>, in which case the attr is modified based on the object's
   *       <code>toString()</code> value
   *   <li>an <code>Object</code> array or <code>Collection</code>, in which case a multi-valued
   *       attr is updated
   * </ul>
   */
  @Override
  public void modifyAttrs(
      Entry e, Map<String, ? extends Object> attrs, boolean checkImmutable, boolean allowCallback)
      throws ServiceException {
    CallbackContext callbackContext = new CallbackContext(CallbackContext.Op.MODIFY);
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance())
        .preModify(attrs, e, callbackContext, checkImmutable, allowCallback);
    modifyAttrsInternal(e, null, attrs);
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(attrs, e, callbackContext, allowCallback);
  }
  ...
  public void restoreAccountAttrs(Account acct, Map<String, ? extends Object> backupAttrs)
    ...
    for (String oc : ocsInBackup) {
      if (!LdapObjectClassHierarchy.isSuperiorOC(
          this, LdapObjectClass.ZIMBRA_DEFAULT_PERSON_OC, oc)) {
  ...
  protected void modifyAttrsInternal(
      Entry entry, ZLdapContext initZlc, Map<String, ? extends Object> attrs)
      throws ServiceException {
  ...
  protected void modifyAttrsInternal(
      Entry entry,
      ZLdapContext initZlc,
      Map<String, ? extends Object> attrs,
      boolean storeEphemeralInLdap)
      throws ServiceException {
    if (entry instanceof Account && !(entry instanceof CalendarResource)) {
      ...
      validate(
          ...
          acct.getAttr(A_zimbraMailDeliveryAddress),
          attrs,
          acct);
    }
    if (!storeEphemeralInLdap) {
      Map<String, AttributeInfo> ephemeralAttrMap =
          StoreAttributeManager.getInstance().getEphemeralAttrs();
  ...
  private void modifyEphemeralAttrs(
      Entry entry, Map<String, Object> attrs, Map<String, AttributeInfo> ephemeralAttrMap)
      throws ServiceException {
    ...
    for (Map.Entry<String, Object> e : attrs.entrySet()) {
      ...
      if (doAdd || doRemove) {
        ...
        if (attrs.containsKey(key))
          throw ServiceException.INVALID_REQUEST(
              "can't mix +attrName/-attrName with attrName", null);
      }
      ...
      if (ai.isDynamic()) {
        ...
        if (converter == null) {
          ZimbraLog.ephemeral.warn(
              "Dynamic ephemeral attribute %s has no registered AttributeConverter, so cannot be"
                  + " modified with modifyAttrs",
              key);
          continue;
        }
      }
      if (value instanceof Collection) {
        ...
        ZimbraLog.ephemeral.warn(
            "Ephemeral attribute %s doesn't support deletion by key; only deletion by key+value is"
                + " supported",
            key);
      }
    }
  ...
  private void handleEphemeralAttrChange(
      EphemeralStore store,
      String key,
      String value,
      EphemeralLocation location,
      AttributeInfo ai,
    ...
    if (ai.isDynamic()) {
      ...
      if (input == null) {
        ZimbraLog.ephemeral.warn(
            "LDAP-formatted value %s for ephemeral attribute %s cannot be converted to an ephemeral"
                + " input",
            value, key);
        return;
      }
  ...
  void refreshEntry(Entry entry, ZLdapContext initZlc) throws ServiceException {
    ...
    try {
      ...
      if (entry instanceof Account) {
        ...
        if (domain != null) secondaryDefaults = domain.getAccountDefaults();
      ...
      else entry.setAttrs(attrs, defaults, secondaryDefaults, overrideDefaults);
  ...
  public List<MimeTypeInfo> getMimeTypesByQuery(String mimeType) throws ServiceException {
    ...
    try {
      ZSearchResultEnumeration ne =
          helper.searchDir(
              mDIT.mimeBaseDN(),
              filterFactory.mimeEntryByMimeType(mimeType),
  ...
  private ZSearchResultEntry getSearchResultForAccountByQuery(
      String base,
      ZLdapFilter filter,
      ZLdapContext initZlc,
    ...
    try {
      ZSearchResultEntry sr =
          helper.searchForEntry(base, filter, initZlc, loadFromMaster, returnAttrs);
      return sr;
      ...
      throw AccountServiceException.MULTIPLE_ACCOUNTS_MATCHED(
          String.format(
              "multiple entries are returned by query: base=%s, query=%s",
              e.getQueryBase(), e.getQuery()));
    }
  }

  private Account getAccountByQuery(
      String base, ZLdapFilter filter, ZLdapContext initZlc, boolean loadFromMaster)
      throws ServiceException {
    try {
      ZSearchResultEntry sr =
          getSearchResultForAccountByQuery(base, filter, initZlc, loadFromMaster, null);
      if (sr != null) {
        return makeAccount(sr.getDN(), sr.getAttributes());
      }
    } catch (ServiceException e) {
      throw ServiceException.FAILURE(
          "unable to lookup account via query: "
  ...
  public String getDNforAccountById(String zimbraId, ZLdapContext zlc, boolean loadFromMaster) {
    ...
    try {
      String[] retAttrs =
          new String[] {Provisioning.A_zimbraId}; /* Just 1 attr to save bandwidth */
      ZSearchResultEntry sr;
      sr =
          getSearchResultForAccountByQuery(
              mDIT.mailBranchBaseDN(), filter, zlc, loadFromMaster, retAttrs);
      // search again under the admin base if not found and admin base is not under mail base
      if (sr == null && !mDIT.isUnder(mDIT.mailBranchBaseDN(), mDIT.adminBaseDN())) {
        sr =
            getSearchResultForAccountByQuery(
                mDIT.adminBaseDN(), filter, zlc, loadFromMaster, retAttrs);
      }
      if (sr != null) {
        return sr.getDN();
      }
      ...
      ZimbraLog.search.debug(
          "unable to lookup DN for account via query: %s", filter.toFilterString(), e);
    }
    return null;
  }
  ...
  private Account getAccountByForeignPrincipal(String foreignPrincipal, boolean loadFromMaster)
    ...
    // this is so we don't change our caching behavior - the above search was just to check for dup
    // - we did that anyway
  ...
  private String fixupAccountName(String emailAddress) throws ServiceException {
    ...
    if (index == -1) {
      ...
      else emailAddress = emailAddress + "@" + domain;
    } else emailAddress = IDNUtil.toAsciiEmail(emailAddress);
  ...
  private Cos lookupCos(String key, ZLdapContext zlc) throws ServiceException {
    ...
    if (c == null) c = getCosByName(key, zlc);
    if (c == null) throw AccountServiceException.NO_SUCH_COS(key);
    else return c;
  }

  @Override
  public void autoProvAccountEager(EagerAutoProvisionScheduler scheduler) throws ServiceException {
    AutoProvisionEager.handleScheduledDomains(this, scheduler);
  }

  @Override
  public Account autoProvAccountLazy(
      Domain domain, String loginName, String loginPassword, AutoProvAuthMech authMech)
      throws ServiceException {
  ...
  @Override
  public Account autoProvAccountManual(
      Domain domain, AutoProvPrincipalBy by, String principal, String password)
      throws ServiceException {
    AutoProvisionManual autoProv = new AutoProvisionManual(this, domain, by, principal, password);
  ...
  public void searchAutoProvDirectory(
      ...
      throws ServiceException {
    AutoProvision.searchAutoProvDirectory(
        this, domain, filter, name, null, returnAttrs, maxResults, visitor);
  }
  ...
  public Account createAccount(String emailAddress, String password, Map<String, Object> attrs)
    ...
    return createAccount(
        emailAddress, password, attrs, mDIT.handleSpecialAttrs(attrs), null, false, null);
  }
  ...
  public Account restoreAccount(
      ...
      throws ServiceException {
    return createAccount(
        emailAddress, password, attrs, mDIT.handleSpecialAttrs(attrs), null, true, origAttrs);
  }
  ...
  private Account createAccount(
    ...
    if (restoring) {
      validate(
          ProvisioningValidator.CREATE_ACCOUNT, emailAddress, additionalObjectClasses, origAttrs);
      validate(
      ...
      validate(
          ProvisioningValidator.CREATE_ACCOUNT, emailAddress, additionalObjectClasses, acctAttrs);
      validate(
          ProvisioningValidator.CREATE_ACCOUNT_CHECK_DOMAIN_COS_AND_FEATURE,
          emailAddress,
          acctAttrs);
    ...
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).preModify(acctAttrs, null, callbackContext, true);
      ...
      if (cosId != null) {
        ...
        if (cos == null) {
          cos =
              getCosByName(
                  isExternalVirtualAccount(entry)
                      ? Provisioning.DEFAULT_EXTERNAL_COS_NAME
                      : Provisioning.DEFAULT_COS_NAME,
                  zlc);
        }
      }
      ...
      if (entry.hasAttribute(Provisioning.A_zimbraMailHost)
        ...
        throw ServiceException.INVALID_REQUEST(
            "missing "
                ...
                + " or "
                + Provisioning.A_zimbraMailTransport
                + " for CreateAccount: "
                + emailAddress,
            null);
      }
      ...
      if (acct == null) {
        throw ServiceException.FAILURE(
            "unable to get account after creating LDAP account entry: "
                + emailAddress
                + ", check ldap log for possible error",
            null);
      }

      LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(acctAttrs, acct, callbackContext);
      removeExternalAddrsFromAllDynamicGroups(acct.getAllAddrsSet(), zlc);
      validate(
          ProvisioningValidator.CREATE_ACCOUNT_SUCCEEDED,
          emailAddress,
          acct,
          skipCountingLicenseQuota);
      if (password != null) {
  ...
  private boolean isExternalVirtualAccount(ZMutableEntry entry) throws LdapException {
    return entry.hasAttribute(Provisioning.A_zimbraIsExternalVirtualAccount)
        && ProvisioningConstants.TRUE.equals(
            entry.getAttrString(Provisioning.A_zimbraIsExternalVirtualAccount));
  }
  ...
  private void setMailHost(ZMutableEntry entry, Server server, boolean setMailTransport) {
    ...
    if (setMailTransport) {
      int lmtpPort =
          server.getIntAttr(
              Provisioning.A_zimbraLmtpBindPort, com.zimbra.cs.util.Config.D_LMTP_BIND_PORT);
  ...
  private String addMailHost(
      ZMutableEntry entry, String[] mailHostPool, String cosName, boolean setMailTransport)
      throws ServiceException {
  ...
  public void searchAccountsOnServer(
      Server server, SearchAccountsOptions opts, NamedEntry.Visitor visitor)
      throws ServiceException {
  ...
  private List<NamedEntry> searchAccountsOnServerInternal(
      Server server, SearchAccountsOptions options, NamedEntry.Visitor visitor)
      throws ServiceException {
  ...
  public String[] getSearchBases(Domain domain, Set<ObjectType> types) throws ServiceException {
    ...
    if (domain != null) {
      ...
      if (types.contains(ObjectType.domains) || types.contains(ObjectType.habgroups)) {
        domainsTree = true;
      }
      ...
      if (domainsTree && (groupsTree || peopleTree)) {
        throw ServiceException.FAILURE(
            "specifying domains type and one of "
                + "accounts/resources/groups type is not supported by in-memory LDAP server",
            null);
      }
  ...
  private List<NamedEntry> searchDirectoryInternal(
      SearchDirectoryOptions options, NamedEntry.Visitor visitor) throws ServiceException {
  ...
  private static class NamedEntryComparator implements Comparator<NamedEntry> {
    ...
    public int compare(NamedEntry a, NamedEntry b) {
      ...
      if (mByName) comp = a.getName().compareToIgnoreCase(b.getName());
      else {
        String sa = null;
        String sb = null;
  ...
  private static class SearchObjectsVisitor extends SearchLdapVisitor {
    ...
    public void visit(String dn, IAttributes ldapAttrs) {
      try {
        ...
        ZimbraLog.account.warn(
            "entry skipped, encountered error while processing entry at:" + dn, e);
      }
    }
    ...
    private void doVisit(String dn, IAttributes ldapAttrs) throws ServiceException {
      ...
      */
      ...
      // skip admin accounts
      // if we are looking for domains or coses, they can be under config branch in non default DIT
      // impl.
      ...
      if (objectclass == null
          || objectclass.contains(AttributeClass.OC_zimbraAccount)
  ...
  private List<NamedEntry> searchObjects(
    ...
    if (visitor != null) {
      if (opts.getSortOpt() != SortOpt.NO_SORT) {
        throw ServiceException.INVALID_REQUEST(
            "Sorting is not supported with visitor interface", null);
      }
  ...
  private void searchLdapObjects(
    ...
    try {
      ...
      SearchObjectsVisitor searchObjectsVisitor =
          new SearchObjectsVisitor(
              this, zlc, visitor, opts.getMaxResults(), opts.getMakeObjectOpt(), returnAttrs);

      SearchLdapOptions searchObjectsOptions =
          new SearchLdapOptions(
              base,
              filter,
              returnAttrs,
              opts.getMaxResults(),
  ...
  private String[] fixReturnAttrs(String[] returnAttrs, int flags) {
    if (returnAttrs == null || returnAttrs.length == 0) return null;
    ...
    boolean needCn =
        ((flags & Provisioning.SD_COS_FLAG) != 0)
            || ((flags & Provisioning.SD_DYNAMIC_GROUP_FLAG) != 0);
  ...
  private boolean isEntryAlias(ZAttributes attrs) throws ServiceException {
    ...
    if (ocs instanceof String)
      ...
      for (String oc : (String[]) ocs) {
        if (oc.equalsIgnoreCase(AttributeClass.OC_zimbraAlias)) return true;
      }
    }
    return false;
  }
    ...
    try {
      ...
      try {
        ...
        if (targetEntry == null) {
          ...
          if (mailAliases != null
              && mailAliases.contains(alias)
              && mails != null
              && mails.contains(alias)) {
            throw e;
          } else {
            ZimbraLog.account.warn(
                "alias entry exists at "
                    + aliasDn
  ...
  private void removeAliasInternal(NamedEntry entry, String alias) throws ServiceException {
    ...
    try {
      ...
      try {
        ...
        // see if the entry is an alias
        if (!isEntryAlias(aliasAttrs)) throw AccountServiceException.NO_SUCH_ALIAS(alias);
      ...
      if (aliasEntry != null) targetEntry = searchAliasTarget(aliasEntry, false);

      boolean aliasPointsToEntry =
          ((entry != null)
              && (aliasEntry != null)
              && entry.getId().equals(aliasEntry.getAttr(Provisioning.A_zimbraAliasTargetId)));

      boolean aliasPointsToOtherExistingEntry =
          ((aliasEntry != null)
              && (targetEntry != null)
  ...
  public Domain createDomain(String name, Map<String, Object> domainAttrs) throws ServiceException {
    ...
    try {
      ...
      CallbackContext callbackContext = new CallbackContext(CallbackContext.Op.CREATE);
      LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).preModify(domainAttrs, null, callbackContext, true);
      ...
      if (mailStatus == null) entry.setAttr(A_zimbraMailStatus, MAIL_STATUS_ENABLED);
      ...
      LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(domainAttrs, domain, callbackContext);
      return domain;
    ...
    try {
      ...
      if (sr != null) {
        return new LdapDomain(
            sr.getDN(), sr.getAttributes(), getConfig().getDomainDefaults(), this);
      }
    } catch (LdapMultipleEntriesMatchedException e) {
      throw AccountServiceException.MULTIPLE_DOMAINS_MATCHED("getDomainByQuery: " + e.getMessage());
    } catch (ServiceException e) {
      throw ServiceException.FAILURE(
          "unable to lookup domain via query: "
              + filter.toFilterString()
              + " message:"
              + e.getMessage(),
          e);
  ...
  public Domain getDomain(Key.DomainBy keyType, String key, boolean checkNegativeCache)
    ...
    GetFromDomainCacheOption option =
        checkNegativeCache ? GetFromDomainCacheOption.BOTH : GetFromDomainCacheOption.POSITIVE;
  ...
  private Domain getDomainByIdInternal(
      String zimbraId, ZLdapContext zlc, GetFromDomainCacheOption option) throws ServiceException {
    if (zimbraId == null) {
      return null;
    }
   ...
   * @throws ServiceException
   */
  private Domain getDomainByIdFromCache(
      String zimbraId, ZLdapContext zlc, GetFromDomainCacheOption option) {
    if (zimbraId == null) {
      return null;
    }
    Domain d = domainCache.getById(zimbraId, option);
  ...
  private Domain getDomainByAsciiNameInternal(
      String name, ZLdapContext zlc, GetFromDomainCacheOption option) throws ServiceException {
    Domain d = domainCache.getByName(name, option);
    if (d instanceof DomainCache.NonExistingDomain) return null;
  ...
  private Domain getDomainByVirtualHostnameInternal(
      String virtualHostname, GetFromDomainCacheOption option) throws ServiceException {
  ...
  private Domain getDomainByForeignNameInternal(String foreignName, GetFromDomainCacheOption option)
      throws ServiceException {
  ...
  private Domain getDomainByKrb5RealmInternal(String krb5Realm, GetFromDomainCacheOption option)
      throws ServiceException {
    ...
    if (!cacheMisses.isEmpty()) {
      ...
      if (!cacheDomains) {
        ZimbraLog.search.info(
            "localconfig ldap_cache_domain_maxsize=%d < number of domains=%d.  Consider increasing"
                + " it.",
  ...
  private static class AllDomainIdsCollector
      implements BySearchResultEntrySearcher.SearchEntryProcessor {
  ...
  private void createParentDomains(ZLdapContext zlc, String[] parts, String[] dns)
    ...
    for (int i = dns.length - 1; i > 0; i--) {
      if (!domainDnExists(zlc, dns[i])) {
        ...
        zlc.createEntry(
            dn,
            new String[] {"dcObject", "organization"},
  ...
  private Cos copyCos(String srcCosId, String destCosName, Map<String, Object> cosAttrs)
    ...
    if (srcCos == null) throw AccountServiceException.NO_SUCH_COS(srcCosId);
    ...
    for (String attr : allAttrs.keySet()) {
      AttributeInfo info = StoreAttributeManager.getInstance().getAttributeInfo(attr);
      if (info != null && info.isDeprecated()) {
        allNewAttrs.remove(attr);
      }
    }
    allAttrs = allNewAttrs;
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).preModify(allAttrs, null, callbackContext, true);
    ...
    try {
      ...
      LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(allAttrs, cos, callbackContext);
      return cos;
    } catch (LdapEntryAlreadyExistException nabe) {
  ...
  public void renameCos(String zimbraId, String newName) throws ServiceException {
    ...
    if (cos == null) throw AccountServiceException.NO_SUCH_COS(zimbraId);
  ...
  private LdapCos getCOSByQuery(ZLdapFilter filter, ZLdapContext initZlc) throws ServiceException {
    try {
      ...
      throw ServiceException.FAILURE(
          "unable to lookup cos via query: "
              + filter.toFilterString()
              + " message:"
              + e.getMessage(),
          e);
  ...
  private Cos getCosByName(String name, ZLdapContext initZlc) throws ServiceException {
    ...
    if (cos != null) return cos;

    try {
      String dn = mDIT.cosNametoDN(name);
      ZAttributes attrs =
          helper.getAttributes(initZlc, LdapServerType.REPLICA, LdapUsage.GET_COS, dn, null);
      ...
      throw ServiceException.FAILURE(
          "unable to lookup COS by name: " + name + " message: " + e.getMessage(), e);
    }
  }
  ...
  public List<Cos> getAllCos() throws ServiceException {
    ...
    try {
      ZSearchResultEnumeration ne =
          helper.searchDir(
              mDIT.cosBaseDN(), filterFactory.allCoses(), ZSearchControls.SEARCH_CTLS_SUBTREE());
      while (ne.hasMore()) {
        ZSearchResultEntry sr = ne.next();
  ...
  public void deleteAccount(String zimbraId) throws ServiceException {
    ...
    if (acc == null) throw AccountServiceException.NO_SUCH_ACCOUNT(zimbraId);
      ...
      for (String alias : aliases) {
        try {
          ...
          if (AccountServiceException.NO_SUCH_ALIAS.equals(se.getCode())) {
            ZimbraLog.account.warn(
                "got no such alias from removeAlias call when deleting account; likely alias was"
                    + " previously in a bad state");
          } else {
            throw se;
          }
        }
  ...
  public void renameAccount(String zimbraId, String newName) throws ServiceException {
    ...
    if (acct == null) throw AccountServiceException.NO_SUCH_ACCOUNT(zimbraId);
    ...
    try {
      ...
      if (domainChanged) {
        validate(
            ProvisioningValidator.RENAME_ACCOUNT,
            newName,
            acct.getMultiAttr(Provisioning.A_objectClass, false),
            acct.getAttrs(false));
        validate(
      ...
      ReplaceAddressResult replacedMails =
          replaceMailAddresses(acct, Provisioning.A_mail, oldEmail, newName);
      ...
      ReplaceAddressResult replacedAliases =
          replaceMailAddresses(acct, Provisioning.A_zimbraMailAlias, oldEmail, newName);
      ...
      ReplaceAddressResult replacedAllowAddrForDelegatedSender =
          replaceMailAddresses(
              acct, Provisioning.A_zimbraPrefAllowAddressForDelegatedSender, oldEmail, newName);
      ...
      if (newAttrs.get(Provisioning.A_displayName) == null
          && oldLocal.equals(newAttrs.get(Provisioning.A_cn)))
      ...
      */
      ...
      if (dnChanged) {
        ...
        acct =
            getAccountByQuery(
                mDIT.mailBranchBaseDN(), filterFactory.accountById(zimbraId), zlc, true);
        if (acct == null) {
  ...
  public List<String> getEmptyAliasDomainIds(
    ...
    try {
      ...
      ne =
          helper.searchDir(
              mDIT.domainBaseDN(),
              filterFactory.domainAliases(targetDomain.getId()),
              searchControls,
              zlc,
              LdapServerType.MASTER);
      ...
      while (ne.hasMore()) {
        ...
        if (subordinateCheck
            && (hasSubordinates(zlc, acctBaseDn) || hasSubordinates(zlc, dynGroupsBaseDn))) {
          throw ServiceException.FAILURE(
              "alias domain "
                  + aliasDomainName
                  + " of domain "
  ...
  public void deleteDomainInternal(ZLdapContext zlc, String zimbraId) throws ServiceException {
    ...
    try {
      ...
      SearchLdapOptions.SearchLdapVisitor visitor =
          new SearchLdapOptions.SearchLdapVisitor() {
            @Override
      ...
      try {
        ...
        ZimbraLog.account.warn(
            "unable to get sample entries in non-empty domain "
                + domain.getName()
                + " for reporting",
            se);
      }
  ...
  public void renameDomain(String zimbraId, String newDomainName) throws ServiceException {
    ...
    try {
      ...
      RenameDomain.RenameDomainLdapHelper helper =
          new RenameDomain.RenameDomainLdapHelper(this, zlc) {
            ...
            public Account getAccountById(String id) throws ServiceException {
              ...
              return ((LdapProvisioning) mProv)
                  .getAccountByQuery(
                      mProv.getDIT().mailBranchBaseDN(),
                      ZLdapFilterFactory.getInstance().accountById(id),
                      toZLdapContext(),
                      true);
            }
            ...
            public DynamicGroup getDynamicGroupById(String id) throws ServiceException {
              // note: we do NOT want to get a cahed entry
              return ((LdapProvisioning) mProv)
                  .getDynamicGroupByQuery(
                      filterFactory.dynamicGroupById(id), toZLdapContext(), false);
            }
      ...
      if (oldDomain == null) throw AccountServiceException.NO_SUCH_DOMAIN(zimbraId);
  ...
  public void deleteCos(String zimbraId) throws ServiceException {
    ...
    if (c == null) throw AccountServiceException.NO_SUCH_COS(zimbraId);
  ...
  public ShareLocator createShareLocator(String id, Map<String, Object> attrs)
      throws ServiceException {
    CallbackContext callbackContext = new CallbackContext(CallbackContext.Op.CREATE);
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).preModify(attrs, null, callbackContext, true);
    ...
    try {
      ...
      LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(attrs, shloc, callbackContext);
      return shloc;
  ...
  public void deleteShareLocator(String id) throws ServiceException {
    ...
    if (shloc == null) throw AccountServiceException.NO_SUCH_SHARE_LOCATOR(id);
  ...
  public Server createServer(String name, Map<String, Object> serverAttrs) throws ServiceException {
    ...
    CallbackContext callbackContext = new CallbackContext(CallbackContext.Op.CREATE);
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).preModify(serverAttrs, null, callbackContext, true);
    ...
    try {
      ...
      LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(serverAttrs, server, callbackContext);
      return server;
    ...
    try {
      ...
      if (sr != null) {
        return new LdapServer(
            sr.getDN(), sr.getAttributes(), getConfig().getServerDefaults(), this);
      }
    } catch (LdapMultipleEntriesMatchedException e) {
      throw AccountServiceException.MULTIPLE_ENTRIES_MATCHED("getServerByQuery", e);
    } catch (ServiceException e) {
      throw ServiceException.FAILURE(
          "unable to lookup server via query: "
              + filter.toFilterString()
              + " message:"
              + e.getMessage(),
          e);
  ...
  private Server getServerById(String zimbraId, ZLdapContext zlc, boolean nocache)
    ...
    if (zimbraId == null) return null;
    Server s = null;
    if (!nocache) s = serverCache.getById(zimbraId);
    if (s == null) {
  ...
  private ShareLocator getShareLocatorByQuery(ZLdapFilter filter, ZLdapContext initZlc)
    ...
    try {
      ZSearchResultEntry sr =
          helper.searchForEntry(mDIT.shareLocatorBaseDN(), filter, initZlc, false);
      if (sr != null) {
      ...
      throw ServiceException.FAILURE(
          "unable to lookup share locator via query: "
              + filter.toFilterString()
              + " message:"
              + e.getMessage(),
          e);
  ...
  private ShareLocator getShareLocatorById(String id, ZLdapContext zlc, boolean nocache)
    ...
    if (!nocache) shloc = shareLocatorCache.getById(id);
    if (shloc == null) {
  ...
  private Server getServerByName(String name, boolean nocache) throws ServiceException {
    ...
    try {
      ...
      throw ServiceException.FAILURE(
          "unable to lookup server by name: " + name + " message: " + e.getMessage(), e);
    }
  }
  ...
  public void deleteServer(String zimbraId) throws ServiceException {
    ...
    if (server == null) throw AccountServiceException.NO_SUCH_SERVER(zimbraId);

    // check that no account is still on this server
    long numAcctsOnServer = getNumAccountsOnServer(server);
    if (numAcctsOnServer != 0) {
      throw ServiceException.INVALID_REQUEST(
          "There are " + numAcctsOnServer + " account(s) on this server.", null);
    }
  ...
  private DistributionList createDistributionList(
      String listAddress, Map<String, Object> listAttrs, Account creator) throws ServiceException {
    ...
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).preModify(listAttrs, null, callbackContext, true);
    ...
    try {
      ...
      entry.setDN(
              mDIT.distributionListDNCreate(baseDn, entry.getAttributes(), localPart, domain));
      ...
      if (dlist != null) {
        LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(listAttrs, dlist, callbackContext);
        removeExternalAddrsFromAllDynamicGroups(dlist.getAllAddrsSet(), zlc);
        allDLs.addGroup(dlist);
      } else {
        throw ServiceException.FAILURE(
            "unable to get distribution list after creating LDAP entry: " + listAddress, null);
      }
      return dlist;
  ...
  private DistributionList getDistributionListByQuery(
      String base, ZLdapFilter filter, ZLdapContext initZlc, boolean basicAttrsOnly)
      throws ServiceException {
    ...
    try {
      ...
      ZSearchResultEnumeration ne =
          helper.searchDir(base, filter, searchControls, initZlc, LdapServerType.REPLICA);
      if (ne.hasMore()) {
        ZSearchResultEntry sr = ne.next();
      ...
      throw ServiceException.FAILURE(
          "unable to lookup distribution list via query: "
              + filter.toFilterString()
              + " message: "
              + e.getMessage(),
          e);
  ...
  public void renameDistributionList(String zimbraId, String newEmail) throws ServiceException {
    ...
    try {
      ...
      if (parts == null) throw ServiceException.INVALID_REQUEST("bad value for newName", null);
      String newLocal = parts[0];
      String newDomain = parts[1];
      ...
      ReplaceAddressResult replacedAliases =
          replaceMailAddresses(dl, Provisioning.A_zimbraMailAlias, oldEmail, newEmail);
      if (replacedAliases.newAddrs().length > 0) {
        attrs.put(Provisioning.A_zimbraMailAlias, replacedAliases.newAddrs());

        String newDomainDN = mDIT.domainToAccountSearchDN(newDomain);

        // check up front if any of renamed aliases already exists in the new domain (if domain also
        // got changed)
      ...
      ReplaceAddressResult replacedAllowAddrForDelegatedSender =
          replaceMailAddresses(
              dl, Provisioning.A_zimbraPrefAllowAddressForDelegatedSender, oldEmail, newEmail);
      if (replacedAllowAddrForDelegatedSender.newAddrs().length > 0) {
        attrs.put(
            Provisioning.A_zimbraPrefAllowAddressForDelegatedSender,
            replacedAllowAddrForDelegatedSender.newAddrs());
      ...
      try {
        ...
        ZimbraLog.account.error(
            "distribution list renamed to "
                + newLocal
                + " but failed to move old name's LDAP attributes",
            e);
        throw e;
      }
  ...
  private DistributionList getDistributionListById(String zimbraId, ZLdapContext zlc)
    ...
    return getDistributionListByQuery(
        mDIT.mailBranchBaseDN(), filterFactory.distributionListById(zimbraId), zlc, false);
  }
  ...
  private void deleteDistributionList(LdapDistributionList dl, boolean cascadeDelete)
      throws ServiceException {
  ...
  private DistributionList getDistributionListByNameInternal(String listAddress)
    ...
    return getDistributionListByQuery(
        mDIT.mailBranchBaseDN(), filterFactory.distributionListByName(listAddress), null, false);
  }
   ...
   * @return Groups which {@code acct} is a member of which have been granted one or more or the
   *     {@code rights}
   */
  @Override
  public GroupMembership getGroupMembershipWithRights(
      Account acct, Set<Right> rights, boolean adminGroupsOnly) throws ServiceException {
    SearchForGroupsWithRightsVisitor visitor = new SearchForGroupsWithRightsVisitor(rights);
    Set<String> groupsWithRights =
        searchForGroupsWhichUseRights(getDIT().zimbraBaseDN(), rights, visitor);
  ...
  /**
   * Visits entries which have zimbraACE Mine search results for groups which have been assigned
   * certain rights
   */
   ...
   * @throws ServiceException
   */
  private Set<String> searchForGroupsWhichUseRights(
      String base, Set<Right> rights, SearchForGroupsWithRightsVisitor visitor)
      throws ServiceException {
    ...
    if ((rights == null) || rights.isEmpty()) {
      ...
      for (Right right : rights) {
        query
            .append('(')
            .append(Provisioning.A_zimbraACE)
            .append('=')
            .append("* grp ")
  ...
  private GroupMembership setupGroupedEntryCacheData(Account acct, boolean adminGroupsOnly)
    ...
    groups =
        LdapDynamicGroup.updateGroupMembershipForDynamicGroups(
            this,
            groups,
            acct,
            allGroupIDs,
            false /* adminGroupsOnly - false because need them all for the cache */,
            false /* customGroupsOnly */,
            true /* nonCustomGroupsOnly */);

    GroupMembership customMembership =
        getCustomDynamicGroupMembership(acct, false /* need them all for cache */);
  ...
  private void checkAccountStatus(Account acct, Map<String, Object> authCtxt, boolean ignoreLockout)
    ...
    if (accountStatus == null) {
      throw AuthFailedServiceException.AUTH_FAILED(
          acct.getName(), AuthMechanism.namePassedIn(authCtxt), "missing account status");
    }
    ...
    if (!ignoreLockout
        && !(accountStatus.equals(Provisioning.ACCOUNT_STATUS_ACTIVE)
            || accountStatus.equals(Provisioning.ACCOUNT_STATUS_LOCKOUT))) {
      throw AuthFailedServiceException.AUTH_FAILED(
          acct.getName(),
          AuthMechanism.namePassedIn(authCtxt),
          "account(or domain) status is " + accountStatus);
    }
  }

  @Override
  public void preAuthAccount(
      Account acct,
      String acctValue,
      String acctBy,
      long timestamp,
  ...
  public void preAuthAccount(
    ...
    ZimbraLog.security.info(
        ZimbraLog.encodeAttrs(new String[] {"cmd", "PreAuth", "account", acctValue}));
  }

  private void verifyPreAuth(
      Account acct,
      String acctValue,
      String acctBy,
      long timestamp,
  ...
  void verifyPreAuth(
    ...
    if (!computedPreAuth.equalsIgnoreCase(preAuth)) {
      throw AuthFailedServiceException.AUTH_FAILED(
          acctNameForLogging, AuthMechanism.namePassedIn(authCtxt), "preauth mismatch");
    }
  }
  ...
  private void preAuth(
    ...
    try {
      if (lockoutPolicy.isLockedOut()) {
        throw AuthFailedServiceException.AUTH_FAILED(
            acct.getName(), AuthMechanism.namePassedIn(authCtxt), "account lockout");
      }
  ...
  public void authAccount(
      Account acct, String password, AuthContext.Protocol proto, Map<String, Object> authCtxt)
      throws ServiceException {
    try {
      ...
      ZimbraLog.security.info(
          ZimbraLog.encodeAttrs(
              new String[] {
                "cmd", "Auth", "account", acct.getName(), "protocol", proto.toString()
              }));
    } catch (AuthFailedServiceException e) {
      ZimbraLog.security.warn(
          ZimbraLog.encodeAttrs(
  ...
  private void authAccount(
      Account acct, String password, boolean checkPasswordPolicy, Map<String, Object> authCtxt)
      throws ServiceException {
    checkAccountStatus(acct, authCtxt);
    ...
    if (authMech.checkPasswordAging()) {
      ...
      if (maxAge > 0) {
        Date lastChange =
            acct.getGeneralizedTimeAttr(Provisioning.A_zimbraPasswordModifiedTime, null);
        if (lastChange != null) {
      ...
      if (mustChange) throw AccountServiceException.CHANGE_PASSWORD();
    }
  ...
  private void recoveryCodeBasedAuthAccount(
      Account acct, String recoveryCode, Map<String, Object> authCtxt) throws ServiceException {
    ...
    if (AccountStatus.lockout.equals(acct.getAccountStatus())) {
      ...
      ZimbraLog.security.info(
          ZimbraLog.encodeAttrs(
              new String[] {
                "cmd", "Auth", "account", acct.getName(), "mode", "recoveryCode - account unlocked"
              }));
    } else {
      ZimbraLog.security.info(
          ZimbraLog.encodeAttrs(
              new String[] {"cmd", "Auth", "account", acct.getName(), "mode", "recoveryCode"}));
    }
    updateLastLogon(acct);
  }
  ...
  private void reportException(Account acct, String message, Map<String, Object> authCtxt)
    ...
    ZimbraLog.security.warn(
        ZimbraLog.encodeAttrs(
            new String[] {"cmd", "Auth", "account", acct.getName(), "error", message}));
    throw AuthFailedServiceException.AUTH_FAILED(
        acct.getName(), AuthMechanism.namePassedIn(authCtxt), message);
  }
  ...
  private void verifyRecoveryCode(Account acct, String recoveryCode, Map<String, Object> authCtxt)
    ...
    String lockoutMsg =
        AccountStatus.lockout.equals(acct.getAccountStatus()) ? " - account lockout" : "";
    if (codeMap == null) {
    ...
    if (recoveryCode.equals(code)) {
      ...
      if (StringUtils.isEmpty(expiryTimeStr)) {
        reportException(
            acct, "invalid recovery code map, expiry time not found" + lockoutMsg, authCtxt);
      }
  ...
  public void ssoAuthAccount(Account acct, AuthContext.Protocol proto, Map<String, Object> authCtxt)
    ...
    try {
      ...
      ZimbraLog.security.info(
          ZimbraLog.encodeAttrs(
              new String[] {
                "cmd", "SSOAuth", "account", acct.getName(), "protocol", proto.toString()
              }));
    } catch (AuthFailedServiceException e) {
      ZimbraLog.security.warn(
          ZimbraLog.encodeAttrs(
  ...
  private void ldapAuthenticate(
    ...
    if (password == null || password.equals("")) {
      AuthFailedServiceException afe =
          AccountServiceException.AuthFailedServiceException.AUTH_FAILED("empty password");
  ...
  private void ldapAuthenticate(
    ...
    ExternalLdapConfig config =
        new ExternalLdapConfig(
            url, wantStartTLS, null, searchDn, searchPassword, null, "external LDAP auth");
    ...
    if (tooMany != null) {
      ZimbraLog.account.warn(
          String.format(
              "ldapAuthenticate searchFilter returned more then one result: (dn1=%s, dn2=%s,"
                  + " filter=%s)",
              resultDn, tooMany, searchFilter));
      AuthFailedServiceException afse =
          AccountServiceException.AuthFailedServiceException.AUTH_FAILED(
              "too many results from search filter!");
      AuthListener.invokeOnException(afse);
      throw afse;
    } else if (resultDn == null) {
      AuthFailedServiceException afse =
          AccountServiceException.AuthFailedServiceException.AUTH_FAILED("empty search");
      AuthListener.invokeOnException(afse);
      throw afse;
    }
  ...
  public Provisioning.Result checkAuthConfig(Map attrs, String name, String password)
      throws ServiceException {
    AuthMech mech =
        AuthMech.fromString(Check.getRequiredAttr(attrs, Provisioning.A_zimbraAuthMech));
    ...
    boolean requireStartTLS =
        startTLSEnabled == null ? false : ProvisioningConstants.TRUE.equals(startTLSEnabled);
    ...
    try {
      ...
      if (searchFilter != null) {
        ...
        ldapAuthenticate(
            url, requireStartTLS, password, searchBase, searchFilter, searchDn, searchPassword);
      ...
      throw ServiceException.INVALID_REQUEST(
          "must specify "
              + Provisioning.A_zimbraAuthLdapSearchFilter
              + " or "
              + Provisioning.A_zimbraAuthLdapBindDn,
          null);
    } catch (ServiceException e) {
      return toResult(e, "");
    }
  ...
  public Provisioning.Result checkGalConfig(Map attrs, String query, int limit, GalOp galOp)
    ...
    try {
      ...
      if (galOp == GalOp.autocomplete)
        result =
            LdapGalSearch.searchLdapGal(
                galParams, GalOp.autocomplete, query, limit, rules, null, null);
      else if (galOp == GalOp.search)
        result =
            LdapGalSearch.searchLdapGal(galParams, GalOp.search, query, limit, rules, null, null);
      else if (galOp == GalOp.sync)
        result = LdapGalSearch.searchLdapGal(galParams, GalOp.sync, query, limit, rules, "", null);
      else throw ServiceException.INVALID_REQUEST("invalid GAL op: " + galOp.toString(), null);
  ...
  @Override
  public void externalLdapAuth(
      Domain domain, AuthMech authMech, Account acct, String password, Map<String, Object> authCtxt)
      throws ServiceException {
  ...
  @Override
  public void externalLdapAuth(
      Domain d, AuthMech authMech, String principal, String password, Map<String, Object> authCtxt)
      throws ServiceException {
    externalLdapAuth(d, authMech, null, principal, password, authCtxt);
  }

  void externalLdapAuth(
      Domain d,
      AuthMech authMech,
      Account acct,
      String principal,
    ...
    try {
      ...
      AuthFailedServiceException afse =
          AuthFailedServiceException.AUTH_FAILED(
              principal,
              AuthMechanism.namePassedIn(authCtxt),
              "external LDAP auth failed, " + e.getMessage(),
              e);
      AuthListener.invokeOnException(afse);
      throw afse;
    }
    ...
    String msg =
        "one of the following attrs must be set "
            + Provisioning.A_zimbraAuthLdapBindDn
            + ", "
            + Provisioning.A_zimbraAuthLdapSearchFilter;
    ZimbraLog.account.fatal(msg);
  ...
  private void verifyPassword(
      Account acct, String password, AuthMechanism authMech, Map<String, Object> authCtxt)
      throws ServiceException {
    synchronized (acct) {
   ...
   */
  private void verifyPasswordInternal(
      ...
      try {
        ...
        ZimbraLog.account.warn(
            authMech.getMechanism()
                + " auth for domain "
                + domain.getName()
                + " failed, fall back to zimbra default auth mechanism",
            e);
      }
      ...
      if (sepIndex != -1) {
        ...
        if (PasswordUtil.SSHA.isSSHA(encoded)) {
          ...
          ZimbraLog.account.debug(
              "password hash neither SSHA nor SSHA512; ignored for password history");
        }
      }
    }
  }
  ...
  public SetPasswordResult setPassword(
      Account acct, String newPassword, boolean enforcePasswordPolicy) throws ServiceException {
  ...
  /**
   * called to check password strength. Should pass in either an Account, or Cos/Attributes (during
   * creation).
   *
   * @param password
   * @param acct
  ...
  private void checkPasswordStrength(String password, Account acct, Cos cos, ZMutableEntry entry)
    ...
    int minPunctuation =
        getInt(acct, cos, entry, Provisioning.A_zimbraPasswordMinPunctuationChars, 0);
    ...
    if (allowedChars != null) {
      try {
        ...
        throw AccountServiceException.INVALID_PASSWORD(
            Provisioning.A_zimbraPasswordAllowedChars + " is not valid regex: " + e.getMessage());
      }
    }
    ...
    String allowedPuncChars =
        getString(acct, cos, entry, Provisioning.A_zimbraPasswordAllowedPunctuationChars);
    ...
    if (allowedPuncChars != null) {
      try {
        ...
        throw AccountServiceException.INVALID_PASSWORD(
            Provisioning.A_zimbraPasswordAllowedPunctuationChars
                + " is not valid regex: "
                + e.getMessage());
      }
    }
    ...
    boolean hasPolicies =
        minUpperCase > 0
            ...
            || minAlpha > 0
            || minNumOrPunc > 0
            || allowedCharsPattern != null
            || allowedPuncCharsPattern != null;
    ...
    for (int i = 0; i < password.length(); i++) {
      ...
      if (allowedCharsPattern != null) {
        if (!allowedCharsPattern.matcher(Character.toString(ch)).matches()) {
          throw AccountServiceException.INVALID_PASSWORD(
              ch + " is not an allowed character",
              new Argument(
                  Provisioning.A_zimbraPasswordAllowedChars, allowedChars, Argument.Type.STR));
        }
      }
    ...
    if (upper < minUpperCase) {
      throw AccountServiceException.INVALID_PASSWORD(
          ...
          new Argument(
              Provisioning.A_zimbraPasswordMinUpperCaseChars, minUpperCase, Argument.Type.NUM));
    }
    if (lower < minLowerCase) {
      throw AccountServiceException.INVALID_PASSWORD(
          "not enough lower case characters",
          new Argument(
              Provisioning.A_zimbraPasswordMinLowerCaseChars, minLowerCase, Argument.Type.NUM));
    }
    if (numeric < minNumeric) {
      throw AccountServiceException.INVALID_PASSWORD(
          "not enough numeric characters",
          new Argument(
              Provisioning.A_zimbraPasswordMinNumericChars, minNumeric, Argument.Type.NUM));
    }
    if (punctuation < minPunctuation) {
      throw AccountServiceException.INVALID_PASSWORD(
          "not enough punctuation characters",
          new Argument(
              Provisioning.A_zimbraPasswordMinPunctuationChars, minPunctuation, Argument.Type.NUM));
    }
    if (alpha < minAlpha) {
      throw AccountServiceException.INVALID_PASSWORD(
    ...
    if (numeric + punctuation < minNumOrPunc) {
      throw AccountServiceException.INVALID_PASSWORD(
          "not enough numeric or punctuation characters",
          new Argument(
              Provisioning.A_zimbraPasswordMinDigitsOrPuncs, minNumOrPunc, Argument.Type.NUM));
    }
  }
  ...
  void setPassword(Account acct, String newPassword, boolean enforcePolicy, boolean dryRun)
    ...
    if (mustChange) attrs.put(Provisioning.A_zimbraPasswordMustChange, "");
    ...
    acct.setAuthTokenValidityValue(
        tokenValidityValue == Integer.MAX_VALUE ? 0 : tokenValidityValue + 1, attrs);

    ChangePasswordListener.ChangePasswordListenerContext ctxts =
        new ChangePasswordListener.ChangePasswordListenerContext();
  ...
  public Zimlet createZimlet(String name, Map<String, Object> zimletAttrs) throws ServiceException {
    ...
    CallbackContext callbackContext = new CallbackContext(CallbackContext.Op.CREATE);
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).preModify(zimletAttrs, null, callbackContext, true);
    ...
    try {
      ...
      LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(zimletAttrs, zimlet, callbackContext);
      return zimlet;
    } catch (LdapEntryAlreadyExistException nabe) {
  ...
  public CalendarResource createCalendarResource(
    ...
    calResAttrs.put(
        Provisioning.A_zimbraAccountCalendarUserType, AccountCalendarUserType.RESOURCE.toString());
    ...
    Account acct =
        createAccount(
            ...
            calResAttrs,
            specialAttrs,
            ocs.toArray(new String[0]),
            false,
            null);

    LdapCalendarResource resource =
        (LdapCalendarResource) getCalendarResourceById(acct.getId(), true);
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(calResAttrs, resource, callbackContext);
    return resource;
  }
  ...
  private CalendarResource getCalendarResourceByForeignPrincipal(
      String foreignPrincipal, boolean loadFromMaster) throws ServiceException {
    LdapCalendarResource resource =
        (LdapCalendarResource)
            getAccountByQuery(
                mDIT.mailBranchBaseDN(),
  ...
  private Account makeAccount(String dn, ZAttributes attrs, MakeObjectOpt makeObjOpt)
    ...
    boolean isAccount =
        (userType == null) || userType.equals(AccountCalendarUserType.USER.toString());

    String emailAddress = attrs.getAttrString(Provisioning.A_zimbraMailDeliveryAddress);
    if (emailAddress == null) emailAddress = mDIT.dnToEmail(dn, attrs);

    Account acct =
        (isAccount)
            ? new LdapAccount(dn, emailAddress, attrs, null, this)
  ...
  /**
   * Note - can be a bit expensive (because of loading the units) if called for a lot of groups.
   * Some LDAP search code uses this to return NamedEntry hits which happen to be Dynamic groups.
   */
  private DynamicGroup makeDynamicGroup(ZLdapContext initZlc, String dn, ZAttributes attrs)
    ...
    if (!group.isMembershipDefinedByCustomURL()) {
      ...
      ZAttributes dynamicUnitAttrs =
          helper.getAttributes(
              initZlc, LdapServerType.REPLICA, LdapUsage.GET_GROUP_UNIT, dynamicUnitDN, null);

      LdapDynamicGroup.DynamicUnit dynamicUnit =
          new LdapDynamicGroup.DynamicUnit(
      ...
      ZAttributes staticUnitAttrs =
          helper.getAttributes(
              initZlc, LdapServerType.REPLICA, LdapUsage.GET_GROUP_UNIT, staticUnitDN, null);

      LdapDynamicGroup.StaticUnit staticUnit =
          new LdapDynamicGroup.StaticUnit(
    ...
    for (String oldAddress : changedPairs.keySet()) {
      ...
      for (DistributionList list : lists) {
        ...
        try {
          ...
          ZimbraLog.account.warn(
              "unable to rename " + oldAddress + " to " + newAddress + " in DL " + list.getName(),
              se);
        }
      }
    }
  ...
  /**
   * called when an account is being deleted or status being set to closed. swallows all exceptions
   * (logs warnings).
   */
  ...
  /**
   * - Get list of ids from EntryCacheDataKey.GROUPEDENTRY_DIRECT_GROUPIDS for "entry" - Entry not
   * cached: - Get all addresses of this entry that can be identified as a member in a static group.
   * - Get direct groups for those addresses using filterFactory.distributionListsByMemberAddrs i.e.
   * using an OR filter on Provisioning.A_zimbraMailForwardingAddress - See if prov's Group Cache
   * has this group already. If so, use that! otherwise add it - Put list of ids to
   * EntryCacheDataKey.GROUPEDENTRY_DIRECT_GROUPIDS for "entry" - Entry is cached: - Get all the
   * direct groups. If any have been deleted, update the cache to reflect that
   *
   * @param prov
   * @param entry
   * @return
  ...
  private DistributionList getDLBasic(Key.DistributionListBy keyType, String key, ZLdapContext zlc)
    ...
    switch (keyType) {
      case id:
        dl =
            getDistributionListByQuery(
                mDIT.mailBranchBaseDN(), filterFactory.distributionListById(key), zlc, true);
        break;
      case name:
        dl =
            getDistributionListByQuery(
                mDIT.mailBranchBaseDN(), filterFactory.distributionListByName(key), zlc, true);
        break;
      default:
        return null;
    }
  ...
  @Override
  public List<AddressListInfo> getAllAddressLists(Domain domain, boolean activeOnly)
      throws ServiceException {
    LdapEntry ldapEntry =
        (LdapEntry) (domain instanceof LdapEntry ? domain : getDomainById(domain.getId()));
    if (ldapEntry == null) {
      throw AccountServiceException.NO_SUCH_DOMAIN(domain.getName());
    }

    List<AddressListInfo> result =
        getAddressListByQuery(ldapEntry.getDN(), filterFactory.allAddressLists(), activeOnly);
    result = Collections.unmodifiableList(result);
    return result;
  }

  private List<AddressListInfo> getAddressListByQuery(
      String base, ZLdapFilter filter, boolean activeOnly) throws ServiceException {
  ...
  private List<AddressListInfo> getAddressListByQuery(
    ...
    try {
      ZSearchResultEnumeration ne =
          helper.searchDir(
              base, filter, ZSearchControls.SEARCH_CTLS_SUBTREE(), null, LdapServerType.REPLICA);
      while (ne.hasMore()) {
        ZSearchResultEntry sr = ne.next();
        if (getDN) {
          ...
          if (attrs != null) {
            boolean active =
                Boolean.parseBoolean(attrs.getAttrString(Provisioning.A_zimbraIsAddressListActive));
      ...
      throw ServiceException.FAILURE(
          "unable to lookup address lists via query: "
              + filter.toFilterString()
              + " message: "
              + e.getMessage(),
          e);
  ...
  private AddressListInfo getAddressListById(String zimbraId) throws ServiceException {
    ...
    List<AddressListInfo> adlList =
        getAddressListByQuery(
            mDIT.mailBranchBaseDN(), filterFactory.addressListById(zimbraId), false, true);
    if (adlList.size() != 0) {
      adl = adlList.get(0);
    }
    return adl;
  ...
  @Override
  public SearchGalResult autoCompleteGal(
      Domain domain, String query, GalSearchType type, int limit, GalContact.Visitor visitor)
      throws ServiceException {
  ...
  @Override
  public SearchGalResult searchGal(
      Domain domain, String query, GalSearchType type, int limit, GalContact.Visitor visitor)
      throws ServiceException {
    SearchGalResult searchResult = SearchGalResult.newSearchGalResult(visitor);
  ...
  @Override
  public SearchGalResult searchGal(
      Domain d, String n, GalSearchType type, GalMode galMode, String token)
      throws ServiceException {
    return searchGal(d, n, type, galMode, token, null);
  }

  private SearchGalResult searchGal(
      Domain d,
      String n,
      GalSearchType type,
      GalMode galMode,
    ...
    int maxResults =
        token != null
            ? 0
            : d.getIntAttr(Provisioning.A_zimbraGalMaxResults, DEFAULT_GAL_MAX_RESULTS);
    ...
    GalMode mode =
        galMode != null ? galMode : GalMode.fromString(d.getAttr(Provisioning.A_zimbraGalMode));
    ...
    if (results == null)
      results = SearchGalResult.newSearchGalResult(visitor); // should really not be null by now

    if (type == GalSearchType.all) {
      SearchGalResult resourceResults = null;
      if (maxResults == 0) resourceResults = searchResourcesGal(d, n, 0, token, galOp, visitor);
      else {
        int room = maxResults - results.getNumMatches();
        if (room > 0) resourceResults = searchResourcesGal(d, n, room, token, galOp, visitor);
      }
      if (resourceResults != null) {
        results.addMatches(resourceResults);
        results.setToken(
            LdapUtil.getLaterTimestamp(results.getToken(), resourceResults.getToken()));
      }
    }
  ...
  public static String getFilterDef(String name) throws ServiceException {
    ...
    if (queryExpr == null)
      ZimbraLog.gal.warn(
          "missing filter def " + name + " in " + Provisioning.A_zimbraGalLdapFilterDef);
  ...
  private SearchGalResult searchResourcesGal(
      Domain d, String n, int maxResults, String token, GalOp galOp, GalContact.Visitor visitor)
      throws ServiceException {
    return searchZimbraWithNamedFilter(
        d,
        galOp,
        GalNamedFilter.getZimbraCalendarResourceFilter(galOp),
        n,
        maxResults,
        token,
        visitor);
  ...
  private SearchGalResult searchGroupsGal(
      Domain d, String n, int maxResults, String token, GalOp galOp, GalContact.Visitor visitor)
      throws ServiceException {
    return searchZimbraWithNamedFilter(
        d, galOp, GalNamedFilter.getZimbraGroupFilter(galOp), n, maxResults, token, visitor);
  }

  private SearchGalResult searchZimbraGal(
      Domain d, String n, int maxResults, String token, GalOp galOp, GalContact.Visitor visitor)
      throws ServiceException {
    return searchZimbraWithNamedFilter(
        d, galOp, GalNamedFilter.getZimbraAcountFilter(galOp), n, maxResults, token, visitor);
  }
  ...
  private SearchGalResult searchLdapGal(
      Domain domain,
      String n,
      int maxResults,
      String token,
    ...
    try {
      return LdapGalSearch.searchLdapGal(galParams, galOp, n, maxResults, rules, token, visitor);
    } catch (ServiceException e) {
  ...
  private void addDistributionListMembers(DistributionList dl, String[] members)
    ...
    for (String member : members) {
      ...
      if (dynMember != null) {
        throw ServiceException.INVALID_REQUEST(
            "Cannot add dynamic group as a member: " + memberName, null);
      }
  ...
  private AddrsOfEntry getAllAddressesOfEntry(String name) {
    ...
    if (primary != null) addrs.setPrimary(primary);
    if (aliases != null) addrs.addAll(aliases);
  ...
  private List<Identity> getIdentitiesByQuery(
    ...
    try {
      ...
      ZSearchResultEnumeration ne =
          helper.searchDir(
              base, filter, ZSearchControls.SEARCH_CTLS_SUBTREE(), initZlc, LdapServerType.REPLICA);
      while (ne.hasMore()) {
        ZSearchResultEntry sr = ne.next();
      ...
      throw ServiceException.FAILURE(
          "unable to lookup identity via query: "
              + filter.toFilterString()
              + " message: "
              + e.getMessage(),
          e);
  ...
  private Identity getIdentityByName(LdapEntry entry, String name, ZLdapContext zlc)
      throws ServiceException {
  ...
  private void validateIdentityAttrs(Map<String, Object> attrs) throws ServiceException {
    Set<String> validAttrs =
        StoreAttributeManager.getInstance().getLowerCaseAttrsInClass(AttributeClass.identity);
  ...
  public Identity createIdentity(
      Account account, String identityName, Map<String, Object> identityAttrs)
      throws ServiceException {
    return createIdentity(account, identityName, identityAttrs, false);
  }

  @Override
  public Identity restoreIdentity(
      Account account, String identityName, Map<String, Object> identityAttrs)
      throws ServiceException {
  ...
  private Identity createIdentity(
      Account account, String identityName, Map<String, Object> identityAttrs, boolean restoring)
      throws ServiceException {
    removeAttrIgnoreCase("objectclass", identityAttrs);
    validateIdentityAttrs(identityAttrs);

    LdapEntry ldapEntry =
        (LdapEntry) (account instanceof LdapEntry ? account : getAccountById(account.getId()));

    if (ldapEntry == null) throw AccountServiceException.NO_SUCH_ACCOUNT(account.getName());
    ...
    CallbackContext callbackContext = new CallbackContext(CallbackContext.Op.CREATE);
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).preModify(identityAttrs, null, callbackContext, checkImmutable);
    ...
    try {
      ...
      LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(identityAttrs, identity, callbackContext);
  ...
  public void modifyIdentity(
    ...
    if (identityName.equalsIgnoreCase(ProvisioningConstants.DEFAULT_IDENTITY_NAME)) {
      ...
      if (newName) {
        // the identity cache could've been loaded again if getAllIdentities were called in
        // pre/poseModify callback, so we clear it again
        account.setCachedData(IDENTITY_LIST_CACHE_KEY, null);
  ...
  private List<Signature> getSignaturesByQuery(
      Account acct,
      LdapEntry entry,
      ZLdapFilter filter,
      ZLdapContext initZlc,
    ...
    try {
      ...
      throw ServiceException.FAILURE(
          "unable to lookup signature via query: "
              + filter.toFilterString()
              + " message: "
              + e.getMessage(),
          e);
  ...
  private Signature getSignatureById(Account acct, LdapEntry entry, String id, ZLdapContext zlc)
      throws ServiceException {
    List<Signature> result =
        getSignaturesByQuery(acct, entry, filterFactory.signatureById(id), zlc, null);
    return result.isEmpty() ? null : result.get(0);
  }
  ...
  private void validateSignatureAttrs(Map<String, Object> attrs) throws ServiceException {
    Set<String> validAttrs =
        StoreAttributeManager.getInstance().getLowerCaseAttrsInClass(AttributeClass.signature);
    for (String key : attrs.keySet()) {
      if (!validAttrs.contains(key.toLowerCase())) {
        throw ServiceException.INVALID_REQUEST("unable to modify attr: " + key, null);
      }
  ...
  public Signature createSignature(
      Account account, String signatureName, Map<String, Object> signatureAttrs)
      throws ServiceException {
    return createSignature(account, signatureName, signatureAttrs, false);
  }

  @Override
  public Signature restoreSignature(
      Account account, String signatureName, Map<String, Object> signatureAttrs)
      throws ServiceException {
  ...
  private Signature createSignature(
      Account account, String signatureName, Map<String, Object> signatureAttrs, boolean restoring)
      throws ServiceException {
    ...
    else if (numSigs == 0) setAsDefault = true;

    account.setCachedData(SIGNATURE_LIST_CACHE_KEY, null);

    boolean checkImmutable = !restoring;
    CallbackContext callbackContext = new CallbackContext(CallbackContext.Op.CREATE);
    callbackContext.setData(
        DataKey.MAX_SIGNATURE_LEN, String.valueOf(account.getMailSignatureMaxLength()));
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).preModify(signatureAttrs, null, callbackContext, checkImmutable);
    ...
    try {
      ...
      LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(signatureAttrs, signature, callbackContext);

      if (setAsDefault) setDefaultSignature(account, signatureId);
  ...
  public void modifySignature(
      Account account, String signatureId, Map<String, Object> signatureAttrs)
      throws ServiceException {
    removeAttrIgnoreCase("objectclass", signatureAttrs);
    ...
    if (LdapSignature.isAccountSignature(account, signatureId)) {
      ...
      LdapSignature signature =
          (LdapSignature) getSignatureById(account, ldapEntry, signatureId, null);
      ...
      if (nameChanged) signatureAttrs.remove(A_zimbraSignatureName);
  ...
  private List<DataSource> getDataSourcesByQuery(
    ...
    try {
      ...
      throw ServiceException.FAILURE(
          "unable to lookup data source via query: "
              + filter.toFilterString()
              + " message: "
              + e.getMessage(),
          e);
  ...
  protected ReplaceAddressResult replaceMailAddresses(
      Entry entry, String attrName, String oldAddr, String newAddr) throws ServiceException {
  ...
  private void moveAliases(
      ZLdapContext zlc,
      ReplaceAddressResult addrs,
      String newDomain,
      String primaryUid,
      String targetOldDn,
      String targetNewDn,
      String targetOldDomain,
      String targetNewDomain)
      throws ServiceException {
      ...
      if (aliasNewDomain.equals(newDomain)) {
        ...
        if (!(primaryUid != null && newAliasLocal.equals(primaryUid))) {
          try {
            ...
            ZimbraLog.account.warn(
                "unable to move alias from " + oldAliasDN + " to " + newAliasDN, nabe);
          } catch (ServiceException ne) {
  ...
  public DataSource createDataSource(
      Account account, DataSourceType dsType, String dsName, Map<String, Object> dataSourceAttrs)
      throws ServiceException {
  ...
  private DataSource createDataSource(
    ...
    CallbackContext callbackContext = new CallbackContext(CallbackContext.Op.CREATE);
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance())
        .preModify(dataSourceAttrs, null, callbackContext, checkImmutable);
    ...
    try {
      ...
      if (smtpPassword != null) {
        String encrypted =
            passwdAlreadyEncrypted ? smtpPassword : DataSource.encryptData(dsId, smtpPassword);
      ...
      LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(dataSourceAttrs, ds, callbackContext);
      return ds;
    } catch (LdapEntryAlreadyExistException nabe) {
  ...
  public void modifyDataSource(Account account, String dataSourceId, Map<String, Object> attrs)
    ...
    if (ds == null) throw AccountServiceException.NO_SUCH_DATA_SOURCE(dataSourceId);
    ...
    if (smtpPassword != null) {
      attrs.put(
          A_zimbraDataSourceSmtpAuthPassword, DataSource.encryptData(ds.getId(), smtpPassword));
    }

    modifyAttrs(ds, attrs, true);
    if (newName) {
      // the datasoruce cache could've been loaded again if getAllDataSources were called in
      // pre/poseModify callback, so we clear it again
      account.setCachedData(DATA_SOURCE_LIST_CACHE_KEY, null);
      ZLdapContext zlc = null;
      try {
    ...
    switch (keyType) {
      case id:
        for (DataSource source : getAllDataSources(account))
          if (source.getId().equals(key)) return source;
        return null;
        // return getDataSourceById(ldapEntry, key, null);
      case name:
        for (DataSource source : getAllDataSources(account))
          if (source.getName().equalsIgnoreCase(key)) return source;
        return null;
  ...
  public Right getRight(String rightName, boolean expandAllAttrs) throws ServiceException {
    if (expandAllAttrs) throw ServiceException.FAILURE("expandAllAttrs is not supported", null);
  ...
  public RightCommand.AllEffectiveRights getAllEffectiveRights(
      ...
      throws ServiceException {
    return RightCommand.getAllEffectiveRights(
        this, granteeType, granteeBy, grantee, expandSetAttrs, expandGetAttrs);
  }
  ...
  public RightCommand.EffectiveRights getEffectiveRights(
      ...
      boolean expandGetAttrs)
      throws ServiceException {
    return RightCommand.getEffectiveRights(
        this, targetType, targetBy, target, granteeBy, grantee, expandSetAttrs, expandGetAttrs);
  }

  @Override
  public EffectiveRights getCreateObjectAttrs(
      String targetType,
      ...
      String grantee)
      throws ServiceException {
    return RightCommand.getCreateObjectAttrs(
        this, targetType, domainBy, domainStr, cosBy, cosStr, granteeBy, grantee);
  }
  ...
  public void flushCache(CacheEntryType type, CacheEntry[] entries) throws ServiceException {
    ...
    switch (type) {
      ...
      case account:
        if (entries != null) {
          for (CacheEntry entry : entries) {
            AccountBy accountBy =
                (entry.mEntryBy == Key.CacheEntryBy.id) ? AccountBy.id : AccountBy.name;
      ...
      case group:
        if (entries != null) {
          for (CacheEntry entry : entries) {
            Key.DistributionListBy dlBy =
                (entry.mEntryBy == Key.CacheEntryBy.id)
      ...
      case config:
        if (entries != null) {
          throw ServiceException.INVALID_REQUEST(
              "cannot specify entry for flushing global config", null);
        }
      ...
      case globalgrant:
        if (entries != null) {
          throw ServiceException.INVALID_REQUEST(
              "cannot specify entry for flushing global grant", null);
        }
      ...
      case cos:
        if (entries != null) {
          for (CacheEntry entry : entries) {
            Key.CosBy cosBy =
                (entry.mEntryBy == Key.CacheEntryBy.id) ? Key.CosBy.id : Key.CosBy.name;
            Cos cos = getFromCache(cosBy, entry.mEntryIdentity);
            if (cos != null) reload(cos, false);
          }
        } else cosCache.clear();
        return;
      case domain:
        if (entries != null) {
          for (CacheEntry entry : entries) {
            Key.DomainBy domainBy =
                (entry.mEntryBy == Key.CacheEntryBy.id) ? Key.DomainBy.id : Key.DomainBy.name;
            Domain domain =
                getFromCache(domainBy, entry.mEntryIdentity, GetFromDomainCacheOption.BOTH);
            if (domain != null) {
              if (domain instanceof DomainCache.NonExistingDomain)
                domainCache.removeFromNegativeCache(domainBy, entry.mEntryIdentity);
              else reload(domain, false);
            }
          }
      ...
      case server:
        if (entries != null) {
          for (CacheEntry entry : entries) {
            Key.ServerBy serverBy =
                (entry.mEntryBy == Key.CacheEntryBy.id) ? Key.ServerBy.id : Key.ServerBy.name;
  ...
  private static class CountAccountVisitor implements NamedEntry.Visitor {
    ...
    public void visit(NamedEntry entry) throws ServiceException {
      ...
      if (entry instanceof CalendarResource) return;

      Account acct = (Account) entry;
      if (acct.getBooleanAttr(Provisioning.A_zimbraIsSystemResource, false)) return;
  ...
  public Map<String, String> getNamesForIds(Set<String> ids, EntryType type)
    ...
    switch (entryType) {
      ...
      default:
        throw ServiceException.FAILURE(
            "unsupported entry type for getNamesForIds" + type.name(), null);
    }
            ...
            try {
              switch (entryType) {
                case account:
                  ...
                  if (name == null) name = mDIT.dnToEmail(dn, ldapAttrs);
                  break;
                case group:
  ...
  @Override
  public void searchLdapOnReplica(
      String base, String filter, String[] returnAttrs, SearchLdapVisitor visitor)
      throws ServiceException {
  ...
  public void searchLdapOnMaster(
      String base, ZLdapFilter filter, String[] returnAttrs, SearchLdapVisitor visitor)
      throws ServiceException {
  ...
  private void searchZimbraLdap(
      String base, String query, String[] returnAttrs, boolean useMaster, SearchLdapVisitor visitor)
      throws ServiceException {
   ...
   */
  private boolean addressExists(ZLdapContext zlc, String[] addrs) throws ServiceException {
  ...
  private boolean addressExistsUnderDN(ZLdapContext zlc, String baseDN, String[] addrs)
    ...
    ZSearchControls searchControls =
        ZSearchControls.createSearchControls(ZSearchScope.SEARCH_SCOPE_SUBTREE, 1, null);
  ...
  @Override
  public Group createDelegatedGroup(
      String name, Map<String, Object> attrs, boolean dynamic, Account creator)
      throws ServiceException {
    if (creator == null) {
    ...
    grantRight(
        ...
        creator.getId(),
        null,
        Group.GroupOwner.GROUP_OWNER_RIGHT.getName(),
        null);
  ...
  public Group getGroup(
      Key.DistributionListBy keyType, String key, boolean loadFromMaster, boolean basicAttrsOnly)
      throws ServiceException {
  ...
  private Group getGroupInternal(
      Key.DistributionListBy keyType, String key, boolean basicAttrsOnly, boolean loadFromMaster)
      throws ServiceException {
    switch (keyType) {
      case id:
  ...
  private Group getGroupById(
      String zimbraId, ZLdapContext zlc, boolean basicAttrsOnly, boolean loadFromMaster)
      throws ServiceException {
    return getGroupByQuery(filterFactory.groupById(zimbraId), zlc, basicAttrsOnly, loadFromMaster);
  }

  private Group getGroupByName(
      String groupAddress, ZLdapContext zlc, boolean basicAttrsOnly, boolean loadFromMaster)
      throws ServiceException {
    groupAddress = IDNUtil.toAsciiEmail(groupAddress);
    return getGroupByQuery(
        filterFactory.groupByName(groupAddress), zlc, basicAttrsOnly, loadFromMaster);
  }

  private Group getGroupByQuery(
      ZLdapFilter filter, ZLdapContext initZlc, boolean basicAttrsOnly, boolean loadFromMaster)
      throws ServiceException {
    try {
      String[] returnAttrs = basicAttrsOnly ? BASIC_GROUP_ATTRS : null;
      ZSearchResultEntry sr =
          helper.searchForEntry(
      ...
      throw ServiceException.FAILURE(
          "unable to lookup group via query: "
              + filter.toFilterString()
              + " message:"
              + e.getMessage(),
          e);
   ...
   */
  private void setGroupHomeServer(ZMutableEntry entry, Account creator) throws ServiceException {
    //
  ...
  private DynamicGroup createDynamicGroup(
      String groupAddress, Map<String, Object> groupAttrs, Account creator)
      throws ServiceException {
    ...
    LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).preModify(groupAttrs, null, callbackContext, true);
    ...
    try {
      ...
      */
      ...
      if (!entry.hasAttribute(A_memberURL)) {
        ...
        // We want to be able to use dynamic groups as ACLs, for instance when sharing a folder with
        // a group
        // This used to be disallowed via a requirement that zimbraIsACLGroup be specified and set
        // to FALSE.
      ...
      entry.setAttr(A_cn, localPart);
      // entry.setAttr(A_uid, localPart); need to use uid if we move dynamic groups to the ou=people
      // tree
      ...
      if (isACLGroup) {
        ...
        entry.setAttr(A_dgIdentity, LC.zimbra_ldap_userdn.value());
        String memberURL =
            LdapDynamicGroup.getDefaultDynamicUnitMemberURL(zimbraId); // id of the main group
        entry.setAttr(Provisioning.A_memberURL, memberURL);
      ...
      if (group != null) {
        LdapAttributeCallbackHelper.get(StoreAttributeManager.getInstance()).postModify(groupAttrs, group, callbackContext);
        removeExternalAddrsFromAllDynamicGroups(group.getAllAddrsSet(), zlc);
        allDLs.addGroup(group);
      } else {
        throw ServiceException.FAILURE(
            "unable to get dynamic group after creating LDAP entry: " + groupAddress, null);
      }
      return group;
  ...
  private void searchDynamicGroupInternalMembers(
      ZLdapContext zlc, String dynGroupId, SearchLdapVisitor visitor) throws ServiceException {
    String base = mDIT.mailBranchBaseDN();
  ...
  private void renameDynamicGroup(String zimbraId, String newEmail) throws ServiceException {
    ...
    try {
      ...
      ReplaceAddressResult replacedAliases =
          replaceMailAddresses(group, Provisioning.A_zimbraMailAlias, oldEmail, newEmail);
      if (replacedAliases.newAddrs().length > 0) {
        attrs.put(Provisioning.A_zimbraMailAlias, replacedAliases.newAddrs());
      ...
      ReplaceAddressResult replacedAllowAddrForDelegatedSender =
          replaceMailAddresses(
              group, Provisioning.A_zimbraPrefAllowAddressForDelegatedSender, oldEmail, newEmail);
      if (replacedAllowAddrForDelegatedSender.newAddrs().length > 0) {
        attrs.put(
            Provisioning.A_zimbraPrefAllowAddressForDelegatedSender,
            replacedAllowAddrForDelegatedSender.newAddrs());
      ...
      // rename the distribution list and all it's renamed aliases to the new name in all
      // distribution lists
      // doesn't throw exceptions, just logs
  ...
  private DynamicGroup getDynamicGroupBasic(
      Key.DistributionListBy keyType, String key, ZLdapContext zlc) throws ServiceException {
    return getDynamicGroup(keyType, key, zlc, Boolean.TRUE);
  }

  private DynamicGroup getDynamicGroup(
      Key.DistributionListBy keyType, String key, ZLdapContext zlc, boolean basicAttrsOnly)
      throws ServiceException {
  ...
  private DynamicGroup getDynamicGroupById(
      String zimbraId, ZLdapContext zlc, boolean basicAttrsOnly) throws ServiceException {
    return getDynamicGroupByQuery(filterFactory.dynamicGroupById(zimbraId), zlc, basicAttrsOnly);
  }

  private DynamicGroup getDynamicGroupByName(
      String groupAddress, ZLdapContext zlc, boolean basicAttrsOnly) throws ServiceException {
    groupAddress = IDNUtil.toAsciiEmail(groupAddress);
    return getDynamicGroupByQuery(
        filterFactory.dynamicGroupByName(groupAddress), zlc, basicAttrsOnly);
  }

  private DynamicGroup getDynamicGroupByQuery(
      ZLdapFilter filter, ZLdapContext initZlc, boolean basicAttrsOnly) throws ServiceException {
    try {
  ...
  private void removeDynamicGroupMembers(
      LdapDynamicGroup group, String[] members, boolean externalOnly) throws ServiceException {
    if (group.isMembershipDefinedByCustomURL()) {
      throw ServiceException.INVALID_REQUEST(
          String.format(
              "cannot remove members from dynamic group '%s' with custom memberURL",
              group.getName()),
          null);
    }
  ...
  /**
   * Get Dynamic Groups this account is a member of due to the value of the "zimbraMemberOf"
   * attribute. i.e. excludes groups this account is a member of because it satisfies the LDAP
   * filter specified in the group's MemberURL where that MemberURL is a custom one.
   *
   * @param acct
   * @return
   * @throws ServiceException
    ...
    if (acct instanceof GuestAccount) {
      ...
      memberOf =
          searchContainingDynamicGroupIdsForExternalAddress(
              acct.getExternalUserMailAddress(), null);
    } else {
  ...
  public String[] getNonDefaultDynamicGroupMembers(DynamicGroup group) {
    ...
    try {
      ...
      final String[] attrsToGet =
          new String[] {
            Provisioning.A_zimbraMailDeliveryAddress, Provisioning.A_zimbraIsExternalVirtualAccount
          };
      for (String memberDN : memberDNs) {
        ...
        boolean isVirtualAcct =
            memberAttrs.hasAttributeValue(Provisioning.A_zimbraIsExternalVirtualAccount, "TRUE");
  ...
  public void refreshUserCredentials(Account account) throws ServiceException {
    ...
    try {
      ...
      String[] returnAttrs = {
        ...
        Provisioning.A_zimbraResetPasswordRecoveryCode,
        Provisioning.A_zimbraPrefPasswordRecoveryAddress,
  ...
  public String createAddressList(
    ...
    String dn =
        LdapConstants.ATTR_uid
            + "="
            + name
            + ","
            + LdapConstants.ATTR_ou
            + "="
            + LdapConstants.PEOPLE
            + ","
            + domainDn;
  ...
  public AddressList getAddressList(String zimbraId) throws ServiceException {
    ...
    try {
      ...
      String[] returnAttrs = {
        ...
        Provisioning.A_zimbraAddressListGalFilter,
      ...
      ZSearchResultEnumeration ne =
          helper.searchDir(
              mDIT.mailBranchBaseDN(),
              filterFactory.addressListById(zimbraId),
              searchControls,
              null,
              LdapServerType.MASTER);
      if (ne.hasMore()) {
      ...
      throw ServiceException.FAILURE(
          String.format("Unable to fetch address list '%s'", zimbraId), e);
    }
    return list;
  }
  ...
  public AddressListInfo getAddressListByName(String name, Domain domain) throws ServiceException {
    ...
    List<AddressListInfo> result =
        getAddressListByQuery(ldapEntry.getDN(), filterFactory.addressListByName(name), false);
    if (result.size() < 1) {
  ...
  public void modifyAddressList(AddressList addressList, String name, Map<String, String> attrs)
    ...
    try {
      ...
      if (!StringUtil.isNullOrEmpty(name) && !StringUtil.equal(name, oldName)) {
        ...
        String newDn =
            oldDn.replaceFirst(
                LdapConstants.ATTR_uid + "=" + oldName,
