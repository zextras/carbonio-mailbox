...
public class ShareInfoData {
  ...
  public String getMountpointId_zmprov_only() {
    if (mMountpointId_zmprov_only == null) return "";
    else return mMountpointId_zmprov_only;
  }
  ////////////////////////////////////
  ...
  public String getOwnerNotifName() {
    ...
    if (notifName != null) return notifName;
    else return getOwnerAcctEmail();
  }
  ...
  public String getGranteeNotifName() {
    ...
    if (notifName != null) return notifName;
    else return getGranteeName();
  }

  public static ShareInfoData fromJaxbShareInfo(com.zimbra.soap.type.ShareInfo sInfo)
  ...
  public static ShareInfoData fromXML(Element eShare) throws ServiceException {
    ...
    sid.setFolderDefaultView(
        MailItem.Type.of(eShare.getAttribute(MailConstants.A_DEFAULT_VIEW, null)));
  ...
  public String toString() {
    ...
    sb.append(String.format(format, "owner id", getOwnerAcctId()));
    sb.append(String.format(format, "owner email", getOwnerAcctEmail()));
    sb.append(String.format(format, "owner display", getOwnerAcctDisplayName()));
    sb.append(String.format(format, "folder id", String.valueOf(getItemId())));
    sb.append(String.format(format, "folder uuid", getItemUuid()));
    sb.append(String.format(format, "folder path", getPath()));
    sb.append(String.format(format, "view", getFolderDefaultView()));
    sb.append(String.format(format, "rights", getRights()));
    sb.append(String.format(format, "mountpoint id", getMountpointId_zmprov_only()));
    sb.append(String.format(format, "grantee type", getGranteeType()));
    sb.append(String.format(format, "grantee id", getGranteeId()));
    sb.append(String.format(format, "grantee email", getGranteeName()));
    sb.append(String.format(format, "grantee display", getGranteeDisplayName()));
    return sb.toString();
  }
