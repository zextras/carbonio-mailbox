...
public class RightCommand {
  ...
  /**
   * TODO: this method can be deleted because {@link AccessManager#getInstance()} always return an
   * {@link ACLAccessManager}
   *
   * <p>Verifies the current access manager is of type {@link ACLAccessManager}
   *
   * @throws ServiceException
   */
