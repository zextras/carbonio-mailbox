...
public abstract class Group extends MailTarget implements AliasedEntry {
  ...
  public static final DistributionListSubscriptionPolicy DEFAULT_SUBSCRIPTION_POLICY =
      DistributionListSubscriptionPolicy.REJECT;

  public static final DistributionListUnsubscriptionPolicy DEFAULT_UNSUBSCRIPTION_POLICY =
      DistributionListUnsubscriptionPolicy.REJECT;
  ...
  /**
   * Ldap implementation of Group will cost a LDAP search. Use Provisioning.getGroupMembers() to get
   * cached results.
   */
  ...
  public static class GroupOwner {
    ...
    public static Set<Group> getOwnedGroups(Account acct) throws ServiceException {
      ...
      Map<Right, Set<Entry>> discoveredRights =
          accessMgr.discoverUserRights(acct, Collections.singleton(right), true);
     ...
     */
    public static boolean hasOwnerPrivilege(Account acct, Group group) throws ServiceException {
