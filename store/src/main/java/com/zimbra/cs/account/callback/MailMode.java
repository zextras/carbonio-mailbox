...
public class MailMode extends LocalBind {
  static final String ERROR_MM_W_IP_SEC =
      "Only \"https\" and \"both\" are valid modes when requiring interprocess security with web"
          + " proxy.";
  static final String ERROR_MM_WO_IP_SEC =
      "Only \"http\" and \"both\" are valid modes when not requiring interprocess security with web"
          + " proxy.";
