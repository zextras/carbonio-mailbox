...
public class FileGenUtil {
  ...
  public static String wrapComments(
      String comments, int maxLineLength, String prefix, String suffix) {
  ...
  public static void replaceFile(
      String outFile, String templateFile, Map<String, String> templateFillers) throws IOException {
