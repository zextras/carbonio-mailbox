...
public class PasswordUtil {
  ...
  public static class SSHA512 {
    ...
    public static boolean verifySSHA512(String encodedPassword, String password) {
      if (!encodedPassword.startsWith(SSHA512_ENCODING)) return false;
  ...
  public static class SHA1 {
    ...
    public static boolean verifySHA1(String encodedPassword, String password) {
      ...
      if (encodedPassword.startsWith(SHA1_ENCODING)) prefix = SHA1_ENCODING;
      else if (encodedPassword.startsWith(SHA_ENCODING)) prefix = SHA_ENCODING;
      else return false;
  ...
  public static class MD5 {
    ...
    public static boolean verifyMD5(String encodedPassword, String password) {
      if (!encodedPassword.startsWith(MD5_ENCODING)) return false;
