...
public class BUG_57875 extends UpgradeOp {
  ...
  private void upgradeGlobalConfig(ZLdapContext zlc) throws ServiceException {
    ...
    String query =
        "(&"
            + ZLdapFilterFactory.getInstance().globalConfig().toFilterString()
            + "("
            + ATTR_NAME
            + "="
            + OLD_VALUE
  ...
  private void upgradeDomains(ZLdapContext zlc) {
    ...
    String query =
        "(&"
            + ZLdapFilterFactory.getInstance().allDomains().toFilterString()
            + "("
            + ATTR_NAME
            + "="
            + OLD_VALUE
  ...
  private void upgradeDataSources(ZLdapContext zlc) {
    ...
    String query =
        "(&"
            + ZLdapFilterFactory.getInstance().allDataSources().toFilterString()
            + "("
            + ATTR_NAME
            + "="
            + OLD_VALUE
