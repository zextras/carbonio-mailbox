...
public class BUG_50465 extends UpgradeOp {
  private static final String ATTR_NOTEBOOK = Provisioning.A_zimbraFeatureNotebookEnabled;
  ...
  private void upgrade(ZLdapContext modZlc, String bases[], String query) {
    ...
    String attrs[] = new String[] {ATTR_NOTEBOOK};
  ...
  private String query() {
    return "(|(" + ATTR_NOTEBOOK + "=" + LdapConstants.LDAP_TRUE + "))";
  }
