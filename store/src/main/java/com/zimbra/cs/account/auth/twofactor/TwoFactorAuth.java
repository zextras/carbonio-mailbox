...
public abstract class TwoFactorAuth implements SecondFactor {
  ...
  public interface Factory {
    ...
    TwoFactorAuth getTwoFactorAuth(Account account, String acctNamePassedIn)
        throws ServiceException;

    TrustedDevices getTrustedDevices(Account account) throws ServiceException;

    TrustedDevices getTrustedDevices(Account account, String acctNamePassedIn)
        throws ServiceException;

    AppSpecificPasswords getAppSpecificPasswords(Account account) throws ServiceException;

    AppSpecificPasswords getAppSpecificPasswords(Account account, String acctNamePassedIn)
        throws ServiceException;
  ...
  public static class DefaultFactory implements Factory {
    ...
    @Override
    public TwoFactorAuth getTwoFactorAuth(Account account, String acctNamePassedIn)
        throws ServiceException {
    ...
    @Override
    public TrustedDevices getTrustedDevices(Account account, String acctNamePassedIn)
        throws ServiceException {
      return null;
    }
    ...
    @Override
    public AppSpecificPasswords getAppSpecificPasswords(Account account, String acctNamePassedIn)
        throws ServiceException {
      return null;
    }
    ...
    @Override
    public ScratchCodes getScratchCodes(Account account, String acctNamePassedIn)
        throws ServiceException {
      return null;
    }
  }
  ...
  public static final void setFactory(String factoryClassName) {
      ...
      try {
        ...
        try {
          ...
          ZimbraLog.extensions.error(
              "cannot instantiate specified two-factor auth factory, using default");
    ...
    ZimbraLog.extensions.info(
        "Using two-factor auth factory %s", factory.getClass().getDeclaringClass().getSimpleName());
  }
  ...
  public abstract static class TwoFactorChangeListener {
    private static Map<String, TwoFactorChangeListener> listeners =
        new HashMap<String, TwoFactorChangeListener>();
