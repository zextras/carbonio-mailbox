...
public class ForgetPasswordException extends AccountServiceException {
  ...
  protected ForgetPasswordException(
  ...
  public static ServiceException RECOVERY_EMAIL_SAME_AS_PRIMARY_OR_ALIAS(String message) {
    return new ForgetPasswordException(
        "service exception: " + message,
        Codes.RECOVERY_EMAIL_SAME_AS_PRIMARY_OR_ALIAS.toString(),
        SENDERS_FAULT);
  }

  public static ServiceException CODE_ALREADY_SENT(String message) {
    return new ForgetPasswordException(
        "service exception: " + message, Codes.CODE_ALREADY_SENT.toString(), SENDERS_FAULT);
  }

  public static ServiceException MAX_ATTEMPTS_REACHED(String message) {
    return new ForgetPasswordException(
        "service exception: " + message, Codes.MAX_ATTEMPTS_REACHED.toString(), SENDERS_FAULT);
  }

  public static ServiceException MAX_ATTEMPTS_REACHED_SUSPEND_FEATURE(String message) {
    return new ForgetPasswordException(
        "service exception: " + message,
        Codes.MAX_ATTEMPTS_REACHED_SUSPEND_FEATURE.toString(),
        SENDERS_FAULT);
  }

  public static ServiceException CODE_NOT_FOUND(String message) {
    return new ForgetPasswordException(
        "service exception: " + message, Codes.CODE_NOT_FOUND.toString(), SENDERS_FAULT);
  }

  public static ServiceException CODE_MISMATCH(String message) {
    return new ForgetPasswordException(
        "service exception: " + message, Codes.CODE_MISMATCH.toString(), SENDERS_FAULT);
  }

  public static ServiceException CODE_EXPIRED(String message) {
    return new ForgetPasswordException(
        "service exception: " + message, Codes.CODE_EXPIRED.toString(), SENDERS_FAULT);
  }

  public static ServiceException CONTACT_ADMIN(String message) {
    return new ForgetPasswordException(
        "service exception: " + message, Codes.CONTACT_ADMIN.toString(), SENDERS_FAULT);
  }

  public static ServiceException FEATURE_RESET_PASSWORD_SUSPENDED(String message) {
    return new ForgetPasswordException(
        "service exception: " + message,
        Codes.FEATURE_RESET_PASSWORD_SUSPENDED.toString(),
        SENDERS_FAULT);
  }
  ...
  public static ServiceException FEATURE_RESET_PASSWORD_DISABLED(String message) {
    return new ForgetPasswordException(
        "service exception: " + message,
        Codes.FEATURE_RESET_PASSWORD_DISABLED.toString(),
        SENDERS_FAULT);
  }
}
