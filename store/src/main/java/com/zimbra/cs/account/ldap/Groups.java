...
public class Groups {
  ...
  private static class GetAllDLsVisitor extends SearchLdapVisitor {
    ...
    public void visit(String dn, Map<String, Object> attrs, IAttributes ldapAttrs) {
      ...
      if (addrs instanceof String) allDLs.add(((String) addrs).toLowerCase());
      else if (addrs instanceof String[]) {
        for (String addr : (String[]) addrs) allDLs.add(addr.toLowerCase());
      }
    }
