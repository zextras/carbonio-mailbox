...
public class AdminRights {
  ...
  public static void init(RightManager rm) throws ServiceException {
    ...
    R_adminConsoleAccountsACLTabRights =
        rm.getAdminRight(Right.RT_adminConsoleAccountsACLTabRights);
    R_adminConsoleAccountsAliasesTabRights =
        rm.getAdminRight(Right.RT_adminConsoleAccountsAliasesTabRights);
    R_adminConsoleAccountsContactTabRights =
        rm.getAdminRight(Right.RT_adminConsoleAccountsContactTabRights);
    R_adminConsoleAccountsFeaturesTabRights =
        rm.getAdminRight(Right.RT_adminConsoleAccountsFeaturesTabRights);
    R_adminConsoleAccountsForwardingTabRights =
        rm.getAdminRight(Right.RT_adminConsoleAccountsForwardingTabRights);
    R_adminConsoleAccountsFreeBusyInteropTabRights =
        rm.getAdminRight(Right.RT_adminConsoleAccountsFreeBusyInteropTabRights);
    R_adminConsoleAccountsInfoTabRights =
        rm.getAdminRight(Right.RT_adminConsoleAccountsInfoTabRights);
    R_adminConsoleAccountsMemberOfTabRights =
        rm.getAdminRight(Right.RT_adminConsoleAccountsMemberOfTabRights);
    R_adminConsoleAccountsPreferencesTabRights =
        rm.getAdminRight(Right.RT_adminConsoleAccountsPreferencesTabRights);
    R_adminConsoleAccountsThemesTabRights =
        rm.getAdminRight(Right.RT_adminConsoleAccountsThemesTabRights);
    R_adminConsoleAccountsZimletsTabRights =
        rm.getAdminRight(Right.RT_adminConsoleAccountsZimletsTabRights);
    ...
    R_adminConsoleCOSAdvancedTabRights =
        rm.getAdminRight(Right.RT_adminConsoleCOSAdvancedTabRights);
    R_adminConsoleCOSFeaturesTabRights =
        rm.getAdminRight(Right.RT_adminConsoleCOSFeaturesTabRights);
    ...
    R_adminConsoleCOSPreferencesTabRights =
        rm.getAdminRight(Right.RT_adminConsoleCOSPreferencesTabRights);
    R_adminConsoleCOSRights = rm.getAdminRight(Right.RT_adminConsoleCOSRights);
    R_adminConsoleCOSServerPoolTabRights =
        rm.getAdminRight(Right.RT_adminConsoleCOSServerPoolTabRights);
    ...
    R_adminConsoleCreateSubDomainModifierRights =
        rm.getAdminRight(Right.RT_adminConsoleCreateSubDomainModifierRights);
    R_adminConsoleCreateSubDomainRights =
        rm.getAdminRight(Right.RT_adminConsoleCreateSubDomainRights);
    R_adminConsoleCreateTopDomainRights =
        rm.getAdminRight(Right.RT_adminConsoleCreateTopDomainRights);
    R_adminConsoleCrossMailboxSearchRights =
        rm.getAdminRight(Right.RT_adminConsoleCrossMailboxSearchRights);
    ...
    R_adminConsoleDomainAuthenticationTabRights =
        rm.getAdminRight(Right.RT_adminConsoleDomainAuthenticationTabRights);
    R_adminConsoleDomainDocumentsTabRights =
        rm.getAdminRight(Right.RT_adminConsoleDomainDocumentsTabRights);
    R_adminConsoleDomainFreebusyTabRights =
        rm.getAdminRight(Right.RT_adminConsoleDomainFreebusyTabRights);
    ...
    R_adminConsoleDomainLimitsTabRights =
        rm.getAdminRight(Right.RT_adminConsoleDomainLimitsTabRights);
    R_adminConsoleDomainRights = rm.getAdminRight(Right.RT_adminConsoleDomainRights);
    R_adminConsoleDomainThemesTabRights =
        rm.getAdminRight(Right.RT_adminConsoleDomainThemesTabRights);
    R_adminConsoleDomainVirtualHostsTabRights =
        rm.getAdminRight(Right.RT_adminConsoleDomainVirtualHostsTabRights);
    R_adminConsoleDomainZimletsTabRights =
        rm.getAdminRight(Right.RT_adminConsoleDomainZimletsTabRights);
    R_adminConsoleExtensionACLTabRights =
        rm.getAdminRight(Right.RT_adminConsoleExtensionACLTabRights);
    ...
    R_adminConsoleGlobalAttachmentsTabRights =
        rm.getAdminRight(Right.RT_adminConsoleGlobalAttachmentsTabRights);
    R_adminConsoleGlobalBackupRestoreTabRights =
        rm.getAdminRight(Right.RT_adminConsoleGlobalBackupRestoreTabRights);
    R_adminConsoleGlobalFreebusyTabRights =
        rm.getAdminRight(Right.RT_adminConsoleGlobalFreebusyTabRights);
    ...
    R_adminConsoleGlobalLicenseTabRights =
        rm.getAdminRight(Right.RT_adminConsoleGlobalLicenseTabRights);
    ...
    R_adminConsoleGlobalThemesTabRights =
        rm.getAdminRight(Right.RT_adminConsoleGlobalThemesTabRights);
    ...
    R_adminConsoleResourcesContactTabRights =
        rm.getAdminRight(Right.RT_adminConsoleResourcesContactTabRights);
    R_adminConsoleResourcesPropertiesTabRights =
        rm.getAdminRight(Right.RT_adminConsoleResourcesPropertiesTabRights);
    ...
    R_adminConsoleServerBackupRestoreTabRights =
        rm.getAdminRight(Right.RT_adminConsoleServerBackupRestoreTabRights);
    ...
    R_adminConsoleServerServicesTabRights =
        rm.getAdminRight(Right.RT_adminConsoleServerServicesTabRights);
    R_adminConsoleServerStatisticRights =
        rm.getAdminRight(Right.RT_adminConsoleServerStatisticRights);
    R_adminConsoleServerStatusRights = rm.getAdminRight(Right.RT_adminConsoleServerStatusRights);
    R_adminConsoleServerVolumesTabRights =
        rm.getAdminRight(Right.RT_adminConsoleServerVolumesTabRights);
    R_adminConsoleSoftwareUpdatesRights =
        rm.getAdminRight(Right.RT_adminConsoleSoftwareUpdatesRights);
    ...
    R_checkCalendarResourcePasswordStrength =
        rm.getAdminRight(Right.RT_checkCalendarResourcePasswordStrength);
    ...
    R_domainAdminCalendarResourceRights =
        rm.getAdminRight(Right.RT_domainAdminCalendarResourceRights);
    R_domainAdminConsoleAccountRights = rm.getAdminRight(Right.RT_domainAdminConsoleAccountRights);
    R_domainAdminConsoleAccountsAliasesTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleAccountsAliasesTabRights);
    R_domainAdminConsoleAccountsContactTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleAccountsContactTabRights);
    R_domainAdminConsoleAccountsFeaturesTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleAccountsFeaturesTabRights);
    R_domainAdminConsoleAccountsForwardingTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleAccountsForwardingTabRights);
    R_domainAdminConsoleAccountsFreeBusyInteropTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleAccountsFreeBusyInteropTabRights);
    R_domainAdminConsoleAccountsInfoTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleAccountsInfoTabRights);
    R_domainAdminConsoleAccountsMemberOfTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleAccountsMemberOfTabRights);
    R_domainAdminConsoleAccountsThemesTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleAccountsThemesTabRights);
    R_domainAdminConsoleAccountsZimletsTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleAccountsZimletsTabRights);
    R_domainAdminConsoleAliasRights = rm.getAdminRight(Right.RT_domainAdminConsoleAliasRights);
    R_domainAdminConsoleDLAliasesTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleDLAliasesTabRights);
    R_domainAdminConsoleDLMemberOfTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleDLMemberOfTabRights);
    R_domainAdminConsoleDLMembersTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleDLMembersTabRights);
    R_domainAdminConsoleDLNotesTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleDLNotesTabRights);
    R_domainAdminConsoleDLRights = rm.getAdminRight(Right.RT_domainAdminConsoleDLRights);
    R_domainAdminConsoleDLSharesTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleDLSharesTabRights);
    R_domainAdminConsoleResourceRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleResourceRights);
    R_domainAdminConsoleResourcesContactTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleResourcesContactTabRights);
    R_domainAdminConsoleResourcesPropertiesTabRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleResourcesPropertiesTabRights);
    R_domainAdminConsoleRights = rm.getAdminRight(Right.RT_domainAdminConsoleRights);
    R_domainAdminConsoleSavedSearchRights =
        rm.getAdminRight(Right.RT_domainAdminConsoleSavedSearchRights);
    R_domainAdminCosRights = rm.getAdminRight(Right.RT_domainAdminCosRights);
    R_domainAdminDistributionListRights =
        rm.getAdminRight(Right.RT_domainAdminDistributionListRights);
    ...
    R_getDomainAdminCalendarResourceAttrs =
        rm.getAdminRight(Right.RT_getDomainAdminCalendarResourceAttrs);
    ...
    R_setAdminConsoleAccountsAliasesTab =
        rm.getAdminRight(Right.RT_setAdminConsoleAccountsAliasesTab);
    R_setAdminConsoleAccountsContactTab =
        rm.getAdminRight(Right.RT_setAdminConsoleAccountsContactTab);
    R_setAdminConsoleAccountsFeaturesTab =
        rm.getAdminRight(Right.RT_setAdminConsoleAccountsFeaturesTab);
    R_setAdminConsoleAccountsForwardingTab =
        rm.getAdminRight(Right.RT_setAdminConsoleAccountsForwardingTab);
    R_setAdminConsoleAccountsFreeBusyInteropTab =
        rm.getAdminRight(Right.RT_setAdminConsoleAccountsFreeBusyInteropTab);
    R_setAdminConsoleAccountsInfoTab = rm.getAdminRight(Right.RT_setAdminConsoleAccountsInfoTab);
    R_setAdminConsoleAccountsPreferencesTab =
        rm.getAdminRight(Right.RT_setAdminConsoleAccountsPreferencesTab);
    R_setAdminConsoleAccountsThemesTab =
        rm.getAdminRight(Right.RT_setAdminConsoleAccountsThemesTab);
    R_setAdminConsoleAccountsZimletsTab =
        rm.getAdminRight(Right.RT_setAdminConsoleAccountsZimletsTab);
    ...
    R_setAdminConsoleCOSPreferencesTab =
        rm.getAdminRight(Right.RT_setAdminConsoleCOSPreferencesTab);
    ...
    R_setAdminConsoleDomainAuthenticationTab =
        rm.getAdminRight(Right.RT_setAdminConsoleDomainAuthenticationTab);
    R_setAdminConsoleDomainDocumentsTab =
        rm.getAdminRight(Right.RT_setAdminConsoleDomainDocumentsTab);
    R_setAdminConsoleDomainFreebusyTab =
        rm.getAdminRight(Right.RT_setAdminConsoleDomainFreebusyTab);
    ...
    R_setAdminConsoleDomainVirtualHostsTab =
        rm.getAdminRight(Right.RT_setAdminConsoleDomainVirtualHostsTab);
    ...
    R_setAdminConsoleGlobalAttachmentsTab =
        rm.getAdminRight(Right.RT_setAdminConsoleGlobalAttachmentsTab);
    R_setAdminConsoleGlobalBackupRestoreTab =
        rm.getAdminRight(Right.RT_setAdminConsoleGlobalBackupRestoreTab);
    R_setAdminConsoleGlobalFreebusyTab =
        rm.getAdminRight(Right.RT_setAdminConsoleGlobalFreebusyTab);
    ...
    R_setAdminConsoleResourcesContactTab =
        rm.getAdminRight(Right.RT_setAdminConsoleResourcesContactTab);
    R_setAdminConsoleResourcesPropertiesTab =
        rm.getAdminRight(Right.RT_setAdminConsoleResourcesPropertiesTab);
    R_setAdminConsoleServerACLTab = rm.getAdminRight(Right.RT_setAdminConsoleServerACLTab);
    R_setAdminConsoleServerBackupRestoreTab =
        rm.getAdminRight(Right.RT_setAdminConsoleServerBackupRestoreTab);
    ...
    R_setAdminConsoleServerServicesTab =
        rm.getAdminRight(Right.RT_setAdminConsoleServerServicesTab);
    R_setAdminConsoleServerVolumesTab = rm.getAdminRight(Right.RT_setAdminConsoleServerVolumesTab);
    R_setAdminConsoleSoftwareUpdatesConfigAttrs =
        rm.getAdminRight(Right.RT_setAdminConsoleSoftwareUpdatesConfigAttrs);
    ...
    R_setDomainAdminAccountAndCalendarResourceAttrs =
        rm.getAdminRight(Right.RT_setDomainAdminAccountAndCalendarResourceAttrs);
    R_setDomainAdminCalendarResourceAttrs =
        rm.getAdminRight(Right.RT_setDomainAdminCalendarResourceAttrs);
    R_setDomainAdminConsoleAccountsAliasesTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleAccountsAliasesTab);
    R_setDomainAdminConsoleAccountsContactTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleAccountsContactTab);
    R_setDomainAdminConsoleAccountsFeaturesTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleAccountsFeaturesTab);
    R_setDomainAdminConsoleAccountsForwardingTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleAccountsForwardingTab);
    R_setDomainAdminConsoleAccountsFreeBusyInteropTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleAccountsFreeBusyInteropTab);
    R_setDomainAdminConsoleAccountsInfoTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleAccountsInfoTab);
    R_setDomainAdminConsoleAccountsThemesTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleAccountsThemesTab);
    R_setDomainAdminConsoleAccountsZimletsTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleAccountsZimletsTab);
    R_setDomainAdminConsoleDLAliasesTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleDLAliasesTab);
    R_setDomainAdminConsoleDLMembersTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleDLMembersTab);
    R_setDomainAdminConsoleDLNotesTab = rm.getAdminRight(Right.RT_setDomainAdminConsoleDLNotesTab);
    R_setDomainAdminConsoleDLSharesTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleDLSharesTab);
    R_setDomainAdminConsoleResourcesContactTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleResourcesContactTab);
    R_setDomainAdminConsoleResourcesPropertiesTab =
        rm.getAdminRight(Right.RT_setDomainAdminConsoleResourcesPropertiesTab);
    R_setDomainAdminDistributionListAttrs =
        rm.getAdminRight(Right.RT_setDomainAdminDistributionListAttrs);
    ...
    R_viewAdminConsoleAccountsAliasesTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleAccountsAliasesTab);
    R_viewAdminConsoleAccountsContactTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleAccountsContactTab);
    R_viewAdminConsoleAccountsFeaturesTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleAccountsFeaturesTab);
    R_viewAdminConsoleAccountsForwardingTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleAccountsForwardingTab);
    R_viewAdminConsoleAccountsFreeBusyInteropTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleAccountsFreeBusyInteropTab);
    R_viewAdminConsoleAccountsInfoTab = rm.getAdminRight(Right.RT_viewAdminConsoleAccountsInfoTab);
    R_viewAdminConsoleAccountsPreferencesTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleAccountsPreferencesTab);
    R_viewAdminConsoleAccountsThemesTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleAccountsThemesTab);
    R_viewAdminConsoleAccountsZimletsTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleAccountsZimletsTab);
    ...
    R_viewAdminConsoleCOSPreferencesTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleCOSPreferencesTab);
    R_viewAdminConsoleCOSServerPoolTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleCOSServerPoolTab);
    ...
    R_viewAdminConsoleDomainAuthenticationTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleDomainAuthenticationTab);
    R_viewAdminConsoleDomainDocumentsTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleDomainDocumentsTab);
    R_viewAdminConsoleDomainFreebusyTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleDomainFreebusyTab);
    ...
    R_viewAdminConsoleDomainVirtualHostsTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleDomainVirtualHostsTab);
    R_viewAdminConsoleDomainZimletsTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleDomainZimletsTab);
    ...
    R_viewAdminConsoleGlobalAttachmentsTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleGlobalAttachmentsTab);
    R_viewAdminConsoleGlobalBackupRestoreTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleGlobalBackupRestoreTab);
    R_viewAdminConsoleGlobalFreebusyTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleGlobalFreebusyTab);
    ...
    R_viewAdminConsoleGlobalLicenseTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleGlobalLicenseTab);
    ...
    R_viewAdminConsoleResourcesContactTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleResourcesContactTab);
    R_viewAdminConsoleResourcesPropertiesTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleResourcesPropertiesTab);
    R_viewAdminConsoleServerACLTab = rm.getAdminRight(Right.RT_viewAdminConsoleServerACLTab);
    R_viewAdminConsoleServerBackupRestoreTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleServerBackupRestoreTab);
    ...
    R_viewAdminConsoleServerServicesTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleServerServicesTab);
    R_viewAdminConsoleServerStatus = rm.getAdminRight(Right.RT_viewAdminConsoleServerStatus);
    R_viewAdminConsoleServerVolumesTab =
        rm.getAdminRight(Right.RT_viewAdminConsoleServerVolumesTab);
    R_viewAdminConsoleSoftwareUpdatesConfigAttrs =
        rm.getAdminRight(Right.RT_viewAdminConsoleSoftwareUpdatesConfigAttrs);
    R_viewAdminConsoleSoftwareUpdatesServerAttrs =
        rm.getAdminRight(Right.RT_viewAdminConsoleSoftwareUpdatesServerAttrs);
    ...
    R_viewDomainAdminConsoleAccountsAliasesTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleAccountsAliasesTab);
    R_viewDomainAdminConsoleAccountsContactTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleAccountsContactTab);
    R_viewDomainAdminConsoleAccountsFeaturesTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleAccountsFeaturesTab);
    R_viewDomainAdminConsoleAccountsForwardingTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleAccountsForwardingTab);
    R_viewDomainAdminConsoleAccountsFreeBusyInteropTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleAccountsFreeBusyInteropTab);
    R_viewDomainAdminConsoleAccountsInfoTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleAccountsInfoTab);
    R_viewDomainAdminConsoleAccountsThemesTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleAccountsThemesTab);
    R_viewDomainAdminConsoleAccountsZimletsTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleAccountsZimletsTab);
    R_viewDomainAdminConsoleDLAliasesTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleDLAliasesTab);
    R_viewDomainAdminConsoleDLMembersTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleDLMembersTab);
    R_viewDomainAdminConsoleDLNotesTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleDLNotesTab);
    R_viewDomainAdminConsoleDLSharesTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleDLSharesTab);
    R_viewDomainAdminConsoleResourcesContactTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleResourcesContactTab);
    R_viewDomainAdminConsoleResourcesPropertiesTab =
        rm.getAdminRight(Right.RT_viewDomainAdminConsoleResourcesPropertiesTab);
