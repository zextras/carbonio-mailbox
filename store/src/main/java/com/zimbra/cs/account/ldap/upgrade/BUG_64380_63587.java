...
public class BUG_64380_63587 extends UpgradeOp {
  ...
  private static List<Pair> VALUES =
      Lists.newArrayList(
          ...
          new Pair(
              "zimbraResources:(&(|(displayName=*%s*)(cn=*%s*)(sn=*%s*)(gn=*%s*)(mail=*%s*)(zimbraMailDeliveryAddress=*%s*)(zimbraMailAlias=*%s*))(objectclass=zimbraCalendarResource))",
          ...
          new Pair(
              "zimbraResourceAutoComplete:(&(|(displayName=%s*)(cn=%s*)(sn=%s*)(gn=%s*)(mail=%s*)(zimbraMailDeliveryAddress=%s*)(zimbraMailAlias=%s*))(objectclass=zimbraCalendarResource))",
  ...
  Description getDescription() {
    ...
    return new Description(
        ...
        newValues.toString(),
        String.format(
            "Upgrade zimbraSync, zimbraAccountSync, zimbraResourceSync, "
