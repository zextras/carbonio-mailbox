...
public abstract class DistributionList extends ZAttrDistributionList implements GroupedEntry {
  ...
  private static final class BasicInfo {
    ...
    public static GroupMembership mergeIntoGroupMembership(
  ...
  private static final Set<ObjectType> DISTRIBUTION_LISTS =
      Sets.newHashSet(ObjectType.distributionlists);
  private static final String[] BASIC_ATTRS = {
    Provisioning.A_zimbraId, Provisioning.A_zimbraIsAdminGroup, Provisioning.A_zimbraMailAlias
  };
  ...
  public static GroupMembership updateGroupMembership(
    ...
    try {
      ...
      BySearchResultEntrySearcher searcher =
          new BySearchResultEntrySearcher(prov, zlc, (Domain) null, BASIC_ATTRS, dlUpdator);
  ...
  public static GroupMembership updateGroupMembership(
    ...
    return updateGroupMembership(
        prov, zlc, membership, new BasicInfo(dl), via, adminGroupsOnly, directOnly);
  }
   ...
   * @return Updated membership
   */
  private static GroupMembership updateGroupMembership(
      LdapProvisioning prov,
      ZLdapContext zlc,
      GroupMembership membership,
      BasicInfo dl,
    ...
    try {
      ...
      List<BasicInfo> directDLs =
          getContainingDLs(prov, zlc, dl, adminGroupsOnly, true /* directOnly */);
  ...
  private static GroupMembership updateGroupMembership(
    ...
    try {
      ...
      List<BasicInfo> directDLs =
          getContainingDLs(prov, zlc, dls, adminGroupsOnly, true /* directOnly */);
      Iterator<BasicInfo> iter = directDLs.iterator();
      while (iter.hasNext()) {
        BasicInfo directDL = iter.next();
        if (membership.groupIds().contains(directDL.id)) {
  ...
  public static List<BasicInfo> getContainingDLs(
      LdapProvisioning prov,
      ZLdapContext zlc,
      BasicInfo dl,
      boolean adminGroupsOnly,
  ...
  private static class ContainingDLUpdator
    ...
    public void processSearchEntry(ZSearchResultEntry sr) {
      ...
      try {
        ...
        boolean isAdmin =
            (isAdminStr == null ? false : ProvisioningConstants.TRUE.equals(isAdminStr));
