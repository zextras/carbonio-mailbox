...
public class PresetRight extends AdminRight {
  ...
  boolean overlaps(Right other) throws ServiceException {
    if (other.isPresetRight()) return this == other;
    else if (other.isAttrRight()) return false;
    else if (other.isComboRight()) return ((ComboRight) other).containsPresetRight(this);
