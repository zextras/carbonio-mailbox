...
public class Domain extends ZAttrDomain {
  ...
  public Domain(
    ...
    if (name == null) mUnicodeName = name;
    else mUnicodeName = IDNUtil.toUnicodeDomainName(name);
    if (attrs != null) resetData();
  }
  ...
  public void getAllCalendarResources(Server s, NamedEntry.Visitor visitor)
