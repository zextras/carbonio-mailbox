...
public class ZLdapHelper extends LdapHelper {
  ...
  private ZModificationList getModList(
  ...
  @Override
  public boolean testAndModifyEntry(
      ZLdapContext zlc,
      String dn,
  ...
  public ZSearchResultEntry searchForEntry(
    ...
    try {
      ...
      */
      ...
      if (initZlc == null) LdapClient.closeContext(zlc);
    }
    return null;
  }
      ...
      if (zlc == null) {
        if (ldapServerType == null) {
          throw ServiceException.FAILURE(
              "Unexpected null ldapServerType with null ldap context.", null);
        }
        if (usage == null) {
  ...
  @Override
  protected long countEntriesByNoopSearch(
      String baseDN,
      ZLdapFilter filter,
      ZSearchControls searchControls,
      ZLdapContext initZlc,
