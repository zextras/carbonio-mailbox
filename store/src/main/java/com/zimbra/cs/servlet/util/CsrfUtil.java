...
public final class CsrfUtil {
   ...
   */
  public static boolean isCsrfRequestBasedOnReferrer(
      final HttpServletRequest req, final String[] allowedRefHost) throws MalformedURLException {
    ...
    if (ZimbraLog.soap.isDebugEnabled()) {
      ZimbraLog.soap.debug(
          "Host : %s, Referrer host :%s, Allowed Hosts:[%s] Soap req is %s",
          host,
          refHost,
          Joiner.on(',').join(allowedRefHostList),
  ...
  public static boolean isValidCsrfToken(String csrfToken, AuthToken authToken) {
    ...
    try {
      ...
      if (!validToken) {
        ...
        if (ZimbraLog.misc.isDebugEnabled()) {
          ZimbraLog.misc.debug(
              "The csrfToken second check: " + (validToken ? "is valid." : " is invalid."));
        }
      }
   ...
   */
  private static boolean validateCsrfToken(
      String hmacFromToken, String crumb, String keyVersion, boolean validToken, Account account)
  ...
  public static String generateCsrfToken(
      String accountId, long authTokenExpiration, int tokenSalt, AuthToken at)
      throws ServiceException {
   ...
   * @throws ServiceException
   */
  private static void storeTokenData(
      String data, AuthToken authToken, long authTokenExpiration, String crumb)
      throws ServiceException {
    Account account = getAccount(authToken, Boolean.TRUE);
    if (account != null) {
  ...
  public static String generateCsrfTokenTest(
      String accountId, long authTokenExpiration, int tokenSalt, String sessionId)
      throws AuthTokenException {
  ...
  public static void main(String args[]) {
    try {
      AuthToken at =
          ZimbraAuthToken.getAuthToken(
              "0_f66f9e23c3d6ec89c0723375489c729b13b108d9_69643d33363a34313537336365352d303035352d343066362d626235372d6264396238663136663666393b6578703d31333a313430333935303235363538323b747970653d363a7a696d6272613b7469643d31303a313837363638363831333b76657273696f6e3d303a3b637372663d313a313b");
