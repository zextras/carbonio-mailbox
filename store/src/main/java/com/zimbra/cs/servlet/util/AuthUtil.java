...
public class AuthUtil {
  ...
  public static AuthToken getAuthTokenFromHttpReq(HttpServletRequest req, boolean isAdminReq) {
    ...
    try {
      ...
      if (authToken.isExpired() || !authToken.isRegistered()) return null;
   ...
   */
  public static Account basicAuthRequest(
      HttpServletRequest req,
      HttpServletResponse resp,
  ...
  public static AuthResult basicAuthRequest(
      HttpServletRequest req,
      HttpServletResponse resp,
      boolean sendChallenge,
      ZimbraServlet servlet)
  ...
  public static Account basicAuthRequest(
      HttpServletRequest req, HttpServletResponse resp, boolean sendChallenge, boolean isDav)
      throws IOException, ServiceException {
    try {
  ...
  public static Account basicAuthRequest(HttpServletRequest req, boolean allowGuest, boolean isDav)
    ...
    if (loc == -1) {
      throw new UserServletException(
          HttpServletResponse.SC_BAD_REQUEST, "invalid basic auth credentials");
    }
    ...
    if (acct == null) {
      ...
      throw new UserServletException(
          HttpServletResponse.SC_UNAUTHORIZED, "invalid username/password");
    }
    try {
  ...
  public AuthToken cookieAuthRequest(HttpServletRequest req, HttpServletResponse resp)
      throws IOException, ServiceException {
    AuthToken at =
        AuthUtil.isAdminRequest(req)
            ? AuthUtil.getAdminAuthTokenFromCookie(req, resp, true)
            : AuthUtil.getAuthTokenFromCookie(req, resp, true);
    return at;
  }
  ...
  public static String getRedirectURL(
      HttpServletRequest req, Server server, boolean isAdminRequest, boolean relative)
