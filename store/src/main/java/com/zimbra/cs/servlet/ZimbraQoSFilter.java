...
/**
 * This Servlet {@link Filter} limits the number of concurrent HTTP requests per account.
 *
 * <p>It temporarily suspends the requests if exceeding the limit. The limit is configurable by
 * {@link LC#servlet_max_concurrent_http_requests_per_account}. To disable, set the LC key to 0 or
 * remove this servlet filter from web.xml.
 */
public class ZimbraQoSFilter implements Filter {
  ...
  private ConcurrentLinkedHashMap<String, Semaphore> passes =
      new ConcurrentLinkedHashMap.Builder<String, Semaphore>()
