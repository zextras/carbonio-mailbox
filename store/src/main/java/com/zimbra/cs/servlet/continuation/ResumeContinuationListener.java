...
/**
 * ContinuationListener implementation to handle internal details of when and when not to attempt
 * resume Application code which implements timeout + explicit resume should do so via this class
 */
