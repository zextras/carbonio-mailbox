...
/**
 * Indirect {@link Conversation} result. Efficient Read-access to a {@link Conversation} object
 * returned from a query.
 *
 * <p>This class may have a real {@link Conversation} under it, or it might just have a Lucene
 * Document, or something else -- the accessor APIs in this class will do the most efficient
 * possible lookup and caching for read access to the data.
 *
 * @since Oct 15, 2004
 * @author tim
 */
public final class ConversationHit extends ZimbraHit {
  ...
  /**
   * Returns the real {@link Conversation} object. Only use this if you need write access to the
   * Conversation.
   *
   * <p>Depending on the type of query that was executed, this may or may not result in a DB access
   *
