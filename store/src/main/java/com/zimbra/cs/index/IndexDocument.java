...
public final class IndexDocument {
  ...
  public void addPartName(String value) {
    document.add(
        new Field(LuceneFields.L_PARTNAME, value, Field.Store.YES, Field.Index.NOT_ANALYZED));
  }
  ...
  public void addMessageId(String value) {
    document.add(
        new Field(LuceneFields.L_H_MESSAGE_ID, value, Field.Store.NO, Field.Index.NOT_ANALYZED));
  }
  ...
  public void addContactData(String value) {
    document.add(
        new Field(LuceneFields.L_CONTACT_DATA, value, Field.Store.NO, Field.Index.ANALYZED));
  }
