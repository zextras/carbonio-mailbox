 ...
 *
 * <p>Very simple wrapper classes that each represent a node in the parse tree for the query string.
 *
 * @author tim
 * @author ysasaki
 */
public abstract class Query {
  ...
  /**
   * {@link StringBuilder} version of {@link #toString()} to efficiently concatenate multiple query
   * objects.
   *
   * <p>Sub classes may override if a special handling is required, such as conjunction.
   *
   * @param out output
  ...
  /**
   * Sub classes must implement this method to dump the internal information for debugging purpose.
   *
   * @param out output
   */
