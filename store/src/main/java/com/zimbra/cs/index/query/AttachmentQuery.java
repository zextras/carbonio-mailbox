...
public final class AttachmentQuery extends LuceneQuery {
  ...
  private static final ImmutableList<String> MS_WORD_TYPES =
      ImmutableList.of(
  ...
  private static final ImmutableList<String> MS_EXCEL_TYPES =
      ImmutableList.of(
  ...
  private static final ImmutableList<String> MS_POWERPOINT_TYPES =
      ImmutableList.of(
