 ...
 *
 * <p>For example: {@literal "Zimbra Japan" <support@zimbra.vmware.co.jp>} is tokenized as:
 *
 * <ul>
 *   <li>zimbra japan
 *   <li>zimbra
 ...
 * </ul>
 *
 * <p>We tokenize RFC822 addresses casually (relaxed parsing) and formally (strict parsing). We do
 * both in case strict parsing mistakenly strips tokens. This way, we might have false hits, but
 * won't have hit miss.
 *
 * @author ysasaki
 */
