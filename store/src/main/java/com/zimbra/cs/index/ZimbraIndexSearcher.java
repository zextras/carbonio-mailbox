...
public interface ZimbraIndexSearcher extends Closeable {
   ...
   * if non-null, and sorting the hits by the criteria in sort. NOTE: this does not compute scores
   * by default; use setDefaultFieldSortScoring(boolean, boolean) to enable scoring.
   */
