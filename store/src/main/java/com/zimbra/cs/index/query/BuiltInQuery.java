 ...
 * Built-in queries.
 *
 * <p>Use {@link #getQuery(String, Mailbox, Analyzer, int)} to create an instance.
 *
 * @author tim
 * @author ysasaki
 */
public abstract class BuiltInQuery {
  ...
  public static Query getQuery(String name, Mailbox mailbox, Analyzer analyzer)
  ...
  private static final Map<String, BuiltInQuery> BUILTIN_QUERIES =
      ImmutableMap.<String, BuiltInQuery>builder()
          .put(
              "read",
              new BuiltInQuery() {
                @Override
          ...
          .put(
              ...
              new BuiltInQuery() {
                @Override
                Query create(Mailbox mbox, Analyzer analyzer) throws ServiceException {
                  return MeQuery.create(
                      mbox, analyzer, EnumSet.of(AddrQuery.Address.TO, AddrQuery.Address.FROM));
                }
              })
          .put(
              "toccme",
              new BuiltInQuery() {
                ...
                Query create(Mailbox mbox, Analyzer analyzer) throws ServiceException {
                  return MeQuery.create(
                      mbox, analyzer, EnumSet.of(AddrQuery.Address.TO, AddrQuery.Address.CC));
                }
              })
          .put(
              "fromccme",
              new BuiltInQuery() {
                ...
                Query create(Mailbox mbox, Analyzer analyzer) throws ServiceException {
                  return MeQuery.create(
                      mbox, analyzer, EnumSet.of(AddrQuery.Address.FROM, AddrQuery.Address.CC));
                }
              })
          .put(
              "tofromccme",
              new BuiltInQuery() {
                ...
                Query create(Mailbox mbox, Analyzer analyzer) throws ServiceException {
                  return MeQuery.create(
                      ...
                      analyzer,
                      EnumSet.of(
                          AddrQuery.Address.TO, AddrQuery.Address.FROM, AddrQuery.Address.CC));
                }
              })
          .build();
}
