 ...
 *
 * <p>This is not the same as a {@link NoResultsQueryOperation} because:
 *
 * <ul>
 ...
 * </ul>
 *
 * Basically, this pseudo-Operation is here to handle the situation when a Lucene term evaluates to
 * the empty string (as might happen if a stop-word were searched for, e.g. searching for "the") --
 * by generating a special-purpose Pseudo-Operation for this case we can hand-tune the Optimizer
 * behavior and make it do the right thing in all cases.
 *
 * @author tim
 */
