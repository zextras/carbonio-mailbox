...
public abstract class ZMutableEntry extends ZEntry {
  ...
  /**
   * Sets the provided attribute to this entry. If this entry already contains an attribute with the
   * same name, then the current value will be *replaced* by the new value.
   */
  public abstract void setAttr(String attrName, String value);

  /**
   * Adds the provided attribute to this entry. If this entry already contains an attribute with the
   * same name, then their values will be *merged*.
   */
