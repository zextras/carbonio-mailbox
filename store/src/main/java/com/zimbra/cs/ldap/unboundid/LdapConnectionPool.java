...
public class LdapConnectionPool {
  ...
  static LDAPConnectionPool createConnectionPool(String connPoolName, LdapServerConfig config)
    ...
    GetEntryLDAPConnectionPoolHealthCheck healthChecker =
  ...
  private static synchronized LDAPConnectionPool getConnPool(
      String connPoolName, ExternalLdapConfig config) throws LdapException {
  ...
  static LDAPConnectionPool getConnPoolByConfig(ExternalLdapConfig config) throws LdapException {
  ...
  private static class DebugConnPool {
    ...
    private static synchronized void checkIn(LDAPConnectionPool connPool, LDAPConnection conn) {
      ...
      for (Iterator<CheckedOutInfo> it = checkedOutFromPool.checkedOutConns.iterator();
          it.hasNext(); ) {
