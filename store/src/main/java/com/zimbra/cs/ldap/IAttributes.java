...
public interface IAttributes {
  ...
  /**
   * - If a method does not have a CheckBinary parameter, it will *not* check for binary data and
  ...
  public String[] getMultiAttrString(
      String attrName, boolean containsBinaryData, boolean isBinaryTransfer)
