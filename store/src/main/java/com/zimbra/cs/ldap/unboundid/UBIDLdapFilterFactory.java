...
public class UBIDLdapFilterFactory extends ZLdapFilterFactory {
  ...
  private static void _initialize() throws LDAPException {
    ...
    FILTER_HAB_GROUPS = Filter.createANDFilter(FILTER_ALL_HAB_GROUPS);
  ...
  public ZLdapFilter hasSubordinates() {
    return new UBIDLdapFilter(FilterId.HAS_SUBORDINATES, FILTER_HAS_SUBORDINATES);
  }
  ...
  public ZLdapFilter anyEntry() {
    return new UBIDLdapFilter(FilterId.ANY_ENTRY, FILTER_ANY_ENTRY);
  }

  @Override
  public ZLdapFilter fromFilterString(FilterId filterId, String filterString) throws LdapException {
    try {
      return new UBIDLdapFilter(filterId, Filter.create(encloseFilterIfNot(filterString)));
    } catch (LDAPException e) {
  ...
  public ZLdapFilter andWith(ZLdapFilter filter, ZLdapFilter otherFilter) {
    ...
    try {
      andedFilter =
          new UBIDLdapFilter(
              filter.getFilterId(), // use filter id of the filter to which the other filter is
              // appended.
              Filter.createANDFilter(
                  ((UBIDLdapFilter) filter).getNative(),
                  ((UBIDLdapFilter)
  ...
  public ZLdapFilter negate(ZLdapFilter filter) {
    return new UBIDLdapFilter(
        filter.getFilterId(), Filter.createNOTFilter(((UBIDLdapFilter) filter).getNative()));
  }
  ...
  public ZLdapFilter allAccounts() {
    return new UBIDLdapFilter(FilterId.ALL_ACCOUNTS, FILTER_ALL_ACCOUNTS);
  }

  @Override
  public ZLdapFilter allAccountsOnly() {
    return new UBIDLdapFilter(FilterId.ALL_ACCOUNTS_ONLY, FILTER_ALL_ACCOUNTS_ONLY);
  }
  ...
  public ZLdapFilter allAdminAccounts() {
    return new UBIDLdapFilter(FilterId.ALL_ADMIN_ACCOUNTS, FILTER_ALL_ADMIN_ACCOUNTS);
  }

  @Override
  public ZLdapFilter allNonSystemAccounts() {
    return new UBIDLdapFilter(FilterId.ALL_NON_SYSTEM_ACCOUNTS, FILTER_ALL_NON_SYSTEM_ACCOUNTS);
  }
  ...
  public ZLdapFilter homedOnServer(String serverServiceHostname) {
    return new UBIDLdapFilter(FilterId.HOMED_ON_SERVER, homedOnServerFilter(serverServiceHostname));
  }
  ...
  public ZLdapFilter allAliases() {
    return new UBIDLdapFilter(FilterId.ALL_ALIASES, FILTER_ALL_ALIASES);
  }
  ...
  public ZLdapFilter allCalendarResources() {
    return new UBIDLdapFilter(FilterId.ALL_CALENDAR_RESOURCES, FILTER_ALL_CALENDAR_RESOURCES);
  }
  ...
  public ZLdapFilter allCoses() {
    return new UBIDLdapFilter(FilterId.ALL_COSES, FILTER_ALL_COSES);
  }
  ...
  public ZLdapFilter allDataSources() {
    return new UBIDLdapFilter(FilterId.ALL_DATA_SOURCES, FILTER_ALL_DATASOURCES);
  }
  ...
  public ZLdapFilter allDistributionLists() {
    return new UBIDLdapFilter(FilterId.ALL_DISTRIBUTION_LISTS, FILTER_ALL_DISTRIBUTION_LISTS);
  }
  ...
  public ZLdapFilter allGroups() {
    return new UBIDLdapFilter(FilterId.ALL_GROUPS, FILTER_ALL_GROUPS);
  }

  @Override
  public ZLdapFilter allHabGroups() {
    return new UBIDLdapFilter(FilterId.ALL_GROUPS, FILTER_ALL_HAB_GROUPS);
  }
  ...
  public ZLdapFilter allDomains() {
    return new UBIDLdapFilter(FilterId.ALL_DOMAINS, FILTER_ALL_DOMAINS);
  }
    ...
    return new UBIDLdapFilter(
        ...
        Filter.createANDFilter(
            Filter.createEqualityFilter(
                ...
                id), // zimbraDomainAliasTargetId is indexed, bug 72309
            FILTER_ALL_DOMAINS,
            Filter.createEqualityFilter(
  ...
  public ZLdapFilter domainLabel() {
    return new UBIDLdapFilter(FilterId.DOMAIN_LABEL, FILTER_DOMAIN_LABEL);
  }
  ...
  public ZLdapFilter allIdentities() {
    return new UBIDLdapFilter(FilterId.ALL_IDENTITIES, FILTER_ALL_IDENTITIES);
  }
  ...
  public ZLdapFilter allMimeEntries() {
    return new UBIDLdapFilter(FilterId.ALL_MIME_ENTRIES, FILTER_ALL_MIME_ENTRIES);
  }
  ...
  public ZLdapFilter allServers() {
    return new UBIDLdapFilter(FilterId.ALL_SERVERS, FILTER_ALL_SERVERS);
  }
  ...
  public ZLdapFilter allSignatures() {
    return new UBIDLdapFilter(FilterId.ALL_SIGNATURES, FILTER_ALL_SIGNATURES);
  }
  ...
  /**
   * DistributionLists in customDIT do not have the "zimbraMailDeliveryAddress" attribute. From an
   * earlier comment in CustomLdapDIT we can't tell whether the main email is "zimbraMailAlias" or
   * "mail". So, accept either.
   */
  @Override
  ...
  public ZLdapFilter allAddressLists() {
    return new UBIDLdapFilter(FilterId.ALL_ADDRESS_LISTS, FILTER_ALL_ADDRESS_LISTS);
  }
