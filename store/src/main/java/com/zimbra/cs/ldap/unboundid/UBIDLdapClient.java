...
public class UBIDLdapClient extends LdapClient {
  ...
  @Override
  protected ZLdapContext getContextImpl(
  ...
  @Override
  protected void externalLdapAuthenticateImpl(
      String[] urls, boolean wantStartTLS, String bindDN, String password, String note)
      throws ServiceException {
    UBIDLdapContext.externalLdapAuthenticate(urls, wantStartTLS, bindDN, password, note);
  }
