...
public abstract class ZSearchControls {
  ...
  public static ZSearchControls SEARCH_CTLS_SUBTREE() {
    return createSearchControls(
        ZSearchScope.SEARCH_SCOPE_SUBTREE, SIZE_UNLIMITED, RETURN_ALL_ATTRS);
  }

  public static ZSearchControls createSearchControls(
      ZSearchScope searchScope, int sizeLimit, String[] returnAttrs) {
    return LdapClient.getInstance().createSearchControlsImpl(searchScope, sizeLimit, returnAttrs);
  }
}
