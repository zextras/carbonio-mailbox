...
public enum LdapUsage {
  ...
  public static LdapUsage modifyEntryfromEntryType(Entry.EntryType entryType) {
    switch (entryType) {
      ...
      case ADDRESS_LIST:
        return MODIFY_ADDRESS_LIST;
      case ALIAS:
        return MODIFY_ALIAS;
      case CALRESOURCE:
        return MODIFY_CALRESOURCE;
      case COS:
        return MODIFY_COS;
      case DATASOURCE:
        return MODIFY_DATASOURCE;
      case DISTRIBUTIONLIST:
        return MODIFY_DISTRIBUTIONLIST;
      case DOMAIN:
        return MODIFY_DOMAIN;
      case DYNAMICGROUP:
        return MODIFY_DYNAMICGROUP;
      case GLOBALCONFIG:
        return MODIFY_GLOBALCONFIG;
      case GLOBALGRANT:
        return MODIFY_GLOBALGRANT;
      case IDENTITY:
        return MODIFY_IDENTITY;
      case MIMETYPE:
      ...
      case XMPPCOMPONENT:
        return MODIFY_XMPPCOMPONENT;
      case ZIMLET:
        return MODIFY_ZIMLET;
      default:
        return MODIFY_ENTRY;
    }
  }
