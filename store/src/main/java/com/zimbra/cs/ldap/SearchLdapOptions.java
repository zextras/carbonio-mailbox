...
public class SearchLdapOptions {
  ...
  */
  ...
  public abstract static class SearchLdapVisitor {
    ...
    /**
     * invoked for each hit returned from the LDAP server, when wantAttrMapOnVisit is true.
     *
     * @param dn
     * @param attrs
     * @param ldapAttrs
     * @throws StopIteratingException Indicating to the search result iterator to stop iterating the
     *     remaining LDAP search result and calling the visit method.
     */
    public void visit(String dn, Map<String, Object> attrs, IAttributes ldapAttrs)
    ...
    /**
     * invoked for each hit returned from the LDAP server, when wantAttrMapOnVisit is false.
     *
     * @param dn
     * @param attrs
     * @param ldapAttrs
