...
public class ExchangeMessage {
  ...
  public static final Namespace NS_MSFT =
      Namespace.get("b", "http://schemas.microsoft.com/mapi/proptag/");
  public static final Namespace NS_WEB_FOLDERS =
      Namespace.get("e", "urn:uuid:c2f41010-65b3-11d1-a29f-00aa00c14882/");
  ...
  public static final QName PR_DECLINE_RECURRING_MEETING_REQUESTS =
      QName.get("0x686E000B", NS_MSFT);
  public static final QName PR_DECLINE_CONFLICTING_MEETING_REQUESTS =
      QName.get("0x686F000B", NS_MSFT);
  ...
  protected String getRcpt(KnownKey override) {
    ...
    if (value != null && value.length() > 0) return "/cn=" + value + "/cn=";
    return PUBURL_RCPT;
  }
  ...
  public Document createRequest(FreeBusy fb) {
    ...
    encodeIntervals(
        fb, startMonth, endMonth, IcalXmlStrMap.FBTYPE_BUSY, busyMonths, busyEvents, consolidated);
    encodeIntervals(
        fb,
        startMonth,
        endMonth,
        IcalXmlStrMap.FBTYPE_BUSY_TENTATIVE,
        tentativeMonths,
        tentativeEvents,
        consolidated);
    encodeIntervals(
        ...
        startMonth,
        endMonth,
        IcalXmlStrMap.FBTYPE_BUSY_UNAVAILABLE,
        oofMonths,
        oofEvents,
        consolidated);
    encodeIntervals(
        consolidated, startMonth, endMonth, IcalXmlStrMap.FBTYPE_BUSY, allMonths, allEvents, null);
    return new DefaultDocument(root);
  }

  private void encodeIntervals(
      Iterable<Interval> fb,
      long startMonth,
      long endMonth,
      String type,
      Element months,
  ...
  public HttpRequestBase createMethod(String uri, FreeBusy fb) throws IOException {
    ...
    if (ZimbraLog.fb.isDebugEnabled()) ZimbraLog.fb.debug(new String(buf, "UTF-8"));
  ...
  private Element addElement(Element parent, QName name, String text, QName attr, String attrVal) {
    ...
    if (attr != null && attrVal != null) el.addAttribute(attr, attrVal);
    return el;
  }
