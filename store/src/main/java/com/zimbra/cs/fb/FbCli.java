...
public class FbCli {
  ...
  public Collection<FbProvider> getAllFreeBusyProviders()
  ...
  public Collection<FbQueue> getFreeBusyQueueInfo(String provider)
      throws ServiceException, IOException, HttpException {
  ...
  public void pushFreeBusyForDomain(String domain)
      throws ServiceException, IOException, HttpException {
    try {
      auth();
  ...
  public void pushFreeBusyForAccounts(Collection<String> accounts)
      throws ServiceException, IOException, HttpException {
    try {
      auth();
      XMLElement req = new XMLElement(AdminConstants.PUSH_FREE_BUSY_REQUEST);
  ...
  public void purgeFreeBusyQueue(String provider)
      throws ServiceException, IOException, HttpException {
    try {
      auth();
