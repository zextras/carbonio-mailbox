...
public class Version {
  ...
  /**
   * Returns a version object with latest major and minor version supported by code.
   *
   * @return
   */
   ...
   *
   * @return true if this version is higher than or equal to major/minor, false if this version is
   *     lower
   */
  public boolean atLeast(int major, int minor) {
    return (mMajorVer > major || (mMajorVer == major && mMinorVer >= minor));
  }

  /**
   * Returns if this version is at least as high as version b.
   *
   * @return true if this version is higher than or equal to version b, false if this version is
   *     lower than version b
   */
  ...
  public boolean tooHigh() {
    return (mMajorVer > CURRENT_MAJOR || (mMajorVer == CURRENT_MAJOR && mMinorVer > CURRENT_MINOR));
  }
