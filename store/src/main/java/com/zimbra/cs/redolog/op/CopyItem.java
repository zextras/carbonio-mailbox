...
public class CopyItem extends RedoableOp {
  ...
  protected String getPrintableData() {
    ...
    if (mFromDumpster) sb.append(", fromDumpster=").append(mFromDumpster);
    return sb.toString();
  }
  ...
  public void redo() throws Exception {
    ...
    try {
      if (!mFromDumpster) mbox.copy(getOperationContext(), itemIds, type, mDestFolderId);
      else mbox.recover(getOperationContext(), itemIds, type, mDestFolderId);
