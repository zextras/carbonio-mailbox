...
/**
 * This class is equivalent to java.io.DataInputStream except that readUTF() method doesn't have
 * 64KB limit thanks to using a different serialization format. (thus incompatible with
 * DataInputStream) This class is not derived from DataInputStream and does not implement DataInput
 * interface, to prevent using either of those in redo log operation classes.
 *
 * @author jhahm
 */
public class RedoLogInput {
  ...
  /**
   * Returns the path to the redo log file, or <tt>null</tt> if this object reads from an
   * <tt>InputStream</tt>.
   */
  ...
  /**
   * Returns the current offset in this file, or <tt>-1</tt> if this object reads from an
   * <tt>InputStream</tt>.
   */
