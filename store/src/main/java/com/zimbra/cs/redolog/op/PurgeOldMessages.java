...
/**
 * Purge old messages. The arguments to this operation are mailbox ID and operation timestamp, both
 * of which are managed by the superclass. See Mailbox.purgeMessages() for more info.
 */
