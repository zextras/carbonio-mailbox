...
/**
 * @author jhahm
 *     <p>A Checkpoint record is written at the end of a redolog file as it is rolled over. It lists
 *     all uncommitted (i.e. in-progress) operations at the time of log rollover. Currently
 *     checkpoint information is not used. One potential use is logfile validity check.
 */
