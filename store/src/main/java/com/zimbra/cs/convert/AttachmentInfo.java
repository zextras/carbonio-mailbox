...
/**
 * Represents an attachment to a message or a piece of content within an archive-type attachment.
 *
 * @author kchen
 */
public class AttachmentInfo {
  ...
  public AttachmentInfo(
      InputStream in, String digest, String ct, String p, String filename, long length) {
  ...
  /**
   * @return the digest of the containing message. This is the digest computed over the body of the
   *     message plus all its attachments.
   */
  ...
  /**
   * @return the relative file path to the converted main HTML file. Its general construct is: <msg
   *     digest>/<attachment part id>[/<seq id1>/<seq id2>/.../<seq idn>].html where <seq idn>
   *     refers to the sequence ID for content piece within an archive type attachment. They are not
   *     applicable if the attachment is not archive type.
   */
