...
public class TagUtil {
  ...
  @Deprecated
  public static String[] tagIdStringToNames(
      Mailbox mbox, OperationContext octxt, String tagIdString) throws ServiceException {
  ...
  @Deprecated
  public static String[] tagBitmaskToNames(Mailbox mbox, OperationContext octxt, long tagBitmask)
  ...
  @Deprecated
  public static String tagIdToName(Mailbox mbox, OperationContext octxt, int tagId)
      throws ServiceException {
  ...
  public static String[] parseTags(Element elt, Mailbox mbox, OperationContext octxt)
      throws ServiceException {
