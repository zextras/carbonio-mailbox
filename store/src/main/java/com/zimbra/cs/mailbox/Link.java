...
public class Link extends Document {
  ...
  static Link create(
    ...
    ZimbraLog.mailop.info(
        "Adding Link %s: id=%d, parentId=%d, parentName=%s.",
  ...
  Metadata encodeMetadata(Metadata meta) {
    return encodeMetadata(
        meta, mRGBColor, mMetaVersion, mVersion, mOwnerId, mRemoteId, mExtendedData);
  }
  ...
  private static String encodeMetadata(
    ...
    return encodeMetadata(new Metadata(), color, metaVersion, version, owner, remoteId, extended)
        .toString();
  }
