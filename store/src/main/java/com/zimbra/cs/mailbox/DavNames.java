...
/**
 * Utility class to handle EXCEPTIONS to the conventional DAV name scheme. This is typically needed
 * when a client chooses the name for an item on creation via the PUT method and that name doesn't
 * follow our preferred convention. TODO: Make these names persistent rather than in memory.
 */
public class DavNames {
  public static final class DavName {
    ...
    public String toString() {
      StringBuilder sb =
          new StringBuilder("DavName:mbox=")
              .append(mailbox_id)
              .append(" folder=")
              .append(folder_id)
              .append(" name=")
  ...
  public static final class MboxAndId {
    ...
    public String toString() {
      StringBuilder sb =
          new StringBuilder("MboxAndId:mbox=").append(mailbox_id).append(" item=").append(item_id);
      return sb.toString();
    }
  ...
  private static final Map<MboxAndId, DavName> idToName =
      new ConcurrentHashMap<MboxAndId, DavName>();
