...
public class MemcachedItemCache {
  ...
  MemcachedItemCache() {
    ...
    memcachedLookup =
        new MemcachedMap<ItemCacheKey, Metadata>(memcachedClient, new MailItemSerializer(), false);
    memcachedUuidLookup =
        new MemcachedMap<ItemCacheUuidKey, Integer>(
            memcachedClient, new IntegerSerializer(), false);
  }
