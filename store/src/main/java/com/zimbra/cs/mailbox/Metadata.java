...
public final class Metadata {
  ...
  @Deprecated public static final String FN_RIGHTS = "acl";
  ...
  @Deprecated
  public static final String FN_MD_VERSION =
      "v"; // metadata version; frozen but needs to be encoded for legacy clients
  ...
  public Metadata(String encoded, Integer associatedItemId) throws MailServiceException {
    ...
    try {
      try {
        ...
        // Bug 87718 in some instances, it appears that an encoded string is getting corrupted by
        // being
        // treated at some point as if the bytes were ISO-8859-1 instead of UTF-8.  Try again with
        // this reversed.
        // If this works, the internal lengths will have gotten corrected, so there is a fair chance
        // this has
  ...
  private static StringBuilder prettyEncode(StringBuilder sb, Object object, int indentLevel) {
    if (object instanceof Map) {
      SortedMap<?, ?> tree =
          object instanceof SortedMap
              ? (SortedMap<?, ?>) object
              : new TreeMap<Object, Object>((Map<?, ?>) object);
      sb.append("{\n");
  ...
  public static void main(String[] args) throws MailServiceException {
    String encoded =
        "d1:ai1e4:aclmd1:gld1:ei0e1:g36:474b7021-cef6-469d-b5fb-54c96117efd11:ri1e1:ti1eee2:gei0e2:iei0ee5:mdveri4e4:mseqi628e2:szi7596456e4:unxti744e1:vi10e2:vti5ee";
