 ...
 *
 * <p>period = period-explicit / period-start
 *
 * <p>period-explicit = date-time "/" date-time ; [ISO 8601] complete representation basic format
 * for a period of ; time consisting of a start and end. The start MUST be before the ; end.
 *
 * <p>period-start = date-time "/" dur-value ; [ISO 8601] complete representation basic format for a
 * period of ; time consisting of a start and positive duration of time.
 */
