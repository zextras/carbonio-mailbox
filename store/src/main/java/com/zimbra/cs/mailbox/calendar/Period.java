...
public class Period {
    ...
    private final ParsedDateTime mStart;  // DATE-TIME in UTC or local without TZ
    private final ParsedDateTime mEnd;    // DATE-TIME in UTC or local without TZ
    private final ParsedDuration mDuration;
