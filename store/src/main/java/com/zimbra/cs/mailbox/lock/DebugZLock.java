...
/**
 * Extension of ZLock for debugging; enabled via DebugConfig.debugMailboxLock (debug_mailbox_lock in
 * localconfig) Used to track read lock owners since they are not tracked by base
...
public class DebugZLock extends ZLock {
  ...
  private class DebugReentrantReadLock extends ReentrantReadWriteLock.ReadLock {
    ...
    private final ConcurrentMap<Long, MailboxLockOwner> debugReadOwners =
        new ConcurrentHashMap<Long, MailboxLockOwner>();
