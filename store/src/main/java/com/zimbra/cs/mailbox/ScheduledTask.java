...
public abstract class ScheduledTask<V> implements Callable<V> {
  ...
  /** Returns the mailbox id, or <tt>0</tt> if this task is not specific to a mailbox. */
  ...
  /** Returns the recurrence interval, or <tt>0</tt> if this is not a recurring task. */
  ...
  public String toString() {
    return String.format(
        "%s: { name=%s, mailboxId=%d, execTime=%s, intervalMillis=%d }",
