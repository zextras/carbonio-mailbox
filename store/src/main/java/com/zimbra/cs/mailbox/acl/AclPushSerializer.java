...
public class AclPushSerializer {
  ...
  public static String serialize(
      ...
      String itemUuid,
      String path,
      MailItem.Type folderDefaultView,
      MailItem.Type type,
      String granteeId,
      String granteeName,
      byte granteeType,
      ...
      try {
        switch (granteeType) {
          ...
          case ACL.GRANTEE_GROUP:
            DistributionList granteeDL =
                Provisioning.getInstance().get(Key.DistributionListBy.id, granteeId);
            if (granteeDL != null) {
    ...
    StringBuilder sb =
        new StringBuilder()
            ...
            .append(granteeName)
            .append(";granteeType:")
            .append(ACL.typeToString(granteeType))
            .append(";folderId:")
            .append(itemId)
            .append(";folderUuid:")
            .append(itemUuid)
            .append(";folderPath:")
            .append(path)
            .append(";folderDefaultView:")
            .append(folderDefaultView)
            .append(";rights:")
            .append(ACL.rightsToString(rights))
            .append(";type:")
            .append(type);
    if (expiry != 0) {
