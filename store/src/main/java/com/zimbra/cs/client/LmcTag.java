...
public class LmcTag {
  ...
  /**
   * @return the optional unread count. Check to see if the unread count is valid before calling
   *     this method. If not valid, this method will throw an IllegalStateException.
   * @throws IllegalStateException
   */
  public long getUnreadCount() throws IllegalStateException {
    if (!isUnreadCountValid) throw new IllegalStateException("Unread count not valid");
    else return mUnreadCount;
  }
