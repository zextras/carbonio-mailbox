...
public class LmcMimePart {
  ...
  public void setSubParts(LmcMimePart s[]) {
    subParts = s;
  }

  public void setConvID(String c) {
    convID = c;
  }
  ...
  public void setPartName(String m) {
    partName = m;
  }
  ...
  public void setContentTypeName(String c) {
    contentTypeName = c;
  }

  public void setContentDisp(String c) {
    contentDisp = c;
  }

  public void setContentDispFilename(String c) {
    contentDispFilename = c;
  }
  ...
  public void setContentEncoding(String c) {
    contentEncoding = c;
  }
  ...
  private static String findBodyContent(LmcMimePart parent) {
    if (parent.isBody()) return parent.getContent();
