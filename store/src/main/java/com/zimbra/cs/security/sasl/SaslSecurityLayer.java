...
/**
 * Class used to wrap either SaslServer or SaslClient and lift out common methods related to the
 * negotiated security layer as well as add some new convenience methods.
 */
public abstract class SaslSecurityLayer {
  ...
  /**
   * Returns true if a security layer (either integrity or confidentiality) is enabled for the
   * associated SaslClient or SaslServer.
   *
