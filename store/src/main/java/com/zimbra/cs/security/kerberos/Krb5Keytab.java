 ...
 *
 * <p>See <a href="http://www.ioplex.com/utilities/keytab.txt">The Kerberos Keytab Binary File
...
public class Krb5Keytab {
   ...
   * @throws IOException if the keytab file format was invalid, or an I/O error ocurred
   */
   ...
   * @return the Krb5Keytab representing the keytab contents
   * @throws FileNotFoundException if the keytab file was not found
   * @throws IOException if the keytab file format was invalid, or an I/O error occurred
   */
  ...
  /**
   * Returns the list of Kerberos keys for the specified principal in the keytab. Returns null if
   ...
   * @throws IOException if the keytab file required reloading and was invalid or an I/O error
   *     occurred
   */
  ...
  private void loadKeytab() throws IOException {
    ...
    try {
      ...
      if (version != VERSION_1 && version != VERSION_2) {
        throw formatError("Unsupported file format version 0x" + Integer.toHexString(version));
      }
      keyMap.clear();
  ...
  private KerberosPrincipal getPrincipal(ByteBuffer bb) throws IOException {
    ...
    int type = version == VERSION_1 ? KerberosPrincipal.KRB_NT_PRINCIPAL : bb.getInt();
