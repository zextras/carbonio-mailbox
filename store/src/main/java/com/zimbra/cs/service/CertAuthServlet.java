...
public class CertAuthServlet extends SSOServlet {
  ...
  private static final Pattern allowedUrl =
      Pattern.compile("^(/service/certauth)(/|/(admin)(/)?)?$");
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    try {
      ...
      AuthToken authToken =
          authorize(req, AuthContext.Protocol.client_certificate, principal, isAdminRequest);
  ...
  private void dispatchOnError(
      HttpServletRequest req, HttpServletResponse resp, boolean isAdminRequest, String msg)
      throws ServletException, IOException {
