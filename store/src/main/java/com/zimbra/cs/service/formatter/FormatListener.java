...
/**
 * Interface for classes which need to known when a formatter is running For example if a background
 * process needs to suspend while a particular formatting routine occurs
 */
