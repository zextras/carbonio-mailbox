...
public class GetMailbox extends AdminDocumentHandler {
  ...
  private static final String[] TARGET_ACCOUNT_PATH =
      new String[] {AdminConstants.E_MAILBOX, AdminConstants.A_ACCOUNTID};
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    GetMailboxResponse resp =
        new GetMailboxResponse(new MailboxWithMailboxId(mbox.getId(), null, mbox.getSize()));
