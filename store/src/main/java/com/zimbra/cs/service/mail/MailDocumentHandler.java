...
public abstract class MailDocumentHandler extends DocumentHandler {
  ...
  protected static ItemId getProxyTarget(
      ZimbraSoapContext zsc, OperationContext octxt, ItemId iid, boolean checkMountpoint)
      throws ServiceException {
    ...
    if (!checkMountpoint || !Provisioning.getInstance().onLocalServer(acct)) {
      return null;
    }
  ...
  private void insertMountpointReferences(
      Element response,
      String[] xpath,
      ItemId iidMountpoint,
      ItemId iidLocal,
  ...
  protected Element proxyRequest(
      Element request, Map<String, Object> context, ItemId iidRequested, ItemId iidResolved)
      throws ServiceException {
  ...
  private Element proxyRequest(
      Element request, Map<String, Object> context, String acctId, boolean mountpoint)
      throws ServiceException {
    ZimbraSoapContext zsc = getZimbraSoapContext(context);
