...
/**
 * Returns data from the encapsulated stream until <tt>CRLFCRLF</tt> is reached. The trailing
 * <tt>CRLFCRLF</tt> is read from the wrapped stream, but is not returned by the <tt>read()</tt>
 * methods in <tt>HeadersOnlyInputStream</tt>.
 */
