...
public class GetAllEffectiveRights extends RightDocumentHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    RightCommand.AllEffectiveRights aer =
  ...
  public void docRights(List<AdminRight> relatedRights, List<String> notes) {
    ...
    notes.add(
        "If grantee to check for is an account, needs the "
            + Admin.R_checkRightUsr.getName()
            + " right");
    notes.add(
        "If grantee to check for is a group, needs the "
            + Admin.R_checkRightGrp.getName()
            + " right");
  }
}
