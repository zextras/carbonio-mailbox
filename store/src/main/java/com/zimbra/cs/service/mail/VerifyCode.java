  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    if (SendVerificationCode.emailToCodeMap.containsKey(emailAddr)) {
      ...
      ZimbraLog.misc.debug(
          "Verification code for %s has either not been generated or has expired", emailAddr);
    }
    return zsc.createElement(MailConstants.VERIFY_CODE_RESPONSE)
        .addAttribute(MailConstants.A_VERIFICATION_SUCCESS, success ? "1" : "0");
  }
}
