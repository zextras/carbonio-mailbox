...
public class GetNote extends MailDocumentHandler {
  ...
  private static final String[] TARGET_NOTE_PATH =
      new String[] {MailConstants.E_NOTE, MailConstants.A_ID};
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    if (note == null) throw MailServiceException.NO_SUCH_NOTE(iid.getId());
