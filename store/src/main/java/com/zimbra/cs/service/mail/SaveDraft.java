...
public class SaveDraft extends MailDocumentHandler {
  ...
  private static final String[] TARGET_DRAFT_PATH =
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    if (folderId != null || flags != null || !ArrayUtil.isEmpty(tags) || color != null) {
      try {
        ...
        ZimbraLog.soap.warn(
            "error setting metadata for draft " + msg.getId() + "; skipping that operation", e);
      }
    }
  ...
  protected Element generateResponse(
    ...
    try {
      ...
      ZimbraLog.soap.info(
          "draft was deleted while serializing response; omitting <m> from response");
    } catch (ServiceException e) {
