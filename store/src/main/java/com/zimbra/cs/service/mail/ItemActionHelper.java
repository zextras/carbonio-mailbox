...
public class ItemActionHelper {
  ...
  public static ItemActionHelper TAG(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      MailItem.Type type,
      String tagName,
      boolean flagValue,
    ...
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.TAG, type, flagValue, tcon);
    ia.setTagName(tagName);
    ia.schedule();
    return ia;
  }

  public static ItemActionHelper FLAG(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.FLAG, type, flagValue, tcon);
    ia.schedule();
    return ia;
  }

  public static ItemActionHelper PRIORITY(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.PRIORITY, type, flagValue, tcon);
    ia.schedule();
    return ia;
  }

  public static ItemActionHelper READ(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.READ, type, flagValue, tcon);
    ia.schedule();
    return ia;
  }

  public static ItemActionHelper COLOR(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.COLOR, type, true, tcon);
    ia.setColor(color);
    ia.schedule();
    return ia;
  }

  public static ItemActionHelper HARD_DELETE(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.HARD_DELETE, type, true, tcon);
    ia.schedule();
    return ia;
  }

  public static ItemActionHelper RECOVER(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.RECOVER, type, true, tcon);
    ia.setIidFolder(iidFolder);
    ia.schedule();
    return ia;
  }

  public static ItemActionHelper DUMPSTER_DELETE(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.DUMPSTER_DELETE, type, true, tcon);
    ia.schedule();
    return ia;
  }

  public static ItemActionHelper MOVE(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.MOVE, type, true, tcon);
    ia.setIidFolder(iidFolder);
    ia.schedule();
    return ia;
  }
  ...
  public static List<ItemActionHelper> MOVE(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      TargetConstraint tcon,
      String acctRelativePath)
      throws ServiceException {
    ...
    for (int convId : ids) {
      ...
      String targetFolderPath =
          rootFolderPath.concat(
              acctRelativePath.startsWith("/") ? acctRelativePath : "/" + acctRelativePath);
      Folder targetFolder;
      try {
  ...
  public static ItemActionHelper COPY(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.COPY, type, true, tcon);
    ia.setIidFolder(iidFolder);
    ia.schedule();
    return ia;
  }

  public static ItemActionHelper SPAM(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.SPAM, type, flagValue, tcon);
    ia.setIidFolder(iidFolder);
    ia.schedule();
    return ia;
  }

  public static ItemActionHelper RENAME(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.RENAME, type, true, tcon);
    ia.setName(name);
    ia.setIidFolder(iidFolder);
    ia.schedule();
    return ia;
  ...
  public static ItemActionHelper UPDATE(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.UPDATE, type, true, tcon);
    ia.setName(name);
    ia.setIidFolder(iidFolder);
    ia.setFlags(flags);
    ia.setTags(tags);
  ...
  public static ItemActionHelper LOCK(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.LOCK, type, true, tcon);
    ia.schedule();
    return ia;
  }

  public static ItemActionHelper UNLOCK(
      OperationContext octxt,
      Mailbox mbox,
      SoapProtocol responseProto,
      List<Integer> ids,
      ...
      throws ServiceException {
    ItemActionHelper ia =
        new ItemActionHelper(octxt, mbox, responseProto, ids, Op.UNLOCK, type, true, tcon);
    ia.schedule();
    return ia;
  }
  ...
  public String toString() {
    ...
    if (mOperation == Op.MOVE
        || mOperation == Op.SPAM
        || mOperation == Op.COPY
        || mOperation == Op.RENAME
        || mOperation == Op.UPDATE) {
  ...
  public void setIidFolder(ItemId iidFolder) {
    assert (mOperation == Op.MOVE
        || mOperation == Op.SPAM
        || mOperation == Op.COPY
        || mOperation == Op.RENAME
        || mOperation == Op.UPDATE
        || mOperation == Op.RECOVER);
  ...
  ItemActionHelper(
    ...
    if (mAuthenticatedAccount == null) mAuthenticatedAccount = mbox.getAccount();
    mIdFormatter = new ItemIdFormatter(mAuthenticatedAccount, mbox, false);
    mResponseProtocol = responseProto;

    int i = 0;
    itemIds = new int[ids.size()];
    for (int id : ids) itemIds[i++] = id;

    mOperation = op;
    if (mOperation == null) throw ServiceException.INVALID_REQUEST("unknown operation: null", null);
    this.type = type;
  ...
  protected void schedule() throws ServiceException {
    boolean targeted =
        mOperation == Op.MOVE
            ...
            || mOperation == Op.COPY
            || mOperation == Op.RENAME
            || (mOperation == Op.UPDATE && mIidFolder != null);

    // deal with local mountpoints pointing at local folders here
    if (targeted
        && mIidFolder.belongsTo(mMailbox)
        && mIidFolder.getId() > 0
        && mIidFolder.getId() != Mailbox.ID_FOLDER_TRASH
        && mIidFolder.getId() != Mailbox.ID_FOLDER_SPAM) {
      try {
        Folder folder = mMailbox.getFolderById(mOpCtxt, mIidFolder.getId());
        if (folder instanceof Mountpoint
            && !((Mountpoint) folder).getOwnerId().equals(mIidFolder.getAccountId())) {
          mIidFolder = ((Mountpoint) folder).getTarget();
          mHopCount++;
        }
      } catch (ServiceException e) {
        // could be a PERM_DENIED, could be something else -- this is not the right place to fail,
        // however
      }
    }

    try {
      if (!targeted || mIidFolder.belongsTo(mMailbox)) mResult = executeLocal();
      else mResult = executeRemote();
  ...
  private ItemActionResult executeLocalBatch(int[] ids) throws ServiceException {
    ...
    switch (mOperation) {
      case FLAG:
        getMailbox()
            .alterTag(getOpCtxt(), ids, type, Flag.FlagInfo.FLAGGED, mFlagValue, mTargetConstraint);
        break;
      case PRIORITY:
        getMailbox()
            .alterTag(
                getOpCtxt(), ids, type, Flag.FlagInfo.PRIORITY, mFlagValue, mTargetConstraint);
        break;
      case READ:
        getMailbox()
            .alterTag(getOpCtxt(), ids, type, Flag.FlagInfo.UNREAD, !mFlagValue, mTargetConstraint);
        break;
      case TAG:
  ...
  private AuthToken getAuthToken() throws ServiceException {
    ...
    if (mOpCtxt != null) authToken = AuthToken.getCsrfUnsecuredAuthToken(mOpCtxt.getAuthToken());

    if (authToken == null) authToken = AuthProvider.getAuthToken(mAuthenticatedAccount);
  ...
  private ItemActionResult executeRemote() throws ServiceException, IOException, HttpException {
    ...
    if (zfolder instanceof ZMountpoint) {
      ItemId iidTarget =
          new ItemId(((ZMountpoint) zfolder).getCanonicalRemoteId(), mAuthenticatedAccount.getId());
    ...
    for (MailItem item : mMailbox.getItemById(mOpCtxt, itemIds, type)) {
      ...
      if (deleteOriginal) {
        if (msgs != null) {
          ...
          if (msgs.isEmpty()) {
            if (permDenied) {
              throw ServiceException.PERM_DENIED(
                  "cannot delete any messages in " + item.getType() + " " + item.getId());
            }
          ...
          if (!canDelete(item)) {
            throw ServiceException.PERM_DENIED(
                "cannot delete existing copy of " + item.getType() + " " + item.getId());
          }
        }
      }
      ...
      String name =
          ((mOperation == Op.RENAME || mOperation == Op.UPDATE) && mName != null
              ? mName
              : item.getName());
      ...
      switch (item.getType()) {
        case CONTACT:
          ...
          for (Contact.Attachment att : ct.getAttachments()) {
            ...
            ZMailbox.ZAttachmentInfo info =
                new ZMailbox.ZAttachmentInfo().setAttachmentId(attachmentId);
        ...
        case MESSAGE:
          try {
            ...
            createdId =
                zmbx.addMessage(
                    folderStr, flags, (String) null, item.getDate(), in, item.getSize(), true);
          } finally {
        ...
        case CONVERSATION:
          for (Message msg : msgs) {
            ...
            try {
              ...
              createdId =
                  zmbx.addMessage(
                      folderStr, flags, (String) null, msg.getDate(), in, msg.getSize(), true);
            } finally {
              ByteUtil.closeStream(in);
            }
            createdIds.add(createdId);
        ...
        case DOCUMENT:
          ...
          try {
            ...
            String uploadId =
                zmbx.uploadContentAsStream(
                    name, in, doc.getContentType(), doc.getSize(), 4000, true);
        ...
        case TASK:
          ...
          QName qname =
              (item.getType() == MailItem.Type.TASK
                  ? MailConstants.SET_TASK_REQUEST
      ...
      try {
        if (deleteOriginal && !mIdFormatter.formatItemId(item).equals(createdId)) {
          ...
          if (msgs == null) {
            mMailbox.delete(
                mOpCtxt, new int[] {item.getId()}, item.getType(), null, nonExistentItems);
          } else {
            for (Message msg : msgs) {
              mMailbox.delete(
                  mOpCtxt, new int[] {msg.getId()}, msg.getType(), null, nonExistentItems);
            }
          }
        ...
        if (e.getCode() != ServiceException.PERM_DENIED) throw e;
        // something funky happened permissions-wise between the getEffectivePermissions check and
        // here...
        ZimbraLog.misc.info(
            "could not delete original item "
                + item.getId()
                + "; treating operation as a copy instead");
      }
    }
  ...
  private void addCalendarPart(
      Element parent,
      CalendarItem cal,
      Invite inv,
      ZMailbox zmbx,
      Account target,
      boolean takeoverAsOrganizer)
      throws ServiceException {
    ...
    if (takeoverAsOrganizer && inv.isOrganizer() && inv.hasOrganizer()) {
      ...
      if (authAcct == null || authAcct.equals(target)) org.setSentBy(null);
      else org.setSentBy(authAcct.getName());
      inv = invCopy;
    }
  ...
  private boolean canDelete(MailItem item) throws ServiceException {
    return (mMailbox.getEffectivePermissions(mOpCtxt, item.getId(), item.getType())
            & ACL.RIGHT_DELETE)
        != 0;
  }
}
