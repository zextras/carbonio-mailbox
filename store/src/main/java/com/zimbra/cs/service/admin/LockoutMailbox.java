...
public class LockoutMailbox extends AdminDocumentHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    defendAgainstAccountOrCalendarResourceHarvesting(
        ...
        accountSelectorKey,
        zsc,
        Admin.R_moveAccountMailbox,
        Admin.R_moveCalendarResourceMailbox);
  ...
  public void docRights(List<AdminRight> relatedRights, List<String> notes) {
    ...
    notes.add(
        "If the account is a calendar resource, need "
            + Admin.R_moveCalendarResourceMailbox.getName()
            + " right on the calendar resource.");
    notes.add(
        "If the account is a regular account, need "
            + Admin.R_moveAccountMailbox.getName()
