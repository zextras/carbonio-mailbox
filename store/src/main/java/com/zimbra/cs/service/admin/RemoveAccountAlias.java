  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    try {
      defendAgainstAccountOrCalendarResourceHarvesting(
          ...
          id,
          zsc,
          Admin.R_removeAccountAlias,
          Admin.R_removeCalendarResourceAlias);
    ...
    // If account is null, still invoke removeAlias. Ensures dangling aliases are cleaned up as much
    // as possible
