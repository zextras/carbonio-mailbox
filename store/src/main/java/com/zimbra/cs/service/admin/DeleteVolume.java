...
public final class DeleteVolume extends AdminDocumentHandler {
  ...
  private DeleteVolumeResponse handle(DeleteVolumeRequest req, Map<String, Object> ctx)
    ...
    if (storeManager.supports(
        StoreManager.StoreFeature.CUSTOM_STORE_API, String.valueOf(req.getId()))) {
      throw ServiceException.INVALID_REQUEST(
          "Operation unsupported, use zxsuite to delete this volume", null);
    }
