...
public class SendDeliveryReport extends MailDocumentHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    if ((mbox.getEffectivePermissions(octxt, msgid, MailItem.Type.MESSAGE) & ACL.RIGHT_WRITE)
        == 0) {
  ...
  public static void sendReport(
      Account authAccount, Message msg, boolean automatic, String requestHost, String userAgent)
    ...
    try {
      ...
      MailSender.logMessage(
          (MimeMessage) report,
          report.getAllRecipients(),
          report.getEnvelopeFrom(),
  ...
  public static String generateTextPart(Account owner, MimeMessage mm, Locale lc)
    ...
    return L10nUtil.getMessage(
        MsgKey.readReceiptNotification, lc, dateStr, owner.getName(), subject);
  }

  public static String generateReport(
      Account owner, MimeMessage mm, boolean automatic, String requestHost, String userAgent)
      throws MessagingException {
