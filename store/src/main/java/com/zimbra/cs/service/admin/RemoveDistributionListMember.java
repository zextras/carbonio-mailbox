...
public class RemoveDistributionListMember extends ReloadMemberPostProxyHandler {
  ...
  private List<String> addMembersFromAccountElements(
      Element request, List<String> memberList, Group group) throws ServiceException {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    defendAgainstGroupHarvesting(
        ...
        id,
        zsc,
        Admin.R_removeGroupMember,
        Admin.R_removeDistributionListMember);
