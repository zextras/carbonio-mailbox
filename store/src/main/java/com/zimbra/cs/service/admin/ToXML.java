...
public class ToXML {
  ...
  public static Element encodeAccount(
    ...
    return encodeAccount(parent, account, applyCos, false, reqAttrs, attrRightChecker);
  }
  ...
  public static Element encodeAccount(
      ...
      Account account,
      boolean applyCos,
      boolean needsExternalIndicator,
      Set<String> reqAttrs,
      AttrRightChecker attrRightChecker) {
  ...
  public static void encodeAttrs(
