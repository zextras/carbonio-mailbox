...
public class TestDataSource extends MailDocumentHandler {
  ...
  static String testDataSource(
    ...
    if (value != null) {
      testAttrs.put(
          Provisioning.A_zimbraDataSourceOAuthToken, DataSource.encryptData(testId, value));
      testAttrs.put(
    ...
    if (password != null) {
      ...
      testAttrs.put(
          Provisioning.A_zimbraDataSourcePassword, DataSource.encryptData(testId, password));
    }
    ...
    if (value != null) {
      ...
      testAttrs.put(
          Provisioning.A_zimbraDataSourceSmtpAuthPassword, DataSource.encryptData(testId, value));
    }
  ...
  public static void testDataSourceConnection(
      Provisioning prov, Element eDataSource, DataSourceType type, Account account)
      throws ServiceException {
    String error = testDataSource(prov, account, eDataSource, type);
    if (error != null) {
