...
public class GetShareInfo extends ShareInfoHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    byte granteeType =
        com.zimbra.cs.service.account.GetShareInfo.getGranteeType(
    ...
    // to defend against harvest attacks return "no shares" instead of error when an invalid user
    // name/id is used.
    // this is the admin namespace GetShareInfo, we want to let the admin know if the owner name is
    // bad
    ...
    defendAgainstAccountOrCalendarResourceHarvesting(
        ...
        Admin.R_adminLoginCalendarResourceAs);
