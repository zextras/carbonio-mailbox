...
public abstract class AdminDocumentHandler extends DocumentHandler implements AdminRightCheckPoint {
  ...
  protected Account getAccount(
      Provisioning prov, AccountBy accountBy, String value, AuthToken authToken)
  ...
  private CalendarResource getCalendarResource(
      Provisioning prov, Key.CalendarResourceBy crBy, String value) throws ServiceException {
  ...
  public static Entry pseudoTargetInSameDomainAsEmail(TargetType targetType, String emailAddr) {
    ...
    try {
      return PseudoTarget.createPseudoTarget(
          Provisioning.getInstance(), targetType, DomainBy.name, domainStr, false, null, null);
    } catch (ServiceException e) {
      return null;
    }
  }

  protected void defendAgainstAccountHarvestingWhenAbsent(
      AccountBy by, String selectorKey, ZimbraSoapContext zsc, AccountHarvestingChecker checker)
      throws ServiceException {
  ...
  protected void defendAgainstAccountHarvesting(
      Account account,
      AccountBy by,
      String selectorKey,
      ZimbraSoapContext zsc,
      AccountHarvestingChecker checker)
      throws ServiceException {
    if (account == null) {
  ...
  protected void defendAgainstAccountHarvestingWhenAbsent(
      AccountBy by, String selectorKey, ZimbraSoapContext zsc, Object needed)
      throws ServiceException {
    defendAgainstAccountHarvestingWhenAbsent(
        by, selectorKey, zsc, new AccountHarvestingCheckerUsingCheckAccountRight(zsc, needed));
  }

  protected void defendAgainstAccountHarvesting(
      Account account, AccountBy by, String selectorKey, ZimbraSoapContext zsc, Object needed)
      throws ServiceException {
  ...
  protected void defendAgainstAccountOrCalendarResourceHarvestingWhenAbsent(
      AccountBy accountBy,
      String selectorKey,
      ZimbraSoapContext zsc,
      AdminRight rightForAcct,
      AdminRight rightForCalRes)
      throws ServiceException {
    try {
      CalendarResourceBy calResBy = CalendarResourceBy.fromString(accountBy.toString());
      defendAgainstCalResourceHarvestingWhenAbsent(
          calResBy,
          selectorKey,
          zsc,
  ...
  protected void defendAgainstAccountOrCalendarResourceHarvesting(
      Account account,
      AccountBy accountBy,
      String selectorKey,
      ZimbraSoapContext zsc,
      ...
      throws ServiceException {
    if (account == null) {
      defendAgainstAccountOrCalendarResourceHarvestingWhenAbsent(
          accountBy, selectorKey, zsc, rightForAcct, rightForCalRes);
  ...
  protected void defendAgainstCalResourceHarvestingWhenAbsent(
      CalendarResourceBy by,
      String selectorKey,
      ZimbraSoapContext zsc,
      CalResourceHarvestingChecker checker)
      throws ServiceException {
    AuthToken authToken = zsc.getAuthToken();
    if (authToken.isAdmin()) {
  ...
  protected void defendAgainstCalResourceHarvesting(
      CalendarResource calRes,
      CalendarResourceBy by,
      String selectorKey,
      ZimbraSoapContext zsc,
      CalResourceHarvestingChecker checker)
  ...
  protected void defendAgainstServerNameHarvesting(
      Server server, ServerBy by, String selectorKey, ZimbraSoapContext zsc, AdminRight needed)
      throws ServiceException {
    if (server == null) {
  ...
  protected void defendAgainstServerNameHarvestingWhenAbsent(
      ServerBy by, String selectorKey, ZimbraSoapContext zsc, AdminRight needed)
      throws ServiceException {
    AuthToken authToken = zsc.getAuthToken();
    if (authToken.isAdmin()) {
      ...
      Entry psedoTarget =
          PseudoTarget.createPseudoTarget(
              Provisioning.getInstance(), TargetType.server, null, null, false, null, null);
  ...
  protected class AccountHarvestingCheckerUsingCheckAccountRight
      extends AccountHarvestingCheckerBase {
  ...
  protected class AccountHarvestingCheckerUsingCheckRight extends AccountHarvestingCheckerBase {
    ...
    public AccountHarvestingCheckerUsingCheckRight(
        ZimbraSoapContext zsc, Map<String, Object> context, AdminRight right) {
      super(zsc);
  ...
  protected class CalResourceHarvestingCheckerUsingCheckCalendarResourceRight
    ...
    public CalResourceHarvestingCheckerUsingCheckCalendarResourceRight(
        ZimbraSoapContext zsc, Object needed) {
      super(zsc);
      this.needed = needed;
    }
  ...
  protected class GroupHarvestingCheckerUsingGetAttrsPerms extends GroupHarvestingCheckerBase {
    ...
    public GroupHarvestingCheckerUsingGetAttrsPerms(
        ZimbraSoapContext zsc, AttrRightChecker arc, List<String> getAttrs) {
      super(zsc);
      this.arc = arc;
  ...
  protected class GroupHarvestingCheckerUsingCheckRight extends GroupHarvestingCheckerBase {
    ...
    public GroupHarvestingCheckerUsingCheckRight(
        ZimbraSoapContext zsc, Map<String, Object> context, AdminRight right) {
      super(zsc);
      this.adminRight = right;
      this.context = context;
  ...
  protected void defendAgainstGroupHarvestingWhenAbsent(
      DistributionListBy dlBy,
      String groupSelectorKey,
      ZimbraSoapContext zsc,
      GroupHarvestingChecker checker)
      throws ServiceException {
    AuthToken authToken = zsc.getAuthToken();
    if (authToken.isAdmin()) {
      ...
      if (DistributionListBy.name.equals(dlBy) && AuthToken.isAnyAdmin(authToken)) {
        ...
        if (pseudoTarget != null) {
          ...
          throw AccountServiceException.NO_SUCH_DISTRIBUTION_LIST(
              groupSelectorKey); // passed the check
        }
      }
    }
  ...
  protected void defendAgainstGroupHarvesting(
      Group group,
      DistributionListBy dlBy,
      String groupSelectorKey,
      ZimbraSoapContext zsc,
  ...
  protected void defendAgainstGroupHarvestingWhenAbsent(
      DistributionListBy dlBy, String groupSelectorKey, ZimbraSoapContext zsc, AdminRight dlRight)
      throws ServiceException {
    defendAgainstGroupHarvestingWhenAbsent(
        dlBy, groupSelectorKey, zsc, new GroupHarvestingCheckerUsingCheckGroupRight(zsc, dlRight));
  }
  ...
  protected void defendAgainstGroupHarvesting(
    ...
    GroupHarvestingCheckerUsingCheckGroupRight checker =
        new GroupHarvestingCheckerUsingCheckGroupRight(
            zsc, group.isDynamic() ? dynamicGroupNeeded : dlNeeded);
    checker.check(group, groupSelectorKey);
  }
    ...
    try {
      ...
      if (acctId != null) {
        ...
        if (acct != null && !Provisioning.onLocalServer(acct, reasons)) {
          ZimbraLog.soap.info(
              "Proxying request: ProxiedAccountPath=%s reason: %s",
      ...
      if (acctElt != null) {
        Account acct =
            getAccount(
                prov,
                AccountBy.fromString(acctElt.getAttribute(AdminConstants.A_BY)),
                acctElt.getText(),
                zsc.getAuthToken());
        if (acct != null && !Provisioning.onLocalServer(acct, reasons)) {
          ZimbraLog.soap.info(
              "Proxying request: ProxiedAccountElementPath=%s acctElt=%s reason: %s",
      ...
      if (rsrcId != null) {
        ...
        if (rsrc != null && !Provisioning.onLocalServer(rsrc, reasons)) {
          ZimbraLog.soap.info(
              "Proxying request: ProxiedResourcePath=%s rsrcId=%s reason: %s",
      ...
      if (resourceElt != null) {
        ...
        if (rsrc != null && !Provisioning.onLocalServer(rsrc, reasons)) {
          ZimbraLog.soap.info(
              "Proxying request: ProxiedResourceElementPath=%s resourceElt=%s reason: %s",
      ...
      if (serverId != null) {
        ...
        if (server != null && !getLocalHostId().equalsIgnoreCase(server.getId())) {
          ZimbraLog.soap.info(
              "Proxying request: ProxiedServerPath=%s serverId=%s server=%s reason: server ID=%s !="
                  + " localHostId=%s",
              Joiner.on("/").join(xpath),
              serverId,
              server.getName(),
              server.getId(),
              getLocalHostId());
      ...
      if (ServiceException.PROXY_ERROR.equals(e.getCode())) return null;
    ...
    for (String attr : attrs) {
      if (attrsOnEntry.contains(attr)) {
        ...
        throw ServiceException.INVALID_REQUEST(
            "requested attribute " + attr + " is not on " + klass.name(), null);
      }
    }
  ...
  protected boolean canAccessDomain(ZimbraSoapContext zsc, String domainName)
      throws ServiceException {
   ...
   * @throws ServiceException
   */
  public void checkModifyAttrs(
      ZimbraSoapContext zsc, AttributeClass attrClass, Map<String, Object> attrs)
      throws ServiceException {
    AdminAccessControl.getAdminAccessControl(zsc).checkModifyAttrs(attrClass, attrs);
  }

  /**
   * This has to be called *after* the *can create* check. For domain based AccessManager, all attrs
   * are allowed if the admin can create.
   */
  protected void checkSetAttrsOnCreate(
      ZimbraSoapContext zsc, TargetType targetType, String entryName, Map<String, Object> attrs)
      throws ServiceException {
    AdminAccessControl.getAdminAccessControl(zsc)
        .checkSetAttrsOnCreate(targetType, entryName, attrs);
  }

  protected boolean hasRightsToList(
      ZimbraSoapContext zsc, NamedEntry target, AdminRight listRight, Object getAttrRight)
      throws ServiceException {
    return AdminAccessControl.getAdminAccessControl(zsc)
        .hasRightsToList(target, listRight, getAttrRight);
  }

  protected boolean hasRightsToListCos(
      ZimbraSoapContext zsc, Cos target, AdminRight listRight, Object getAttrRight)
      throws ServiceException {
    return AdminAccessControl.getAdminAccessControl(zsc)
        .hasRightsToListCos(target, listRight, getAttrRight);
  }

  /**
   * ------------------- non-domained rights (i.e. not: account, calendar resource, distribution
   * list, domain)
   *
   * <p>For domain based access manager, if the authed admin is domain admin only, it should have
   * been rejected in SoapEngine. So it should just return true here. But we sanity check again,
   * just in case. -------------------
   */
  protected AdminAccessControl checkRight(
      ZimbraSoapContext zsc, Map<String, Object> context, Entry target, Object needed)
      throws ServiceException {
  ...
  /**
   * This API is for checking ACL rights only, domain based access manager will always return OK.
   * This should be called only when
   *
   * <p>(1) domain based permission checking has passed. or (2) from SOAP handlers that are actually
   * admin commands, but can't inherit from AdminDocumentHanlder because it already inherited from
   * otehr class, e.g. SearchMultipleMailboxes. This method is static just because of that. Ideally
   * it should call the other checkRight API, which does sanity checking for domain admins if the
   * active AccessManager is a domain based access manager. But that API has other dependency on
   * AdminDocumentHanlder/DocumentHandler instance methods, also, the sanity is really not
   * necessary, we should remove it at some point when we can completely retire the domain based
   * access manager.
   *
   * <p>TODO: find callsites of non AdminDocumentHanlder and call AdminAccessControl directly, after
   * this method can be protected and non-static
   *
   * @param zsc
   * @param target
   * @param needed
   ...
   * ------------- account right -------------
   */
  protected AdminAccessControl checkAccountRight(
      ZimbraSoapContext zsc, Account account, Object needed) throws ServiceException {
    AdminAccessControl aac = AdminAccessControl.getAdminAccessControl(zsc);
   ...
   */
  protected AdminAccessControl checkCalendarResourceRight(
      ZimbraSoapContext zsc, CalendarResource cr, Object needed) throws ServiceException {
    AdminAccessControl aac = AdminAccessControl.getAdminAccessControl(zsc);
   ...
   */
  protected AdminAccessControl checkAdminLoginAsRight(
      ZimbraSoapContext zsc, Provisioning prov, Account account) throws ServiceException {
   ...
   * -------- DL right --------
   */
  protected AdminAccessControl checkDistributionListRight(
      ZimbraSoapContext zsc, DistributionList dl, Object needed) throws ServiceException {
    AdminAccessControl aac = AdminAccessControl.getAdminAccessControl(zsc);
   ...
   * -------- Dynamic group right --------
   */
  protected AdminAccessControl checkDynamicGroupRight(
      ZimbraSoapContext zsc, DynamicGroup group, Object needed) throws ServiceException {
    AdminAccessControl aac = AdminAccessControl.getAdminAccessControl(zsc);
   ...
   */
  /**
   * called by handlers that need to check right on a domain for domain-ed objects: account, alias,
   * cr, dl.
   *
   * <p>Note: this method *do* check domain status.
   */
  protected AdminAccessControl checkDomainRightByEmail(
      ZimbraSoapContext zsc, String email, AdminRight needed) throws ServiceException {
    AdminAccessControl aac = AdminAccessControl.getAdminAccessControl(zsc);
  ...
  protected AdminAccessControl checkDomainRight(
      ZimbraSoapContext zsc, String domainName, Object needed) throws ServiceException {
    AdminAccessControl aac = AdminAccessControl.getAdminAccessControl(zsc);
  ...
  public Account verifyAccountHarvestingAndPerms(AccountSelector acctSel, ZimbraSoapContext zsc)
      throws ServiceException {
    Provisioning prov = Provisioning.getInstance();
    ...
    if (!canModifyOptions(zsc, account)) {
      ...
      ZimbraLog.filter.debug(
          "Do not have permission to modify options on account %s", account.getName(), se);
      throw se;
    }
    return account;
  }

  public Domain verifyDomainPerms(DomainSelector domainSelector, ZimbraSoapContext zsc)
      throws ServiceException {
    Provisioning prov = Provisioning.getInstance();
    if (domainSelector == null) {
      ServiceException se =
          ServiceException.INVALID_REQUEST(
              String.format("missing <%s>", AdminConstants.E_DOMAIN), null);
    ...
    if (domain == null) {
      ...
      ZimbraLog.filter.debug(
          "DomainSelector failed to get domain - %s:%s",
          domainSelector.getBy().toString(), domainSelector.getKey(), se);
      throw se;
    }
  ...
  public Cos verifyCosPerms(CosSelector cosSelector, ZimbraSoapContext zsc)
      throws ServiceException {
    Provisioning prov = Provisioning.getInstance();
    if (cosSelector == null) {
      ServiceException se =
          ServiceException.INVALID_REQUEST(
              String.format("missing <%s>", AdminConstants.E_COS), null);
    ...
    if (cosSelector.getBy().toString().equals(CosBy.id.toString())) {
      ...
      ZimbraLog.filter.debug(
          "CosSelector not valid - %s:%s",
          cosSelector.getBy().toString(), cosSelector.getKey(), se);
      throw se;
    }
    if (cos == null) {
      ServiceException se = ServiceException.FAILURE(String.format("failed to get cos"), null);
      ZimbraLog.filter.debug(
          "CosSelector failed to get cos - %s:%s",
          cosSelector.getBy().toString(), cosSelector.getKey(), se);
      throw se;
    }
  ...
  public Server verifyServerPerms(ServerSelector serverSelector, ZimbraSoapContext zsc)
      throws ServiceException {
    Provisioning prov = Provisioning.getInstance();
    if (serverSelector == null) {
      ServiceException se =
          ServiceException.INVALID_REQUEST(
              String.format("missing <%s>", AdminConstants.E_SERVER), null);
    ...
    if (serverSelector
        .getBy()
        .toString()
        .equals(com.zimbra.soap.admin.type.ServerSelector.ServerBy.id.toString())) {
      server = prov.getServerById(serverSelector.getKey());
    } else if (serverSelector
        .getBy()
        .toString()
        .equals(com.zimbra.soap.admin.type.ServerSelector.ServerBy.name.toString())) {
      server = prov.getServerByName(serverSelector.getKey());
    } else if (serverSelector
        .getBy()
        .toString()
        .equals(com.zimbra.soap.admin.type.ServerSelector.ServerBy.serviceHostname.toString())) {
      server = prov.getServerByServiceHostname(serverSelector.getKey());
    } else {
      ServiceException se =
          ServiceException.INVALID_REQUEST(String.format("invalid serverby"), null);
      ZimbraLog.filter.debug(
          "ServerSelector not valid - %s:%s",
          serverSelector.getBy().toString(), serverSelector.getKey(), se);
      throw se;
    }
    if (server == null) {
      ServiceException se = ServiceException.FAILURE(String.format("failed to get server"), null);
      ZimbraLog.filter.debug(
          "ServerSelector failed to get server - %s:%s",
          serverSelector.getBy().toString(), serverSelector.getKey(), se);
      throw se;
    }
