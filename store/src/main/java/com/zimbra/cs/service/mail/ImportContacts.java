...
public class ImportContacts extends MailDocumentHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    if (folder == null) folder = this.DEFAULT_FOLDER_ID;
  ...
  private static BufferedReader parseUploadedContent(
  ...
  public static List<ItemId> ImportCsvContacts(
      OperationContext oc, Mailbox mbox, ItemId iidFolder, List<Map<String, String>> csvContacts)
