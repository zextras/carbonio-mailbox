...
/**
 * <GetXMPPComponentRequest> <xmppcomponent by="by">identifier</xmppcomponent>
...
public class GetXMPPComponent extends AdminDocumentHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    if (comp == null) throw AccountServiceException.NO_SUCH_XMPP_COMPONENT(name);
  ...
  public static Element encodeXMPPComponent(
      Element parent, XMPPComponent comp, Set<String> reqAttrs, AttrRightChecker attrRightChecker) {
  ...
  public void docRights(List<AdminRight> relatedRights, List<String> notes) {
    ...
    notes.add(
        String.format(AdminRightCheckPoint.Notes.GET_ENTRY, Admin.R_getXMPPComponent.getName()));
  }
}
