...
public class GetCalendarResource extends AdminDocumentHandler {
  ...
  private static final String[] TARGET_RESOURCE_PATH =
      new String[] {AdminConstants.E_CALENDAR_RESOURCE};
  ...
  /** must be careful and only return calendar resources a domain admin can see */
  @Override
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    defendAgainstCalResourceHarvesting(
        resource, calresBy, value, zsc, Admin.R_getCalendarResourceInfo);
    ...
    ToXML.encodeCalendarResource(
        response, resource, applyCos, reqAttrs, aac.getAttrRightChecker(resource));
  ...
  public void docRights(List<AdminRight> relatedRights, List<String> notes) {
    ...
    notes.add(
        String.format(AdminRightCheckPoint.Notes.GET_ENTRY, Admin.R_getCalendarResource.getName()));
  }
}
