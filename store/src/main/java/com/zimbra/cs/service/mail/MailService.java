...
public final class MailService implements DocumentService {
  ...
  @Inject
  public MailService(AttachmentService attachmentService, FilesClient filesClient) {
  ...
  public void registerHandlers(DocumentDispatcher dispatcher) {
    ...
    dispatcher.registerHandler(
        MailConstants.GET_CONTACT_BACKUP_LIST_REQUEST, new GetContactBackupList());
    ...
    // Documents
    dispatcher.registerHandler(
        MailConstants.SAVE_DOCUMENT_REQUEST, new com.zimbra.cs.service.doc.SaveDocument());
    dispatcher.registerHandler(
    ...
    dispatcher.registerHandler(
        MailConstants.COPY_TO_DRIVE_REQUEST, new CopyToFiles(attachmentService, filesClient));
  }
}
