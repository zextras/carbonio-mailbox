...
public class ModifyDataSource extends MailDocumentHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    if (value != null) {
      dsAttrs.put(
          ...
          LdapUtil.getLdapBooleanString(
              eDataSource.getAttributeBool(MailConstants.A_DS_IS_ENABLED)));
    }
    ...
    if (value != null) dsAttrs.put(Provisioning.A_zimbraDataSourcePort, value);
    value = eDataSource.getAttribute(MailConstants.A_DS_CONNECTION_TYPE, null);
    if (value != null) dsAttrs.put(Provisioning.A_zimbraDataSourceConnectionType, value);
    ...
    if (value != null) {
      ...
      dsAttrs.put(
          ...
          ZAttrProvisioning.DataSourceAuthMechanism.XOAUTH2.name());
    }
    ...
    if (value != null) {
      if (type != DataSourceType.pop3) {
        String msg =
            String.format(
                "%s only allowed for %s data sources",
      ...
      if (newValue != ds.leaveOnServer()) {
        dsAttrs.put(
            Provisioning.A_zimbraDataSourceLeaveOnServer, LdapUtil.getLdapBooleanString(newValue));
        Mailbox mbox = getRequestedMailbox(zsc);
    ...
    if (value != null) {
      dsAttrs.put(
          Provisioning.A_zimbraDataSourceSmtpEnabled,
          LdapUtil.getLdapBooleanString(
              eDataSource.getAttributeBool(MailConstants.A_DS_SMTP_ENABLED)));
    }
  ...
  public static void processCommonOptionalAttrs(
      Account account, Map<String, Object> dsAttrs, Element eDataSource) throws ServiceException {
    String value;
    ...
    if (value != null) {
      dsAttrs.put(
          Provisioning.A_zimbraDataSourceUseAddressForForwardReply,
          LdapUtil.getLdapBooleanString(
              eDataSource.getAttributeBool(
                  MailConstants.A_DS_USE_ADDRESS_FOR_FORWARD_REPLY, false)));
    }
