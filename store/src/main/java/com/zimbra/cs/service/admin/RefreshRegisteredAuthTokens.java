...
/**
 * This admin SOAP handler receives a list of authtokens that have been deregistered on another
 * server and reloads corresponding accounts from LDAP in order to have updated registry of
 * authtokens for the accounts
 *
 * @author gsolovyev
 */
