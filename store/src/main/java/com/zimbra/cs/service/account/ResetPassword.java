...
public class ResetPassword extends AccountDocumentHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    boolean getPasswordRules =
        request.getAttributeBool(AccountConstants.E_GET_PASSWORD_RULES, false);
    boolean cancelResetPassword =
        request.getAttributeBool(AccountConstants.E_CANCEL_RESET_PASSWORD, false);
  ...
  protected void setPasswordAndPurgeAuthTokens(
      Provisioning prov, Account acct, String newPassword, boolean dryRun) throws ServiceException {
    if (dryRun) {
  ...
  protected void checkPasswordStrength(Provisioning prov, Account acct, String newPassword)
