...
public class AtomFormatter extends Formatter {
  ...
  public void formatCallback(UserServletContext context) throws IOException, ServiceException {
    ...
    try {
      ...
      feed.addElement("updated")
          .setText(DateUtil.toISO8601(new Date(context.targetMailbox.getLastChangeDate())));
  ...
  private void addCalendarItem(CalendarItem calItem, Element feed, UserServletContext context)
