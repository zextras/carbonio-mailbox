...
public class DeleteGalSyncAccount extends AdminDocumentHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    if (account == null) throw AccountServiceException.NO_SUCH_ACCOUNT(acctValue);
    ...
    if (!acctIds.contains(id)) throw AccountServiceException.NO_SUCH_ACCOUNT(id);
    acctIds.remove(id);
    ...
    ZimbraLog.security.info(
        ZimbraLog.encodeAttrs(new String[] {"cmd", "DeleteGalSyncAccount", "id", id}));
