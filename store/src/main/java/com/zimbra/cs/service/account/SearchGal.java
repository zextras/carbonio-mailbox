...
public class SearchGal extends GalDocumentHandler {
  ...
  private static class SearchGalResultCallback
      extends GalExtraSearchFilter.FilteredGalSearchResultCallback {

    private SearchGalResultCallback(
        GalSearchParams params, EntrySearchFilter filter, Set<String> attrs) {
      super(params, filter, attrs);
    }
  }

  private static class SearchGalExtraQueryCallback extends GalExtraQueryCallback
