...
public class SearchAutoProvDirectory extends AdminDocumentHandler {
  ...
  private void encodeEntries(
      Element response, List<Entry> entryList, String keyAttr, int offset, int limit) {
  ...
  private void encodeAttr(Element parent, String attrName, Object value) {
    if (value instanceof String) {
      parent
          ...
          .addAttribute(AdminConstants.A_N, attrName)
  ...
  private List<Entry> search(
    ...
    Provisioning.getInstance()
        .searchAutoProvDirectory(domain, query, name, returnAttrs, maxResults, result);
