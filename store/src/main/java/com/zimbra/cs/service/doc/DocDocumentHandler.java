...
public abstract class DocDocumentHandler extends MailDocumentHandler {
  private static final String[] TARGET_ID_PATH =
      new String[] {MailConstants.E_WIKIWORD, MailConstants.A_ID};
  ...
  private static final String[] TARGET_FOLDER_PATH =
      new String[] {MailConstants.E_WIKIWORD, MailConstants.A_FOLDER};
  ...
  protected ItemId getRequestedFolder(Element request, ZimbraSoapContext zsc)
