...
public abstract class Formatter {
  ...
  public abstract void formatCallback(UserServletContext context)
      throws UserServletException, ServiceException, IOException, ServletException,
          MessagingException, HttpException;
  ...
  public void saveCallback(
    ...
    throw new UserServletException(
        HttpServletResponse.SC_BAD_REQUEST, "format not supported for save");
  }
    ...
    switch (folder.getDefaultView()) {
      ...
      default:
        return context.targetMailbox.getItemList(
            context.opContext, MailItem.Type.MESSAGE, folder.getId(), context.sortBy);
    }
  }
  ...
  protected void updateClient(UserServletContext context, Exception e, List<ServiceException> w)
    ...
    if (e != null) {
      ...
      exception =
          cause instanceof UserServletException
    ...
    // Don't report a ConversionUnsupportedException to the caller, unless they registered an error
    // callback.
    // This ensures seamless display of manual download link provided by error callback, or
    // otherwise a null blank preview pane.
    if (exception instanceof ConversionUnsupportedException
        && (callback == null || !callback.startsWith("ZmPreviewView._errorCallback"))) {
      exception = null;
    }
