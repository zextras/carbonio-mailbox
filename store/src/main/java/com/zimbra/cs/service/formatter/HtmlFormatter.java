...
public class HtmlFormatter extends Formatter {
  ...
  private static final String ATTR_TARGET_ACCOUNT_PREF_TIME_ZONE =
  ...
  private static final String ATTR_TARGET_ACCOUNT_PREF_CALENDAR_FIRST_DAY_OF_WEEK =
      "zimbra_target_account_prefCalendarFirstDayOfWeek";
  private static final String ATTR_TARGET_ACCOUNT_PREF_CALENDAR_DAY_HOUR_START =
      "zimbra_target_account_prefCalendarDayHourStart";
  private static final String ATTR_TARGET_ACCOUNT_PREF_CALENDAR_DAY_HOUR_END =
      "zimbra_target_account_prefCalendarDayHourEnd";

  @Override
  public void formatCallback(UserServletContext context)
      throws UserServletException, ServiceException, IOException, ServletException, HttpException {
  ...
  static void dispatchJspRest(Servlet servlet, UserServletContext context)
    ...
    if (targetAccount != null) {
      ...
      com.zimbra.cs.account.Cos defaultCos =
      ...
      context.req.setAttribute(
          ATTR_TARGET_ACCOUNT_PREF_SKIN, defaultCos.getAttr(Provisioning.A_zimbraPrefSkin));
      context.req.setAttribute(
          ATTR_TARGET_ACCOUNT_PREF_LOCALE, defaultCos.getAttr(Provisioning.A_zimbraPrefLocale));
      context.req.setAttribute(
          ATTR_TARGET_ACCOUNT_PREF_CALENDAR_FIRST_DAY_OF_WEEK,
    ...
    if (targetItem != null) {
      ...
      if (targetItem instanceof Folder) {
        context.req.setAttribute(
            ATTR_TARGET_ITEM_VIEW, ((Folder) targetItem).getDefaultView().toString());
      }
    ...
    if (WebSplitUtil.isZimbraServiceSplitEnabled()) {
      ...
      HttpClient httpclient =
          ZimbraHttpConnectionManager.getInternalHttpConnMgr().getDefaultHttpClient().build();
      /*
      ...
      */
      ...
      try {
        ...
        ByteUtil.copy(
            httpResp.getEntity().getContent(), true, context.resp.getOutputStream(), false);
