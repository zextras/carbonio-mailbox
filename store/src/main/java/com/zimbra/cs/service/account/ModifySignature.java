...
public class ModifySignature extends DocumentHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    if (signature == null) throw AccountServiceException.NO_SUCH_SIGNATURE(id);
    ...
    for (Element eContent : contents) {
      ...
      if (attr == null) throw ServiceException.INVALID_REQUEST("invalid type " + type, null);
      ...
      if (content != null) attrs.put(attr, content);
    }

    String name = eSignature.getAttribute(AccountConstants.A_NAME, null);
    if (name != null) attrs.put(Provisioning.A_zimbraSignatureName, name);
