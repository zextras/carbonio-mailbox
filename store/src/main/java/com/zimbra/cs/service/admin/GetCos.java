...
public class GetCos extends AdminDocumentHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    if (cos == null) throw AccountServiceException.NO_SUCH_COS(value);
  ...
  public static void encodeCos(
      Element e, Cos c, Set<String> reqAttrs, AttrRightChecker attrRightChecker)
    ...
    if (c.isDefaultCos()) cos.addAttribute(AdminConstants.A_IS_DEFAULT_COS, true);
  ...
  private static void encodeCosAttr(
      Element parent, String key, String value, boolean isCosAttr, boolean allowed) {
