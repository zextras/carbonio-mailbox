...
public class ZipFormatter extends ArchiveFormatter {
  public class ZipArchiveInputStream implements ArchiveInputStream {
    public class ZipArchiveInputEntry implements ArchiveInputEntry {
      ...
      public boolean isUnread() {
        return entry.getComment() != null && entry.getComment().endsWith("-unread");
      }
    }
  ...
  public class ZipArchiveOutputStream implements ArchiveOutputStream {
    ...
    public ZipArchiveOutputStream(OutputStream os, String cset, int lvl) throws IOException {
      ...
      if (lvl >= 0 && lvl <= 9) this.os.setLevel(lvl);
    }
  ...
  protected ArchiveInputStream getInputStream(UserServletContext context, String charset)
    ...
    return new ZipArchiveInputStream(context.getRequestInputStream(-1), charset);
  }
