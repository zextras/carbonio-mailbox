...
public class GetAccountInfo extends AdminDocumentHandler {
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    defendAgainstAccountOrCalendarResourceHarvesting(
        ...
        accountSelectorKey,
        zsc,
        Admin.R_getAccountInfo,
        Admin.R_getCalendarResourceInfo);
  ...
  static void addUrls(Element response, Account account) throws ServiceException {
    ...
    if (http != null) response.addNonUniqueElement(AdminConstants.E_SOAP_URL).setText(http);
    ...
    String webMailUrl =
        URLUtil.getPublicURLForDomain(
            server, Provisioning.getInstance().getDomain(account), "", true);
    if (webMailUrl != null)
