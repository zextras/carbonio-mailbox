...
public abstract class SSOServlet extends ZimbraServlet {
  ...
  protected void setAuthTokenCookieAndReturn(
  ...
  protected void setAuthTokenCookieAndRedirect(
      HttpServletRequest req, HttpServletResponse resp, Account acct, AuthToken authToken)
      throws IOException, ServiceException {
  ...
  protected void redirectToErrorPage(
      HttpServletRequest req, HttpServletResponse resp, boolean isAdminRequest, String errorUrl)
      throws IOException, ServiceException {
    String redirectUrl;
