...
public class GetConv extends MailDocumentHandler {
  ...
  private static final String[] TARGET_CONV_PATH =
      new String[] {MailConstants.E_CONV, MailConstants.A_ID};
  ...
  public Element handle(Element request, Map<String, Object> context) throws ServiceException {
    ...
    params.setInlineRule(
        ExpandResults.valueOf(econv.getAttribute(MailConstants.A_FETCH, null), zsc));
    if (params.getInlineRule() != ExpandResults.NONE) {
      ...
      params.setMaxInlinedLength(
          (int) econv.getAttributeLong(MailConstants.A_MAX_INLINED_LENGTH, -1));
