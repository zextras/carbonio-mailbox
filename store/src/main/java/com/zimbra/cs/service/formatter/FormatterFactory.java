...
public class FormatterFactory {
  /**
   * The list of supported formatter types. These are the desired output type of the formatting
   * operation
   */
  public enum FormatType {
    ATOM("atom", "application/atom+xml"),
    CONTACT_FOLDER("cf", "text/x-delimitted-fields"),
    CSV("csv", "text/csv"),
  ...
  /**
   * Adds a new formatter to the factory. Using this method it is possible to override the default
   * formatters for a specificy FormatType. The last formatter added to the the factory will always
   * win.
   *
