...
public final class VolumeServiceException extends ServiceException {
  ...
  public static VolumeServiceException BAD_CURRVOL_CONFIG(String msg) {
    return new VolumeServiceException(
        "invalid current volumes config: " + msg, BAD_CURRVOL_CONFIG, RECEIVERS_FAULT, null);
  }
  ...
  public static VolumeServiceException NO_SUCH_PATH(String path) {
    return new VolumeServiceException(
        "directory does not exist or is not writable: " + path, NO_SUCH_PATH, SENDERS_FAULT, null);
  }

  public static VolumeServiceException ALREADY_EXISTS(
      int id, String name, String path, Throwable t) {
    return new VolumeServiceException(
  ...
  public static VolumeServiceException CANNOT_DELETE_CURRVOL(int id, String volType) {
    return new VolumeServiceException(
        "volume " + id + " cannot be deleted because it is a current volume: " + volType,
        CANNOT_DELETE_CURRVOL,
        SENDERS_FAULT,
        null);
  }
  ...
  public static VolumeServiceException WRONG_TYPE_CURRVOL(int id, short currVolType) {
    return new VolumeServiceException(
        "volume " + id + " cannot be used as current volume of type " + currVolType,
        WRONG_TYPE_CURRVOL,
        SENDERS_FAULT,
        null);
  }
  ...
  public static VolumeServiceException INVALID_REQUEST(String msg) {
    return new VolumeServiceException(
        "invalid request: " + msg, INVALID_REQUEST, SENDERS_FAULT, null);
  }

  public static VolumeServiceException NOT_ABSOLUTE_PATH(String path) {
    return new VolumeServiceException(
        "\"" + path + "\" is not an absolute path", NOT_ABSOLUTE_PATH, SENDERS_FAULT, null);
  }
  ...
  public static VolumeServiceException SUBDIR_OF_ANOTHER_VOLUME(String path, Volume anotherVol) {
    return new VolumeServiceException(
        "the path \""
            + path
            + "\" is a subdirectory of another volume (id="
            + anotherVol.getId()
            + ", path="
            + anotherVol.getRootPath()
            + ")",
        SUBDIR_OF_ANOTHER_VOLUME,
        SENDERS_FAULT,
        null);
  }
