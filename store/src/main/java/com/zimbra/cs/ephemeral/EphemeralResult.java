...
/**
 * A wrapper class for results retrieved from EphemeralStore. This class supports both single- and
 * multi-valued keys. If a key is known to have a single value, the get*Value() methods should be
 * used. If a key has more than one, get*Values() should be used.
 *
 * @author iraykin
 */
public class EphemeralResult {
  ...
  public Integer getIntValue() {
    try {
      ...
      ZimbraLog.ephemeral.warn(
          "value '%s' cannot be converted to an integer, returning null", values[0]);
      return null;
    }
  }
  ...
  public Integer getIntValue(Integer defaultValue) {
    try {
      ...
      ZimbraLog.ephemeral.warn(
          "value '%s' cannot be converted to an integer, returning default value", values[0]);
      return defaultValue;
    }
  }
  ...
  public Long getLongValue() {
    try {
      ...
      ZimbraLog.ephemeral.warn(
          "value '%s' cannot be converted to a long, returning null", values[0]);
      return null;
    }
  }
  ...
  public Long getLongValue(Long defaultValue) {
    try {
      ...
      ZimbraLog.ephemeral.warn(
          "value '%s' cannot be converted to a long, returning default value", values[0]);
      return defaultValue;
    }
  }
  ...
  public Boolean getBoolValue() {
    try {
      ...
      ZimbraLog.ephemeral.warn(
          "value '%s' cannot be converted to a boolean, returning null", values[0]);
      return null;
    }
  }
  ...
  public Boolean getBoolValue(Boolean defaultValue) {
    try {
      ...
      ZimbraLog.ephemeral.warn(
          "value '%s' cannot be converted to a boolean, returning default value", values[0]);
      return defaultValue;
    }
  }
  ...
  private Integer[] convertToInts(Integer defaultValue) {
    ...
    for (int i = 0; i < values.length; i++) {
      try {
        ...
        ZimbraLog.ephemeral.warn(
            "value '%s' cannot be converted to an integer, using default", values[i]);
  ...
  private Long[] convertToLongs(Long defaultValue) {
    ...
    for (int i = 0; i < values.length; i++) {
      try {
        ...
        ZimbraLog.ephemeral.warn(
            "value '%s' cannot be converted to a long, using default", values[i]);
  ...
  private Boolean[] convertToBools(Boolean defaultValue) {
    ...
    for (int i = 0; i < values.length; i++) {
      try {
        ...
        ZimbraLog.ephemeral.warn(
            "value '%s' cannot be converted to a boolean, using default", values[i]);
