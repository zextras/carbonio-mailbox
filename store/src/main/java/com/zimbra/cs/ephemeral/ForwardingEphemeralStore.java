...
/**
 * Ephemeral store implementation used while attribute migration is in progress. Attribute
 * modifications are applied to both the current and upcoming store.
 *
 * @author iraykin
 */
