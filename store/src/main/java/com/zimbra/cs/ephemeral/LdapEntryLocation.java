 ...
 *
 * <p>This class exposes an additional getEntry() method to simply return the LDAP entry it was
 * instantiated with. This is used by @LdapEphemeralStore to simplify the process of accessing the
 * entry to modify.
 *
 * @author iraykin
 */
