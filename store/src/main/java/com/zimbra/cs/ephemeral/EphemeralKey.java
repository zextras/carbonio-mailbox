...
/**
 * The key portion of an ephemeral key/value pair. A wrapper around a string key, with an optional
 * "dynamic" component. It is up to the EphemeralBackend implementation to decide what to do with
