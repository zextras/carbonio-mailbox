...
public class ImapServerListenerPool {
   ...
   * believe this can be addressed by having more IMAP server front loaders. May revisit this later
   * if needed.
   */
  private final LoadingCache<String, ImapServerListener> serverToListenerMap =
      CacheBuilder.newBuilder()
          .concurrencyLevel(4)
          .initialCapacity(16) /* TODO - base on the total number of servers or use LDAP config? */
          .build(
              new CacheLoader<String, ImapServerListener>() {
