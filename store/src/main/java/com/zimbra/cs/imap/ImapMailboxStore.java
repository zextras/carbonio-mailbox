...
public abstract class ImapMailboxStore {
  ...
  public abstract ImapListener createListener(ImapFolder i4folder, ImapHandler handler)
   ...
   */
  public abstract List<Integer> imapCopy(
      OperationContext octxt, int[] itemIds, MailItemType type, int folderId)
      throws IOException, ServiceException;

  public abstract InputStreamWithSize getByImapId(
      OperationContext octxt, int imapId, String folderId, String resolvedPath)
      throws ServiceException;

  public abstract void checkAppendMessageFlags(OperationContext octxt, List<AppendMessage> appends)
      throws ServiceException;

  public abstract int getCurrentMODSEQ(ItemIdentifier folderId) throws ServiceException;

  public abstract boolean addressMatchesAccountOrSendAs(String givenAddress)
      throws ServiceException;
  ...
  public abstract Collection<FolderStore> getVisibleFolders(
  ...
  public abstract void saveSubscriptions(OperationContext octxt, Set<String> subs)
      throws ServiceException;

  public abstract int getImapRECENTCutoff(FolderStore folder);

  public abstract int getImapRECENT(OperationContext ctxt, FolderStore folder)
      throws ServiceException;
  ...
  public ImapServerListener getServerListener(ItemIdentifier ident) {
    ...
    try {
      ...
      ZimbraLog.imap.debug(
          "Problem getting ImapServerListener for folder=%s acct=%s from pool", ident, acctId, se);
      return null;
    }
  }
