...
public class ImapServiceException extends ServiceException {
  ...
  private ImapServiceException(
      String message, String code, boolean isReceiversFault, Argument... args) {
    super(message, code, isReceiversFault, args);
  }

  //  private ImapServiceException(String message, String code, boolean isReceiversFault, Throwable
  // cause, Argument... args) {
  ...
  public static ImapServiceException CANNOT_DELETE_SYSTEM_FOLDER(String folderName) {
    return new ImapServiceException(
        "cannot delete system folder: ",
        CANT_DELETE_SYSTEM_FOLDER,
        SENDERS_FAULT,
        new Argument(FOLDER_NAME, folderName, Argument.Type.STR));
  }

  public static ImapServiceException CANT_RENAME_INBOX() {
    return new ImapServiceException(
        "Rename of INBOX not supported", CANT_RENAME_INBOX, SENDERS_FAULT);
  }
