...
public abstract class MimeVisitor {
     ...
     *  messages on the fly. */
    private static final List<Class<? extends MimeVisitor>> sMimeConverters = new ArrayList<>();
    /** The list of registered MimeVistor classes that convert new messages
     *  before storing them to disk. */
    private static final List<Class<? extends MimeVisitor>> sMimeMutators   = new ArrayList<>();
