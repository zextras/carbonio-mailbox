...
/**
 * <code>MimeVisitor</code> implementation used for printing the structure of a <code>MimePart
...
public class MimeFormatter extends MimeVisitor {
  ...
  @Override
  public boolean visitMessage(MimeMessage mm, VisitPhase visitPhase) throws MessagingException {
