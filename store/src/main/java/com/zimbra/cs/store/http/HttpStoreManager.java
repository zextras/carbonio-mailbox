...
public abstract class HttpStoreManager extends ExternalStoreManager {
  ...
  protected abstract String getLocator(
      HttpPost post, String postDigest, long postSize, Mailbox mbox, HttpResponse httpResp)
  ...
  public String writeStreamToStore(InputStream in, long actualSize, Mailbox mbox)
    ...
    try {
      ...
      InputStreamEntity entity =
          new InputStreamEntity(pin, actualSize, ContentType.APPLICATION_OCTET_STREAM);
      ...
      if (statusCode == HttpStatus.SC_OK
        ...
        return getLocator(
            post, ByteUtil.encodeFSSafeBase64(digest.digest()), pin.getPosition(), mbox, httpResp);
      } else {
        throw ServiceException.FAILURE(
            "error POSTing blob: " + httpResp.getStatusLine().getReasonPhrase(), null);
      }
