...
/**
 * Example implementation of ExternalResumableUpload which writes to a flat directory structure This
 * is intended for illustration purposes only; it should *never* be used in a production environment
 */
public class SimpleStreamingStoreManager extends SimpleStoreManager
  ...
  private class SimpleStreamingIncomingBlob extends ExternalResumableIncomingBlob {
    ...
    public SimpleStreamingIncomingBlob(String id, BlobBuilder blobBuilder, Object ctx)
