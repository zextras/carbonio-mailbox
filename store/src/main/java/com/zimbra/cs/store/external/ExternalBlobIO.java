...
/**
 * Interface for the simplest blob store integration possible The implementor must provide
 * functionality for reading, writing, and deleting blobs
 */
public interface ExternalBlobIO {
   ...
   */
  String writeStreamToStore(InputStream in, long actualSize, Mailbox mbox)
