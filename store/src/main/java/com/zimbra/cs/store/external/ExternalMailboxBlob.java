...
public class ExternalMailboxBlob extends MailboxBlob {
  ...
  /**
   * Test if a MailboxBlob is valid and exists in remote store. Default implementation preemptively
   * fetches the complete blob to cache. However, implementors may override this to do a HEAD or
   * similar 'exists' operation
   *
