...
public class SharedFile {
  ...
  /**
   * Keep track of the number of threads that are reading from this file. We do this so that we
   * don't delete a file that's being read on Windows (bug 43497).
   */
  private int mNumReaders;

  /**
   * Remember the file's length, in case we have an open file descriptor and the uncompressed cache
   * deletes this file from disk.
   */
  private long mLength;

  /** Creates a new <tt>SharedFile</tt> and opens the underlying file descriptor. */
