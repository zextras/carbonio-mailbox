...
public class CommandFailedException extends MailException {
  ...
  /**
   * Creates a new <tt>CommandFailedException</tt> for the specified command and detail message.
   *
  ...
  /**
   * Returns true if use of mail connection can continue even after this command failure.
   *
