 ...
 *
 * <p>body-response = "BODY" section ["<" number ">"] SP nstring section = "[" [section-spec] "]"
 * section-spec = section-msgtext / (section-part ["." section-text]) section-msgtext = "HEADER" /
 * "HEADER.FIELDS" [".NOT"] SP header-list / "TEXT" section-text = section-msgtext / "MIME"
 * section-part = nz-number *("." nz-number) header-list = "(" header-fld-name *(SP header-fld-name)
