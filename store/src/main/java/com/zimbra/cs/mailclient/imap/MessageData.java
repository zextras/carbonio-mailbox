 ...
 *
 * <p>msg-att = "(" (msg-att-dynamic / msg-att-static) *(SP (msg-att-dynamic / msg-att-static)) ")"
 *
 * <p>msg-att-dynamic = "FLAGS" SP "(" [flag-fetch *(SP flag-fetch)] ")" ; MAY change for a message
 *
 * <p>msg-att-static = "ENVELOPE" SP envelope / "INTERNALDATE" SP date-time / "RFC822" [".HEADER" /
 * ".TEXT"] SP nstring / "RFC822.SIZE" SP number / "BODY" ["STRUCTURE"] SP body / "BODY" section
 * ["<" number ">"] SP nstring / "UID" SP uniqueid ; MUST NOT change for a message
 */
public final class MessageData {
  ...
  public Body[] getBodySections() {
    return bodySections != null ? bodySections.toArray(new Body[bodySections.size()]) : null;
  }
