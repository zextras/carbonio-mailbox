 ...
 *
 * <p>envelope = "(" env-date SP env-subject SP env-from SP env-sender SP env-reply-to SP env-to SP
 * env-cc SP env-bcc SP env-in-reply-to SP env-message-id ")" env-bcc = "(" 1*address ")" / nil
 * env-cc = "(" 1*address ")" / nil env-date = nstring env-from = "(" 1*address ")" / nil
 * env-in-reply-to = nstring env-message-id = nstring env-reply-to = "(" 1*address ")" / nil
 * env-sender = "(" 1*address ")" / nil env-subject = nstring env-to = "(" 1*address ")" / nil
 *
 * <p>address = "(" addr-name SP addr-adl SP addr-mailbox SP addr-host ")" addr-adl = nstring
 * addr-host = nstring addr-mailbox = nstring addr-name = nstring
 */
