...
public final class Flags extends AbstractSet<Atom> {
  ...
  public boolean isAnswered() {
    return isSet(MASK_ANSWERED);
  }

  public boolean isFlagged() {
    return isSet(MASK_FLAGGED);
  }

  public boolean isDeleted() {
    return isSet(MASK_DELETED);
  }

  public boolean isSeen() {
    return isSet(MASK_SEEN);
  }

  public boolean isDraft() {
    return isSet(MASK_DRAFT);
  }

  public boolean isRecent() {
    return isSet(MASK_RECENT);
  }

  public boolean isStar() {
    return isSet(MASK_STAR);
  }

  public boolean isNoselect() {
    return isSet(MASK_NOSELECT);
  }

  public boolean isMarked() {
    return isSet(MASK_MARKED);
  }

  public boolean isUnmarked() {
    return isSet(MASK_UNMARKED);
  }

  public boolean isNoinferiors() {
    return isSet(MASK_NOINFERIORS);
  }
  ...
  public boolean contains(Object obj) {
    ...
    Atom flag = (Atom) obj;
    int mask = getMask(CAtom.get(flag));
    return mask != 0 ? isSet(mask) : otherFlags != null && otherFlags.contains(flag);
  }
