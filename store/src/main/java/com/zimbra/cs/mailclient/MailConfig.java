...
public abstract class MailConfig {
  ...
  /**
   * Creates a new {@link MailConfig} instance for the specified mail server host.
   *
   * @param log default logger
  ...
  /**
   * Returns the <tt>SSLSocketFactory</tt> to use for creating SSL or TLS connections. The default
   * is to use the factory returned by the method <tt>SSLSocketFactory.getDefault</tt>.
   *
  ...
  /**
   * Sets the <tt>SSLSocketFactory</tt> to use for creating SSL or TLS connections.
   *
  ...
  /**
   * Sets the authentication id. This is the identify that must be authenticated when accessing the
   * mail server and is usually required for authentication.
   *
  ...
  /**
   * Returns the authorization id. This is an alternate user identity that will be used when
   * accessing the mail server. This is optional and only used for SASL authentication.
   *
  ...
  /**
   * Sets the authorization id to use for SASL authentication. This is an alternate user identity
   * that will be used when accessing the mail server.
   *
  ...
  /**
   * Returns the SASL authentication mechanism for the connection. If <tt>null</tt> then SASL
   * authentication will not be used (this is the default).
   *
  ...
  /**
   * Returns SASL authentication properties. These properties will be specified when {@link
   * javax.security.sasl.Sasl#createSaslClient Sasl.createSaslClient} is called to create the
   * <tt>SaslClient</tt>.
   *
  ...
  /**
   * Returns the <tt>AuthenticatorFactory</tt> to use for SASL authentication. The default value is
   * what is returned by calling {@link AuthenticatorFactory#getDefault}
   *
  ...
  /**
   * Returns the current socket read timeout value in seconds. This is the maximum number of seconds
   * to wait for data when reading from the connection.
   *
  ...
  /**
   * Returns the socket connect timeout value in seconds. This is the maximum number of seconds to a
   * new connection to get established.
   *
