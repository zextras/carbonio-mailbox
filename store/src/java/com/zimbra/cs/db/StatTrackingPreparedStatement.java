...
/**
 * A decorator class for the PreparedStatement interface that tracks the performance of database
 * calls for various request types in zmstats CSV files. The actual SQL query string can be passed
 * in the constructor or via setQueryString, since the actual SQL query can't reliably be retrieved
 * from the PreparedStatement. Calls to trackQueryStats happen in all "execute" methods that take no
 * arguments; all other calls simply delegate to the wrapped PreparedStatement instance.
 *
 * <p>Added for bug #56968
 *
 * @author iraykin
 */
