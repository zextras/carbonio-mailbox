...
class ProxyConfVar {
  ...
  public String formatLong(Object o) {
    ...
    if (l % (1024 * 1024) == 0) f.format("%dm", l / (1024 * 1024));
    else if (l % 1024 == 0) f.format("%dk", l / 1024);
    else f.format("%d", l);
    return f.toString();
  }
...
public class ProxyConfGen {
  ...
  public static void expandTemplate(File tFile, File wFile) throws ProxyConfException {
