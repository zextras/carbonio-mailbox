...
public abstract class TargetIterator {
    ...
    throws ServiceException {
        ...
        if (target instanceof CalendarResource) {
            ...
            iter =  new TargetIterator.XMPPComponentTargetIterator(prov, target);
             ...
             iter =  new TargetIterator.AlwaysOnClusterTargetIterator(prov, target);
        } else {
            throw ServiceException.FAILURE(new StringBuilder(
                    "internal error - no TargetIterator for ").append(target.getClass().getName()).toString(), null);
        }
    ...
    public static class AlwaysOnClusterTargetIterator extends TargetIterator {
        ...
        AlwaysOnClusterTargetIterator(Provisioning prov, Entry target) {
            super(prov, TargetType.alwaysoncluster, target);
        }
    }
