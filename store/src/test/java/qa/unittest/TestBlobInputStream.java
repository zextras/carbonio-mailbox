...
public class TestBlobInputStream extends TestCase {
  ...
  public void testBlobInputStream() throws Exception {
    ...
    for (int bufferSize : bufferSizes) {
      TestUtil.setServerAttr(
          Provisioning.A_zimbraMailFileDescriptorBufferSize, Integer.toString(bufferSize));
  ...
  public void runLargeFileTest() throws Exception {
    ...
    assertEquals(
        content.substring(thirdChunkStartPos, thirdChunkStartPos + numRead),
        new String(thirdChunk));
