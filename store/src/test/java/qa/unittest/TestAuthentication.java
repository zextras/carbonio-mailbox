...
public class TestAuthentication extends TestCase {
    ...
    public void testAccountLockout() throws Exception {
        ...
        assertTrue("account is not lockedout", verifyLockedoutAndReactivateAccount(acct, transport));
       ...
       assertTrue("account is not active", acct.getAccountStatus().equals(AccountStatus.active));
