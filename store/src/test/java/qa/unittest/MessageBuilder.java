...
public class MessageBuilder {
  ...
  /**
   * Used to generate a message with no <tt>Message-ID</tt> header. This allows us to inject the
   * same message multiple times without being deduped.
   */
  ...
  public String create() throws MessagingException, ServiceException, IOException {
    ...
    if (attachment == null) {
      ...
      body.setDataHandler(
          new DataHandler(new ByteArrayDataSource(this.body.getBytes(), contentType)));
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println(
        new MessageBuilder()
            ...
            .withAttachment("attachment", "test.txt", "text/plain")
            .create());
  }
}
