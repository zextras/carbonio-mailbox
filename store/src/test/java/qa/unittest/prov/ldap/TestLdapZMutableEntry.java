...
public class TestLdapZMutableEntry extends LdapTest {
  ...
  public void mapToAttrsBinarySingle() throws Exception {
    ...
    BinaryLdapData.Content VALUE_BINARY =
        BinaryLdapData.Content.generateContent(NUM_BYTES_IN_BINARY_DATA);
    BinaryLdapData.Content VALUE_BINARY_TRANSFER =
        BinaryLdapData.Content.generateContent(NUM_BYTES_IN_BINARY_DATA);
  ...
  public void mapToAttrsBinaryMulti() throws Exception {
    ...
    BinaryLdapData.Content VALUE_BINARY_1 =
        BinaryLdapData.Content.generateContent(NUM_BYTES_IN_BINARY_DATA);
    BinaryLdapData.Content VALUE_BINARY_2 =
        BinaryLdapData.Content.generateContent(NUM_BYTES_IN_BINARY_DATA);
    BinaryLdapData.Content VALUE_BINARY_TRANSFER_1 =
        BinaryLdapData.Content.generateContent(NUM_BYTES_IN_BINARY_DATA);
    BinaryLdapData.Content VALUE_BINARY_TRANSFER_2 =
        BinaryLdapData.Content.generateContent(NUM_BYTES_IN_BINARY_DATA);

    Map<String, Object> attrMap = new HashMap<String, Object>();

    attrMap.put(
        KEY_MULTI_BINARY, new String[] {VALUE_BINARY_1.getString(), VALUE_BINARY_2.getString()});
    attrMap.put(
        KEY_MULTI_BINARY_TRANSFER,
        new String[] {VALUE_BINARY_TRANSFER_1.getString(), VALUE_BINARY_TRANSFER_2.getString()});
