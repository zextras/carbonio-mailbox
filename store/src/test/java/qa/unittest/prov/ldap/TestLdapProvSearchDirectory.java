...
import qa.unittest.prov.ProvTest;
...
public class TestLdapProvSearchDirectory extends LdapTest {
  ...
  private Account createAccount(
      Provisioning prov, String localPart, Domain domain, Map<String, Object> attrs)
      throws Exception {
  ...
  private CalendarResource createCalendarResource(
  ...
  public void accountsByGrants() throws Exception {
    ...
    ZLdapFilter filter =
        ZLdapFilterFactory.getInstance().accountsByGrants(GRANTEE_IDS, true, false);
  ...
  public void accountsOnServerAndCosHasSubordinates() throws Exception {
    ...
    ZLdapFilter filter =
        ZLdapFilterFactory.getInstance()
            .accountsOnServerAndCosHasSubordinates(
  ...
  public void idnFilter() throws Exception {
    ...
    options.setFilterString(
        FilterId.UNITTEST, String.format("(zimbraMailDeliveryAddress=%s)", acctUnicodeName));
    options.setConvertIDNToAscii(true);
    List<NamedEntry> entries = prov.searchDirectory(options);
  ...
  public void dnSubtreeMatchFilter() throws Exception {
    ...
    DistributionList dlSub =
        provUtil.createDistributionList(genGroupNameLocalPart("dl"), subSubDomain);
    ...
    try {
      ...
      options.setSortOpt(SortOpt.SORT_ASCENDING);
      options.setFilterString(
          FilterId.UNITTEST, ((LdapDomain) subDomain).getDnSubtreeMatchFilter().toFilterString());
  ...
  */
  ...
  public void filterWithCharsNeedEscaping() throws Exception {
    ...
    Account acctStar =
        provUtil.createAccount(
            genAcctNameLocalPart("star"), subDomain, Collections.singletonMap(ATTR, (Object) "*"));
    Account acctLeftParen =
        provUtil.createAccount(
            genAcctNameLocalPart("left-paren"),
            subDomain,
            Collections.singletonMap(ATTR, (Object) "("));
    Account acctRightParen =
        provUtil.createAccount(
            genAcctNameLocalPart("right-paren"),
            subDomain,
            Collections.singletonMap(ATTR, (Object) ")"));
    Account acctBackSlash =
        provUtil.createAccount(
            genAcctNameLocalPart("back-slash"),
            subDomain,
            Collections.singletonMap(ATTR, (Object) "\\"));
  ...
  private void testFilterWithCharsNeedEscaping(
      Account expected, String filterAttr, String filterValue) throws Exception {
    SearchDirectoryOptions options = new SearchDirectoryOptions();
