...
public class TestLdapBinary extends LdapTest {
  ...
  */
  ...
  private static SingleValuedTestData ZIMBRA_BINARY_SINGLE =
      new SingleValuedTestData("zimbraUnittestBinary", CONTENT_NAME);

  private static SingleValuedTestData ZIMBRA_CERTIFICATE_SINGLE =
      new SingleValuedTestData("zimbraUnittestCertificate", CERT_NAME_1);

  private static SingleValuedTestData ZIMBRA_BINARY_SINGLE_TEST_TOO_LARGE =
      new SingleValuedTestData("zimbraUnittestBinary", CONTENT_NAME_TOO_LARGE);

  private static MultiValuedTestData ZIMBRA_BINARY_MULTI =
      new MultiValuedTestData(
  ...
  private static MultiValuedTestData CERTIFICATE_MULTI =
      new MultiValuedTestData(
  ...
  private static MultiValuedTestData RFC2252_BINARY_MULTI =
      new MultiValuedTestData(
  ...
  private static class MultiValuedTestData {
    ...
    MultiValuedTestData(
        String attrName, String[] contents, String[] contentsToRemove, String[] contentsRemaining) {
      this.attrName = attrName;
  ...
  private void modify(String attrName, String[] contentNames) throws Exception {
    ...
    for (String contentName : contentNames) {
      StringUtil.addToMultiMap(
          attrs, attrName, BinaryLdapData.Content.getContentByFileName(contentName).getString());
    }
    prov.modifyAttrs(entry, attrs);
  }
