...
public class TestLdapProvDistributionList extends LdapTest {
  ...
  private void verifyMembership(
      String acctId, Set<String> expectedAllGroups, Set<String> expectedDirectGroups)
      throws Exception {
  ...
  public void renameDistributionList() throws Exception {
    ...
    Set<String> addrsForDelegatedSender =
        renamedDl.getMultiAttrSet(Provisioning.A_zimbraPrefAllowAddressForDelegatedSender);
  ...
  public void renameDistributionListDomainChanged() throws Exception {
    ...
    String DL_NEW_NAME_LOCALPART = Names.makeDLNameLocalPart(genGroupNameLocalPart("new"));
    String DL_NEW_NAME =
        TestUtil.getAddress(DL_NEW_NAME_LOCALPART, newDomain.getName()).toLowerCase();
  ...
  public void accountInDistributionList() throws Exception {
    ...
    String ACCT_NAME_IN_DL_LOCALPART =
        Names.makeAccountNameLocalPart(genAcctNameLocalPart("acct-in"));
    Account acctInDL = createAccount(ACCT_NAME_IN_DL_LOCALPART);
    String ACCT_NAME_NOT_IN_DL_LOCALPART =
        Names.makeAccountNameLocalPart(genAcctNameLocalPart("acct-not-in"));
  ...
  public void dlInDistributionList() throws Exception {
    ...
    String DL_NAME_NOT_IN_DL_LOCALPART =
        Names.makeDLNameLocalPart(genGroupNameLocalPart("dl-not-in"));
