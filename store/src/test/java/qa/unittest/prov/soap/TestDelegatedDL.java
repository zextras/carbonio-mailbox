...
import qa.unittest.prov.Verify;
...
public class TestDelegatedDL extends SoapTest {
  ...
  private static Group createDelegatedGroup(
      SoapTransport transport, String groupName, List<KeyValuePair> attrs) throws Exception {
    Group group = prov.getGroup(Key.DistributionListBy.name, groupName);
    assertNull(group);

    CreateDistributionListRequest req =
        new CreateDistributionListRequest(groupName, attrs, DYNAMIC);
  ...
  private static Group createGroupAndAddOwner(
      String groupName, Multimap<String, String> attrs, String ownerName) throws Exception {
    Group group = prov.getGroup(Key.DistributionListBy.name, groupName);
    assertNull(group);
    ...
    CreateDistributionListRequest req =
        new CreateDistributionListRequest(groupName, KeyValuePair.fromMultimap(attrs), DYNAMIC);
    CreateDistributionListResponse resp = invokeJaxb(transport, req);
  ...
  private static void addOwner(SoapTransport transport, String groupName, String ownerName)
      throws Exception {
    DistributionListAction action = new DistributionListAction(Operation.addOwners);
    DistributionListActionRequest actionReq =
        new DistributionListActionRequest(DistributionListSelector.fromName(groupName), action);

    action.addOwner(
        new DistributionListGranteeSelector(
            com.zimbra.soap.type.GranteeType.usr, DistributionListGranteeBy.name, ownerName));
    DistributionListActionResponse actionResp = invokeJaxb(transport, actionReq);
  }
  ...
  public void getDistributionList() throws Exception {
    ...
    GetDistributionListRequest req =
        new GetDistributionListRequest(DistributionListSelector.fromName(DL_NAME), Boolean.TRUE);
    ...
    for (KeyValuePair attr : attrs) {
      ...
      // zimbraAccount:GetDistributionListResponse should return the default value, instead of
      // empty.
  ...
  public void getDistributionListRights() throws Exception {
    ...
    DistributionListActionRequest req =
        new DistributionListActionRequest(DistributionListSelector.fromName(GROUP_NAME), action);

    DistributionListRightSpec dlRight1 = new DistributionListRightSpec(right1);
    dlRight1.addGrantee(
        new DistributionListGranteeSelector(
            com.zimbra.soap.type.GranteeType.usr,
            DistributionListGranteeBy.name,
            grantee1.getName()));
    dlRight1.addGrantee(
        new DistributionListGranteeSelector(
            com.zimbra.soap.type.GranteeType.usr,
    ...
    dlRight2.addGrantee(
        new DistributionListGranteeSelector(com.zimbra.soap.type.GranteeType.all, null, null));
    ...
    GetDistributionListRequest getDLReq =
        new GetDistributionListRequest(
            DistributionListSelector.fromName(GROUP_NAME), Boolean.FALSE, right1 + "," + right2);
    ...
    Verify.verifyEquals(
        ...
        right1GranteeNames);
    Verify.verifyEquals(
        Sets.newHashSet(Verify.makeResultStr(GranteeType.GT_AUTHUSER.getCode(), "null")),
        right2GranteeNames);
  }
  ...
  public void distributionListActionAddRemoveMembers() throws Exception {
    ...
    DistributionListActionRequest req =
        new DistributionListActionRequest(DistributionListSelector.fromName(DL_NAME), action);
  ...
  public void distributionListActionAddRemoveOwners() throws Exception {
    ...
    action.addOwner(
        new DistributionListGranteeSelector(
            com.zimbra.soap.type.GranteeType.usr, DistributionListGranteeBy.name, USER_OWNER));
    action.addOwner(
        new DistributionListGranteeSelector(
            com.zimbra.soap.type.GranteeType.usr,
            DistributionListGranteeBy.name,
    ...
    //
    GetDistributionListRequest getDLReq =
        new GetDistributionListRequest(DistributionListSelector.fromName(GROUP_NAME), Boolean.TRUE);
    GetDistributionListResponse getDLResp = invokeJaxb(transport, getDLReq);
    DistributionListInfo dlInfo = getDLResp.getDl();
    ...
    Verify.verifyEquals(
        Sets.newHashSet(USER_OWNER, owner1.getName(), owner2.getName()), ownerNames);
  ...
  public void distributionListActionSetOwners() throws Exception {
    ...
    action.addOwner(
        new DistributionListGranteeSelector(
            com.zimbra.soap.type.GranteeType.email,
            DistributionListGranteeBy.name,
            owner3.getName()));
    DistributionListActionResponse resp = invokeJaxb(transport, req);
  ...
  public void distributionListActionGrantRevokeSetRights() throws Exception {
    ...
    dlRight1.addGrantee(
        new DistributionListGranteeSelector(
            com.zimbra.soap.type.GranteeType.grp,
            DistributionListGranteeBy.name,
            groupGrantee1.getName()));
    dlRight1.addGrantee(
        new DistributionListGranteeSelector(com.zimbra.soap.type.GranteeType.all, null, null));
    dlRight1.addGrantee(
        new DistributionListGranteeSelector(com.zimbra.soap.type.GranteeType.pub, null, null));
    dlRight1.addGrantee(
        new DistributionListGranteeSelector(
            com.zimbra.soap.type.GranteeType.email,
            DistributionListGranteeBy.name,
    ...
    dlRight1.addGrantee(
        new DistributionListGranteeSelector(
            com.zimbra.soap.type.GranteeType.email,
            DistributionListGranteeBy.name,
            groupGrantee2.getName()));
    dlRight1.addGrantee(
        new DistributionListGranteeSelector(
            com.zimbra.soap.type.GranteeType.email, DistributionListGranteeBy.name, GUEST));
    ...
    RightCommand.Grants grants =
        prov.getGrants(TargetType.dl.name(), TargetBy.id, group.getId(), null, null, null, true);
  ...
  public void distributionListActionRename() throws Exception {
    ...
    req =
        new DistributionListActionRequest(
  ...
  public void distributionListActionDelete() throws Exception {
    ...
    DistributionListActionRequest req =
        new DistributionListActionRequest(DistributionListSelector.fromName(NAME), action);
  ...
  public void subscribeDistributionList() throws Exception {
    ...
    // subscribe
    SubscribeDistributionListRequest req =
        new SubscribeDistributionListRequest(
            DistributionListSelector.fromName(DL_NAME), DistributionListSubscribeOp.subscribe);
    ...
    req =
        new SubscribeDistributionListRequest(
            DistributionListSelector.fromName(DL_NAME), DistributionListSubscribeOp.unsubscribe);
  ...
  public void getAccountDistributionLists() throws Exception {
    ...
    Group group1 =
        provUtil.createGroup(
            GROUP_1_NAME,
            Collections.singletonMap(Provisioning.A_displayName, (Object) GROUP_1_DISPLAY_NAME),
            DYNAMIC);
    Group group2 =
        provUtil.createGroup(
            GROUP_2_NAME,
            Collections.singletonMap(Provisioning.A_displayName, (Object) GROUP_2_DISPLAY_NAME),
            DYNAMIC);
    Group group3 =
        provUtil.createGroup(
            GROUP_3_NAME,
            Collections.singletonMap(Provisioning.A_displayName, (Object) GROUP_3_DISPLAY_NAME),
            DYNAMIC);
    Group group4 =
        provUtil.createGroup(
            GROUP_4_NAME,
            Collections.singletonMap(Provisioning.A_displayName, (Object) GROUP_4_DISPLAY_NAME),
            DYNAMIC);
    ...
    GetAccountDistributionListsRequest req =
        new GetAccountDistributionListsRequest(
            Boolean.TRUE,
            MemberOfSelector.all,
            Sets.newHashSet(
    ...
    expectedAttrValuesOwner.add(
        Verify.makeResultStr(
            Provisioning.A_zimbraMailStatus, ZAttrProvisioning.MailStatus.enabled.name()));

    List<String> expectedAttrValuesNonOwner = Lists.newArrayList();
    expectedAttrValuesNonOwner.add(
        Verify.makeResultStr(
            Provisioning.A_zimbraDistributionListSubscriptionPolicy,
            ZAttrProvisioning.DistributionListSubscriptionPolicy.REJECT.name()));
    expectedAttrValuesNonOwner.add(
    ...
    Verify.verifyEquals(
        Lists.newArrayList(
            Verify.makeResultStr(
                group2.getId(),
                group2.getName(),
                group2.getDisplayName(),
                Boolean.FALSE,
                Boolean.TRUE,
                expectedAttrValuesNonOwner),
            Verify.makeResultStr(
                group3.getId(),
                group3.getName(),
                group3.getDisplayName(),
                Boolean.FALSE,
                Boolean.TRUE,
                expectedAttrValuesNonOwner),
            Verify.makeResultStr(
                group4.getId(),
                group4.getName(),
                group4.getDisplayName(),
                Boolean.TRUE,
                Boolean.FALSE,
                expectedAttrValuesOwner),
            Verify.makeResultStr(
                group1.getId(),
                group1.getName(),
                group1.getDisplayName(),
                Boolean.TRUE,
                Boolean.TRUE,
                expectedAttrValuesOwner)),
        result);
  ...
  public void noHomeServerZimbraAccount() throws Exception {
     ...
     */
    GetDistributionListRequest getDLreq =
        new GetDistributionListRequest(DistributionListSelector.fromName(groupName), Boolean.TRUE);
    verifyCaughtProxyError(transport, getDLreq);

    /*
     * DistributionListAction
     */
    DistributionListActionRequest DLActionReq =
        new DistributionListActionRequest(
     ...
     */
    SubscribeDistributionListRequest subsDLReq =
        new SubscribeDistributionListRequest(
            DistributionListSelector.fromName(groupName), DistributionListSubscribeOp.subscribe);
  ...
  public void noHomeServerZimbraAdmin() throws Exception {
    ...
    com.zimbra.soap.admin.message.GetDistributionListResponse getDLResp =
     ...
     */
    req =
        new AddDistributionListAliasRequest(
            groupId, TestUtil.getAddress(genGroupNameLocalPart("alias"), DOMAIN_NAME));
    ...
    req =
        new AddDistributionListMemberRequest(
            ...
            Collections.singleton(
                TestUtil.getAddress(genAcctNameLocalPart("member"), DOMAIN_NAME)));
  ...
  public void hideInGal() throws Exception {
    ...
    prov.addGroupMembers(
        group, new String[] {memberAcct3.getName(), memberAcct2.getName(), memberAcct1.getName()});
    ...
    // auth as the owner
    SoapTransport transport = authUser(ownerAcct.getName());
    GetDistributionListMembersRequest req =
        new GetDistributionListMembersRequest(null, null, group.getName());
