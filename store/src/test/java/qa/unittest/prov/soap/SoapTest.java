...
public class SoapTest extends ProvTest {
  ...
  public static SoapTransport authAdmin(String acctName, String password) throws Exception {
    ...
    com.zimbra.soap.admin.message.AuthRequest req =
        new com.zimbra.soap.admin.message.AuthRequest(acctName, password);
  ...
  public static <T> T invokeJaxb(SoapTransport transport, Object jaxbObject)
      throws ServiceException, IOException, HttpException {
    return (T) invokeJaxb(transport, jaxbObject, JSON ? SoapProtocol.SoapJS : SoapProtocol.Soap12);
  }
  ...
  public static <T> T invokeJaxbOnTargetAccount(
      SoapTransport transport, Object jaxbObject, String targetAcctId) throws Exception {
