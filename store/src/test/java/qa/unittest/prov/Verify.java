...
public class Verify {
  ...
  private static void dump(
      AssertionError e, Collection<String> expected, Collection<String> actual) {
    System.out.println();
  ...
  public static void verifyEquals(Set<String> expected, List<NamedEntry> actual) {
    try {
      ...
      System.out.println();
      System.out.println(String.format("expected (size=%d)", expected.size()));
      for (String name : expected) System.out.println("    " + name);

      System.out.println();
      System.out.println(String.format("actual (size=%d)", actual.size()));
      for (NamedEntry entry : actual) System.out.println("    " + entry.getName());
  ...
  public static void verifyEquals(
      List<? extends NamedEntry> expected,
      List<? extends NamedEntry> actual,
