...
/*
 * To run this test:
 * zmsoap -v -z RunUnitTestsRequest/test=qa.unittest.TestCalAttendeesDiff
 *
 */
...
public class TestCalAttendeesDiff extends TestCase {
  ...
  private static final String ZIMBRA_GROUP = TestUtil.getAddress("group", ZIMBRA_DOMAIN);

  private static final String EXTERNAL_DOMAIN = "external.galgrouptest";
  private static final String EXTERNAL_GROUP =
      TestUtil.getAddress("external-group", EXTERNAL_DOMAIN);
