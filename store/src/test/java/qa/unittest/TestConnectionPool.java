...
public class TestConnectionPool extends TestCase {
  ...
  /**
   * Confirms that getting and closing connections properly increments and decrements the pool size.
   * Also confirms that maintenance connections don't affect the connection pool.
   */
