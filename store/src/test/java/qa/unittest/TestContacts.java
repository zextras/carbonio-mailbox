...
public class TestContacts {
    ...
    public void testMoveContact() throws Exception {
        ...
        assertEquals("file1.txt", att.getFilename());
        assertEquals("text/plain", att.getContentType());
        assertEquals("attachment 1", new String(att.getContent()));
    ...
    public void testImportContacts() throws Exception {
        ...
        assertEquals("Number of contacts imported", contactNum, res.getCount());
    }
}
