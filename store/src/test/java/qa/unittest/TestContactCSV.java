...
/**
 * Unit test for {@link ContactCSV}. Note that ContactCSV import requires
 * /opt/zextras/conf/contact-fields.xml
 */
public final class TestContactCSV extends TestCase {

  /**
   * Ensure that we autodetect the use of ";" as a separator when the fields are quoted. Also ensure
   * that a comma inside the quotes for the first field doesn't confuse things
   */
  public void testSemicolonSepWithQuotes() throws Exception {
    String hdr =
        "\"Junk with, comma\";\"Title\";\"First Name\";\"Last Name\";\"E-mail Address\";\"User 1\"";
