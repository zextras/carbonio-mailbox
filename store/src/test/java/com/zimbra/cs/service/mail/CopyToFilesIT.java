...
public class CopyToFilesIT {
  ...
  * @throws ServiceException
   */
 @Test
 void shouldHandleCopyToFilesCall()
  ...
  * @throws ServiceException
   ...
   */
 @Test
 void shouldThrowServiceExceptionIfFileServiceReturnsFailure()
   throws ServiceException, IOException, MessagingException {
  // get account that will do the SOAP request
  Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
  ...
  * @throws ServiceException
   ...
   */
 @Test
 void shouldThrowServiceExceptionIfFileServiceReturnsNull()
   throws ServiceException, IOException, MessagingException {
  // get account that will do the SOAP request
  Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
  ...
  * @throws ServiceException
   ...
   */
 @Test
 void shouldCallFilesUploadWithCorrectParameters() throws Exception {
  Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
  ...
  * @throws Exception
   */
 @Test
 void shouldThrowServiceExceptionWithInternalFailureIfGetAuthTokenFails() throws Exception {
  // prepare request
