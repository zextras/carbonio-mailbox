...
public class GetFilterRulesAdminTest extends MailboxTestSuite {
  ...
  @Test
  void testSieveToSoapReplaceheaderActionBasicWithRelationalComparatorAndValue()
  ...
  @Test
  void testSieveToSoapReplaceheaderActionBasicWithRelationalComparatorAndCount()
      throws ServiceException {
    RuleManager.clearCachedRules(account);
    String script =
        "require [\"editheader\", \"variables\"];\n"
