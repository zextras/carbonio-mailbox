...
public class GetFilterRulesTest {
  ...
  private final FilesClient filesClient = FilesClient.atURL("http://127.78.0.7:20002");
  private final AttachmentService attachmentService = new MailboxAttachmentService();
  ...
  public void testBug71036_SingleRuleSimpleNestedIfwithSOAP() throws Exception {
    ...
    expectedSoap +=
        "      <headerTest index=\"0\" value=\"important\" stringComparison=\"is\""
            + " header=\"Subject\"/>\n";
    ...
    expectedSoap += "      <filterTests condition=\"anyof\">\n";
    expectedSoap +=
        "        <headerTest index=\"0\" value=\"confidential\" stringComparison=\"contains\""
            + " header=\"Subject\"/>\n";
    expectedSoap += "      </filterTests>\n";
    expectedSoap += "      <filterActions>\n";
  ...
  public void testBug71036_SingleRuleSimpleNestedIfwithMultiConditions01() throws Exception {
    ...
    expectedSoap +=
        "      <headerTest index=\"0\" value=\"important\" stringComparison=\"is\""
            + " header=\"Subject\"/>\n";
    expectedSoap +=
        "      <headerTest index=\"1\" value=\"zimbra\" stringComparison=\"contains\""
            + " header=\"From\"/>\n";
    expectedSoap += "    </filterTests>\n";
    // expectedSoap += "    <filterActions/>\n";
    expectedSoap += "    <nestedRule>\n";
  ...
  public void testBug71036_SingleRuleSimpleNestedIfwithJSON() throws Exception {
    ...
    context.put(
        SoapEngine.ZIMBRA_ENGINE,
        new MockSoapEngine(new MailService(attachmentService, filesClient)));
    // return context;
  ...
  public void testBug71036_SingleRuleMultiNestedIf() throws Exception {
    ...
    expectedSoap += "        <filterTests condition=\"anyof\">\n";
    expectedSoap +=
        "          <headerTest index=\"0\" value=\"secret\" stringComparison=\"contains\""
            + " header=\"Subject\"/>\n";
    expectedSoap += "        </filterTests>\n";
    // expectedSoap += "        <filterActions/>\n";
    expectedSoap += "        <nestedRule>\n";
    expectedSoap += "          <filterTests condition=\"anyof\">\n";
    expectedSoap +=
        "            <headerTest index=\"0\" value=\"project\" stringComparison=\"contains\""
            + " header=\"Subject\"/>\n";
    expectedSoap += "          </filterTests>\n";
    expectedSoap += "          <filterActions>\n";
    expectedSoap += "            <actionFlag index=\"0\" flagName=\"priority\"/>\n";
  ...
  public void testBug1281_SingleRuleElsif() throws Exception {
    ...
    ss +=
        "{ redirect \"qa-automation@zqa-380.eng.zimbra.com\"; log \"Forward message to"
            + " qa-automation DL\"; }\n";
  ...
  public void testEnvelopeTest() throws Exception {
    ...
    String expectedSoap =
        "<GetFilterRulesResponse xmlns=\"urn:zimbraMail\"><filterRules><filterRule"
            + " active=\"1\"><filterTests condition=\"anyof\"><envelopeTest stringComparison=\"is\""
            + " part=\"all\" header=\"from\" index=\"0\""
            + " value=\"tim@example.com\"/></filterTests><filterActions><actionTag index=\"0\""
            + " tagName=\"t2\"/>"
  ...
  public void testEnvelopeTestNumericComparison() throws Exception {
    ...
    String expectedSoap =
        "<GetFilterRulesResponse xmlns=\"urn:zimbraMail\"><filterRules><filterRule"
            + " active=\"1\"><filterTests condition=\"anyof\"><envelopeTest countComparison=\"eq\""
            + " part=\"all\" header=\"from\" index=\"0\""
            + " value=\"1\"/></filterTests><filterActions><actionTag index=\"0\" tagName=\"t2\"/>"
            + "</filterActions></filterRule></filterRules></GetFilterRulesResponse>";
  ...
  public void testFilterVariables() {
    try {
      ...
      String filterScript =
          "require [\"fileinto\", \"reject\", \"tag\", \"flag\", \"variables\", \"log\","
              + " \"enotify\"];\n"
              + "\n"
              + "# t60\n"
              + "set \"var\" \"testTag\";\n"
      ...
      String expectedSoap =
          "<GetFilterRulesResponse xmlns=\"urn:zimbraMail\">\n"
              ...
              + "        <headerTest stringComparison=\"contains\" header=\"subject\" index=\"0\""
              + " value=\"test\"/>\n"
              + "      </filterTests>\n"
              + "      <filterActions>\n"
              ...
              + "        <nestedRule>\n"
              + "          <filterTests condition=\"anyof\">\n"
              + "            <headerTest stringComparison=\"contains\" header=\"subject\""
              + " index=\"0\" value=\"def\"/>\n"
              + "          </filterTests>\n"
              + "          <filterActions>\n"
              + "            <filterVariables index=\"0\">\n"
    ...
    try {
      ...
      String expectedSoap =
          "<GetFilterRulesResponse xmlns=\"urn:zimbraMail\">\n"
              ...
              + "      </filterVariables>\n"
              + "      <filterTests condition=\"anyof\">\n"
              + "        <headerTest stringComparison=\"matches\" header=\"subject\" index=\"0\""
              + " value=\"test\"/>\n"
              + "      </filterTests>\n"
              + "      <filterActions>\n"
              + "        <actionTag index=\"0\" tagName=\"${var_new}\"/>\n"
