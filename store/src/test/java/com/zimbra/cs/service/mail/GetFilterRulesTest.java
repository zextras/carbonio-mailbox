...
public class GetFilterRulesTest extends MailboxTestSuite {
  ...
  @Test
  void testBug71036_SingleRuleSimpleNestedIfwithSOAP() throws Exception {
    ...
    expectedSoap +=
        "      <headerTest index=\"0\" value=\"important\" stringComparison=\"is\" header=\"Subject\"/>\n";
    expectedSoap += "    </filterTests>\n";
    // expectedSoap += "    <filterActions/>\n";
    expectedSoap += "    <nestedRule>\n";
    expectedSoap += "      <filterTests condition=\"anyof\">\n";
    expectedSoap +=
        "        <headerTest index=\"0\" value=\"confidential\" stringComparison=\"contains\" header=\"Subject\"/>\n";
    expectedSoap += "      </filterTests>\n";
    expectedSoap += "      <filterActions>\n";
  ...
  @Test
  void testBug71036_SingleRuleSimpleNestedIfwithMultiConditions01() throws Exception {
    Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
    ...
    // header :contains \"Subject\" \"confidential\" { flag \"priority\"; }}");
    // ZimbraLog.filter.info(acct.getMailSieveScript());
    ...
    expectedSoap +=
        "      <headerTest index=\"0\" value=\"important\" stringComparison=\"is\" header=\"Subject\"/>\n";
    expectedSoap +=
        "      <headerTest index=\"1\" value=\"zimbra\" stringComparison=\"contains\" header=\"From\"/>\n";
    expectedSoap += "    </filterTests>\n";
    // expectedSoap += "    <filterActions/>\n";
    expectedSoap += "    <nestedRule>\n";
    expectedSoap += "      <filterTests condition=\"anyof\">\n";
  ...
  @Test
  void testBug71036_SingleRuleSimpleNestedIfwithMultiConditions02() throws Exception {
    Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
    Mailbox mbox = MailboxManager.getInstance().getMailboxByAccount(acct);
  ...
  @Test
  void testBug71036_SingleRuleSimpleNestedIfwithMultiConditions03() throws Exception {
    Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
    Mailbox mbox = MailboxManager.getInstance().getMailboxByAccount(acct);
  ...
  @Test
  void testBug71036_SingleRuleSimpleNestedIfwithMultiConditions() throws Exception {
    Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
    Mailbox mbox = MailboxManager.getInstance().getMailboxByAccount(acct);
  ...
  @Test
  void testBug71036_SingleRuleSimpleNestedIfwithJSON() throws Exception {
    Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
    Mailbox mbox = MailboxManager.getInstance().getMailboxByAccount(acct);

    // set One rule with one nested if
    RuleManager.clearCachedRules(acct);
    acct.setMailSieveScript(
    ...
    assertEquals(expectedJson, rules.prettyPrint());
  }

  @Test
  void testBug71036_SingleRuleMultiNestedIf() throws Exception {
    Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
    Mailbox mbox = MailboxManager.getInstance().getMailboxByAccount(acct);
    ...
    expectedSoap += "        <filterTests condition=\"anyof\">\n";
    expectedSoap +=
        "          <headerTest index=\"0\" value=\"secret\" stringComparison=\"contains\" header=\"Subject\"/>\n";
    expectedSoap += "        </filterTests>\n";
    // expectedSoap += "        <filterActions/>\n";
    expectedSoap += "        <nestedRule>\n";
    expectedSoap += "          <filterTests condition=\"anyof\">\n";
    expectedSoap +=
        "            <headerTest index=\"0\" value=\"project\" stringComparison=\"contains\" header=\"Subject\"/>\n";
    expectedSoap += "          </filterTests>\n";
    expectedSoap += "          <filterActions>\n";
    expectedSoap += "            <actionFlag index=\"0\" flagName=\"priority\"/>\n";
    expectedSoap += "          </filterActions>\n";
  ...
  @Test
  void testBug1281_SingleRuleElsif() throws Exception {
    Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
    ...
    ss +=
        "{ redirect \"qa-automation@zqa-380.eng.zimbra.com\"; log \"Forward message to qa-automation DL\"; }\n";
  ...
  @Test
  void testBug71036_MultiRuleSimpleNestedIf() throws Exception {
    Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
    Mailbox mbox = MailboxManager.getInstance().getMailboxByAccount(acct);
  ...
  @Test
  void testEnvelopeTest() throws Exception {
    Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
    Mailbox mbox = MailboxManager.getInstance().getMailboxByAccount(acct);
  ...
  @Test
  void testEnvelopeTestNumericComparison() throws Exception {
    Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
    Mailbox mbox = MailboxManager.getInstance().getMailboxByAccount(acct);
  ...
  @Test
  void testNegativeCaseAddheaderAction() {
    try {
      Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      RuleManager.clearCachedRules(acct);
  ...
  @Test
  void testNegativeCaseDeleteheaderAction() {
    try {
      Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      RuleManager.clearCachedRules(acct);
      ...
      assertTrue(e instanceof ServiceException);
      assertEquals(
          "parse error: Invalid deleteheader action: deleteheader action is not allowed in user scripts",
          e.getMessage());
    }
  }

  @Test
  void testNegativeCaseReplaceheaderAction() {
    try {
      Account acct = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      RuleManager.clearCachedRules(acct);
      ...
      assertTrue(e instanceof ServiceException);
      assertEquals(
          "parse error: Invalid replaceheader action: replaceheader action is not allowed in user scripts",
          e.getMessage());
    }
  }
}
