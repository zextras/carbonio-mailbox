 ...
 * @author ysasaki
 */
public final class ContactQueryTest extends MailboxTestSuite {
	...
	public void search() throws Exception {
		...
		Contact contact = mbox.createContact(null, new ParsedContact(fields),
				Mailbox.ID_FOLDER_CONTACTS, null);
		ZimbraQueryResults results = mbox.index.search(new OperationContext(mbox),
				"contact:\"Jon Smith\"",
