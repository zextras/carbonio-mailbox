...
class ImapHandlerTest extends MailboxTestSuite {
	...
	private Account createTestAccount() throws ServiceException {
		return createAccount().withPassword(password).withAttribute(Provisioning.A_zimbraFeatureAntispamEnabled, "TRUE")
				.create();
	}

	@Test
	void testDoCOPYByUID() throws Exception {
	...
	void testLogin() throws Exception {
		...
		assertTrue(handler.authenticate(acct.getName(), null, password, "logintag", null));
