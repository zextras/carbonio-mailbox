...
public class ReplaceHeaderTest extends MailboxTestSuite {
	...
	private static String sampleBaseMsg5 = "Received: from edge01e.zimbra.com ([127.0.0.1])\n"
			...
			+ "Subject: example\n"
			+ "to: test@zimbra.com\n";
	private static String sampleBaseMsg6 =
			"Subject: =?utf-8?B?44GT44KM44Gv6KSH5pWw6KGM44Gr5rih44KL?=\n"
					+ "\t=?utf-8?B?5Lu25ZCN44Gn44GZ44CC5Lu25ZCN44Gv44Kt?=\n"
					+ "\t=?utf-8?B?44Oj44Op44Kv44K/44O844K744OD44OI44GM?=\n"
					+ "\t=?utf-8?B?44Om44O844OG44Kj44O844Ko44OV44Ko44Kk?=\n"
					+ "\t=?utf-8?B?44OI44Gn44CB44OZ44O844K55YWt5Y2B5Zub?=\n"
	...
	void testReplaceHeader() {
		try {
			String filterScript = "require [\"editheader\"];\n"
					...
					+ "  ;\n";
			Account acct1 = createAccount().create();
		...
		try {
			...
			for (Enumeration<Header> enumeration = message.getMimeMessage().getAllHeaders();
				...
				if ("X-Test-Header".equals(header.getName())) {
					indexMatch++;
					if (indexMatch == 2) {
						assertEquals("new test", header.getValue());
						break;
					}
				}
			}
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceSecondFromBottomHeader() {
		try {
			String filterScript = "require [\"editheader\"];\n"
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceNoValuePattern() {
		try {
			String filterScript = "require [\"editheader\"];\n"
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceSubjectHeaderUsingIs() {
		try {
			String filterScript = "require [\"editheader\"];\n"
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceSubjectHeaderUsingMatches() {
		try {
			String filterScript = "require [\"editheader\"];\n"
		...
		try {
			...
			for (Enumeration<Header> enumeration = message.getMimeMessage().getAllHeaders();
				...
				if ("X-Test2-Header".equals(header.getName())) {
					assertEquals("test1", header.getValue());
					break;
				}
			}
		} catch (Exception e) {
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderWithNumericComparisionUsingValue() {
		try {
			String filterScript =
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderWithNumericComparisionUsingCount() {
		try {
			String filterScript =
					"require [\"editheader\", \"relational\", \"comparator-i;ascii-numeric\"];\n"
			...
			assertEquals("3", String.valueOf(headerCount));
		} catch (Exception e) {
			fail("No exception should be thrown: " + e.getMessage());
		}
	}
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderWithXSpamScore() {
		try {
			String filterScript =
					"require [\"editheader\", \"variables\", \"relational\", \"comparator-i;ascii-numeric\"];\n"
			...
			assertEquals("[SPAM]example", subjectValue);
		} catch (Exception e) {
			fail("No exception should be thrown: " + e.getMessage());
		}
	}
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderForMultilineValuedHeader() {
		try {
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderForEncodedHeaderValue() {
		try {
			String filterScript = "require [\"editheader\", \"variables\"];\n"
			...
			assertEquals(matchValue, headerValue);
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderForInvalidEncodedMultilineHeaderValue() {
		try {
			String filterScript = "require [\"editheader\", \"variables\"];\n"
					+ "        replaceheader :newvalue \"[test]${1}\" :matches \"X-Test-Header\" \"*\";";
			Account acct1 = createAccount().create();
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderForValidEncodedMultilineHeaderValue() {
		try {
			String filterScript = "require [\"editheader\", \"variables\"];\n"
					+ "        replaceheader :newvalue \"[test]${1}\" :matches \"X-Test-Header\" \"*\";";
			Account acct1 = createAccount().create();
			...
			String matchValue =
					"=?UTF-8?B?W3Rlc3Rd44GT44KM44Gv6KSH5pWw6KGM44Gr5rih44KL5Lu25ZCN44Gn44GZ?=\r\n"
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderNonAscii() {
		try {
			String filterScript = "require [\"editheader\", \"variables\"];\n"
			...
			assertEquals("=?UTF-8?Q?[=E8=BF=BD=E5=8A=A0]example?=", newSubject);
		} catch (Exception e) {
			fail("No exception should be thrown: " + e.getMessage());
		}
	}
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderNonAsciiVariables() {
		try {
			String filterScript = "require [\"editheader\", \"variables\"];\n"
			...
			assertEquals("=?UTF-8?B?W+i/veWKoF3ku7blkI3jgafjgZnjgILku7blkI3jga/jgq3jg6Pjg6njgq8=?=\r\n"
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderSameHeaderNameMultipleHeaderValues1() {
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderSameHeaderNameMultipleHeaderValues2() {
		StringBuffer triggeringMsg = new StringBuffer();
		for (String line : sampleBaseMsg7) {
			triggeringMsg.append(line).append("\r\n");
		}
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderFromBottom() {
		try {
			String filterScript = "require [\"editheader\"];\n"
			...
			RuleManager.applyRulesToIncomingMessage(
					new OperationContext(mbox1), mbox1, new ParsedMessage(
							getSampleBaseMsg8(acct1).getBytes(), false), 0, acct1.getName(),
					null, new DeliveryContext(),
					Mailbox.ID_FOLDER_INBOX, true);
			Integer itemId = mbox1.getItemIds(null, Mailbox.ID_FOLDER_INBOX).getIds(MailItem.Type.MESSAGE)
					.get(0);
			...
			for (Enumeration<Header> enumeration = message.getMimeMessage().getAllHeaders();
				...
				Header header = enumeration.nextElement();
				if ("X-Test-Header".equals(header.getName())) {
					assertEquals("new test" + indexMatch, header.getValue());
					indexMatch--;
				}
			}
		} catch (Exception e) {
	...
	private static String getSampleBaseMsg8(Account account) {
		final String mail = account.getName();
		return "Received: from edge01e.zimbra.com ([127.0.0.1])\n"
				+ "\tby localhost (edge01e.zimbra.com [127.0.0.1]) (amavisd-new, port 10032)\n"
				+ "\twith ESMTP id DN6rfD1RkHD7; Fri, 24 Jun 2016 01:45:31 -0400 (EDT)\n"
				+ "Received: from localhost (localhost [127.0.0.1])\n"
				+ "\tby edge01e.zimbra.com (Postfix) with ESMTP id 9245B13575C;\n"
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderWithCaseMapComparatorUsingValue() {
		try {
			String filterScript =
					"require [\"editheader\", \"relational\", \"comparator-i;ascii-numeric\"];\n"
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderWithoutMatchType() {
		try {
			String filterScript = "require [\"editheader\"];\n"
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderWithEmptyHeaderNewName() {
		try {
			...
			for (Enumeration<Header> enumeration = message.getMimeMessage().getAllHeaders();
					enumeration.hasMoreElements(); ) {
				Header header = enumeration.nextElement();
				assertNotEquals(header.getName(), "");
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderWithSinlgeSpaceAsHeaderNewName() {
		try {
			String filterScript = "require [\"editheader\", \"relational\"];\n"
					+ " replaceheader :newname \" \" :newvalue \"0\" :value \"lt\" :comparator \"i;ascii-casemap\" \"X-Test-Header\" \"test2\" \r\n"
					+ "  ;\n";
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderWithMultipleSpacesAsHeaderNewName() {
		try {
			String filterScript = "require [\"editheader\", \"relational\"];\n"
					+ " replaceheader :newname \"    \" :newvalue \"0\" :value \"lt\" :comparator \"i;ascii-casemap\" \"X-Test-Header\" \"test2\" \r\n"
					+ "  ;\n";
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderStartingWithSpacesAsHeaderNewName() {
		try {
			String filterScript = "require [\"editheader\", \"relational\"];\n"
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderStartingWithSpacesAsHeaderName() {
		try {
			String filterScript = "require [\"editheader\"];\n"
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderValueNegative() {
		try {
			String filterScript =
					"require [\"editheader\", \"relational\", \"comparator-i;ascii-numeric\"];\n"
							+ "replaceheader :newname \"X-Numeric2-Header\" :newvalue \"0\" :value \"lt\" :comparator \"i;ascii-numeric\" \"X-Numeric-Header\" \"-3\";\n";
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderNewNameFromCondition() {
		try {
			String filterScript = "require [\"editheader\", \"variables\"];\n"
	...
	@Test
	void testDeleteHeaderBadContentType() {
		...
		try {
			...
			for (Enumeration<Header> enumeration = message.getMimeMessage().getAllHeaders();
				...
				Header header = enumeration.nextElement();
				if ("Subject".equals(header.getName())) {
					assertEquals("[SPAM]example", header.getValue());
					break;
				}
			}
			String[] tags = message.getTags();
			assertEquals(4, tags.length);
			assertEquals("tag-user1", tags[0]);
			assertEquals("tag-user2", tags[1]);
			assertEquals("tag-user", tags[2]);
			assertEquals("tag-admin-after", tags[3]);
		} catch (Exception e) {
			fail("No exception should be thrown: " + e.getMessage());
		}
	}
	...
	void testImmutableHeaders() {
		...
		try {
			...
			Integer itemId = mbox1.getItemIds(null, Mailbox.ID_FOLDER_INBOX).getIds(MailItem.Type.MESSAGE)
					.get(0);
			Message message = mbox1.getMessageById(null, itemId);
			assertEquals("text/plain; charset=\"ISO-2022-JP\"",
					message.getMimeMessage().getHeader("Content-Type")[0]);
			assertEquals("inline", message.getMimeMessage().getHeader("Content-Disposition")[0]);
			assertEquals("7bit", message.getMimeMessage().getHeader("Content-Transfer-Encoding")[0]);
			assertEquals("1.0", message.getMimeMessage().getHeader("MIME-Version")[0]);
			assertEquals("auto-generated", message.getMimeMessage().getHeader("Auto-Submitted")[0]);
		} catch (Exception e) {
			fail("No exception should be thrown: " + e.getMessage());
		}
	}
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderAsciiNumbericIsComparator() {
		try {
			Account acct1 = createAccount().create();
			...
			assertEquals("New Value", subjectValue);
		} catch (Exception e) {
			fail("No exception should be thrown: " + e.getMessage());
		}
	}
	...
	@Test
	void testNonAsciiHeaderName() {
		EditHeaderExtension ext = new EditHeaderExtension();
		ext.setKey("日本語ヘッダ名");
		try {
			ext.commonValidation("ReplaceHeader");
		} catch (SyntaxException e) {
			assertEquals("ReplaceHeader:Header name must be printable ASCII only.", e.getMessage());

		}
	}

	@Test
	void testNonAsciiHeaderNameWithoutOperation() {
		EditHeaderExtension ext = new EditHeaderExtension();
		ext.setKey("日本語ヘッダ名");
		try {
			ext.commonValidation(null);
		} catch (SyntaxException e) {
			assertEquals("EditHeaderExtension:Header name must be printable ASCII only.", e.getMessage());
	 ...
	 */
	@Test
	void replaceHeaderSieveEditHeaderEnabledTrue() {
		try {
			String filterScript = "require [\"editheader\"];\n"
					+ "replaceheader :newvalue \"my subject\" :contains \"Subject\" \"example\";";
			Account acct1 = createAccount().create();
			...
			for (Enumeration<Header> e = mdnMsg.getMimeMessage().getAllHeaders(); e
				...
				if (temp.getName().equals("Subject")) {
					matchFound = true;
					assertEquals("my subject", temp.getValue());
				}
			}
			assertTrue(matchFound);
		} catch (Exception e) {
	 ...
	 */
	@Test
	void replaceHeaderSieveEditHeaderEnabledFalse() {
		try {
			String filterScript = "require [\"editheader\"];\n"
					+ "replaceheader :newvalue \"my subject\" :contains \"Subject\" \"example\";";
			Account acct1 = createAccount().create();
			...
			for (Enumeration<Header> e = mdnMsg.getMimeMessage().getAllHeaders(); e
				...
				if (temp.getName().equals("Subject")) {
					matchFound = true;
					assertEquals("example", temp.getValue());
				}
			}
			assertTrue(matchFound);
		} catch (Exception e) {
	 ...
	 */
	@Test
	void replaceHeaderUserSieveScript() {
		try {
			String filterScript = "require [\"editheader\"];\n"
	...
	@SuppressWarnings("unchecked")
	@Test
	void testReplaceHeaderUsingWildcardMatchesToControlChars() {
		try {
			String filterScript = "require [\"editheader\", \"variables\"];\n"
			...
			assertEquals("new test", newSubject);
		} catch (Exception e) {
			fail("No exception should be thrown: " + e.getMessage());
		}
	}
	...
	@SuppressWarnings("unchecked")
	@Test
	void testMatchedStringForReplaceHeaderUsingWildcardMatchesToControlChars() {
		try {
			String filterScript = "require [\"editheader\", \"variables\"];\n"
			...
			assertEquals("=?UTF-8?B?W1Rlc3RdbGluZSAxIENSTEYNCiBsaW5lIDINCg==?=", headers[0]);
		} catch (Exception e) {
			fail("No exception should be thrown: " + e.getMessage());
		}
	}
	...
	void testMalencodedHeader() throws Exception {
		...
		try {
			...
			List<ItemId> ids = RuleManager.applyRulesToIncomingMessage(new OperationContext(mbox),
					mbox,
					new ParsedMessage("X-Mal-Encoded-Header: =?ABC?A?GyRCJFskMhsoQg==?=".getBytes(), false),
					0,
			...
			assertNotNull(headers);
			assertNotSame(0, headers.length);
			assertEquals("[test]=?ABC?A?GyRCJFskMhsoQg==?=", headers[0]);
		} catch (Exception e) {
	...
	@Test
	void testBackslashAsciiCasemap4bs() throws Exception {
	...
	@Test
	void testBackslashAsciiCasemap5bs() throws Exception {
	...
	@Test
	void testBackslashOctet() throws Exception {
		String script = "require [\"editheader\"];\n"
	...
	private boolean testBackslash(String script, String pattern, String msg) {
		try {
			...
			assertNotNull(headers);
			assertNotSame(0, headers.length);
			assertEquals("replaced", headers[0]);
			headers = message.getMimeMessage().getHeader("X-HeaderA");
			assertNotNull(headers);
			assertNotSame(0, headers.length);
			assertEquals(pattern, headers[0]);
