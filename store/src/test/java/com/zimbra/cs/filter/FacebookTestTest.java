 ...
 * @author ysasaki
 */
public final class FacebookTestTest extends MailboxTestSuite {
  ...
  void test() throws Exception {
    ...
    List<ItemId> ids =
        RuleManager.applyRulesToIncomingMessage(
            ...
            mbox,
            new ParsedMessage(
                "From: \"Facebook\" <notification+mhw1-ivm@facebookmail.com>\n".getBytes(), false),
            0,
            account.getName(),
            new DeliveryContext(),
    ...
    ids =
        RuleManager.applyRulesToIncomingMessage(
            ...
            mbox,
            new ParsedMessage(
                "From: \"Facebook Deals\" <deals+mhw1-ivm@facebookmail.com>\n".getBytes(), false),
            0,
            account.getName(),
            new DeliveryContext(),
            Mailbox.ID_FOLDER_INBOX,
