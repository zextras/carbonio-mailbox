...
public class NotifyMailtoTest extends MailboxTestSuite {
	 ...
	 * <p>
	 * == (generated notification message) == SMTP; MAIL FROM: &lt;test1@zimbra.com&gt; SMTP; RCPT TO:
	 * &lt;test2@zimbra.com&gt; SMTP; DATA From: test1@zimbra.com To: test2@zimbra.com Subject: おしらせ
	 * <p>
	 * 新しいメールが届きました。 You've got a mail. Chao!
	 */
	...
	void testNotify_variable() {
		...
		try {
			...
			LmtpEnvelope env = new LmtpEnvelope();
			LmtpAddress sender = new LmtpAddress("<test2@zimbra.com>", new String[]{"BODY", "SIZE"},
					null);
			LmtpAddress recipient = new LmtpAddress("<test1@zimbra.com>", null, null);
			env.setSender(sender);
			env.addLocalRecipient(recipient);
