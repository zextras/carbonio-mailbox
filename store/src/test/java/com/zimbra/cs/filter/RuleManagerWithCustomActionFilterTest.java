...
public final class RuleManagerWithCustomActionFilterTest {
  ...
  @Test
  @Ignore("Tries to change value of final filed RuleManager.SIEVE_FACTORY")
  ...
  @Test
  @Ignore(
      "Can not set static final org.apache.jsieve.SieveFactory field"
          + " com.zimbra.cs.filter.RuleManager.SIEVE_FACTORY")
