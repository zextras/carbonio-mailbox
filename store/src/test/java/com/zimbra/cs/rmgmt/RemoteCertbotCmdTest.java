...
public class RemoteCertbotCmdTest {
  RemoteManager remoteManager = mock(RemoteManager.class);
  RemoteCertbotCmd remoteCertbotCmd = new RemoteCertbotCmd(remoteManager);
  ...
  public void shouldCreateCommandForLongChain() {
    ...
    final String actualCommand = remoteCertbotCmd.createCommand(RemoteCommands.CERTBOT_CERTONLY,
