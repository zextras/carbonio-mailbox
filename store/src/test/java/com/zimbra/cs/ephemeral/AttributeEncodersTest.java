...
public class AttributeEncodersTest {
  ...
  @Test
  void testKeyEncoders() throws Exception {
  ...
  @Test
  void testValueEncoders() throws Exception {
    EphemeralLocation location = new TestLocation();
    EphemeralKey staticKey = new EphemeralKey("foo");
    EphemeralKey dynamicKey = new EphemeralKey("foo", "1");
  ...
  @Test
  void testLdapEncoder() throws Exception {
    ...
    ExpirableEphemeralKeyValuePair kvp =
        encoder.decode(Provisioning.A_zimbraAuthTokens, "tokenId|1000|serverVersion");
