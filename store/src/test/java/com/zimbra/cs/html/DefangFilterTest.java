...
public class DefangFilterTest {
 ...
 void testBug49452() throws Exception {
  ...
  assertTrue(result.contains("https://www.plus1staging.net/plus1staging.net/companyAuthorization.jsp"));
 }
 ...
 void testBug64726() throws Exception {
  ...
  assertTrue(result.contains("dfsrc=\"http://www.google.com/intl/en_com/images/srpr/logo3w.png\""));
 }
 ...
 void testBug81641() throws Exception {
  ...
  String result = DefangFactory.getDefanger(MimeConstants.CT_TEXT_HTML).defang(htmlStream,
    true);
  assertFalse(result.contains("url('http://www.househuntnews.com/marketing/images/keller-header.jpg')"));
 ...
 void testBug85478() throws Exception {
  ...
  result = DefangFactory.getDefanger(MimeConstants.CT_TEXT_HTML).defang(htmlStream,
    true);
  assertTrue(result.contains("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAErkJggg&#61;&#61;"));
