...
public class DefangFilterTest {
	...
	void testBug98215() throws Exception {
		...
		String result = DefangFactory.getDefanger(MimeConstants.CT_TEXT_HTML).defang(htmlStream,
				true);
		assertTrue(result.contains("VBSCRIPT-BLOCKED"));
	...
	void testBug100966() throws Exception {
		String inputString = new String(
				ByteUtil.getContent(new File(EMAIL_BASE_DIR + "bug_100966.txt")));
		String expectedResult = new String(
				ByteUtil.getContent(new File(EMAIL_BASE_DIR + "bug_100966_op.txt")));
