...
public class OwaspHtmlSanitizerTest {
	...
	private static OwaspHtmlSanitizer getOwaspHtmlSanitizerWithImages(String html) {
		return new OwaspHtmlSanitizer(html, true, null);
	}
	...
	void testBug98215() {
		...
		result = getOwaspHtmlSanitizerWithImages(html).sanitize();
	...
	void testBug58889() throws Exception {
		...
		result = getOwaspHtmlSanitizerNoImages(html).sanitize();
		assertNotNull(result);
	...
	private static OwaspHtmlSanitizer getOwaspHtmlSanitizerNoImages(String html) {
		return new OwaspHtmlSanitizer(html, false, UUID.randomUUID().toString());
	}
	...
	void testBug83999() {
		...
		String result = getZimbraOwaspHtmlSanitizer(html).sanitize();
		...
		result = getZimbraOwaspHtmlSanitizer(html).sanitize();
