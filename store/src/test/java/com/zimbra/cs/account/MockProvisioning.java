...
public final class MockProvisioning extends Provisioning {
  ...
  public void modifyAttrs(
      Entry entry, Map<String, ? extends Object> attrs, boolean checkImmutable) {
  ...
  public List<DistributionList> getDistributionLists(
      Account acct, boolean directOnly, Map<String, String> via) {
    throw new UnsupportedOperationException();
  }

  @Override
  public List<DistributionList> getDistributionLists(
      DistributionList list, boolean directOnly, Map<String, String> via) {
    throw new UnsupportedOperationException();
  }
  ...
  public void authAccount(
      Account acct, String password, Protocol proto, Map<String, Object> authCtxt)
      throws ServiceException {
    ...
    if (!LC.alias_login_enabled.booleanValue()
        && Arrays.asList(acct.getAliases())
            .contains(authCtxt.get(AuthContext.AC_ACCOUNT_NAME_PASSEDIN))) {
      throw AuthFailedServiceException.AUTH_FAILED(
          accountNamePassedIn, accountNamePassedIn, "alias login not enabled.");
    }
  }
  ...
  public Server createServer(String name, Map<String, Object> attrs) {
    ...
    if (server == null) {
      server = new Server(name, name, attrs, Collections.emptyMap(), this);
  ...
  public DistributionList createDistributionList(
      String listAddress, Map<String, Object> listAttrs) {
    throw new UnsupportedOperationException();
  }
  ...
  public Signature createSignature(
      Account account, String signatureName, Map<String, Object> attrs) {
    throw new UnsupportedOperationException();
  }
