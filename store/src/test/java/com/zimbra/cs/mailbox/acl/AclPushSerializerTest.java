...
public class AclPushSerializerTest {
  ...
  */
 @Test
 void testSerializeShareInfoDataFolderWithSemiColon() {
  try {
   sid.setPath("/Inbox/Test; Bed");
 ...
 @Test
 void testSerializeShareInfoDataFolderWithoutSemiColon() {
  try {
 ...
 void testDeserialize() {
  ...
  try {
   ...
   assertEquals("/Inbox/Test; Bed", path);
   ...
   data = AclPushSerializer.deserialize(shareInfoData);
   path = data.getPath();
   assertEquals("/Inbox/TestASCII59 Bed", path);
   ...
   data = AclPushSerializer.deserialize(shareInfoData);
   path = data.getPath();
   assertEquals("/Inbox/Test; Bed; 123", path);
  } catch (Exception e) {
   e.printStackTrace();
  ...
  */
 @Test
 void testSerializeShareInfoDataFolderWithNewSemiColonEscapeAsData() {
  try {
