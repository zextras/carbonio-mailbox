...
public class InviteTest extends MailboxTestSuite {
	...
	void shouldReturnInviteWithCorrectScheduleAgent(String scheduleAgentParam,
			ScheduleAgent scheduleAgentExpected) throws Exception {

		Account organizer =
				createAccount().create();
		Account attendee =
				createAccount().create();
		final String attendeeName = attendee.getName();
