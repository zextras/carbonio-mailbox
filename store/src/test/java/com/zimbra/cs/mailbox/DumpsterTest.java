...
public class DumpsterTest extends MailboxTestSuite {
  ...
  public void setUp() throws Exception {
    ...
    mbox.createFolder(null, "/Briefcase/f", new Folder.FolderOptions().setDefaultView(Type.FOLDER));
  }
  ...
  void msgInConversationTest() throws Exception {
    ...
    try {
      ...
      fail("should not be able to move message from a conversation that is already in dumpster");
    } catch (MailServiceException e) {
