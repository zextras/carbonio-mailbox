...
public abstract class AbstractBlobConsistencyCheckTest extends MailboxTestSuite {
	...
	void singleBlob() throws Exception {
		...
		mbox.addMessage(null, new ParsedMessage("From: test1-1@sub1.zimbra.com".getBytes(), false),
				dopt, null);
	...
	void wrongSize() throws Exception {
		...
		Message msg = mbox.addMessage(null,
				new ParsedMessage("From: test1-1@sub1.zimbra.com".getBytes(), false), dopt, null);
