...
public class SampleLocalMailbox {
  ...
  public static Server setUpServer(String mailboxHome, String timeZoneFile) throws Exception {
  ...
  public static void main(String[] args) throws Exception {
    final Server server = setUpServer("./store", "store/src/test/resources/timezones-test.ics");
    server.start();
    server.join();
  }
