...
class CheckFolderActionUseCaseTest {
  private MailboxManager mailboxManager;
  private CheckFolderActionUseCase checkFolderActionUseCase;
  ...
  void setUp() {
    ...
    checkFolderActionUseCase = new CheckFolderActionUseCase(mailboxManager, itemIdFactory);
  }
  ...
  void shouldBeSuccessWithCheckFolderTag() throws ServiceException {
    ...
    final Try<Void> operationResult =
        checkFolderActionUseCase.check(operationContext, accountId, folderId);
  ...
  void shouldBeSuccessWithUncheckFolderTag() throws ServiceException {
    ...
    final Try<Void> operationResult =
        checkFolderActionUseCase.uncheck(operationContext, accountId, folderId);
