...
public class AdminServiceClientImpl extends PooledClient<ZcsAdminPortType> implements AdminServiceClient {
  ...
  public static class Builder {
    ...
    private List<ZcsAdminPortType> createServices() {
      return IntStream.range(0, size)
          .mapToObj(i -> AdminServiceClientImpl.from(wsdl, server))
