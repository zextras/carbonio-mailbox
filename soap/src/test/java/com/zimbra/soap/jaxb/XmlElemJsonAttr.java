...
public class XmlElemJsonAttr {
  ...
  public String getXmlElemJsonAttr() {
    return xmlElemJsonAttr;
  }

  public void setXmlElemJsonAttr(String xmlElemJsonAttr) {
    this.xmlElemJsonAttr = xmlElemJsonAttr;
  }

  public String getDefaultElem() {
    return defaultElem;
  }

  public void setDefaultElem(String defaultElem) {
