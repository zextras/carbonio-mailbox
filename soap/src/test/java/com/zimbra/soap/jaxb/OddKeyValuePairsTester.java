...
/**
 * Test {@link ZimbraKeyValuePairs} annotation, where the key/value pairs use different key/value
 * names to the default
 */
...
public class OddKeyValuePairsTester {
  ...
  public OddKeyValuePairsTester(List<Attr> attrs) {
    setAttrList(attrs);
  }
