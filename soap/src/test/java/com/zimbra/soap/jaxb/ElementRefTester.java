...
public class ElementRefTester {
  @XmlElementRef(
      name = "ignored-name-root-elem-name-used-instead",
      type = StringAttribIntValue.class)
  private StringAttribIntValue byRef;

  public ElementRefTester() {}

  public StringAttribIntValue getByRef() {
    return byRef;
  }

  public void setByRef(StringAttribIntValue byRef) {
    this.byRef = byRef;
  }
}
