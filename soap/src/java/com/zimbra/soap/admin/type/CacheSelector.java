...
public final class CacheSelector {
  ...
  public void setIncludeImapServers(boolean bool) {
    imapServers = ZmBoolean.fromBool(bool);
  }

  public boolean isIncludeImapServers() {
    return ZmBoolean.toBool(imapServers, true);
  }
}
