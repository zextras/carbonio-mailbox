...
public class CacheEntrySelector {
  ...
  public enum CacheEntryBy {
    ...
    public com.zimbra.common.account.Key.CacheEntryBy toKeyCacheEntryBy() throws ServiceException {
   ...
   * @zm-api-field-description The key used to identify the cache entry. Meaning determined by
   *     <b>{cache-entry-by}</b>
   */
