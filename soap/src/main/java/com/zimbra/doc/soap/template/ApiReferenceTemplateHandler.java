...
public class ApiReferenceTemplateHandler extends TemplateHandler {
   ...
   */
  public ApiReferenceTemplateHandler(Properties context) throws IOException {
    super(NAME, context);
  ...
  @Override
  public void process(Root root) throws IOException, SoapDocException {
  ...
  private void processService(Root root, Service svc) throws IOException, SoapDocException {
   ...
   */
  private void processIndex(Root root) throws IOException, SoapDocException {
   ...
   * @param root the root data
   */
  private void processOverviewFrame(Root root) throws IOException, SoapDocException {
   ...
   * @param root the root data
   */
  private void processOverviewSummary(Root root) throws IOException, SoapDocException {
   ...
   * @param root the root data
   */
  private void processAllCommandsFrame(Root root) throws IOException, SoapDocException {
