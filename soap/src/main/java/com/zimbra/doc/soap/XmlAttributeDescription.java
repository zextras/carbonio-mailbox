...
public class XmlAttributeDescription implements XmlUnit {
  ...
  public static XmlAttributeDescription create(
      XmlElementDescription parent, JaxbAttributeInfo info) {
    XmlAttributeDescription desc =
        new XmlAttributeDescription(info.getName(), info.isRequired(), info.getFieldName());
    desc.parent = parent;
  ...
  public String getValueRepresentation() {
    return (valueDescription == null)
        ? ""
        : Strings.nullToEmpty(valueDescription.getRepresentation());
  }
