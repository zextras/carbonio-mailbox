...
public class SoapApiCommand implements Comparable<SoapApiCommand> {
  ...
  public boolean isNetworkEditionOnly() {
    return networkEditionOnly;
  }
  ...
  public SoapApiElement getRequest() {
    return request;
  }

  public SoapApiElement getResponse() {
    return response;
  }
