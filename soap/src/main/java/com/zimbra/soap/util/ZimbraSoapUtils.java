...
public class ZimbraSoapUtils {
  ...
  public static <T> T invokeJaxb(SoapHttpTransport transport, Object jaxbObject)
  ...
  private static Element invoke(SoapHttpTransport transport, Element request)
      throws ServiceException {
    return invoke(transport, request, null);
  }

  private static synchronized Element invoke(
      SoapHttpTransport transport, Element request, String requestedAccountId)
      throws ServiceException {
    try {
   ...
   * @throws ServiceException
   */
  public static void soapAdminAuthenticate(
      SoapHttpTransport transport, String name, String password) throws ServiceException {
    transport.setVoidOnExpired(true);
    com.zimbra.soap.admin.message.AuthRequest req =
        new com.zimbra.soap.admin.message.AuthRequest(name, password);
