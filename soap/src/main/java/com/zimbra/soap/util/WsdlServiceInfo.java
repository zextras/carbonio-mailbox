...
public final class WsdlServiceInfo implements Comparable<WsdlServiceInfo> {
  ...
  public static final String localhostSoapAdminHttpsURL =
  ...
  public static WsdlServiceInfo zcsAdminService =
      WsdlServiceInfo.createForAdmin(localhostSoapAdminHttpsURL);
  ...
  private WsdlServiceInfo(
      String svcName, String soapAddressURL, String portTypeName, String bindingName) {
  ...
  public static WsdlServiceInfo createForAdmin(String soapAddressURL) {
    return new WsdlServiceInfo(
        zcsAdminServiceName, soapAddressURL, zcsAdminPortTypeName, zcsAdminBindingName);
  }
