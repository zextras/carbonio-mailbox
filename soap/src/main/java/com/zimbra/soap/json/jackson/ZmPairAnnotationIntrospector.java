 ...
 * (JacksonAnnotationIntrospector/ZimbraJaxbAnnotationIntrospector) ZimbraJaxbAnnotationIntrospector
 * is a hopefully temporary wrapper round JaxbAnnotationIntrospector to get around a bug. @XmlValue
 * handling - Zimbra uses the property name "_content" (JaxbAnnotationIntrospector uses "value")
 *
 * <p>Enum value handling - Use JaxbAnnotationIntrospector's handling in preference to
 * JacksonAnnotationIntrospector's
 */
