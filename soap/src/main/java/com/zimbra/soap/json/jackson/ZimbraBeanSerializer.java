...
public class ZimbraBeanSerializer extends BeanSerializer {
  ...
  /**
   * Based on {@code BeanSerializer.serialize} but allows the addition of Zimbra's namespace
   * property "_jsns" to the list of properties serialized.
   */
  public final void serializeWithNamespace(
      Object bean, JsonGenerator jgen, SerializerProvider provider, String namespace)
