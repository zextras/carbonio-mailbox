...
public class ZmDomElementJsonSerializer extends StdSerializer<Element> {
  ...
  private void serializeInner(
      Element value, JsonGenerator jgen, SerializerProvider provider, String parentNs)
