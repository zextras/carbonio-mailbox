 ...
 * @zm-api-command-description Modify call features of a phone. <br>
 *     Refer to <b>GetVoiceFeaturesResponse</b> for attributes and child elements of each call
 *     feature
 */
...
public class ModifyVoiceFeaturesRequest {
  ...
  public void setPhone(ModifyVoiceFeaturesSpec phone) {
    this.phone = phone;
  }
