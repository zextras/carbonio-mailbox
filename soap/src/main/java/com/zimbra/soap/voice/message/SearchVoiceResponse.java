...
public class SearchVoiceResponse {
   ...
   * @zm-api-field-description Integer specifying the 0-based offset into the results list returned
   *     as the first result for this search operation. It is always the same as the offset
  ...
  /**
   * @zm-api-field-description Voice folder summary <br>
   *     For certain search combinations, server is able to compute a folder inventory. If folder
   *     inventory is available on the server, a <b>&lt;vfi></b> tag is included for that folder.
   *     <br>
   *     Given the lack of a notification mechanism in the voice API infrastructure, clients can use
   *     this information to refresh the message count in the accordion if it is available.
   */
