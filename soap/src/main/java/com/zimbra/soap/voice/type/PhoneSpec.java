...
public class PhoneSpec {
   ...
   * @zm-api-field-description Preferences specification <br>
   *     If no <b>&lt;pref></b> elements are provided, all known prefs for the requested phone are
   *     returned in the response. If <b>&lt;pref></b> elements are provided, only those prefs are
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("name", name).add("prefs", prefs);
  }
