...
public class CallForwardNoAnswerFeature extends CallFeatureInfo {
  ...
  public void setNumRingCycles(String numRingCycles) {
    this.numRingCycles = numRingCycles;
  }
  ...
  public String getNumRingCycles() {
    return numRingCycles;
  }

  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    helper = super.addToStringInfo(helper);
    return helper.add("forwardTo", forwardTo).add("numRingCycles", numRingCycles);
  }
