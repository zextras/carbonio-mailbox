...
public class ResetPhoneVoiceFeaturesSpec {
  ...
  @XmlElements({
    @XmlElement(
        ...
        type = PhoneVoiceFeaturesSpec.AnonCallRejectionReq.class),
    @XmlElement(
        name = VoiceConstants.E_CALLER_ID_BLOCKING /* calleridblocking */,
        type = PhoneVoiceFeaturesSpec.CallerIdBlockingReq.class),
    @XmlElement(
        name = VoiceConstants.E_CALL_FORWARD /* callforward */,
        type = PhoneVoiceFeaturesSpec.CallForwardReq.class),
    @XmlElement(
        name = VoiceConstants.E_CALL_FORWARD_BUSY_LINE /* callforwardbusyline */,
        type = PhoneVoiceFeaturesSpec.CallForwardBusyLineReq.class),
    @XmlElement(
        name = VoiceConstants.E_CALL_FORWARD_NO_ANSWER /* callforwardnoanswer */,
        type = PhoneVoiceFeaturesSpec.CallForwardNoAnswerReq.class),
    @XmlElement(
        name = VoiceConstants.E_CALL_WAITING /* callwaiting */,
        type = PhoneVoiceFeaturesSpec.CallWaitingReq.class),
    @XmlElement(
        name = VoiceConstants.E_SELECTIVE_CALL_FORWARD /* selectivecallforward */,
        type = PhoneVoiceFeaturesSpec.SelectiveCallForwardReq.class),
    @XmlElement(
        name = VoiceConstants.E_SELECTIVE_CALL_ACCEPTANCE /* selectivecallacceptance */,
        type = PhoneVoiceFeaturesSpec.SelectiveCallAcceptanceReq.class),
    @XmlElement(
        name = VoiceConstants.E_SELECTIVE_CALL_REJECTION /* selectivecallrejection */,
        type = PhoneVoiceFeaturesSpec.SelectiveCallRejectionReq.class)
  })
