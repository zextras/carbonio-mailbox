 ...
 * @zm-api-command-description Reset call features of a phone. <br>
 *     If no <b>&lt;{call-feature}></b> are provided, all subscribed call features for the phone are
 *     reset to the default values. If <b>&lt;{call-feature}></b> elements are provided, only those
 *     call features are reset. <br>
 *     <br>
...
public class ResetVoiceFeaturesRequest {
  ...
  public void setPhone(ResetPhoneVoiceFeaturesSpec phone) {
    this.phone = phone;
  }
