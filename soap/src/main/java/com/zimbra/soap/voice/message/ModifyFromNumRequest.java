 ...
 * @zm-api-command-description Modify the phone num and label. <br>
 *     NOTE: UI should insert empty values for oldPhone, phone label in-case the user wants to leave
 *     them empty.
 */
...
public class ModifyFromNumRequest {
  ...
  public void setPhone(ModifyFromNumSpec phone) {
    this.phone = phone;
  }
