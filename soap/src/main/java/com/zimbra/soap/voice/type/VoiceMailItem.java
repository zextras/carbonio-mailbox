...
public class VoiceMailItem extends VoiceCallItem {
   ...
   * @zm-api-field-description Flags = 'u'(nread), '!'(high priority), 'p'(rivate, i.e. message is
   *     not forwardable)
   */
  ...
  public void setCallParty(VoiceMailCallParty callParty) {
    this.callParty = callParty;
  }

  public void setVoiceContent(VoiceMailContent voiceContent) {
