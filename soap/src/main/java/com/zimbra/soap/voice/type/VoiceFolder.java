...
public class VoiceFolder {
   ...
   * @zm-api-field-description Number of unread voice messages <br>
   ...
   * @zm-api-field-description Total number of voice messages <br>
   *     Only present for Trash and Voicemail Inbox
   */
  ...
  public void setNumUnreadMsgs(Long numUnreadMsgs) {
    this.numUnreadMsgs = numUnreadMsgs;
  }

  public void setNumTotalMsgs(Long numTotalMsgs) {
