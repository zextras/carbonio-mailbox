...
public class VoiceMsgUploadSpec {
   ...
   * @zm-api-field-description Message id of the voice mail. It can only be a voice mail in the
   *     INBOX, not the trash folder.
   */
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("voiceMailId", voiceMailId).add("phoneNumber", phoneNumber);
  }
