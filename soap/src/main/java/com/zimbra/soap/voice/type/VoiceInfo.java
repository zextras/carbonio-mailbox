...
public class VoiceInfo {
   ...
   * @zm-api-field-description Phone type (Optional). <br>
   *     Currently used in Mitel, it denotes the type of phone. Possible values are: <br>
   *     <b>DeskPhone, SoftPhone, Voicemail, MobileExt, EDHU, PRG, OTHER</b>
   */
   ...
   * @zm-api-field-description Voice mailbox quota used in bytes (available only if the phone has
   *     voicemail service)
   */
   ...
   * @zm-api-field-description Voice mailbox quota limit in bytes, or 0 if unlimited (available only
   *     if the phone has voicemail service)
   */
  ...
  public void setCallable(Boolean callable) {
    this.callable = ZmBoolean.fromBool(callable);
  }

  public void setEditable(Boolean editable) {
    this.editable = ZmBoolean.fromBool(editable);
  }
  ...
  public void setClick2callDeviceId(String click2callDeviceId) {
    this.click2callDeviceId = click2callDeviceId;
  }
  ...
  public Boolean getCallable() {
    return ZmBoolean.toBool(callable);
  }

  public Boolean getEditable() {
    return ZmBoolean.toBool(editable);
  }
