 ...
 *     <ul>
 *       <li>Modify state of voice messages
 *       <li>soft delete/undelete voice messages
 *       <li>empty (hard-delete) voice message trash folders
 *     </ul>
 */
...
public class VoiceMsgActionRequest {
  ...
  public void setAction(VoiceMsgActionSpec action) {
    this.action = action;
  }
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("storePrincipal", storePrincipal).add("action", action);
  }
