...
public class SearchVoiceRequest {
   ...
   * @zm-api-field-description Query [mandatory] <br>
   *     Currently the only supported query clauses are phone:, in:, after:, before: <br>
   *     <pre>
   ...
   * @zm-api-field-description Comma-separated list of search types. Legal values are:
   *     <b>voicemail|calllog</b> <br>
   ...
   * @zm-api-field-description Sort by: <b>dateDesc|dateAsc|durDesc|durAsc|nameDesc|nameAsc</b>
   *     [default:"dateDesc"]
   *     <ul>
   *       <li>durDesc: duration decending
   *       <li>durAsc: deration ascending
   *       <li>rest are the same as those for the sortBy attribute in <b>&lt;SearchRequest
   *           xmlns="urn:zimbraMail></b>
   *     </ul>
   */
