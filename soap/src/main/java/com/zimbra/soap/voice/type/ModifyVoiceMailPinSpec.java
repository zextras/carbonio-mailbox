...
public class ModifyVoiceMailPinSpec {
  ...
  public void setOldVoiceMailPin(String oldVoiceMailPin) {
    this.oldVoiceMailPin = oldVoiceMailPin;
  }

  public void setNewVoiceMailPin(String newVoiceMailPin) {
    this.newVoiceMailPin = newVoiceMailPin;
  }
  ...
  public String getOldVoiceMailPin() {
    return oldVoiceMailPin;
  }

  public String getNewVoiceMailPin() {
    return newVoiceMailPin;
  }
