...
@GraphQLType(
    name = GqlConstants.CLASS_CONTACT_SPEC,
...
public class ContactSpec implements SpecifyContact<NewContactAttr, NewContactGroupMember> {
   ...
   * @zm-api-field-description ID of folder to create contact in. Un-specified means use the default
   *     Contacts folder.
   */
  ...
  /**
   * @zm-api-field-description Contact group members. Valid only if the contact being created is a
   *     contact group (has attribute type="group")
   */
  @XmlElement(name = MailConstants.E_CONTACT_GROUP_MEMBER /* m */, required = false)
  @GraphQLInputField(
      name = GqlConstants.CONTACT_GROUP_MEMBERS,
      description = "Valid only if the contact being created is a contact group")
  ...
  @GraphQLInputField(
      ...
      description = "ID - specified when modifying a contact")
  ...
  @GraphQLInputField(
      name = GqlConstants.VCARD,
      description = "Either a vcard or attributes can be specified but not both")
  public void setVcard(VCardInfo vcard) {
    this.vcard = vcard;
  }
