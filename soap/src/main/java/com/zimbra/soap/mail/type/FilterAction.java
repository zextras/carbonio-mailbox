...
public class FilterAction {
  ...
  public static final class FileIntoAction extends FilterAction {
     ...
     * @zm-api-field-description If true, item will be copied to the new location, leaving the
     *     original in place. See https://tools.ietf.org/html/rfc3894 "Sieve Extension: Copying
  ...
  public static final class RedirectAction extends FilterAction {
    ...
    /**
     * @zm-api-field-tag copy
     * @zm-api-field-description If true, item's copy will be redirected, leaving the original in
     *     place.See https://tools.ietf.org/html/rfc3894 "Sieve Extension: Copying Without Side
     *     Effects"
     */
    @XmlAttribute(name = MailConstants.A_COPY /* copy */, required = false)
    private ZmBoolean copy;
  ...
  public static final class NotifyAction extends FilterAction {
     ...
     * @zm-api-field-description Subject template <br>
     *     Can contain variables such as ${SUBJECT}, ${TO}, ${CC}, etc (basically
     *     ${any-header-name}; case not important), plus ${BODY} (text body of the message).
     */
     ...
     * @zm-api-field-description Body template <br>
     *     Can contain variables such as ${SUBJECT}, ${TO}, ${CC}, etc (basically
     *     ${any-header-name}; case not important), plus ${BODY} (text body of the message).
     */
  ...
  public static class RejectAction extends FilterAction {
     ...
     */
    @XmlValue protected final String content;
  ...
  public static class LogAction extends FilterAction {
     ...
     * @zm-api-field-description Log level - <b>fatal|error|warn|info|debug|trace</b>, info is
  ...
  public static class ReplaceheaderAction extends DeleteheaderAction {
     ...
     * @param newValue
     */
    public ReplaceheaderAction(
        Boolean last, Integer offset, EditheaderTest test, String newName, String newValue) {
    ...
    public void validateReplaceheaderAction() throws ServiceException {
      if (StringUtil.isNullOrEmpty(newName) && StringUtil.isNullOrEmpty(newValue)) {
        throw ServiceException.PARSE_ERROR(
            ":newname or :newvalue must be provided with replaceHeader", null);
      }
