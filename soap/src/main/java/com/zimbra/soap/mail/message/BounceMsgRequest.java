 ...
 * @zm-api-command-description Resend a message <br>
 *     Supports (f)rom, (t)o, (c)c, (b)cc, (s)ender "type" on &lt;e> elements <br>
 *     (these get mapped to Resent-From, Resent-To, Resent-CC, Resent-Bcc, Resent-Sender headers,
 *     which are prepended to copy of existing message) <br>
