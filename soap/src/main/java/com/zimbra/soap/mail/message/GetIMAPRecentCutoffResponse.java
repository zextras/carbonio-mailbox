...
public class GetIMAPRecentCutoffResponse {
   ...
   * @zm-api-field-description The last recorded assigned item ID in the enclosing Mailbox the last
   *     time the folder was accessed via a read/write IMAP session. <br>
