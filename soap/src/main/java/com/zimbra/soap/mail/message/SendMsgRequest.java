 ...
 *     <ul>
 *       <li>Supports (f)rom, (t)o, (c)c, (b)cc, (r)eply-to, (s)ender, read-receipt (n)otification
 *           "type" on <b>&lt;e></b> elements.
 *       <li>Only allowed one top-level <b>&lt;mp></b> but can nest <b>&lt;mp></b>s within if
 *           multipart/*
 *       <li>A leaf <b>&lt;mp></b> can have inlined content (<b>&lt;mp
 *           ct="{content-type}">&lt;content>...&lt;/content>&lt;/mp></b>)
 *       <li>A leaf <b>&lt;mp></b> can have referenced content (<b>&lt;mp>&lt;attach
 *           ...>&lt;/mp></b>)
 *       <li>Any <b>&lt;mp></b> can have a Content-ID header attached to it.
 *       <li>On reply/forward, set origid on <b>&lt;m></b> element and set rt to "r" or "w",
 *           respectively
 *       <li>Can optionally set identity-id to specify the identity being used to compose the
 *           message
 *       <li>If noSave is set, a copy will <b>not</b> be saved to sent regardless of
 *           account/identity settings
 *       <li>Can set priority high (!) or low (?) on sent message by specifying "f" attr on
 *           <b>&lt;m></b>
 *       <li>The message to be sent can be fully specified under the <b>&lt;m></b> element or, to
 *           compose the message remotely remotely, upload it via FileUploadServlet, and submit it
 *           through our server using something like:
 *           <pre>
 *         &lt;SendMsgRequest [suid="{send-uid}"] [needCalendarSentByFixup="0|1"]>
 *             &lt;m aid="{uploaded-MIME-body-ID}" [origid="..." rt="r|w"]/>
 *         &lt;/SendMsgRequest>
 *      </pre>
 *       <li>If the message is saved to the sent folder then the ID of the message is returned.
 *           Otherwise, no ID is returned -- just a <b>&lt;m></b> is returned.
 *     </ul>
 */
...
public class SendMsgRequest {
   ...
   * @zm-api-field-description If set then Add SENT-BY parameter to ORGANIZER and/or ATTENDEE
   *     properties in iCalendar part when sending message on behalf of another user. Default is
   *     unset.
   */
  @XmlAttribute(
      name = MailConstants.A_NEED_CALENDAR_SENTBY_FIXUP /* needCalendarSentByFixup */,
      required = false)
  private ZmBoolean needCalendarSentbyFixup;

  /**
   * @zm-api-field-tag calendar-forward
   * @zm-api-field-description Indicates whether this a forward of calendar invitation in which case
   *     the server sends Forward Invitation Notification, default is unset.
   */
  @XmlAttribute(
      name = MailConstants.A_IS_CALENDAR_FORWARD /* isCalendarForward */,
      required = false)
  private ZmBoolean isCalendarForward;

  /**
   * @zm-api-field-tag no-save
   * @zm-api-field-description If set, a copy will <b>not</b> be saved to sent regardless of
   *     account/identity settings
   */
   ...
   * @zm-api-field-description If set, return the copy of the sent message, if it was saved, in the
   *     response.
   */
  ...
  public void setMsg(MsgToSend msg) {
    this.msg = msg;
  }

  public Boolean getNeedCalendarSentbyFixup() {
    return ZmBoolean.toBool(needCalendarSentbyFixup);
  }

  public Boolean getIsCalendarForward() {
    return ZmBoolean.toBool(isCalendarForward);
  }

  public Boolean getNoSaveToSent() {
    return ZmBoolean.toBool(noSaveToSent);
  }

  public Boolean getFetchSavedMsg() {
    return ZmBoolean.toBool(fetchSavedMsg);
  }
