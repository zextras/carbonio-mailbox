...
// TODO: should have an option on import that matches email addresses to existing contacts, and
// updates/ignores them.
/**
...
public class ImportContactsRequest {
   ...
   * @zm-api-field-description The format of csv being imported. when it's not defined, Zimbra
