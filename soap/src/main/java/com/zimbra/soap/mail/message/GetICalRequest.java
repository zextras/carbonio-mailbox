 ...
 * @zm-api-command-description Retrieve the unparsed (but XML-encoded (&amp;quot)) iCalendar data
 *     for an Invite <br>
 *     This is intended for interfacing with 3rd party programs <br>
 *     <ul>
 *       <li>If <b>id</b> attribute specified, gets the iCalendar representation for one invite
 *       <li>If <b>id</b> attribute is <b>not</b> specified, then start/end MUST be, Calendar data
...
public class GetICalRequest {
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("id", id).add("startTime", startTime).add("endTime", endTime);
  }
