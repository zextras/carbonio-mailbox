...
public abstract class GetCalendarItemRequestBase {
   ...
   * @zm-api-field-description If set, MIME parts for body content are returned; <b>default
   *     unset</b>
   */
   ...
   * @zm-api-field-description iCalendar UID Either id or uid should be specified, but not both
   */
   ...
   * @zm-api-field-description Appointment ID. Either id or uid should be specified, but not both
   */
  ...
  public void setIncludeInvites(Boolean includeInvites) {
    this.includeInvites = ZmBoolean.fromBool(includeInvites);
  }
  ...
  public Boolean getIncludeContent() {
    return ZmBoolean.toBool(includeContent);
  }

  public Boolean getIncludeInvites() {
    return ZmBoolean.toBool(includeInvites);
  }
