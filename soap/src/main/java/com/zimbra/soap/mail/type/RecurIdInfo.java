...
@GraphQLType(
    name = GqlConstants.CLASS_RECURRENCE_ID_INFORMATION,
    description = "Recurrence ID Information")
public class RecurIdInfo implements RecurIdInfoInterface {
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.RECURRENCE_RANGE_TYPE,
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.RECURRENCE_ID,
      description = "Recurrence ID in format : YYMMDD[THHMMSS[Z]]")
  ...
  @GraphQLInputField(
      ...
      description = "Recurrence-id in UTC time zone; used in non-all-day appointments only")
