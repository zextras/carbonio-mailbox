 ...
 * @zm-api-command-description Used by an attendee to forward an instance or entire appointment to
...
public class ForwardAppointmentRequest {
  ...
  /**
   * @zm-api-field-description RECURRENCE-ID information if forwarding a single instance of a
