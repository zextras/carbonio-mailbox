...
@GraphQLType(
    name = GqlConstants.CLASS_SIMPLE_REPEATING_RULE,
    description = "Simple repeating rule information")
public class SimpleRepeatingRule implements RecurRuleBase, SimpleRepeatingRuleInterface {
  ...
  @GraphQLNonNull
  @GraphQLQuery(
      name = GqlConstants.FREQUENCY,
      description = "Frequency. SEC, MIN, HOU, DAI, WEE, MON, YEA")
  ...
  public SimpleRepeatingRule(
      @GraphQLNonNull @GraphQLInputField(name = GqlConstants.FREQUENCY) String frequency) {
  ...
  public void setByWeekNo(ByWeekNoRule byWeekNo) {
    this.byWeekNo = byWeekNo;
  }

  @GraphQLInputField(name = GqlConstants.BY_MONTH, description = "BYMONTH rule")
  public void setByMonth(ByMonthRule byMonth) {
    this.byMonth = byMonth;
  }

  @GraphQLInputField(name = GqlConstants.BY_SET_POS, description = "BYSETPOS rule")
  public void setBySetPos(BySetPosRule bySetPos) {
    this.bySetPos = bySetPos;
  }

  @GraphQLInputField(
      name = GqlConstants.WEEK_START,
      description = "Week start day - SU,MO,TU,WE,TH,FR,SA")
  public void setWeekStart(WkstRule weekStart) {
