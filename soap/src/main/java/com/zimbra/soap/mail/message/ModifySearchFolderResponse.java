...
public class ModifySearchFolderResponse {
  ...
  /**
   * @zm-api-field-description Information about search folder, if and only if Search folder was
   *     modified.
   */
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this).add("searchFolder", searchFolder).toString();
  }
}
