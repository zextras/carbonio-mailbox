...
public class FilterTest {
  ...
  public static class AddressTest extends FilterTest {
     ...
     * @zm-api-field-description value comparison comparator -
     *     <b>i;ascii-numeric|i;ascii-casemap|i;octet</b>
     */
    @XmlAttribute(
        name = MailConstants.A_VALUE_COMPARISON_COMPARATOR /* valueComparisonComparator */,
        required = false)
    ...
    public static Importance fromString(String value) throws ServiceException {
      ...
      try {
        ...
        throw ServiceException.INVALID_REQUEST(
            "Invalid value: " + value + ", valid values: " + Arrays.asList(Importance.values()),
            null);
      }
    }
  }
  ...
  public static final class SizeTest extends FilterTest {
     ...
     * @zm-api-field-description size value. Value can be specified in bytes (no suffix), kilobytes
     *     (50K), megabytes (50M) or gigabytes (2G)
     */
    ...
    public String toString() {
      return MoreObjects.toStringHelper(this)
          .add("numberComparison", numberComparison)
          .add("size", size)
          .toString();
    }
  }
