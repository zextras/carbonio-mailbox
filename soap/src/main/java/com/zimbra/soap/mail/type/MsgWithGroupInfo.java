...
@GraphQLType(
    name = GqlConstants.CLASS_MESSAGE_WITH_GROUP_INFO,
    description = "Message with group information")
public class MsgWithGroupInfo extends MessageCommon {
   ...
   * @zm-api-field-description Message id of the message being replied to/forwarded (outbound
   *     messages only)
   */
   ...
   * @zm-api-field-description Can optionally set this to specify the time at which the draft should
   *     be automatically sent by the server
   */
  ...
  @XmlElements({
    ...
    @XmlElement(
        name = MailConstants.E_SHARE_NOTIFICATION /* shr */,
        type = ShareNotification.class),
    @XmlElement(
        name = MailConstants.E_DL_SUBSCRIPTION_NOTIFICATION /* dlSubs */,
  ...
  @GraphQLIgnore
  public void setInvite(InviteWithGroupInfo invite) {
    this.invite = invite;
  }
  ...
  public void setContent(UrlAndValue content) {
  ...
  @GraphQLQuery(
      name = GqlConstants.ORIG_ID,
      description = "Message id of the message being replied to/forwarded (outbound messages only)")
  ...
  public String getDraftReplyType() {
    return draftReplyType;
  }

  @GraphQLQuery(
      name = GqlConstants.IDENTITY_ID,
      description = "Specifies the identity being used to compose the message")
  ...
  @GraphQLQuery(
      name = GqlConstants.DRAFT_AUTO_SEND_TIME,
      description =
          "Specifies the time at which the draft should be automatically sent by the server")
  public Long getDraftAutoSendTime() {
    return draftAutoSendTime;
  }
  ...
  @GraphQLQuery(
      name = GqlConstants.IN_REPLY_TO,
      description = "Message-ID header for message being replied to")
