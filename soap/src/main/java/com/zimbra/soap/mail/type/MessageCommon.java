...
public class MessageCommon implements MessageCommonInterface {
   ...
   * @zm-api-field-description Converstation ID. only present if <b>&lt;m></b> is not enclosed
   *     within a <b>&lt;c></b> element
   */
   ...
   * @zm-api-field-description Flags. (u)nread, (f)lagged, has (a)ttachment, (r)eplied, (s)ent by
   *     me, for(w)arded, calendar in(v)ite, (d)raft, IMAP-\Deleted (x), (n)otification sent, urgent
  ...
  @GraphQLQuery(
      ...
      description = "Date Seconds since the epoch, from the date header in the message")
  public Long getDate() {
    return date;
  }
  ...
  @GraphQLQuery(
      ...
      description =
          "Flags set on the conversation. (u)nread, (f)lagged, has (a)ttachment, (r)eplied, (s)ent"
              + " by me, for(w)arded, calendar in(v)ite, (d)raft, IMAP-Deleted (x), (n)otification"
              + " sent, urgent (!), low-priority (?), priority (+)")
