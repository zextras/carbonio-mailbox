...
@GraphQLType(
    name = GqlConstants.CLASS_DATE_TIME_STRING_ATTRIBUTE,
    description = "Date time string attribute")
public class DateTimeStringAttr implements DateTimeStringAttrInterface {
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this).add("dateTime", dateTime).toString();
  }
}
