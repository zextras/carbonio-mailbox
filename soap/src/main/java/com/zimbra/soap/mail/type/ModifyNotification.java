...
public class ModifyNotification {
  ...
  public ModifyNotification(int bitmask) {
    changeBitmask = bitmask;
  }

  public void setChangeBitmask(int bitmask) {
    changeBitmask = bitmask;
  }
  ...
  public static class ModifyItemNotification extends ModifyNotification {
    ...
    public void setMessageInfo(ImapMessageInfo msgInfo) {
      this.msgInfo = msgInfo;
    }

    public ImapMessageInfo getMessageInfo() {
      return msgInfo;
    }
  }
