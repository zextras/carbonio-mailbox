 ...
 * @zm-api-command-description Get contacts <br>
 *     Contact group members are returned as &lt;m> elements. <br>
 *     If derefGroupMember is not set, group members are returned in the order they were inserted in
 *     the group. <br>
 *     If derefGroupMember is set, group members are returned ordered by the "key" of member. <br>
 *     Key is:
 *     <ul>
 ...
 *     </ul>
 *     Contact group members are returned as sub-elements of &lt;m>. If for any(transient or
 *     permanent) reason a member cannot be dereferenced, then there will be no sub-element under
 *     &lt;m>. <br>
 *     <br>
 *     For example:
 *     <pre>
...
public class GetContactsRequest {
   ...
   * @zm-api-field-description If set, deref contact group members. <br>
   ...
   *       <li>a GAL entry
   *     </ul>
   *     <b>Note</b>: for performance reason, derefGroupMember is supported only when specific
   *     contact ids are specified.
   */
  @XmlAttribute(
      name = MailConstants.A_DEREF_CONTACT_GROUP_MEMBER /* derefGroupMember */,
      required = false)
   ...
   * @zm-api-field-description Whether to return contact hidden attrs defined in
   *     <b>zimbraContactHiddenAttributes</b> <br>
   *     ignored if <b>&lt;a></b> is present.
   */
  @XmlAttribute(
      name = MailConstants.A_RETURN_HIDDEN_ATTRS /* returnHiddenAttrs */,
      required = false)
  private ZmBoolean returnHiddenAttrs;

  /**
   * @zm-api-field-tag return-certificate-info
   * @zm-api-field-description Whether to return smime certificate info <br>
   */
  ...
  /**
   * @zm-api-field-description If present, return only the specified attribute(s) for derefed
   *     members, applicable only when <b>derefGroupMember</b> is set.
   */
  ...
  public boolean getDerefGroupMember() {
    return ZmBoolean.toBool(derefGroupMember, false);
  }

  public boolean getReturnHiddenAttrs() {
    return ZmBoolean.toBool(returnHiddenAttrs, false);
  }

  public boolean getReturnCertInfo() {
    return ZmBoolean.toBool(returnCertInfo, false);
  }
