 ...
 * @zm-api-command-description Check if the authed user has the specified right(s) on a target. <br>
 ...
 *     </ul>
 *     e.g. With user1's auth token, the following checks if user1 can invite user2 and view user2's
 *     free/busy.
 *     <pre>
...
public class CheckPermissionRequest {
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("target", target).add("rights", rights);
  }
