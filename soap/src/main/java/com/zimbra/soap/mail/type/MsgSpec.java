...
@GraphQLType(
    name = GqlConstants.CLASS_MESSAGE_SPECIFICATION,
    description = "Message Specifications.")
public class MsgSpec {

  /**
   * @zm-api-field-tag message-id
   * @zm-api-field-description Message ID. Can contain a subpart identifier (e.g. "775-778") to
   *     return a message stored as a subpart of some other mail-item, specifically for Messages
   *     stored as part of Appointments
   */
   ...
   * @zm-api-field-description Supply a "part" and the retrieved data will be on the specified
   *     message/rfc822 subpart. If the part does not exist or is not a message/rfc822 part,
   ...
   * @zm-api-field-description Set to return the raw message content rather than a parsed mime
   *     structure; (default is unset. if message is too big or not ASCII, a content servlet URL is
   *     returned)
   */
   ...
   * @zm-api-field-description Set to mark the message as read, unset to leave the read status
   *     unchanged. By default, the read status is left unchanged.
   */
   ...
   * @zm-api-field-description Use <b>{max-inlined-length}</b> to limit the length of the text
   *     inlined into body <b>&lt;content></b>. <br>
   *     Only applicable when <b>raw</b> is unset. <b>Ignored</b> when <b>raw</b> is set. <br>
   ...
   * @zm-api-field-description If set, never inline raw <b>&lt;content></b> for messages, specify by
   *     <b>"url"</b> instead. <br>
   *     Only applicable when <b>raw</b> is set. <b>Ignored</b> when <b>raw</b> is unset. <br>
   *     (Default is unset - meaning inline content unless it is too big, in which case the
   *     <b>"url"</b> method will be used)
   */
   ...
   * @zm-api-field-description Set to "neuter" <b>&lt;IMG></b> tags returned in HTML content; this
   *     involves switching the <b>"src"</b> attribute to <b>"dfsrc"</b> so that images don't
   *     display by default (default is set.)
   */
   ...
   * @zm-api-field-description Recurrence ID in format <b>YYYYMMDD[ThhmmssZ]</b>. Used only when
   *     making GetMsg call to open an instance of a recurring appointment. The value specified is
   *     the date/time data of the RECURRENCE-ID of the instance being requested.
   */
   ...
   * @zm-api-field-description Set to return group info (isGroup and exp flags) on <b>&lt;e></b>
   *     elements in the response (default is unset.)
   */
   ...
   * @zm-api-field-description wantContent = <b>"full"</b> to get the complete message along with
   *     the quoted content <br>
   *     wantContent = <b>"original"</b> to get the message without quoted content <br>
   *     wantContent = <b>"both"</b> to get complete message as well as the message without quoted
   *     content <br>
   *     By default wantContent = <b>"full"</b> <br>
   *     Only applicable when <b>raw</b> is unset.
   *     <p>Note: Quoted text identification is a best effort. It is not supported by any RFCs
   */
  ...
  @GraphQLInputField(
      name = GqlConstants.MESSAGE_PART,
      description = "Set the part or message or rfc822 part.")
  public void setPart(String part) {
    this.part = part;
  }

  @GraphQLInputField(
      name = GqlConstants.INCLUDE_RAW_MESSAGE,
      description = "Set to return the raw message content rather than a parsed mime structure.")
  public void setRaw(Boolean raw) {
    this.raw = ZmBoolean.fromBool(raw);
  }

  @GraphQLInputField(
      name = GqlConstants.MARK_MESSAGE_AS_READ,
      description = "Set to true to mark the message as read.")
  public void setMarkRead(Boolean markRead) {
    this.markRead = ZmBoolean.fromBool(markRead);
  }

  @GraphQLInputField(
      name = GqlConstants.INLINED_TEXT_LENGTH,
      description = "Set the length of the text inlined into body.")
  public void setMaxInlinedLength(Integer maxInlinedLength) {
    this.maxInlinedLength = maxInlinedLength;
  }

  @GraphQLInputField(
      name = GqlConstants.INCLUDE_URL_CONTENT,
      description = "Set the content to raw or url method.")
  public void setUseContentUrl(Boolean useUrl) {
    this.useContentUrl = ZmBoolean.fromBool(useUrl);
  }

  @GraphQLInputField(
      name = GqlConstants.INCLUDE_HTML,
      description = "Set to return defanged html content.")
  public void setWantHtml(Boolean wantHtml) {
    this.wantHtml = ZmBoolean.fromBool(wantHtml);
  }

  @GraphQLInputField(
      name = GqlConstants.INCLUDE_IMAP_UID,
      description = "Set to return the IMAP UID.")
  public void setWantImapUid(Boolean wantImapUid) {
    this.wantImapUid = ZmBoolean.fromBool(wantImapUid);
  }

  @GraphQLInputField(
      name = GqlConstants.INCLUDE_MODIFIED_SEQUENCE,
      description = "Set to return modified sequence.")
  public void setWantModifiedSequence(Boolean wantModSeq) {
    this.wantModifiedSequence = ZmBoolean.fromBool(wantModSeq);
  }

  @GraphQLInputField(
      name = GqlConstants.HIDE_IMAGES,
      description = "Set to not display images by default.")
  public void setNeuter(Boolean neuter) {
    this.neuter = ZmBoolean.fromBool(neuter);
  }

  @GraphQLInputField(
      name = GqlConstants.RECURRENCE_DATE_ID,
      description = "Set the date-time data to open an instance of a recurring appointment.")
  ...
  @GraphQLInputField(
      ...
      description = "Set the message content type.")
  public void setWantContent(MsgContent msgContent) {
    this.wantContent = msgContent;
  }

  @GraphQLInputField(
      name = GqlConstants.INCLUDE_GROUP_INFO,
      description = "Set to return group info in the response ")
  ...
  public Boolean getUseContentUrl() {
    return ZmBoolean.toBool(useContentUrl);
  }
  ...
  public Boolean getNeuter() {
    return ZmBoolean.toBool(neuter);
  }
