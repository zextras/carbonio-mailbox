...
@GraphQLType(
    name = GqlConstants.CLASS_CALENDAR_ATTACHMENT,
    description = "Calendar attachment information")
public class CalendarAttach implements CalendarAttachInterface {
   ...
   */
  @XmlValue private String binaryB64Data;
  ...
  @GraphQLInputField(
      ...
      description = "Content-Type for the binary64Data")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.BINARY_64_DATA,
      description = "Base64 encoded binary alarm attachment data")
