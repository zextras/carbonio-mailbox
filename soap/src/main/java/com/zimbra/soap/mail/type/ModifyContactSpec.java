...
public class ModifyContactSpec
    implements SpecifyContact<ModifyContactAttr, ModifyContactGroupMember> {
  ...
  @GraphQLInputField(
      name = GqlConstants.ATTRIBUTES,
      description = "Cannot specify vcard as well as these")
  ...
  @GraphQLInputField(
      ...
      description = "Contact group members.")
  ...
  public void setId(@GraphQLNonNull Integer id) {
    this.id = id;
  }
  ...
  public ModifyContactGroupMember addContactGroupMemberWithTypeAndValue(String type, String value) {
    final ModifyContactGroupMember mcgm =
        ModifyContactGroupMember.createForTypeAndValue(type, value);
