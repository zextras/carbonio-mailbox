...
@GraphQLType(
    name = GqlConstants.CLASS_CALENDAR_ACTION_RESPONSE,
    description = "Contains response information for calendar actions (create, modify, reply)")
public class CreateCalendarItemResponse {
  ...
  public void setCalInvId(String calInvId) {
  ...
  public void setMsg(Id msg) {
    this.msg = msg;
  }

  public void setEcho(CalEcho echo) {
    this.echo = echo;
  }
