...
public class ActionGrantSelector {
  ...
  @GraphQLQuery(
      name = "granteeType",
      description = "Grantee Type - usr | grp | cos | dom | all | pub | guest | key")
   ...
   * @zm-api-field-description Name or email address of the grantee. Not present if
   *     <b>{grantee-type}</b> is "all" or "pub"
   */
   ...
   * @zm-api-field-description Optional argument. Password when <b>{grantee-type}</b> is "gst" (not
   *     yet supported)
   */
