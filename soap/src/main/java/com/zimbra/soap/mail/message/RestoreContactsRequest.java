...
public class RestoreContactsRequest {
   ...
   * @zm-api-field-description Restore resolve action - one of <b>ignore|modify|replace|reset</b>
   *     <br>
   *     Default value - reset <br>
   *     <ul>
   *       <li>ignore - In case of conflict, ignore the existing contact. Create new contact from
   *           backup file.
   *       <li>modify - In case of conflict, merge the existing contact with contact in backup file.
   *       <li>replace - In case of conflict, replace the existing contact with contact in backup
   *           file.
