...
public abstract class CalItemRequestBase {
   ...
   * @zm-api-field-description If specified, the created appointment is echoed back in the response
   *     as if a GetMsgRequest was made
   */
   ...
   * @zm-api-field-description If set, ignore smtp 550 errors when sending the notification to
   *     attendees. <br>
   *     If unset, throw the soapfaultexception with invalid addresses so that client can give the
   *     forcesend option to the end user. <br>
   *     The default is 1.
   */
  ...
  public void setEcho(Boolean echo) {
    this.echo = ZmBoolean.fromBool(echo);
  }
  ...
  public void setForceSend(Boolean force) {
    this.forceSend = ZmBoolean.fromBool(force);
  }

  public Boolean getEcho() {
    return ZmBoolean.toBool(echo);
  }
  ...
  public Boolean getForceSend() {
    return ZmBoolean.toBool(forceSend);
  }
