 ...
 * @zm-api-command-description Enable/disable reminders for shared appointments/tasks on a
 *     mountpoint
 */
...
public class EnableSharedReminderRequest {
  ...
  public SharedReminderMount getMount() {
    return mount;
  }

  @Override
  public String toString() {
    return MoreObjects.toStringHelper(this).add("mount", mount).toString();
  }
}
