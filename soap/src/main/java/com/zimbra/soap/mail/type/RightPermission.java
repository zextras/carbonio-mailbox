...
public class RightPermission {
   ...
   * @zm-api-field-description If set then the authed user has the right <b>{right-name}</b> on the
   *     target.
   */
   ...
   */
  @XmlValue private String rightName;
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("allow", allow).add("rightName", rightName);
  }
