 ...
 * @zm-api-command-description Triggers the specified data sources to kick off their import
 *     processes. Data import runs asynchronously, so the response immediately returns. Status of an
 *     import can be queried via the <b>&lt;GetImportStatusRequest></b> message. If the server
 *     receives an <b>&lt;ImportDataRequest></b> while an import is already running for a given data
 *     source, the second request is ignored.
 */
