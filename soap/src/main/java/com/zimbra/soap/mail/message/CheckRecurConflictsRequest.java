 ...
 * @zm-api-command-description Check conflicts in recurrence against list of users. <br>
 *     Set <b>all</b> attribute to get all instances, even those without conflicts. By default only
...
public class CheckRecurConflictsRequest {
   ...
   * @zm-api-field-description Set this to get all instances, even those without conflicts. By
   *     default only instances that have conflicts are returned.
   */
  ...
  @XmlElements({
    @XmlElement(
        name = MailConstants.E_CAL_CANCEL /* cancel */,
        type = ExpandedRecurrenceCancel.class),
    @XmlElement(
        name = MailConstants.E_INVITE_COMPONENT /* comp */,
        type = ExpandedRecurrenceInvite.class),
    @XmlElement(
        name = MailConstants.E_CAL_EXCEPT /* except */,
  ...
  public CheckRecurConflictsRequest addComponent(ExpandedRecurrenceComponent component) {
  ...
  public CheckRecurConflictsRequest addFreebusyUser(FreeBusyUserSpec freebusyUser) {
  ...
  public Boolean getAllInstances() {
    return ZmBoolean.toBool(allInstances);
  }
