...
public class SetRecoveryAccountRequest {
  ...
  @XmlAttribute(
      name =
          MailConstants.A_RECOVERY_ACCOUNT_VERIFICATION_CODE /* recoveryAccountVerificationCode */,
      required = false)
  ...
  public void setRecoveryAccountVerificationCode(String recoveryAccountVerificationCode) {
