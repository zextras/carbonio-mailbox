...
public class InviteAsMP extends MessageCommon {
  ...
  /**
   * @zm-api-field-tag
   * @zm-api-field-description If non-null, this message/rfc822 subpart of the specified Message is
   *     serialized instead of the Message itself.
   */
  ...
  /**
   * @zm-api-field-description Mime parts, share notifications and distribution list subscription
   *     notifications
   */
  @XmlElements({
  ...
  @GraphQLInputField(
      name = GqlConstants.PART,
      description =
          "If non-null, this message/rfc822 subpart of the specified Message is serialized instead"
  ...
  public void setInvite(MPInviteInfo invite) {
    this.invite = invite;
  }
