...
public class PartInfo implements PartInfoInterface {
   ...
   * @zm-api-field-description MIME part name. "" means top-level part, 1 first part, 1.1 first part
   *     of a multipart inside of 1.
   */
   ...
   * @zm-api-field-description Set if this part is considered to be the "body" of the message for
   *     display purposes.
   */
  ...
  @Override
  public PartInfoInterface createFromPartAndContentType(String part, String contentType) {
  ...
  public void setBody(Boolean body) {
    this.body = ZmBoolean.fromBool(body);
  }
  ...
  public static Iterable<PartInfo> fromInterfaces(Iterable<PartInfoInterface> ifs) {
  ...
  public static List<PartInfoInterface> toInterfaces(Iterable<PartInfo> params) {
