 ...
 * @zm-api-command-description Remove attachments from a message body <br>
 *     <b>NOTE</b> that this operation is effectively a create and a delete, and thus the message's
 *     item ID will change
 */
