 ...
 * @zm-api-command-description Modify an appointment, or if the appointment is a recurrence then
 *     modify the "default" invites. That is, all instances that do not have exceptions. <br>
 *     <br>
 *     If the appointment has a <b>&lt;recur></b>, then the following caveats are worth mentioning:
 *     <br>
 *     <b>If any of: START, DURATION, END or RECUR change, then all exceptions are implicitly
 *     canceled!</b>
 */
...
public class ModifyAppointmentRequest extends CalItemRequestBase {
   ...
   * @zm-api-field-description Changed sequence of fetched version. <br>
   *     Used for conflict detection. By setting this, the request indicates which version of the
   *     appointment it is attempting to modify. If the appointment was updated on the server
   *     between the fetch and modify, an <b>INVITE_OUT_OF_DATE exception</b> will be thrown.
   */
