...
public class WatcherInfo {
  ...
  /**
   * @zm-api-field-description List of items in the user's mailbox currently being watched by other
   *     users
   */
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("id", id).add("email", email).add("name", name).add("items", items);
  }
