...
public class AddMsgSpec {
   ...
   *     me, for(w)arded, (d)raft, deleted (x), (n)otification sent
   */
   ...
   * @zm-api-field-description (optional) Time the message was originally received, in MILLISECONDS
   *     since the epoch
   */
   ...
   * @zm-api-field-description The entire message's content. (Omit if you specify an "aid"
   *     attribute.) <br>
  ...
  public void setNoICal(Boolean noICal) {
    this.noICal = ZmBoolean.fromBool(noICal);
  }
  ...
  public Boolean getNoICal() {
    return ZmBoolean.toBool(noICal);
  }
