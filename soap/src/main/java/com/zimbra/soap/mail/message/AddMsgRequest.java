...
public class AddMsgRequest {
   ...
   * @zm-api-field-description If set, then do outgoing message filtering if the msg is being added
   *     to the Sent folder and has been flagged as sent. Default is unset.
   */
  ...
  public Boolean getFilterSent() {
    return ZmBoolean.toBool(filterSent);
  }

  public AddMsgSpec getMsg() {
    return msg;
  }

  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("filterSent", filterSent).add("msg", msg);
  }
