...
public class CommonDocumentInfo {
   ...
   * @zm-api-field-description Date the item's content was last modified in milliseconds since
   *     1970-01-01 00:00:00 UTC. For immutable objects (e.g. received messages), this will be the
   *     same as the date the item was created.
   */
   ...
   * @zm-api-field-description The date the item's metadata and/or content was last modified in
  ...
  public Boolean getDescEnabled() {
    return ZmBoolean.toBool(descEnabled);
  }
