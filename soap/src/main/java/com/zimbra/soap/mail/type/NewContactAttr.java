...
@GraphQLType(
    name = GqlConstants.CLASS_NEW_CONTACT_ATTRIBUTE,
    description = "Input for creating a new contact attribute")
public class NewContactAttr {
   ...
   * @zm-api-field-description Attribute data <br>
   *     Date related attributes like "birthday" and "anniversary" SHOULD use <b>"yyyy-MM-dd"</b>
   *     format or, if the year isn't specified <b>"--MM-dd"</b> format
   */
  @XmlValue
  ...
  @GraphQLIgnore
  public NewContactAttr setName(String name) {
    this.name = name;
    return this;
  }

  @GraphQLInputField(name = GqlConstants.ATTACHMENT_ID, description = "Upload ID")
  public NewContactAttr setAttachId(String attachId) {
    this.attachId = attachId;
    return this;
  }

  @GraphQLInputField(name = GqlConstants.ID, description = "Item ID. Used in combination with part")
  public NewContactAttr setId(Integer id) {
    this.id = id;
    return this;
  }

  @GraphQLInputField(name = GqlConstants.PART, description = "Subpart name")
  public NewContactAttr setPart(String part) {
    this.part = part;
    return this;
  }

  @GraphQLInputField(name = GqlConstants.VALUE, description = "Attribute value")
  public NewContactAttr setValue(String value) {
    this.value = value;
    return this;
  }
