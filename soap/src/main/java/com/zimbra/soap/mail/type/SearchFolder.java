...
public final class SearchFolder extends Folder {
   ...
   * @zm-api-field-description Comma-separated list. Legal values in list are: <br>
   *     <b>appointment|chat|contact|conversation|document|message|tag|task|wiki</b> (default is
   *     &quot;conversation&quot;)
   */
  ...
  @GraphQLInputField(
      ...
      description = "type of the new folder created")
