...
public final class FilterTests {
  ...
  @XmlElements({
    ...
    @XmlElement(
        name = MailConstants.E_CONTACT_RANKING_TEST,
        type = FilterTest.ContactRankingTest.class),
    @XmlElement(name = MailConstants.E_CONVERSATION_TEST, type = FilterTest.ConversationTest.class),
    @XmlElement(
        name = MailConstants.E_CURRENT_DAY_OF_WEEK_TEST,
        type = FilterTest.CurrentDayOfWeekTest.class),
    ...
    @XmlElement(
        name = MailConstants.E_HEADER_EXISTS_TEST,
        type = FilterTest.HeaderExistsTest.class),
    ...
    @XmlElement(
        name = MailConstants.E_COMMUNITY_REQUESTS_TEST,
        type = FilterTest.CommunityRequestsTest.class),
    @XmlElement(
        name = MailConstants.E_COMMUNITY_CONTENT_TEST,
        type = FilterTest.CommunityContentTest.class),
    @XmlElement(
        name = MailConstants.E_COMMUNITY_CONNECTIONS_TEST,
        type = FilterTest.CommunityConnectionsTest.class),
  })
