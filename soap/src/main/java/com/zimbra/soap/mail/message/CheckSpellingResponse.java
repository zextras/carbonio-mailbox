...
public class CheckSpellingResponse {
   ...
   * @zm-api-field-description The "available" attribute specifies whether the server-side spell
   *     checking interface is available or not.
   */
  ...
  public void setAvailable(boolean available) {
    this.available = ZmBoolean.fromBool(available);
  }
  ...
  public boolean isAvailable() {
    return ZmBoolean.toBool(available);
  }
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("available", available).add("misspelledWords", misspelledWords);
  }
