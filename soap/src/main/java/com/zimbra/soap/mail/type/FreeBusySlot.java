...
public class FreeBusySlot {
   ...
   * @zm-api-field-description returns a boolean value whether this calendar event is a meeting or
   *     not.
   */
   ...
   * @zm-api-field-description returns a boolean indicating whether any reminder has been set or
   *     not.
   */
   ...
   * @zm-api-field-description returns a boolean indicating hasPermission to view FreeBusy
   *     information
   */
  ...
  @GraphQLNonNull
  @GraphQLQuery(
      name = GqlConstants.START_TIME,
      description = "GMT Start time for slot in milliseconds")
