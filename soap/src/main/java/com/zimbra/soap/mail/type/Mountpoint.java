...
public class Mountpoint extends Folder {
   ...
   * @zm-api-field-description If "tr" is true in the request, <b>broken</b> is set if this is a
   *     broken link
   */
  ...
  @GraphQLQuery(
      name = GqlConstants.OWNER_EMAIL,
      description = "Primary email address of the owner of the linked-to resource")
  public String getOwnerEmail() {
    return ownerEmail;
  }

  @GraphQLQuery(
      name = GqlConstants.OWNER_ACCOUNT_ID,
      description = "Zimbra ID (guid) of the owner of the linked-to resource")
  public String getOwnerAccountId() {
    return ownerAccountId;
  }

  @GraphQLQuery(
      name = GqlConstants.REMOTE_FOLDER_ID,
      description = "Item ID of the linked-to resource in the remote mailbox")
  public int getRemoteFolderId() {
    return remoteFolderId;
  }

  @GraphQLQuery(
      name = GqlConstants.OWNER_FOLDER_NAME,
      description = "The name presently used for the item by the owner")
  public String getRemoteFolderName() {
    return remoteFolderName;
  }

  @GraphQLQuery(
      name = GqlConstants.REMINDER_ENABLED,
      description = "If set, client should display reminders for shared appointments/tasks")
  ...
  @GraphQLQuery(
      name = GqlConstants.IS_BROKEN,
      description = "If \"tr\" is true in the request, broken is set if this is a broken link")
  ...
  @GraphQLQuery(
      name = GqlConstants.REMOTE_UUID,
      description = "UUID of the linked-to resource in the remote mailbox")
