...
public class CommentInfo {
   ...
   */
  @XmlElementRefs({@XmlElementRef(/* meta */ type = MailCustomMetadata.class)})
  @XmlMixed
  ...
  public void setText(String text) {
    if (elements == null) elements = Lists.newArrayList();
  ...
  public List<MailCustomMetadata> getMetadatas() {
    ...
    for (Object obj : elements) {
      if (obj instanceof MailCustomMetadata) metadatas.add((MailCustomMetadata) obj);
    }
