...
public class ExportContactsRequest {
   ...
   * @zm-api-field-description Optional csv format for exported contacts. the supported formats are
   *     defined in <b>$ZIMBRA_HOME/conf/contact-fields.xml</b>
   */
   ...
   * @zm-api-field-description The locale to use when there are multiple <b>{csv-format}</b> locales
   *     defined. When it is not specified, the <b>{csv-format}</b> with no locale specification is
   *     used.
   */
   ...
   * @zm-api-field-description Optional delimiter character to use in the resulting csv file -
   *     usually "," or ";"
   */
