...
public class AlarmInfo implements AlarmInfoInterface {
   ...
   * @zm-api-field-description Alarm action <br>
   *     Possible values: <br>
  ...
  /**
   * @zm-api-field-description Non-standard properties (see RFC2445 section 4.8.8.1) <br>
   *     e.g. <br>
   *     iCalendar:
   *     <pre>
  ...
  public AlarmInfo(@GraphQLNonNull @GraphQLInputField(name = GqlConstants.ACTION) String action) {
    this.action = action;
  }
  ...
  public void setRepeat(DurationInfo repeat) {
    this.repeat = repeat;
  }
  ...
  @GraphQLInputField(
      ...
      description =
          "Alarm description\n"
              ...
              + " * action=EMAIL|X_YAHOO_CALENDAR_ACTION_IM|X_YAHOO_CALENDAR_ACTION_MOBILE: EMail"
              + " body \n"
  ...
  public void setAttach(CalendarAttach attach) {
    this.attach = attach;
  }
