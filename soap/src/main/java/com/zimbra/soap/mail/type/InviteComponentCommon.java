...
@GraphQLType(
    name = GqlConstants.CLASS_INVITE_COMPONENT_COMMON,
    description = "Invite component common information")
public class InviteComponentCommon implements InviteComponentCommonInterface {
  ...
  @GraphQLQuery(
      name = GqlConstants.COMPONENT_NUMBER,
      description = "Component number of the invite")
  ...
  @GraphQLQuery(
      name = GqlConstants.RSVP,
      description = "RSVP flag.  Set if response requested, unset if no response requested")
   ...
   */
  @XmlAttribute(
      name = MailConstants.A_TASK_PERCENT_COMPLETE /* percentComplete */,
      required = false)
   ...
   * @zm-api-field-description The "actual" free-busy status of this invite (ie what the client
   *     should display). This is synthesized taking into account our Attendee's PartStat, the
   *     Opacity of the appointment, its Status, etc... <br>
   *     Valid values - <b>F|B|T|U</b>. i.e. Free, Busy (default), busy-Tentative, OutOfOffice
   *     (busy-unavailable)
   */
   ...
   * @zm-api-field-description FreeBusy setting <b>F|B|T|U</b> <br>
   ...
   * @zm-api-field-description UID to use when creating appointment. Optional: client can request
   *     the UID to use
   */
   ...
   * @zm-api-field-description Status - <b>TENT|CONF|CANC|NEED|COMP|INPR|WAITING|DEFERRED</b> <br>
   *     i.e. TENTative, CONFirmed, CANCelled, COMPleted, INPRogress, WAITING, DEFERRED <br>
   ...
   * @zm-api-field-description Class = <b>PUB|PRI|CON</b>. i.e. PUBlic (default), PRIvate,
   *     CONfidential
   */
   ...
   * @zm-api-field-description Set if invite has changes that haven't been sent to attendees; for
   *     organizer only
   */
   ...
   * @zm-api-field-description Set if attendees were never notified of this invite; for organizer
   *     only
   */
   ...
   * @zm-api-field-description Comma-separated list of changed data in an updated invite. <br>
   *     Possible values are "subject", "location", "time" (start time, end time, or duration), and
   *     "recurrence".
   */
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.PERCENT_COMPLETE,
      description = "Percent complete for VTODO (0 - 100; default = 0)")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.COMPLETED,
      description = "VTODO COMPLETED DATE-TIME in format: yyyyMMddThhmmssZ")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.NO_BLOB,
      description = "Set if invite has no blob data, i.e. all data is in db metadata")
  public void setNoBlob(Boolean noBlob) {
    this.noBlob = ZmBoolean.fromBool(noBlob);
  }

  @Override
  @GraphQLInputField(
      name = GqlConstants.FREE_BUSY_ACTUAL,
      description =
          "The actual free-busy status of this invite (ie what the client should display).\n"
              + " This is synthesized taking into account our Attendee's participationStatus, the"
              + " Opacity of the appointment, its Status, etc...\n"
              + " > Valid values:\n"
              + " * F: Free\n"
              + " * B: Busy (default)\n"
              + " * T: busy-Tentative\n"
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.TRANSPARENCY,
      description =
          "Transparency\n " + "> Valid values:\n " + "* O: Opaque\n " + "* T: Transparent")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.IS_ORGANIZER,
      description = "Denotes whether owner is the organizer (defaults to false)")
  public void setIsOrganizer(Boolean isOrganizer) {
    this.isOrganizer = ZmBoolean.fromBool(isOrganizer);
  }
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.CALENDAR_ITEM_ID,
      description = "Mail item ID of appointment")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.CALENDAR_ITEM_FOLDER,
      description = "Folder of appointment")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.CALENDAR_CLASS,
      description =
          "Class\n "
              + "> Valid values:\n "
              + "* PUB: Public (default)\n "
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.IS_EXCEPTION,
      description = "Denotes whether this invite is an exception")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.RECURRENCE_ID_Z,
      description = "Recurrence-id string in UTC timezone")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.IS_ALL_DAY,
      description = "Denotes whether this is an all day appointment")
  public void setIsAllDay(Boolean isAllDay) {
    this.isAllDay = ZmBoolean.fromBool(isAllDay);
  }

  @Override
  @GraphQLInputField(
      name = GqlConstants.IS_DRAFT,
      description =
          "Denotes whether this invite has changes that haven't been sent to attendees; for"
              + " organizer only")
  public void setIsDraft(Boolean isDraft) {
    this.isDraft = ZmBoolean.fromBool(isDraft);
  }

  @Override
  @GraphQLInputField(
      name = GqlConstants.IS_NEVER_SENT,
      description = "Denotes if attendees were never notified of this invite; for organizer only")
  public void setNeverSent(Boolean neverSent) {
    this.neverSent = ZmBoolean.fromBool(neverSent);
  }

  @Override
  @GraphQLInputField(
      name = GqlConstants.CHANGES,
      description =
  ...
  public Boolean getNoBlob() {
    return ZmBoolean.toBool(noBlob);
  }
  ...
  public Boolean getIsOrganizer() {
    return ZmBoolean.toBool(isOrganizer);
  }
  ...
  public Boolean getIsException() {
    return ZmBoolean.toBool(isException);
  }
  ...
  public Boolean getIsAllDay() {
    return ZmBoolean.toBool(isAllDay);
  }
  ...
  public Boolean getIsDraft() {
    return ZmBoolean.toBool(isDraft);
  }
  ...
  public Boolean getNeverSent() {
    return ZmBoolean.toBool(neverSent);
  }
