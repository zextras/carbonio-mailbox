...
public class Misspelling {
   ...
   * @zm-api-field-description Comma separated list of suggestions. Suggested words are listed in
   *     decreasing order of their match score.
   */
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("word", word).add("suggestions", suggestions);
  }
