...
public class Msg {
   ...
   * @zm-api-field-description Identity ID. The identity referenced by <b>{identity-id}</b>
   *     specifies the folder where the sent message is saved.
   */
  ...
  @GraphQLInputField(
      name = GqlConstants.REPLY_TYPE,
      description = "Reply type - r|w. (r)eplied or for(w)arded.")
  ...
  @GraphQLInputField(
      ...
      description =
          "The identity referenced by {identity-id} specifies the folder where the sent message is"
              + " saved.")
  ...
  public void setMimePart(MimePartInfo mimePart) {
  ...
  public void setInvite(InvitationInfo invite) {
    this.invite = invite;
  }
