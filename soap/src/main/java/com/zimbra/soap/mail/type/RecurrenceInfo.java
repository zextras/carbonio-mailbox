...
@GraphQLType(
    name = GqlConstants.CLASS_RECURRENCE_INFORMATION,
    description = "Recurrence Information")
public class RecurrenceInfo implements RecurRuleBase, RecurrenceInfoInterface {
  ...
  @XmlElements({
    ...
    @XmlElement(
        name = MailConstants.E_CAL_EXCLUDE /* exclude */,
  ...
  public static Iterable<RecurRuleBase> fromInterfaces(Iterable<RecurRuleBaseInterface> params) {
  ...
  public static List<RecurRuleBaseInterface> toInterfaces(Iterable<RecurRuleBase> params) {
    if (params == null) return null;
  ...
  @GraphQLInputField(
      name = GqlConstants.RULES_EXCLUDE,
      description = "Recurrence rules for excluding")
  ...
  @GraphQLInputField(
      name = GqlConstants.RULES_EXCEPT,
      description = "Recurrence rules for excepting")
  ...
  @GraphQLInputField(
      name = GqlConstants.RULES_CANCEL,
      description = "Recurrence rules for canceling")
