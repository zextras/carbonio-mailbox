...
public class EmailAddrInfo {
  ...
  public static EmailAddrInfo createForAddressPersonalAndAddressType(
      String address, String personalName, String addressType) {
  ...
  @GraphQLInputField(
      ...
      description =
          "Address type\n "
              ...
              + "* n: notification\n "
              + "* rf: resent-from")
  public void setAddressType(@GraphQLNonNull String addressType) {
    this.addressType = addressType;
  }

  @GraphQLInputField(
      name = GqlConstants.PERSONAL,
      description = "The comment/name part of an address")
  ...
  @GraphQLQuery(
      name = GqlConstants.ADDRESS_TYPE,
      description =
          "Address type - (f)rom, (t)o, (c)c, (b)cc, (r)eply-to, (s)ender, read-receipt"
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("address", address).add("addressType", addressType).add("personal", personal);
  }
