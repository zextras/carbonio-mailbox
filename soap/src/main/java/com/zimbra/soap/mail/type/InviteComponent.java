...
public class InviteComponent extends InviteComponentCommon implements InviteComponentInterface {
  ...
  @GraphQLQuery(
      name = GqlConstants.EXCEPTION_ID,
      description = "Recurrence id, if this is an exception")
  private ExceptionRecurIdInfo exceptionId;

  // For JSON, wrapped in array because ToXML.encodeDtStart used addElement instead of
  // addUniqueElement :-(
  /**
  ...
  // For JSON, wrapped in array because ToXML.encodeDtEnd used addElement instead of
  // addUniqueElement :-(
  /**
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.CATEGORIES,
      description = "for iCalendar CATEGORY properties")
  ...
  public void setDtStart(@GraphQLNonNull DtTimeInfo dtStart) {
  ...
  @Override
  @GraphQLQuery(
      name = GqlConstants.DESCRIPTION,
      description = "Present if noBlob is set, and message has a plain text description")
  ...
  @Override
  @GraphQLQuery(
      name = GqlConstants.HTML_DESCRIPTION,
      description = "Present if noBlob is set, and message has an HTML description")
  ...
  @Override
  @GraphQLIgnore
  public void setAttendeeInterfaces(Iterable<CalendarAttendeeInterface> attendees) {
  ...
  @Override
  @GraphQLIgnore
  public void setExceptionIdInterface(ExceptionRecurIdInfoInterface exceptionId) {
