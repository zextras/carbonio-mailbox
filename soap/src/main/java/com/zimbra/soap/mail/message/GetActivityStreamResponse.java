...
/**
 * @zm-api-response-description The response has three sections: user, op and activity. <br>
 *     User and op sections lists all the users and activities logged in the current stream to allow
 *     the client to show filter UI if the user wants to see activities from specific users or
 *     specific operation. <br>
 *     Activity section contains the who, what and when. Arg element contains extra data for some of
 *     the operations. e.g.
 *     <pre>
 * AddDocumentRevision
 *   ver - old version
