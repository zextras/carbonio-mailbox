...
@GraphQLType(
    name = GqlConstants.CLASS_ATTACHMENT_SPECIFICATIONS,
    description = "Attachment specifications")
public abstract class AttachSpec {
  ...
  public void setOptional(Boolean optional) {
    this.optional = ZmBoolean.fromBool(optional);
  }

  @GraphQLQuery(name = GqlConstants.OPTIONAL, description = "Optional")
  public Boolean getOptional() {
    return ZmBoolean.toBool(optional);
  }

  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("optional", optional);
  }
