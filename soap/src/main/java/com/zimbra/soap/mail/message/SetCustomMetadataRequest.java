 ...
 * @zm-api-command-description Set Custom Metadata <br>
 *     Setting a custom metadata section but providing no key/value pairs will remove the sction
 *     from the item
 */
...
public class SetCustomMetadataRequest {
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("id", id).add("metadata", metadata);
  }
