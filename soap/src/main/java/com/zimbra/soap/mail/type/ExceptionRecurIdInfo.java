...
@GraphQLType(
    name = GqlConstants.CLASS_EXCEPTION_RECURRENCE_ID_INFORMATION,
    description = "Exception recurrence id information")
public class ExceptionRecurIdInfo implements ExceptionRecurIdInfoInterface {
  ...
  @GraphQLQuery(
      name = GqlConstants.DATE_TIME,
      description = "Date and/or time.  Format is : YYYYMMDD['T'HHMMSS[Z]]")
   ...
   * @zm-api-field-description Range type - 1 means NONE, 2 means THISANDFUTURE, 3 means
   *     THISANDPRIOR
   */
