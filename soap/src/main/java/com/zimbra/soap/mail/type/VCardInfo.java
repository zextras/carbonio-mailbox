...
@GraphQLType(
    name = GqlConstants.CLASS_VCARD_INFO,
    description = "Input for creating a new contact VCard")
public class VCardInfo {
  ...
  @GraphQLInputField(
      name = GqlConstants.MESSAGE_ID,
      description = "Message ID. Use in conjuction with part")
  ...
  @GraphQLInputField(
      ...
      description = "Part identifier. Use in conjunction with message id")
