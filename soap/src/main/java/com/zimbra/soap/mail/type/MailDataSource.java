...
public class MailDataSource implements DataSource {
  ...
  /**
   * @zm-api-field-description Whether sending outbound mail using external SMTP server is enabled
   *     in this data source.
   */
   ...
   * @zm-api-field-description Name of SMTP server <br>
   *     e.g. "smtp.myisp.com"
   */
   ...
   * @zm-api-field-description Port number of SMTP server <br>
   *     e.g. "465"
   */
  ...
  /**
   * @zm-api-field-description Which security layer to use for connecting to SMTP host associated
   *     with this data source.
   */
  @XmlAttribute(
      name = MailConstants.A_DS_SMTP_CONNECTION_TYPE /* smtpConnectionType */,
      required = false)
  private MdsConnectionType smtpConnectionType;

  /**
   * @zm-api-field-description Whether SMTP server associated with this data source requires
   *     authentication.
   */
  @XmlAttribute(
      name = MailConstants.A_DS_SMTP_AUTH_REQUIRED /* smtpAuthRequired */,
      required = false)
  ...
  public void setSmtpEnabled(Boolean smtpEnabled) {
    this.smtpEnabled = ZmBoolean.fromBool(smtpEnabled);
  }
  ...
  public Boolean isSmtpEnabled() {
    return ZmBoolean.toBool(smtpEnabled);
  }
  ...
  public Boolean isSmtpAuthRequired() {
    return ZmBoolean.toBool(smtpAuthRequired);
  }
