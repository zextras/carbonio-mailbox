...
public class NewSearchFolderSpec {
  ...
  public static NewSearchFolderSpec forNameQueryAndFolder(
      String folderName, String searchQuery, String parentId) {
  ...
  @GraphQLInputField(
      ...
      description = "type of the new folder to be created")
