...
public class SingleDates implements RecurRuleBase, SingleDatesInterface {
  ...
  @GraphQLInputField(
      name = GqlConstants.DATE_TIME_VALUES,
      description = "Information on start date/time and end date/time or duration")
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("timezone", timezone).add("dtVals", dtVals);
  }
