...
public class MiniCalError {
   ...
   * @zm-api-field-description ServiceException error code - service.PERM_DENIED,
   *     mail.NO_SUCH_FOLDER, account.NO_SUCH_ACCOUNT, etc.
   */
   ...
   */
  @XmlValue private String errorMessage;
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("id", id).add("code", code).add("errorMessage", errorMessage);
  }
