...
public class DispositionAndText {
   ...
   * @zm-api-field-description Disposition. Sections of text that are identical to both versions are
   *     indicated with <b>disp="common"</b>. For each conflict the chunk will show
   *     <b>disp="first"</b> or <b>disp="second"</b>
   */
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("disposition", disposition).add("text", text);
  }
