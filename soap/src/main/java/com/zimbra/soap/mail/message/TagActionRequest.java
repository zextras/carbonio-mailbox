...
public class TagActionRequest {
  ...
  /**
   * @zm-api-field-description Specify action to perform. <br>
   *     Caller must supply one of <b>"id"</b> or <b>"tn"</b> <br>
   *     Supported operations: <b>"read|!read|color|delete|rename|update|retentionpolicy"</b> <br>
