...
public class BrowseData {
   ...
   * @zm-api-field-description Set for domains. Indicates whether or not the domain was from the
   *     "From", "To", or "Cc" header. Valid flags are always one of: "f", "t", "ft", "c", "fc",
   *     "tc", "ftc"
   */
   ...
   *     <p>for objects: object type (url, etc)
   *     <p>for domains: domains (stanford.edu, etc)
   */
  @XmlValue private final String data;
  ...
  public String getBrowseDomainHeader() {
    return browseDomainHeader;
  }
