 ...
 * @zm-api-command-description Record that an IMAP client has seen all the messages in this folder
 *     as they are at this time. This is used to determine which messages are considered by IMAP to
 *     be RECENT. <br>
