...
public class PurgeRevisionSpec {
   ...
   * @zm-api-field-description When set, the server will purge all the old revisions inclusive of
   *     the revision specified in the request.
   */
  @XmlAttribute(
      name = MailConstants.A_INCLUDE_OLDER_REVISIONS /* includeOlderRevisions */,
      required = false)
  ...
  public Boolean getIncludeOlderRevisions() {
    return ZmBoolean.toBool(includeOlderRevisions);
  }
