...
public class DocumentActionGrant {
   ...
   * @zm-api-field-description (Optional) Time when this grant expires in milliseconds since the
   *     Epoch
   */
  ...
  public static DocumentActionGrant createForRightsGrantTypeAndExpiry(
      String rights, String grantType, Long expiry) {
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("rights", rights).add("grantType", grantType).add("expiry", expiry);
  }
