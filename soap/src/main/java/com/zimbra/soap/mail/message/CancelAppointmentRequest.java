 ...
 * @zm-api-command-description Cancel appointment <br>
 *     NOTE: If canceling an exception, the original instance (ie the one the exception was
 *     "excepting") WILL NOT be restored when you cancel this exception. <br>
 *     <br>
 *     if <b>&lt;inst></b> is set, then this cancels just the specified instance or range of
 *     instances, otherwise it cancels the entire appointment. If <b>&lt;inst></b> is not set, then
 *     id MUST refer to the default invite for the appointment.
 */
