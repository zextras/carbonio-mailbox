...
/**
 * @zm-api-command-deprecation-info Note: This API is deprecated Use <b>&lt;SearchRequest></b> with
 *     the <b>calExpandInstStart</b> and <b>calExpandInstEnd</b> parameters
...
public class GetApptSummariesRequest {
   ...
   * @zm-api-field-description Folder ID. Optional folder to constrain requests to; otherwise,
   *     searches all folders but trash and spam
   */
