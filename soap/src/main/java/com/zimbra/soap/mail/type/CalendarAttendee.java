...
@GraphQLType(
    name = GqlConstants.CLASS_CALENDAR_ATTENDEE,
...
public class CalendarAttendee implements CalendarAttendeeInterface {
   ...
   * @zm-api-field-description URL - has same value as <b>{email-address}</b>. <br>
   ...
   * @zm-api-field-description iCalendar DIR - Reference to a directory entry associated with the
   *     calendar user. the property.
   */
  ...
  public static CalendarAttendee createForAddressDisplaynameRolePartstatRsvp(
      String attendeeEmail, String attendeeName, String role, String partstat, Boolean rsvp) {
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.DISPLAY_NAME,
      description = "Friendly name - CN in iCalendar")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.LANGUAGE,
      description = "iCalendar LANGUAGE - As defined in RFC5646 * (e.g. \"en-US\")")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.CALENDAR_USER_TYPE,
      description = "iCalendar CUTYPE (Calendar user type)")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.PARTICIPATION_STATUS,
      description =
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.MEMBER,
      description = "iCalendar MEMBER - The group or list membership of the calendar user")
  ...
  public static List<CalendarAttendeeInterface> toInterfaces(Iterable<CalendarAttendee> params) {
    if (params == null) return null;
