...
public class InvitationInfo extends InviteComponent {
   ...
   * @zm-api-field-description RAW RFC822 MESSAGE (XML-encoded) <b>MUST CONTAIN A text/calendar
   *     PART</b>
   */
  ...
  @GraphQLInputField(
      name = GqlConstants.CONTENT,
      description = "RAW RFC822 MESSAGE (XML-encoded) MUST CONTAIN A text/calendar PART")
  public void setContent(RawInvite content) {
