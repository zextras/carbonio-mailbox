 ...
 * @zm-api-command-description Get item <br>
 *     A successful GetItemResponse will contain a single element appropriate for the type of the
 *     requested item if there is no matching item, a fault containing the code mail.NO_SUCH_ITEM is
 *     returned
