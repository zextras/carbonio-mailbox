...
public class DurationInfo implements DurationInfoInterface {
   ...
   * @zm-api-field-description Weeks component of the duration <br>
   *     <b>Special note: if WEEKS are specified, NO OTHER OFFSET MAY BE SPECIFIED (weeks must be
   *     alone, per RFC2445)</b>
   */
   ...
   * @zm-api-field-description Specifies whether the alarm is related to the start of end. <br>
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.IS_NEGATIVE,
      description = "Denotes whether the donation is negative")
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.RELATED,
      description =
          "Specifies whether the alarm is related to the start or end\n" + "* START\n " + "* END")
  ...
  public Boolean getDurationNegative() {
    return ZmBoolean.toBool(durationNegative);
  }
