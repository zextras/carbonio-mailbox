...
@GraphQLType(
    name = GqlConstants.CLASS_NEW_CONTACT_GROUP_MEMBER,
    description = "Input for creating a new contact group member")
public class NewContactGroupMember {
  ...
  public void setType(@GraphQLNonNull String type) {
    this.type = type;
  }
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("type", type).add("value", value);
  }
