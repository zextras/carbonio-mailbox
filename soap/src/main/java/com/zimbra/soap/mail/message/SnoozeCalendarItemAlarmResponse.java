...
public class SnoozeCalendarItemAlarmResponse {
  ...
  /**
   * @zm-api-field-description Updated alarm information so the client knows when to trigger the
   *     next alarm
   */
  @XmlElements({
    @XmlElement(
  ...
  public SnoozeCalendarItemAlarmResponse addUpdatedAlarm(UpdatedAlarmInfo updatedAlarm) {
