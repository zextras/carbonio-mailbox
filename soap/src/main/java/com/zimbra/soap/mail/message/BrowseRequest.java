 ...
 * @zm-api-command-description Browse <br>
 *     EXAMPLE:
 *     <pre>
...
public class BrowseRequest {
   ...
   * @zm-api-field-description Browse by setting - <b>domains|attachments|objects</b> <br>
   *     where <b>objects</b> means objects in message body content recognized by Zimlets via
   ...
   * @zm-api-field-description Regex string. Return only those results which match the specified
   *     regular expression
   */
   ...
   *     <b>{max-entries}</b> results exist, the server will return the first {max-entries}, sorted
   *     by frequency
   */
