 ...
 * @zm-api-command-description Modify Contact <br>
 *     When modifying tags, all specified tags are set and all others are unset. If tn="{tag-names}"
 *     is NOT specified then any existing tags will remain set.
 */
...
public class ModifyContactRequest {
   ...
   * @zm-api-field-description If set, all attrs and group members in the specified contact are
   *     replaced with specified attrs and group members, otherwise the attrs and group members are
   *     merged with the existing contact. Unset by default.
   */
   ...
   * @zm-api-field-description If unset, the returned <b>&lt;cn></b> is just a placeholder
   *     containing the contact ID (i.e. <b>&lt;cn id="{id}"/></b>). <b>{verbose}</b> is set by
   *     default.
   */
  ...
  public void setReplace(Boolean replace) {
    this.replace = ZmBoolean.fromBool(replace);
  }

  public void setVerbose(Boolean verbose) {
    this.verbose = ZmBoolean.fromBool(verbose);
  }

  public Boolean getReplace() {
    return ZmBoolean.toBool(replace);
  }

  public Boolean getVerbose() {
    return ZmBoolean.toBool(verbose);
  }
