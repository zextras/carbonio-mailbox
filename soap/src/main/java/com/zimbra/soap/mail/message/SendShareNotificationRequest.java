 ...
 * @zm-api-command-description Send share notification <br>
 *     The client can list the recipient email addresses for the share, along with the itemId of the
 *     item being shared.
 */
...
public class SendShareNotificationRequest {
   ...
   * @zm-api-field-description Set to "revoke" if it is a grant revoke notification. It is set to
   *     "expire" by the system to send notification for a grant expiry.
   */
  ...
  public static SendShareNotificationRequest create(
      Id id, Action action, String notes, List<EmailAddrInfo> emailAddresses) {
  ...
  public static SendShareNotificationRequest create(
      Integer id, Action action, String notes, List<EmailAddrInfo> emailAddresses) {
    SendShareNotificationRequest req = new SendShareNotificationRequest();
  ...
  public static enum Action {
    @GraphQLEnumValue(description = "edit share")
    edit,
    @GraphQLEnumValue(description = "revoke share")
    revoke,
    @GraphQLEnumValue(description = "share expired")
    expire;
