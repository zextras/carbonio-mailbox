...
public class MailCustomMetadata extends MailKeyValuePairs implements CustomMetadataInterface {
   ...
   * @zm-api-field-description Section. <br>
   *     Normally present. If absent this indicates that CustomMetadata info is present but there
   *     are no sections to report on.
   */
