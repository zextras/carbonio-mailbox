...
public class ConversationSpec {
   ...
   * @zm-api-field-description if value is "1" or "all" the full expanded message structure is
   *     inlined for the first (or for all) messages in the conversation. <br>
  ...
  /**
   * @zm-api-field-description Requested headers. if <b>&lt;header></b>s are requested, any matching
   *     headers are inlined into the response (not available when <b>raw</b> is set)
   */
