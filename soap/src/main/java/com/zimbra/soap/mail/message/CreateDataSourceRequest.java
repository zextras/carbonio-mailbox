 ...
 * @zm-api-command-description Creates a data source that imports mail items into the specified
 *     folder, for example via the POP3 or IMAP protocols. Only one data source is allowed per
 *     request.
 */
