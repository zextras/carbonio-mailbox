...
public class SharedReminderMount {
   ...
   * @zm-api-field-description Set to enable (or unset to disable) reminders for shared
   *     appointments/tasks
   */
  ...
  public Boolean getShowReminders() {
    return ZmBoolean.toBool(showReminders);
  }

  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("id", id).add("showReminders", showReminders);
  }
