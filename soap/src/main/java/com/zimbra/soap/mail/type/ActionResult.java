...
public class ActionResult {
  ...
  @GraphQLNonNull
  @GraphQLQuery(
      name = GqlConstants.IDS,
      description = "Comma-separated list of ids which have been successfully processed")
  ...
  @GraphQLQuery(
      name = GqlConstants.NON_EXISTENT_IDS,
      description = "Comma-separated list of non-existent ids (if requested)")
  ...
  public void setNonExistentIds(String ids) {
    this.nonExistentIds = ids;
  }
  ;
  ...
  @GraphQLQuery(
      name = GqlConstants.NON_EXISTENT_IDS,
      description = "Comma-separated list of non-existent ids (if requested)")
  public String getNonExistentIds() {
    return nonExistentIds;
  }
  ;

  public void setNewlyCreatedIds(String newlyCreatedIds) {
