...
public class PendingFolderModifications {
   ...
   */
  @XmlElement(
      name = MailConstants.E_MODIFIED_MSGS /* modMsgs */,
      required = false,
      type = ModifyItemNotification.class)
   ...
   */
  @XmlElement(
      name = MailConstants.E_MODIFIED_TAGS /* modTags */,
      required = false,
      type = ModifyTagNotification.class)
   ...
   */
  @XmlElement(
      name = MailConstants.E_MODIFIED_FOLDERS /* modFolders */,
      required = false,
      type = RenameFolderNotification.class)
