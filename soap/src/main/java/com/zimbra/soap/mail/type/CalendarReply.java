...
public class CalendarReply extends RecurIdInfo implements CalendarReplyInterface {
  ...
  public static CalendarReplyInterface createFromSeqDateAttendee(
      int seq, long date, String attendee) {
  ...
  public static Iterable<CalendarReply> fromInterfaces(Iterable<CalendarReplyInterface> params) {
  ...
  public static List<CalendarReplyInterface> toInterfaces(Iterable<CalendarReply> params) {
    if (params == null) return null;
