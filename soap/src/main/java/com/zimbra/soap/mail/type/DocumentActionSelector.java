...
public class DocumentActionSelector extends ActionSelector {
  ...
  public void setGrant(DocumentActionGrant grant) {
    this.grant = grant;
  }
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    ...
    return helper.add("zimbraId", zimbraId).add("grant", grant);
  }
