...
@GraphQLType(
    name = GqlConstants.CLASS_AUTO_COMPLETE_MATCH,
    description = "Contains auto-complete match information")
public class AutoCompleteMatch {
  ...
  @GraphQLQuery(
      name = GqlConstants.EMAIL,
      description = "Comma-separated list of email addresses in case of group")
  ...
  @GraphQLQuery(
      ...
      description = "The match type. (gal|contact|rankingTable)")
  ...
  @GraphQLQuery(
      ...
      description =
          "Denotes whether the user has the right to expand group members. Returned only when"
              + " requested")
  ...
  @GraphQLQuery(
      ...
      description = "String that should be displayed by the client")
