...
public class ContactInfo implements ContactInterface, SearchHit {
   ...
   * @zm-api-field-description Set if the user can (has right to) expand group members. Returned
   *     only if needExp is set in the request and only on group entries (type=group in attrs on a
   *     <b>&lt;cn></b>).
   */
   ...
   * @zm-api-field-description Folder ID. When creating a contact, this is the ID of the folder to
   ...
   * @zm-api-field-description Current "file as" string for display/sorting purposes; <b>cannot</b>
   *     be used to <b>set</b> the file-as value
   */
   ...
   * @zm-api-field-description If number of members on a GAL group is greater than the specified
   *     max, do not return any members for the entry. Instead, set "tooManyMembers.
   */
   ...
   * @zm-api-field-description Comma separated list of IDs of contact groups this contact is a
   *     member of. <br>
  ...
  public void setCanExpand(Boolean canExpand) {
    this.canExpand = ZmBoolean.fromBool(canExpand);
  }
  ...
  @GraphQLQuery(
      name = "memberOf",
      description = "Comma separated list of IDs of contact groups this contact is a member of")
  ...
  @Override
  @GraphQLQuery(
      name = GqlConstants.IS_EXPANDABLE,
      description = "Denotes whether user can expand group members")
  public Boolean getCanExpand() {
    return ZmBoolean.toBool(canExpand);
  }
  ...
  @Override
  @GraphQLQuery(
      name = GqlConstants.FILE_AS,
      description = "Current fileAs string for display/sorting purposes")
  ...
  @Override
  @GraphQLQuery(
      name = GqlConstants.IS_TOO_MANY_MEMBERS,
      description =
          "Denotes whether the number of entries on a GAL group exceeds the specified max")
  public Boolean getTooManyMembers() {
    return ZmBoolean.toBool(tooManyMembers);
  }
