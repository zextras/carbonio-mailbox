 ...
 * @zm-api-command-description Returns <b>{num}</b> number of revisions starting from
 *     <b>{version}</b> of the requested document. <b>{num}</b> defaults to 1. <b>{version}</b>
 *     defaults to the current version. <br>
 *     Documents that have multiple revisions have the flag "/", which indicates that the document
 *     is versioned.
 */
