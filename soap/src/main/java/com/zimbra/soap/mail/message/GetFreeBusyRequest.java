 ...
 * @zm-api-command-description Get Free/Busy information. <br>
 *     For accounts listed using uid,id or name attributes, f/b search will be done for all calendar
 *     folders. <br>
...
public class GetFreeBusyRequest {
   ...
   * @zm-api-field-description <b>DEPRECATED</b>. Comma-separated list of Zimbra IDs or emails. Each
   *     value can be a Ziimbra ID or an email.
   */
  @Deprecated
  ...
  /**
   * @zm-api-field-description To view free/busy for a single folders in particular accounts, use
   *     these.
   */
