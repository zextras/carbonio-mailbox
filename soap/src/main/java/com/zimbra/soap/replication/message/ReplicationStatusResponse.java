...
public class ReplicationStatusResponse {
   ...
   */
  @XmlAttribute(
      name = ReplicationConstants.A_REPLICATION_ENABLED /* replicationEnabled */,
      required = true)
  ...
  /**
   * @zm-api-field-description Master replication status. Only one of masterStatus and slaveStatus
   *     can be present
   */
  @ZimbraUniqueElement
  ...
  public boolean getReplicationEnabled() {
    return ZmBoolean.toBool(replicationEnabled);
  }
