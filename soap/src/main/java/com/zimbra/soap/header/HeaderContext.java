...
public class HeaderContext {
   ...
   * @zm-api-field-description Specify that no notifications are required. No particular value
   *     needed.
   *     <p>Note that a session will not return any notifications if &lt;nonotify/> was ever
   *     specified in a &lt;context> request element involving the session.)
   */
  @ZimbraUniqueElement
   ...
   * @zm-api-field-description Flag that item IDs in responses should not be qualified. No
   *     particular value needed.
   */
  @ZimbraUniqueElement
   ...
   *     <p>format something like: {request-ip(user-agent)[,...]}
   */
  @ZimbraUniqueElement
  ...
  public void setSession(HeaderSessionInfo session) {
    this.session = session;
  }

  @Deprecated
  public void setLegacySessionId(HeaderSessionInfo legacySessionId) {
  ...
  public void setAccount(HeaderAccountInfo account) {
    this.account = account;
  }

  public void setChange(HeaderChangeInfo change) {
    this.change = change;
  }
  ...
  public void setUserAgent(HeaderUserAgentInfo userAgent) {
  ...
  public void setFormat(HeaderFormatInfo format) {
    this.format = format;
  }

  public void setNotify(HeaderNotifyInfo notify) {
    this.notify = notify;
  }

  public void setNoNotify(String noNotify) {
    this.noNotify = noNotify;
  }

  public void setNoQualify(String noQualify) {
  ...
  public void setSoapRequestId(String soapRequestId) {
