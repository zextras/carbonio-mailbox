...
public class AdminWaitSetResponse implements WaitSetResp {
   ...
   * @zm-api-field-description Information on signaled accounts. <br>
   *     folder IDs are only provided if a list of <b>folderInterests</b> are active for the
   *     signalled account. It follows that they will never be provided if <b>allAccounts</b> is set
   *     because <b>folderInterests</b> can only be set via <b>add/update/remove</b> elements which
   *     are ignored when <b>allAccounts</b> is set. <br>
  ...
  public void setCanceled(Boolean canceled) {
    this.canceled = ZmBoolean.fromBool(canceled);
  }
  ...
  public Boolean getCanceled() {
    return ZmBoolean.toBool(canceled);
  }
