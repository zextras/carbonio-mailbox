...
public class DirPathInfo {
  ...
  public DirPathInfo(
      String path, boolean exists, boolean directory, boolean readable, boolean writable) {
    this.path = path;
  ...
  public boolean isExists() {
    return ZmBoolean.toBool(exists);
  }

  public boolean isDirectory() {
    return ZmBoolean.toBool(directory);
  }

  public boolean isReadable() {
    return ZmBoolean.toBool(readable);
  }

  public boolean isWritable() {
    return ZmBoolean.toBool(writable);
  }
}
