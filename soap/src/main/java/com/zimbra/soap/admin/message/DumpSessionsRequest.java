...
public class DumpSessionsRequest {
  ...
  public DumpSessionsRequest(Boolean includeAccounts, Boolean groupByAccount) {
  ...
  public Boolean getIncludeAccounts() {
    return ZmBoolean.toBool(includeAccounts);
  }

  public Boolean getGroupByAccount() {
    return ZmBoolean.toBool(groupByAccount);
  }
}
