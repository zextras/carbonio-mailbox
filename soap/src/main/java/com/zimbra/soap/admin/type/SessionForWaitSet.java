...
public class SessionForWaitSet {
   ...
   * @zm-api-field-description Interest types - Either <b>all</b> or some combination of the
   *     letters: <b>mcatd</b> Which stand for Message, Contact, Appointment, Task and Document
   *     respectively
   */
   ...
   * @zm-api-field-description Account ID stored in WaitSetAccount object. Differs from
   *     <b>account</b> value.
   */
  ...
  public String getAcctIdError() {
    return acctIdError;
  }

  public void setAcctIdError(String acctIdError) {
