 ...
 * @zm-api-command-description Returns all grants on the specified target entry, or all grants
 *     granted to the specified grantee entry. <br>
 *     The authenticated admin must have an effective "viewGrants" (TBD) system right on the
 *     specified target/grantee. <br>
 *     At least one of <b>&lt;target></b> or <b>&lt;grantee></b> must be specified. If both
 *     <b>&lt;target></b> and <b>&lt;grantee></b> are specified, only grants that are granted on the
 *     target to the grantee are returned.
 */
...
public class GetGrantsRequest {
  ...
  public GetGrantsRequest(EffectiveRightsTargetSelector target, GranteeSelector grantee) {
    this.target = target;
