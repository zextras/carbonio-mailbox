 ...
 * @zm-api-command-description Query WaitSet <br>
 *     This API dumps the internal state of all active waitsets. It is intended for debugging use
 *     only and should not be used for production uses. This API is not guaranteed to be stable
 *     between releases in any way and might be removed without warning. <br>
 *     <br>
 *     <ul>
 *       SomeAccountsWaitSet:
 *     </ul>
