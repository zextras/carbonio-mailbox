...
public class GenCSRRequest implements CertSubjectAttrs {
  ...
  // "1" means new
  /**
   * @zm-api-field-description If value is "1" then force to create a new CSR, the previous one will
   *     be overwrited
   */
   ...
   * @zm-api-field-description Used to add the Subject Alt Name extension in the certificate, so
   *     multiple hosts can be supported
   */
