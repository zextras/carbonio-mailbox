 ...
 * @zm-api-command-description Get Free/Busy provider information <br>
 *     If the optional element <b>&lt;provider/></b> is present in the request, the response
 *     contains the requested provider only. if no provider is supplied in the request, the response
