...
public class PrincipalSelector {
   ...
   * @zm-api-field-description The key used to identify the principal. Meaning determined by
   *     <b>{principal-selector-by}</b>
   */
  ...
  public void setBy(AutoProvPrincipalBy by) {
    this.by = by;
  }
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("by", by).add("key", key);
  }
