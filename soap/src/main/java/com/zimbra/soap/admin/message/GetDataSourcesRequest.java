 ...
 * @zm-api-command-description Returns all data sources defined for the given mailbox. For each data
 *     source, every attribute value is returned except password. <br>
