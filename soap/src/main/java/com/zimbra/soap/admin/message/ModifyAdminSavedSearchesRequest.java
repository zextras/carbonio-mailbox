 ...
 * @zm-api-command-description Modifies admin saved searches. <br>
 *     Returns the admin saved searches. <br>
 *     <br>
 *     If <b>{search-query}</b> is empty => delete the search if it exists <br>
 *     If <b>{search-name}</b> already exists => replace with new <b>{search-query}</b> <br>
