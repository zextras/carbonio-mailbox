 ...
 *     <p>Re-calculate the end times used for calendar items after changes to the recurrence
 *     expansion configuration. The current configured values can be determined from:<br>
