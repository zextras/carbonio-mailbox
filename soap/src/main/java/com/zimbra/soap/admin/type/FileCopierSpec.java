...
public class FileCopierSpec {
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_FC_OIO_COPY_BUFSIZE /* fcOIOCopyBufferSize */,
      required = false)
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_FC_ASYNC_QUEUE_CAPACITY /* fcAsyncQueueCapacity */,
      required = false)
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_FC_PARALLEL_WORKERS /* fcParallelWorkers */,
      required = false)
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_FC_PIPE_BUFFER_SIZE /* fcPipeBufferSize */,
      required = false)
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_FC_PIPE_READERS /* fcPipeReadersPerPipe */,
      required = false)
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_FC_PIPE_WRITERS /* fcPipeWritersPerPipe */,
      required = false)
  ...
  public void setPipes(Integer pipes) {
    this.pipes = pipes;
  }
  ...
  public void setPipeReaders(Integer pipeReaders) {
    this.pipeReaders = pipeReaders;
  }

  public void setPipeWriters(Integer pipeWriters) {
    this.pipeWriters = pipeWriters;
  }
