...
public class SearchCalendarResourcesResponse {
   ...
   * @zm-api-field-description Total number of calendar resources that matched search (not affected
   *     by limit/offset)
   */
  ...
  public SearchCalendarResourcesResponse(
      boolean more, long searchTotal, Iterable<CalendarResourceInfo> calResources) {
    setMore(more);
