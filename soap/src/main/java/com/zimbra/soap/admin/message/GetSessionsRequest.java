 ...
 * @zm-api-command-description Get Sessions <br>
...
public class GetSessionsRequest {
  ...
  /**
   * @zm-api-field-description Limit - the number of sessions to return per page (0 is default and
   *     means all)
   */
  ...
  /**
   * @zm-api-field-description Refresh. If <b>1 (true)</b>, ignore any cached results and start
   *     fresh.
   */
  ...
  public GetSessionsRequest(
      String type, GetSessionsSortBy sortBy, Long offset, Long limit, Boolean refresh) {
    this.type = type;
    this.sortBy = sortBy;
    this.offset = offset;
    this.limit = limit;
