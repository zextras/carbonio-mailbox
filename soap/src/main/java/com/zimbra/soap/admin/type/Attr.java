...
public class Attr extends KeyValuePair {
  ...
  public static List<Attr> mapToList(Map<String, ? extends Object> attrs) throws ServiceException {
  ...
  public static Map<String, Object> collectionToMap(
      Collection<Attr> attrs, boolean ignoreEmptyValues) throws ServiceException {
