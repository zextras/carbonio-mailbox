 ...
 * @zm-api-command-description Used to request a new auth token that is valid for the specified
 *     account. The id of the auth token will be the id of the target account, and the requesting
 *     admin's id will be stored in the auth token for auditing purposes.
 */
...
public class DelegateAuthRequest {
   ...
   * @zm-api-field-description Lifetime in seconds of the newly-created authtoken. defaults to 1
   *     hour. Can't be longer then <b>zimbraAuthTokenLifetime</b>.
   */
