...
public class DeployZimletRequest {
  ...
  private DeployZimletRequest() {
    this((String) null, (Boolean) null, (Boolean) null, (AttachmentIdAttrib) null);
  }

  public DeployZimletRequest(
      String action, Boolean flushCache, Boolean synchronous, AttachmentIdAttrib content) {
    this.action = action;
  ...
  public Boolean getFlushCache() {
    return ZmBoolean.toBool(flushCache);
  }

  public Boolean getSynchronous() {
    return ZmBoolean.toBool(synchronous);
  }
