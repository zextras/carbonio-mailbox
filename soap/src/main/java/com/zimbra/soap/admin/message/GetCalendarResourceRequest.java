 ...
 * @zm-api-command-description Get a calendar resource <b>Access</b>: domain admin sufficient
 */
...
public class GetCalendarResourceRequest extends AttributeSelectorImpl {
  ...
  public GetCalendarResourceRequest(CalendarResourceSelector calResource) {
    this(calResource, (Boolean) null, (Iterable<String>) null);
  }

  public GetCalendarResourceRequest(CalendarResourceSelector calResource, Boolean applyCos) {
    this(calResource, applyCos, (Iterable<String>) null);
  }

  public GetCalendarResourceRequest(
      CalendarResourceSelector calResource, Boolean applyCos, Iterable<String> attrs) {
    super(attrs);
