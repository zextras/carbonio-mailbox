 ...
 * @zm-api-command-description Create account <br>
 *     Notes:
 *     <ul>
...
public class CreateAccountRequest extends AdminAttrsImpl {
   ...
   * @zm-api-field-description New account's name <br>
  ...
  public CreateAccountRequest(String name, String password, Map<String, ? extends Object> attrs)
