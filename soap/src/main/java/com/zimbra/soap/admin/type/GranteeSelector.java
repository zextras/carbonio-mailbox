...
public class GranteeSelector {
   ...
   * @zm-api-field-description Password for guest grantee or the access key for key grantee <b>For
   *     user right only</b>
   */
   ...
   * @zm-api-field-description For <b>GetGrantsRequest</b>, selects whether to include grants
   *     granted to groups the specified grantee belongs to. Default is <b>1 (true)</b>
   */
   ...
   * @zm-api-field-description The key used to identify the grantee. Meaning determined by
   *     <b>{grantee-selector-by}</b>
   */
