 ...
 * @zm-api-command-description Get attributes related to an account <br>
 *     <b>{request-attrs}</b> - comma-seperated list of attrs to return <br>
 *     <br>
...
public class GetAccountRequest extends AttributeSelectorImpl {
  ...
  public GetAccountRequest(AccountSelector account, Boolean applyCos, Iterable<String> attrs) {
    super(attrs);
