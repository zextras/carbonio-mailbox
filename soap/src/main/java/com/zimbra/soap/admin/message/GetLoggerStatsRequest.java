 ...
 * @zm-api-command-description Query to retrieve Logger statistics in ZCS <br>
 *     Use cases:
 *     <ul>
 *       <li>No elements specified <br>
 *           result: a listing of reporting host names
 *       <li>hostname specified <br>
 *           result: a listing of stat groups for the specified host
 *       <li>hostname and stats specified, text content of stats non-empty <br>
 *           result: a listing of columns for the given host and group
 *       <li>hostname and stats specified, text content empty, startTime/endTime optional <br>
 *           result: all of the statistics for the given host/group are returned, if start and end
 *           are specified, limit/expand the timerange to the given setting. if limit=true is
 *           specified, attempt to reduce result set to under 500 records
 *     </ul>
 */
...
public class GetLoggerStatsRequest {
  ...
  public GetLoggerStatsRequest(
      HostName hostName, StatsSpec stats, TimeAttr startTime, TimeAttr endTime) {
