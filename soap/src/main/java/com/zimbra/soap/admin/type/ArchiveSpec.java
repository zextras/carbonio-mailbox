...
public class ArchiveSpec extends AdminAttrsImpl {
   ...
   * @zm-api-field-description for <b>&lt;EnableArchiveRequest></b>, Archive account is created by
   *     default based on name templates. You can suppress this by setting this flag to <b>0
   *     (false)</b>. This is useful if you are going to use a third party system to do the
   ...
   * @zm-api-field-description Archive account name. If not specified, archive account name is
   *     computed based on name templates.
   */
   ...
   * @zm-api-field-description Archive account password - <b>Recommended that password not be
   *     specified so only admins can login</b>
   */
  ...
  public Boolean getCreate() {
    return ZmBoolean.toBool(create);
  }
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    ...
    return helper.add("create", create).add("name", name).add("cos", cos).add("password", password);
  }
