 ...
 * @zm-api-command-description Count number of accounts by cos in a domain, <br>
 *     Note, it doesn't include any account with zimbraIsSystemResource=TRUE, nor does it include
 *     any calendar resources. <br>
 *     e.g.
 *     <pre>
