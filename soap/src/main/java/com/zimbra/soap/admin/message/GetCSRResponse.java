...
public class GetCSRResponse {
   ...
   * @zm-api-field-description Flag whether CSR exists or not - <b>"1"</b> means true, <b>"0"</b>
   *     means false.
   */
   ...
   * @zm-api-field-description Flag whether CSR is commercial or not - <b>"1"</b> means true,
   *     <b>"0"</b> means false. <br>
  ...
  public void setCsrExists(String csrExists) {
    this.csrExists = csrExists;
  }
  ...
  public void setCsubjectDSN(String csubjectDSN) {
    CsubjectDSN = csubjectDSN;
  }
  ...
  public void setSTsubjectDSN(String sTsubjectDSN) {
    STsubjectDSN = sTsubjectDSN;
  }
  ...
  public void setLsubjectDSN(String lsubjectDSN) {
    LsubjectDSN = lsubjectDSN;
  }
  ...
  public void setOsubjectDSN(String osubjectDSN) {
    OsubjectDSN = osubjectDSN;
  }
  ...
  public void setOUsubjectDSN(String oUsubjectDSN) {
    OUsubjectDSN = oUsubjectDSN;
  }
  ...
  public void setCNsubjectDSN(String cNsubjectDSN) {
    CNsubjectDSN = cNsubjectDSN;
  }
