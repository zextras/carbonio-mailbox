...
public class RestoreSpec {
   ...
   * @zm-api-field-description whether to include or exclude searchIndex. Valid values
   *     <b>include|exclude</b>
   */
  ...
  /**
   * @zm-api-field-tag include|exclude
   * @zm-api-field-description whether to include or exclude blobs. Valid values
   *     <b>include|exclude</b>
   */
  ...
  /**
   * @zm-api-field-tag include|exclude
   * @zm-api-field-description whether to include or exclude secondary blobs. Valid values
   *     <b>include|exclude</b> <br>
   ...
   * @zm-api-field-description when includeIncrementals is set, any incremental backups from the
   *     last full backup are also restored. Default to <b>1 (true)</b>
   */
  @XmlAttribute(
      name = BackupConstants.A_INCLUDEINCREMENTALS /* includeIncrementals */,
      required = false)
   ...
   * @zm-api-field-description Used to produce new account names if the name is reused or a new
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_RESTORE_TO_REDO_SEQ /* restoreToRedoSeq */,
      required = false)
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_RESTORE_TO_INCR_LABEL /* restoreToIncrLabel */,
      required = false)
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_IGNORE_REDO_ERRORS /* ignoreRedoErrors */,
      required = false)
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_SKIP_DELETED_ACCT /* skipDeletedAccounts */,
      required = false)
  ...
  public void setSysData(Boolean sysData) {
    this.sysData = ZmBoolean.fromBool(sysData);
  }
  ...
  public Boolean getSysData() {
    return ZmBoolean.toBool(sysData);
  }

  public Boolean getIncludeIncrementals() {
    return ZmBoolean.toBool(includeIncrementals);
  }

  public Boolean getReplayCurrentRedoLogs() {
    return ZmBoolean.toBool(replayCurrentRedoLogs);
  }

  public Boolean getContinueOnError() {
    return ZmBoolean.toBool(continueOnError);
  }
  ...
  public Boolean getIgnoreRedoErrors() {
    return ZmBoolean.toBool(ignoreRedoErrors);
  }

  public Boolean getSkipDeleteOps() {
    return ZmBoolean.toBool(skipDeleteOps);
  }

  public Boolean getSkipDeletedAccounts() {
    return ZmBoolean.toBool(skipDeletedAccounts);
  }
