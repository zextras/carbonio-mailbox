 ...
 *     <p>For accountOnUCService/cosOnUCService/domainOnUCService, UCService is required, and domain
 *     cannot be specified.
...
public class CountObjectsRequest {
  ...
  public CountObjectsRequest(
      CountObjectsType type, DomainSelector domain, UCServiceSelector ucService) {
    setType(type);
    addDomain(domain);
