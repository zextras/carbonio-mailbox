 ...
 * @zm-api-command-description Get a Distribution List <br>
...
public class GetDistributionListRequest extends AttributeSelectorImpl {
   ...
   * @zm-api-field-description Flag whether to sort in ascending order <b>1 (true)</b> is the
   *     default
   */
  ...
  public GetDistributionListRequest(
      DistributionListSelector dl, Integer limit, Integer offset, Boolean sortAscending) {
    setDl(dl);
    setLimit(limit);
    setOffset(offset);
