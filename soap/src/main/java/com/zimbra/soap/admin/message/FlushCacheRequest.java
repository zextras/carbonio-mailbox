 ...
 *     caches(source of data is LDAP): <b>account|cos|domain|server</b> <br>
 *     <br>
 ...
 *     <b>&lt;entry></b> is given, all entries of the type will be flushed from cache. <br>
 *     type can contain locale. E.g. type='locale'
 */
