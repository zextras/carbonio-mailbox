 ...
 *     <br>
 *     Directory scan caches(source of data is on local disk of the server): <b>skin|locale</b> LDAP
 *     caches(source of data is LDAP): <b>account|cos|domain|server|zimlet</b> <br>
 *     <br>
 *     For LDAP caches, one or more optional <b>&lt;entry></b> can be specified. <br>
 *     If <b>&lt;entry></b>(s) are specified, only the specified entries will be flushed. If no
 *     <b>&lt;entry></b> is given, all enties of the type will be flushed from cache. <br>
 *     type can contain a combination of skin, locale and zimlet. E.g. type='skin,locale,zimlet' or
 *     type='zimletskin'
 */
