...
public class ExportMailboxSelector {
   ...
   * @zm-api-field-description Account email address. <br>
   ...
   * @zm-api-field-description Hostname of target server. <br>
  ...
  public void setOverwrite(Boolean overwrite) {
    this.overwrite = ZmBoolean.fromBool(overwrite);
  }
  ...
  public Boolean getOverwrite() {
    return ZmBoolean.toBool(overwrite);
  }
