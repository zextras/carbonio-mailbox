 ...
 * @zm-api-command-description Moves blobs between volumes. Unlike <b>HsmRequest</b>, this request
 *     is synchronous, and reads parameters from the request attributes instead of
 *     <b>zimbraHsmPolicy</b>.
 */
...
public class MoveBlobsRequest {
   ...
   * @zm-api-field-description A comma-separated list of item types, or "all" for all types. See the
   *     spec for <b>&lt;SearchRequest></b> for details.
   */
  ...
  /**
   * @zm-api-field-description Limit for the total number of bytes of data to move. Blob move will
   *     abort if this threshold is exceeded.
   */
