...
public class CosInfoAttr extends Attr {
   ...
   * @zm-api-field-description Flags that the value of this attribute has been suppressed for
   *     permissions reasons
   */
  ...
  public void setCosAttr(Boolean isCosAttr) {
    this.cosAttr = ZmBoolean.fromBool(isCosAttr);
  }

  public Boolean getCosAttr() {
    return ZmBoolean.toBool(cosAttr);
  }

  public void setPermDenied(Boolean isPermDenied) {
    this.permDenied = ZmBoolean.fromBool(isPermDenied);
  }
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    ...
    return helper.add("cosAttr", cosAttr).add("permDenied", cosAttr);
  }
