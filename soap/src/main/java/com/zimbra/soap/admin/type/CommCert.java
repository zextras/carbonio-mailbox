...
public class CommCert {
  ...
  public void setCert(AidAndFilename cert) {
    this.cert = cert;
  }

  public void setRootCA(AidAndFilename rootCA) {
    this.rootCA = rootCA;
  }
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("cert", cert).add("rootCA", rootCA).add("intermediateCAs", intermediateCAs);
  }
