 ...
 * @zm-api-command-description Create Global Address List (GAL) Synchronisation account <br>
 *     Notes:
 *     <ul>
 ...
 *       <li>server is a required parameter and specifies the mailhost on which this account
 *           resides.
 *     </ul>
...
public class CreateGalSyncAccountRequest extends AdminAttrsImpl {
  ...
  public CreateGalSyncAccountRequest(
      String name,
      String domain,
      GalMode type,
