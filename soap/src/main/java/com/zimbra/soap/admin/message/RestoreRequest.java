 ...
 *     <ul>
 *       <li>When includeIncrementals is 1 (true), any incremental backups from the last full backup
 *           are also restored. Default to 1 (true).
 ...
 *       <li>prefix is used to produce new account names if the name is reused or a new account is
 *           to be created
 *     </ul>
 */
...
public class RestoreRequest {
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("restore", restore);
  }
