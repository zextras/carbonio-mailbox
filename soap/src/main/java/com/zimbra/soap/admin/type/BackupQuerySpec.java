...
public class BackupQuerySpec {
   ...
   * @zm-api-field-description Return backups whose start time is at or after this time. Defaults to
   *     beginning of time if not specified
   */
   ...
   * @zm-api-field-description Return backups whose end time is at or before this time. Defaults to
   *     end of time if not specified
   */
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_BACKUP_LIST_OFFSET /* backupListOffset */,
      required = false)
  private Integer backupListOffset;

  /**
   * @zm-api-field-tag backup-list-count
   * @zm-api-field-description Backup list count. Used in backup list pagination. Default = -1,
   *     meaning all
   */
   ...
   * @zm-api-field-description Use this to filter the account list by backup status. <br>
   *     Values: <b>NONE | ALL | COMPLETED | ERROR | NOTSTARTED | INPROGRESS</b> <br>
   *     Default: <b>NONE</b>
   */
  @XmlAttribute(
      name = BackupConstants.A_ACCOUNT_LIST_STATUS /* accountListStatus */,
      required = false)
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_ACCOUNT_LIST_OFFSET /* accountListOffset */,
      required = false)
  private Integer accountListOffset;

  /**
   * @zm-api-field-tag account-list-count
   * @zm-api-field-description Account list count. Used in account list pagination. Default = -1,
   *     meaning all
   */
  @XmlAttribute(
      name = BackupConstants.A_ACCOUNT_LIST_COUNT /* accountListCount */,
      required = false)
  ...
  public void setShowStats(Boolean showStats) {
    this.showStats = ZmBoolean.fromBool(showStats);
  }
  ...
  public Boolean getShowStats() {
    return ZmBoolean.toBool(showStats);
  }
