 ...
 * @zm-api-command-description Remove Distribution List Member <br>
 *     Unlike add, remove of a non-existent member causes an exception and no modification to the
 *     list. <br>
...
public class RemoveDistributionListMemberRequest {
   ...
   * @zm-api-field-description specify Accounts insteaf of members if you want to remove all
   *     addresses that belong to an account from the list
   */
  ...
  public RemoveDistributionListMemberRequest(
      String id, Collection<String> members, Collection<String> accounts) {
    setId(id);
    setMembers(members);
