...
public class CosInfo implements AdminObjectInterface {
  ...
  public static CosInfo createForIdNameAndAttrs(
      String id, String name, Collection<CosInfoAttr> attrs) {
    return new CosInfo(id, name, false, attrs);
  }

  public static CosInfo createDefaultCosForIdNameAndAttrs(
      String id, String name, Collection<CosInfoAttr> attrs) {
    return new CosInfo(id, name, true, attrs);
  }

  public static CosInfo createNonDefaultCosForIdNameAndAttrs(
      String id, String name, Collection<CosInfoAttr> attrs) {
    return new CosInfo(id, name, false, attrs);
  }
  ...
  public Boolean getIsDefaultCos() {
    return ZmBoolean.toBool(isDefaultCos);
  }
