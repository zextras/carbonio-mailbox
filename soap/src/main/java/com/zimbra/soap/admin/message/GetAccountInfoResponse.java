...
public class GetAccountInfoResponse {
   ...
   * </pre>
   *     Multiple URLs can be returned if both http and https (SSL) are enabled. If only one of the
   *     two is enabled, then only one URL will be returned.
   */
   ...
   * @zm-api-field-description URL for the Admin SOAP service <br>
