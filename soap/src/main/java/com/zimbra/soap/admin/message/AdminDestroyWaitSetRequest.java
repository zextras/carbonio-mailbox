 ...
 * @zm-api-command-description Use this to close out the waitset. Note that the server will
 *     automatically time out a wait set if there is no reference to it for (default of) 20 minutes.
