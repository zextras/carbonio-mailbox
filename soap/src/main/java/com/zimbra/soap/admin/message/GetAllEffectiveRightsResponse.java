...
public class GetAllEffectiveRightsResponse {
  ...
  public GetAllEffectiveRightsResponse setTargets(Collection<EffectiveRightsTarget> targets) {
    this.targets.clear();
    if (targets != null) {
  ...
  public GetAllEffectiveRightsResponse addTarget(EffectiveRightsTarget target) {
    targets.add(target);
    return this;
  }
