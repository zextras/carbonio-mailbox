...
public class ModifyAddressListRequest {
   ...
   * @param searchFilter
   */
  public ModifyAddressListRequest(
      String id, String name, String desc, GalSearchType type, EntrySearchFilterInfo searchFilter) {
    this.id = id;
    this.name = name;
    this.desc = desc;
  ...
  public void validateModifyAddressListRequest() throws ServiceException {
    if (StringUtil.isNullOrEmpty(id)) {
      throw ServiceException.INVALID_REQUEST("Modify address list requires an id", null);
    }
  ...
  public String toString() {
    return "ModifyAddressListRequest [type="
        + type
        + ", id="
        + id
        + ", name="
