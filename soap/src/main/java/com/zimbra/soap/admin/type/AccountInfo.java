...
public class AccountInfo extends AdminObjectInfo {
   ...
   * @zm-api-field-description Whether the account's <b>zimbraMailTranport</b> points to the
   *     designated protocol(lmtp) and server(home server of the account).
   */
  ...
  public Boolean getIsExternal() {
    return ZmBoolean.toBool(isExternal);
  }
}
