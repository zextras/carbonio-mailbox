...
public class BackupAccountQuerySpec {
   ...
   * @zm-api-field-description Backup type - <b>full|incremental</b>. Means both types if omitted or
   *     bogus value
   */
   ...
   * @zm-api-field-description Return backups whose start time is at or before this time. Defaults
   *     to end of time if not specified
   */
