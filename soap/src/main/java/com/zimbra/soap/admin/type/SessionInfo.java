...
public class SessionInfo {
   ...
   */
  @XmlAnyAttribute private Map<QName, Object> extraAttributes = Maps.newHashMap();

  /**
   * @zm-api-field-description Extra elements - possibly including an "imap" element
   */
  @XmlAnyElement private List<org.w3c.dom.Element> extraElements = Lists.newArrayList();
  ...
  public SessionInfo(
      String zimbraId, String name, String sessionId, long createdDate, long lastAccessedDate) {
  ...
  public Map<QName, Object> getExtraAttributes() {
