...
// soap-waitset.txt implies a lot of these attributes are directly unser QueryWaitSetResponse.  They
// aren't.
...
public class WaitSetInfo {
  ...
  private WaitSetInfo(
      String waitSetId, String owner, String defaultInterests, long lastAccessDate) {
  ...
  public static WaitSetInfo createForWaitSetIdOwnerInterestsLastAccessDate(
      String waitSetId, String owner, String defaultInterests, long lastAccessDate) {
  ...
  public void setCbSeqNo(String cbSeqNo) {
  ...
  public void setBufferedCommits(Iterable<BufferedCommitInfo> bufferedCommits) {
