...
public class EffectiveRightsInfo {
  ...
  public EffectiveRightsInfo(EffectiveAttrsInfo setAttrs, EffectiveAttrsInfo getAttrs) {
    this(null, setAttrs, getAttrs);
  }

  public EffectiveRightsInfo(
      Iterable<RightWithName> rights, EffectiveAttrsInfo setAttrs, EffectiveAttrsInfo getAttrs) {
    setRights(rights);
