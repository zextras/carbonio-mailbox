 ...
 * @zm-api-command-description Get Certificate <br>
 *     Currently, GetCertRequest/Response only handle 2 types "staged" and "all". May need to
...
public class GetCertRequest {
  ...
  /**
   * @zm-api-field-tag
   * @zm-api-field-description Required only when type is "staged". <br>
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("server", server).add("type", type).add("option", option);
  }
