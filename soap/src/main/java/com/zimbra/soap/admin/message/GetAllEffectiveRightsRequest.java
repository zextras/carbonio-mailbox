...
public class GetAllEffectiveRightsRequest {
  ...
  public GetAllEffectiveRightsRequest(
      GranteeSelector grantee, Boolean expandSetAttrs, Boolean expandGetAttrs) {
    setGrantee(grantee);
   ...
   * @zm-api-field-description Flags whether to include all attribute names if the right is meant
   *     for all attributes
   */
