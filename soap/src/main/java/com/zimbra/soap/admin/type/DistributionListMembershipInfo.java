...
public class DistributionListMembershipInfo {
   ...
   * @zm-api-field-description Present if the dl is a member of the returned list because they are
   *     either a direct or indirect member of another list that is a member of the returned list.
   *     For example, if a dl is a member of engineering@domain.com, and engineering@domain.com is a
   *     member of all@domain.com, then
   *     <pre>
