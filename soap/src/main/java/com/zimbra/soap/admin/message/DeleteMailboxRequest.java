 ...
 * @zm-api-command-description Delete a mailbox <br>
 *     The request includes the account ID (uuid) of the target mailbox on success, the response
 *     includes the mailbox ID (numeric) of the deleted mailbox the <b>&lt;mbox></b> element is left
 *     out of the response if no mailbox existed for that account. <br>
 *     Note: this request is by default proxied to the account's home server <br>
 *     <br>
