...
public class MailQueueAction {
  ...
  public enum QueueAction {
    ...
    public static QueueAction fromString(String s) throws ServiceException {
      try {
        return QueueAction.valueOf(s);
      } catch (IllegalArgumentException e) {
        throw ServiceException.INVALID_REQUEST(
            "unknown action : " + s + ", valid values: " + Arrays.asList(QueueAction.values()),
            null);
      }
    }
  }
  ...
  public enum QueueActionBy {
    ...
    public static QueueActionBy fromString(String s) throws ServiceException {
      try {
        return QueueActionBy.valueOf(s);
      } catch (IllegalArgumentException e) {
        throw ServiceException.INVALID_REQUEST(
            "unknown by : " + s + ", valid values: " + Arrays.asList(QueueActionBy.values()), null);
      }
    }
  }
   ...
   */
  @XmlElementRefs({@XmlElementRef(/* query */ type = QueueQuery.class)})
  @XmlMixed
  ...
  public MailQueueAction(QueueAction op, QueueActionBy by, String ids, QueueQuery query) {
    this.op = op;
    this.by = by;
  ...
  public String getIds() {
    ...
    if (by != null && (!by.equals(QueueActionBy.id))) return null;
  ...
  public QueueQuery getQuery() {
    if (content == null) return null;
    if (by != null && (!by.equals(QueueActionBy.query))) return null;
    for (Object obj : content) {
      if (obj instanceof QueueQuery) return (QueueQuery) obj;
    }
    return null;
  }
