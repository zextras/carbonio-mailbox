 ...
 * @zm-api-command-description Create a system retention policy. <br>
 *     The system retention policy SOAP APIs allow the administrator to edit named system retention
 *     policies that users can apply to folders and tags.
 */
