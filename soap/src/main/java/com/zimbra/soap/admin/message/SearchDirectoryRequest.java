 ...
 * @zm-api-command-description Search directory <br>
 *     <b>Access</b>: domain admin sufficient (though a domain admin can't specify "domains" as a
 *     type)
 */
...
public class SearchDirectoryRequest extends AttributeSelectorImpl {
  ...
  /**
   * @zm-api-field-description whether or not to apply the global config attrs to account. specify
   *     <b>0 (false)</b> if only requesting attrs that aren't inherited from global config
   */
   ...
   * @zm-api-field-description Comma-separated list of types to return. Legal values are: <br>
   *     <b>accounts|distributionlists|aliases|resources|domains|coses</b> <br>
   *     (default is accounts)
   */
  ...
  public Boolean getCountOnly() {
    return ZmBoolean.toBool(isCountOnly);
  }
}
