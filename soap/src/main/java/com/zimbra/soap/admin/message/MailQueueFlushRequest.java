 ...
 * @zm-api-command-description Command to invoke postqueue -f. All queues cached in the server are
 *     stale after invoking this because this is a global operation to all the queues in a given
 *     server.
 */
