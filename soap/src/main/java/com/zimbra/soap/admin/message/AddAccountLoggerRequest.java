 ...
 *     Adds a custom logger for the given account and log category. The logger stays in effect only
 *     during the lifetime of the current server instance. If the request is sent to a server other
 *     than the one that the account resides on, it is proxied to the correct server.
 *     <p>If the category is "all", adds a custom logger for every category or the given user.
 */
...
public class AddAccountLoggerRequest {
  ...
  public static AddAccountLoggerRequest createForAccountAndLogger(
