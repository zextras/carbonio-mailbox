 ...
 * @zm-api-command-description Get a configuration for SMIME public key lookup via external LDAP on
 *     a domain or globalconfig <br>
 *     Notes: if <b>&lt;domain></b> is present, get the config on the domain, otherwise get the
 *     config on globalconfig.
...
public class GetSMIMEConfigRequest {
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("config", config).add("domain", domain);
  }
