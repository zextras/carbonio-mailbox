 ...
 * @zm-api-command-description Search Auto Prov Directory <br>
 *     Only one of <b>&lt;name></b> or <b>&lt;query></b> can be provided. If neither is provided,
 *     the configured search filter for auto provision will be used.
 */
...
public class SearchAutoProvDirectoryRequest extends AttributeSelectorImpl {
   ...
   * @zm-api-field-description Name of attribute for the key. Value of the key attribute will appear
   *     in the <b>&lt;key></b> element in the response. It is recommended to pick a key attribute
   *     that is single-valued and can unique identify an entry in the external auto provision
   *     directory. If the key attribute contains multiple values then multiple <b>&lt;key></b>
   *     elements will appear in the response. <br>
  ...
  /**
   * @zm-api-field-description Name to fill the auto provisioning search template configured on the
   *     domain
   */
   ...
   * @zm-api-field-description Maximum results that the backend will attempt to fetch from the
   *     directory before returning an account.TOO_MANY_SEARCH_RESULTS error.
   */
   ...
   * @zm-api-field-description The number of accounts to return per page (0 is default and means
   *     all)
   */
  ...
  /**
   * @zm-api-field-description Refresh - whether to always re-search in LDAP even when cached
   *     entries are available. <b>0 (false)</b> is the default.
   */
  @XmlAttribute(name = AdminConstants.A_REFRESH, required = false)
  private ZmBoolean refresh;

  /**
   * @zm-api-field-description Domain selector for the domain name to limit the search to (do not
   *     use if searching for domains)
   */
  ...
  public static SearchAutoProvDirectoryRequest createForKeyAttrAndDomain(
      String keyAttr, DomainSelector domain) {
