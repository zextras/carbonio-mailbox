 ...
 * @zm-api-command-description Check Global Addressbook Configuration <br>
 *     <pre>
 ...
 *       <li>zimbraGalSyncLdapXXX attributes are for GAL sync. They are ignored if &lt;action> is
 *           not sync. <br>
 *           For GAL sync, if a zimbraGalSyncLdapXXX attribute is not set, server will fallback to
 *           the corresponding zimbraGalLdapXXX attribute.
 *     </ul>
 */
...
public class CheckGalConfigRequest extends AdminAttrsImpl {
  ...
  public void setQuery(LimitedQuery query) {
    this.query = query;
  }
