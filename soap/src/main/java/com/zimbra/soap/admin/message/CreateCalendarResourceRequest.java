 ...
 * @zm-api-command-description Create a calendar resource <br>
 *     Notes:
 *     <ul>
 *       <li>A calendar resource is a special type of Account. The Create, Delete, Modify, Rename,
 *           Get, GetAll, and Search operations are very similar to those of Account.
...
public class CreateCalendarResourceRequest extends AdminAttrsImpl {
   ...
   * @zm-api-field-description Name or calendar resource <br>
  ...
  public CreateCalendarResourceRequest(String name, String password, Collection<Attr> attrs) {
    setName(name);
