...
public class MoveMailboxInfo {
   ...
   * @zm-api-field-description Option to include/exclude blobs in a move -
   *     <b>include|exclude|config</b> <br>
   *     Default value is "config", to use the configured value. "include" or "exclude" overrides
   *     the configuration
   */
  ...
  /**
   * @zm-api-field-tag include|exclude|config
   * @zm-api-field-description Option to include/exclude secondary blobs in a move -
   *     <b>include|exclude|config</b> <br>
   *     Default value is "config", to use the configured value. "include" or "exclude" overrides
  ...
  /**
   * @zm-api-field-tag include|exclude|config
   * @zm-api-field-description Option to include/exclude searchIndex in a move -
   *     <b>include|exclude|config</b> <br>
   *     Default value is "config", to use the configured value. "include" or "exclude" overrides
   *     the configuration
   */
   ...
   */
  @XmlAttribute(
      name = BackupConstants.A_SYNC_FINISH_THRESHOLD /* syncFinishThreshold */,
      required = false)
  private Long syncFinishThreshold;

  /**
   * @zm-api-field-tag sync
   * @zm-api-field-description If set, run synchronously; command doesn't return until move is
   *     finished
   */
   ...
   * @zm-api-field-description If set, do not lockout the remote mailbox. Used for backward
   *     compatibility when moving from legacy server versions
   */
   ...
   * @zm-api-field-description If set, do not automatically purge route info from memcache. Provided
   *     for special cases where memcache/proxy is handled outside the move process
   */
  ...
  public static MoveMailboxInfo createForNameTargetAndSource(
  ...
  public void setMaxSyncs(Integer maxSyncs) {
    this.maxSyncs = maxSyncs;
  }

  public void setSyncFinishThreshold(Long syncFinishThreshold) {
    this.syncFinishThreshold = syncFinishThreshold;
  }
  ...
  public void setSkipRemoteLockout(Boolean skipRemoteLockout) {
    this.skipRemoteLockout = ZmBoolean.fromBool(skipRemoteLockout);
  }

  public void setSkipMemcachePurge(Boolean skipMemcachePurge) {
    this.skipMemcachePurge = ZmBoolean.fromBool(skipMemcachePurge);
  }
  ...
  public Boolean getSkipRemoteLockout() {
    return ZmBoolean.toBool(skipRemoteLockout);
  }

  public Boolean getSkipMemcachePurge() {
    return ZmBoolean.toBool(skipMemcachePurge);
  }
