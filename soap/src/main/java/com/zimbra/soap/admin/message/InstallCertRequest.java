...
@XmlType(
    propOrder = {"commCert", "validationDays", "digest", "subject", "subjectAltNames", "keySize"})
public class InstallCertRequest {
  ...
  /**
   * @zm-api-field-description Certificate type <br>
   ...
   * @zm-api-field-description Validation days: required. Number of the validation days of the self
   *     signed certificate
   */
  ...
  /**
   * @zm-api-field-tag
   * @zm-api-field-description Key length of the self-signed certificate. Default value: 2048.
   *     Minimum allowed value: 2048
   */
   ...
   * @zm-api-field-description Flag whether or not to delete temporary files. This should be used
  ...
  public void setSubject(CSRSubject subject) {
