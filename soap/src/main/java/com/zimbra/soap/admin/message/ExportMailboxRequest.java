 ...
 * @zm-api-command-description Export Mailbox (OLD mailbox move mechanism) <br>
 *     This request blocks until mailbox move is complete and can take a long time. Client side
 *     should set timeout accordingly. <br>
 *     Note: This is the old mailbox move request. The new mailbox move request is
 *     <b>MoveMailboxRequest</b>.
 */
