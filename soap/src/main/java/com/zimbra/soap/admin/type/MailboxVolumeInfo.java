...
public class MailboxVolumeInfo {
  ...
  public static MailboxVolumeInfo createForIdTypeAndRootpath(
      short id, short volumeType, String volumeRootpath) {
  ...
  public void setVolumeRootpath(String volumeRootpath) {
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("id", id).add("volumeType", volumeType).add("volumeRootpath", volumeRootpath);
  }
