...
public class BackupQueryInfo {
  ...
  /**
   * @zm-api-field-description Information about current accounts. <b>&lt;currentAccounts></b> is
   *     returned only for a live backup.
   */
  ...
  /**
   * @zm-api-field-description Any errors that are not account-specific; account-specific errors are
   *     returned in <b>&lt;account></b>.
   */
  ...
  public void setMinRedoSeq(Long minRedoSeq) {
    this.minRedoSeq = minRedoSeq;
  }

  public void setMaxRedoSeq(Long maxRedoSeq) {
    this.maxRedoSeq = maxRedoSeq;
  }

  public void setLive(Boolean live) {
    this.live = ZmBoolean.fromBool(live);
  }
