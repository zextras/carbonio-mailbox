...
public class InviteInfo implements InviteInfoInterface {
  ...
  @Override
  public void setInviteComponentInterface(InviteComponentInterface inviteComponent) {
    setInviteComponent((InviteComponent) inviteComponent);
  }

  @Override
  public void setCalendarReplyInterfaces(Iterable<CalendarReplyInterface> calendarReplies) {
