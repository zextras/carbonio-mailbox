 ...
 * @zm-api-command-description Search for Calendar Resources <b>Access</b>: domain admin sufficient
 */
...
public class SearchCalendarResourcesRequest extends AttributeSelectorImpl {
   ...
   * @zm-api-field-description The maximum number of calendar resources to return (0 is default and
   *     means all)
   */
   ...
   * @zm-api-field-description applyCos - Flag whether or not to apply the COS policy to calendar
   *     resource. Specify <b>0 (false)</b> if only requesting attrs that aren't inherited from COS
   */
