 ...
 * @zm-api-request-description Only one of <b>attrs</b> or <b>entryTypes</b> can be specified. <br>
 *     If both are specified, INVALID_REQUEST will be thrown. <br>
...
public class GetAttributeInfoRequest {
   ...
   * @zm-api-field-description Comma separated list of entry types. Attributes on the specified
   *     entry types will be returned. <br>
   *     valid entry types:
   *     <pre>
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("attrs", attrs).add("entryTypes", entryTypes);
  }
