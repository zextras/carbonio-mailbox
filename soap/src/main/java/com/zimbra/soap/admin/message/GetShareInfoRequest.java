 ...
 * @zm-api-command-description Iterate through all folders of the owner's mailbox and return shares
 *     that match grantees specified by the <b>&lt;grantee></b> specifier. <br>
 *     e.g.
 *     <pre>
 *      &lt;GetShareInfoRequest>
