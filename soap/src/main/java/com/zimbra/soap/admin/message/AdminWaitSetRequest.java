 ...
 * @zm-api-command-description <b>AdminWaitSetRequest</b> optionally modifies the wait set and
 *     checks for any notifications. If block=1 and there are no notifications, then this API will
