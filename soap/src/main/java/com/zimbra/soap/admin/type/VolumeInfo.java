...
public final class VolumeInfo {
   ...
   * @zm-api-field-description Absolute path to root of volume, e.g. /opt/zextras/store
   */
   ...
   * @zm-api-field-description Long value that specifies the maximum uncompressed file size, in
   *     bytes, of blobs that will not be compressed (in other words blobs larger than this
   *     threshold are compressed)
   */
  @XmlAttribute(
      name = AdminConstants.A_VOLUME_COMPRESSION_THRESHOLD /* compressionThreshold */,
      required = false)
