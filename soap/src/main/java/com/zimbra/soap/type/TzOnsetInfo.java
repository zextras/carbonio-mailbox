...
@GraphQLType(
    name = GqlConstants.CLASS_TZ_ONSET_INFO,
    description =
        "Time/rule for transitioning from daylight time to standard time. Either specify week/wkday"
            + " combo, or mday.")
public class TzOnsetInfo {
  ...
  @GraphQLQuery(
      name = GqlConstants.WEEK,
      description = "Week number; 1=first, 2=second, 3=third, 4=fourth, -1=last")
  ...
  @GraphQLQuery(
      name = GqlConstants.DAY_OF_WEEK,
      description = "Day of week; 1=Sunday, 2=Monday, etc.")
  ...
  public void setMonth(@GraphQLNonNull Integer month) {
    this.month = month;
  }
  ...
  public void setHour(@GraphQLNonNull Integer hour) {
    this.hour = hour;
  }

  public void setMinute(@GraphQLNonNull Integer minute) {
    this.minute = minute;
  }

  public void setSecond(@GraphQLNonNull Integer second) {
    this.second = second;
  }
