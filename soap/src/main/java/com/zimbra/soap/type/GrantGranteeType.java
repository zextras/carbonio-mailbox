...
public enum GrantGranteeType {
  ...
  @GraphQLEnumValue(
      name = "pub",
      description = "access is granted to public. no authentication needed.")
  pub,
  ...
  @GraphQLEnumValue(
      name = "guest",
      description = "access is granted to a non-Zimbra email address and a password")
  guest,
  /** access is granted to a non-Zimbra email address and an accesskey */
  @GraphQLEnumValue(
      name = "key",
      description = "access is granted to a non-Zimbra email address and an accesskey")
  key;
    ...
    try {
      ...
      throw ServiceException.INVALID_REQUEST(
          "Invalid grantee type: "
              + s
              + ", valid values: "
              + Arrays.asList(GrantGranteeType.values()),
          null);
    }
  }
}
