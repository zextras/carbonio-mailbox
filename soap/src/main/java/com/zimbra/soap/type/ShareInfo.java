...
public class ShareInfo {
   ...
   */
  @XmlAttribute(
      name = AccountConstants.A_GRANTEE_DISPLAY_NAME /* granteeDisplayName */,
      required = true)
  private String granteeDisplayName;

  /**
   * @zm-api-field-tag mountpoint-id
   * @zm-api-field-description Returned if the share is already mounted. Contains the folder id of
   *     the mountpoint in the local mailbox.
   */
