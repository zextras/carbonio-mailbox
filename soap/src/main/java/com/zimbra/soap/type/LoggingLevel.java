...
public enum LoggingLevel {
  ...
  @XmlEnumValue("error")
  error(com.zimbra.common.util.Log.Level.error),
  @XmlEnumValue("warn")
  warn(com.zimbra.common.util.Log.Level.warn),
  @XmlEnumValue("info")
  info(com.zimbra.common.util.Log.Level.info),
  @XmlEnumValue("debug")
  debug(com.zimbra.common.util.Log.Level.debug),
  @XmlEnumValue("trace")
  trace(com.zimbra.common.util.Log.Level.trace);
  ...
  public static LoggingLevel fromString(String s) throws ServiceException {
    try {
      ...
      throw ServiceException.INVALID_REQUEST(
          "unknown Logging Level: " + s + ", valid values: " + Arrays.asList(LoggingLevel.values()),
          null);
    }
  }
}
