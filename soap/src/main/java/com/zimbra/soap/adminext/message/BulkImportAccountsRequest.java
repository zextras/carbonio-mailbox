...
public class BulkImportAccountsRequest extends AttrsImpl {
   ...
   * @zm-api-field-description Flags whether to generate passwords. Ttrue if "true" (case
   *     insensitive) else false - default value "false"
   */
   ...
   * @zm-api-field-description Flags whether user must change the password. True if "true" (case
   *     insensitive) else false
   */
  @XmlElement(
