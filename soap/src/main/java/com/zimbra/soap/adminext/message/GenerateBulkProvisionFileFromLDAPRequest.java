...
public class GenerateBulkProvisionFileFromLDAPRequest extends AttrsImpl {
   ...
   * @zm-api-field-description Generate password flag. True if "true" (case insensitive) else false
   *     - default value "false"
   */
   ...
   */
  @XmlElement(
      name = AdminExtConstants.A_genPasswordLength /* genPasswordLength */,
      required = false)
   ...
   */
  @XmlElement(
      name = AdminExtConstants.E_mustChangePassword /* mustChangePassword */,
      required = true)
   ...
   * @zm-api-field-description Flag whether to import deleted items. True if "TRUE" (case
   *     insensitive)
   */
  @XmlElement(
      name = AdminExtConstants.E_importDeletedItems /* importDeletedItems */,
      required = false)
  private String importDeletedItems;

  /**
   * @zm-api-field-tag ignore-previously-imported
   * @zm-api-field-description Flag whether to import previosly imported items. True if "TRUE" (case
   *     insensitive)
   */
  @XmlElement(
      name = AdminExtConstants.E_ignorePreviouslyImported /* ignorePreviouslyImported */,
      required = false)
  ...
  /**
   * @zm-api-field-tag admin-password
   * @zm-api-field-description Zimbra Admin password
   */
  @XmlElement(
      name = AdminExtConstants.E_ZimbraAdminPassword /* ZimbraAdminPassword */,
      required = false)
