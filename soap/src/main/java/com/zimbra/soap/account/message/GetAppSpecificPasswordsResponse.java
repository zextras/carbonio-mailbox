...
public class GetAppSpecificPasswordsResponse {
  ...
  @XmlElements({
    @XmlElement(
        name = AccountConstants.E_APP_SPECIFIC_PASSWORD_DATA,
        type = AppSpecificPasswordData.class)
  })
  private List<AppSpecificPasswordData> appSpecificPasswords =
      new ArrayList<AppSpecificPasswordData>();
  ...
  public void addAppSpecificPassword(AppSpecificPasswordData appSpecificPassword) {
    appSpecificPasswords.add(appSpecificPassword);
  }
  ...
  public void setMaxAppPasswords(int maxAppPasswords) {
    this.maxAppPasswords = maxAppPasswords;
  }
