 ...
 * @zm-api-command-description Modify Preferences <br>
 *     Notes: <br>
 ...
 * </pre>
 *     <br>
 *     You can also add/subtract single values to/from a multi-value pref by prefixing the
 *     preference name with a '+' or '-', respectively in the same way you do when using zmprov. For
 *     example:
 *     <pre>
 *      &lt;ModifyPrefsRequest>
 *          &lt;pref name="+foo">value1&lt;/pref>
...
public class ModifyPrefsRequest {
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this).add("prefs", prefs).toString();
  }
}
