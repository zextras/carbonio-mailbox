...
public class ContactInfo implements ContactInterface {
   ...
   * @zm-api-field-description Contact type <br>
   *     Default value is <b>"contact"</b>. If is present and set to <b>"group"</b>, then the
   *     contact is a personal distribution list.
   */
   ...
   * @zm-api-field-description Flag whether there were too many members. <br>
   *     If the number of members on a GAL group is greater than the specified max, no members are
   *     returned and this flag is set to <b>1 (true)</b> instead.
   */
  ...
  @Override
  @GraphQLQuery(
      name = GqlConstants.TYPE,
      description =
          "Contact type, Default value is \"contact\". If is present and set to \"group\", then the"
              + " contact is a personal distribution list.")
  ...
  @GraphQLQuery(
      name = GqlConstants.IS_OWNER,
      description = "For group entries, flags whether user is the owner of a group")
  public Boolean isOwner() {
    return ZmBoolean.toBool(isOwner);
  }

  @GraphQLQuery(
      name = GqlConstants.IS_MEMBER,
      description = "For group entries, flags whether user is a member of a group ")
