...
public class GetSmimeCertificateInfoRequest {
   ...
   * @zm-api-field-description Certificate Id. If it's value is specified, details of certificate
   *     matching that id will be returned. If value is not specified, details of all certificates
