...
public class ModifyIdentityRequest {
  ...
  /**
   * @zm-api-field-description Specify identity to be modified Must specify either "name" or "id"
   *     attribute
   */
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this).add("identity", identity).toString();
  }
}
