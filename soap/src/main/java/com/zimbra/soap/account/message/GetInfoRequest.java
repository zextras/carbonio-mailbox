 ...
 * @zm-api-request-description By default, GetInfo returns all data; to limit the returned data,
...
public class GetInfoRequest {
  ...
  /**
   * @zm-api-field-description Comma separated list of sections to return information about. <br>
  ...
  @GraphQLInputField(
      name = GqlConstants.SECTIONS,
      description = "Comma separated list of sections to return information about")
  public GetInfoRequest setSections(String sections) throws ServiceException {
    this.sections.clear();
    if (sections != null) {
  ...
  public GetInfoRequest addSection(String sectionName) throws ServiceException {
  ...
  public GetInfoRequest addSections(String... sectionNames) throws ServiceException {
  ...
  @GraphQLInputField(
      name = GqlConstants.RIGHTS,
      description = "Comma separated list of rights to return information about")
  public void setRights(String rights) throws ServiceException {
    setRights(rights.split(","));
  }

  public GetInfoRequest setRights(String... rights) throws ServiceException {
    this.rights.clear();
    if (rights != null) {
  ...
  public GetInfoRequest addRight(String right) throws ServiceException {
    rights.add(right);
    return this;
  }
}
