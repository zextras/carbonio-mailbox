 ...
 * @zm-api-command-description Modify the anti-spam WhiteList and BlackList addresses <br>
 *     Note: If no <b>&lt;addr></b> is present in a list, it means to remove all addresses in the
 *     list. <br>
 ...
 *     </ul>
 *     if not present, replace the entire list with provided values. <br>
 *     Note, can't mix +/- with non-present op) <br>
 *     <br>
 *     e.g.
 *     <ol>
...
public class ModifyWhiteBlackListRequest {
  ...
  public ModifyWhiteBlackListRequest addWhiteListEntry(OpValue whiteListEntry) {
  ...
  public ModifyWhiteBlackListRequest addBlackListEntry(OpValue blackListEntry) {
