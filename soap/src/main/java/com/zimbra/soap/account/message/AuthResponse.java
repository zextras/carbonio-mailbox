...
public class AuthResponse {
  ...
  /**
   * @zm-api-field-description indicates whether the authentication account acts as a "Proxy" to a
   *     Zimbra account on another system.
   */
  ...
  @GraphQLQuery(
      name = "refer",
      description = "Host that additional SOAP requests should be redirected to")
  ...
  @GraphQLQuery(
      name = "skin",
      description = "Name of the skin to use if a requestedSkin was specified")
  ...
  @GraphQLQuery(
      name = "attrs",
      description = "Requested attribute settings that are allowed to be returned")
  ...
  @GraphQLQuery(
      name = "csrfToken",
      description = "The csrf token returned if the client says it is csrf enabled")
  ...
  @GraphQLQuery(
      name = "deviceId",
      description = "Random secure device ID generated for the requesting device")
  ...
  @GraphQLQuery(
      name = "trustLifetime",
      description = "Trust lifetime, if a trusted token is issued")
  ...
  @GraphQLQuery(
      ...
      description = "Denotes if two factor authentication is required")
  ...
  public AuthResponse setTwoFactorAuthRequired(boolean bool) {
    this.twoFactorAuthRequired = ZmBoolean.fromBool(bool);
    return this;
  }
  ...
  @GraphQLQuery(
      name = "zmgProxy",
      description =
          "Indicates whether the authentication account acts as a proxy to a Zimbra account on"
              + " another system")
  public Boolean getZmgProxy() {
    return ZmBoolean.toBool(zmgProxy);
  }

  public void setZmgProxy(Boolean zmgProxy) {
    this.zmgProxy = ZmBoolean.fromBool(zmgProxy);
  }

  @GraphQLQuery(
      name = "trustedDevicesEnabled",
      description = "Denotes if trusted devices are enabled")
  public ZmBoolean getTrustedDevicesEnabled() {
    return trustedDevicesEnabled;
  }

  public AuthResponse setTrustedDevicesEnabled(boolean bool) {
    this.trustedDevicesEnabled = ZmBoolean.fromBool(bool);
    return this;
  }
}
