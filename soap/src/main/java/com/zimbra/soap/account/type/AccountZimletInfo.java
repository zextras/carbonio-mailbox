...
public class AccountZimletInfo implements ZimletInterface {
  ...
  @XmlAnyElement private Element zimletHandlerConfig;

  public AccountZimletInfo() {}

  public void setZimletContext(AccountZimletContext zimletContext) {
    this.zimletContext = zimletContext;
  }

  public void setZimlet(AccountZimletDesc zimlet) {
    this.zimlet = zimlet;
  }

  public void setZimletConfig(AccountZimletConfigInfo zimletConfig) {
  ...
  public void setZimlet(ZimletDesc zimlet) {
    setZimlet((AccountZimletDesc) zimlet);
  }
