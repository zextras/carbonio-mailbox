...
@XmlType(propOrder = {})
@GraphQLType(
    name = GqlConstants.CLASS_ACCOUNT_ZIMLET_CONFIG_INFO,
    description = "Zimlet config info")
public class AccountZimletConfigInfo implements ZimletConfigInfo {
  ...
  public void setGlobal(AccountZimletGlobalConfigInfo global) {
    this.global = global;
  }

  public void setHost(AccountZimletHostConfigInfo host) {
    this.host = host;
  }
  ...
  @Override
  public AccountZimletGlobalConfigInfo getGlobal() {
    return global;
  }

  @GraphQLQuery(
      name = GqlConstants.HOST,
      description = "Zimlet host specific configuration information")
  @Override
  public AccountZimletHostConfigInfo getHost() {
    return host;
  }
