...
@GraphQLType(
    name = GqlConstants.CLASS_SEARCH_FILTER_SINGLE_CONDITION,
    description = "Single condition search filter.")
public class EntrySearchFilterSingleCond implements SearchFilterCondition {
  ...
  @GraphQLInputField(
      name = GqlConstants.SEARCH_FILTER_OP,
      description =
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("not", not).add("attr", attr).add("op", op).add("value", value);
  }
