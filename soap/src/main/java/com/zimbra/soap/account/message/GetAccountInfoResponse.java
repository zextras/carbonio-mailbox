...
public class GetAccountInfoResponse {
   ...
   * @zm-api-field-description Zimbra Community URL to load in Community tab. The URL points to
   *     /api.ashx/v2/oauth/redirect script in Zimbra Community and contains signed GET parameters
   *     used by Zimbra Community to authenticate current user. This parameter is returned only when
   *     <b>zimbraFeatureSocialExternalEnabled</b> is set to <b>TRUE</b> and the following
   *     attributes are configured: <b>zimbraCommunityAPIClientID</b>,
   *     <b>zimbraCommunityAPIClientSecret</b>,
   *     <b>zimbraCommunityUsernameMapping</b>,<b>zimbraCommunityBaseURL</b>,<b>zimbraCommunityHomeURL</b>
   */
