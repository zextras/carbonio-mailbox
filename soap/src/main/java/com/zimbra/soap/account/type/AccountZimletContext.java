...
public class AccountZimletContext implements ZimletContextInterface {
   ...
   * @zm-api-field-description Zimlet presence <br>
  ...
  public AccountZimletContext(String zimletBaseUrl, Integer zimletPriority, String zimletPresence) {
