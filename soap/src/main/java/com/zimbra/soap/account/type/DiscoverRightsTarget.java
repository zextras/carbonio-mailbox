...
@GraphQLType(
    name = GqlConstants.CLASS_DISCOVER_RIGHTS_TARGET,
    description = "Discover rights target")
public class DiscoverRightsTarget {
   ...
   * @zm-api-field-description If a discovered target is an account or a group and the entry has a
   *     display name set then this is set to that display name.
   */
