...
@GraphQLType(
    name = GqlConstants.CLASS_ACCOUNT_CONTACT_GROUP_MEMBER,
    description = "Contact group member")
public class ContactGroupMember implements ContactGroupMemberInterface {
  ...
  public static ContactGroupMember createForTypeValueAndContact(
      String type, String value, ContactInfo contact) {
  ...
  @Override
  @GraphQLQuery(
      name = GqlConstants.CONTACT,
      description = "Contact information for dereferenced member")
  ...
  public static Iterable<ContactGroupMember> fromInterfaces(
      Iterable<ContactGroupMemberInterface> params) {
  ...
  public static List<ContactGroupMemberInterface> toInterfaces(
      Iterable<ContactGroupMember> params) {
    if (params == null) return null;
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("type", type).add("value", value).add("contact", contact);
  }
