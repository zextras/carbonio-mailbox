...
public class GetTrustedDevicesResponse {
  ...
  public void setNumOtherTrustedDevices(Integer n) {
    numOtherTrustedDevices = n;
  }

  public Integer getNumOtherTrustedDevices() {
    return numOtherTrustedDevices;
  }

  public void setThisDeviceTrusted(Boolean b) {
    thisDeviceTrusted = ZmBoolean.fromBool(b);
  }

  public Boolean getThisDeviceTrusted() {
    return ZmBoolean.toBool(thisDeviceTrusted);
  }
}
