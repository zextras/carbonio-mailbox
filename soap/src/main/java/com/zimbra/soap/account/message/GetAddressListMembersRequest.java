 ...
 *           owners.
 *       <li>Only grants on this group entry are returned, inherited grants on domain or global
 *           grant are not returned.
 *     </ul>
 */
...
public class GetAddressListMembersRequest {
   ...
   * @zm-api-field-description Set to 1 if the response should only contain the count of total
