...
public class AuthToken {
  ...
  /**
   * @zm-api-field-description If verifyAccount="1", &lt;account> is required and the account in the
   *     auth token is compared to the named account. If verifyAccount="0" (default), only the auth
   *     token is verified and any <b>&lt;account></b> element specified is ignored.
   */
  ...
  @GraphQLQuery(
      name = "verifyAccount",
      description = "Denotes whether to verify account data in the request")
  public Boolean getVerifyAccount() {
    return ZmBoolean.toBool(verifyAccount);
  }
