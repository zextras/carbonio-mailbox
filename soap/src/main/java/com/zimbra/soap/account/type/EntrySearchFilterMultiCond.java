...
@XmlType(propOrder = {})
@GraphQLType(
    name = GqlConstants.CLASS_SEARCH_FILTER_MULTIPLE_CONDITIONS,
    description = "Multiple conditions search filter.")
public class EntrySearchFilterMultiCond implements SearchFilterCondition {

  /**
   * @zm-api-field-tag not
   * @zm-api-field-description Negation flag <br>
  ...
  @XmlElements({
    @XmlElement(
        name = AccountConstants.E_ENTRY_SEARCH_FILTER_MULTICOND /* conds */,
        type = EntrySearchFilterMultiCond.class),
    @XmlElement(
        name = AccountConstants.E_ENTRY_SEARCH_FILTER_SINGLECOND /* cond */,
  ...
  @Override
  @GraphQLInputField(
      name = GqlConstants.SEARCH_FILTER_NEGATION,
      description = "Negation flag, if set to 1 (true) then negate the compound condition")
  public void setNot(Boolean not) {
    this.not = ZmBoolean.fromBool(not);
  }

  @GraphQLInputField(
      name = GqlConstants.SEARCH_FILTER_OR,
      description =
          "OR flag, 1 (true): child conditions are OR'ed together\n"
              + "0 (false): [default] child conditions are AND'ed together")
  public void setOr(Boolean or) {
    this.or = ZmBoolean.fromBool(or);
  }
  ...
  @GraphQLInputField(
      name = GqlConstants.SINGLE_CONDITION,
      description = "search filter single conditions")
  ...
  @GraphQLInputField(
      name = GqlConstants.MULTIPLE_CONDITION,
      description = "search filter multiple conditions")
  ...
  public Boolean isNot() {
    return ZmBoolean.toBool(not);
  }

  public Boolean isOr() {
    return ZmBoolean.toBool(or);
  }
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("not", not).add("or", or).add("conditions", conditions);
  }
