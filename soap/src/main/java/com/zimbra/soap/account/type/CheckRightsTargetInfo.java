...
public class CheckRightsTargetInfo {
   ...
   * @zm-api-field-description Key for target. <br>
   *     If <b>{target-by}</b> is <b>id</b> this key is the zimbraId of the target entry <br>
  ...
  public CheckRightsTargetInfo(TargetType targetType, TargetBy targetBy, String targetKey) {
  ...
  public CheckRightsTargetInfo(
      ...
      String targetKey,
      boolean allow,
      Iterable<CheckRightsRightInfo> rights) {
