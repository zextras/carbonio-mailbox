...
public class EnableTwoFactorAuthRequest {
  ...
  public EnableTwoFactorAuthRequest setPassword(String password) {
  ...
  public EnableTwoFactorAuthRequest setName(String acctName) {
  ...
  public EnableTwoFactorAuthRequest setTwoFactorCode(String code) {
