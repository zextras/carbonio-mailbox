...
public class SyncGalResponse {
   ...
   * @zm-api-field-description galDefinitionLastModified is the time at which the GAL definition is
   *     last modified. This is returned if the sync does not happen using GAL sync account.
   */
  @XmlAttribute(
      name = MailConstants.A_GAL_DEFINITION_LAST_MODIFIED /* galDefinitionLastModified */,
      required = false)
   ...
   */
  @XmlAttribute(
      name = MailConstants.A_GALSYNC_FULLSYNC_RECOMMENDED /* fullSyncRecommended */,
      required = false)
  ...
  /**
   * @zm-api-field-description Details of contact. For element names <b>&lt;deleted</b> - gives
  ...
  public void setGalDefinitionLastModified(String timestamp) {
    this.galDefinitionLastModified = timestamp;
  }

  public void setThrottled(Boolean throttled) {
    this.throttled = ZmBoolean.fromBool(throttled);
  }

  public void setFullSyncRecommended(Boolean value) {
    this.fullSyncRecommended = ZmBoolean.fromBool(value);
  }
  ...
  public Boolean getThrottled() {
    return ZmBoolean.toBool(throttled);
  }

  public Boolean getFullSyncRecommended() {
    return ZmBoolean.toBool(fullSyncRecommended);
  }
