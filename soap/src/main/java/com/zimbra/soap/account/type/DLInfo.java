...
public class DLInfo extends ObjectInfo {
   ...
   * @zm-api-field-description <b>{via-dl-name}</b> = is present if the account is a member of the
   *     returned list because they are either a direct or indirect member of another list that is a
   *     member of the returned list. For example, if a user is a member of engineering@domain.com,
   *     and engineering@domain.com is a member of all@domain.com, then the following would be
   *     returned:
   *     <pre>
   ...
   * @zm-api-field-description Flags whether user is the owner of the group. <br>
   ...
   * @zm-api-field-description Flags whether user is a member of the group. <br>
