...
/**
 * <ChangePasswordResponse> <authToken>...</authToken> <lifetime>...</lifetime>
 * <ChangePasswordResponse/>
 *
 * @zm-api-response-description Note: Returns new authToken, as old authToken will be invalidated on
 *     password change.
 */
@XmlRootElement(name = AccountConstants.E_CHANGE_PASSWORD_RESPONSE)
@GraphQLType(
    name = GqlConstants.CLASS_CHANGE_PASSWORD_RESPONSE,
    description = "The response to change password request.")
@XmlType(propOrder = {})
public class ChangePasswordResponse {
  ...
  @GraphQLQuery(
      name = GqlConstants.AUTH_TOKEN,
      description = "Auth token based on the new password")
