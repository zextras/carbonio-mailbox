...
public class DistributionListAction extends AccountKeyValuePairs {
  ...
  /**
   * @zm-api-field-description Group members <br>
   ...
   * @zm-api-field-description New Name <br>
  ...
  /**
   * @zm-api-field-description Owner <br>
   *     Required if op="addOwners" or op="removeOwners", <br>
   *     Optional if op="setOwners". If not present when op="setOwners" all current owners will be
   *     removed.
   */
  ...
  /**
   * @zm-api-field-description Rights <br>
  ...
  /**
   * @zm-api-field-description Subscription request <br>
