...
public class DistributionListInfo extends ObjectInfo {
  ...
  private DistributionListInfo() {
    this((String) null, (String) null, (Collection<String>) null, (Collection<KeyValuePair>) null);
  }

  public DistributionListInfo(String id, String name) {
    this((String) id, (String) name, (Collection<String>) null, (Collection<KeyValuePair>) null);
  }

  public DistributionListInfo(
      String id, String name, Collection<String> members, Collection<KeyValuePair> attrs) {
    super(id, name, attrs);
    setMembers(members);
  }
