 ...
 * @zm-api-request-description Notes:
 *     <ul>
 *       <li>if <b>&lt;owner></b> is *not* specified the server will search the LDAP directory for
 *           published shares (<b>zimbraSharedItem</b> account attribute) accessible to the authed
 *           user.
 *       <li>if <b>&lt;owner></b> *is* specified, the server will iterate through the owner's
 *           mailbox to discover all shares applicable to the authed user, instead of looking at any
 *           of the published share info.
 ...
 *           <ol type="a">
 *             <li>include all folders directly shared with me and shared with an entry I can
 *                 inherit shares from:
 *                 <pre>
 *              &lt;GetShareInfoRequest>
 *                  &lt;owner by="name">user1@example.com&lt;/owner>
 ...
 *           </pre>
 *           </ol>
 *       <li>Show me all folders shared directly with me and with any entry I can inherit shares
 *           from:
 *           <pre>
 *              &lt;GetShareInfoRequest>
 *              &lt;/GetShareInfoRequest>
...
public class GetShareInfoRequest {
  ...
  /**
   * @zm-api-field-description Flags that have been proxied to this server because the specified
   *     "owner account" is homed here. Do not proxy in this case. (Used internally by ZCS)
   */
   ...
   *     <ul>
   *       <li><b>0</b> if shares owned by the requested account should not be included in the
   *           response
   *       <li><b>1</b> (default) include shares owned by the requested account
   *     </ul>
   *     (It might be useful to see the shares I've shared to a DL that I belong to so that I know
   *     I'm sharing it correctly.)
   */
  ...
  public static GetShareInfoRequest create(
      AccountSelector owner, GranteeChooser grantee, Boolean includeSelf) {
  ...
  public void setInternal(Boolean internal) {
    this.internal = ZmBoolean.fromBool(internal);
  }

  public void setIncludeSelf(Boolean includeSelf) {
    this.includeSelf = ZmBoolean.fromBool(includeSelf);
  }

  public void setGrantee(GranteeChooser grantee) {
    this.grantee = grantee;
  }

  public void setOwner(AccountSelector owner) {
    this.owner = owner;
  }

  public Boolean getInternal() {
    return ZmBoolean.toBool(internal);
  }

  public Boolean getIncludeSelf() {
    return ZmBoolean.toBool(includeSelf);
  }
