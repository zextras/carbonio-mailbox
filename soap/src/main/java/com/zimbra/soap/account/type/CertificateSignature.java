...
public class CertificateSignature {
   ...
   * @zm-api-field-description serialNumber of the certificate, which is used to uniquely identify
   *     the certificate.
   */
  @ZimbraJsonAttribute
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("serialNo", serialNumber).add("algorithm", algorithm);
  }
