...
public class SMIMEPublicCertsStoreSpec {
   ...
   *     <ul>
   *       <li><b>ANY</b> (default) : While iterating through stores, stop if any certs are found in
   *           a store and just return those certs - remaining stores will not be attempted.
   *       <li><b>ALL</b>: Always iterate through all specified stores.
   *     </ul>
   */
  @XmlAttribute(
      name = AccountConstants.A_SMIME_STORE_LOOKUP_OPT /* storeLookupOpt */,
      required = false)
   ...
   *     <ul>
   *       <li><b>ANY</b> : While iterating through multiple sources configured for a store, stop if
   *           any certificates are found in one source - remaining configured sources will not be
   *           attempted.
   ...
   */
  @XmlAttribute(
      name = AccountConstants.A_SMIME_SOURCE_LOOKUP_OPT /* sourceLookupOpt */,
      required = false)
  ...
  /**
   * @zm-api-field-description Comma separated list of store types <br>
   *     Valid store types:
   *     <ol>
