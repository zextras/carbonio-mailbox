...
@GraphQLType(
    name = GqlConstants.CLASS_ACCOUNT_ZIMLET_GLOBAL_CONFIG_INFO,
    description = "Account zimlet global configuration information")
public class AccountZimletGlobalConfigInfo implements ZimletGlobalConfigInfo {
  ...
  @GraphQLQuery(
      name = GqlConstants.ZIMLET_GLOBAL_CONFIG_PROPERTIES,
      description = "Global zimlet configuration properties")
  ...
  public MoreObjects.ToStringHelper addToStringInfo(MoreObjects.ToStringHelper helper) {
    return helper.add("properties", properties);
  }
