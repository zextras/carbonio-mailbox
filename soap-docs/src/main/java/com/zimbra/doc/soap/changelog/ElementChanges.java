...
/**
 * Encodes information about changes to the value of an element between a baseline revision and the
 * current revision
 *
 * @author gren
 */
public class ElementChanges {
  ...
  public ElementChanges(
      String xpath,
      SoapApiNamedElement baseElem,
      SoapApiNamedElement currElem,
      Map<String, SoapApiType> baselineTypes,
      Map<String, SoapApiType> currentTypes) {
    this.xpath = xpath;
  ...
  private String valueDescription(
      SoapApiNamedElement elem, Map<String, SoapApiType> apiTypes, String marker) {
  ...
  private String getRepresentation(
      String jaxbName, Map<String, SoapApiType> apiTypes, String marker) {
  ...
  public String getBaselineRepresentation() {
