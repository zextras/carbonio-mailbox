...
public class ZAttrProvisioning {
  ...
  /**
   * AlwaysOn cluster-id to which this server belongs to. If empty, it&#039;s not part of AlwaysOn
   * and is a stand-alone server.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1446)
  ...
  /**
   * Whether to allow a user to access touch client. Note: touch client is a Network feature, this
   * attribute is effective only if touch client is permitted by license.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1636)
  ...
  /**
   * last response of last Zimbra version check. This will be a short XML that will contain
