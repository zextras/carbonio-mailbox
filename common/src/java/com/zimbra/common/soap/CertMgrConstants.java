...
public final class CertMgrConstants {
  ...
  public static final QName VERIFY_CERTKEY_RESPONSE =
      QName.get(E_VERIFY_CERTKEY_RESPONSE, NAMESPACE);
  public static final QName UPLOAD_DOMCERT_REQUEST = QName.get(E_UPLOAD_DOMCERT_REQUEST, NAMESPACE);
  public static final QName UPLOAD_DOMCERT_RESPONSE =
      QName.get(E_UPLOAD_DOMCERT_RESPONSE, NAMESPACE);
  public static final QName UPLOAD_PROXYCA_REQUEST = QName.get(E_UPLOAD_PROXYCA_REQUEST, NAMESPACE);
  public static final QName UPLOAD_PROXYCA_RESPONSE =
      QName.get(E_UPLOAD_PROXYCA_RESPONSE, NAMESPACE);
  ...
  public static final String A_certChain = "certChain";
