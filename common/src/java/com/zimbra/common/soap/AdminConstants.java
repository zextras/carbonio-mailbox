...
public final class AdminConstants {
  ...
  public static final String E_GET_ALL_DISTRIBUTION_LISTS_REQUEST =
      "GetAllDistributionListsRequest";
  public static final String E_GET_ALL_DISTRIBUTION_LISTS_RESPONSE =
      "GetAllDistributionListsResponse";
  public static final String E_ADD_DISTRIBUTION_LIST_MEMBER_REQUEST =
      "AddDistributionListMemberRequest";
  public static final String E_ADD_DISTRIBUTION_LIST_MEMBER_RESPONSE =
      "AddDistributionListMemberResponse";
  public static final String E_REMOVE_DISTRIBUTION_LIST_MEMBER_REQUEST =
      "RemoveDistributionListMemberRequest";
  public static final String E_REMOVE_DISTRIBUTION_LIST_MEMBER_RESPONSE =
  ...
  public static final String E_ADD_DISTRIBUTION_LIST_ALIAS_REQUEST =
      "AddDistributionListAliasRequest";
  public static final String E_ADD_DISTRIBUTION_LIST_ALIAS_RESPONSE =
      "AddDistributionListAliasResponse";
  public static final String E_REMOVE_DISTRIBUTION_LIST_ALIAS_REQUEST =
      "RemoveDistributionListAliasRequest";
  public static final String E_REMOVE_DISTRIBUTION_LIST_ALIAS_RESPONSE =
  ...
  public static final String E_RECALCULATE_MAILBOX_COUNTS_REQUEST =
  ...
  public static final String E_GET_ALL_CALENDAR_RESOURCES_REQUEST =
      "GetAllCalendarResourcesRequest";
  public static final String E_GET_ALL_CALENDAR_RESOURCES_RESPONSE =
  ...
  public static final String E_COMPUTE_AGGR_QUOTA_USAGE_REQUEST =
      "ComputeAggregateQuotaUsageRequest";
  public static final String E_COMPUTE_AGGR_QUOTA_USAGE_RESPONSE =
      "ComputeAggregateQuotaUsageResponse";
  public static final String E_GET_AGGR_QUOTA_USAGE_ON_SERVER_REQUEST =
      "GetAggregateQuotaUsageOnServerRequest";
  public static final String E_GET_AGGR_QUOTA_USAGE_ON_SERVER_RESPONSE =
  ...
  public static final String E_GET_DISTRIBUTION_LIST_MEMBERSHIP_REQUEST =
  ...
  public static final String E_MODIFY_ADMIN_SAVED_SEARCHES_REQUEST =
      "ModifyAdminSavedSearchesRequest";
  public static final String E_MODIFY_ADMIN_SAVED_SEARCHES_RESPONSE =
  ...
  // f/b providers
  public static final String E_GET_ALL_FREE_BUSY_PROVIDERS_REQUEST =
      "GetAllFreeBusyProvidersRequest";
  public static final String E_GET_ALL_FREE_BUSY_PROVIDERS_RESPONSE =
  ...
  // calendar cache
  public static final String E_PURGE_ACCOUNT_CALENDAR_CACHE_REQUEST =
      "PurgeAccountCalendarCacheRequest";
  public static final String E_PURGE_ACCOUNT_CALENDAR_CACHE_RESPONSE =
  ...
  public static final String E_GET_DELEGATED_ADMIN_CONSTRAINTS_REQUEST =
      "GetDelegatedAdminConstraintsRequest";
  public static final String E_GET_DELEGATED_ADMIN_CONSTRAINTS_RESPONSE =
      "GetDelegatedAdminConstraintsResponse";
  public static final String E_MODIFY_DELEGATED_ADMIN_CONSTRAINTS_REQUEST =
      "ModifyDelegatedAdminConstraintsRequest";
  public static final String E_MODIFY_DELEGATED_ADMIN_CONSTRAINTS_RESPONSE =
  ...
  // memcached
  public static final String E_RELOAD_MEMCACHED_CLIENT_CONFIG_REQUEST =
      "ReloadMemcachedClientConfigRequest";
  public static final String E_RELOAD_MEMCACHED_CLIENT_CONFIG_RESPONSE =
      "ReloadMemcachedClientConfigResponse";
  public static final String E_GET_MEMCACHED_CLIENT_CONFIG_REQUEST =
      "GetMemcachedClientConfigRequest";
  public static final String E_GET_MEMCACHED_CLIENT_CONFIG_RESPONSE =
  ...
  public static final String E_REFRESH_REGISTERED_AUTHTOKENS_REQUEST =
  ...
  public static final String E_SEARCH_AUTO_PROV_DIRECTORY_REQUEST =
      "SearchAutoProvDirectoryRequest";
  public static final String E_SEARCH_AUTO_PROV_DIRECTORY_RESPONSE =
      "SearchAutoProvDirectoryResponse";

  // Retention policy
  public static final String E_GET_SYSTEM_RETENTION_POLICY_REQUEST =
      "GetSystemRetentionPolicyRequest";
  public static final String E_GET_SYSTEM_RETENTION_POLICY_RESPONSE =
      "GetSystemRetentionPolicyResponse";
  public static final String E_CREATE_SYSTEM_RETENTION_POLICY_REQUEST =
      "CreateSystemRetentionPolicyRequest";
  public static final String E_CREATE_SYSTEM_RETENTION_POLICY_RESPONSE =
      "CreateSystemRetentionPolicyResponse";
  public static final String E_MODIFY_SYSTEM_RETENTION_POLICY_REQUEST =
      "ModifySystemRetentionPolicyRequest";
  public static final String E_MODIFY_SYSTEM_RETENTION_POLICY_RESPONSE =
      "ModifySystemRetentionPolicyResponse";
  public static final String E_DELETE_SYSTEM_RETENTION_POLICY_REQUEST =
      "DeleteSystemRetentionPolicyRequest";
  public static final String E_DELETE_SYSTEM_RETENTION_POLICY_RESPONSE =
  ...
  public static final QName CREATE_ACCOUNT_RESPONSE =
      QName.get(E_CREATE_ACCOUNT_RESPONSE, NAMESPACE);
  public static final QName CREATE_GAL_SYNC_ACCOUNT_REQUEST =
      QName.get(E_CREATE_GAL_SYNC_ACCOUNT_REQUEST, NAMESPACE);
  public static final QName CREATE_GAL_SYNC_ACCOUNT_RESPONSE =
      QName.get(E_CREATE_GAL_SYNC_ACCOUNT_RESPONSE, NAMESPACE);
  public static final QName ADD_GAL_SYNC_DATASOURCE_REQUEST =
      QName.get(E_ADD_GAL_SYNC_DATASOURCE_REQUEST, NAMESPACE);
  public static final QName ADD_GAL_SYNC_DATASOURCE_RESPONSE =
      QName.get(E_ADD_GAL_SYNC_DATASOURCE_RESPONSE, NAMESPACE);
  ...
  public static final QName DELETE_GAL_SYNC_ACCOUNT_REQUEST =
      QName.get(E_DELETE_GAL_SYNC_ACCOUNT_REQUEST, NAMESPACE);
  public static final QName DELETE_GAL_SYNC_ACCOUNT_RESPONSE =
      QName.get(E_DELETE_GAL_SYNC_ACCOUNT_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_ALL_ACCOUNTS_REQUEST =
      QName.get(E_GET_ALL_ACCOUNTS_REQUEST, NAMESPACE);
  public static final QName GET_ALL_ACCOUNTS_RESPONSE =
      QName.get(E_GET_ALL_ACCOUNTS_RESPONSE, NAMESPACE);
  public static final QName GET_ALL_ADMIN_ACCOUNTS_REQUEST =
      QName.get(E_GET_ALL_ADMIN_ACCOUNTS_REQUEST, NAMESPACE);
  public static final QName GET_ALL_ADMIN_ACCOUNTS_RESPONSE =
      QName.get(E_GET_ALL_ADMIN_ACCOUNTS_RESPONSE, NAMESPACE);
  public static final QName MODIFY_ACCOUNT_REQUEST = QName.get(E_MODIFY_ACCOUNT_REQUEST, NAMESPACE);
  public static final QName MODIFY_ACCOUNT_RESPONSE =
      QName.get(E_MODIFY_ACCOUNT_RESPONSE, NAMESPACE);
  public static final QName DELETE_ACCOUNT_REQUEST = QName.get(E_DELETE_ACCOUNT_REQUEST, NAMESPACE);
  public static final QName DELETE_ACCOUNT_RESPONSE =
      QName.get(E_DELETE_ACCOUNT_RESPONSE, NAMESPACE);
  ...
  public static final QName CHECK_PASSWORD_STRENGTH_REQUEST =
      QName.get(E_CHECK_PASSWORD_STRENGTH_REQUEST, NAMESPACE);
  public static final QName CHECK_PASSWORD_STRENGTH_RESPONSE =
      QName.get(E_CHECK_PASSWORD_STRENGTH_RESPONSE, NAMESPACE);
  public static final QName RESET_ACCOUNT_PASSWORD_REQUEST =
      QName.get(E_RESET_ACCOUNT_PASSWORD_REQUEST, NAMESPACE);
  public static final QName RESET_ACCOUNT_PASSWORD_RESPONSE =
      QName.get(E_RESET_ACCOUNT_PASSWORD_RESPONSE, NAMESPACE);

  public static final QName ADD_ACCOUNT_ALIAS_REQUEST =
      QName.get(E_ADD_ACCOUNT_ALIAS_REQUEST, NAMESPACE);
  public static final QName ADD_ACCOUNT_ALIAS_RESPONSE =
      QName.get(E_ADD_ACCOUNT_ALIAS_RESPONSE, NAMESPACE);
  public static final QName REMOVE_ACCOUNT_ALIAS_REQUEST =
      QName.get(E_REMOVE_ACCOUNT_ALIAS_REQUEST, NAMESPACE);
  public static final QName REMOVE_ACCOUNT_ALIAS_RESPONSE =
      QName.get(E_REMOVE_ACCOUNT_ALIAS_RESPONSE, NAMESPACE);
  public static final QName SEARCH_ACCOUNTS_REQUEST =
      QName.get(E_SEARCH_ACCOUNTS_REQUEST, NAMESPACE);
  public static final QName SEARCH_ACCOUNTS_RESPONSE =
      QName.get(E_SEARCH_ACCOUNTS_RESPONSE, NAMESPACE);
  public static final QName RENAME_ACCOUNT_REQUEST = QName.get(E_RENAME_ACCOUNT_REQUEST, NAMESPACE);
  public static final QName RENAME_ACCOUNT_RESPONSE =
      QName.get(E_RENAME_ACCOUNT_RESPONSE, NAMESPACE);
  public static final QName CHANGE_PRIMARY_EMAIL_REQUEST =
  ...
  public static final QName GET_DOMAIN_INFO_REQUEST =
      QName.get(E_GET_DOMAIN_INFO_REQUEST, NAMESPACE);
  public static final QName GET_DOMAIN_INFO_RESPONSE =
      QName.get(E_GET_DOMAIN_INFO_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_ALL_DOMAINS_REQUEST =
      QName.get(E_GET_ALL_DOMAINS_REQUEST, NAMESPACE);
  public static final QName GET_ALL_DOMAINS_RESPONSE =
      QName.get(E_GET_ALL_DOMAINS_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_SERVER_NIFS_REQUEST =
      QName.get(E_GET_SERVER_NIFS_REQUEST, NAMESPACE);
  public static final QName GET_SERVER_NIFS_RESPONSE =
      QName.get(E_GET_SERVER_NIFS_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_ALL_SERVERS_REQUEST =
  ...
  public static final QName CREATE_ALWAYSONCLUSTER_REQUEST =
      QName.get(E_CREATE_ALWAYSONCLUSTER_REQUEST, NAMESPACE);
  public static final QName CREATE_ALWAYSONCLUSTER_RESPONSE =
      QName.get(E_CREATE_ALWAYSONCLUSTER_RESPONSE, NAMESPACE);
  public static final QName GET_ALWAYSONCLUSTER_REQUEST =
      QName.get(E_GET_ALWAYSONCLUSTER_REQUEST, NAMESPACE);
  public static final QName GET_ALWAYSONCLUSTER_RESPONSE =
      QName.get(E_GET_ALWAYSONCLUSTER_RESPONSE, NAMESPACE);

  public static final QName MODIFY_ALWAYSONCLUSTER_REQUEST =
      QName.get(E_MODIFY_ALWAYSONCLUSTER_REQUEST, NAMESPACE);
  public static final QName MODIFY_ALWAYSONCLUSTER_RESPONSE =
      QName.get(E_MODIFY_ALWAYSONCLUSTER_RESPONSE, NAMESPACE);
  public static final QName DELETE_ALWAYSONCLUSTER_REQUEST =
      QName.get(E_DELETE_ALWAYSONCLUSTER_REQUEST, NAMESPACE);
  public static final QName DELETE_ALWAYSONCLUSTER_RESPONSE =
      QName.get(E_DELETE_ALWAYSONCLUSTER_RESPONSE, NAMESPACE);
  public static final QName GET_ALL_ALWAYSONCLUSTERS_REQUEST =
      QName.get(E_GET_ALL_ALWAYSONCLUSTERS_REQUEST, NAMESPACE);
  public static final QName GET_ALL_ALWAYSONCLUSTERS_RESPONSE =
      QName.get(E_GET_ALL_ALWAYSONCLUSTERS_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_ALL_CONFIG_RESPONSE =
      QName.get(E_GET_ALL_CONFIG_RESPONSE, NAMESPACE);

  public static final QName GET_SERVICE_STATUS_REQUEST =
      QName.get(E_GET_SERVICE_STATUS_REQUEST, NAMESPACE);
  public static final QName GET_SERVICE_STATUS_RESPONSE =
      QName.get(E_GET_SERVICE_STATUS_RESPONSE, NAMESPACE);

  public static final QName PURGE_MESSAGES_REQUEST = QName.get(E_PURGE_MESSAGES_REQUEST, NAMESPACE);
  public static final QName PURGE_MESSAGES_RESPONSE =
      QName.get(E_PURGE_MESSAGES_RESPONSE, NAMESPACE);
  public static final QName DELETE_MAILBOX_REQUEST = QName.get(E_DELETE_MAILBOX_REQUEST, NAMESPACE);
  public static final QName DELETE_MAILBOX_RESPONSE =
      QName.get(E_DELETE_MAILBOX_RESPONSE, NAMESPACE);
  ...
  public static final QName LOCKOUT_MAILBOX_REQUEST =
      QName.get(E_LOCKOUT_MAILBOX_REQUEST, NAMESPACE);
  public static final QName LOCKOUT_MAILBOX_RESPONSE =
      QName.get(E_LOCKOUT_MAILBOX_RESPONSE, NAMESPACE);

  public static final QName RUN_UNIT_TESTS_REQUEST = QName.get(E_RUN_UNIT_TESTS_REQUEST, NAMESPACE);
  public static final QName RUN_UNIT_TESTS_RESPONSE =
      QName.get(E_RUN_UNIT_TESTS_RESPONSE, NAMESPACE);

  public static final QName CHECK_HOSTNAME_RESOLVE_REQUEST =
      QName.get(E_CHECK_HOSTNAME_RESOLVE_REQUEST, NAMESPACE);
  public static final QName CHECK_HOSTNAME_RESOLVE_RESPONSE =
      QName.get(E_CHECK_HOSTNAME_RESOLVE_RESPONSE, NAMESPACE);
  public static final QName CHECK_AUTH_CONFIG_REQUEST =
      QName.get(E_CHECK_AUTH_CONFIG_REQUEST, NAMESPACE);
  public static final QName CHECK_AUTH_CONFIG_RESPONSE =
      QName.get(E_CHECK_AUTH_CONFIG_RESPONSE, NAMESPACE);
  public static final QName CHECK_GAL_CONFIG_REQUEST =
      QName.get(E_CHECK_GAL_CONFIG_REQUEST, NAMESPACE);
  public static final QName CHECK_GAL_CONFIG_RESPONSE =
      QName.get(E_CHECK_GAL_CONFIG_RESPONSE, NAMESPACE);
  public static final QName CHECK_EXCHANGE_AUTH_REQUEST =
  ...
  public static final QName GET_ALL_VOLUMES_REQUEST =
      QName.get(E_GET_ALL_VOLUMES_REQUEST, NAMESPACE);
  public static final QName GET_ALL_VOLUMES_RESPONSE =
      QName.get(E_GET_ALL_VOLUMES_RESPONSE, NAMESPACE);
  public static final QName GET_CURRENT_VOLUMES_REQUEST =
      QName.get(E_GET_CURRENT_VOLUMES_REQUEST, NAMESPACE);
  public static final QName GET_CURRENT_VOLUMES_RESPONSE =
      QName.get(E_GET_CURRENT_VOLUMES_RESPONSE, NAMESPACE);
  public static final QName SET_CURRENT_VOLUME_REQUEST =
      QName.get(E_SET_CURRENT_VOLUME_REQUEST, NAMESPACE);
  public static final QName SET_CURRENT_VOLUME_RESPONSE =
      QName.get(E_SET_CURRENT_VOLUME_RESPONSE, NAMESPACE);
  public static final QName CHECK_BLOB_CONSISTENCY_REQUEST =
      QName.get(E_CHECK_BLOB_CONSISTENCY_REQUEST, NAMESPACE);
  public static final QName CHECK_BLOB_CONSISTENCY_RESPONSE =
      QName.get(E_CHECK_BLOB_CONSISTENCY_RESPONSE, NAMESPACE);
  public static final QName EXPORT_AND_DELETE_ITEMS_REQUEST =
      QName.get(E_EXPORT_AND_DELETE_ITEMS_REQUEST, NAMESPACE);
  public static final QName EXPORT_AND_DELETE_ITEMS_RESPONSE =
  ...
  public static final QName GET_ALL_DISTRIBUTION_LISTS_REQUEST =
      QName.get(E_GET_ALL_DISTRIBUTION_LISTS_REQUEST, NAMESPACE);
  public static final QName GET_ALL_DISTRIBUTION_LISTS_RESPONSE =
      QName.get(E_GET_ALL_DISTRIBUTION_LISTS_RESPONSE, NAMESPACE);
  public static final QName ADD_DISTRIBUTION_LIST_MEMBER_REQUEST =
      QName.get(E_ADD_DISTRIBUTION_LIST_MEMBER_REQUEST, NAMESPACE);
  public static final QName ADD_DISTRIBUTION_LIST_MEMBER_RESPONSE =
      QName.get(E_ADD_DISTRIBUTION_LIST_MEMBER_RESPONSE, NAMESPACE);
  public static final QName REMOVE_DISTRIBUTION_LIST_MEMBER_REQUEST =
      QName.get(E_REMOVE_DISTRIBUTION_LIST_MEMBER_REQUEST, NAMESPACE);
  public static final QName REMOVE_DISTRIBUTION_LIST_MEMBER_RESPONSE =
      QName.get(E_REMOVE_DISTRIBUTION_LIST_MEMBER_RESPONSE, NAMESPACE);
  public static final QName MODIFY_DISTRIBUTION_LIST_REQUEST =
      QName.get(E_MODIFY_DISTRIBUTION_LIST_REQUEST, NAMESPACE);
  public static final QName MODIFY_DISTRIBUTION_LIST_RESPONSE =
      QName.get(E_MODIFY_DISTRIBUTION_LIST_RESPONSE, NAMESPACE);
  public static final QName DELETE_DISTRIBUTION_LIST_REQUEST =
      QName.get(E_DELETE_DISTRIBUTION_LIST_REQUEST, NAMESPACE);
  public static final QName DELETE_DISTRIBUTION_LIST_RESPONSE =
      QName.get(E_DELETE_DISTRIBUTION_LIST_RESPONSE, NAMESPACE);
  public static final QName ADD_DISTRIBUTION_LIST_ALIAS_REQUEST =
      QName.get(E_ADD_DISTRIBUTION_LIST_ALIAS_REQUEST, NAMESPACE);
  public static final QName ADD_DISTRIBUTION_LIST_ALIAS_RESPONSE =
      QName.get(E_ADD_DISTRIBUTION_LIST_ALIAS_RESPONSE, NAMESPACE);
  public static final QName REMOVE_DISTRIBUTION_LIST_ALIAS_REQUEST =
      QName.get(E_REMOVE_DISTRIBUTION_LIST_ALIAS_REQUEST, NAMESPACE);
  public static final QName REMOVE_DISTRIBUTION_LIST_ALIAS_RESPONSE =
      QName.get(E_REMOVE_DISTRIBUTION_LIST_ALIAS_RESPONSE, NAMESPACE);
  public static final QName RENAME_DISTRIBUTION_LIST_REQUEST =
      QName.get(E_RENAME_DISTRIBUTION_LIST_REQUEST, NAMESPACE);
  ...
  public static final QName GET_ATTRIBUTE_INFO_REQUEST =
      QName.get(E_GET_ATTRIBUTE_INFO_REQUEST, NAMESPACE);
  public static final QName GET_ATTRIBUTE_INFO_RESPONSE =
      QName.get(E_GET_ATTRIBUTE_INFO_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_INDEX_STATS_REQUEST =
      QName.get(E_GET_INDEX_STATS_REQUEST, NAMESPACE);
  public static final QName GET_INDEX_STATS_RESPONSE =
      QName.get(E_GET_INDEX_STATS_RESPONSE, NAMESPACE);
  ...
  public static final QName RECALCULATE_MAILBOX_COUNTS_REQUEST =
  ...
  public static final QName CREATE_CALENDAR_RESOURCE_RESPONSE =
      QName.get(E_CREATE_CALENDAR_RESOURCE_RESPONSE, NAMESPACE);
  public static final QName DELETE_CALENDAR_RESOURCE_REQUEST =
      QName.get(E_DELETE_CALENDAR_RESOURCE_REQUEST, NAMESPACE);
  public static final QName DELETE_CALENDAR_RESOURCE_RESPONSE =
      QName.get(E_DELETE_CALENDAR_RESOURCE_RESPONSE, NAMESPACE);
  public static final QName MODIFY_CALENDAR_RESOURCE_REQUEST =
      QName.get(E_MODIFY_CALENDAR_RESOURCE_REQUEST, NAMESPACE);
  public static final QName MODIFY_CALENDAR_RESOURCE_RESPONSE =
      QName.get(E_MODIFY_CALENDAR_RESOURCE_RESPONSE, NAMESPACE);
  public static final QName RENAME_CALENDAR_RESOURCE_REQUEST =
      QName.get(E_RENAME_CALENDAR_RESOURCE_REQUEST, NAMESPACE);
  public static final QName RENAME_CALENDAR_RESOURCE_RESPONSE =
      QName.get(E_RENAME_CALENDAR_RESOURCE_RESPONSE, NAMESPACE);
  public static final QName GET_CALENDAR_RESOURCE_REQUEST =
      QName.get(E_GET_CALENDAR_RESOURCE_REQUEST, NAMESPACE);
  public static final QName GET_CALENDAR_RESOURCE_RESPONSE =
      QName.get(E_GET_CALENDAR_RESOURCE_RESPONSE, NAMESPACE);
  public static final QName GET_ALL_CALENDAR_RESOURCES_REQUEST =
      QName.get(E_GET_ALL_CALENDAR_RESOURCES_REQUEST, NAMESPACE);
  public static final QName GET_ALL_CALENDAR_RESOURCES_RESPONSE =
      QName.get(E_GET_ALL_CALENDAR_RESOURCES_RESPONSE, NAMESPACE);
  ...
  public static final QName SEARCH_MULTIPLE_MAILBOXES_REQUEST =
      QName.get(E_SEARCH_MULTIPLE_MAILBOXES_REQUEST, NAMESPACE);
  public static final QName SEARCH_MULTIPLE_MAILBOXES_RESPONSE =
      QName.get(E_SEARCH_MULTIPLE_MAILBOXES_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_QUOTA_USAGE_REQUEST =
      QName.get(E_GET_QUOTA_USAGE_REQUEST, NAMESPACE);
  public static final QName GET_QUOTA_USAGE_RESPONSE =
      QName.get(E_GET_QUOTA_USAGE_RESPONSE, NAMESPACE);
  public static final QName COMPUTE_AGGR_QUOTA_USAGE_REQUEST =
      QName.get(E_COMPUTE_AGGR_QUOTA_USAGE_REQUEST, NAMESPACE);
  public static final QName COMPUTE_AGGR_QUOTA_USAGE_RESPONSE =
      QName.get(E_COMPUTE_AGGR_QUOTA_USAGE_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_ALL_MAILBOXES_REQUEST =
      QName.get(E_GET_ALL_MAILBOXES_REQUEST, NAMESPACE);
  public static final QName GET_ALL_MAILBOXES_RESPONSE =
      QName.get(E_GET_ALL_MAILBOXES_RESPONSE, NAMESPACE);
  public static final QName GET_MAILBOX_STATS_REQUEST =
      QName.get(E_GET_MAILBOX_STATS_REQUEST, NAMESPACE);
  public static final QName GET_MAILBOX_STATS_RESPONSE =
      QName.get(E_GET_MAILBOX_STATS_RESPONSE, NAMESPACE);

  public static final QName GET_MAIL_QUEUE_INFO_REQUEST =
      QName.get(E_GET_MAIL_QUEUE_INFO_REQUEST, NAMESPACE);
  public static final QName GET_MAIL_QUEUE_INFO_RESPONSE =
      QName.get(E_GET_MAIL_QUEUE_INFO_RESPONSE, NAMESPACE);
  public static final QName GET_MAIL_QUEUE_REQUEST = QName.get(E_GET_MAIL_QUEUE_REQUEST, NAMESPACE);
  public static final QName GET_MAIL_QUEUE_RESPONSE =
      QName.get(E_GET_MAIL_QUEUE_RESPONSE, NAMESPACE);
  public static final QName MAIL_QUEUE_ACTION_REQUEST =
      QName.get(E_MAIL_QUEUE_ACTION_REQUEST, NAMESPACE);
  public static final QName MAIL_QUEUE_ACTION_RESPONSE =
      QName.get(E_MAIL_QUEUE_ACTION_RESPONSE, NAMESPACE);
  public static final QName MAIL_QUEUE_FLUSH_REQUEST =
      QName.get(E_MAIL_QUEUE_FLUSH_REQUEST, NAMESPACE);
  public static final QName MAIL_QUEUE_FLUSH_RESPONSE =
      QName.get(E_MAIL_QUEUE_FLUSH_RESPONSE, NAMESPACE);

  public static final QName SEARCH_DIRECTORY_REQUEST =
      QName.get(E_SEARCH_DIRECTORY_REQUEST, NAMESPACE);
  public static final QName SEARCH_DIRECTORY_RESPONSE =
      QName.get(E_SEARCH_DIRECTORY_RESPONSE, NAMESPACE);

  public static final QName GET_ACCOUNT_MEMBERSHIP_REQUEST =
      QName.get(E_GET_ACCOUNT_MEMBERSHIP_REQUEST, NAMESPACE);
  public static final QName GET_ACCOUNT_MEMBERSHIP_RESPONSE =
      QName.get(E_GET_ACCOUNT_MEMBERSHIP_RESPONSE, NAMESPACE);

  public static final QName GET_DISTRIBUTION_LIST_MEMBERSHIP_REQUEST =
      QName.get(E_GET_DISTRIBUTION_LIST_MEMBERSHIP_REQUEST, NAMESPACE);
  public static final QName GET_DISTRIBUTION_LIST_MEMBERSHIP_RESPONSE =
      QName.get(E_GET_DISTRIBUTION_LIST_MEMBERSHIP_RESPONSE, NAMESPACE);
  ...
  // calendar time zone fixup
  public static final QName FIX_CALENDAR_TZ_REQUEST =
      QName.get(E_FIX_CALENDAR_TZ_REQUEST, NAMESPACE);
  public static final QName FIX_CALENDAR_TZ_RESPONSE =
      QName.get(E_FIX_CALENDAR_TZ_RESPONSE, NAMESPACE);

  // calendar item end time fixup
  public static final QName FIX_CALENDAR_END_TIME_REQUEST =
      QName.get(E_FIX_CALENDAR_END_TIME_REQUEST, NAMESPACE);
  public static final QName FIX_CALENDAR_END_TIME_RESPONSE =
      QName.get(E_FIX_CALENDAR_END_TIME_RESPONSE, NAMESPACE);

  // calendar item priority fixup
  public static final QName FIX_CALENDAR_PRIORITY_REQUEST =
      QName.get(E_FIX_CALENDAR_PRIORITY_REQUEST, NAMESPACE);
  public static final QName FIX_CALENDAR_PRIORITY_RESPONSE =
      QName.get(E_FIX_CALENDAR_PRIORITY_RESPONSE, NAMESPACE);

  // Admin saved searches
  public static final QName GET_ADMIN_SAVED_SEARCHES_REQUEST =
      QName.get(E_GET_ADMIN_SAVED_SEARCHES_REQUEST, NAMESPACE);
  public static final QName GET_ADMIN_SAVED_SEARCHES_RESPONSE =
      QName.get(E_GET_ADMIN_SAVED_SEARCHES_RESPONSE, NAMESPACE);
  public static final QName MODIFY_ADMIN_SAVED_SEARCHES_REQUEST =
      QName.get(E_MODIFY_ADMIN_SAVED_SEARCHES_REQUEST, NAMESPACE);
  public static final QName MODIFY_ADMIN_SAVED_SEARCHES_RESPONSE =
      QName.get(E_MODIFY_ADMIN_SAVED_SEARCHES_RESPONSE, NAMESPACE);

  public static final QName CHECK_DIRECTORY_REQUEST =
      QName.get(E_CHECK_DIRECTORY_REQUEST, NAMESPACE);
  public static final QName CHECK_DIRECTORY_RESPONSE =
      QName.get(E_CHECK_DIRECTORY_RESPONSE, NAMESPACE);
  ...
  // Account loggers
  public static final QName ADD_ACCOUNT_LOGGER_REQUEST =
      QName.get(E_ADD_ACCOUNT_LOGGER_REQUEST, NAMESPACE);
  public static final QName ADD_ACCOUNT_LOGGER_RESPONSE =
      QName.get(E_ADD_ACCOUNT_LOGGER_RESPONSE, NAMESPACE);
  public static final QName REMOVE_ACCOUNT_LOGGER_REQUEST =
      QName.get(E_REMOVE_ACCOUNT_LOGGER_REQUEST, NAMESPACE);
  public static final QName REMOVE_ACCOUNT_LOGGER_RESPONSE =
      QName.get(E_REMOVE_ACCOUNT_LOGGER_RESPONSE, NAMESPACE);
  public static final QName GET_ACCOUNT_LOGGERS_REQUEST =
      QName.get(E_GET_ACCOUNT_LOGGERS_REQUEST, NAMESPACE);
  public static final QName GET_ACCOUNT_LOGGERS_RESPONSE =
      QName.get(E_GET_ACCOUNT_LOGGERS_RESPONSE, NAMESPACE);
  public static final QName GET_ALL_ACCOUNT_LOGGERS_REQUEST =
      QName.get(E_GET_ALL_ACCOUNT_LOGGERS_REQUEST, NAMESPACE);
  public static final QName GET_ALL_ACCOUNT_LOGGERS_RESPONSE =
      QName.get(E_GET_ALL_ACCOUNT_LOGGERS_RESPONSE, NAMESPACE);
  public static final QName RESET_ALL_LOGGERS_REQUEST =
      QName.get(E_RESET_ALL_LOGGERS_REQUEST, NAMESPACE);
  public static final QName RESET_ALL_LOGGERS_RESPONSE =
      QName.get(E_RESET_ALL_LOGGERS_RESPONSE, NAMESPACE);

  // f/b providers
  public static final QName GET_ALL_FREE_BUSY_PROVIDERS_REQUEST =
      QName.get(E_GET_ALL_FREE_BUSY_PROVIDERS_REQUEST, NAMESPACE);
  public static final QName GET_ALL_FREE_BUSY_PROVIDERS_RESPONSE =
      QName.get(E_GET_ALL_FREE_BUSY_PROVIDERS_RESPONSE, NAMESPACE);
  public static final QName GET_FREE_BUSY_QUEUE_INFO_REQUEST =
      QName.get(E_GET_FREE_BUSY_QUEUE_INFO_REQUEST, NAMESPACE);
  public static final QName GET_FREE_BUSY_QUEUE_INFO_RESPONSE =
      QName.get(E_GET_FREE_BUSY_QUEUE_INFO_RESPONSE, NAMESPACE);
  public static final QName PUSH_FREE_BUSY_REQUEST = QName.get(E_PUSH_FREE_BUSY_REQUEST, NAMESPACE);
  public static final QName PUSH_FREE_BUSY_RESPONSE =
      QName.get(E_PUSH_FREE_BUSY_RESPONSE, NAMESPACE);
  public static final QName PURGE_FREE_BUSY_QUEUE_REQUEST =
      QName.get(E_PURGE_FREE_BUSY_QUEUE_REQUEST, NAMESPACE);
  public static final QName PURGE_FREE_BUSY_QUEUE_RESPONSE =
      QName.get(E_PURGE_FREE_BUSY_QUEUE_RESPONSE, NAMESPACE);

  // calendar cache
  public static final QName PURGE_ACCOUNT_CALENDAR_CACHE_REQUEST =
      QName.get(E_PURGE_ACCOUNT_CALENDAR_CACHE_REQUEST, NAMESPACE);
  public static final QName PURGE_ACCOUNT_CALENDAR_CACHE_RESPONSE =
      QName.get(E_PURGE_ACCOUNT_CALENDAR_CACHE_RESPONSE, NAMESPACE);

  // admin-version of WaitSetRequest
  public static final QName ADMIN_CREATE_WAIT_SET_REQUEST =
      QName.get(E_ADMIN_CREATE_WAIT_SET_REQUEST, NAMESPACE);
  public static final QName ADMIN_CREATE_WAIT_SET_RESPONSE =
      QName.get(E_ADMIN_CREATE_WAIT_SET_RESPONSE, NAMESPACE);
  public static final QName ADMIN_WAIT_SET_REQUEST = QName.get(E_ADMIN_WAIT_SET_REQUEST, NAMESPACE);
  public static final QName ADMIN_WAIT_SET_RESPONSE =
      QName.get(E_ADMIN_WAIT_SET_RESPONSE, NAMESPACE);
  public static final QName ADMIN_DESTROY_WAIT_SET_REQUEST =
      QName.get(E_ADMIN_DESTROY_WAIT_SET_REQUEST, NAMESPACE);
  public static final QName ADMIN_DESTROY_WAIT_SET_RESPONSE =
      QName.get(E_ADMIN_DESTROY_WAIT_SET_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_ADMIN_CONSOLE_UI_COMP_REQUEST =
      QName.get(E_GET_ADMIN_CONSOLE_UI_COMP_REQUEST, NAMESPACE);
  public static final QName GET_ADMIN_CONSOLE_UI_COMP_RESPONSE =
      QName.get(E_GET_ADMIN_CONSOLE_UI_COMP_RESPONSE, NAMESPACE);
  public static final QName GET_ALL_EFFECTIVE_RIGHTS_REQUEST =
      QName.get(E_GET_ALL_EFFECTIVE_RIGHTS_REQUEST, NAMESPACE);
  public static final QName GET_ALL_EFFECTIVE_RIGHTS_RESPONSE =
      QName.get(E_GET_ALL_EFFECTIVE_RIGHTS_RESPONSE, NAMESPACE);
  public static final QName GET_ALL_RIGHTS_REQUEST = QName.get(E_GET_ALL_RIGHTS_REQUEST, NAMESPACE);
  public static final QName GET_ALL_RIGHTS_RESPONSE =
      QName.get(E_GET_ALL_RIGHTS_RESPONSE, NAMESPACE);
  public static final QName GET_EFFECTIVE_RIGHTS_REQUEST =
      QName.get(E_GET_EFFECTIVE_RIGHTS_REQUEST, NAMESPACE);
  public static final QName GET_EFFECTIVE_RIGHTS_RESPONSE =
      QName.get(E_GET_EFFECTIVE_RIGHTS_RESPONSE, NAMESPACE);
  public static final QName GET_CREATE_OBJECT_ATTRS_REQUEST =
      QName.get(E_GET_CREATE_OBJECT_ATTRS_REQUEST, NAMESPACE);
  public static final QName GET_CREATE_OBJECT_ATTRS_RESPONSE =
      QName.get(E_GET_CREATE_OBJECT_ATTRS_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_RIGHTS_DOC_RESPONSE =
      QName.get(E_GET_RIGHTS_DOC_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_DELEGATED_ADMIN_CONSTRAINTS_REQUEST =
      QName.get(E_GET_DELEGATED_ADMIN_CONSTRAINTS_REQUEST, NAMESPACE);
  public static final QName GET_DELEGATED_ADMIN_CONSTRAINTS_RESPONSE =
      QName.get(E_GET_DELEGATED_ADMIN_CONSTRAINTS_RESPONSE, NAMESPACE);
  public static final QName MODIFY_DELEGATED_ADMIN_CONSTRAINTS_REQUEST =
      QName.get(E_MODIFY_DELEGATED_ADMIN_CONSTRAINTS_REQUEST, NAMESPACE);
  public static final QName MODIFY_DELEGATED_ADMIN_CONSTRAINTS_RESPONSE =
      QName.get(E_MODIFY_DELEGATED_ADMIN_CONSTRAINTS_RESPONSE, NAMESPACE);

  // Monitoring
  public static final QName GET_SERVER_STATS_REQUEST =
      QName.get(E_GET_SERVER_STATS_REQUEST, NAMESPACE);
  public static final QName GET_SERVER_STATS_RESPONSE =
      QName.get(E_GET_SERVER_STATS_RESPONSE, NAMESPACE);

  public static final QName GET_LOGGER_STATS_REQUEST =
      QName.get(E_GET_LOGGER_STATS_REQUEST, NAMESPACE);
  public static final QName GET_LOGGER_STATS_RESPONSE =
      QName.get(E_GET_LOGGER_STATS_RESPONSE, NAMESPACE);

  public static final QName SYNC_GAL_ACCOUNT_REQUEST =
      QName.get(E_SYNC_GAL_ACCOUNT_REQUEST, NAMESPACE);
  public static final QName SYNC_GAL_ACCOUNT_RESPONSE =
      QName.get(E_SYNC_GAL_ACCOUNT_RESPONSE, NAMESPACE);

  // memcached
  public static final QName RELOAD_MEMCACHED_CLIENT_CONFIG_REQUEST =
      QName.get(E_RELOAD_MEMCACHED_CLIENT_CONFIG_REQUEST, NAMESPACE);
  public static final QName RELOAD_MEMCACHED_CLIENT_CONFIG_RESPONSE =
      QName.get(E_RELOAD_MEMCACHED_CLIENT_CONFIG_RESPONSE, NAMESPACE);
  public static final QName GET_MEMCACHED_CLIENT_CONFIG_REQUEST =
      QName.get(E_GET_MEMCACHED_CLIENT_CONFIG_REQUEST, NAMESPACE);
  public static final QName GET_MEMCACHED_CLIENT_CONFIG_RESPONSE =
      QName.get(E_GET_MEMCACHED_CLIENT_CONFIG_RESPONSE, NAMESPACE);

  // local config
  public static final QName RELOAD_LOCAL_CONFIG_REQUEST =
      QName.get(E_RELOAD_LOCAL_CONFIG_REQUEST, NAMESPACE);
  public static final QName RELOAD_LOCAL_CONFIG_RESPONSE =
      QName.get(E_RELOAD_LOCAL_CONFIG_RESPONSE, NAMESPACE);

  // wiki migration
  public static final QName MIGRATE_ACCOUNT_REQUEST =
      QName.get(E_MIGRATE_ACCOUNT_REQUEST, NAMESPACE);
  public static final QName MIGRATE_ACCOUNT_RESPONSE =
      QName.get(E_MIGRATE_ACCOUNT_RESPONSE, NAMESPACE);
  ...
  public static final QName REFRESH_REGISTERED_AUTHTOKENS_REQUEST =
      QName.get(E_REFRESH_REGISTERED_AUTHTOKENS_REQUEST, NAMESPACE);
  ...
  public static final QName AUTO_PROV_ACCOUNT_RESPONSE =
      QName.get(E_AUTO_PROV_ACCOUNT_RESPONSE, NAMESPACE);
  public static final QName AUTO_PROV_TASK_CONTROL_REQUEST =
      QName.get(E_AUTO_PROV_TASK_CONTROL_REQUEST, NAMESPACE);
  public static final QName AUTO_PROV_TASK_CONTROL_RESPONSE =
      QName.get(E_AUTO_PROV_TASK_CONTROL_RESPONSE, NAMESPACE);
  public static final QName SEARCH_AUTO_PROV_DIRECTORY_REQUEST =
      QName.get(E_SEARCH_AUTO_PROV_DIRECTORY_REQUEST, NAMESPACE);
  public static final QName SEARCH_AUTO_PROV_DIRECTORY_RESPONSE =
      QName.get(E_SEARCH_AUTO_PROV_DIRECTORY_RESPONSE, NAMESPACE);

  // Retention policy
  public static final QName GET_SYSTEM_RETENTION_POLICY_REQUEST =
      QName.get(E_GET_SYSTEM_RETENTION_POLICY_REQUEST, NAMESPACE);
  public static final QName CREATE_SYSTEM_RETENTION_POLICY_REQUEST =
      QName.get(E_CREATE_SYSTEM_RETENTION_POLICY_REQUEST, NAMESPACE);
  public static final QName MODIFY_SYSTEM_RETENTION_POLICY_REQUEST =
      QName.get(E_MODIFY_SYSTEM_RETENTION_POLICY_REQUEST, NAMESPACE);
  public static final QName DELETE_SYSTEM_RETENTION_POLICY_REQUEST =
      QName.get(E_DELETE_SYSTEM_RETENTION_POLICY_REQUEST, NAMESPACE);

  // Store Manager Verifier
  public static final QName VERIFY_STORE_MANAGER_REQUEST =
      QName.get(E_VERIFY_STORE_MANAGER_REQUEST, NAMESPACE);
  ...
  public static final String E_GET_OUTGOING_FILTER_RULES_RESPONSE =
      "GetOutgoingFilterRulesResponse";
  public static final String E_MODIFY_OUTGOING_FILTER_RULES_REQUEST =
      "ModifyOutgoingFilterRulesRequest";
  public static final String E_MODIFY_OUTGOING_FILTER_RULES_RESPONSE =
  ...
  public static final QName GET_FILTER_RULES_REQUEST =
      QName.get(E_GET_FILTER_RULES_REQUEST, NAMESPACE);
  public static final QName GET_FILTER_RULES_RESPONSE =
      QName.get(E_GET_FILTER_RULES_RESPONSE, NAMESPACE);
  public static final QName MODIFY_FILTER_RULES_REQUEST =
      QName.get(E_MODIFY_FILTER_RULES_REQUEST, NAMESPACE);
  public static final QName MODIFY_FILTER_RULES_RESPONSE =
      QName.get(E_MODIFY_FILTER_RULES_RESPONSE, NAMESPACE);
  public static final QName GET_OUTGOING_FILTER_RULES_REQUEST =
      QName.get(E_GET_OUTGOING_FILTER_RULES_REQUEST, NAMESPACE);
  public static final QName GET_OUTGOING_FILTER_RULES_RESPONSE =
      QName.get(E_GET_OUTGOING_FILTER_RULES_RESPONSE, NAMESPACE);
  public static final QName MODIFY_OUTGOING_FILTER_RULES_REQUEST =
      QName.get(E_MODIFY_OUTGOING_FILTER_RULES_REQUEST, NAMESPACE);
  public static final QName MODIFY_OUTGOING_FILTER_RULES_RESPONSE =
      QName.get(E_MODIFY_OUTGOING_FILTER_RULES_RESPONSE, NAMESPACE);
  ...
  public static final QName DELETE_ADDRESS_LIST_REQUEST =
      QName.get(E_DELETE_ADDRESS_LIST_REQUEST, NAMESPACE);
  public static final QName DELETE_ADDRESS_LIST_RESPONSE =
      QName.get(E_DELETE_ADDRESS_LIST_RESPONSE, NAMESPACE);
  ...
  public static final QName MODIFY_ADDRESS_LIST_REQUEST =
      QName.get(E_MODIFY_ADDRESS_LIST_REQUEST, NAMESPACE);
  public static final QName MODIFY_ADDRESS_LIST_RESPONSE =
      QName.get(E_MODIFY_ADDRESS_LIST_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_ADDRESS_LIST_INFO_REQUEST =
      QName.get(E_GET_ADDRESS_LIST_INFO_REQUEST, NAMESPACE);
  public static final QName GET_ADDRESS_LIST_INFO_RESPONSE =
      QName.get(E_GET_ADDRESS_LIST_INFO_RESPONSE, NAMESPACE);
  ...
  public static final String A_MEMCACHED_CLIENT_CONFIG_DEFAULT_EXPIRY_SECONDS =
      "defaultExpirySeconds";
  public static final String A_MEMCACHED_CLIENT_CONFIG_DEFAULT_TIMEOUT_MILLIS =
  ...
  public static final QName GET_CREATE_ADDRESS_LIST_REQUEST =
      QName.get(E_CREATE_ADDRESS_LIST_REQUEST, NAMESPACE);
  public static final QName GET_CREATE_ADDRESS_LIST_RESPONSE =
      QName.get(E_CREATE_ADDRESS_LIST_RESPONSE, NAMESPACE);
