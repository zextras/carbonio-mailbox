...
public class InputStreamRequestHttpRetryHandler extends DefaultHttpRequestRetryHandler {
  ...
  @Override
  /**
   * Same as default, but returns false if method is an unbuffered input stream request This avoids
   * HttpMethodDirector masking real IO exception with bogus 'Unbuffered content cannot be retried'
   * exception
   */
