...
public class HttpClientUtil {
  ...
  public static HttpResponse executeMethod(HttpRequestBase method)
  ...
  public static HttpResponse executeMethod(HttpClient client, HttpRequestBase method)
      throws HttpException, IOException {
    return executeMethod(client, method, null, null);
  }

  public static HttpResponse executeMethod(
      HttpClient client, HttpRequestBase method, BasicCookieStore state, HttpClientContext context)
      throws HttpException, IOException {
  ...
  public static HttpResponse executeMethod(
      HttpClient client, HttpRequestBase method, HttpClientContext context)
      throws HttpException, IOException {
