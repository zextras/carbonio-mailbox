...
public class ItemIdentifier implements Serializable {
  ...
  public static ItemIdentifier fromOwnerAndRemoteId(String ownerId, String remoteId)
    ...
    try {
      ...
      throw ServiceException.INVALID_REQUEST(
          String.format(
              "malformed item ID - can't be based on : ownerId=%s remoteId=%s", ownerId, remoteId),
          nfe);
    }
  }
  ...
  public boolean sameAndFullyDefined(ItemIdentifier other) {
    ...
    return (this.id == other.id)
        && (this.subPartId == other.subPartId)
  ...
  public static String asSimplestString(String encoded, String authAccountId)
      throws ServiceException {
    return asSimplestString(fromEncodedAndDefaultAcctId(encoded, authAccountId), authAccountId);
  }

  public static List<ItemIdentifier> fromAccountIdAndItemIds(
      String accountId, Collection<Integer> ids) {
    if (null == ids) {
