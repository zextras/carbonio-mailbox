...
public interface MailboxStore {
    ...
    ExistingParentFolderStoreAndUnmatchedPart getParentFolderStoreAndUnmatchedPart(OpContext octxt,
        String path)
     ...
     */
    List<String> copyItemAction(OpContext ctxt, ItemIdentifier targetFolder,
        List<ItemIdentifier> idlist)
            throws ServiceException;
    ...
    void modifyFolderGrant(OpContext ctxt, FolderStore folder, GrantGranteeType granteeType,
        String granteeId,
    ...
    void alterTag(OpContext octxt, Collection<ItemIdentifier> ids, String tagName, boolean addTag)
            throws ServiceException;
    void setTags(OpContext octxt, Collection<ItemIdentifier> itemIds, int flags,
