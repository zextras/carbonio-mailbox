...
public enum GrantGranteeType {
  ...
  /**
   * @return zm-store ACL byte constant value equivalent usr --> GRANTEE_USER grp --> GRANTEE_GROUP
   *     all --> GRANTEE_AUTHUSER dom --> GRANTEE_DOMAIN cos --> GRANTEE_COS pub --> GRANTEE_PUBLIC
   *     guest --> GRANTEE_GUEST key --> GRANTEE_KEY
   */
  public byte asByte() {
    return byteEquiv;
  }
