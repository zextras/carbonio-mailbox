...
/**
 * For path e.g. "/foo/bar/baz/gub" where a mailbox has a Folder at "/foo/bar" but NOT one at
 * "/foo/bar/baz" this class can encapsulate this information where: parentFolderStore is the folder
 * at path "/foo/bar" unmatchedPart = "baz/gub".
 */
