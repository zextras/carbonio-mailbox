...
public class PortRule extends Rule {
  ...
  /* ------------------------------------------------------------ */
  /**
   * If the regex is not matched, handle the request with the http status and reason.
   *
  ...
  public String matchAndApply(
      String target, HttpServletRequest request, HttpServletResponse response) throws IOException {
  ...
  private String apply(String target, HttpServletRequest request, HttpServletResponse response)
      throws IOException {
    String reason = null;
  ...
  public String toString() {
    return super.toString()
        ...
        + "]"
        + "["
        + ((_regex != null) ? _regex.toString() : "")
        + "]"
        + "["
        + _httpErrorStatusRegexNotmatched
        + "]";
  }
}
