...
public final class Sieve {
      ...
      try {
        ...
        throw ServiceException.PARSE_ERROR(
            "Invalid value: "
                + value
                + ", valid values: "
                + Arrays.asList(StringComparison.values()),
            e);
      }
    }
  }
  ...
  public enum AddressPart {
    ...
    public static AddressPart fromString(String value) throws ServiceException {
      if (value == null) {
        return null;
      }
      try {
        ...
        throw ServiceException.PARSE_ERROR(
            "Invalid value: " + value + ", valid values: " + Arrays.asList(AddressPart.values()),
            e);
      }
    }
  }
  ...
  public enum Comparator {
    ...
    public static Comparator fromString(String value) throws ServiceException {
      if (value == null) return null;
      for (Comparator comparator : Comparator.values()) {
        if (comparator.toString().equals(value)) return comparator;
      }
      ...
      try {
        ...
        throw ServiceException.PARSE_ERROR(
            "Invalid value: "
                + value
                + ", valid values: "
                + Arrays.asList(NumberComparison.values()),
            e);
      }
    }
  }
      ...
      try {
        ...
        throw ServiceException.PARSE_ERROR(
            "Invalid value: "
                + value
                + ", valid values: "
                + Arrays.asList(ValueComparison.values()),
            e);
      }
    }
  }
