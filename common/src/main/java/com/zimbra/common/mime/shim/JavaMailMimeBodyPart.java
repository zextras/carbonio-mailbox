...
public class JavaMailMimeBodyPart extends MimeBodyPart implements JavaMailShim {
  ...
  public JavaMailMimeBodyPart(InputStream is) throws MessagingException {
    ...
    if (ZPARSER) {
      try {
        ...
        com.zimbra.common.mime.MimeParserInputStream mpis =
            new com.zimbra.common.mime.MimeParserInputStream(is);
        if (bcontent != null) {
  ...
  public JavaMailMimeBodyPart(InternetHeaders headers, byte[] content) throws MessagingException {
    ...
    if (ZPARSER) {
      ...
      try {
        ...
        com.zimbra.common.mime.MimeParserInputStream mpis =
            new com.zimbra.common.mime.MimeParserInputStream(is, hblock);
  ...
  static class SharedInputStreamSource extends FilterInputStream
      implements com.zimbra.common.mime.MimePart.InputStreamSource {
  ...
  public void setDisposition(String disposition) throws MessagingException {
    if (ZPARSER) {
      ...
      if (hasDisposition && disposition != null) {
        zpart.setMimeHeader(
            "Content-Disposition", zpart.getContentDisposition().setDisposition(disposition));
    ...
    if (ZPARSER) {
      if (jmcontent != null) {
        ...
        return this.jmcontent =
            new JavaMailMimeMultipart((com.zimbra.common.mime.MimeMultipart) zpart, this);
      } else {
  ...
  private static final String[] NON_TRANSFERRED =
      new String[] {"Content-Type", "Content-Transfer-Encoding"};

  static void transferHeaders(
      com.zimbra.common.mime.MimePart from, com.zimbra.common.mime.MimePart to) {
    if (from == null || to == null) {
      return;
    }
    for (com.zimbra.common.mime.MimeHeader header :
        new com.zimbra.common.mime.MimeHeaderBlock(from.getMimeHeaderBlock(), NON_TRANSFERRED)) {
      to.addMimeHeader(header);
    }
  }

  private com.zimbra.common.mime.MimePart replaceInParent(com.zimbra.common.mime.MimePart mp)
  ...
  static com.zimbra.common.mime.MimePart parsePart(DataSource ds) throws MessagingException {
    com.zimbra.common.mime.ContentType ctype =
        new com.zimbra.common.mime.ContentType(ds.getContentType());
    com.zimbra.common.mime.MimeHeaderBlock zheaders =
        new com.zimbra.common.mime.MimeHeaderBlock(ctype);
  ...
  public void attachFile(File file) throws IOException, MessagingException {
    if (ZPARSER) {
      com.zimbra.common.mime.ContentType ctype =
          new com.zimbra.common.mime.ContentType("application/octet-stream");
