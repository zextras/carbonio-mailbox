...
public class JavaMailMimeMultipart extends MimeMultipart implements JavaMailShim {
  ...
  private Map<com.zimbra.common.mime.MimePart, JavaMailMimeBodyPart> partMap =
      new HashMap<com.zimbra.common.mime.MimePart, JavaMailMimeBodyPart>();
  ...
  @Override
  protected JavaMailInternetHeaders createInternetHeaders(InputStream is)
      throws MessagingException {
    return new JavaMailInternetHeaders(is);
  }

  @Override
  protected JavaMailMimeBodyPart createMimeBodyPart(InternetHeaders headers, byte[] content)
      throws MessagingException {
  ...
  @Override
  protected synchronized void setMultipartDataSource(MultipartDataSource mpds)
      throws MessagingException {
    if (ZPARSER) {
      com.zimbra.common.mime.ContentType ctype =
          new com.zimbra.common.mime.ContentType(mpds.getContentType(), "multipart/mixed");
      if (!ctype.getPrimaryType().equals("multipart")) {
        throw new MessagingException(
            "invalid (non-multipart) Content-Type: " + mpds.getContentType());
      }
      ...
      com.zimbra.common.mime.MimeHeaderBlock headers =
