...
public class JavaMailMimeMessage extends MimeMessage implements JavaMailShim {
  ...
  public JavaMailMimeMessage(Session session, InputStream is) throws MessagingException {
    ...
    if (ZPARSER) {
      if (is instanceof SharedInputStream
          && !(is instanceof com.zimbra.common.mime.MimePart.InputStreamSource)) {
        is = new JavaMailMimeBodyPart.SharedInputStreamSource((SharedInputStream) is);
      }
      try {
        zmessage =
            new com.zimbra.common.mime.MimeMessage(
                is, session == null ? null : session.getProperties());
  ...
  public JavaMailMimeMessage(MimeMessage mm) throws MessagingException {
    ...
    super(
        mm instanceof JavaMailMimeMessage
            ? ((JavaMailMimeMessage) mm).getSession()
            : Session.getInstance(new Properties()));
    if (ZPARSER) {
      if (mm instanceof JavaMailMimeMessage) {
        zmessage =
            new com.zimbra.common.mime.MimeMessage(
                ((JavaMailMimeMessage) mm).getZimbraMimeMessage());
      } else {
  ...
  private List<com.zimbra.common.mime.InternetAddress> getZimbraAddressList(String name)
  ...
  private void setAddress(String name, Address address) {
    com.zimbra.common.mime.InternetAddress iaddr =
        JavaMailInternetAddress.asZimbraInternetAddress(address);
  ...
  private void setAddressList(
      String name, Address[] addresses, List<com.zimbra.common.mime.InternetAddress> iaddrs) {
    if (addresses != null) {
      if (iaddrs == null) {
  ...
  public Address[] getAllRecipients() throws MessagingException {
    if (ZPARSER) {
      ...
      List<com.zimbra.common.mime.InternetAddress> iaddrs =
          new ArrayList<com.zimbra.common.mime.InternetAddress>();
  ...
  public void setRecipients(Message.RecipientType type, String addresses)
    ...
    if (ZPARSER) {
      ...
      zmessage.setAddressHeader(
          name, com.zimbra.common.mime.InternetAddress.parseHeader(addresses));
    } else {
      super.setRecipients(type, addresses);
    }
  }
  ...
  /**
   * Returns an InputStream consisting of the entire message, as would be written in a call to
  ...
  public Object getContent() throws IOException, MessagingException {
    if (ZPARSER) {
      ...
      if (jmcontent != null) {
        ...
        return jmcontent =
            new JavaMailMimeMultipart((com.zimbra.common.mime.MimeMultipart) body, this);
      } else {
  ...
  private void setDataSource(DataSource ds) throws MessagingException {
    ...
    if (!(body instanceof com.zimbra.common.mime.MimeMultipart)
        && ds.getName() != null
        && !ds.getName().trim().isEmpty()) {
  ...
  public void addHeaderLine(String line) throws MessagingException {
    if (ZPARSER) {
      ...
      if (parsed != null && "Content-Type".equalsIgnoreCase(parsed.getFirst())) {
        com.zimbra.common.mime.ContentType ctype =
            new com.zimbra.common.mime.ContentType(new String(parsed.getSecond()));
        if (ctype.getPrimaryType().equals("multipart")) {
          com.zimbra.common.mime.MimeMultipart mmp =
              new com.zimbra.common.mime.MimeMultipart(ctype.getSubType());
