...
/**
 * Passthrough <tt>InputStream</tt> that performs very simple validation of an RFC822 message. If a
 * line in the message data exceeds the maximum number of characters, {@link #isValid} returns
 * <tt>false</tt>.
 */
