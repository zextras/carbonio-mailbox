...
public class JavaMailInternetAddress extends InternetAddress implements JavaMailShim {
  ...
  public JavaMailInternetAddress(String address) throws AddressException {
    ...
    if (ZPARSER) {
      List<com.zimbra.common.mime.InternetAddress> addrs =
          com.zimbra.common.mime.InternetAddress.parseHeader(address);
      if (addrs.size() != 1) {
  ...
  com.zimbra.common.mime.InternetAddress reverseIfNecessary(
      com.zimbra.common.mime.InternetAddress iaddr) {
    if (iaddr != null && iaddr.getAddress() == null && iaddr.getPersonal() != null) {
      return new com.zimbra.common.mime.InternetAddress(iaddr.getAddress(), iaddr.getPersonal())
          .setCharset(iaddr.getCharset());
    } else {
      return iaddr;
    }
  }
  ...
  static Address[] asJavaMailInternetAddresses(
      Collection<com.zimbra.common.mime.InternetAddress> iaddrs) {
    if (iaddrs == null) {
      return null;
    }
  ...
  public static InternetAddress[] parseHeader(String addresslist, boolean strict)
    ...
    if (ZPARSER) {
      List<com.zimbra.common.mime.InternetAddress> addrs =
          com.zimbra.common.mime.InternetAddress.parseHeader(addresslist);
  ...
  public InternetAddress clone() {
    if (ZPARSER) {
      return new JavaMailInternetAddress(
          new com.zimbra.common.mime.InternetAddress(mAddress), false);
    } else {
    ...
    if (ZPARSER) {
      if (a instanceof JavaMailInternetAddress) {
        ...
        return mAddress.equals(
            new com.zimbra.common.mime.InternetAddress(addr.getPersonal(), addr.getAddress()));
      } else {
        return false;
      }
    } else {
  ...
  public InternetAddress[] getGroup(boolean strict) throws AddressException {
    if (ZPARSER) {
      ...
      com.zimbra.common.mime.InternetAddress.Group group =
          (com.zimbra.common.mime.InternetAddress.Group) mAddress;
