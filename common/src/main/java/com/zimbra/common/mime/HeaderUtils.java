...
public class HeaderUtils {
  ...
  static String decodeWord(byte[] word) {
    ...
    if (encoding == 'Q' || encoding == 'q') {
      ...
      decoder =
          new ContentTransferEncoding.Base64DecoderStream(
              new ByteArrayInputStream(word, pos + 1, remaining));
    } else {
      return null;
    }
    ...
    try {
      ...
      throw oome;
        ...
        Error e) { // bug 40926 - catch java.lang.Error thrown by String class for invalid charset
      // issues
      return null;
    } catch (Exception e) {
      return null;
