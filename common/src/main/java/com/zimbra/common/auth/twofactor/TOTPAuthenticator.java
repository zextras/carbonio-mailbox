...
public class TOTPAuthenticator {
  ...
  public boolean validateCode(String secret, long timestamp, String code, Encoding encoding)
  ...
  public String generateCode(String secret, long timestamp, Encoding encoding)
      throws ServiceException {
