...
public final class HsmConstants {
  ...
  public static final QName GET_HSM_STATUS_RESPONSE =
      QName.get(E_GET_HSM_STATUS_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_APPLIANCE_HSM_FS_REQUEST =
      QName.get(E_GET_APPLIANCE_HSM_FS_REQUEST, NAMESPACE);
  public static final QName GET_APPLIANCE_HSM_FS_RESPONSE =
      QName.get(E_GET_APPLIANCE_HSM_FS_RESPONSE, NAMESPACE);
