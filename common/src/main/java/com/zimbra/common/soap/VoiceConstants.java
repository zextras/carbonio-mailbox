...
public class VoiceConstants {
  ...
  public static final QName CHANGE_UC_PASSWORD_REQUEST =
      QName.get(E_CHANGE_UC_PASSWORD_REQUEST, NAMESPACE);
  public static final QName CHANGE_UC_PASSWORD_RESPONSE =
      QName.get(E_CHANGE_UC_PASSWORD_RESPONSE, NAMESPACE);

  public static final QName GET_VOICE_MAIL_PREFS_REQUEST =
      QName.get(E_GET_VOICE_MAIL_PREFS_REQUEST, NAMESPACE);
  public static final QName GET_VOICE_MAIL_PREFS_RESPONSE =
      QName.get(E_GET_VOICE_MAIL_PREFS_RESPONSE, NAMESPACE);

  public static final QName MODIFY_VOICE_MAIL_PREFS_REQUEST =
      QName.get(E_MODIFY_VOICE_MAIL_PREFS_REQUEST, NAMESPACE);
  public static final QName MODIFY_VOICE_MAIL_PREFS_RESPONSE =
      QName.get(E_MODIFY_VOICE_MAIL_PREFS_RESPONSE, NAMESPACE);

  public static final QName MODIFY_VOICE_MAIL_PIN_REQUEST =
      QName.get(E_MODIFY_VOICE_MAIL_PIN_REQUEST, NAMESPACE);
  public static final QName MODIFY_VOICE_MAIL_PIN_RESPONSE =
      QName.get(E_MODIFY_VOICE_MAIL_PIN_RESPONSE, NAMESPACE);

  public static final QName MODIFY_FROM_NUM_REQUEST =
      QName.get(E_MODIFY_FROM_NUM_REQUEST, NAMESPACE);
  public static final QName MODIFY_FROM_NUM_RESPONSE =
      QName.get(E_MODIFY_FROM_NUM_RESPONSE, NAMESPACE);

  public static final QName GET_VOICE_INFO_REQUEST = QName.get(E_GET_VOICE_INFO_REQUEST, NAMESPACE);
  public static final QName GET_VOICE_INFO_RESPONSE =
      QName.get(E_GET_VOICE_INFO_RESPONSE, NAMESPACE);

  public static final QName GET_VOICE_FOLDER_REQUEST =
      QName.get(E_GET_VOICE_FOLDER_REQUEST, NAMESPACE);
  public static final QName GET_VOICE_FOLDER_RESPONSE =
      QName.get(E_GET_VOICE_FOLDER_RESPONSE, NAMESPACE);
  ...
  public static final QName VOICE_MSG_ACTION_REQUEST =
      QName.get(E_VOICE_MSG_ACTION_REQUEST, NAMESPACE);
  public static final QName VOICE_MSG_ACTION_RESPONSE =
      QName.get(E_VOICE_MSG_ACTION_RESPONSE, NAMESPACE);

  public static final QName GET_VOICE_FEATURES_REQUEST =
      QName.get(E_GET_VOICE_FEATURES_REQUEST, NAMESPACE);
  public static final QName GET_VOICE_FEATURES_RESPONSE =
      QName.get(E_GET_VOICE_FEATURES_RESPONSE, NAMESPACE);

  public static final QName MODIFY_VOICE_FEATURES_REQUEST =
      QName.get(E_MODIFY_VOICE_FEATURES_REQUEST, NAMESPACE);
  public static final QName MODIFY_VOICE_FEATURES_RESPONSE =
      QName.get(E_MODIFY_VOICE_FEATURES_RESPONSE, NAMESPACE);

  public static final QName RESET_VOICE_FEATURES_REQUEST =
      QName.get(E_RESET_VOICE_FEATURES_REQUEST, NAMESPACE);
  public static final QName RESET_VOICE_FEATURES_RESPONSE =
      QName.get(E_RESET_VOICE_FEATURES_RESPONSE, NAMESPACE);

  public static final QName UPLOAD_VOICE_MAIL_REQUEST =
      QName.get(E_UPLOAD_VOICE_MAIL_REQUEST, NAMESPACE);
  public static final QName UPLOAD_VOICE_MAIL_RESPONSE =
      QName.get(E_UPLOAD_VOICE_MAIL_RESPONSE, NAMESPACE);
  ...
  // public static final String E_CALL_FORWARD_COMBINATION   = "callforwardcombination"; //
  // Deprecated in jr-vnes v1.6
  ...
  public static final String C_UNKNOWN =
      "unknown"; // for cases gateway do not return us a value it should,
