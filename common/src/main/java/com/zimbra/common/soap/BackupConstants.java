...
public final class BackupConstants {
  ...
  public static final String E_REGISTER_MAILBOX_MOVE_OUT_RESPONSE =
      "RegisterMailboxMoveOutResponse";
  public static final String E_UNREGISTER_MAILBOX_MOVE_OUT_REQUEST =
      "UnregisterMailboxMoveOutRequest";
  public static final String E_UNREGISTER_MAILBOX_MOVE_OUT_RESPONSE =
  ...
  public static final QName BACKUP_ACCOUNT_QUERY_REQUEST =
      QName.get(E_BACKUP_ACCOUNT_QUERY_REQUEST, NAMESPACE);
  public static final QName BACKUP_ACCOUNT_QUERY_RESPONSE =
      QName.get(E_BACKUP_ACCOUNT_QUERY_RESPONSE, NAMESPACE);
  ...
  public static final QName ROLLOVER_REDOLOG_REQUEST =
      QName.get(E_ROLLOVER_REDOLOG_REQUEST, NAMESPACE);
  public static final QName ROLLOVER_REDOLOG_RESPONSE =
      QName.get(E_ROLLOVER_REDOLOG_RESPONSE, NAMESPACE);

  public static final QName PURGE_MOVED_MAILBOX_REQUEST =
      QName.get(E_PURGE_MOVED_MAILBOX_REQUEST, NAMESPACE);
  public static final QName PURGE_MOVED_MAILBOX_RESPONSE =
      QName.get(E_PURGE_MOVED_MAILBOX_RESPONSE, NAMESPACE);

  public static final QName SCHEDULE_BACKUPS_REQUEST =
      QName.get(E_SCHEDULE_BACKUPS_REQUEST, NAMESPACE);
  public static final QName SCHEDULE_BACKUPS_RESPONSE =
      QName.get(E_SCHEDULE_BACKUPS_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_MAILBOX_VERSION_REQUEST =
      QName.get(E_GET_MAILBOX_VERSION_REQUEST, NAMESPACE);
  public static final QName GET_MAILBOX_VERSION_RESPONSE =
      QName.get(E_GET_MAILBOX_VERSION_RESPONSE, NAMESPACE);
  public static final QName GET_MAILBOX_VOLUMES_REQUEST =
      QName.get(E_GET_MAILBOX_VOLUMES_REQUEST, NAMESPACE);
  public static final QName GET_MAILBOX_VOLUMES_RESPONSE =
      QName.get(E_GET_MAILBOX_VOLUMES_RESPONSE, NAMESPACE);
  ...
  public static final QName UNLOAD_MAILBOX_RESPONSE =
      QName.get(E_UNLOAD_MAILBOX_RESPONSE, NAMESPACE);
  ...
  public static final QName RELOAD_ACCOUNT_RESPONSE =
      QName.get(E_RELOAD_ACCOUNT_RESPONSE, NAMESPACE);
  public static final QName REGISTER_MAILBOX_MOVE_OUT_REQUEST =
      QName.get(E_REGISTER_MAILBOX_MOVE_OUT_REQUEST, NAMESPACE);
  public static final QName REGISTER_MAILBOX_MOVE_OUT_RESPONSE =
      QName.get(E_REGISTER_MAILBOX_MOVE_OUT_RESPONSE, NAMESPACE);
  public static final QName UNREGISTER_MAILBOX_MOVE_OUT_REQUEST =
      QName.get(E_UNREGISTER_MAILBOX_MOVE_OUT_REQUEST, NAMESPACE);
  public static final QName UNREGISTER_MAILBOX_MOVE_OUT_RESPONSE =
      QName.get(E_UNREGISTER_MAILBOX_MOVE_OUT_RESPONSE, NAMESPACE);
  public static final QName QUERY_MAILBOX_MOVE_REQUEST =
      QName.get(E_QUERY_MAILBOX_MOVE_REQUEST, NAMESPACE);
  public static final QName QUERY_MAILBOX_MOVE_RESPONSE =
      QName.get(E_QUERY_MAILBOX_MOVE_RESPONSE, NAMESPACE);
