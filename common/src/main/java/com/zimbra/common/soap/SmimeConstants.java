...
public class SmimeConstants {
  ...
  public static final QName SEND_SECURE_MSG_REQUEST =
      QName.get(E_SEND_SECURE_MSG_REQUEST, MailConstants.NAMESPACE);
  public static final QName SEND_SECURE_MSG_RESPONSE =
      QName.get(E_SEND_SECURE_MSG_RESPONSE, MailConstants.NAMESPACE);
  public static final QName GET_SMIME_CERT_INFO_REQUEST =
      QName.get(E_GET_SMIME_CERT_INFO_REQUEST, AccountConstants.NAMESPACE);
  public static final QName GET_SMIME_CERT_INFO_RESPONSE =
      QName.get(E_GET_SMIME_CERT_INFO_RESPONSE, AccountConstants.NAMESPACE);
  public static final QName SAVE_SMIME_CERTIFICATE_REQUEST =
      QName.get(E_SAVE_SMIME_CERTIFICATE_REQUEST, AccountConstants.NAMESPACE);
  public static final QName SAVE_SMIME_CERTIFICATE_RESPONSE =
      QName.get(E_SAVE_SMIME_CERTIFICATE_RESPONSE, AccountConstants.NAMESPACE);
  ...
  public static final String ERROR_MESSAGE_VERIFIER_NOT_VALID_AT_SIGNINGTIME =
      "verifier not valid at signingTime";
  public static final String ERROR_MESSAGE_SIGNER_DIGEST_MISMATCH =
  ...
  public static final String ERROR_MESSAGE_CERTIFICATE_NOT_TRUSTED =
      "Path does not chain with any of the trust anchors";
  public static final String ERROR_MESSAGE_CERTIFICATE_NOT_YET_VALID =
      "client certificate not yet valid";
  public static final String ERROR_MESSAGE_CANT_GENERATE_CERT_PATH =
      "can't generate certpath for client certificate";
  public static final String ERROR_MESSAGE_KEYSTORE_EXCEPTION =
      "received KeyStoreException while loading KeyStore";
  public static final String ERROR_MESSAGE_NO_SUCH_ALGORITHM_EXCEPTION =
      "received NoSuchAlgorithmException while obtaining instance of certpath validator";
  public static final String ERROR_MESSAGE_KEYSTORE_CANT_BE_FOUND =
      "mailboxd keystore can't be found";
  public static final String ERROR_MESSAGE_IO_EXCEPTION = "received IOException";
  public static final String ERROR_MESSAGE_INVALID_ALGORITHM_PARAMETER =
      "received InvalidAlgorithmParameter while obtaining instance of certpath validator";
  ...
  public static final String ERRORCODE_VERIFIER_NOT_VALID_AT_SIGNING_TIME =
      "VERIFIER_NOT_VALID_AT_SIGNING_TIME";
  ...
  public static final String ERRORCODE_CERTIFICATE_EMAIL_ADDRESS_NOT_MATCHING =
      "CERTIFICATE_EMAIL_ADDRESS_NOT_MATCHING";
  public static final String ERRORCODE_CERTIFICATE_VALIDATION_FAILED =
