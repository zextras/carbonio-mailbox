...
public final class ReplicationConstants {
  ...
  public static final QName REPLICATION_STATUS_REQUEST =
      QName.get(E_REPLICATION_STATUS_REQUEST, NAMESPACE);
  public static final QName REPLICATION_STATUS_RESPONSE =
      QName.get(E_REPLICATION_STATUS_RESPONSE, NAMESPACE);
  ...
  public static final QName BRING_UP_SERVICE_IP_REQUEST =
      QName.get(E_BRING_UP_SERVICE_IP_REQUEST, NAMESPACE);
  public static final QName BRING_UP_SERVICE_IP_RESPONSE =
      QName.get(E_BRING_UP_SERVICE_IP_RESPONSE, NAMESPACE);
  public static final QName BRING_DOWN_SERVICE_IP_REQUEST =
      QName.get(E_BRING_DOWN_SERVICE_IP_REQUEST, NAMESPACE);
  public static final QName BRING_DOWN_SERVICE_IP_RESPONSE =
      QName.get(E_BRING_DOWN_SERVICE_IP_RESPONSE, NAMESPACE);
  public static final QName START_HA_CLIENT_REQUEST =
      QName.get(E_START_HA_CLIENT_REQUEST, NAMESPACE);
  public static final QName START_HA_CLIENT_RESPONSE =
      QName.get(E_START_HA_CLIENT_RESPONSE, NAMESPACE);
  public static final QName STOP_HA_CLIENT_REQUEST = QName.get(E_STOP_HA_CLIENT_REQUEST, NAMESPACE);
  public static final QName STOP_HA_CLIENT_RESPONSE =
      QName.get(E_STOP_HA_CLIENT_RESPONSE, NAMESPACE);
  public static final QName START_HA_DAEMON_REQUEST =
      QName.get(E_START_HA_DAEMON_REQUEST, NAMESPACE);
  public static final QName START_HA_DAEMON_RESPONSE =
      QName.get(E_START_HA_DAEMON_RESPONSE, NAMESPACE);
  public static final QName STOP_HA_DAEMON_REQUEST = QName.get(E_STOP_HA_DAEMON_REQUEST, NAMESPACE);
  public static final QName STOP_HA_DAEMON_RESPONSE =
      QName.get(E_STOP_HA_DAEMON_RESPONSE, NAMESPACE);
  ...
  public static final String A_REPLICATION_ENABLED =
      "replicationEnabled"; // whether replication is enabled
  public static final String A_CURRENT_ROLE = "currentRole"; // currently running as master or slave
  public static final String A_ORIGINAL_ROLE =
      "originalRole"; // master or slave as originally configured
  public static final String A_MASTER_OPERATING_MODE =
      "masterOperatingMode"; // RedoLogManager.OPMODE_*
