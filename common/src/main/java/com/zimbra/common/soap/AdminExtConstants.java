...
public final class AdminExtConstants {
  ...
  public static final String E_GENERATE_BULK_PROV_FROM_LDAP_REQUEST =
      "GenerateBulkProvisionFileFromLDAPRequest";
  public static final String E_GENERATE_BULK_PROV_FROM_LDAP_RESPONSE =
      "GenerateBulkProvisionFileFromLDAPResponse";
  ...
  public static final String E_GET_BULK_IMAP_IMPORT_TASKLIST_REQUEST =
      "GetBulkIMAPImportTaskListRequest";
  public static final String E_GET_BULK_IMAP_IMPORT_TASKLIST_RESPONSE =
      "GetBulkIMAPImportTaskListResponse";
  public static final String E_PURGE_BULK_IMAP_IMPORT_TASKS_REQUEST =
      "PurgeBulkIMAPImportTasksRequest";
  public static final String E_PURGE_BULK_IMAP_IMPORT_TASKS_RESPONSE =
      "PurgeBulkIMAPImportTasksResponse";

  public static final QName BULK_IMPORT_ACCOUNTS_REQUEST =
      QName.get(E_BULK_IMPORT_ACCOUNTS_REQUEST, NAMESPACE);
  public static final QName BULK_IMPORT_ACCOUNTS_RESPONSE =
      QName.get(E_BULK_IMPORT_ACCOUNTS_RESPONSE, NAMESPACE);

  public static final QName GENERATE_BULK_PROV_FROM_LDAP_REQUEST =
      QName.get(E_GENERATE_BULK_PROV_FROM_LDAP_REQUEST, NAMESPACE);
  public static final QName GENERATE_BULK_PROV_FROM_LDAP_RESPONSE =
      QName.get(E_GENERATE_BULK_PROV_FROM_LDAP_RESPONSE, NAMESPACE);

  public static final QName BULK_IMAP_DATA_IMPORT_REQUEST =
      QName.get(E_BULK_IMAP_DATA_IMPORT_REQUEST, NAMESPACE);
  public static final QName BULK_IMAP_DATA_IMPORT_RESPONSE =
      QName.get(E_BULK_IMAP_DATA_IMPORT_RESPONSE, NAMESPACE);

  public static final QName GET_BULK_IMAP_IMPORT_TASK_REQUEST =
      QName.get(E_GET_BULK_IMAP_IMPORT_TASK_REQUEST, NAMESPACE);
  public static final QName GET_BULK_IMAP_IMPORT_TASK_RESPONSE =
      QName.get(E_GET_BULK_IMAP_IMPORT_TASK_RESPONSE, NAMESPACE);

  public static final QName GET_BULK_IMAP_IMPORT_TASKLIST_REQUEST =
      QName.get(E_GET_BULK_IMAP_IMPORT_TASKLIST_REQUEST, NAMESPACE);
  public static final QName GET_BULK_IMAP_IMPORT_TASKLIST_RESPONSE =
      QName.get(E_GET_BULK_IMAP_IMPORT_TASKLIST_RESPONSE, NAMESPACE);

  public static final QName PURGE_BULK_IMAP_IMPORT_TASKS_REQUEST =
      QName.get(E_PURGE_BULK_IMAP_IMPORT_TASKS_REQUEST, NAMESPACE);
  public static final QName PURGE_BULK_IMAP_IMPORT_TASKS_RESPONSE =
      QName.get(E_PURGE_BULK_IMAP_IMPORT_TASKS_RESPONSE, NAMESPACE);
