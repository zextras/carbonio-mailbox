...
public final class MailConstants {
  ...
  public static final String E_APPLY_OUTGOING_FILTER_RULES_REQUEST =
      "ApplyOutgoingFilterRulesRequest";
  public static final String E_APPLY_OUTGOING_FILTER_RULES_RESPONSE =
  ...
  public static final String E_DECLINE_COUNTER_APPOINTMENT_REQUEST =
      "DeclineCounterAppointmentRequest";
  public static final String E_DECLINE_COUNTER_APPOINTMENT_RESPONSE =
  ...
  public static final String E_GET_EFFECTIVE_FOLDER_PERMS_REQUEST =
      "GetEffectiveFolderPermsRequest";
  public static final String E_GET_EFFECTIVE_FOLDER_PERMS_RESPONSE =
  ...
  public static final String E_INVALIDATE_REMINDER_DEVICE_REQUEST =
      "InvalidateReminderDeviceRequest";
  public static final String E_INVALIDATE_REMINDER_DEVICE_RESPONSE =
  ...
  public static final String E_RESET_RECENT_MESSAGE_COUNT_REQUEST =
      "ResetRecentMessageCountRequest";
  public static final String E_RESET_RECENT_MESSAGE_COUNT_RESPONSE =
  ...
  public static final String E_GET_LAST_ITEM_ID_IN_MAILBOX_REQUEST =
      "GetLastItemIdInMailboxRequest";
  public static final String E_GET_LAST_ITEM_ID_IN_MAILBOX_RESPONSE =
  ...
  public static final QName EMPTY_DUMPSTER_RESPONSE =
      QName.get(E_EMPTY_DUMPSTER_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_MAILBOX_METADATA_REQUEST =
      QName.get(E_GET_MAILBOX_METADATA_REQUEST, NAMESPACE);
  public static final QName GET_MAILBOX_METADATA_RESPONSE =
      QName.get(E_GET_MAILBOX_METADATA_RESPONSE, NAMESPACE);
  public static final QName SET_MAILBOX_METADATA_REQUEST =
      QName.get(E_SET_MAILBOX_METADATA_REQUEST, NAMESPACE);
  public static final QName SET_MAILBOX_METADATA_RESPONSE =
      QName.get(E_SET_MAILBOX_METADATA_RESPONSE, NAMESPACE);
  public static final QName MODIFY_MAILBOX_METADATA_REQUEST =
      QName.get(E_MODIFY_MAILBOX_METADATA_REQUEST, NAMESPACE);
  public static final QName MODIFY_MAILBOX_METADATA_RESPONSE =
      QName.get(E_MODIFY_MAILBOX_METADATA_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_MSG_METADATA_REQUEST =
      QName.get(E_GET_MSG_METADATA_REQUEST, NAMESPACE);
  public static final QName GET_MSG_METADATA_RESPONSE =
      QName.get(E_GET_MSG_METADATA_RESPONSE, NAMESPACE);
  ...
  public static final QName SEND_SHARE_NOTIFICATION_REQUEST =
      QName.get(E_SEND_SHARE_NOTIFICATION_REQUEST, NAMESPACE);
  public static final QName SEND_SHARE_NOTIFICATION_RESPONSE =
      QName.get(E_SEND_SHARE_NOTIFICATION_RESPONSE, NAMESPACE);
  ...
  public static final QName REMOVE_ATTACHMENTS_REQUEST =
      QName.get(E_REMOVE_ATTACHMENTS_REQUEST, NAMESPACE);
  public static final QName REMOVE_ATTACHMENTS_RESPONSE =
      QName.get(E_REMOVE_ATTACHMENTS_RESPONSE, NAMESPACE);
  // folders
  ...
  // saved searches
  public static final QName CREATE_SEARCH_FOLDER_REQUEST =
      QName.get(E_CREATE_SEARCH_FOLDER_REQUEST, NAMESPACE);
  public static final QName CREATE_SEARCH_FOLDER_RESPONSE =
      QName.get(E_CREATE_SEARCH_FOLDER_RESPONSE, NAMESPACE);
  public static final QName GET_SEARCH_FOLDER_REQUEST =
      QName.get(E_GET_SEARCH_FOLDER_REQUEST, NAMESPACE);
  public static final QName GET_SEARCH_FOLDER_RESPONSE =
      QName.get(E_GET_SEARCH_FOLDER_RESPONSE, NAMESPACE);
  public static final QName MODIFY_SEARCH_FOLDER_REQUEST =
      QName.get(E_MODIFY_SEARCH_FOLDER_REQUEST, NAMESPACE);
  public static final QName MODIFY_SEARCH_FOLDER_RESPONSE =
      QName.get(E_MODIFY_SEARCH_FOLDER_RESPONSE, NAMESPACE);
  // mountpoints
  public static final QName CREATE_MOUNTPOINT_REQUEST =
      QName.get(E_CREATE_MOUNTPOINT_REQUEST, NAMESPACE);
  public static final QName CREATE_MOUNTPOINT_RESPONSE =
      QName.get(E_CREATE_MOUNTPOINT_RESPONSE, NAMESPACE);
  public static final QName ENABLE_SHARED_REMINDER_REQUEST =
      QName.get(E_ENABLE_SHARED_REMINDER_REQUEST, NAMESPACE);
  public static final QName ENABLE_SHARED_REMINDER_RESPONSE =
      QName.get(E_ENABLE_SHARED_REMINDER_RESPONSE, NAMESPACE);
  // contacts
  public static final QName CREATE_CONTACT_REQUEST = QName.get(E_CREATE_CONTACT_REQUEST, NAMESPACE);
  public static final QName CREATE_CONTACT_RESPONSE =
      QName.get(E_CREATE_CONTACT_RESPONSE, NAMESPACE);
  public static final QName MODIFY_CONTACT_REQUEST = QName.get(E_MODIFY_CONTACT_REQUEST, NAMESPACE);
  public static final QName MODIFY_CONTACT_RESPONSE =
      QName.get(E_MODIFY_CONTACT_RESPONSE, NAMESPACE);
  ...
  public static final QName IMPORT_CONTACTS_REQUEST =
      QName.get(E_IMPORT_CONTACTS_REQUEST, NAMESPACE);
  public static final QName IMPORT_CONTACTS_RESPONSE =
      QName.get(E_IMPORT_CONTACTS_RESPONSE, NAMESPACE);
  public static final QName EXPORT_CONTACTS_REQUEST =
      QName.get(E_EXPORT_CONTACTS_REQUEST, NAMESPACE);
  public static final QName EXPORT_CONTACTS_RESPONSE =
      QName.get(E_EXPORT_CONTACTS_RESPONSE, NAMESPACE);
  public static final QName CONTACT_ACTION_REQUEST = QName.get(E_CONTACT_ACTION_REQUEST, NAMESPACE);
  public static final QName CONTACT_ACTION_RESPONSE =
      QName.get(E_CONTACT_ACTION_RESPONSE, NAMESPACE);
  public static final QName GET_CONTACT_BACKUP_LIST_REQUEST =
  ...
  public static final QName APPLY_FILTER_RULES_REQUEST =
      QName.get(E_APPLY_FILTER_RULES_REQUEST, NAMESPACE);
  public static final QName APPLY_FILTER_RULES_RESPONSE =
      QName.get(E_APPLY_FILTER_RULES_RESPONSE, NAMESPACE);
  ...
  public static final QName APPLY_OUTGOING_FILTER_RULES_REQUEST =
      QName.get(E_APPLY_OUTGOING_FILTER_RULES_REQUEST, NAMESPACE);
  public static final QName APPLY_OUTGOING_FILTER_RULES_RESPONSE =
  ...
  public static final QName FORWARD_APPOINTMENT_REQUEST =
      QName.get(E_FORWARD_APPOINTMENT_REQUEST, NAMESPACE);
  public static final QName FORWARD_APPOINTMENT_INVITE_REQUEST =
      QName.get(E_FORWARD_APPOINTMENT_INVITE_REQUEST, NAMESPACE);
  public static final QName ADD_APPOINTMENT_INVITE_REQUEST =
      QName.get(E_ADD_APPOINTMENT_INVITE_REQUEST, NAMESPACE);
  public static final QName ADD_APPOINTMENT_INVITE_RESPONSE =
      QName.get(E_ADD_APPOINTMENT_INVITE_RESPONSE, NAMESPACE);
  public static final QName COUNTER_APPOINTMENT_REQUEST =
      QName.get(E_COUNTER_APPOINTMENT_REQUEST, NAMESPACE);
  public static final QName COUNTER_APPOINTMENT_RESPONSE =
      QName.get(E_COUNTER_APPOINTMENT_RESPONSE, NAMESPACE);
  public static final QName DECLINE_COUNTER_APPOINTMENT_REQUEST =
      QName.get(E_DECLINE_COUNTER_APPOINTMENT_REQUEST, NAMESPACE);
  public static final QName DECLINE_COUNTER_APPOINTMENT_RESPONSE =
      QName.get(E_DECLINE_COUNTER_APPOINTMENT_RESPONSE, NAMESPACE);
  public static final QName IMPORT_APPOINTMENTS_REQUEST =
  ...
  //    public static final QName GET_CALITEM_REQUEST = QName.get("GetCalendarItemRequest",
  // NAMESPACE);
  //    public static final QName SET_CALITEM_REQUEST = QName.get("SetCalendarItemRequest",
  // NAMESPACE);
  //    public static final QName CREATE_CALITEM_REQUEST = QName.get("CreateCalendarItemRequest",
  // NAMESPACE);
  //    public static final QName CREATE_CALITEM_EXCEPTION_REQUEST =
  // QName.get("CreateCalendarItemExceptionRequest", NAMESPACE);
  //    public static final QName MODIFY_CALITEM_REQUEST = QName.get("ModifyCalendarItemRequest",
  // NAMESPACE);
  //    public static final QName CANCEL_CALITEM_REQUEST = QName.get("CancelCalendarItemRequest",
  // NAMESPACE);

  public static final QName SEND_INVITE_REPLY_REQUEST =
      QName.get(E_SEND_INVITE_REPLY_REQUEST, NAMESPACE);
  ...
  public static final QName GET_WORKING_HOURS_REQUEST =
      QName.get(E_GET_WORKING_HOURS_REQUEST, NAMESPACE);
  public static final QName GET_ICAL_REQUEST = QName.get(E_GET_ICAL_REQUEST, NAMESPACE);
  public static final QName ANNOUNCE_ORGANIZER_CHANGE_REQUEST =
      QName.get(E_ANNOUNCE_ORGANIZER_CHANGE_REQUEST, NAMESPACE);
  public static final QName DISMISS_CALITEM_ALARM_REQUEST =
      QName.get(E_DISMISS_CALITEM_ALARM_REQUEST, NAMESPACE);
  public static final QName SNOOZE_CALITEM_ALARM_REQUEST =
      QName.get(E_SNOOZE_CALITEM_ALARM_REQUEST, NAMESPACE);
  ...
  public static final QName CHECK_RECUR_CONFLICTS_REQUEST =
      QName.get(E_CHECK_RECUR_CONFLICTS_REQUEST, NAMESPACE);

  // spell checking
  public static final QName GET_SPELL_DICTIONARIES_REQUEST =
      QName.get(E_GET_SPELL_DICTIONARIES_REQUEST, NAMESPACE);
  public static final QName GET_SPELL_DICTIONARIES_RESPONSE =
      QName.get(E_GET_SPELL_DICTIONARIES_RESPONSE, NAMESPACE);
  ...
  public static final QName CREATE_WAIT_SET_RESPONSE =
      QName.get(E_CREATE_WAIT_SET_RESPONSE, NAMESPACE);
  ...
  public static final QName DESTROY_WAIT_SET_REQUEST =
      QName.get(E_DESTROY_WAIT_SET_REQUEST, NAMESPACE);
  public static final QName DESTROY_WAIT_SET_RESPONSE =
      QName.get(E_DESTROY_WAIT_SET_RESPONSE, NAMESPACE);

  // account ACL
  public static final QName GET_PERMISSION_REQUEST = QName.get(E_GET_PERMISSION_REQUEST, NAMESPACE);
  public static final QName GET_PERMISSION_RESPONSE =
      QName.get(E_GET_PERMISSION_RESPONSE, NAMESPACE);
  public static final QName CHECK_PERMISSION_REQUEST =
      QName.get(E_CHECK_PERMISSION_REQUEST, NAMESPACE);
  public static final QName CHECK_PERMISSION_RESPONSE =
      QName.get(E_CHECK_PERMISSION_RESPONSE, NAMESPACE);
  public static final QName GRANT_PERMISSION_REQUEST =
      QName.get(E_GRANT_PERMISSION_REQUEST, NAMESPACE);
  public static final QName GRANT_PERMISSION_RESPONSE =
      QName.get(E_GRANT_PERMISSION_RESPONSE, NAMESPACE);
  public static final QName REVOKE_PERMISSION_REQUEST =
      QName.get(E_REVOKE_PERMISSION_REQUEST, NAMESPACE);
  public static final QName REVOKE_PERMISSION_RESPONSE =
      QName.get(E_REVOKE_PERMISSION_RESPONSE, NAMESPACE);

  // folder ACL
  public static final QName GET_EFFECTIVE_FOLDER_PERMS_REQUEST =
      QName.get(E_GET_EFFECTIVE_FOLDER_PERMS_REQUEST, NAMESPACE);
  public static final QName GET_EFFECTIVE_FOLDER_PERMS_RESPONSE =
      QName.get(E_GET_EFFECTIVE_FOLDER_PERMS_RESPONSE, NAMESPACE);

  // Yahoo Auth
  public static final QName GET_YAHOO_COOKIE_REQUEST =
      QName.get(E_GET_YAHOO_COOKIE_REQUEST, NAMESPACE);
  public static final QName GET_YAHOO_COOKIE_RESPONSE =
      QName.get(E_GET_YAHOO_COOKIE_RESPONSE, NAMESPACE);
  public static final QName GET_YAHOO_AUTH_TOKEN_REQUEST =
      QName.get(E_GET_YAHOO_AUTH_TOKEN_REQUEST, NAMESPACE);
  public static final QName GET_YAHOO_AUTH_TOKEN_RESPONSE =
      QName.get(E_GET_YAHOO_AUTH_TOKEN_RESPONSE, NAMESPACE);
  ...
  public static final QName SEND_VERIFICATION_CODE_REQUEST =
      QName.get(E_SEND_VERIFICATION_CODE_REQUEST, NAMESPACE);
  public static final QName SEND_VERIFICATION_CODE_RESPONSE =
      QName.get(E_SEND_VERIFICATION_CODE_RESPONSE, NAMESPACE);
  ...
  public static final QName INVALIDATE_REMINDER_DEVICE_REQUEST =
      QName.get(E_INVALIDATE_REMINDER_DEVICE_REQUEST, NAMESPACE);
  public static final QName INVALIDATE_REMINDER_DEVICE_RESPONSE =
      QName.get(E_INVALIDATE_REMINDER_DEVICE_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_SHARE_NOTIFICATIONS_RESPONSE =
      QName.get(E_GET_SHARE_NOTIFICATIONS_RESPONSE, NAMESPACE);

  public static final QName GET_SYSTEM_RETENTION_POLICY_REQUEST =
      QName.get(E_GET_SYSTEM_RETENTION_POLICY_REQUEST, NAMESPACE);
  public static final QName GET_SYSTEM_RETENTION_POLICY_RESPONSE =
      QName.get(E_GET_SYSTEM_RETENTION_POLICY_RESPONSE, NAMESPACE);

  // IMAP
  public static final QName LIST_IMAP_SUBSCRIPTIONS_REQUEST =
      QName.get(E_LIST_IMAP_SUBSCRIPTIONS_REQUEST, NAMESPACE);
  public static final QName LIST_IMAP_SUBSCRIPTIONS_RESPONSE =
      QName.get(E_LIST_IMAP_SUBSCRIPTIONS_RESPONSE, NAMESPACE);
  public static final QName SAVE_IMAP_SUBSCRIPTIONS_REQUEST =
      QName.get(E_SAVE_IMAP_SUBSCRIPTIONS_REQUEST, NAMESPACE);
  public static final QName SAVE_IMAP_SUBSCRIPTIONS_RESPONSE =
      QName.get(E_SAVE_IMAP_SUBSCRIPTIONS_RESPONSE, NAMESPACE);
  public static final QName RESET_RECENT_MESSAGE_COUNT_REQUEST =
      QName.get(E_RESET_RECENT_MESSAGE_COUNT_REQUEST, NAMESPACE);
  public static final QName RESET_RECENT_MESSAGE_COUNT_RESPONSE =
      QName.get(E_RESET_RECENT_MESSAGE_COUNT_RESPONSE, NAMESPACE);
  public static final QName OPEN_IMAP_FOLDER_REQUEST =
      QName.get(E_OPEN_IMAP_FOLDER_REQUEST, NAMESPACE);
  public static final QName OPEN_IMAP_FOLDER_RESPONSE =
      QName.get(E_OPEN_IMAP_FOLDER_RESPONSE, NAMESPACE);
  public static final QName GET_MODIFIED_ITEMS_IDS_REQUEST =
      QName.get(E_GET_MODIFIED_ITEMS_IDS_REQUEST, NAMESPACE);
  public static final QName GET_MODIFIED_ITEMS_IDS_RESPONSE =
      QName.get(E_GET_MODIFIED_ITEMS_IDS_RESPONSE, NAMESPACE);
  public static final QName GET_LAST_ITEM_ID_IN_MAILBOX_REQUEST =
      QName.get(E_GET_LAST_ITEM_ID_IN_MAILBOX_REQUEST, NAMESPACE);
  public static final QName GET_LAST_ITEM_ID_IN_MAILBOX_RESPONSE =
      QName.get(E_GET_LAST_ITEM_ID_IN_MAILBOX_RESPONSE, NAMESPACE);
  public static final QName BEGIN_TRACKING_IMAP_REQUEST =
      QName.get(E_BEGIN_TRACKING_IMAP_REQUEST, NAMESPACE);
  public static final QName BEGIN_TRACKING_IMAP_RESPONSE =
      QName.get(E_BEGIN_TRACKING_IMAP_RESPONSE, NAMESPACE);
  public static final QName GET_IMAP_RECENT_REQUEST =
      QName.get(E_GET_IMAP_RECENT_REQUEST, NAMESPACE);
  public static final QName GET_IMAP_RECENT_RESPONSE =
      QName.get(E_GET_IMAP_RECENT_RESPONSE, NAMESPACE);
  public static final QName GET_IMAP_RECENT_CUTOFF_REQUEST =
      QName.get(E_GET_IMAP_RECENT_CUTOFF_REQUEST, NAMESPACE);
  public static final QName GET_IMAP_RECENT_CUTOFF_RESPONSE =
      QName.get(E_GET_IMAP_RECENT_CUTOFF_RESPONSE, NAMESPACE);
  public static final QName RECORD_IMAP_SESSION_REQUEST =
      QName.get(E_RECORD_IMAP_SESSION_REQUEST, NAMESPACE);
  public static final QName RECORD_IMAP_SESSION_RESPONSE =
      QName.get(E_RECORD_IMAP_SESSION_RESPONSE, NAMESPACE);
  ...
  public static final String OP_RECOVER =
      "recover"; // recover by copying then deleting from dumpster
  ...
  public static final QName RESTORE_CONTACTS_REQUEST =
      QName.get(E_RESTORE_CONTACTS_REQUEST, NAMESPACE);
  public static final QName RESTORE_CONTACTS_RESPONSE =
      QName.get(E_RESTORE_CONTACTS_RESPONSE, NAMESPACE);
