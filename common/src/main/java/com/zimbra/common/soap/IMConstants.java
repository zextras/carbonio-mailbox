...
public class IMConstants {
  ...
  public static final QName IM_AUTHORIZE_SUBSCRIBE_REQUEST =
      QName.get("IMAuthorizeSubscribeRequest", NAMESPACE);
  public static final QName IM_AUTHORIZE_SUBSCRIBE_RESPONSE =
      QName.get("IMAuthorizeSubscribeResponse", NAMESPACE);
  public static final QName IM_SET_PRESENCE_REQUEST = QName.get("IMSetPresenceRequest", NAMESPACE);
  public static final QName IM_SET_PRESENCE_RESPONSE =
      QName.get("IMSetPresenceResponse", NAMESPACE);
  ...
  public static final QName IM_SEND_MESSAGE_RESPONSE =
      QName.get("IMSendMessageResponse", NAMESPACE);
  public static final QName IM_JOIN_CONFERENCE_ROOM_REQUEST =
      QName.get("IMJoinConferenceRoomRequest", NAMESPACE);
  public static final QName IM_JOIN_CONFERENCE_ROOM_RESPONSE =
      QName.get("IMJoinConferenceRoomResponse", NAMESPACE);

  public static final QName IM_GET_PRIVACY_LIST_REQUEST =
      QName.get("IMGetPrivacyListRequest", NAMESPACE);
  public static final QName IM_GET_PRIVACY_LIST_RESPONSE =
      QName.get("IMGetPrivacyListResponse", NAMESPACE);

  public static final QName IM_SET_PRIVACY_LIST_REQUEST =
      QName.get("IMSetPrivacyListRequest", NAMESPACE);
  public static final QName IM_SET_PRIVACY_LIST_RESPONSE =
      QName.get("IMSetPrivacyListResponse", NAMESPACE);

  public static final QName IM_GATEWAY_LIST_REQUEST = QName.get("IMGatewayListRequest", NAMESPACE);
  public static final QName IM_GATEWAY_LIST_RESPONSE =
      QName.get("IMGatewayListResponse", NAMESPACE);
  public static final QName IM_GATEWAY_REGISTER_REQUEST =
      QName.get("IMGatewayRegisterRequest", NAMESPACE);
  public static final QName IM_GATEWAY_REGISTER_RESPONSE =
      QName.get("IMGatewayRegisterResponse", NAMESPACE);
  ...
  public static final QName IM_LIST_CONFERENCE_SERVICES_REQUEST =
      QName.get("IMListConferenceServicesRequest", NAMESPACE);
  public static final QName IM_LIST_CONFERENCE_SERVICES_RESPONSE =
      QName.get("IMListConferenceServicesResponse", NAMESPACE);

  public static final QName IM_LIST_CONFERENCE_ROOMS_REQUEST =
      QName.get("IMListConferenceRoomsRequest", NAMESPACE);
  public static final QName IM_LIST_CONFERENCE_ROOMS_RESPONSE =
      QName.get("IMListConferenceRoomsResponse", NAMESPACE);

  public static final QName IM_GET_CHAT_CONFIGURATION_REQUEST =
      QName.get("IMGetChatConfigurationRequest", NAMESPACE);
  public static final QName IM_GET_CHAT_CONFIGURATION_RESPONSE =
      QName.get("IMGetChatConfigurationResponse", NAMESPACE);
