...
public final class ClusterConstants {
  ...
  public static final QName GET_CLUSTER_STATUS_REQUEST =
      QName.get(E_GET_CLUSTER_STATUS_REQUEST, NAMESPACE);
  public static final QName GET_CLUSTER_STATUS_RESPONSE =
      QName.get(E_GET_CLUSTER_STATUS_RESPONSE, NAMESPACE);
  public static final QName FAILOVER_CLUSTER_SERVICE_REQUEST =
      QName.get(E_FAILOVER_CLUSTER_SERVICE_REQUEST, NAMESPACE);
  public static final QName FAILOVER_CLUSTER_SERVICE_RESPONSE =
      QName.get(E_FAILOVER_CLUSTER_SERVICE_RESPONSE, NAMESPACE);
