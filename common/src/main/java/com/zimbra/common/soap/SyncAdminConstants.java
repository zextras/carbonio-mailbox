...
public final class SyncAdminConstants {
  ...
  public static final String E_GET_DEVICES_COUNT_SINCE_LAST_USED_REQUEST =
      "GetDevicesCountSinceLastUsedRequest";
  public static final String E_GET_DEVICES_COUNT_SINCE_LAST_USED_RESPONSE =
      "GetDevicesCountSinceLastUsedResponse";
  public static final String E_GET_DEVICES_COUNT_USED_TODAY_REQUEST =
      "GetDevicesCountUsedTodayRequest";
  public static final String E_GET_DEVICES_COUNT_USED_TODAY_RESPONSE =
  ...
  public static final String E_CANCEL_PENDING_REMOTE_WIPE_REQUEST =
      "CancelPendingRemoteWipeRequest";
  public static final String E_CANCEL_PENDING_REMOTE_WIPE_RESPONSE =
  ...
  public static final String E_REMOVE_STALE_DEVICE_METADATA_REQUEST =
      "RemoveStaleDeviceMetadataRequest";
  public static final String E_REMOVE_STALE_DEVICE_METADATA_RESPONSE =
      "RemoveStaleDeviceMetadataResponse";

  public static final QName GET_DEVICES_COUNT_REQUEST =
      QName.get(E_GET_DEVICES_COUNT_REQUEST, NAMESPACE);
  public static final QName GET_DEVICES_COUNT_RESPONSE =
      QName.get(E_GET_DEVICES_COUNT_RESPONSE, NAMESPACE);
  public static final QName GET_DEVICES_COUNT_SINCE_LAST_USED_REQUEST =
      QName.get(E_GET_DEVICES_COUNT_SINCE_LAST_USED_REQUEST, NAMESPACE);
  public static final QName GET_DEVICES_COUNT_SINCE_LAST_USED_RESPONSE =
      QName.get(E_GET_DEVICES_COUNT_SINCE_LAST_USED_RESPONSE, NAMESPACE);
  public static final QName GET_DEVICES_COUNT_USED_TODAY_REQUEST =
      QName.get(E_GET_DEVICES_COUNT_USED_TODAY_REQUEST, NAMESPACE);
  public static final QName GET_DEVICES_COUNT_USED_TODAY_RESPONSE =
      QName.get(E_GET_DEVICES_COUNT_USED_TODAY_RESPONSE, NAMESPACE);
  ...
  public static final QName CANCEL_PENDING_REMOTE_WIPE_REQUEST =
      QName.get(E_CANCEL_PENDING_REMOTE_WIPE_REQUEST, NAMESPACE);
  public static final QName CANCEL_PENDING_REMOTE_WIPE_RESPONSE =
      QName.get(E_CANCEL_PENDING_REMOTE_WIPE_RESPONSE, NAMESPACE);
  public static final QName GET_DEVICE_STATUS_REQUEST =
      QName.get(E_GET_DEVICE_STATUS_REQUEST, NAMESPACE);
  public static final QName GET_DEVICE_STATUS_RESPONSE =
      QName.get(E_GET_DEVICE_STATUS_RESPONSE, NAMESPACE);
  ...
  public static final QName SUSPEND_DEVICE_RESPONSE =
      QName.get(E_SUSPEND_DEVICE_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_SYNC_STATE_RESPONSE =
      QName.get(E_GET_SYNC_STATE_RESPONSE, NAMESPACE);
  public static final QName REMOVE_STALE_DEVICE_METADATA_REQUEST =
      QName.get(E_REMOVE_STALE_DEVICE_METADATA_REQUEST, NAMESPACE);
  public static final QName REMOVE_STALE_DEVICE_METADATA_RESPONSE =
      QName.get(E_REMOVE_STALE_DEVICE_METADATA_RESPONSE, NAMESPACE);
