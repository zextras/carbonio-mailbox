...
public final class OctopusXmlConstants {
  ...
  public static final QName GET_ACTIVITY_STREAM_REQUEST =
      QName.get(E_GET_ACTIVITY_STREAM_REQUEST, NAMESPACE);
  public static final QName GET_ACTIVITY_STREAM_RESPONSE =
      QName.get(E_GET_ACTIVITY_STREAM_RESPONSE, NAMESPACE);

  public static final QName REGISTER_DEVICE_REQUEST =
      QName.get(E_REGISTER_DEVICE_REQUEST, NAMESPACE);
  public static final QName REGISTER_DEVICE_RESPONSE =
      QName.get(E_REGISTER_DEVICE_RESPONSE, NAMESPACE);

  public static final QName UPDATE_DEVICE_STATUS_REQUEST =
      QName.get(E_UPDATE_DEVICE_STATUS_REQUEST, NAMESPACE);
  public static final QName UPDATE_DEVICE_STATUS_RESPONSE =
      QName.get(E_UPDATE_DEVICE_STATUS_RESPONSE, NAMESPACE);

  public static final QName CHECK_DEVICE_STATUS_REQUEST =
      QName.get(E_CHECK_DEVICE_STATUS_REQUEST, NAMESPACE);
  public static final QName CHECK_DEVICE_STATUS_RESPONSE =
      QName.get(E_CHECK_DEVICE_STATUS_RESPONSE, NAMESPACE);

  public static final QName GET_ALL_DEVICES_REQUEST =
      QName.get(E_GET_ALL_DEVICES_REQUEST, NAMESPACE);
  public static final QName GET_ALL_DEVICES_RESPONSE =
      QName.get(E_GET_ALL_DEVICES_RESPONSE, NAMESPACE);
  ...
  public static final QName DOCUMENT_ACTION_REQUEST =
      QName.get(E_DOCUMENT_ACTION_REQUEST, NAMESPACE);
  public static final QName DOCUMENT_ACTION_RESPONSE =
      QName.get(E_DOCUMENT_ACTION_RESPONSE, NAMESPACE);
  ...
  public static final QName GET_WATCHING_ITEMS_REQUEST =
      QName.get(E_GET_WATCHING_ITEMS_REQUEST, NAMESPACE);
  public static final QName GET_WATCHING_ITEMS_RESPONSE =
      QName.get(E_GET_WATCHING_ITEMS_RESPONSE, NAMESPACE);

  public static final QName GET_NOTIFICATIONS_REQUEST =
      QName.get(E_GET_NOTIFICATIONS_REQUEST, NAMESPACE);
  public static final QName GET_NOTIFICATIONS_RESPONSE =
      QName.get(E_GET_NOTIFICATIONS_RESPONSE, NAMESPACE);

  public static final QName GET_DOCUMENT_SHARE_URL_REQUEST =
      QName.get(E_GET_DOCUMENT_SHARE_URL_REQUEST, NAMESPACE);
  public static final QName GET_DOCUMENT_SHARE_URL_RESPONSE =
      QName.get(E_GET_DOCUMENT_SHARE_URL_RESPONSE, NAMESPACE);

  public static final QName GET_SHARE_DETAILS_REQUEST =
      QName.get(E_GET_SHARE_DETAILS_REQUEST, NAMESPACE);
  public static final QName GET_SHARE_DETAILS_RESPONSE =
      QName.get(E_GET_SHARE_DETAILS_RESPONSE, NAMESPACE);
