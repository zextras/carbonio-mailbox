...
public final class XMbxSearchConstants {
  ...
  public static final QName GET_XMBX_SEARCH_REQUEST =
      QName.get(E_GET_XMBX_SEARCH_REQUEST, NAMESPACE);
  public static final QName GET_XMBX_SEARCH_RESPONSE =
      QName.get(E_GET_XMBX_SEARCH_RESPONSE, NAMESPACE);

  public static final QName GET_XMBX_SEARCHES_REQUEST =
      QName.get(E_GET_XMBX_SEARCHES_REQUEST, NAMESPACE);
  public static final QName GET_XMBX_SEARCHES_RESPONSE =
      QName.get(E_GET_XMBX_SEARCHES_RESPONSE, NAMESPACE);

  public static final QName CREATE_XMBX_SEARCH_REQUEST =
      QName.get(E_CREATE_XMBX_SEARCH_REQUEST, NAMESPACE);
  public static final QName CREATE_XMBX_SEARCH_RESPONSE =
      QName.get(E_CREATE_XMBX_SEARCH_RESPONSE, NAMESPACE);

  public static final QName ABORT_XMBX_SEARCH_REQUEST =
      QName.get(E_ABORT_XMBX_SEARCH_REQUEST, NAMESPACE);
  public static final QName ABORT_XMBX_SEARCH_RESPONSE =
      QName.get(E_ABORT_XMBX_SEARCH_RESPONSE, NAMESPACE);

  public static final QName DELETE_XMBX_SEARCH_REQUEST =
      QName.get(E_DELETE_XMBX_SEARCH_REQUEST, NAMESPACE);
  public static final QName DELETE_XMBX_SEARCH_RESPONSE =
      QName.get(E_DELETE_XMBX_SEARCH_RESPONSE, NAMESPACE);
