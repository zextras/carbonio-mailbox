...
public class ServiceException extends Exception {
  ...
  public static final String CANNOT_DISABLE_TWO_FACTOR_AUTH =
      "account.CANNOT_DISABLE_TWO_FACTOR_AUTH";
  public static final String CANNOT_ENABLE_TWO_FACTOR_AUTH =
      "account.CANNOT_ENABLE_TWO_FACTOR_AUTH";
  public static final String AUTH_EXPIRED = "service.AUTH_EXPIRED";
  public static final String WRONG_HOST = "service.WRONG_HOST";
  public static final String NON_READONLY_OPERATION_DENIED =
  ...
  public static final String PROXIED_FROM_ACCT =
      "proxiedFromAcct"; // exception proxied from remote account
  ...
  /** Argument that should not be included in SOAP fault. For example: url */
  ...
  /**
   * Comment for <code>mReceiver</code> Causes a Sender/Receiver element to show up in a soap fault.
   * It is supposed to let the client know whether it did something wrong or something is wrong on
   * the server.
   *
   * <p>For example, ServiceException.FAILURE sets it to true, meaning something bad happened on the
   * server-side and the client could attempt a retry. The rest are false, as it generally means the
   ...
   * in the exception id so the thrown(or instantiation) location can be identified by the exception
   * id alone (without referencing the log - the stack won't be in the log).
   *
  ...
  protected ServiceException(
    ...
    List<Argument> argList =
        (arguments == null ? Collections.<Argument>emptyList() : Arrays.asList(arguments));
  ...
  protected ServiceException(
      String message, String code, boolean isReceiversFault, Argument... arguments) {
  ...
  /**
   * Returns a generic service exception but without tracing the cause. This is useful for when
   * something bad happens but is handled and there is no underlying exception.
   *
  ...
  public static ServiceException INVALID_REQUEST(String message, Throwable cause) {
    return new ServiceException(
        "invalid request: " + message, INVALID_REQUEST, SENDERS_FAULT, cause);
  }
  ...
  public static ServiceException UNKNOWN_DOCUMENT(String message, Throwable cause) {
    return new ServiceException(
        "unknown document: " + message, UNKNOWN_DOCUMENT, SENDERS_FAULT, cause);
  }
  ...
  public static ServiceException RESOURCE_UNREACHABLE(
      String message, Throwable cause, Argument... arguments) {
    return new ServiceException(
        "resource unreachable: " + message,
  ...
  public static ServiceException TEMPORARILY_UNAVAILABLE() {
    return new ServiceException(
        "service temporarily unavailable", TEMPORARILY_UNAVAILABLE, RECEIVERS_FAULT);
  }
  ...
  public static ServiceException PERM_DENIED(String message, Argument... arguments) {
    return new ServiceException(
        "permission denied: " + message, PERM_DENIED, SENDERS_FAULT, arguments);
  }

  public static ServiceException AUTH_EXPIRED(String message) {
    return new ServiceException(
        "auth credentials have expired" + (message == null ? "" : ": " + message),
        AUTH_EXPIRED,
        SENDERS_FAULT);
  }
  ...
  public static ServiceException DEFEND_ACCOUNT_HARVEST(String account) {
    ...
    // return new ServiceException("permission denied: can not access account " + account,
  ...
  public static ServiceException AUTH_REQUIRED(String email) {
    return new ServiceException(
        "no valid authtoken present for " + email, AUTH_REQUIRED, SENDERS_FAULT);
  }

  public static ServiceException CANNOT_DISABLE_TWO_FACTOR_AUTH() {
    return new ServiceException(
        "cannot disable two-factor authentication", CANNOT_DISABLE_TWO_FACTOR_AUTH, SENDERS_FAULT);
  }

  public static ServiceException CANNOT_ENABLE_TWO_FACTOR_AUTH() {
    return new ServiceException(
        "cannot enable two-factor authentication", CANNOT_ENABLE_TWO_FACTOR_AUTH, SENDERS_FAULT);
  }

  public static ServiceException WRONG_HOST(String target, Throwable cause) {
    return new ServiceException(
        "operation sent to wrong host (you want '" + target + "')",
        WRONG_HOST,
        SENDERS_FAULT,
        cause,
  ...
  public static ServiceException NON_READONLY_OPERATION_DENIED() {
    return new ServiceException(
        "non-readonly operation denied", NON_READONLY_OPERATION_DENIED, SENDERS_FAULT);
  }
  ...
  public static ServiceException PROXY_ERROR(Throwable cause, String url) {
    return new ServiceException(
        ...
        RECEIVERS_FAULT,
        cause,
        new InternalArgument(URL, url, Argument.Type.STR));
  }

  public static ServiceException PROXY_ERROR(String statusLine, String url) {
    return new ServiceException(
        "error while proxying request to target server: " + statusLine,
        PROXY_ERROR,
        RECEIVERS_FAULT,
        new InternalArgument(URL, url, Argument.Type.STR));
  }
  ...
  public static ServiceException TOO_MANY_HOPS(String acctId) {
    return new ServiceException(
        "mountpoint or proxy loop detected",
        TOO_MANY_HOPS,
        SENDERS_FAULT,
        new Argument(ACCOUNT_ID, acctId, Argument.Type.STR));
  }
  ...
  public static ServiceException TOO_MANY_PROXIES(String url) {
    return new ServiceException(
        ...
        TOO_MANY_HOPS,
        SENDERS_FAULT,
        new Argument(URL, HttpUtil.sanitizeURL(url), Argument.Type.STR));
  }
  ...
  public static ServiceException ALREADY_IN_PROGRESS(String mboxId, String action) {
    return new ServiceException(
        "mbox " + mboxId + " is already running action " + action,
        ALREADY_IN_PROGRESS,
        SENDERS_FAULT,
        new Argument(MAILBOX_ID, mboxId, Argument.Type.IID),
        new Argument("action", action, Argument.Type.STR));
  }

  public static ServiceException NOT_IN_PROGRESS(String mboxId, String action) {
    return new ServiceException(
        "mbox " + mboxId + " is not currently running action " + action,
        NOT_IN_PROGRESS,
        SENDERS_FAULT,
        new Argument(MAILBOX_ID, mboxId, Argument.Type.IID),
        new Argument("action", action, Argument.Type.STR));
  ...
  public static ServiceException SAX_READER_ERROR(String str, Throwable cause) {
    return new ServiceException(
        "SAX Reader Error: " + (str != null ? str : ""), SAX_READER_ERROR, SENDERS_FAULT, cause);
  }
  ...
  public static ServiceException NOT_FOUND(String msg, Throwable cause) {
    return new ServiceException(
        "not found" + msg != null ? msg : "", NOT_FOUND, RECEIVERS_FAULT, cause);
  }
  ...
  public static ServiceException NETWORK_MODULES_NG_ENABLED(String str) {
    return new ServiceException(
        "ZimbraNetworkModulesNG: " + str + " is not enabled.",
        ZIMBRA_NETWORK_MODULES_NG_ENABLED,
        RECEIVERS_FAULT);
  }

  public static ServiceException INTERNAL_ERROR(Throwable cause) {
    return ServiceException.FAILURE("internal error", cause);
  }
}
