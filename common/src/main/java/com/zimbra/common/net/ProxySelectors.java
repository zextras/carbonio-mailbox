...
public final class ProxySelectors {
  ...
  static {
    ...
    if (className != null && !className.equals("")) {
      try {
        ...
        ZimbraLog.net.error(
            "could not instantiate ConditionalProxySelector interface of class '"
                + className
                + "'; defaulting to system proxy settings",
            e);
      }
    }
  }
  ...
  /**
   * On supported systems returns the native ProxySelector otherwise returns the system default.
   *
  ...
  /**
   * Returns a "dummy" ProxySelector whose select method always returns a DIRECT connection. Used
   * for testing.
   *
