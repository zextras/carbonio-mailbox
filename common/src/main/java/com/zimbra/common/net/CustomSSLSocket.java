...
class CustomSSLSocket extends SSLSocket {
  ...
  private String getHostname() {
    if (host == null) host = ((InetSocketAddress) sslSocket.getRemoteSocketAddress()).getHostName();
    return host;
  }
  ...
  public void startHandshake() throws IOException {
    ...
    else isHandshakeStarted = true;

    if (sock.getSoTimeout() == 0) sock.setSoTimeout(LC.socket_so_timeout.intValue());
