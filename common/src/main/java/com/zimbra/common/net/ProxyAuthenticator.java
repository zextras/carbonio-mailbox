...
public class ProxyAuthenticator extends Authenticator {
  ...
  private Map<Proxy.Type, UsernamePassword> userPasswords =
      new HashMap<Proxy.Type, UsernamePassword>();
  ...
  protected PasswordAuthentication getPasswordAuthentication() {
    if (getRequestorType() == RequestorType.PROXY) {
      ...
      ZimbraLog.net.warn(
          "Non-proxy authentication type %s requested, unable to fulfil", getRequestorType());
      return null;
    }
  }
}
