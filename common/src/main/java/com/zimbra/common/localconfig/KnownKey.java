...
public final class KnownKey {
  ...
  /**
   * The only public method here. If you have a KnownKey object, this is a shortcut to get it's
   * value.
   *
   * @see LC#get
   */
  ...
  /**
   * Returns the value of this KnownKey as an int, but forces it to be within the range of minValue
   * <= RETURN <= maxValue
   */
  ...
  /**
   * Returns the value of this KnownKey as a long, but forces it to be within the range of minValue
   * <= RETURN <= maxValue
   */
   ...
   *
   * <p>This is solely for documentation purpose. Developers are responsible for providing accurate
   * information. If it's reloadable, changes are in effect after LC reload. Otherwise, changes are
   * in effect after server restart.
   */
