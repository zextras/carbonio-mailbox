...
public final class LogFactory {
  ...
  public static synchronized void reset() {
    ...
    // LogManager.resetConfiguration() will set all logger's level to null. We don't want to leave
    // account loggers
    // with that state.
  ...
  /**
   * Returns all account loggers that have been created since the last server start, or an empty
   * <tt>List</tt>.
   */
  ...
  /**
   * Returns all the loggers that have been created with {@link #getLog}. The <tt>Collection</tt>
   * does not include account loggers.
   */
