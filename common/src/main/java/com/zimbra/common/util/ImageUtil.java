...
public class ImageUtil {
  ...
  public static BufferedImage resize(BufferedImage img, int targetWidth, int targetHeight) {
    log.debug(
        "Resizing image from %dx%d to %dx%d pixels.",
   ...
   *     higher quality than the usual one-step technique (only useful in down-scaling cases, where
  ...
  private static BufferedImage getScaledInstance(
      BufferedImage img, int targetWidth, int targetHeight, Object hint, boolean higherQuality) {
