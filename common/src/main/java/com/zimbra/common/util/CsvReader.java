...
/**
 * Simple CSV file reader. Current implementation is not bullet-proof, but should be close enough.
 * Splits on commas, possibly surrounded by spaces and quotes. Doesn't currently handle escaped
 * quotes ("") or quoted strings that contain commas (e.g. 1,"Zimbra, Inc.",2).
 *
 * @author bburtin
 */
public class CsvReader {
  ...
  /** Returns the value for the specified column in the current line. */
