...
public class RandomPassword {
  ...
  /**
   * 64 entry alphabet gives a 6 bits of entropy per character in the password.
   *
   * <p>http://world.std.com/~reinhold/dicewarefaq.html#calculatingentropy
   *
   * <p>If the passphrase is made out of M symbols, each chosen at random from a universe of N
   * possibilities, each equally likely, the entropy is M*log2(N).
   */
   ...
   *
   * <p>When using an 8-bit value to select a character from an alphabet of length k, there is a
   * risk of bias if k does not evenly divide 256. To eliminate this, candidate cipher output bytes
   * are discarded if they are greater than or equal to the largest multiple of k less than 256.
   */
  ...
  public static void main(String args[]) {
    ...
    if (cl.hasOption('l')) localpart = true;
