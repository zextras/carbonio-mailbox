...
/**
 * Wrapper around {@link SimpleDateFormat} that allows it to be used in a static context.
 * <tt>DateParser</tt> automatically handles using <tt>ThreadLocal</tt> to allocate one
 * <tt>SimpleDateFormat</tt> per thread.
 */
