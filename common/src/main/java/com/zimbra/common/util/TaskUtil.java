...
public final class TaskUtil {
  ...
  /**
   * Like {@link Executors#defaultThreadFactory()} except it creates daemon threads and allows
   * specifying the thread name prefix.
   *
   * @param threadNamePrefix a counter is appended to this value to generate a name for each new
   *     thread
  ...
  /**
   * A modified version of {@link Executors.DefaultThreadFactory} which creates daemon threads
   * instead of user threads and allows specifying the thread name prefix.
   */
