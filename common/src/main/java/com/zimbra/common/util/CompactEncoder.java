...
/**
 * @author tfr compact, fast encoder supporting all basic Java Objects
 */
public class CompactEncoder {
  ...
  public static Object decode(byte[] data) throws CompactEncoderException {
    ...
    try {
      order = bb.get();
      if (order == '[') bb.order(ByteOrder.BIG_ENDIAN);
      else if (order == ']') bb.order(ByteOrder.LITTLE_ENDIAN);
      else if (order != '\\') throw new CompactEncoderException("invalid data format");
      obj = decode(bb);
    ...
    if (bb.hasRemaining()) throw new CompactEncoderException("invalid trailing data");
    return obj;
  }
            ...
            case 'B':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = (byte) getStringLong(bb);
                return ret;
              }
            case 'C':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = (char) getStringLong(bb);
                return ret;
              }
            case 'S':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = (short) getStringLong(bb);
                return ret;
              }
            case 'I':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = (int) getStringLong(bb);
                return ret;
              }
            case 'L':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = getStringLong(bb);
                return ret;
              }
            case 'F':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = Float.parseFloat(getString(bb));
                return ret;
              }
            case 'D':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = Double.parseDouble(getString(bb));
                return ret;
              }
            case 'O':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = decode(bb);
                return ret;
              }
            default:
            ...
            case 'b':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = bb.get();
                return ret;
              }
            case 'c':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = bb.getChar();
                return ret;
              }
            case 's':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = bb.getShort();
                return ret;
              }
            case 'i':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = bb.getInt();
                return ret;
              }
            case 'l':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = bb.getLong();
                return ret;
              }
            case 'f':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = bb.getFloat();
                return ret;
              }
            case 'd':
              {
                ...
                for (int i = 0; i < len; i++) ret[i] = bb.getDouble();
                return ret;
              }
            case 'o':
              {
      ...
      case 'M':
        {
          ...
          Map<Object, Object> map = new HashMap<Object, Object>((int) (cnt * 1.5));

          for (int i = 0; i < cnt; i++) map.put(decode(bb), decode(bb));
          return map;
        }
      case 'm':
        {
      ...
      case 'V':
        {
          ...
          for (int i = 0; i < cnt; i++) array.add(i, decode(bb));
          return array;
        }
      case 'v':
        {
  ...
  private static ByteBuffer encode(ByteBuffer bb, Object obj) {
    if (obj instanceof String) {
      ...
      if (obj instanceof int[]) {
        ...
        for (int i = 0; i < len; i++) bb.putInt(Array.getInt(obj, i));
      } else if (obj instanceof byte[]) {
        bb = putRaw(bb, 'b', Integer.SIZE + len * Byte.SIZE).putInt(len);
        for (int i = 0; i < len; i++) bb.put(Array.getByte(obj, i));
      } else if (obj instanceof char[]) {
        bb = putRaw(bb, 'c', Integer.SIZE + len * Character.SIZE).putInt(len);
        for (int i = 0; i < len; i++) bb.putChar(Array.getChar(obj, i));
      } else if (obj instanceof short[]) {
        bb = putRaw(bb, 's', Integer.SIZE + len * Short.SIZE).putInt(len);
        for (int i = 0; i < len; i++) bb.putShort(Array.getShort(obj, i));
      } else if (obj instanceof long[]) {
        bb = putRaw(bb, 'l', Integer.SIZE + len * Long.SIZE).putInt(len);
        for (int i = 0; i < len; i++) bb.putLong(Array.getLong(obj, i));
      } else if (obj instanceof float[]) {
        bb = putRaw(bb, 'f', Integer.SIZE + len * Float.SIZE).putInt(len);
        for (int i = 0; i < len; i++) bb.putFloat(Array.getFloat(obj, i));
      } else if (obj instanceof Double[]) {
        bb = putRaw(bb, 'd', Integer.SIZE + len * Double.SIZE).putInt(len);
        for (int i = 0; i < len; i++) bb.putDouble(Array.getDouble(obj, i));
      } else {
        bb = putRaw(bb, 'o', Integer.SIZE).putInt(len);
        for (int i = 0; i < len; i++) bb = encode(bb, Array.get(obj, i));
      }
      return bb;
      ...
      for (Object val : l) bb = encode(bb, val);
      return bb;
    ...
    if (val.length < 'A' - ' ') return putRaw(bb, (char) (' ' + val.length), val.length).put(val);
    else if (val.length <= Short.MAX_VALUE)
      return putRaw(bb, 'p', Short.SIZE + val.length).putShort((short) val.length).put(val);
    return putRaw(bb, 't', Integer.SIZE + val.length).putInt(val.length).put(val);
  }
  ...
  private static ByteBuffer encodeToString(ByteBuffer bb, Object obj) {
    if (obj instanceof String) {
      ...
      if (obj instanceof int[]) {
        ...
        for (int i = 0; i < len; i++) bb = putStringElem(bb, Array.getInt(obj, i));
      } else if (obj instanceof byte[]) {
        bb = putString(bb, 'B', len);
        for (int i = 0; i < len; i++) bb = putStringElem(bb, Array.getByte(obj, i));
      } else if (obj instanceof char[]) {
        bb = putString(bb, 'C', len);
        for (int i = 0; i < len; i++) bb = putStringElem(bb, (short) Array.getChar(obj, i));
      } else if (obj instanceof short[]) {
        bb = putString(bb, 'S', len);
        for (int i = 0; i < len; i++) bb = putStringElem(bb, Array.getShort(obj, i));
      } else if (obj instanceof long[]) {
        bb = putString(bb, 'L', len);
        for (int i = 0; i < len; i++) bb = putStringElem(bb, Array.getLong(obj, i));
      } else if (obj instanceof float[]) {
        bb = putString(bb, 'F', len);
        for (int i = 0; i < len; i++) bb = putStringElem(bb, Array.getFloat(obj, i));
      } else if (obj instanceof Double[]) {
        bb = putString(bb, 'D', len);
        for (int i = 0; i < len; i++) bb = putStringElem(bb, Array.getDouble(obj, i));
      } else {
        bb = putString(bb, 'O', len);
        for (int i = 0; i < len; i++) bb = encodeToString(bb, Array.get(obj, i));
      }
      return bb;
    } else if (obj instanceof List) {
      List<?> l = (List<?>) obj;
      ...
      for (Object val : l) bb = encodeToString(bb, val);
      return bb;
    } else if (obj instanceof Map) {
      Map<?, ?> map = (Map<?, ?>) obj;
  ...
  private static long getStringLong(ByteBuffer bb) throws CharConversionException {
    ...
    while (len-- > 0) {
      ...
      if (b == '-' && l == 0) neg = true;
      else if (!isDigit(b)) throw new CharConversionException();
      else l = 10 * l + b - '0';
    }
    return neg ? -1 * l : l;
  }
  ...
  private static ByteBuffer ensure(ByteBuffer bb, int cap) {
    if (bb.remaining() < cap)
      return ByteBuffer.allocate(
              bb.capacity() < cap ? bb.capacity() * 2 : bb.capacity() + cap + 512)
          .put(bb.array());
    return bb;
  }
  ...
  private static ByteBuffer putString(ByteBuffer bb, char type, Object obj) {
    ...
    return ensure(bb, str.length + 2).put((byte) type).put((byte) (' ' + str.length)).put(str);
  }
  ...
  public static void main(String[] args) throws CompactEncoderException {
    ...
    Object[] darray, oarray = new Object[] {new String("arraystring"), Integer.valueOf(9)};
    byte[] print, raw;
