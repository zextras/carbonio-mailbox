...
/**
 * Calculates changes to the total, count, and average for the wrapped <tt>Counter</tt> between
...
public class DeltaCalculator implements Accumulator {
  ...
  /**
   * If non-null, the given name will be returned by {@link #getNames()} and the count value will be
  ...
  /**
   * If non-null, the given name will be returned by {@link #getNames()} and the total value will be
   * returned by {@link #getData()}.
   */
  ...
  /**
   * If non-null, the given name will be returned by {@link #getNames()} and the average value will
   * be returned by {@link #getData()}.
   */
  ...
  /**
   * If non-null, the given name will be returned by {@link #getNames()} and the realtime average
   * value will be returned by {@link #getData()}.
   */
  ...
  /**
   * Returns the average since the second-to-last call to {@link #reset}. We use the second-to-last
   * call in order to avoid spikes at the beginning of the interval.
   */
