...
public class Geo {
  ...
  public boolean equals(Object o) {
    ...
    return mLatitude != null
        && mLatitude.equals(other.mLatitude)
        && mLongitude != null
        && mLongitude.equals(other.mLongitude);
  }
  ...
  public static Geo parse(ZProperty prop) {
    ...
    if (latlon != null && latlon.length == 2) return new Geo(latlon[0], latlon[1]);
    else return new Geo("0", "0");
  }
}
