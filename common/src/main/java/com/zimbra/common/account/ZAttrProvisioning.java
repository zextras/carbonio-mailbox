...
public class ZAttrProvisioning {
  ...
  public static enum AccountCalendarUserType {
    ...
    private AccountCalendarUserType(String value) {
      mValue = value;
    }
  ...
  public static enum AdminAccessControlMech {
    ...
    private AdminAccessControlMech(String value) {
      mValue = value;
    }
  ...
  public static enum AmavisFinalSpamDestiny {
    ...
    private AmavisFinalSpamDestiny(String value) {
      mValue = value;
    }
    ...
    public boolean isD_BOUNCE() {
      return this == D_BOUNCE;
    }

    public boolean isD_REJECT() {
      return this == D_REJECT;
    }

    public boolean isD_DISCARD() {
  ...
  public static enum AutoProvAuthMech {
    ...
    private AutoProvAuthMech(String value) {
      mValue = value;
    }
  ...
  public static enum AutoProvMode {
    ...
    private AutoProvMode(String value) {
      mValue = value;
    }
  ...
  public static enum CalendarCompatibilityMode {
    ...
    private CalendarCompatibilityMode(String value) {
      mValue = value;
    }
  ...
  public static enum CalResType {
    ...
    private CalResType(String value) {
      mValue = value;
    }
  ...
  public static enum CBPolicydBypassMode {
    ...
    private CBPolicydBypassMode(String value) {
      mValue = value;
    }
  ...
  public static enum DataSourceAuthMechanism {
    ...
    private DataSourceAuthMechanism(String value) {
      mValue = value;
    }
  ...
  public static enum DataSourceConnectionType {
    ...
    private DataSourceConnectionType(String value) {
      mValue = value;
    }
  ...
  public static enum DataSourceSmtpConnectionType {
    ...
    private DataSourceSmtpConnectionType(String value) {
      mValue = value;
    }
  ...
  public static enum DistributionListSubscriptionPolicy {
    ...
    private DistributionListSubscriptionPolicy(String value) {
      mValue = value;
    }
  ...
  public static enum DistributionListUnsubscriptionPolicy {
    ...
    private DistributionListUnsubscriptionPolicy(String value) {
      mValue = value;
    }
    ...
    public static DistributionListUnsubscriptionPolicy fromString(String s)
  ...
  public static enum DNSTCPUpstream {
    ...
    private DNSTCPUpstream(String value) {
      mValue = value;
    }
  ...
  public static enum DNSUseTCP {
    ...
    private DNSUseTCP(String value) {
      mValue = value;
    }
  ...
  public static enum DNSUseUDP {
    ...
    private DNSUseUDP(String value) {
      mValue = value;
    }
  ...
  public static enum DomainAggregateQuotaPolicy {
    ...
    private DomainAggregateQuotaPolicy(String value) {
      mValue = value;
    }
    ...
    public boolean isALLOWSENDRECEIVE() {
      return this == ALLOWSENDRECEIVE;
    }
    ...
    public boolean isBLOCKSENDRECEIVE() {
      return this == BLOCKSENDRECEIVE;
    }
  }
  ...
  public static enum FeatureAddressVerificationStatus {
    ...
    private FeatureAddressVerificationStatus(String value) {
      mValue = value;
    }
  ...
  public static enum FeatureResetPasswordStatus {
    ...
    private FeatureResetPasswordStatus(String value) {
      mValue = value;
    }
  ...
  public static enum FeatureSocialFiltersEnabled {
    ...
    private FeatureSocialFiltersEnabled(String value) {
      mValue = value;
    }
  ...
  public static enum FreebusyExchangeAuthScheme {
    ...
    private FreebusyExchangeAuthScheme(String value) {
      mValue = value;
    }
  ...
  public static enum FreebusyExchangeServerType {
    ...
    private FreebusyExchangeServerType(String value) {
      mValue = value;
    }
  ...
  public static enum GalLdapAuthMech {
    ...
    private GalLdapAuthMech(String value) {
      mValue = value;
    }
  ...
  public static enum GalStatus {
    ...
    private GalStatus(String value) {
      mValue = value;
    }
  ...
  public static enum GalSyncLdapAuthMech {
    ...
    private GalSyncLdapAuthMech(String value) {
      mValue = value;
    }
  ...
  public static enum GalTokenizeAutoCompleteKey {
    ...
    private GalTokenizeAutoCompleteKey(String value) {
      mValue = value;
    }
  ...
  public static enum GalTokenizeSearchKey {
    ...
    private GalTokenizeSearchKey(String value) {
      mValue = value;
    }
  ...
  public static enum IMService {
    ...
    private IMService(String value) {
      mValue = value;
    }
  ...
  public static enum MailReferMode {
    ...
    private MailReferMode(String value) {
      mValue = value;
    }
  ...
  public static enum MailSSLClientCertMode {
    ...
    private MailSSLClientCertMode(String value) {
      mValue = value;
    }
  ...
  public static enum MailThreadingAlgorithm {
    ...
    private MailThreadingAlgorithm(String value) {
      mValue = value;
    }
    ...
    public boolean isSubjrefs() {
      return this == subjrefs;
    }
  ...
  public static enum MobileGatewayProxyImapConnectionType {
    ...
    private MobileGatewayProxyImapConnectionType(String value) {
      mValue = value;
    }
    ...
    public static MobileGatewayProxyImapConnectionType fromString(String s)
        throws ServiceException {
  ...
  public static enum MobileGatewayProxySmtpConnectionType {
    ...
    private MobileGatewayProxySmtpConnectionType(String value) {
      mValue = value;
    }
    ...
    public static MobileGatewayProxySmtpConnectionType fromString(String s)
        throws ServiceException {
  ...
  public static enum MtaAlwaysAddMissingHeaders {
    ...
    private MtaAlwaysAddMissingHeaders(String value) {
      mValue = value;
    }
  ...
  public static enum MtaBrokenSaslAuthClients {
    ...
    private MtaBrokenSaslAuthClients(String value) {
      mValue = value;
    }
  ...
  public static enum MtaLmtpHostLookup {
    ...
    private MtaLmtpHostLookup(String value) {
      mValue = value;
    }
  ...
  public static enum MtaLmtpTlsCiphers {
    ...
    private MtaLmtpTlsCiphers(String value) {
      mValue = value;
    }
  ...
  public static enum MtaLmtpTlsMandatoryCiphers {
    ...
    private MtaLmtpTlsMandatoryCiphers(String value) {
      mValue = value;
    }
  ...
  public static enum MtaLmtpTlsSecurityLevel {
    ...
    private MtaLmtpTlsSecurityLevel(String value) {
      mValue = value;
    }
    ...
    public boolean isDane_only() {
      return this == dane_only;
    }
  ...
  public static enum MtaMilterDefaultAction {
    ...
    private MtaMilterDefaultAction(String value) {
      mValue = value;
    }
  ...
  public static enum MtaNotifyClasses {
    ...
    private MtaNotifyClasses(String value) {
      mValue = value;
    }
  ...
  public static enum MtaPostscreenBareNewlineAction {
    ...
    private MtaPostscreenBareNewlineAction(String value) {
      mValue = value;
    }
  ...
  public static enum MtaPostscreenBareNewlineEnable {
    ...
    private MtaPostscreenBareNewlineEnable(String value) {
      mValue = value;
    }
  ...
  public static enum MtaPostscreenBlacklistAction {
    ...
    private MtaPostscreenBlacklistAction(String value) {
      mValue = value;
    }
  ...
  public static enum MtaPostscreenDnsblAction {
    ...
    private MtaPostscreenDnsblAction(String value) {
      mValue = value;
    }
  ...
  public static enum MtaPostscreenGreetAction {
    ...
    private MtaPostscreenGreetAction(String value) {
      mValue = value;
    }
  ...
  public static enum MtaPostscreenNonSmtpCommandAction {
    ...
    private MtaPostscreenNonSmtpCommandAction(String value) {
      mValue = value;
    }
  ...
  public static enum MtaPostscreenNonSmtpCommandEnable {
    ...
    private MtaPostscreenNonSmtpCommandEnable(String value) {
      mValue = value;
    }
  ...
  public static enum MtaPostscreenPipeliningAction {
    ...
    private MtaPostscreenPipeliningAction(String value) {
      mValue = value;
    }
  ...
  public static enum MtaPostscreenPipeliningEnable {
    ...
    private MtaPostscreenPipeliningEnable(String value) {
      mValue = value;
    }
  ...
  public static enum MtaPostscreenUpstreamProxyProtocol {
    ...
    private MtaPostscreenUpstreamProxyProtocol(String value) {
      mValue = value;
    }
  ...
  public static enum MtaPropagateUnmatchedExtensions {
    ...
    private MtaPropagateUnmatchedExtensions(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSaslAuthEnable {
    ...
    private MtaSaslAuthEnable(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpCnameOverridesServername {
    ...
    private MtaSmtpCnameOverridesServername(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpdClientPortLogging {
    ...
    private MtaSmtpdClientPortLogging(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpdHeloRequired {
    ...
    private MtaSmtpdHeloRequired(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpDnsSupportLevel {
    ...
    private MtaSmtpDnsSupportLevel(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpdRejectUnlistedRecipient {
    ...
    private MtaSmtpdRejectUnlistedRecipient(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpdRejectUnlistedSender {
    ...
    private MtaSmtpdRejectUnlistedSender(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpdSaslAuthenticatedHeader {
    ...
    private MtaSmtpdSaslAuthenticatedHeader(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpdSaslSecurityOptions {
    ...
    private MtaSmtpdSaslSecurityOptions(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpdTlsAskCcert {
    ...
    private MtaSmtpdTlsAskCcert(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpdTlsCiphers {
    ...
    private MtaSmtpdTlsCiphers(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpdTlsMandatoryCiphers {
    ...
    private MtaSmtpdTlsMandatoryCiphers(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpdTlsReceivedHeader {
    ...
    private MtaSmtpdTlsReceivedHeader(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpSaslAuthEnable {
    ...
    private MtaSmtpSaslAuthEnable(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpSaslSecurityOptions {
    ...
    private MtaSmtpSaslSecurityOptions(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpTlsCiphers {
    ...
    private MtaSmtpTlsCiphers(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpTlsDaneInsecureMXPolicy {
    ...
    private MtaSmtpTlsDaneInsecureMXPolicy(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpTlsMandatoryCiphers {
    ...
    private MtaSmtpTlsMandatoryCiphers(String value) {
      mValue = value;
    }
  ...
  public static enum MtaSmtpTlsSecurityLevel {
    ...
    private MtaSmtpTlsSecurityLevel(String value) {
      mValue = value;
    }
  ...
  public static enum MtaTlsAppendDefaultCA {
    ...
    private MtaTlsAppendDefaultCA(String value) {
      mValue = value;
    }
  ...
  public static enum MtaTlsSecurityLevel {
    ...
    private MtaTlsSecurityLevel(String value) {
      mValue = value;
    }
  ...
  public static enum PasswordLockoutSuppressionProtocols {
    ...
    private PasswordLockoutSuppressionProtocols(String value) {
      mValue = value;
    }
    ...
    public boolean isHttp_basic() {
      return this == http_basic;
    }

    public boolean isHttp_dav() {
      return this == http_dav;
    }
  ...
  public static enum PrefBriefcaseReadingPaneLocation {
    ...
    private PrefBriefcaseReadingPaneLocation(String value) {
      mValue = value;
    }
  ...
  public static enum PrefCalendarAllowedTargetsForInviteDeniedAutoReply {
    ...
    private PrefCalendarAllowedTargetsForInviteDeniedAutoReply(String value) {
      mValue = value;
    }
    ...
    public static PrefCalendarAllowedTargetsForInviteDeniedAutoReply fromString(String s)
        throws ServiceException {
  ...
  public static enum PrefCalendarApptVisibility {
    ...
    private PrefCalendarApptVisibility(String value) {
      mValue = value;
    }
  ...
  public static enum PrefCalendarInitialView {
    ...
    private PrefCalendarInitialView(String value) {
      mValue = value;
    }
  ...
  public static enum PrefClientType {
    ...
    private PrefClientType(String value) {
      mValue = value;
    }
  ...
  public static enum PrefComposeDirection {
    ...
    private PrefComposeDirection(String value) {
      mValue = value;
    }
  ...
  public static enum PrefComposeFormat {
    ...
    private PrefComposeFormat(String value) {
      mValue = value;
    }
  ...
  public static enum PrefContactsInitialView {
    ...
    private PrefContactsInitialView(String value) {
      mValue = value;
    }
  ...
  public static enum PrefConversationOrder {
    ...
    private PrefConversationOrder(String value) {
      mValue = value;
    }
  ...
  public static enum PrefConvReadingPaneLocation {
    ...
    private PrefConvReadingPaneLocation(String value) {
      mValue = value;
    }
  ...
  public static enum PrefDedupeMessagesSentToSelf {
    ...
    private PrefDedupeMessagesSentToSelf(String value) {
      mValue = value;
    }
  ...
  public static enum PrefDelegatedSendSaveTarget {
    ...
    private PrefDelegatedSendSaveTarget(String value) {
      mValue = value;
    }
  ...
  public static enum PrefExternalSendersType {
    ...
    private PrefExternalSendersType(String value) {
      mValue = value;
    }
    ...
    public boolean isALLNOTINAB() {
      return this == ALLNOTINAB;
    }
  ...
  public static enum PrefForwardIncludeOriginalText {
    ...
    private PrefForwardIncludeOriginalText(String value) {
      mValue = value;
    }
  ...
  public static enum PrefForwardReplyFormat {
    ...
    private PrefForwardReplyFormat(String value) {
      mValue = value;
    }
  ...
  public static enum PrefFromAddressType {
    ...
    private PrefFromAddressType(String value) {
      mValue = value;
    }
  ...
  public static enum PrefGetMailAction {
    ...
    private PrefGetMailAction(String value) {
      mValue = value;
    }
  ...
  public static enum PrefGroupMailBy {
    ...
    private PrefGroupMailBy(String value) {
      mValue = value;
    }
  ...
  public static enum PrefIMIdleStatus {
    ...
    private PrefIMIdleStatus(String value) {
      mValue = value;
    }
  ...
  public static enum PrefMailSelectAfterDelete {
    ...
    private PrefMailSelectAfterDelete(String value) {
      mValue = value;
    }
  ...
  public static enum PrefMailSendReadReceipts {
    ...
    private PrefMailSendReadReceipts(String value) {
      mValue = value;
    }
  ...
  public static enum PrefMailSignatureStyle {
    ...
    private PrefMailSignatureStyle(String value) {
      mValue = value;
    }
  ...
  public static enum PrefOutOfOfficeFreeBusyStatus {
    ...
    private PrefOutOfOfficeFreeBusyStatus(String value) {
      mValue = value;
    }
  ...
  public static enum PrefPasswordRecoveryAddressStatus {
    ...
    private PrefPasswordRecoveryAddressStatus(String value) {
      mValue = value;
    }
  ...
  public static enum PrefPop3DeleteOption {
    ...
    private PrefPop3DeleteOption(String value) {
      mValue = value;
    }
  ...
  public static enum PrefReadingPaneLocation {
    ...
    private PrefReadingPaneLocation(String value) {
      mValue = value;
    }
  ...
  public static enum PrefReplyIncludeOriginalText {
    ...
    private PrefReplyIncludeOriginalText(String value) {
      mValue = value;
    }
  ...
  public static enum PrefTasksFilterBy {
    ...
    private PrefTasksFilterBy(String value) {
      mValue = value;
    }
  ...
  public static enum PrefTasksReadingPaneLocation {
    ...
    private PrefTasksReadingPaneLocation(String value) {
      mValue = value;
    }
  ...
  public static enum ReverseProxyAcceptMutex {
    ...
    private ReverseProxyAcceptMutex(String value) {
      mValue = value;
    }
  ...
  public static enum ReverseProxyClientCertMode {
    ...
    private ReverseProxyClientCertMode(String value) {
      mValue = value;
    }
  ...
  public static enum ReverseProxyExactServerVersionCheck {
    ...
    private ReverseProxyExactServerVersionCheck(String value) {
      mValue = value;
    }
  ...
  public static enum ReverseProxyImapStartTlsMode {
    ...
    private ReverseProxyImapStartTlsMode(String value) {
      mValue = value;
    }
  ...
  public static enum ReverseProxyLogLevel {
    ...
    private ReverseProxyLogLevel(String value) {
      mValue = value;
    }
    ...
    public boolean isDebug_http() {
      return this == debug_http;
    }

    public boolean isDebug_mail() {
      return this == debug_mail;
    }

    public boolean isDebug_core() {
      return this == debug_core;
    }

    public boolean isDebug_zimbra() {
      return this == debug_zimbra;
    }
  }
  ...
  public static enum ReverseProxyMailMode {
    ...
    private ReverseProxyMailMode(String value) {
      mValue = value;
    }
  ...
  public static enum ReverseProxyPop3StartTlsMode {
    ...
    private ReverseProxyPop3StartTlsMode(String value) {
      mValue = value;
    }
  ...
  public static enum ScheduledTaskRetryPolicy {
    ...
    private ScheduledTaskRetryPolicy(String value) {
      mValue = value;
    }
  ...
  public static enum ShareNotificationMtaConnectionType {
    ...
    private ShareNotificationMtaConnectionType(String value) {
      mValue = value;
    }
  ...
  public static enum TableMaintenanceOperation {
    ...
    private TableMaintenanceOperation(String value) {
      mValue = value;
    }
  ...
  public static enum TwoFactorAuthHashAlgorithm {
    ...
    private TwoFactorAuthHashAlgorithm(String value) {
      mValue = value;
    }
  ...
  public static enum TwoFactorAuthScratchCodeEncoding {
    ...
    private TwoFactorAuthScratchCodeEncoding(String value) {
      mValue = value;
    }
  ...
  public static enum TwoFactorAuthSecretEncoding {
    ...
    private TwoFactorAuthSecretEncoding(String value) {
      mValue = value;
    }
   ...
   */
  @ZAttr(id = 3091)
  public static final String A_carbonioVideoServerRecordingEnabled =
   ...
   */
  @ZAttr(id = 3100)
  public static final String A_carbonioWebUiDarkLoginBackground =
  ...
  /**
   * Deprecated since: 5.0. deprecated in favor of the accountInfo flag. Orig desc: additional
   * account attrs that get returned to a client
   */
  @ZAttr(id = 112)
  public static final String A_zimbraAccountClientAttr = "zimbraAccountClientAttr";

  /**
   * Object classes to add when creating a zimbra account object. Useful if you want to add
   * sambaSamAccount etc to zimbra accounts.
   */
  @ZAttr(id = 438)
  public static final String A_zimbraAccountExtraObjectClass = "zimbraAccountExtraObjectClass";

  /**
   * account status. active - active lockout - no login until lockout duration is over, mail
   * delivery OK. locked - no login, mail delivery OK. maintenance - no login, no delivery(lmtp
   * server returns 4.x.x Persistent Transient Failure). pending - no login, no delivery(lmtp server
   * returns 5.x.x Permanent Failure), Account behavior is like closed, except that when the status
   * is being set to pending, account addresses are not removed from distribution lists. The use
   * case is for hosted. New account creation based on invites that are not completed until user
   * accepts TOS on account creation confirmation page. closed - no login, no delivery(lmtp server
   * returns 5.x.x Permanent Failure), all addresses (account main email and all aliases) of the
  ...
  /**
   * Ehcache: default expiration time for activesync cache values; default is 5 minutes. Must be in
   * valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 3003)
  public static final String A_zimbraActiveSyncEhcacheExpiration =
      "zimbraActiveSyncEhcacheExpiration";

  /**
   * Ehcache: the maximum heap size of the ActiveSync cache in Bytes before eviction. By default
   * this value is 10MB. This is a rough limit,Due to internals of ehcache actual size in memory
   * will often exceed this limit by a modest margin.
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 3001)
  ...
  /**
   * Ehcache: the maximum disk size of the ActiveSync cache in Bytes before eviction. By default
   * this value is 10GB. This is a rough limit,Due to internals of ehcache actual size on disk will
   * often exceed this limit by a modest margin.
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 3002)
  public static final String A_zimbraActiveSyncEhcacheMaxDiskSize =
  ...
  /**
   * access control mechanism for admin access acl: ACL based access control (a.k.a. delegated
   * admin). global: allows only global admins.
   *
   * @since ZCS 6.0.9
   */
  @ZAttr(id = 1101)
  ...
  /**
   * lifetime of newly created admin auth tokens. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 109)
  public static final String A_zimbraAdminAuthTokenLifetime = "zimbraAdminAuthTokenLifetime";

  /**
   * interface address on which Admin HTTPS server should listen; if empty, binds to all interfaces
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1368)
   ...
   */
  @ZAttr(id = 746)
  public static final String A_zimbraAdminConsoleCatchAllAddressEnabled =
   ...
   */
  @ZAttr(id = 743)
  public static final String A_zimbraAdminConsoleDNSCheckEnabled =
   ...
   */
  @ZAttr(id = 774)
  public static final String A_zimbraAdminConsoleLDAPAuthEnabled =
  ...
  /**
   * login URL for admin console to send the user to upon explicit logging in
   *
   * @since ZCS 5.0.9
   */
  @ZAttr(id = 696)
  ...
  /**
   * logout URL for admin console to send the user to upon explicit logging out
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 684)
  ...
  /**
   * Zimlet Util will set this attribute based on the value in zimlet definition XML file
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 803)
  ...
  /**
   * Specifies whether the admin server should bound to localhost or not. This is an immutable
   * property and is generated based on zimbraAdminBindAddress.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1377)
  ...
  /**
   * outgoing sieve script defined by admin (not able to edit and view from the end user) applied
   * after the end user filter rule
   *
   * @since ZCS 8.7.8
   */
  @ZAttr(id = 2116)
  public static final String A_zimbraAdminOutgoingSieveScriptAfter =
      "zimbraAdminOutgoingSieveScriptAfter";
   ...
   */
  @ZAttr(id = 2115)
  public static final String A_zimbraAdminOutgoingSieveScriptBefore =
      "zimbraAdminOutgoingSieveScriptBefore";
  ...
  /**
   * Deprecated since: 8.7.8. Variable feature is always enabled, hence this attribute has been
   * deprecated. Orig desc: Whether to enable the Sieve &quot;Variables&quot; extension defined in
   * RFC 5229 in the admin-defined sieve rules.
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 2098)
  public static final String A_zimbraAdminSieveFeatureVariablesEnabled =
      "zimbraAdminSieveFeatureVariablesEnabled";

  /**
   * sieve script defined by admin (not able to edit and view from the end user) applied after the
   * end user filter rule
   *
   * @since ZCS 8.7.8
   */
  @ZAttr(id = 2114)
  ...
  /**
   * sieve script defined by admin (not able to edit and view from the end user) applied before the
   * end user filter rule
   *
   * @since ZCS 8.7.8
   */
  ...
  /**
   * Whether this account can use any from address. Not changeable by domain admin to allow
   * arbitrary addresses
   */
  @ZAttr(id = 427)
  ...
  /**
   * Addresses that this account is permitted to use in From: header on sent messages. Only
   * applicable when zimbraAllowAnyFromAddress is set to false.
   */
  @ZAttr(id = 428)
  public static final String A_zimbraAllowFromAddress = "zimbraAllowFromAddress";

  /**
   * whether creating domains, and renaming domains to a name, containing non-LDH (letter, digit,
   * hyphen) characters is allowed
   *
   * @since ZCS 6.0.2
   */
  @ZAttr(id = 1052)
  ...
  /**
   * Deprecated since: 22.9.0. dropping always on cluster feature in whole. Orig desc: AlwaysOn
   * cluster-id to which this server belongs to. If empty, it&#039;s not part of AlwaysOn and is a
   * stand-alone server.
   *
   * @since ZCS 8.5.0
   */
   ...
   */
  @ZAttr(id = 1459)
  public static final String A_zimbraAmavisDomainDisclaimerHTML =
   ...
   */
  @ZAttr(id = 1458)
  public static final String A_zimbraAmavisDomainDisclaimerText =
      "zimbraAmavisDomainDisclaimerText";

  /**
   * Whether or not Amavis should use DSPAM as an additional score factor for SPAM. Defaults to
   * FALSE
   *
   * @since ZCS 8.5.0
   */
   ...
   */
  @ZAttr(id = 1463)
  public static final String A_zimbraAmavisEnableDKIMVerification =
  ...
  /**
   * Whether or not Amavis should Bypass SpamAsassin for originating email. Defaults to FALSE
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1464)
  ...
  /**
   * Whether or not Amavis disclaimers should only be attached to outbound emails. Defaults to FALSE
   * (Always attach a disclaimer)
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1577)
  public static final String A_zimbraAmavisOutboundDisclaimersOnly =
  ...
  /**
   * Loglevel for SpamAssassin when called via Amavis. Defaults to 0 (info). Can be 0 or 1 (info,
   * all)
   *
   * @since ZCS 8.5.0
   */
   ...
   */
  @ZAttr(id = 1457)
  public static final String A_zimbraAntispamExtractionBatchDelay =
   ...
   */
  @ZAttr(id = 1456)
  public static final String A_zimbraAntispamExtractionBatchSize =
  ...
  /**
   * lifetime of app-specific passwords, or 0 for no expiry. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1839)
  public static final String A_zimbraAppSpecificPasswordDuration =
  ...
  /**
   * Mailboxes in which the current account in archived. Multi-value attr with eg values {
   * user-2006@example.com.archive, user-2007@example.com.archive } that tells us that
  ...
  /**
   * An account or CoS setting that works with the name template that allows you to dictate the date
   * format used in the name template. This is a Java SimpleDateFormat specifier. The default is an
   * LDAP generalized time format:
   */
  @ZAttr(id = 432)
  public static final String A_zimbraArchiveAccountDateTemplate =
      "zimbraArchiveAccountDateTemplate";

  /**
   * An account or CoS setting - typically only in CoS - that tells the archiving system how to
   * derive the archive mailbox name. ID, USER, DATE, and DOMAIN are expanded.
   */
  @ZAttr(id = 431)
  public static final String A_zimbraArchiveAccountNameTemplate =
  ...
  /**
   * Address to which archive message bounces should be sent. Typically could be an admin account.
   * This is global across all domains.
   */
  @ZAttr(id = 430)
  ...
  /**
   * Maximum number of characters that will be indexed for a given MIME part.
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 582)
  public static final String A_zimbraAttachmentsIndexedTextLimit =
      "zimbraAttachmentsIndexedTextLimit";

  /** whether or not to index attachments */
  @ZAttr(id = 173)
  public static final String A_zimbraAttachmentsIndexingEnabled =
  ...
  /**
   * Information about the latest run of zmmigrateattrs. Includes the URL of the destination
   * ephemeral store and the state of the migration (in progress, completed, failed)
   *
   * @since ZCS 8.8.1
   */
  @ZAttr(id = 3019)
  ...
  @ZAttr(id = 254)
  public static final String A_zimbraAuthLdapSearchBindPassword =
  ...
  /**
   * mechanism to use for verifying password. Valid values are zimbra, ldap, ad, kerberos5,
   * custom:{handler-name} [arg1 arg2 ...]
   */
  @ZAttr(id = 42)
  ...
  /**
   * lifetime of newly created auth tokens. Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 108)
  public static final String A_zimbraAuthTokenLifetime = "zimbraAuthTokenLifetime";

  /**
   * This attribute is used to configure the interval with which servers will send a list of
   * invalidated tokens to each other. When an account logs out of a server, the account&#039;s
   * authtoken is added to a queue of invalidated tokens on the server. Each server will send
   * it&#039;s queue of invalidated tokens to all other servers with frequency configurable by this
   * attribute. See zimbraLogOutFromAllServers for more info on configuring authtoken invalidation
   * on Accounts and Classes of Service. Set to higher value to reduce network chatter. Set to lower
   * value to decrease the window during which a stolen cookie may be reused to access an account.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1635)
  public static final String A_zimbraAuthTokenNotificationInterval =
  ...
  /**
   * if set, this value gets stored in the auth token and compared on every request. Changing it
   * will invalidate all outstanding auth tokens. It also gets changed when an account password is
   * changed.
   *
   * @since ZCS 6.0.0_GA
   */
   ...
   */
  @ZAttr(id = 1094)
  public static final String A_zimbraAuthTokenValidityValueEnabled =
      "zimbraAuthTokenValidityValueEnabled";

  /**
   * EAGER mode: optional LAZY mode: optional MANUAL mode: optional Attribute name in the external
   * directory that contains localpart of the account name. If not specified, localpart of the
  ...
  /**
   * EAGER mode: optional LAZY mode: optional MANUAL mode: optional Attribute map for mapping
   * attribute values from the external entry to Zimbra account attributes. Values are in the format
   * of {external attribute}={zimbra attribute}. If not set, no attributes from the external
   * directory will be populated in Zimbra directory. Invalid mapping configuration will cause the
   * account creation to fail. Examples of bad mapping: - invalid external attribute name. - invalid
   * Zimbra attribute name. - external attribute has multiple values but the zimbra attribute is
   * single-valued. - syntax violation. e.g. Value on the external attribute is a String but the
   * Zimbra attribute is declared an integer.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1231)
  ...
  /**
   * EAGER mode: N/A LAZY mode: required MANUAL mode: N/A Auth mechanisms enabled for auto provision
   * in LAZY mode. When a user authenticates via one of the external auth mechanisms enabled in this
   * attribute, and when the user account does not yet exist in Zimbra directory, an account entry
   * will be automatically created in Zimbra directory.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1222)
  ...
  /**
   * EAGER mode: required LAZY mode: N/A MANUAL mode: N/A Max number of accounts to process in each
   * interval for EAGER auto provision.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1234)
  ...
  /**
   * EAGER mode: for Zimbra internal use only - do not change it. LAZY mode: N/A MANUAL mode: N/A
   * Timestamp when the external domain is last polled for EAGER auto provision. The poll (LDAP
   * search) for the next iteration will fetch external entries with create timestamp later than the
   * timestamp recorded from the previous iteration.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1235)
  public static final String A_zimbraAutoProvLastPolledTimestamp =
      "zimbraAutoProvLastPolledTimestamp";

  /**
   * EAGER mode: required LAZY mode: required (if using zimbraAutoProvLdapSearchFilter) MANUAL mode:
   * required LDAP search bind DN for auto provision.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1225)
  ...
  /**
   * EAGER mode: required LAZY mode: required MANUAL mode: required LDAP search bind password for
   * auto provision.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1226)
  public static final String A_zimbraAutoProvLdapAdminBindPassword =
      "zimbraAutoProvLdapAdminBindPassword";

  /**
   * EAGER mode: required LAZY mode: optional (if not using zimbraAutoProvLdapSearchFilter) MANUAL
   * mode: optional (if not using zimbraAutoProvLdapSearchFilter) LDAP external DN template for
   * account auto provisioning. For LAZY and MANUAL modes, either zimbraAutoProvLdapSearchFilter or
   * zimbraAutoProvLdapBindDn has to be set. If both are set, zimbraAutoProvLdapSearchFilter will
   * take precedence. Supported place holders: %n = username with @ (or without, if no @ was
   * specified) %u = username with @ removed %d = domain as foo.com %D = domain as dc=foo,dc=com
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1229)
  ...
  /**
   * EAGER mode: required LAZY mode: required (if using zimbraAutoProvLdapSearchFilter), MANUAL
   * mode: required LDAP search base for auto provision, used in conjunction with
   * zimbraAutoProvLdapSearchFilter. If not set, LDAP root DSE will be used.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1227)
  ...
  /**
   * EAGER mode: required LAZY mode: optional (if not using zimbraAutoProvLdapBindDn) MANUAL mode:
   * optional (if not using zimbraAutoProvLdapBindDn) LDAP search filter template for account auto
   * provisioning. For LAZY and MANUAL modes, either zimbraAutoProvLdapSearchFilter or
   * zimbraAutoProvLdapBindDn has to be set. If both are set, zimbraAutoProvLdapSearchFilter will
   * take precedence. Supported place holders: %n = username with @ (or without, if no @ was
   * specified) %u = username with @ removed %d = domain as foo.com %D = domain as dc=foo,dc=com
   *
  ...
  /**
   * EAGER mode: optional LAZY mode: optional MANUAL mode: optional Default is FALSE. Whether to use
   * startTLS when accessing the external LDAP server for auto provision.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1224)
  public static final String A_zimbraAutoProvLdapStartTlsEnabled =
      "zimbraAutoProvLdapStartTlsEnabled";

  /**
   * EAGER mode: required LAZY mode: required MANUAL mode: required LDAP URL of the external LDAP
  ...
  /**
   * EAGER mode: optional LAZY mode: optional MANUAL mode: optional Class name of auto provision
   * listener. The class must implement the com.zimbra.cs.account.Account.AutoProvisionListener
   * interface. The singleton listener instance is invoked after each account is auto created in
   * Zimbra. Listener can be plugged in as a server extension to handle tasks like updating the
   * account auto provision status in the external LDAP directory. At each eager provision interval,
   * ZCS does an LDAP search based on the value configured in zimbraAutoProvLdapSearchFilter.
   * Returned entries from this search are candidates to be auto provisioned in this batch. The
   * zimbraAutoProvLdapSearchFilter should include an assertion that will only hit entries in the
   * external directory that have not yet been provisioned in ZCS, otherwise it&#039;s likely the
   * same entries will be repeated pulled in to ZCS. After an account is auto provisioned in ZCS,
   * com.zimbra.cs.account.Account.AutoProvisionListener.postCreate(Domain domain, Account acct,
   * String externalDN) will be called by the auto provisioning framework. Customer can implement
   * the AutoProvisionListener interface in a ZCS server extension and get their
   * AutoProvisionListener.postCreate() get called. The implementation of customer&#039;s postCreate
   * method can be, for example, setting an attribute in the external directory on the account just
   * provisioned in ZCS. The attribute can be included as a condition in the
   * zimbraAutoProvLdapSearchFilter, so the entry won&#039;t be returned again by the LDAP search in
   * the next interval.
   *
   * @since ZCS 8.0.0
   */
   ...
   * one server can perform provisioning for a domain at one time. This attribute servers a lock for
   * the test-and-set LDAP operation to synchronize EAGER auto provision attempts between servers.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1236)
  ...
  /**
   * Auto provision modes enabled. Multiple modes can be enabled on a domain. EAGER: A server
   * maintenance thread automatically polls the configured external auto provision LDAP source at a
   * configured interval for entries due to be auto provisioned in Zimbra, and then auto creates the
   * accounts in Zimbra directory. LAZY: auto creates the Zimbra account when user first login via
   * one of the external auth mechanisms enabled for auto provisioning. Auth mechanisms enabled for
   * auto provisioning are configured in zimbraAutoProvAuthMech. MANUAL: admin to search from the
   * configured external auto provision LDAP source and select an entry from the search result to
   * create the corresponding Zimbra account for the external entry. In all cases, localpart of the
   * Zimbra account is mapped from an attribute on the external entry based on
   * zimbraAutoProvAccountNameMap. The Zimbra account is populated with attributes mapped from the
   * external entry based on zimbraAutoProvAttrMap.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1221)
  ...
  /**
   * Template used to construct the subject of the notification message sent to the user when the
   * user&#039;s account is auto provisioned. Supported variables: ${ACCOUNT_ADDRESS},
  ...
  /**
   * EAGER mode: optional LAZY mode: optional MANUAL mode: optional Email address to put in the From
   * header for the notification email to the newly created account. If not set, no notification
   * email will sent to the newly created account.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1232)
  public static final String A_zimbraAutoProvNotificationFromAddress =
   ...
   */
  @ZAttr(id = 1356)
  public static final String A_zimbraAutoProvNotificationSubject =
      "zimbraAutoProvNotificationSubject";

  /**
   * EAGER mode: required LAZY mode: N/A MANUAL mode: N/A Interval between successive polling and
   * provisioning accounts in EAGER mode. The actual interval may take longer since it can be
   * affected by two other factors: zimbraAutoProvBatchSize and number of domains configured in
   * zimbraAutoProvScheduledDomains. At each interval, the auto provision thread iterates through
   * all domains in zimbraAutoProvScheduledDomains and auto creates up to
   * domain.zimbraAutoProvBatchSize accounts. If that process takes longer than
   * zimbraAutoProvPollingInterval then the next iteration will start immediately instead of waiting
   * for zimbraAutoProvPollingInterval amount of time. If set to 0 when server starts up, the auto
   * provision thread will not start. If changed from a non-0 value to 0 while server is running,
   * the auto provision thread will be shutdown. If changed from 0 to a non-0 value while server is
   * running, the auto provision thread will be started. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
  ...
  /**
   * EAGER mode: required LAZY mode: N/A MANUAL mode: N/A Domain scheduled for eager auto provision
   * on this server. Scheduled domains must have EAGER mode enabled in zimbraAutoProvMode. Multiple
   * domains can be scheduled on a server for EAGER auto provision. Also, a domain can be scheduled
   * on multiple servers for EAGER auto provision.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1237)
  ...
  /**
   * If TRUE, use a null return path for envelope MAIL FROM when sending out of office and new mail
   * notifications. If FALSE, the account address is used for the return path. Note that setting the
   * value to TRUE may cause failed delivery of some out of office or new mail notifications because
   * some agents require a valid sender.
   */
  @ZAttr(id = 502)
  public static final String A_zimbraAutoSubmittedNullReturnPath =
      "zimbraAutoSubmittedNullReturnPath";

  /**
   * Whether account should act as a service account to provide free busy information to exchange
   * servers for users in the domain.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2072)
  public static final String A_zimbraAvailabilityServiceProvider =
      "zimbraAvailabilityServiceProvider";
  ...
  /**
   * Skins available for this account. Fallback order is: 1. the normal account/cos inheritance 2.
   * if not set on account/cos, use the value on the domain of the account
   */
  @ZAttr(id = 364)
  ...
  @ZAttr(id = 514)
  public static final String A_zimbraBackupAutoGroupedNumGroups =
      "zimbraBackupAutoGroupedNumGroups";

  /**
   * if true, limit the number of mailboxes in auto-grouped backup to total mailboxes divided by
   * auto-group days
   */
  @ZAttr(id = 515)
  public static final String A_zimbraBackupAutoGroupedThrottled =
      "zimbraBackupAutoGroupedThrottled";

  /**
   * Minimum percentage or TB/GB/MB/KB/bytes of free space on backup target to allow a full or
   * auto-grouped backup to start; 0 = no minimum is enforced. Examples: 25%, 10GB
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1111)
  ...
  @ZAttr(id = 459)
  public static final String A_zimbraBackupReportEmailRecipients =
  ...
  @ZAttr(id = 461)
  public static final String A_zimbraBackupReportEmailSubjectPrefix =
  ...
  /**
   * if true, do not backup blobs on secondary (HSM) volumes during a full backup
   *
   * @since ZCS 6.0.0_BETA2
   */
  @ZAttr(id = 1005)
   ...
   */
  @ZAttr(id = 651)
  public static final String A_zimbraCalendarCalDavAlternateCalendarHomeSet =
   ...
   * If FALSE, the &quot;calendar-schedule&quot; feature of CalDAV is advertised instead - see
   * draft-desruisseaux-caldav-sched-03. Note that the value of
   * &quot;zimbraCalendarCalDavDisableScheduling&quot; takes precedence over this attribute.
   *
   * @since ZCS 8.6.0
   */
  @ZAttr(id = 1655)
  public static final String A_zimbraCalendarCalDavCalendarAutoScheduleEnabled =
      "zimbraCalendarCalDavCalendarAutoScheduleEnabled";

  /**
   * Whether to allow password sent to non-secured port from CalDAV clients. If it set to TRUE the
   * server will allow access from CalDAV client to zimbraMailPort. If it set to FALSE the server
   * will return an error if a request is made from CalDAV client to zimbraMailPort.
   *
   * @since ZCS 5.0.14
   */
  @ZAttr(id = 820)
  public static final String A_zimbraCalendarCalDavClearTextPasswordEnabled =
      "zimbraCalendarCalDavClearTextPasswordEnabled";

  /**
   * Id of calendar folder to advertise as the default calendar to CalDAV client.
   *
   * @since ZCS 6.0.6
   */
  @ZAttr(id = 1078)
  public static final String A_zimbraCalendarCalDavDefaultCalendarId =
   ...
   */
  @ZAttr(id = 690)
  public static final String A_zimbraCalendarCalDavDisableFreebusy =
   ...
   */
  @ZAttr(id = 652)
  public static final String A_zimbraCalendarCalDavDisableScheduling =
      "zimbraCalendarCalDavDisableScheduling";

  /**
   * CalDAV shared folder cache duration. Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.14
   */
  @ZAttr(id = 817)
  public static final String A_zimbraCalendarCalDavSharedFolderCacheDuration =
      "zimbraCalendarCalDavSharedFolderCacheDuration";

  /**
   * see description of zimbraCalendarCalDavSyncStart. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.14
  ...
  /**
   * zimbraCalendarCalDavSyncStart and zimbraCalendarCalDavSyncEnd limits the window of appointment
   * data available via CalDAV. for example when zimbraCalendarCalDavSyncStart is set to 30 days,
   * and zimbraCalendarCalDavSyncEnd is set to 1 years, then the appointments between (now - 30
   * days) and (now + 1 year) will be available via CalDAV. When they are unset all the appointments
   * are available via CalDAV. . Must be in valid duration format: {digits}{time-unit}. digits: 0-9,
   * time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time
  ...
  /**
   * Deprecated since: 8.0.0. Deprecated per bug 69886.. Orig desc: When set to TRUE, Calendar
   * folders and Todo folders in Zimbra will be advertised as Calendar only and Todo only via
   * CalDAV. When set to FALSE, Calendar folders will be able to store both appointments and tasks,
   * and Todo folders will not be advertised as CalDAV enabled.
   *
   * @since ZCS 5.0.12
   */
  @ZAttr(id = 794)
  public static final String A_zimbraCalendarCalDavUseDistinctAppointmentAndToDoCollection =
  ...
  /**
   * whether to retain exception instances when the recurrence series is changed to new time; set to
   * FALSE for Exchange compatibility
   *
   * @since ZCS 7.1.2
   */
  @ZAttr(id = 1240)
  public static final String A_zimbraCalendarKeepExceptionsOnSeriesTimeChange =
   ...
   */
  @ZAttr(id = 1218)
  public static final String A_zimbraCalendarLocationDisabledFields =
      "zimbraCalendarLocationDisabledFields";

  /**
   * maximum number of revisions to keep for calendar items (appointments and tasks). 0 means
   * unlimited.
   *
   * @since ZCS 5.0.10
   */
  ...
  /**
   * Maximum number of days a DAILY recurrence rule can span; 0 means unlimited
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 661)
  public static final String A_zimbraCalendarRecurrenceDailyMaxDays =
      "zimbraCalendarRecurrenceDailyMaxDays";

  /**
   * Maximum number of instances expanded per recurrence rule; 0 means unlimited
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 660)
  public static final String A_zimbraCalendarRecurrenceMaxInstances =
      "zimbraCalendarRecurrenceMaxInstances";

  /**
   * Maximum number of months a MONTHLY recurrence rule can span; 0 means unlimited
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 663)
  public static final String A_zimbraCalendarRecurrenceMonthlyMaxMonths =
      "zimbraCalendarRecurrenceMonthlyMaxMonths";

  /**
   * Maximum number of years a recurrence rule can span for frequencies other than
   * DAILY/WEEKLY/MONTHLY/YEARLY; 0 means unlimited
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 665)
  public static final String A_zimbraCalendarRecurrenceOtherFrequencyMaxYears =
      "zimbraCalendarRecurrenceOtherFrequencyMaxYears";

  /**
   * Maximum number of weeks a WEEKLY recurrence rule can span; 0 means unlimited
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 662)
  public static final String A_zimbraCalendarRecurrenceWeeklyMaxWeeks =
      "zimbraCalendarRecurrenceWeeklyMaxWeeks";

  /**
   * Maximum number of years a YEARLY recurrence rule can span; 0 means unlimited
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 664)
  public static final String A_zimbraCalendarRecurrenceYearlyMaxYears =
      "zimbraCalendarRecurrenceYearlyMaxYears";

  /**
   * email address identifying the default device for receiving reminders for appointments and tasks
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1140)
  public static final String A_zimbraCalendarReminderDeviceEmail =
   ...
   */
  @ZAttr(id = 1087)
  public static final String A_zimbraCalendarResourceDoubleBookingAllowed =
   ...
   */
  @ZAttr(id = 753)
  public static final String A_zimbraCalendarResourceExtraObjectClass =
      "zimbraCalendarResourceExtraObjectClass";

  /**
   * whether to show Find Locations and Find Resources tabs for editing appointments
   *
   * @since ZCS 6.0.7
   */
  @ZAttr(id = 1092)
  ...
  /** Whether this calendar resource accepts/declines meeting invites automatically; default TRUE */
  @ZAttr(id = 315)
  public static final String A_zimbraCalResAutoAcceptDecline = "zimbraCalResAutoAcceptDecline";

  /** Whether this calendar resource declines invite if already busy; default TRUE */
  @ZAttr(id = 322)
  public static final String A_zimbraCalResAutoDeclineIfBusy = "zimbraCalResAutoDeclineIfBusy";

  /** Whether this calendar resource declines invites to recurring appointments; default FALSE */
  @ZAttr(id = 323)
  public static final String A_zimbraCalResAutoDeclineRecurring =
  ...
  /**
   * Maximum number of conflicting instances allowed before declining schedule request for a
   * recurring appointments; default 0 (means decline on any conflict)
   *
   * @since ZCS 5.0.14
   */
  @ZAttr(id = 808)
  public static final String A_zimbraCalResMaxNumConflictsAllowed =
      "zimbraCalResMaxNumConflictsAllowed";

  /**
   * Maximum percent of conflicting instances allowed before declining schedule request for a
   * recurring appointment; default 0 (means decline on any conflict)
   *
   * @since ZCS 5.0.14
   */
  @ZAttr(id = 809)
  public static final String A_zimbraCalResMaxPercentConflictsAllowed =
  ...
  /**
   * Whether or not to enable CBPolicyd Access Control module. Defaults to FALSE
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1469)
  public static final String A_zimbraCBPolicydAccessControlEnabled =
      "zimbraCBPolicydAccessControlEnabled";

  /**
   * Whether or not to enable CBPolicyd Accounting module. Defaults to FALSE
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1470)
  public static final String A_zimbraCBPolicydAccountingEnabled =
  ...
  /**
   * Whether or not to enable CBPolicyd Check Helo module. Defaults to FALSE
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1472)
  ...
  /**
   * Message to give when client is on blacklist. Default is Greylisting in effect, sending server
   * blacklisted
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1487)
  public static final String A_zimbraCBPolicydGreylistingBlacklistMsg =
      "zimbraCBPolicydGreylistingBlacklistMsg";

  /**
   * Message to give when deferring email. Default is Greylisting in effect, please come back later
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1486)
  public static final String A_zimbraCBPolicydGreylistingDeferMsg =
      "zimbraCBPolicydGreylistingDeferMsg";

  /**
   * Whether or not to enable CBPolicyd Greylisting module. Defaults to FALSE
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1474)
  public static final String A_zimbraCBPolicydGreylistingEnabled =
      "zimbraCBPolicydGreylistingEnabled";

  /**
   * Whether or not to put CBPolicyd Greylisting module in training only mode. Defaults to FALSE
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1475)
  public static final String A_zimbraCBPolicydGreylistingTrainingEnabled =
  ...
  /**
   * Maximum number of spare servers to have on hand that are idle. Defaults to 12
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1479)
  ...
  /**
   * Timeout when talking to clients and servers are busy. Defaults to 120 seconds
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1483)
  ...
  /**
   * Timeout when talking to clients and servers are idle. Defaults to 1020 seconds
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1482)
  ...
  /**
   * When creating self-signed SSL certs during an install, we also create a local Certificate
   * Authority (CA) to sign these SSL certs. This local CA-s own cert is then added to different
   * applications &quot;trusted CA-s&quot; list/store. This attribute should not be used in a system
   * with real certs issued by well known CAs.
   */
  @ZAttr(id = 280)
  public static final String A_zimbraCertAuthorityCertSelfSigned =
      "zimbraCertAuthorityCertSelfSigned";

  /**
   * Please see the documentation for the attribute zimbraCertAuthorityCertSelfSigned. In addition,
   * please note that this attribute is provided at install for convenience during a test install
   * without real certs issued by well known CAs. If you choose to create your own CA for your
   * production uses, please note that it is a bad idea to store your CA-s private key in LDAP, as
   * this data maybe read from zimbraGlobalConfig in the clear.
   */
  @ZAttr(id = 279)
  public static final String A_zimbraCertAuthorityKeySelfSigned =
   ...
   */
  @ZAttr(id = 2109)
  public static final String A_zimbraChatAllowDlMemberAddAsFriend =
   ...
   */
  @ZAttr(id = 2106)
  public static final String A_zimbraChatAllowUnencryptedPassword =
      "zimbraChatAllowUnencryptedPassword";

  /**
   * enable dedicated log for the chat conversation (needed by some jurisdictions)
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 2104)
  public static final String A_zimbraChatConversationAuditEnabled =
  ...
  /**
   * Deprecated since: 8.5.0. family mailbox feature is deprecated. Orig desc: zimbraId of child
   * accounts
   */
  @ZAttr(id = 449)
  ...
  /**
   * Deprecated since: 5.0.0. deprecated in favor of user-settable attribute
   * zimbraPrefChildVisibleAccount . Orig desc: zimbraId of visible child accounts
   */
  @ZAttr(id = 450)
  public static final String A_zimbraChildVisibleAccount = "zimbraChildVisibleAccount";

  /**
   * IP Address/hostname for ClamAV to bind to for attachment scanning. Default is localhost
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1619)
  ...
  /**
   * Default database mirror for freshclam to use for virus and other updates. Defaults to the
   * United States mirror. See http://www.iana.org/cctld/cctld-whois.htm for a list of mirrors.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2073)
  ...
  /**
   * Type of HA cluster software in use; &quot;none&quot; by default, &quot;RedHat&quot; for Red Hat
   * cluster or &quot;Veritas&quot; for Veritas Cluster Server from Symantec
   */
  @ZAttr(id = 508)
  ...
  /**
   * Base URL where Zimbra Community is deployed. Do not include / symbol at the end
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1640)
  ...
  /**
   * URL to be loaded in Zimbra Community tab relative to zimbraCommunityBaseURL
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1641)
  ...
  /**
   * User&#039;s ID in Zimbra Community. When user IDs between Zimbra Collaboraiton and Zimbra
   * Community are not synchronized use this attrribute to store the user&#039;s Zimbra Community
   * ID. In order for this attribute to be used for SSO zimbraCommunityUsernameMapping has to be set
   * to zimbraCommunityID.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1644)
   ...
   */
  @ZAttr(id = 1551)
  public static final String A_zimbraConfiguredServerIDForBlobDirEnabled =
  ...
  /**
   * Deprecated since: 6.0.7. deprecated in favor of zimbraContactEmailFields, for bug 45475. Orig
   * desc: Comma separates list of attributes in contact object to search for email addresses when
   * generating auto-complete contact list. The same set of fields are used for GAL contacts as well
   * because LDAP attributes for GAL objects are mapped to Contact compatible attributes via
   * zimbraGalLdapAttrMap.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 760)
  public static final String A_zimbraContactAutoCompleteEmailFields =
   ...
   */
  @ZAttr(id = 827)
  public static final String A_zimbraContactAutoCompleteMaxResults =
      "zimbraContactAutoCompleteMaxResults";

  /**
   * Comma separates list of attributes in contact object to search for email addresses when
   * generating auto-complete contact list. The same set of fields are used for GAL contacts as well
   * because LDAP attributes for GAL objects are mapped to Contact compatible attributes via
   * zimbraGalLdapAttrMap.
   *
  ...
  /**
   * Comma separated list of Contact attributes that should be hidden from clients and export of
   * contacts.
   *
   * @since ZCS 6.0.6
   */
  ...
  /**
   * Deprecated since: 6.0.6. Deprecated per bug 40081. Orig desc: How often do we refresh contact
   * ranking table from address book and GAL to get friendly name for the email address. Use 0 to
   * disable the refresh.. Must be in valid duration format: {digits}{time-unit}. digits: 0-9,
   * time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time
   * unit is not specified, the default is s(seconds).
   *
   * @since ZCS 6.0.0_BETA2
   */
  @ZAttr(id = 1023)
  public static final String A_zimbraContactRankingTableRefreshInterval =
      "zimbraContactRankingTableRefreshInterval";

  /**
   * Size of the contact ranking table. Ranking table is used to keep track of most heavily used
   * contacts in outgoing email. Contacts in the ranking table are given the priority when
   * generating the auto-complete contact list.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 758)
  ...
  /**
   * Specify the decomposition mode used for looking up the Contact items by the phonetic last/first
   * name or last/first name. The accepted value is as follows: 0 = No decomposition. The accented
   * characters will be compared &#039;as is&#039; (not be decomposed) (Collator.NO_DECOMPOSITION).
   * 1 = Canonical decomposition mapping rules found in the Unicode Standard is used
   * (Collator.CANONICAL_DECOMPOSITION). 2 = Unicode canonical and Unicode compatibility
   * decomposition mapping rules found in the Unicode Standard is used. When this mode is selected,
   * compatible characters, such as half-width and full-width katakana characters, are considered
   * equivalent (Collator.FULL_DECOMPOSITION).
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1971)
  public static final String A_zimbraContactSearchDecomposition =
  ...
  /**
   * Allows converter hints to be supplied on the COS level. Can be used to enable or disable some
   * converters
   *
   * @since ZCS 8.5.0
   */
  ...
  /**
   * Deprecated since: 5.0. deprecated in favor of the accountInherited flag. Orig desc: zimbraCOS
   * attrs that get inherited in a zimbraAccount
   */
  @ZAttr(id = 21)
  ...
  /**
   * A flag to turn on or off CSRF referer related check. When set to FALSE no CSRF referer check
   * happens. When set to true CSRF referer type check happens.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1631)
  ...
  /**
   * A flag to turn on or off CSRF token related check. When set to FALSE no CSRF check happens.
   * When set to true both CSRF referer and CSRF token change is effective.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1628)
  ...
  /**
   * List of data associated with CSRF token for an account. The data format is CSRF token data:Auth
   * token Key crumb:Auth Token Key expiration
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1629)
  ...
  /**
   * Custom RFC822 header names (case-sensitive) allowed to specify in SendMsgRequest
   *
   * @since ZCS 7.1.3
   */
  @ZAttr(id = 1265)
  public static final String A_zimbraCustomMimeHeaderNameAllowed =
      "zimbraCustomMimeHeaderNameAllowed";

  /**
   * SQL statements that take longer than this duration to execute will be logged to the sqltrace
   * category in mailbox.log.. Must be in valid duration format: {digits}{time-unit}. digits: 0-9,
   * time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time
   * unit is not specified, the default is s(seconds).
   *
   * @since ZCS 6.0.0_RC1
  ...
  /**
   * Which SASL authentication mechanism to use for authenticating to IMAP server.
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1107)
  ...
  /**
   * The time interval between automated data imports for a Caldav data source. If unset or 0, the
   * data source will not be scheduled for automated polling. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 788)
  public static final String A_zimbraDataSourceCaldavPollingInterval =
      "zimbraDataSourceCaldavPollingInterval";

  /**
   * The time interval between automated data imports for a remote calendar data source. If
   * explicitly set to 0, the data source will not be scheduled for automated polling. . Must be in
   * valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   ...
   */
  @ZAttr(id = 819)
  public static final String A_zimbraDataSourceCalendarPollingInterval =
      "zimbraDataSourceCalendarPollingInterval";

  /**
   * Which security layer to use for connection (cleartext, ssl, tls, or tls if available). If not
   * set on data source, fallback to the value on global config.
   */
  @ZAttr(id = 425)
  ...
  /**
   * Timestamp of the first sync error for a data source. This value is unset after a successful
   * sync.
   *
   * @since ZCS 5.0.17
   */
  ...
  /**
   * The time interval between automated data imports for a GAL data source. If unset or 0, the data
   * source will not be scheduled for automated polling. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 826)
  public static final String A_zimbraDataSourceGalPollingInterval =
  ...
  /**
   * The time interval between automated data imports for an Imap data source. If unset or 0, the
   * data source will not be scheduled for automated polling. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   ...
   */
  @ZAttr(id = 768)
  public static final String A_zimbraDataSourceImapPollingInterval =
   ...
   */
  @ZAttr(id = 2062)
  public static final String A_zimbraDataSourceImapTrashFolderId =
      "zimbraDataSourceImapTrashFolderId";
  ...
  /**
   * whether to invoke data imports for all data sources owned by an account after successful user
  ...
  /**
   * indicates that this datasource is used for one way (incoming) import vs. two-way sync
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1106)
  ...
  /**
   * whether this data source corresponds to an account on the Zimbra system being proxied
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2037)
  ...
  /**
   * If the last data source sync failed, contains the error message. If the last data source sync
   * succeeded, this attribute is unset.
   *
   * @since ZCS 5.0.17
   */
  @ZAttr(id = 1029)
  ...
  /**
   * The time interval between automated data imports for a Live data source. If unset or 0, the
   * data source will not be scheduled for automated polling. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   ...
   */
  @ZAttr(id = 769)
  public static final String A_zimbraDataSourceLivePollingInterval =
  ...
  /**
   * Message content data exceeding this size will not be included in IMAP trace file
   *
   * @since ZCS 6.0.0_RC1
   */
  @ZAttr(id = 1033)
  ...
  /**
   * Shortest allowed duration for zimbraDataSourcePollingInterval.. Must be in valid duration
   * format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s -
   * seconds, d - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 525)
  public static final String A_zimbraDataSourceMinPollingInterval =
   ...
   */
  @ZAttr(id = 2022)
  public static final String A_zimbraDataSourceOAuthClientSecret =
   ...
   */
  @ZAttr(id = 2023)
  public static final String A_zimbraDataSourceOAuthRefreshToken =
      "zimbraDataSourceOAuthRefreshToken";
   ...
   */
  @ZAttr(id = 2024)
  public static final String A_zimbraDataSourceOAuthRefreshTokenUrl =
      "zimbraDataSourceOAuthRefreshTokenUrl";
  ...
  /**
   * Prior to 6.0.0: The time interval between automated data imports for a data source, or all data
   * sources owned by an account. If unset or 0, the data source will not be scheduled for automated
   * polling. Since 6.0.0: Deprecated on account/cos since 6.0.0. Values on account/cos are migrated
   * to protocol specific zimbraDataSource{proto}PollingInterval attributes. 1. if
   * zimbraDataSourcePollingInterval is set on data source, use it 2. otherwise use the
   * zimbraDataSource{Proto}PollingInterval on account/cos 3. if
   * zimbraDataSource{Proto}PollingInterval is not set on account/cos, use the attribute&#039;s
   * default if one is specified. See individual attribute descriptions for defaults. . Must be in
   * valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   */
  ...
  /**
   * The time interval between automated data imports for a Pop3 data source. If unset or 0, the
   * data source will not be scheduled for automated polling. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   ...
   */
  @ZAttr(id = 767)
  public static final String A_zimbraDataSourcePop3PollingInterval =
  ...
  /**
   * The time interval between automated data imports for a Rss data source. If explicitly set to 0,
   * the data source will not be scheduled for automated polling. . Must be in valid duration
   * format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s -
   * seconds, d - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 770)
  public static final String A_zimbraDataSourceRssPollingInterval =
      "zimbraDataSourceRssPollingInterval";

  /**
   * SMTP authentication password for this data source. If not set and if
   * zimbraDataSourceSmtpAuthRequired is set to TRUE, then defaults to zimbraDataSourcePassword
   * value.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1916)
  public static final String A_zimbraDataSourceSmtpAuthPassword =
   ...
   */
  @ZAttr(id = 1914)
  public static final String A_zimbraDataSourceSmtpAuthRequired =
      "zimbraDataSourceSmtpAuthRequired";

  /**
   * SMTP authentication username for this data source. If not set and if
   * zimbraDataSourceSmtpAuthRequired is set to TRUE, then defaults to zimbraDataSourceUsername
   * value.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1915)
  public static final String A_zimbraDataSourceSmtpAuthUsername =
      "zimbraDataSourceSmtpAuthUsername";
   ...
   */
  @ZAttr(id = 1913)
  public static final String A_zimbraDataSourceSmtpConnectionType =
  ...
  /**
   * when forwarding or replying to messages sent to this data source, whether or not to use the
   * email address of the data source for the from address and the designated signature/replyTo of
   * the data source for the outgoing message.
   */
  @ZAttr(id = 496)
  public static final String A_zimbraDataSourceUseAddressForForwardReply =
  ...
  /**
   * The time interval between automated data imports for a Yahoo address book data source. If unset
   * or 0, the data source will not be scheduled for automated polling. . Must be in valid duration
   * format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s -
   * seconds, d - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 789)
  public static final String A_zimbraDataSourceYabPollingInterval =
  ...
  /**
   * stop words for lucene text analyzer. This setting takes effect only for default analyzer. This
   * setting affects only accounts that do not have custom text analyzers. See zimbraTextAnalyzer
   * for information on custom text analyzers.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1587)
  ...
  /** name of the default domain for accounts when authenticating without a domain */
  @ZAttr(id = 172)
  public static final String A_zimbraDefaultDomainName = "zimbraDefaultDomainName";

  /**
   * Default flags on folder. These are set when a new folder is created, has no effect on existing
   * folders. Possible values are: * - \Subscribed b - \ExcludeFB # - \Checked i - \NoInherit y -
   * \SyncFolder ~ - \Sync o - \Noinferiors g - \Global
   *
   * @since ZCS 7.1.1
   */
  @ZAttr(id = 1210)
  ...
  /**
   * allowed passcode lockout duration. Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1397)
  public static final String A_zimbraDeviceAllowedPasscodeLockoutDuration =
   ...
   * Suppose device is set to sync calendar item of 2 months range then server will ONLY send
   * softdelete for out of range (expired) calendar items, if device id DOES NOT match to the regex
   * provided.
   *
   * @since ZCS 8.0.5
   */
  @ZAttr(id = 1450)
  public static final String A_zimbraDeviceCalendarSoftDeleteExcludePattern =
  ...
  /**
   * passcode lockout duration. Must be in valid duration format: {digits}{time-unit}. digits: 0-9,
   * time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time
   * unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1398)
  public static final String A_zimbraDevicePasscodeLockoutDuration =
      "zimbraDevicePasscodeLockoutDuration";

  /**
   * Whether conversations are allowed to span multiple accounts. Every time this attribute is
   * changed, new messages that continue existing conversation threads in imported accounts will no
   * longer thread with those conversations, and will instead start new ones.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2048)
  public static final String A_zimbraDisableCrossAccountConversationThreading =
      "zimbraDisableCrossAccountConversationThreading";

  /**
   * Email address to put in from header for the share info email. If not set, email address of the
   * authenticated admin account will be used.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 811)
  public static final String A_zimbraDistributionListSendShareMessageFromAddress =
      "zimbraDistributionListSendShareMessageFromAddress";

  /**
   * Whether to send an email with all the shares of the group when a new member is added to the
   * group. If not set, default is to send the email.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 810)
  public static final String A_zimbraDistributionListSendShareMessageToNewMembers =
      "zimbraDistributionListSendShareMessageToNewMembers";

  /**
   * distribution subscription policy. ACCEPT: always accept, REJECT: always reject, APPROVAL:
   * require owners approval.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1275)
  public static final String A_zimbraDistributionListSubscriptionPolicy =
   ...
   */
  @ZAttr(id = 1276)
  public static final String A_zimbraDistributionListUnsubscriptionPolicy =
      "zimbraDistributionListUnsubscriptionPolicy";

  /**
   * This attribute is used for DNS check by customers that configure their MX to point at spam
   * relays or other non-zimbra inbox smtp servers
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 744)
  ...
  /**
   * IP Address(es) of the root DNS servers to be used by the DNS cache service
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1569)
  ...
  /**
   * For zimbra dnscache, whether or not to only use TCP when talking to the upstream Master DNS
   * servers. Defaults to no
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1597)
  ...
  /**
   * Deprecated since: 5.0. deprecated in favor of the domainAdminAdminModifiable flag. Orig desc:
  ...
  /**
   * policy for a domain whose quota usage is above zimbraDomainAggregateQuota
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1329)
  public static final String A_zimbraDomainAggregateQuotaPolicy =
      "zimbraDomainAggregateQuotaPolicy";

  /**
   * email recipients to be notified when zimbraAggregateQuotaLastUsage reaches
   * zimbraDomainAggregateQuotaWarnPercent of the zimbraDomainAggregateQuota
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1331)
  public static final String A_zimbraDomainAggregateQuotaWarnEmailRecipient =
   ...
   */
  @ZAttr(id = 1330)
  public static final String A_zimbraDomainAggregateQuotaWarnPercent =
  ...
  /**
   * Client IP/IPRange whitelist for this domain (IPRange needs to be in CIDR notation
   * e.g:192.168.1.0/24). If configured, all IPs outside this whitelist will be blocked. If unset,
   * all IPs are allowed
   *
   * @since ZCS 8.7.0
   */
  ...
  /**
   * maximum number of accounts allowed to be assigned to specified COSes in a domain. Values are in
   * the format of {zimbraId-of-a-cos}:{max-accounts}
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 714)
   ...
   */
  @ZAttr(id = 1247)
  public static final String A_zimbraDomainDefaultExternalUserCOSId =
  ...
  /**
   * maximum number of accounts allowed to have specified features in a domain
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 715)
  ...
  /**
   * Deprecated since: 5.0. deprecated in favor of the domainInherited flag. Orig desc: zimbraDomain
   * attrs that get inherited from global config
   */
  @ZAttr(id = 63)
   ...
   */
  @ZAttr(id = 1069)
  public static final String A_zimbraDomainMandatoryMailSignatureEnabled =
      "zimbraDomainMandatoryMailSignatureEnabled";

  /**
   * Deprecated since: 8.5.0. deprecated in favor of zimbraAmavisDomainDisclaimerHTML. Orig desc:
   * domain mandatory mail html signature
   *
   * @since ZCS 6.0.4
   */
  @ZAttr(id = 1071)
  public static final String A_zimbraDomainMandatoryMailSignatureHTML =
      "zimbraDomainMandatoryMailSignatureHTML";

  /**
   * Deprecated since: 8.5.0. deprecated in favor of zimbraAmavisDomainDisclaimerText. Orig desc:
   * domain mandatory mail plain text signature
   *
   * @since ZCS 6.0.4
   */
  @ZAttr(id = 1070)
  public static final String A_zimbraDomainMandatoryMailSignatureText =
  ...
  /**
   * domain status. enum values are akin to those of zimbraAccountStatus but the status affects all
   * accounts on the domain. See table below for how zimbraDomainStatus affects account status.
   * active - see zimbraAccountStatus maintenance - see zimbraAccountStatus locked - see
   * zimbraAccountStatus closed - see zimbraAccountStatus suspended - maintenance + no
   * creating/deleting/modifying accounts/DLs under the domain. shutdown - suspended + cannot modify
   * domain attrs + cannot delete the domain Indicating server is doing major and lengthy
   * maintenance work on the domain, e.g. renaming the domain and moving LDAP entries. Modification
   * and deletion of the domain can only be done internally by the server when it is safe to release
   * the domain, they cannot be done in admin console or zmprov. How zimbraDomainStatus affects
   * account behavior : ------------------------------------- zimbraDomainStatus account behavior
   * ------------------------------------- active zimbraAccountStatus locked zimbraAccountStatus if
   * it is maintenance or pending or closed, else locked maintenance zimbraAccountStatus if it is
   * pending or closed, else maintenance suspended zimbraAccountStatus if it is pending or closed,
   * else maintenance shutdown zimbraAccountStatus if it is pending or closed, else maintenance
   * closed closed
   *
   * @since ZCS 5.0.0
   */
  ...
  /**
   * limits how much of a dumpster data is viewable by the end user, based on the age since being
   * put in dumpster. Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit:
   * [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is
   * not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1314)
  ...
  /**
   * EmptyFolderOpTimeout is the time in seconds for which empty folder operation will wait for the
   * current empty folder operation to complete
   *
   * @since ZCS 8.6.0
   */
  @ZAttr(id = 1652)
  ...
  /**
   * Maximum period in days for export, including start and end date. No limit if set to
   * non-positive integer or unset.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2056)
  ...
  /**
   * interface address on which zimbra extension server should listen; if empty, binds to all
   * interfaces
   *
   * @since ZCS 8.0.0
   */
  ...
  /**
   * Time when external virtual account was last automatically disabled by the system. Applicable
   * only when zimbraIsExternalVirtualAccount on the account is set to TRUE.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1371)
  public static final String A_zimbraExternalAccountDisabledTime =
      "zimbraExternalAccountDisabledTime";

  /**
   * Duration after the last time the external virtual account was automatically disabled by the
   * system after which the external virtual account would be automatically deleted. Value of 0
   * indicates that the external virtual account should never be automatically deleted. Applicable
   * only when zimbraIsExternalVirtualAccount on the account is set to TRUE. . Must be in valid
   * duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1372)
  public static final String A_zimbraExternalAccountLifetimeAfterDisabled =
      "zimbraExternalAccountLifetimeAfterDisabled";

  /**
   * Auth token secret key used for encrypting data/auth token in share URL when created for
   * external users.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1648)
  public static final String A_zimbraExternalAccountProvisioningKey =
      "zimbraExternalAccountProvisioningKey";

  /**
   * Interval between successive executions of the task that: - disables an external virtual account
   * when all its accessible shares have been revoked or expired. - deletes an external virtual
   * account after zimbraExternalAccountLifetimeAfterDisabled of being disabled. . Must be in valid
   * duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   ...
   */
  @ZAttr(id = 1370)
  public static final String A_zimbraExternalAccountStatusCheckInterval =
      "zimbraExternalAccountStatusCheckInterval";

  /**
   * the handler class for getting all groups an account belongs to in the external directory
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1251)
   ...
   */
  @ZAttr(id = 1249)
  public static final String A_zimbraExternalGroupLdapSearchBase =
   ...
   */
  @ZAttr(id = 1250)
  public static final String A_zimbraExternalGroupLdapSearchFilter =
  ...
  /**
   * whether checking against zimbraExternalShareWhitelistDomain for external user sharing is
   * enabled
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1264)
  public static final String A_zimbraExternalShareDomainWhitelistEnabled =
      "zimbraExternalShareDomainWhitelistEnabled";

  /**
   * Duration for which the URL sent in the share invitation email to an external user is valid. A
   * value of 0 indicates that the URL never expires. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1349)
  public static final String A_zimbraExternalShareInvitationUrlExpiration =
      "zimbraExternalShareInvitationUrlExpiration";

  /**
   * Maximum allowed lifetime of shares to external users. A value of 0 indicates that there&#039;s
   * no limit on an external share&#039;s lifetime. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
   ...
   */
  @ZAttr(id = 1263)
  public static final String A_zimbraExternalShareWhitelistDomain =
  ...
  /**
   * External email address of an external user. Applicable only when zimbraIsExternalVirtualAccount
   * is set to TRUE.
   *
   * @since ZCS 8.0.0
   */
   ...
   */
  @ZAttr(id = 2128)
  public static final String A_zimbraFeatureAddressUnderVerification =
      "zimbraFeatureAddressUnderVerification";
   ...
   */
  @ZAttr(id = 2126)
  public static final String A_zimbraFeatureAddressVerificationEnabled =
      "zimbraFeatureAddressVerificationEnabled";

  /**
   * Expiry time for end-user email address verification. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.8.5
   */
  @ZAttr(id = 2127)
  public static final String A_zimbraFeatureAddressVerificationExpiry =
   ...
   */
  @ZAttr(id = 2129)
  public static final String A_zimbraFeatureAddressVerificationStatus =
      "zimbraFeatureAddressVerificationStatus";

  /**
   * whether email features and tabs are enabled in the web client if accessed from the admin
   * console
   *
   * @since ZCS 7.1.0
   */
  ...
  /**
   * Whether email related configuration categories in Preference tab are enabled in the web client
   * even if the zimbraFeatureAdminMailEnabled is set to FALSE (Email tab is disabled), and accessed
   * from the admin console. If the zimbraFeatureAdminMailEnabled is TRUE, this key is ignored.
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 1686)
  public static final String A_zimbraFeatureAdminPreferencesEnabled =
      "zimbraFeatureAdminPreferencesEnabled";

  /**
   * Deprecated since: 8.0.0. Deprecated as of bug 56924. Orig desc: advanced search button enabled
   */
  @ZAttr(id = 138)
  public static final String A_zimbraFeatureAdvancedSearchEnabled =
      "zimbraFeatureAdvancedSearchEnabled";

  /**
   * whether or not to enable rerouting spam messages to Junk folder in ZCS, exposing Junk folder
   * and actions in the web UI, and exposing Junk folder to IMAP clients.
   *
   * @since ZCS 7.1.0
   */
  @ZAttr(id = 1168)
  ...
  /**
   * Whether app-specific passwords are enabled when two-factor auth is enabled. If TRUE, the port
   * specified by zimbraMtaAuthPort must be accessible by the MTA.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1907)
  public static final String A_zimbraFeatureAppSpecificPasswordsEnabled =
   ...
   */
  @ZAttr(id = 1055)
  public static final String A_zimbraFeatureBriefcaseDocsEnabled =
   ...
   */
  @ZAttr(id = 1054)
  public static final String A_zimbraFeatureBriefcaseSlidesEnabled =
   ...
   */
  @ZAttr(id = 1053)
  public static final String A_zimbraFeatureBriefcaseSpreadsheetEnabled =
  ...
  /**
   * whether receiving reminders on the designated device for appointments and tasks is enabled
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1150)
  public static final String A_zimbraFeatureCalendarReminderDeviceEmailEnabled =
   ...
   */
  @ZAttr(id = 531)
  public static final String A_zimbraFeatureCalendarUpsellEnabled =
  ...
  /** password changing */
  @ZAttr(id = 141)
  public static final String A_zimbraFeatureChangePasswordEnabled =
   ...
   */
  @ZAttr(id = 584)
  public static final String A_zimbraFeatureComposeInNewWindowEnabled =
      "zimbraFeatureComposeInNewWindowEnabled";

  /**
   * whether a confirmation page should be display after an operation is done in the UI
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 806)
  public static final String A_zimbraFeatureConfirmationPageEnabled =
   ...
   */
  @ZAttr(id = 2131)
  public static final String A_zimbraFeatureContactBackupEnabled =
      "zimbraFeatureContactBackupEnabled";

  /**
   * Deprecated since: 8.8.6. No longer used by ContactBackupRequest SOAP handler. Orig desc: Sleep
   * time between subsequent contact backups. 0 means that contact backup is disabled. . Must be in
   * valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   ...
   */
  @ZAttr(id = 2124)
  public static final String A_zimbraFeatureContactBackupFrequency =
      "zimbraFeatureContactBackupFrequency";

  /**
   * Duration for which the backups should be preserved. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.8.5
   */
  @ZAttr(id = 2125)
  public static final String A_zimbraFeatureContactBackupLifeTime =
   ...
   */
  @ZAttr(id = 1164)
  public static final String A_zimbraFeatureContactsDetailedSearchEnabled =
   ...
   */
  @ZAttr(id = 529)
  public static final String A_zimbraFeatureContactsUpsellEnabled =
  ...
  /** conversations */
  @ZAttr(id = 140)
  public static final String A_zimbraFeatureConversationsEnabled =
   ...
   */
  @ZAttr(id = 2014)
  public static final String A_zimbraFeatureDataSourcePurgingEnabled =
   ...
   */
  @ZAttr(id = 773)
  public static final String A_zimbraFeatureDiscardInFiltersEnabled =
   ...
   */
  @ZAttr(id = 1134)
  public static final String A_zimbraFeatureDistributionListExpandMembersEnabled =
   ...
   */
  @ZAttr(id = 1438)
  public static final String A_zimbraFeatureDistributionListFolderEnabled =
   ...
   */
  @ZAttr(id = 1185)
  public static final String A_zimbraFeatureExportFolderEnabled =
   ...
   */
  @ZAttr(id = 1373)
  public static final String A_zimbraFeatureExternalFeedbackEnabled =
   ...
   */
  @ZAttr(id = 1143)
  public static final String A_zimbraFeatureFreeBusyViewEnabled =
  ...
  /**
   * enable auto-completion from the GAL, zimbraFeatureGalEnabled also has to be enabled for the
   * auto-completion feature
   */
  @ZAttr(id = 359)
  public static final String A_zimbraFeatureGalAutoCompleteEnabled =
  ...
  /**
   * group calendar features. if set to FALSE, calendar works as a personal calendar and attendees
   * and scheduling etc are turned off in web UI
   */
  @ZAttr(id = 481)
  public static final String A_zimbraFeatureGroupCalendarEnabled =
  ...
  /**
   * whether user is allowed to retrieve mail from an external IMAP data source
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 568)
  public static final String A_zimbraFeatureImapDataSourceEnabled =
      "zimbraFeatureImapDataSourceEnabled";

  /**
   * Deprecated since: 8.7.0. deprecated in favor of zimbraFeatureChatEnabled. Orig desc: IM
   * features
   */
  @ZAttr(id = 305)
  ...
  /**
   * Deprecated since: 7.1.0. deprecated in favor of zimbraFeatureImportFolderEnabled and
   * zimbraFeatureExportFolderEnabled for bug 53745. Orig desc: whether import export folder feature
   * is enabled
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 750)
  public static final String A_zimbraFeatureImportExportFolderEnabled =
   ...
   */
  @ZAttr(id = 1184)
  public static final String A_zimbraFeatureImportFolderEnabled =
      "zimbraFeatureImportFolderEnabled";

  /** preference to set initial search */
  @ZAttr(id = 142)
  public static final String A_zimbraFeatureInitialSearchPreferenceEnabled =
  ...
  @ZAttr(id = 342)
  public static final String A_zimbraFeatureMailForwardingEnabled =
   ...
   */
  @ZAttr(id = 704)
  public static final String A_zimbraFeatureMailForwardingInFiltersEnabled =
      "zimbraFeatureMailForwardingInFiltersEnabled";

  /**
   * Deprecated since: 5.0. done via skin template overrides. Orig desc: whether user is allowed to
   * set mail polling interval
   */
  @ZAttr(id = 441)
  public static final String A_zimbraFeatureMailPollingIntervalPreferenceEnabled =
   ...
   */
  @ZAttr(id = 566)
  public static final String A_zimbraFeatureMailPriorityEnabled =
   ...
   */
  @ZAttr(id = 1137)
  public static final String A_zimbraFeatureMailSendLaterEnabled =
  ...
  /**
   * whether to allow end user to publish and remove S/MIME certificates to their GAL entry in the
   * web UI
   *
   * @since ZCS 7.1.0
   */
  @ZAttr(id = 1183)
  public static final String A_zimbraFeatureManageSMIMECertificateEnabled =
   ...
   */
  @ZAttr(id = 1127)
  public static final String A_zimbraFeatureMAPIConnectorEnabled =
   ...
   */
  @ZAttr(id = 2123)
  public static final String A_zimbraFeatureMarkMailForwardedAsRead =
   ...
   */
  @ZAttr(id = 2063)
  public static final String A_zimbraFeatureMobileGatewayEnabled =
   ...
   */
  @ZAttr(id = 833)
  public static final String A_zimbraFeatureMobilePolicyEnabled =
   ...
   */
  @ZAttr(id = 3082)
  public static final String A_zimbraFeatureModernDesktopEnabled =
  ...
  /** Whether new mail notification feature should be allowed for this account or in this cos */
  @ZAttr(id = 367)
  public static final String A_zimbraFeatureNewMailNotificationEnabled =
      "zimbraFeatureNewMailNotificationEnabled";

  /**
   * Deprecated since: 7.0.0. Deprecated per bugs 50465, 56201. Orig desc: Whether notebook feature
   * should be allowed for this account or in this cos
   */
  @ZAttr(id = 356)
   ...
   */
  @ZAttr(id = 585)
  public static final String A_zimbraFeatureOpenMailInNewWindowEnabled =
  ...
  /** Whether out of office reply feature should be allowed for this account or in this cos */
  @ZAttr(id = 366)
  public static final String A_zimbraFeatureOutOfOfficeReplyEnabled =
      "zimbraFeatureOutOfOfficeReplyEnabled";

  /**
   * Deprecated since: 8.0.0. Deprecated per bug 56924. Orig desc: whether people search feature is
   * enabled
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1109)
  public static final String A_zimbraFeaturePeopleSearchEnabled =
      "zimbraFeaturePeopleSearchEnabled";

  /** whether user is allowed to retrieve mail from an external POP3 data source */
  @ZAttr(id = 416)
  public static final String A_zimbraFeaturePop3DataSourceEnabled =
   ...
   */
  @ZAttr(id = 1271)
  public static final String A_zimbraFeaturePriorityInboxEnabled =
   ...
   */
  @ZAttr(id = 821)
  public static final String A_zimbraFeatureReadReceiptsEnabled =
   ...
   */
  @ZAttr(id = 2134)
  public static final String A_zimbraFeatureResetPasswordStatus =
      "zimbraFeatureResetPasswordStatus";

  /**
   * time for which reset password feature is suspended. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.8.9
   */
  @ZAttr(id = 2142)
  public static final String A_zimbraFeatureResetPasswordSuspensionTime =
      "zimbraFeatureResetPasswordSuspensionTime";

  /** saved search feature */
  @ZAttr(id = 139)
  public static final String A_zimbraFeatureSavedSearchesEnabled =
  ...
  /** Deprecated since: 6.0.0_GA. deprecated. Orig desc: keyboard shortcuts aliases features */
  @ZAttr(id = 452)
  public static final String A_zimbraFeatureShortcutAliasesEnabled =
  ...
  /**
   * whether S/MIME feature is enabled. Note: SMIME is a Network feature, this attribute is
   * effective only if SMIME is permitted by license.
   *
   * @since ZCS 7.1.0
   */
  @ZAttr(id = 1186)
   ...
   */
  @ZAttr(id = 1491)
  public static final String A_zimbraFeatureSocialExternalEnabled =
   ...
   */
  @ZAttr(id = 1272)
  public static final String A_zimbraFeatureSocialFiltersEnabled =
  ...
  /**
   * Deprecated since: 22.8.0. deprecated as not being used in Carbonio. Orig desc: Whether to allow
   * a user to access touch client. Note: touch client is a Network feature, this attribute is
   * effective only if touch client is permitted by license.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1636)
  ...
  /**
   * Whether the option of specifying trusted devices when using two-factor authentication is
   * available on the account
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2054)
  public static final String A_zimbraFeatureTrustedDevicesEnabled =
      "zimbraFeatureTrustedDevicesEnabled";

  /**
   * Whether the option of enabling two-factor authentication is available on the account
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2050)
  public static final String A_zimbraFeatureTwoFactorAuthAvailable =
   ...
   */
  @ZAttr(id = 1820)
  public static final String A_zimbraFeatureTwoFactorAuthRequired =
   ...
   */
  @ZAttr(id = 1050)
  public static final String A_zimbraFeatureVoiceChangePinEnabled =
   ...
   */
  @ZAttr(id = 1611)
  public static final String A_zimbraFeatureWebClientOfflineAccessEnabled =
      "zimbraFeatureWebClientOfflineAccessEnabled";

  /**
   * Deprecated since: 6.0.0_GA. deprecated per bug 40170. Orig desc: whether web search feature is
   * enabled
   *
   * @since ZCS 5.0.2
   */
   ...
   */
  @ZAttr(id = 544)
  public static final String A_zimbraFeatureZimbraAssistantEnabled =
      "zimbraFeatureZimbraAssistantEnabled";

  /**
   * Deprecated since: 8.9.0. deprecated with attribute zimbraFeatureModernDesktopEnabled. Orig
   * desc: Whether to allow a user to access Zimbra X desktop
   *
   * @since ZCS 8.9.0
   */
  @ZAttr(id = 3080)
   ...
   */
  @ZAttr(id = 1385)
  public static final String A_zimbraFileAndroidCrashReportingEnabled =
   ...
   */
  @ZAttr(id = 1313)
  public static final String A_zimbraFileDeletionNotificationBody =
      "zimbraFileDeletionNotificationBody";

  /**
   * template for constructing the subject of a file deletion warning message
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1312)
  public static final String A_zimbraFileDeletionNotificationSubject =
      "zimbraFileDeletionNotificationSubject";

  /**
   * template for constructing the body of a file expiration warning message
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1311)
  ...
  /**
   * template for constructing the subject of a file expiration warning message
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1310)
  public static final String A_zimbraFileExpirationWarningSubject =
      "zimbraFileExpirationWarningSubject";

  /**
   * Period of inactivity after which file owner receives a deletion warning email. Must be in valid
   * duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   ...
   */
  @ZAttr(id = 1308)
  public static final String A_zimbraFileExpirationWarningThreshold =
      "zimbraFileExpirationWarningThreshold";

  /**
   * Maximum allowed lifetime of file shares to external users. A value of 0 indicates that
   * there&#039;s no limit on an external file share&#039;s lifetime. . Must be in valid duration
   * format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s -
   * seconds, d - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
   ...
   */
  @ZAttr(id = 1390)
  public static final String A_zimbraFileIOSCrashReportingEnabled =
      "zimbraFileIOSCrashReportingEnabled";

  /**
   * Period of inactivity after which a file gets deleted. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
  ...
  /**
   * Maximum allowed lifetime of public file shares. A value of 0 indicates that there&#039;s no
   * limit on a public file share&#039;s lifetime. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
  ...
  /**
   * Maximum allowed lifetime of file shares to internal users or groups. A value of 0 indicates
   * that there&#039;s no limit on an internal file share&#039;s lifetime. . Must be in valid
   * duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
  ...
  /**
   * how long a file version is kept around. Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
  ...
  /**
   * Maximum number of messages that can be processed in a single ApplyFilterRules operation.
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1158)
  ...
  /**
   * The amount of time to sleep between every two messages during ApplyFilterRules. Increasing this
   * value will even out server load at the expense of slowing down the operation. . Must be in
   * valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
  ...
  /**
   * Whether to force clear zimbra auth cookies when SOAP session ends (i.e. force logout on browser
   * tab close)
   *
   * @since ZCS 8.0.4
   */
  ...
  /**
   * foreign name for mapping an external name to a zimbra domain on domain level, it is in the
   * format of {application}:{foreign name}
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1135)
  ...
  /**
   * handler for foreign name mapping, it is in the format of {application}:{class name}[:{params}]
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1136)
   ...
   */
  @ZAttr(id = 609)
  public static final String A_zimbraFreebusyExchangeAuthPassword =
   ...
   */
  @ZAttr(id = 611)
  public static final String A_zimbraFreebusyExchangeAuthScheme =
   ...
   */
  @ZAttr(id = 608)
  public static final String A_zimbraFreebusyExchangeAuthUsername =
      "zimbraFreebusyExchangeAuthUsername";

  /**
   * The duration of f/b block pushed to Exchange server.. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.3
   */
  @ZAttr(id = 621)
  public static final String A_zimbraFreebusyExchangeCachedInterval =
      "zimbraFreebusyExchangeCachedInterval";

  /**
   * The value of duration is used to indicate the start date (in the past relative to today) of the
   * f/b interval pushed to Exchange server.. Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.3
   */
  @ZAttr(id = 620)
  public static final String A_zimbraFreebusyExchangeCachedIntervalStart =
      "zimbraFreebusyExchangeCachedIntervalStart";

  /**
   * Can be set to either webdav for Exchange 2007 or older, or ews for 2010 and newer
   *
   * @since ZCS 6.0.11
   */
  @ZAttr(id = 1174)
  public static final String A_zimbraFreebusyExchangeServerType =
  ...
  /**
   * when set to TRUE, free/busy for the account is not calculated from local mailbox.
   *
   * @since ZCS 5.0.11
   */
  @ZAttr(id = 752)
  public static final String A_zimbraFreebusyLocalMailboxNotActive =
      "zimbraFreebusyLocalMailboxNotActive";

  /**
   * The interval to wait when the server encounters problems while propagating Zimbra users
   * free/busy information to external provider such as Exchange. . Must be in valid duration
   * format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s -
   * seconds, d - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.17
   */
  @ZAttr(id = 1026)
  public static final String A_zimbraFreebusyPropagationRetryInterval =
  ...
  /**
   * When set to TRUE, GAL search will always include local calendar resources regardless of
   * zimbraGalMode.
   *
   * @since ZCS 6.0.7
   */
  @ZAttr(id = 1093)
  public static final String A_zimbraGalAlwaysIncludeLocalCalendarResources =
   ...
   */
  @ZAttr(id = 1413)
  public static final String A_zimbraGalDefinitionLastModifiedTime =
  ...
  /**
   * LDAP search base for internal GAL queries (special values: &quot;ROOT&quot; for top,
   * &quot;DOMAIN&quot; for domain only, &quot;SUBDOMAINS&quot; for domain and subdomains)
   */
  @ZAttr(id = 358)
   ...
   */
  @ZAttr(id = 829)
  public static final String A_zimbraGalLastFailedSyncTimestamp =
   ...
   */
  @ZAttr(id = 828)
  public static final String A_zimbraGalLastSuccessfulSyncTimestamp =
  ...
  /**
   * external LDAP GAL authentication mechanism none: anonymous binding simple: zimbraGalLdapBindDn
   * and zimbraGalLdapBindPassword has to be set kerberos5: zimbraGalLdapKerberos5Principal and
  ...
  /**
   * the handler class for mapping groups from GAL source to zimbra GAL contacts for external GAL
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1112)
  ...
  /**
   * LDAP page size for paged search control while accessing LDAP server for GAL. This applies to
   * both Zimbra and external LDAP servers. A value of 0 means paging is not enabled.
   *
   * @since ZCS 5.0.1
   */
  @ZAttr(id = 583)
  ...
  /**
   * whether to use startTLS for external GAL. startTLS will be used for external GAL access only if
   * this attribute is true and zimbraGalLdapURL(or zimbraGalSyncLdapURL for sync) does not contain
   * a ldaps URL.
   *
   * @since ZCS 5.0.6
   */
  ...
  /**
   * LDAP Gal attribute to contact value mapping. Each value is in the format of {gal contact
   * filed}: {regex} {replacement}
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1110)
   ...
   */
  @ZAttr(id = 1027)
  public static final String A_zimbraGalSyncAccountBasedAutoCompleteEnabled =
      "zimbraGalSyncAccountBasedAutoCompleteEnabled";

  /**
   * List of attributes that will be ignored when determining whether a GAL contact has been
   * modified. Any change in other attribute values will make the contact &quot;dirty&quot; and the
   * contact will show as modified in the next GAL sync response. By default modifyTimeStamp is
   * always included in ignored attributes. Then if the only change in GAL contact is
   * modifyTimeStamp, the contact will not be shown as modified in the next GAL sync response from
   * the client, thus minimizing the need to download the GAL contact again when none of the
  ...
  /**
   * LDAP search base for internal GAL sync (special values: &quot;ROOT&quot; for top,
   * &quot;DOMAIN&quot; for domain only, &quot;SUBDOMAINS&quot; for domain and subdomains) If not
   * set fallback to zimbraGalInternalSearchBase
   *
   * @since ZCS 5.0.2
   */
  @ZAttr(id = 598)
  ...
  /**
   * external LDAP GAL authentication mechanism for GAL sync none: anonymous binding simple:
   * zimbraGalLdapBindDn and zimbraGalLdapBindPassword has to be set kerberos5:
   * zimbraGalLdapKerberos5Principal and zimbraGalLdapKerberos5Keytab has to be set if not set
   * fallback to zimbraGalLdapAuthMech
   *
   * @since ZCS 5.0.2
   */
  @ZAttr(id = 592)
  ...
  /**
   * LDAP bind dn for external GAL sync queries, if not set fallback to zimbraGalLdapBindDn
   *
   * @since ZCS 5.0.2
   */
  @ZAttr(id = 593)
  ...
  /**
   * LDAP bind password for external GAL sync queries, if not set fallback to
  ...
  /**
   * LDAP search filter for external GAL sync queries, if not set fallback to zimbraGalLdapFilter
   *
   * @since ZCS 5.0.2
   */
  @ZAttr(id = 591)
  ...
  /**
   * kerberos5 keytab file path for external GAL sync queries, if not set fallback to
   * zimbraGalLdapKerberos5Keytab
   *
   * @since ZCS 5.0.2
   */
  @ZAttr(id = 596)
  public static final String A_zimbraGalSyncLdapKerberos5Keytab =
      "zimbraGalSyncLdapKerberos5Keytab";

  /**
   * kerberos5 principal for external GAL sync queries, if not set fallback to
   * zimbraGalLdapKerberos5Principal
   *
   * @since ZCS 5.0.2
   */
  @ZAttr(id = 595)
  public static final String A_zimbraGalSyncLdapKerberos5Principal =
      "zimbraGalSyncLdapKerberos5Principal";

  /**
   * LDAP page size for paged search control while accessing LDAP server for GAL sync. This applies
   * to both Zimbra and external LDAP servers. A value of 0 means paging is not enabled. If not set
   * fallback to zimbraGalLdapPageSize
   *
   * @since ZCS 5.0.2
   */
  @ZAttr(id = 597)
  ...
  /**
   * LDAP search base for external GAL sync queries, if not set fallback to zimbraGalLdapSearchBase
   *
   * @since ZCS 5.0.2
   */
  @ZAttr(id = 590)
   ...
   */
  @ZAttr(id = 656)
  public static final String A_zimbraGalSyncLdapStartTlsEnabled =
      "zimbraGalSyncLdapStartTlsEnabled";

  /**
   * LDAP URL for external GAL sync, if not set fallback to zimbraGalLdapURL
   *
   * @since ZCS 5.0.2
   */
  @ZAttr(id = 589)
  ...
  /**
   * Maximum number of concurrent GAL sync requests allowed on the system / domain.
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1154)
  public static final String A_zimbraGalSyncMaxConcurrentClients =
      "zimbraGalSyncMaxConcurrentClients";

  /**
   * Page size control for SyncGalRequest. By default not more than 30000 entries will be returned
   * for every SyncGalRequest
   *
   * @since ZCS 8.7.2
   */
  @ZAttr(id = 2097)
  ...
  /**
   * whether to tokenize key and AND or OR the tokenized queries for GAL auto complete, if not set,
   * key is not tokenized
   *
   * @since ZCS 5.0.2
   */
  @ZAttr(id = 599)
  public static final String A_zimbraGalTokenizeAutoCompleteKey =
      "zimbraGalTokenizeAutoCompleteKey";

  /**
   * whether to tokenize key and AND or OR the tokenized queries for GAL search, if not set, key is
   * not tokenized
   *
   * @since ZCS 5.0.2
   */
  ...
  /**
   * type of this GAl data source. zimbra - zimbra internal GAL. ldap - external LDAP GAL.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 850)
  ...
  /**
   * Object classes added on the global config entry. Unlike other zimbra***ExtraObjectClass
   * attributes, object classes specified in this attributes will not be automatically added to the
   * global config entry. Extra object class on the global config entry must be added using
   * &quot;zmprov mcf +objectClass {object class}&quot;, then recorded in this attributes.
   *
   * @since ZCS 7.1.3
   */
  @ZAttr(id = 1254)
  public static final String A_zimbraGlobalConfigExtraObjectClass =
  ...
  /**
   * seniority index of the group or group member which will determine the sorting order in the
   ...
   */
  @ZAttr(id = 3072)
  public static final String A_zimbraHierarchicalAddressBookRoot =
      "zimbraHierarchicalAddressBookRoot";

  /**
   * Deprecated since: 6.0.0_BETA2. deprecated in favor for zimbraHsmPolicy. Orig desc: Minimum age
   * of mail items whose filesystem data will be moved to secondary storage.. Must be in valid
   * duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   */
  ...
  /**
   * Maximum number of items to move during a single HSM operation. If the limit is exceeded, the
   * HSM operation is repeated until all qualifying items are moved.
   *
   * @since ZCS 7.2.1
   */
  @ZAttr(id = 1316)
  ...
  /**
   * Keep only the tip revision in the main volume, and move all the old revisions to the secondary
   * volume. For document type mail items only, works independently of zimbraHsmPolicy.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1393)
  ...
  /**
   * The policy that determines which mail items get moved to secondary storage during HSM. Each
   * value specifies a comma-separated list of item types and the search query used to select items
   * to move. See the spec for &lt;SearchRequest&gt; for the complete list of item types and
  ...
  /**
   * Maximum Idle time in milli seconds for a connection. This is applied when waiting for a new
   * request to be received on a connection; when reading the headers and content of a request; when
   * writing the headers and content of a response.
   *
   * @since ZCS 7.2.3
   */
  @ZAttr(id = 1428)
  public static final String A_zimbraHttpConnectorMaxIdleTimeMillis =
      "zimbraHttpConnectorMaxIdleTimeMillis";

  /**
   * Rules for governing the allocation of threads to various web contexts for the current thread
   * pool. Sample value: /zimbra:min=10;max=40% or /zimbraAdmin:min=5
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1593)
  public static final String A_zimbraHttpContextPathBasedThreadPoolBalancingFilterRules =
  ...
  /**
   * Delay imposed on all requests over the rate limit, before they are considered at all. -1 =
   * Reject request, 0 = No delay, any other value = Delay in ms
   *
   * @since ZCS 8.0.3
   */
  @ZAttr(id = 1430)
   ...
   */
  @ZAttr(id = 1431)
  public static final String A_zimbraHttpDosFilterMaxRequestsPerSec =
      "zimbraHttpDosFilterMaxRequestsPerSec";

  /**
   * The maximum allowed size in bytes for a HTTP header field cache in Jetty
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1582)
  ...
  /**
   * The maximum allowed size in bytes for a HTTP form content in Jetty. Can be set to 0 to block
   * all web form submission
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1612)
  ...
  /**
   * The size in bytes of the output buffer used to aggregate HTTP output in Jetty
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1579)
  ...
  /**
   * external socks proxy URL to connect to when making outgoing connections (eg.Zimlet proxy,
   * RSS/ATOM feeds, etc)
   */
  @ZAttr(id = 388)
  ...
  /** Deprecated since: 5.0. not applicable for jetty. Orig desc: number of https handler threads */
  @ZAttr(id = 519)
  public static final String A_zimbraHttpSSLNumThreads = "zimbraHttpSSLNumThreads";

  /**
   * The maximum thread idle time in milli seconds. Threads that are idle for longer than this
   * period may be stopped.
   *
   * @since ZCS 7.2.3
   */
  @ZAttr(id = 1429)
  public static final String A_zimbraHttpThreadPoolMaxIdleTimeMillis =
  ...
  /**
   * Ehcache: the maximum amount of disk space the imap active session cache will consume in Bytes
   * before eviction. By default this value is 100 gigabytes. This is a rough limit,Due to internals
   * of ehcache actual size in memory will often exceed this limit by a modest margin.
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 3005)
  public static final String A_zimbraImapActiveSessionEhcacheMaxDiskSize =
  ...
  /** interface address on which IMAP server should listen; if empty, binds to all interfaces */
  @ZAttr(id = 179)
  public static final String A_zimbraImapBindAddress = "zimbraImapBindAddress";

  /**
   * Whether to bind to port on startup irrespective of whether the server is enabled. Useful when
   * port to bind is privileged and must be bound early.
   */
  @ZAttr(id = 268)
  ...
  /**
   * disabled IMAP capabilities. Capabilities are listed on the CAPABILITY line, also known in RFCs
   * as extensions
   */
  @ZAttr(id = 443)
   ...
   */
  @ZAttr(id = 1909)
  public static final String A_zimbraImapDisplayMailFoldersOnly =
  ...
  /**
   * Ehcache: the maximum disk size of inactive IMAP cache in Bytes before eviction.By default this
   * value is 10GB.This is a rough limit,Due to internals of ehcache actual size on disk will often
   * exceed this limit by a modest margin.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2013)
  public static final String A_zimbraImapInactiveSessionCacheMaxDiskSize =
      "zimbraImapInactiveSessionCacheMaxDiskSize";

  /**
   * Ehcache: the maximum amount of disk space the imap inactive session cache will consume in Bytes
   * before eviction. By default this value is 100 gigabytes. This is a rough limit,Due to internals
   * of ehcache actual size in memory will often exceed this limit by a modest margin.
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 3006)
  public static final String A_zimbraImapInactiveSessionEhcacheMaxDiskSize =
      "zimbraImapInactiveSessionEhcacheMaxDiskSize";

  /**
   * Ehcache: the maximum heap size of the inactive session cache in Bytes before eviction. By
   * default this value is 1 megabyte. This is a rough limit,Due to internals of ehcache actual size
   * in memory will often exceed this limit by a modest margin.
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 3004)
  public static final String A_zimbraImapInactiveSessionEhcacheSize =
      "zimbraImapInactiveSessionEhcacheSize";

  /**
   * Determines the load-balancing algorithm used to select an IMAP server from the pool of
   * available zimbraReverseProxyUpstreamImapServers. Valid values are AccountIdHash,
   * custom:{handler-algorithm} [arg1 arg2 ...]
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 3009)
  public static final String A_zimbraImapLoadBalancingAlgorithm =
      "zimbraImapLoadBalancingAlgorithm";

  /**
   * Maximum number of concurrent IMAP connections allowed. New connections exceeding this limit are
   * rejected.
   *
   * @since ZCS 8.0.0
   */
  ...
  /**
   * disabled IMAP SSL capabilities. Capabilities are listed on the CAPABILITY line, also known in
   * RFCs as extensions
   */
  @ZAttr(id = 444)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: available IM interop gateways
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 571)
  public static final String A_zimbraIMAvailableInteropGateways =
      "zimbraIMAvailableInteropGateways";

  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: interface address on which IM server should listen; if
  ...
  /**
   * Deprecated since: 6.0.0_GA. deprecated per bug 40069. Orig desc: IM service
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 762)
  ...
  /**
   * Deprecated since: 5.0. Installed skin list is a per server property, the list is now generated
   * by directory scan of skin files. Orig desc: Skins installed and available on all servers (this
   * is global config only)
   */
  @ZAttr(id = 368)
  ...
  /**
   * Specifies whether legal intercept messages should contain the entire original message or just
   * the headers.
   *
   * @since ZCS 5.0.3
   */
  ...
  /**
   * whether sharing with accounts and groups of all other domains hosted on this deployment be
   * considered internal sharing
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1386)
  public static final String A_zimbraInternalSharingCrossDomainEnabled =
      "zimbraInternalSharingCrossDomainEnabled";

  /**
   * Domains hosted on this deployment, accounts and groups of which are considered internal during
   * sharing. Applicable when zimbraInternalSharingCrossDomainEnabled is set to FALSE.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1387)
  ...
  /**
   * This attribute is used for failed authentication requests. It indicates the minimum time
   * between current req and last req from the same IP before this suspended IP will be reinstated
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1614)
  public static final String A_zimbraInvalidLoginFilterDelayInMinBetwnReqBeforeReinstating =
      "zimbraInvalidLoginFilterDelayInMinBetwnReqBeforeReinstating";

  /**
   * This attribute is used for failed authentication requests.This is a DOSFilter style check for
   * repeated failed logins from IP, if set to 0 no check happens, else failed login is recorded.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1613)
  public static final String A_zimbraInvalidLoginFilterMaxFailedLogin =
      "zimbraInvalidLoginFilterMaxFailedLogin";

  /**
   * This attribute is used for failed authentication requests. It indicates the max size of data
   * structures that holds the list of failed logins
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1618)
  public static final String A_zimbraInvalidLoginFilterMaxSizeOfFailedIpDb =
      "zimbraInvalidLoginFilterMaxSizeOfFailedIpDb";

  /**
   * This attribute is used for failed authentication requests. Interval at which Task to reinstate
   * IPs suspended as part of ZimbraInvalidLoging filter are run.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1615)
  public static final String A_zimbraInvalidLoginFilterReinstateIpTaskIntervalInMin =
  ...
  /**
   * if the dynamic group can be a legitimate grantee for folder grantees; and a legitimate grantee
   * or target for delegated admin grants
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1242)
   ...
   */
  @ZAttr(id = 2036)
  public static final String A_zimbraIsMobileGatewayProxyAccount =
      "zimbraIsMobileGatewayProxyAccount";
  ...
  /**
   * Indicates the account is an account used by the system such as spam accounts or Notebook
   * accounts. System accounts cannot be deleted in admin console.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1214)
  ...
  /**
   * Indicates the account is a resource used by the system. System resource accounts are not
   * counted against license quota.
   */
  @ZAttr(id = 376)
   ...
   */
  @ZAttr(id = 579)
  public static final String A_zimbraJunkMessagesIndexingEnabled =
  ...
  /**
   * how often the zimbraLastLogonTimestamp is updated. if set to 0, updating
   * zimbraLastLogonTimestamp is completely disabled . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 114)
  public static final String A_zimbraLastLogonTimestampFrequency =
      "zimbraLastLogonTimestampFrequency";

  /**
   * Maximum duration beyond which the mailbox must be scheduled for purge irrespective of whether
   * it is loaded into memory or not.. Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
   ...
   * zimbraPasswordLockoutFailureTime or zimbraGalLastSuccessfulSyncTimestamp). Releases prior to
   * 8.7 are unable to parse gentime values which include fractional seconds; therefore this value
   * must remain set to FALSE in environments where any release 8.6 or lower is present. It should
   * be changed to TRUE once all systems are upgraded to 8.7 or higher.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2018)
  public static final String A_zimbraLdapGentimeFractionalSecondsEnabled =
  ...
  /** interface address on which LMTP server should listen; if empty, binds to all interfaces */
  @ZAttr(id = 25)
  ...
  /**
   * Lmtp Server will reject the client transactions which do not issue LHLO
   *
   * @since ZCS 8.6.0
   */
  @ZAttr(id = 1675)
  ...
  /**
   * If true, a permanent failure (552) is returned when the user is over quota. If false, a
   * temporary failure (452) is returned.
   *
   * @since ZCS 5.0.6
   */
  @ZAttr(id = 657)
  public static final String A_zimbraLmtpPermanentFailureWhenOverQuota =
  ...
  /**
   * Flag to control how authtokens are invalidated in multi-server environment. If set to TRUE:
   * when this account logs out on a server, the server will notify other servers that this
   * account&#039;s authtoken has been invalidated. If set to FALSE, an auth token may remain vallid
   * on servers other than the account&#039;s home server after a user logs out for as long as an
   * account object remains in Provisioning Cache. Set to TRUE for increased protection against
  ...
  /**
   * lifetime of raw log rows in consolidated logger tables. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 263)
  ...
  /**
   * lifetime of summarized log rows in consolidated logger tables. Must be in valid duration
   * format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s -
   * seconds, d - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 264)
   ...
   */
  @ZAttr(id = 1589)
  public static final String A_zimbraLowestSupportedAuthVersion =
   ...
   */
  @ZAttr(id = 1241)
  public static final String A_zimbraMailAddressValidationRegex =
      "zimbraMailAddressValidationRegex";

  /**
   * Deprecated since: 8.7.8. deprecated in favor of zimbraAdminOutgoingSieveScriptAfter. Orig desc:
   * outgoing sieve script defined by admin (not able to edit and view from the end user) applied
   * after the end user filter rule
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 2093)
  public static final String A_zimbraMailAdminOutgoingSieveScriptAfter =
      "zimbraMailAdminOutgoingSieveScriptAfter";

  /**
   * Deprecated since: 8.7.8. deprecated in favor of zimbraAdminOutgoingSieveScriptBefore. Orig
   * desc: outgoing sieve script defined by admin (not able to edit and view from the end user)
   * applied before the end user filter rule
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 2092)
  public static final String A_zimbraMailAdminOutgoingSieveScriptBefore =
      "zimbraMailAdminOutgoingSieveScriptBefore";

  /**
   * Deprecated since: 8.7.8. deprecated in favor of zimbraAdminSieveScriptAfter. Orig desc: sieve
   * script defined by admin (not able to edit and view from the end user) applied after the end
   * user filter rule
   *
   * @since ZCS 8.7.6
   */
  ...
  /**
   * Deprecated since: 8.7.8. deprecated in favor of zimbraAdminSieveScriptBefore. Orig desc: sieve
   * script defined by admin (not able to edit and view from the end user) applied before the end
   * user filter rule
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 2090)
  public static final String A_zimbraMailAdminSieveScriptBefore =
  ...
  /**
   * If TRUE, a mailbox that exceeds its quota is still allowed to receive mail, but is not allowed
   * to send.
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1099)
  public static final String A_zimbraMailAllowReceiveButNotSendWhenOverQuota =
      "zimbraMailAllowReceiveButNotSendWhenOverQuota";

  /**
   * interface address on which HTTP server should listen; if empty, binds to all interfaces
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1365)
  ...
  /**
   * Maximum number of entries for per user black list. This restricts the number of values that can
   * be set on the amavisBlacklistSender attribute of an account. If set to 0, the per user white
   * list feature is disabled.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 799)
  public static final String A_zimbraMailBlacklistMaxNumEntries =
      "zimbraMailBlacklistMaxNumEntries";

  /**
   * List of SSL/TLS protocols (as documented by SunJSSE Provider Protocols and used in
   * setEnabledProtocols) to be enabled in Jetty for HTTPS, IMAPS, POP3S, and STARTTLS (including
   * LMTP)
   *
   * @since ZCS 8.6.0
   */
  ...
  /**
   * Whether TLS renegotiation is allowed. See also RFC 5746 and CVE-2011-1473 for concerns about
   * possible SSL renegotiation DoS
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 1832)
  public static final String A_zimbraMailboxdSSLRenegotiationAllowed =
  ...
  /**
   * This attribute is used in the case of a failed mailbox move. It indicates the delay before the
   * cleanup task is executed for the first time. It also indicates the time interval at which the
   * cleanup task will be re-run in case cleanup does not take place in first attempt. Must be in
   * valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   ...
   */
  @ZAttr(id = 2079)
  public static final String A_zimbraMailboxMoveFailedCleanupTaskInterval =
   ...
   */
  @ZAttr(id = 1006)
  public static final String A_zimbraMailboxMoveSkipSearchIndex =
  ...
  /**
   * Time in milliseconds between IMAP/POP/LMTP rate limiter stale entry cleanup cycle.. Must be in
   * valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   ...
   */
  @ZAttr(id = 2053)
  public static final String A_zimbraMailboxThrottleReapInterval =
  ...
  @ZAttr(id = 216)
  public static final String A_zimbraMailCatchAllCanonicalAddress =
      "zimbraMailCatchAllCanonicalAddress";

  /** Address to deliver catch all messages to */
  @ZAttr(id = 215)
  public static final String A_zimbraMailCatchAllForwardingAddress =
      "zimbraMailCatchAllForwardingAddress";

  /**
   * Whether to allow password sent to non-secured port when zimbraMailMode is mixed. If it set to
   * TRUE the server will allow login with clear text AuthRequests and change password with clear
   * text ChangePasswordRequest. If it set to FALSE the server will return an error if an attempt is
   * made to ChangePasswordRequest or AuthRequest.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 791)
  public static final String A_zimbraMailClearTextPasswordEnabled =
      "zimbraMailClearTextPasswordEnabled";

  /**
   * Maximum size in bytes for the &lt;content &gt; element in SOAP. Mail content larger than this
  ...
  /**
   * Incoming messages larger than this number of bytes are streamed to disk during LMTP delivery,
   * instead of being read into memory. This limits memory consumption at the expense of higher disk
   * utilization.
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 565)
  public static final String A_zimbraMailDiskStreamingThreshold =
      "zimbraMailDiskStreamingThreshold";

  /**
   * Maximum mailbox quota for the domain in bytes. The effective quota for a mailbox would be the
   ...
   * Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h -
   * hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified,
  ...
  /**
   * Deprecated since: 8.0.0. Empty folder operation now always deletes items in batches, hence a
   * threshold is no longer applicable.. Orig desc: Folders that contain more than this many
   * messages will be emptied in batches of size zimbraMailEmptyFolderBatchSize.
   *
   * @since ZCS 6.0.13
   */
  @ZAttr(id = 1208)
  public static final String A_zimbraMailEmptyFolderBatchThreshold =
      "zimbraMailEmptyFolderBatchThreshold";

  /**
   * Number of bytes to buffer in memory per file descriptor in the cache. Larger values result in
   * fewer disk reads, but increase memory consumption.
   *
   * @since ZCS 6.0.0_RC1
   */
  @ZAttr(id = 1035)
  public static final String A_zimbraMailFileDescriptorBufferSize =
   ...
   */
  @ZAttr(id = 1034)
  public static final String A_zimbraMailFileDescriptorCacheSize =
   ...
   */
  @ZAttr(id = 1039)
  public static final String A_zimbraMailForwardingAddressMaxLength =
   ...
   */
  @ZAttr(id = 1040)
  public static final String A_zimbraMailForwardingAddressMaxNumAddrs =
      "zimbraMailForwardingAddressMaxNumAddrs";

  /**
   * max size in KB of text emails that will automatically highlight objects
   *
   * @since ZCS 7.1.2
   */
  @ZAttr(id = 1213)
  public static final String A_zimbraMailHighlightObjectsMaxSize =
  ...
  /**
   * idle timeout. Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit:
   * [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is
   * not specified, the default is s(seconds).
   */
  @ZAttr(id = 147)
  ...
  /**
   * When set to true, robots.txt on mailboxd will be set up to keep web crawlers out
   *
   * @since ZCS 7.0.1
   */
  @ZAttr(id = 1161)
  ...
  /**
   * Deprecated since: 5.0.7. deprecated per bug 28842. Orig desc: The id of the last purged
   * mailbox.
   *
   * @since ZCS 5.0.0
   */
  ...
  /**
   * Specifies whether the http server should bound to localhost or not. This is an immutable
   * property and is generated based on zimbraMailMode and zimbraMailBindAddress.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1380)
  ...
  /**
   * lifetime of a mail message regardless of location. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 106)
  ...
  /**
   * minimum allowed value for zimbraPrefMailPollingInterval. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 110)
  ...
  /**
   * whether to run HTTP or HTTPS or both/mixed mode or redirect mode. See also related attributes
   * zimbraMailPort and zimbraMailSSLPort
   */
  @ZAttr(id = 308)
  ...
  /**
   * The max number of unsuccessful attempts to connect to the current server (as an upstream). If
   * this number is reached, proxy will refuse to connect to the current server, wait for
   * zimbraMailProxyReconnectTimeout and then try to reconnect. Default value is 1. Setting this to
   * 0 means turning this check off.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1358)
  ...
  /**
   * the time in sec that proxy will reconnect the current server (as an upstream) after connection
   * errors happened before
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1268)
  ...
  /**
   * Maximum number of messages to delete from a folder during a single purge operation. If the
   * limit is exceeded, the mailbox is purged again at the end of the purge cycle until all
   * qualifying messages are purged.
   *
   * @since ZCS 6.0.8
   */
  @ZAttr(id = 1096)
  ...
  /**
   * Sleep time between subsequent mailbox purges. 0 means that mailbox purging is disabled. . Must
   * be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours,
   * m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the
  ...
  /**
   * System purge policy, encoded as metadata. Users can apply these policy elements to their
   * folders and tags. If the system policy changes, user settings are automatically updated with
   * the change.
   *
   * @since ZCS 8.0.0
   */
  ...
  /**
   * If TRUE, a message is purged from Spam based on the date that it was moved to the Spam folder.
   * If FALSE, a message is purged from Spam based on the date that it was added to the mailbox.
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1117)
  public static final String A_zimbraMailPurgeUseChangeDateForSpam =
      "zimbraMailPurgeUseChangeDateForSpam";

  /**
   * If TRUE, a message is purged from trash based on the date that it was moved to the Trash
   * folder. If FALSE, a message is purged from Trash based on the date that it was added to the
   * mailbox.
   *
   * @since ZCS 5.0.17
   */
  @ZAttr(id = 748)
  public static final String A_zimbraMailPurgeUseChangeDateForTrash =
  ...
  /**
   * If TRUE, the envelope sender of a message redirected by mail filters will be set to the users
   * address. If FALSE, the envelope sender will be set to the From address of the redirected
   * message.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 764)
  public static final String A_zimbraMailRedirectSetEnvelopeSender =
      "zimbraMailRedirectSetEnvelopeSender";

  /**
   * whether to send back a refer tag in an auth response to force a client redirect. always -
   * always send refer wronghost - send refer if only if the account being authenticated does not
   * live on this mail host reverse-proxied - reverse proxy is in place and should never send refer
   *
   * @since ZCS 5.0.3
   */
  @ZAttr(id = 613)
  ...
  /**
   * Deprecated since: 8.7.8. deprecated in favor of zimbraSieveNotifyActionRFCCompliant, which can
   * be used at account level. Orig desc: Whether the RFC compliant &#039;notify&#039; is used. If
   * TRUE, ZCS parses the &#039;notify&#039; action parameters based on the syntax defined by the
   * RFC 5435 and 5436. If FALSE, ZCS treats the &#039;notify&#039; action parameters with Zimbra
   * specific format
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 2095)
  public static final String A_zimbraMailSieveNotifyActionRFCCompliant =
  ...
  /**
   * Retention period of messages in the Junk folder. 0 means that all messages will be retained.
   * This admin-modifiable attribute works in conjunction with zimbraPrefJunkLifetime, which is
   * user-modifiable. The shorter duration is used. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 105)
  ...
  /**
   * interface address on which HTTPS server should listen; if empty, binds to all interfaces
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1366)
  ...
  /**
   * interface address on which HTTPS server accepting client certificates should listen; if empty,
   * binds to all interfaces
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1367)
  public static final String A_zimbraMailSSLClientCertBindAddress =
      "zimbraMailSSLClientCertBindAddress";

  /**
   * enable authentication via X.509 Client Certificate. Disabled: client authentication is
   * disabled. NeedClientAuth: client authentication is required during SSL handshake on the SSL
   * mutual authentication port(see zimbraMailSSLClientCertPort). The SSL handshake will fail if the
   * client does not present a certificate to authenticate. WantClientAuth: client authentication is
   * requested during SSL handshake on the SSL mutual authentication port(see
   * zimbraMailSSLClientCertPort). The SSL handshake will still proceed if the client does not
   * present a certificate to authenticate. In the case when client does not send a certificate,
   * user will be redirected to the usual entry page of the requested webapp, where
   ...
   */
  @ZAttr(id = 1395)
  public static final String A_zimbraMailSSLClientCertOCSPEnabled =
  ...
  /**
   * Map from a certificate field to a Zimbra account key that can uniquely identify a Zimbra
   * account for client certificate authentication. Value is a comma-separated list of mapping
   * rules, each mapping maps a certificate field to a Zimbra account key. Each is attempted in
   * sequence until a unique account can be resolved. e.g. a value can be:
   * SUBJECTALTNAME_OTHERNAME_UPN=zimbraForeignPrincipal,(uid=%{SUBJECT_CN}) value: comma-separated
   * mapping-rule mapping-rule: {cert-field-to-key-map} | {LDAP-filter} cert-field-to-key-map:
   * {certificate-field}={Zimbra-account-key} certificate-field: SUBJECT_{an RDN attr, e.g. CN}: a
   * RND in DN of Subject SUBJECT_DN: entire DN of Subject SUBJECTALTNAME_OTHERNAME_UPN: UPN(aka
   * Principal Name) in otherName in subjectAltName extension SUBJECTALTNAME_RFC822NAME: rfc822Name
   * in subjectAltName extension Zimbra-account-key: name: primary name or any of the aliases of an
   * account zimbraId: zimbraId of an account zimbraForeignPrincipal: zimbraForeignPrincipal of an
   * account. The matching value on the zimbraForeignPrincipal must be prefixed with &quot;cert
   * {supported-certificate-filed}:&quot; e.g. cert SUBJECTALTNAME_OTHERNAME_UPN:123456@mydomain
   * LDAP-filter: An LDAP filter template with placeholders to be substituted by certificate field
   * values. (objectClass=zimbraAccount) is internally ANDed with the supplied filter. e.g.
   * (|(uid=%{SUBJECT_CN})(mail=%{SUBJECTALTNAME_RFC822NAME})) Note: it is recommended not to use
   * LDAP-filter rule, as it will trigger an LDAP search for each cert auth request. LDAP-filter is
   * disabled by default. To enable it globally, set
   * zimbraMailSSLClientCertPrincipalMapLdapFilterEnabled on global config to TRUE. If LDAP-filter
   * is not enabled, all client certificate authentication will fail on domains configured with
   * LDAP-filter.
   *
   * @since ZCS 7.1.2
   */
  @ZAttr(id = 1215)
  public static final String A_zimbraMailSSLClientCertPrincipalMap =
   ...
   */
  @ZAttr(id = 1216)
  public static final String A_zimbraMailSSLClientCertPrincipalMapLdapFilterEnabled =
   ...
   */
  @ZAttr(id = 1212)
  public static final String A_zimbraMailSSLProxyClientCertPort =
  ...
  /**
   * The algorithm to use when aggregating new messages into conversations. Possible values are: -
   * &quot;none&quot;: no conversation threading is performed. - &quot;subject&quot;: the message
   * will be threaded based solely on its normalized subject. - &quot;strict&quot;: only the
   * threading message headers (References, In-Reply-To, Message-ID, and Resent-Message-ID) are used
   * to correlate messages. No checking of normalized subjects is performed. -
   * &quot;references&quot;: the same logic as &quot;strict&quot; with the constraints slightly
   * altered so that the non-standard Thread-Index header is considered when threading messages and
   * that a reply message lacking References and In-Reply-To headers will fall back to using
   * subject-based threading. - &quot;subjrefs&quot;: the same logic as &quot;references&quot; with
   * the further caveat that changes in the normalized subject will break a thread in two.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1160)
  ...
  /**
   * Retention period of messages in the Trash folder. 0 means that all messages will be retained.
   * This admin-modifiable attribute works in conjunction with zimbraPrefTrashLifetime, which is
   * user-modifiable. The shorter duration is used. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  ...
  /**
   * In our web app, AJAX and standard html client, we have support for adding the HTTP client IP
   * address as X-Originating-IP in an outbound message. We also use the HTTP client IP address in
   * our logging. In the case of standard client making connections to the SOAP layer, the JSP layer
   * tells the SOAP layer in a http header what the remote HTTP client address is. In the case where
   * nginx or some other proxy layer is fronting our webapps, the proxy tells the SOAP/JSP layers in
   * a http header what the real HTTP client s address is. Our SOAP/JSP layers will trust the
   * client/proxy only if the IP address of the client/proxy is one of the IPs listed in this
   * attribute.
   *
   * @since ZCS 5.0.17
   */
   ...
   */
  @ZAttr(id = 1139)
  public static final String A_zimbraMailTrustedSenderListMaxNumEntries =
      "zimbraMailTrustedSenderListMaxNumEntries";

  /**
   * Deprecated since: 6.0.7. Deprecated per bug 43497. The number of uncompressed files on disk
   * will never exceed zimbraMailFileDescriptorCacheSize.. Orig desc: max number of bytes stored in
   * the uncompressed blob cache on disk
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 825)
  public static final String A_zimbraMailUncompressedCacheMaxBytes =
      "zimbraMailUncompressedCacheMaxBytes";

  /**
   * Deprecated since: 6.0.7. Deprecated per bug 43497. The number of uncompressed files on disk
   * will never exceed zimbraMailFileDescriptorCacheSize.. Orig desc: max number of files in the
   * uncompressed blob cache on disk
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 824)
  public static final String A_zimbraMailUncompressedCacheMaxFiles =
  ...
  /**
   * Used to control whether Java NIO direct buffers are used. Value is propagated to Jetty
   * configuration. In the future, other NIO pieces (IMAP/POP/LMTP) will also honor this.
   *
   * @since ZCS 5.0.22
   */
  @ZAttr(id = 1002)
  ...
  /**
   * Maximum number of entries for per user white list. This restricts the number of values that can
   * be set on the amavisWhitelistSender attribute of an account. If set to 0, the per user white
   * list feature is disabled.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 798)
  public static final String A_zimbraMailWhitelistMaxNumEntries =
      "zimbraMailWhitelistMaxNumEntries";

  /**
   * maximum number of application-specific passwords allowed for an account
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1837)
  ...
  /**
   * max number of messages/conversations per page, Web client (not server) verifies that
   * zimbraPrefMailItemsPerPage should not exceed this attribute.
   *
   * @since ZCS 6.0.0_BETA2
   */
  @ZAttr(id = 1011)
  ...
  /**
   * max number of voice items per page, Web client (not server) verifies that
   * zimbraPrefVoiceItemsPerPage should not exceed this attribute.
   *
   * @since ZCS 6.0.0_BETA2
   */
  @ZAttr(id = 1013)
  ...
  /**
   * if true, use binary protocol of memcached; if false, use ascii protocol
   *
   * @since ZCS 5.0.17
   */
  @ZAttr(id = 1015)
  public static final String A_zimbraMemcachedClientBinaryProtocolEnabled =
      "zimbraMemcachedClientBinaryProtocolEnabled";

  /**
   * default expiration time in seconds for memcached values; default is 1 day
   *
   * @since ZCS 5.0.17
   */
  @ZAttr(id = 1017)
  public static final String A_zimbraMemcachedClientExpirySeconds =
   ...
   */
  @ZAttr(id = 1016)
  public static final String A_zimbraMemcachedClientHashAlgorithm =
      "zimbraMemcachedClientHashAlgorithm";

  /**
   * list of host:port for memcached servers; set to empty value to disable the use of memcached
   *
   * @since ZCS 5.0.17
   */
  @ZAttr(id = 1014)
   ...
   */
  @ZAttr(id = 1018)
  public static final String A_zimbraMemcachedClientTimeoutMillis =
  ...
  /**
   * Number of Message-Id header values to keep in the LMTP dedupe cache. Subsequent attempts to
   * deliver a message with a matching Message-Id to the same mailbox will be ignored. A value of 0
   * disables deduping.
   */
  @ZAttr(id = 334)
   ...
   * zimbraMessageIdDedupeCacheSize limit is ignored when this is set to a non-zero value. . Must be
   * in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m
   * - minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   * @since ZCS 7.1.4
   */
  @ZAttr(id = 1340)
  public static final String A_zimbraMessageIdDedupeCacheTimeout =
      "zimbraMessageIdDedupeCacheTimeout";

  /**
   * interface address on which milter server should listen; if not specified, binds to 127.0.0.1
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1115)
  ...
  /**
   * Maximum number of concurrent MILTER connections allowed. New connections exceeding this limit
   * are rejected.
   *
   * @since ZCS 8.0.0
   */
  ...
  /** the name of the zimbra extension where the handler class for the mime type lives */
  @ZAttr(id = 293)
  ...
  /**
   * The priority that this MIME type will be chosen, in the case that more than one MIME type
   * object matches a given type or filename extension.
   */
  @ZAttr(id = 503)
  ...
  /**
   * whether mobile sync should zip the skipped item and attach it to the notification mail
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1423)
  public static final String A_zimbraMobileAttachSkippedItemEnabled =
   ...
   */
  @ZAttr(id = 1572)
  public static final String A_zimbraMobileForceSamsungProtocol25 =
      "zimbraMobileForceSamsungProtocol25";

  /**
   * id of the doamin under which (hidden) accounts for apps would be created
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 1759)
  public static final String A_zimbraMobileGatewayDefaultAppAccountDomainId =
      "zimbraMobileGatewayDefaultAppAccountDomainId";

  /**
   * Id of the domain under which &quot;Proxy&quot; accounts would be created. One can configure the
   * system to act as a &quot;Proxy&quot; to another Zimbra system. When the Proxy mode is enabled,
   * some accounts in the system would be syncing mailbox data from a Zimbra account hosted on a
   * different Zimbra system into a data source.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2029)
  public static final String A_zimbraMobileGatewayDefaultProxyAccountDomainId =
   ...
   */
  @ZAttr(id = 2032)
  public static final String A_zimbraMobileGatewayProxyImapConnectionType =
   ...
   */
  @ZAttr(id = 2030)
  public static final String A_zimbraMobileGatewayProxyImapHost =
   ...
   */
  @ZAttr(id = 2031)
  public static final String A_zimbraMobileGatewayProxyImapPort =
   ...
   */
  @ZAttr(id = 2035)
  public static final String A_zimbraMobileGatewayProxySmtpConnectionType =
   ...
   */
  @ZAttr(id = 2033)
  public static final String A_zimbraMobileGatewayProxySmtpHost =
   ...
   */
  @ZAttr(id = 2034)
  public static final String A_zimbraMobileGatewayProxySmtpPort =
      "zimbraMobileGatewayProxySmtpPort";

  /**
   * Max size of items in a folder that server tracks, categorized by collection type
   * (Email,Calendar,Contacts,Tasks). e.g. Email:3000 makes the max size of items to track for an
   * Email folder to be 3000. If not specify, default value is Integer.MAX_VALUE
   *
   * @since ZCS 8.0.3
   */
  @ZAttr(id = 1426)
  public static final String A_zimbraMobileItemsToTrackPerFolderMaxSize =
      "zimbraMobileItemsToTrackPerFolderMaxSize";

  /**
   * Maximum total size of a mail message that can be synced to device without truncation. 0 means
   * no limit
   *
  ...
  /**
   * whether or not to enable truncating on client metadata size, if enabled server will only track
   * recent items on client device instead of all
   *
   * @since ZCS 8.0.3
   */
  @ZAttr(id = 1425)
  public static final String A_zimbraMobileMetadataMaxSizeEnabled =
      "zimbraMobileMetadataMaxSizeEnabled";

  /**
   * Retention policy for stale mobile metadata. Format is &quot;aa:bb:c&quot;, &quot;aa&quot; being
   * the number of days to define stale data. e.g. 180 means if device&#039;s last_used_date is 180
   * days ago, its metadata need to be removed. &quot;bb&quot; being the days between two retentions
   * are run, e.g. 30 means to run retention every 30 days. &quot;hh&quot; being the hour of day to
   * run retention, from 0 to 23. e.g. 1 means to run retention at some time between 1am and 2am.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1617)
  public static final String A_zimbraMobileMetadataRetentionPolicy =
   ...
   */
  @ZAttr(id = 1422)
  public static final String A_zimbraMobileNotificationAdminAddress =
  ...
  /**
   * whether the Bluetooth capabilities are allowed on the device. The available options are
   * Disable, HandsfreeOnly, and Allow. 0 - DISABLE 1 - HANDSFREE 2 - ALLOW ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyAllowBluetooth value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1285)
  public static final String A_zimbraMobilePolicyAllowBluetooth =
      "zimbraMobilePolicyAllowBluetooth";

  /**
   * whether Microsoft Pocket Internet Explorer is allowed on the mobile phone. This parameter
   * doesn&#039;t affect third-party browsers. ignored if zimbraFeatureMobilePolicyEnabled=FALSE or
  ...
  /**
   * whether to allow camera on device; ignored if zimbraFeatureMobilePolicyEnabled=FALSE or
  ...
  /**
   * whether the device user can configure a personal e-mail account on the mobile phone. This
   * parameter doesn&#039;t control access to e-mails using third-party mobile phone e-mail
   * programs. ignored if zimbraFeatureMobilePolicyEnabled=FALSE or
   * zimbraMobilePolicyAllowConsumerEmail value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1301)
  public static final String A_zimbraMobilePolicyAllowConsumerEmail =
      "zimbraMobilePolicyAllowConsumerEmail";

  /**
   * whether the device can synchronize with a desktop computer through a cable; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyAllowDesktopSync value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1288)
  public static final String A_zimbraMobilePolicyAllowDesktopSync =
      "zimbraMobilePolicyAllowDesktopSync";

  /**
   * whether HTML e-mail is enabled on the device. If set to 0, all e-mail will be converted to
   * plain text before synchronization occurs. ignored if zimbraFeatureMobilePolicyEnabled=FALSE or
   * zimbraMobilePolicyAllowHTMLEmail value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1290)
  public static final String A_zimbraMobilePolicyAllowHTMLEmail =
      "zimbraMobilePolicyAllowHTMLEmail";

  /**
   * whether the mobile device can be used as a modem to connect a computer to the Internet; ignored
   * if zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyAllowInternetSharing value is
   * set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1303)
  public static final String A_zimbraMobilePolicyAllowInternetSharing =
      "zimbraMobilePolicyAllowInternetSharing";

  /**
   * whether infrared connections are allowed to the device; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyAllowIrDA value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1286)
  ...
  /**
   * whether to allow non-provisionable devices; ignored if zimbraFeatureMobilePolicyEnabled=FALSE
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 834)
  public static final String A_zimbraMobilePolicyAllowNonProvisionableDevices =
   ...
   */
  @ZAttr(id = 835)
  public static final String A_zimbraMobilePolicyAllowPartialProvisioning =
      "zimbraMobilePolicyAllowPartialProvisioning";

  /**
   * whether the user can configure a POP3 or IMAP4 e-mail account on the device. This parameter
   * doesn&#039;t control access by third-party e-mail programs. ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyAllowPOPIMAPEmail value is set to
   * -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1284)
  public static final String A_zimbraMobilePolicyAllowPOPIMAPEmail =
      "zimbraMobilePolicyAllowPOPIMAPEmail";

  /**
   * whether the mobile device can initiate a remote desktop connection; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyAllowRemoteDesktop value is set to
   * -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1302)
  public static final String A_zimbraMobilePolicyAllowRemoteDesktop =
      "zimbraMobilePolicyAllowRemoteDesktop";

  /**
   * whether to allow simple password; ignored if zimbraFeatureMobilePolicyEnabled=FALSE or
   * zimbraMobilePolicyDevicePasswordEnabled=FALSE
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 839)
  public static final String A_zimbraMobilePolicyAllowSimpleDevicePassword =
   ...
   * recipient&#039;s certificate doesn&#039;t support the specified encryption algorithm; 0 -
   * BlockNegotiation 1 - OnlyStrongAlgorithmNegotiation 2 - AllowAnyAlgorithmNegotiation ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or
   * zimbraMobilePolicyAllowSMIMEEncryptionAlgorithmNegotiation value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1298)
  public static final String A_zimbraMobilePolicyAllowSMIMEEncryptionAlgorithmNegotiation =
      "zimbraMobilePolicyAllowSMIMEEncryptionAlgorithmNegotiation";

  /**
   * whether S/MIME software certificates are allowed; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyAllowSMIMESoftCerts value is set to
   * -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1299)
  public static final String A_zimbraMobilePolicyAllowSMIMESoftCerts =
      "zimbraMobilePolicyAllowSMIMESoftCerts";

  /**
   * whether to allow removable storage on device; ignored if zimbraFeatureMobilePolicyEnabled=FALSE
   * or zimbraMobilePolicyAllowStorageCard value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1277)
  public static final String A_zimbraMobilePolicyAllowStorageCard =
      "zimbraMobilePolicyAllowStorageCard";

  /**
   * whether text messaging is allowed from the device; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyAllowTextMessaging value is set to
   * -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1283)
  public static final String A_zimbraMobilePolicyAllowTextMessaging =
      "zimbraMobilePolicyAllowTextMessaging";

  /**
   * whether unsigned applications are allowed on device; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyAllowUnsignedApplications value is
   * set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1280)
  public static final String A_zimbraMobilePolicyAllowUnsignedApplications =
      "zimbraMobilePolicyAllowUnsignedApplications";

  /**
   * whether unsigned installation packages are allowed on device; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyAllowUnsignedInstallationPackages
   * value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1281)
  public static final String A_zimbraMobilePolicyAllowUnsignedInstallationPackages =
      "zimbraMobilePolicyAllowUnsignedInstallationPackages";

  /**
   * whether wireless Internet access is allowed on the device; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyAllowWiFi value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1282)
   ...
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyDevicePasswordEnabled=FALSE
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 840)
  public static final String A_zimbraMobilePolicyAlphanumericDevicePasswordRequired =
      "zimbraMobilePolicyAlphanumericDevicePasswordRequired";

  /**
   * approved application for the mobile device the value contains a SHA1 hash (typically 40
   * characters long) for the application file (.exe, .dll etc) ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1305)
  public static final String A_zimbraMobilePolicyApprovedApplication =
      "zimbraMobilePolicyApprovedApplication";

  /**
   * This is the internal attr for &quot;zimbraMobilePolicyApprovedApplication&quot; which can only
   * store app hash (to keep consistent with ActiveSync specification. This attr&#039;s format is
   * &quot;app_name&quot;:&quot;app_hash&quot;, and is used for showing both the app name and hash
   * in admin console UI
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1411)
  public static final String A_zimbraMobilePolicyApprovedApplicationList =
      "zimbraMobilePolicyApprovedApplicationList";

  /**
   * Deprecated since: 8.5.0. Use zimbraMobilePolicyRequireStorageCardEncryption. Orig desc: require
   * data encryption on device; ignored if zimbraFeatureMobilePolicyEnabled=FALSE
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 847)
  public static final String A_zimbraMobilePolicyDeviceEncryptionEnabled =
      "zimbraMobilePolicyDeviceEncryptionEnabled";

  /**
   * whether to force pin on device; ignored if zimbraFeatureMobilePolicyEnabled=FALSE
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 837)
  public static final String A_zimbraMobilePolicyDevicePasswordEnabled =
      "zimbraMobilePolicyDevicePasswordEnabled";

  /**
   * number of days before device pin must expire; ignored if zimbraFeatureMobilePolicyEnabled=FALSE
   * or zimbraMobilePolicyDevicePasswordEnabled=FALSE
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 842)
  public static final String A_zimbraMobilePolicyDevicePasswordExpiration =
      "zimbraMobilePolicyDevicePasswordExpiration";

  /**
   * number of previously used password stored in history; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyDevicePasswordEnabled=FALSE or
   * zimbraMobilePolicyDevicePasswordExpiration=0
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 843)
  public static final String A_zimbraMobilePolicyDevicePasswordHistory =
      "zimbraMobilePolicyDevicePasswordHistory";

  /**
   * the maximum range of calendar days that can be synchronized to the device; 0 - PAST ALL 4 - Two
   * Weeks 5 - One Month 6 - Three Months 7 - Six Months ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyMaxCalendarAgeFilter value is set
   * to -1, 1, 2 or, 3
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1289)
  public static final String A_zimbraMobilePolicyMaxCalendarAgeFilter =
      "zimbraMobilePolicyMaxCalendarAgeFilter";

  /**
   * number of consecutive incorrect pin input before device is wiped; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyDevicePasswordEnabled=FALSE
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 845)
  public static final String A_zimbraMobilePolicyMaxDevicePasswordFailedAttempts =
      "zimbraMobilePolicyMaxDevicePasswordFailedAttempts";

  /**
   * the maximum number of days of e-mail items to synchronize to the device; 0 - PAST ALL 1 - One
   * Day 2 - Three Days 3 - One Week 4 - Two Weeks 5 - One Month ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyMaxEmailAgeFilter value is set to
   * -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1291)
  public static final String A_zimbraMobilePolicyMaxEmailAgeFilter =
      "zimbraMobilePolicyMaxEmailAgeFilter";

  /**
   * the maximum size at which e-mail messages are truncated when synchronized to the device; The
   * value is specified in kilobytes (KB). ignored if zimbraFeatureMobilePolicyEnabled=FALSE
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1292)
  public static final String A_zimbraMobilePolicyMaxEmailBodyTruncationSize =
      "zimbraMobilePolicyMaxEmailBodyTruncationSize";

  /**
   * the maximum size at which HTML-formatted e-mail messages are synchronized to the devices. The
   * value is specified in KB. ignored if zimbraFeatureMobilePolicyEnabled=FALSE
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1293)
  public static final String A_zimbraMobilePolicyMaxEmailHTMLBodyTruncationSize =
   ...
   */
  @ZAttr(id = 844)
  public static final String A_zimbraMobilePolicyMaxInactivityTimeDeviceLock =
      "zimbraMobilePolicyMaxInactivityTimeDeviceLock";

  /**
   * least number of complex characters must be included in device pin; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyDevicePasswordEnabled=FALSE
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 841)
  public static final String A_zimbraMobilePolicyMinDevicePasswordComplexCharacters =
      "zimbraMobilePolicyMinDevicePasswordComplexCharacters";

  /**
   * min length for device pin; ignored if zimbraFeatureMobilePolicyEnabled=FALSE or
   * zimbraMobilePolicyDevicePasswordEnabled=FALSE
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 838)
  public static final String A_zimbraMobilePolicyMinDevicePasswordLength =
      "zimbraMobilePolicyMinDevicePasswordLength";

  /**
   * support device pin recovery; ignored if zimbraFeatureMobilePolicyEnabled=FALSE or
   * zimbraMobilePolicyDevicePasswordEnabled=FALSE
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 846)
  public static final String A_zimbraMobilePolicyPasswordRecoveryEnabled =
      "zimbraMobilePolicyPasswordRecoveryEnabled";

  /**
   * time interval in minutes before forcing device to refresh policy; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 836)
  public static final String A_zimbraMobilePolicyRefreshInterval =
      "zimbraMobilePolicyRefreshInterval";

  /**
   * whether encryption on device is required; ignored if zimbraFeatureMobilePolicyEnabled=FALSE or
   * zimbraMobilePolicyRequireDeviceEncryption value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1279)
  public static final String A_zimbraMobilePolicyRequireDeviceEncryption =
      "zimbraMobilePolicyRequireDeviceEncryption";

  /**
   * whether you must encrypt S/MIME messages; ignored if zimbraFeatureMobilePolicyEnabled=FALSE or
   * zimbraMobilePolicyRequireEncryptedSMIMEMessages value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1295)
  public static final String A_zimbraMobilePolicyRequireEncryptedSMIMEMessages =
      "zimbraMobilePolicyRequireEncryptedSMIMEMessages";

  /**
   * what required algorithm must be used when encrypting a message; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyRequireEncryptionSMIMEAlgorithm
   * value is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1297)
  public static final String A_zimbraMobilePolicyRequireEncryptionSMIMEAlgorithm =
      "zimbraMobilePolicyRequireEncryptionSMIMEAlgorithm";

  /**
   * whether the mobile device must synchronize manually while roaming; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyRequireManualSyncWhenRoaming value
   * is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1287)
  public static final String A_zimbraMobilePolicyRequireManualSyncWhenRoaming =
      "zimbraMobilePolicyRequireManualSyncWhenRoaming";

  /**
   * what required algorithm must be used when signing a message; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyRequireSignedSMIMEAlgorithm value
   * is set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1296)
  public static final String A_zimbraMobilePolicyRequireSignedSMIMEAlgorithm =
      "zimbraMobilePolicyRequireSignedSMIMEAlgorithm";

  /**
   * whether the device must send signed S/MIME messages; ignored if
   * zimbraFeatureMobilePolicyEnabled=FALSE or zimbraMobilePolicyRequireSignedSMIMEMessages value is
   * set to -1
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1294)
  public static final String A_zimbraMobilePolicyRequireSignedSMIMEMessages =
      "zimbraMobilePolicyRequireSignedSMIMEMessages";

  /**
   * require data encryption on storage card; ignored if zimbraFeatureMobilePolicyEnabled=FALSE
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1444)
  public static final String A_zimbraMobilePolicyRequireStorageCardEncryption =
      "zimbraMobilePolicyRequireStorageCardEncryption";

  /**
   * when set to TRUE, suppresses DeviceEncryptionEnabled to be sent down to the device; Some
   * devices choke when DeviceEncryptionEnabled policy is downloaded irrespective of their value set
   * to 0 or, 1 ignored if zimbraFeatureMobilePolicyEnabled=FALSE
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1306)
  public static final String A_zimbraMobilePolicySuppressDeviceEncryption =
   ...
   */
  @ZAttr(id = 1304)
  public static final String A_zimbraMobilePolicyUnapprovedInROMApplication =
      "zimbraMobilePolicyUnapprovedInROMApplication";

  /**
   * Specifies whether MIME body parts are supported in search responses or not. Some devices, like
   * Samsung S5 with Lollipop OS, specify a body preference for either MIME or HTML in search
   * requests. However they do not handle the MIME sent in responses correctly, and are unable to
   * display messages in search results.(Bugs - 99686, 100436) This is actually a device issue, but
   * it breaks visibility of email in search results on the device. If devices are used which do
   * correctly support MIME in search results, zimbraMobileSearchMimeSupportEnabled can be set to
   * TRUE for users of those devices.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2055)
  public static final String A_zimbraMobileSearchMimeSupportEnabled =
  ...
  /**
   * indicates whether the application can forward original email as RFC 822 .eml attachment. Note:
   * this setting is applicable only to the devices using activesync smart forward for forwarding
   * email messages.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1205)
  public static final String A_zimbraMobileSmartForwardRFC822Enabled =
      "zimbraMobileSmartForwardRFC822Enabled";

  /**
   * folders whose sync key are already converted, each device has a list of folders. e.g.
   * ApplDN6GJSQJDFHW:0,2,10 meaning device ApplDN6GJSQJDFHW&#039;s folders, inbox and calendar
   * folder sync key format are converted, use 0 for FolderSync
   *
   * @since ZCS 8.0.4
   */
  @ZAttr(id = 1439)
  public static final String A_zimbraMobileSyncKeyFormatConvertedFolders =
      "zimbraMobileSyncKeyFormatConvertedFolders";

  /**
   * number of times allowed to retry the same sync version before going into penalty. In general,
   * windows phone should be set to 2, iOS should be set to 1. example of config values: windows:2,
   * ios:1, android:1, default:1
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1642)
  ...
  /**
   * whether to enable tombstone syncing. If disabled, changes of tombstones won&#039;t be synced to
   * device
   *
   * @since ZCS 8.5.0
   */
   ...
   */
  @ZAttr(id = 1609)
  public static final String A_zimbraMtaAddressVerifyNegativeRefreshTime =
   ...
   */
  @ZAttr(id = 1610)
  public static final String A_zimbraMtaAddressVerifyPositiveRefreshTime =
   ...
   */
  @ZAttr(id = 1494)
  public static final String A_zimbraMtaAlwaysAddMissingHeaders =
  ...
  /**
   * interface address on which Admin HTTPS connector for MTA Auth should listen; if empty, binds to
   * all interfaces
   *
   * @since ZCS 8.7.0,9.0.0
   */
  ...
  /**
   * Deprecated since: 6.0.0_BETA1. deprecated in favor of zimbraMtaTlsSecurityLevel and
   * zimbraMtaSaslAuthEnable. Orig desc: Value for postconf smtpd_tls_security_level
   */
  @ZAttr(id = 194)
  public static final String A_zimbraMtaAuthEnabled = "zimbraMtaAuthEnabled";

  /**
   * Deprecated since: 8.6. Formally deprecated in 8.6 but has been unused since at least 7.0. MTA
   * now uses all servers which have zimbraMtaAuthTarget set to TRUE. Orig desc: Host running SOAP
   * service for use by MTA auth. Setting this sets zimbraMtaAuthURL via attr callback mechanism.
   */
  @ZAttr(id = 309)
  ...
  /**
   * Deprecated since: 8.6. Formally deprecated in 8.6 but has been unused since at least 7.0. MTA
   * now uses all servers which have zimbraMtaAuthTarget set to TRUE. Orig desc: URL at which this
   * MTA (via zimbra saslauthd) should authenticate. Set by setting zimbraMtaAuthHost.
   */
  @ZAttr(id = 310)
  ...
  /**
   * Whether to email admin on detection of attachment with blocked extension
   *
   * @since ZCS 6.0.0_RC1
   */
  @ZAttr(id = 1031)
  public static final String A_zimbraMtaBlockedExtensionWarnAdmin =
      "zimbraMtaBlockedExtensionWarnAdmin";

  /**
   * Whether to email recipient on detection of attachment with blocked extension
   *
   * @since ZCS 6.0.0_RC1
   */
  @ZAttr(id = 1032)
  public static final String A_zimbraMtaBlockedExtensionWarnRecipient =
  ...
  /**
   * Deprecated since: 8.7.0_BETA2. deprecated in favor zimbraMtaSmtpDnsSupportLevel. Orig desc:
  ...
  /**
   * Maximum Map size for MTA LMDB dbs. Defaults to 16777216 (16MB). Databases will not grow beyond
   * this point.
   *
   * @since ZCS 8.5.0
   */
   ...
   */
  @ZAttr(id = 1505)
  public static final String A_zimbraMtaLmtpConnectionCacheDestinations =
   ...
   */
  @ZAttr(id = 1506)
  public static final String A_zimbraMtaLmtpConnectionCacheTimeLimit =
  ...
  /**
   * Value for postconf lmtp_tls_loglevel. Defaults to 0. Valid range is 0-4
   *
   * @since ZCS 8.6.0
   */
  @ZAttr(id = 1665)
   ...
   */
  @ZAttr(id = 1662)
  public static final String A_zimbraMtaLmtpTlsMandatoryCiphers =
   ...
   */
  @ZAttr(id = 1784)
  public static final String A_zimbraMtaLmtpTlsMandatoryProtocols =
  ...
  /**
   * Maximum total size of a mail message. Enforced in mailbox server and also used as value for
   * postconf message_size_limit. 0 means &quot;no limit&quot;
   */
  @ZAttr(id = 198)
  ...
  /**
   * Value for postconf postscreen_access_list. Single valued, commas separated list.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1917)
   ...
   */
  @ZAttr(id = 1918)
  public static final String A_zimbraMtaPostscreenBareNewlineAction =
   ...
   */
  @ZAttr(id = 1919)
  public static final String A_zimbraMtaPostscreenBareNewlineEnable =
   ...
   */
  @ZAttr(id = 1920)
  public static final String A_zimbraMtaPostscreenBareNewlineTTL =
   ...
   */
  @ZAttr(id = 1921)
  public static final String A_zimbraMtaPostscreenBlacklistAction =
   ...
   */
  @ZAttr(id = 1922)
  public static final String A_zimbraMtaPostscreenCacheCleanupInterval =
   ...
   */
  @ZAttr(id = 1923)
  public static final String A_zimbraMtaPostscreenCacheRetentionTime =
   ...
   */
  @ZAttr(id = 1924)
  public static final String A_zimbraMtaPostscreenCommandCountLimit =
  ...
  /**
   * Value for postconf postscreen_dnsbl_reply_map. Single valued, comma separated list.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1941)
  public static final String A_zimbraMtaPostscreenDnsblReplyMap =
      "zimbraMtaPostscreenDnsblReplyMap";

  /**
   * Value for postconf postscreen_dnsbl_sites. Multi valued, one DNSBL value pair per attribute
   * value.
   *
   * @since ZCS 8.7.0,9.0.0
   */
   ...
   */
  @ZAttr(id = 1927)
  public static final String A_zimbraMtaPostscreenDnsblThreshold =
   ...
   */
  @ZAttr(id = 1930)
  public static final String A_zimbraMtaPostscreenDnsblWhitelistThreshold =
   ...
   */
  @ZAttr(id = 1933)
  public static final String A_zimbraMtaPostscreenNonSmtpCommandAction =
   ...
   */
  @ZAttr(id = 1934)
  public static final String A_zimbraMtaPostscreenNonSmtpCommandEnable =
   ...
   */
  @ZAttr(id = 1935)
  public static final String A_zimbraMtaPostscreenNonSmtpCommandTTL =
   ...
   */
  @ZAttr(id = 1936)
  public static final String A_zimbraMtaPostscreenPipeliningAction =
   ...
   */
  @ZAttr(id = 1937)
  public static final String A_zimbraMtaPostscreenPipeliningEnable =
   ...
   */
  @ZAttr(id = 1938)
  public static final String A_zimbraMtaPostscreenPipeliningTTL =
   ...
   */
  @ZAttr(id = 2089)
  public static final String A_zimbraMtaPostscreenUpstreamProxyProtocol =
   ...
   */
  @ZAttr(id = 1939)
  public static final String A_zimbraMtaPostscreenWatchdogTimeout =
      "zimbraMtaPostscreenWatchdogTimeout";

  /**
   * Value for postconf postscreen_whitelist_interfaces. Single valued, comma separated list.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1940)
  public static final String A_zimbraMtaPostscreenWhitelistInterfaces =
   ...
   */
  @ZAttr(id = 1547)
  public static final String A_zimbraMtaPropagateUnmatchedExtensions =
  ...
  /**
   * Value for postconf recipient_delimiter. Also used by ZCS LMTP server to check if it should
   * accept messages to addresses with extensions.
   */
  @ZAttr(id = 306)
  public static final String A_zimbraMtaRecipientDelimiter = "zimbraMtaRecipientDelimiter";

  /**
   * Value for postconf relayhost. Note: there can be only one value on this attribute, see bug
   * 50697.
   */
  @ZAttr(id = 199)
  ...
  /**
   * Supported SASL mechanisms for use with the MTA. One attribute value per mechanism.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1560)
   ...
   */
  @ZAttr(id = 1524)
  public static final String A_zimbraMtaSmtpCnameOverridesServername =
   ...
   */
  @ZAttr(id = 2084)
  public static final String A_zimbraMtaSmtpdClientAuthRateLimit =
   ...
   */
  @ZAttr(id = 1553)
  public static final String A_zimbraMtaSmtpdClientRestrictions =
   ...
   */
  @ZAttr(id = 1534)
  public static final String A_zimbraMtaSmtpdRejectUnlistedRecipient =
   ...
   */
  @ZAttr(id = 1535)
  public static final String A_zimbraMtaSmtpdRejectUnlistedSender =
   ...
   */
  @ZAttr(id = 1536)
  public static final String A_zimbraMtaSmtpdSaslAuthenticatedHeader =
   ...
   */
  @ZAttr(id = 1550)
  public static final String A_zimbraMtaSmtpdSaslSecurityOptions =
   ...
   */
  @ZAttr(id = 1552)
  public static final String A_zimbraMtaSmtpdSaslTlsSecurityOptions =
   ...
   */
  @ZAttr(id = 1590)
  public static final String A_zimbraMtaSmtpdSenderRestrictions =
   ...
   */
  @ZAttr(id = 1543)
  public static final String A_zimbraMtaSmtpdTlsCcertVerifydepth =
  ...
  /**
   * Value for postconf smtpd_tls_loglevel. Default is 1. Valid range is 1-4.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1541)
   ...
   */
  @ZAttr(id = 1516)
  public static final String A_zimbraMtaSmtpdTlsMandatoryCiphers =
   ...
   */
  @ZAttr(id = 1783)
  public static final String A_zimbraMtaSmtpdTlsMandatoryProtocols =
   ...
   */
  @ZAttr(id = 1528)
  public static final String A_zimbraMtaSmtpSaslMechanismFilter =
   ...
   */
  @ZAttr(id = 1549)
  public static final String A_zimbraMtaSmtpSaslSecurityOptions =
   ...
   */
  @ZAttr(id = 2085)
  public static final String A_zimbraMtaSmtpTlsDaneInsecureMXPolicy =
      "zimbraMtaSmtpTlsDaneInsecureMXPolicy";

  /**
   * Value for postconf smtp_tls_loglevel. Defaults to 0. Valid range is 0-4
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1568)
   ...
   */
  @ZAttr(id = 1514)
  public static final String A_zimbraMtaSmtpTlsMandatoryCiphers =
   ...
   */
  @ZAttr(id = 1782)
  public static final String A_zimbraMtaSmtpTlsMandatoryProtocols =
  ...
  /**
   * Deprecated since: 8.7.0_BETA2. use zimbraMtaSmtpdSoftErrorLimit instead. Orig desc: Value for
   * postconf smtpd_soft_error_limit
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1538)
   ...
   */
  @ZAttr(id = 1606)
  public static final String A_zimbraMtaUnverifiedRecipientDeferCode =
   ...
   */
  @ZAttr(id = 1544)
  public static final String A_zimbraMtaVirtualAliasExpansionLimit =
  ...
  /**
   * certificate to be used for validating the SAML assertions received from myonelogin (tricipher)
   *
   * @since ZCS 7.0.1
   */
  @ZAttr(id = 1169)
  ...
  /**
   * Deprecated since: 8.8.5. This attribute has been renamed to zimbraNetworkAdminNGEnabled. Orig
   * desc: Whether to enable old zimbra network admin module.
   *
   * @since ZCS 8.8.2
   */
  @ZAttr(id = 2119)
  ...
  /**
   * Template used to construct the body of an email notification message. This attribute is ignored
   * when zimbraNewMailNotificationMessage is set.
   */
  @ZAttr(id = 152)
  public static final String A_zimbraNewMailNotificationBody = "zimbraNewMailNotificationBody";

  /**
   * Template used to construct the sender of an email notification message. This attribute is
   * ignored when zimbraNewMailNotificationMessage is set.
   */
  @ZAttr(id = 150)
  public static final String A_zimbraNewMailNotificationFrom = "zimbraNewMailNotificationFrom";

  /**
   * Template used to construct an email notification message. When this attribute is not set, email
   * notification message is composed using zimbraNewMailNotificationBody,
   * zimbraNewMailNotificationFrom and zimbraNewMailNotificationSubject attributes. Use this
   * attribute when you need to specify custom email headers such as charset and content-type.
   * Sample configuration: From: Postmaster &lt;postmaster@${RECIPIENT_DOMAIN}&gt;${NEWLINE}To:
   * &lt;${RECIPIENT_ADDRESS}&gt;${NEWLINE}Subject: New message received at
   * ${RECIPIENT_ADDRESS}${NEWLINE}Date: ${DATE}${NEWLINE}Content-Type:
   * text/plain${NEWLINE}${NEWLINE}New message received at ${RECIPIENT_ADDRESS}.${NEWLINE}Sender:
   * ${SENDER_ADDRESS}${NEWLINE}Subject: ${SUBJECT}
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2019)
  public static final String A_zimbraNewMailNotificationMessage =
      "zimbraNewMailNotificationMessage";

  /**
   * Template used to construct the subject of an email notification message. This attribute is
   * ignored when zimbraNewMailNotificationMessage is set.
   */
  @ZAttr(id = 151)
  public static final String A_zimbraNewMailNotificationSubject =
      "zimbraNewMailNotificationSubject";

  /**
   * Deprecated since: 7.0.0. See bug 39647. Orig desc: Account for storing templates and providing
   * space for public wiki
   */
  @ZAttr(id = 363)
  public static final String A_zimbraNotebookAccount = "zimbraNotebookAccount";

  /**
   * Deprecated since: 6.0.0_BETA1. deprecated. Orig desc: The size of Wiki / Notebook folder cache
   * on the server.
   */
  @ZAttr(id = 370)
  ...
  /**
   * Deprecated since: 6.0.0_BETA1. deprecated. Orig desc: The maximum number of cached templates in
   * each Wiki / Notebook folder cache.
   */
  @ZAttr(id = 371)
  public static final String A_zimbraNotebookMaxCachedTemplatesPerFolder =
      "zimbraNotebookMaxCachedTemplatesPerFolder";

  /** maximum number of revisions to keep for wiki pages and documents. 0 means unlimited. */
  @ZAttr(id = 482)
  ...
  /**
   * whether to strip off potentially harming HTML tags in Wiki and HTML Documents.
   *
   * @since ZCS 5.0.6
   */
  @ZAttr(id = 646)
  ...
  /**
   * Deprecated since: 4.0. was experimental and never part of any shipping feature. Orig desc:
   * Network interface on which notification server should listen; if empty, binds to all
   * interfaces.
   */
  @ZAttr(id = 317)
  ...
  /**
   * Deprecated since: 4.0. was experimental and never part of any shipping feature. Orig desc: Port
   * number on which notification server should listen.
   */
  @ZAttr(id = 318)
  ...
  /**
   * Deprecated since: 4.0. was experimental and never part of any shipping feature. Orig desc:
   * Whether notification server should be enabled.
   */
  @ZAttr(id = 316)
  ...
  /**
   * Deprecated since: 4.0. was experimental and never part of any shipping feature. Orig desc:
   * Network interface on which SSL notification server should listen; if empty, binds to all
   * interfaces
   */
  @ZAttr(id = 320)
  ...
  /**
   * Deprecated since: 4.0. was experimental and never part of any shipping feature. Orig desc:
   * Whether SSL notification server should be enabled.
   */
  @ZAttr(id = 319)
   ...
   * character}apiscope2:consumer-app-name. The separator between apiscope1 and apiscope2 is
  ...
  /**
   * OAuth Consumer id, secret, and application name. It is in the format of
  ...
  /**
   * OAuth redirectURI. It is in the format of redirectURI:consumer-app-name
   *
   * @since ZCS 8.8.9
   */
  @ZAttr(id = 3025)
  ...
  /**
   * temporary RFC822 email address of this recipient for accepting mail during account rename
   *
   * @since ZCS 8.8.10
   */
  @ZAttr(id = 2143)
   ...
   */
  @ZAttr(id = 1191)
  public static final String A_zimbraOpenidConsumerAllowedOPEndpointURL =
      "zimbraOpenidConsumerAllowedOPEndpointURL";

  /**
   * whether stateless mode (not establishing an association with the OpenID Provider) in OpenID
   * Consumer is enabled
   *
   * @since ZCS 7.1.0
   */
  @ZAttr(id = 1189)
  public static final String A_zimbraOpenidConsumerStatelessModeEnabled =
      "zimbraOpenidConsumerStatelessModeEnabled";

  /**
   * The max number of IMAP messages returned by OpenImapFolderRequest before pagination begins
   *
   * @since ZCS 8.8.1
   */
  @ZAttr(id = 3012)
  public static final String A_zimbraOpenImapFolderRequestChunkSize =
   ...
   */
  @ZAttr(id = 1256)
  public static final String A_zimbraPasswordAllowedPunctuationChars =
   ...
   */
  @ZAttr(id = 3090)
  public static final String A_zimbraPasswordBlockCommonEnabled =
  ...
  /**
   * whether or not to enforce password history. Number of unique passwords a user must have before
   * being allowed to re-use an old one. A value of 0 means no password history.
   */
  @ZAttr(id = 37)
  ...
  /**
   * how long an account is locked out. Use 0 to lockout an account until admin resets it. Must be
   * in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m
   * - minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   */
  ...
  /**
   * the duration after which old consecutive failed login attempts are purged from the list, even
   * though no successful authentication has occurred. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 381)
  public static final String A_zimbraPasswordLockoutFailureLifetime =
      "zimbraPasswordLockoutFailureLifetime";

  /**
   * this attribute contains the timestamps of each of the consecutive authentication failures made
   * on an account
   */
  @ZAttr(id = 383)
  public static final String A_zimbraPasswordLockoutFailureTime =
  ...
  /** number of consecutive failed login attempts until an account is locked out */
  @ZAttr(id = 380)
  public static final String A_zimbraPasswordLockoutMaxFailures =
      "zimbraPasswordLockoutMaxFailures";

  /**
   * Number of invalid passwords kept in a cache per account. Any number of login attempts using
   * password present in cache will be considered as single failed attempt. If Twofactor
   * authentication enabled the cache size will be sum of zimbraPasswordLockoutSuppressionCacheSize
   * and number of application specific password generated.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2086)
  public static final String A_zimbraPasswordLockoutSuppressionCacheSize =
      "zimbraPasswordLockoutSuppressionCacheSize";

  /**
   * If TRUE it will not increment the repeated failed login attempt using old or invalid password
   * from zimbraPasswordLockoutSuppressionProtocols.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2087)
  public static final String A_zimbraPasswordLockoutSuppressionEnabled =
      "zimbraPasswordLockoutSuppressionEnabled";

  /**
   * Protocols for which repeated failed login attempts with same password considered as single
   * failure. Supported protocols zsync,imap,pop3,http_basic,http_dav,soap.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2088)
  public static final String A_zimbraPasswordLockoutSuppressionProtocols =
  ...
  /**
   * minimum number of numeric or ascii punctuation characters required in a password
   *
   * @since ZCS 7.1.3
   */
  @ZAttr(id = 1255)
  ...
  @ZAttr(id = 391)
  public static final String A_zimbraPasswordMinPunctuationChars =
   ...
   */
  @ZAttr(id = 2141)
  public static final String A_zimbraPasswordRecoveryMaxAttempts =
  ...
  /** interface address on which POP3 server should listen; if empty, binds to all interfaces */
  @ZAttr(id = 95)
  ...
  /**
   * Maximum number of concurrent POP3 connections allowed. New connections exceeding this limit are
   * rejected.
   *
   * @since ZCS 8.0.0
   */
  ...
  /**
   * whether or not the user has accepted the client&#039;s terms of service
   *
   * @since ZCS 8.8.8
   */
  @ZAttr(id = 3068)
  ...
  /**
   * whether to display a warning when users try to navigate away from the admin console
   *
   * @since ZCS 6.0.0_RC1
   */
  @ZAttr(id = 1036)
  public static final String A_zimbraPrefAdminConsoleWarnOnExit =
      "zimbraPrefAdminConsoleWarnOnExit";

  /**
   * After login, whether the advanced client should enforce minimum display resolution
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 678)
  public static final String A_zimbraPrefAdvancedClientEnforceMinDisplay =
      "zimbraPrefAdvancedClientEnforceMinDisplay";

  /**
   * Addresses of the account that can be used by allowed delegated senders as From and Sender
   * address.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1333)
  public static final String A_zimbraPrefAllowAddressForDelegatedSender =
      "zimbraPrefAllowAddressForDelegatedSender";

  /**
   * Use the iCal style delegation model for shared calendars for CalDAV interface when set to TRUE.
   *
   * @since ZCS 5.0.17
   */
  @ZAttr(id = 1028)
  public static final String A_zimbraPrefAppleIcalDelegationEnabled =
      "zimbraPrefAppleIcalDelegationEnabled";

  /** whether or not new address in outgoing email are auto added to address book */
  @ZAttr(id = 131)
  public static final String A_zimbraPrefAutoAddAddressEnabled = "zimbraPrefAutoAddAddressEnabled";

  /**
   * Deprecated since: 8.5.0. address bubbles always enabled since 8.5.0. Orig desc: whether
   * actionable address objects result from autocomplete is enabled
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1146)
  public static final String A_zimbraPrefAutocompleteAddressBubblesEnabled =
   ...
   */
  @ZAttr(id = 1091)
  public static final String A_zimbraPrefAutoCompleteQuickCompletionOnComma =
      "zimbraPrefAutoCompleteQuickCompletionOnComma";

  /**
   * time to wait before auto saving a draft. Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.0
  ...
  /**
   * address that we will bcc when using sending mail with this identity (deprecatedSince 5.0 in
   * identity)
   */
  @ZAttr(id = 411)
   ...
   */
  @ZAttr(id = 1152)
  public static final String A_zimbraPrefBriefcaseReadingPaneLocation =
   ...
   */
  @ZAttr(id = 1202)
  public static final String A_zimbraPrefCalendarAcceptSignatureId =
   ...
   */
  @ZAttr(id = 702)
  public static final String A_zimbraPrefCalendarAllowCancelEmailToSelf =
      "zimbraPrefCalendarAllowCancelEmailToSelf";

  /**
   * Allowed recipients if &quot;zimbraPrefCalendarSendInviteDeniedAutoReply&quot; is TRUE: internal
   * - Only send &quot;invite denied&quot; auto-response if the sender of the original invite is an
   * internal user. sameDomain - Only send &quot;invite denied&quot; auto-response if the sender of
   * the original invite is in the same domain as the invitee. all - No restrictions on who to send
   * &quot;invite denied&quot; auto-responses to.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1632)
  public static final String A_zimbraPrefCalendarAllowedTargetsForInviteDeniedAutoReply =
      "zimbraPrefCalendarAllowedTargetsForInviteDeniedAutoReply";

  /**
   * whether calendar invite part in a forwarded email is auto-added to calendar
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 686)
  public static final String A_zimbraPrefCalendarAllowForwardedInvite =
      "zimbraPrefCalendarAllowForwardedInvite";

  /**
   * whether calendar invite part with PUBLISH method is auto-added to calendar
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 688)
  public static final String A_zimbraPrefCalendarAllowPublishMethodInvite =
      "zimbraPrefCalendarAllowPublishMethodInvite";

  /** always show the mini calendar */
  @ZAttr(id = 276)
  public static final String A_zimbraPrefCalendarAlwaysShowMiniCal =
      "zimbraPrefCalendarAlwaysShowMiniCal";

  /**
   * Whether to allow attendees to make local edits to appointments. The change is only on the
   * attendees copy of the message and changes from the organizer will overwrite the local changes.
   *
   * @since ZCS 6.0.7
   */
  @ZAttr(id = 1089)
  public static final String A_zimbraPrefCalendarApptAllowAtendeeEdit =
      "zimbraPrefCalendarApptAllowAtendeeEdit";

  /**
   * number of minutes (0 = never and -1 = At the time of event) before appt to show reminder
   * dialog. Note:&quot;0&quot; was chosen to mean &quot;never&quot; before reminders &quot;at the
   * time of event&quot; were supported, hence the need to use &quot;-1&quot; to mean &quot;At the
   * time of event&quot; (instead of &quot;0&quot; which would be more intuitive) to avoid breaking
   * backwards compatibility
   */
  @ZAttr(id = 341)
  public static final String A_zimbraPrefCalendarApptReminderWarningTime =
      "zimbraPrefCalendarApptReminderWarningTime";

  /**
   * default visibility of the appointment when starting a new appointment in the UI
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 832)
  public static final String A_zimbraPrefCalendarApptVisibility =
   ...
   */
  @ZAttr(id = 1192)
  public static final String A_zimbraPrefCalendarAutoAcceptSignatureId =
   ...
   */
  @ZAttr(id = 848)
  public static final String A_zimbraPrefCalendarAutoAddInvites =
      "zimbraPrefCalendarAutoAddInvites";

  /**
   * calendar auto decline reply signature id for account/identity/dataSource
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1193)
  public static final String A_zimbraPrefCalendarAutoDeclineSignatureId =
   ...
   */
  @ZAttr(id = 1194)
  public static final String A_zimbraPrefCalendarAutoDenySignatureId =
      "zimbraPrefCalendarAutoDenySignatureId";

  /** hour of day that the day view should end at, non-inclusive (16=4pm, 24 = midnight, etc) */
  @ZAttr(id = 440)
  ...
  /**
   * calendar manual decline reply signature id for account/identity/dataSource
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1204)
  public static final String A_zimbraPrefCalendarDeclineSignatureId =
      "zimbraPrefCalendarDeclineSignatureId";

  /**
   * default appointment duration. Must be in valid duration format: {digits}{time-unit}. digits:
   * 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If
   * time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1187)
  public static final String A_zimbraPrefCalendarDefaultApptDuration =
      "zimbraPrefCalendarDefaultApptDuration";

  /** first day of week to show in calendar (0=sunday, 6=saturday) */
  @ZAttr(id = 261)
  public static final String A_zimbraPrefCalendarFirstDayOfWeek =
   ...
   */
  @ZAttr(id = 851)
  public static final String A_zimbraPrefCalendarForwardInvitesTo =
      "zimbraPrefCalendarForwardInvitesTo";

  /** comma-sep list of calendars that are initially checked */
  @ZAttr(id = 275)
  public static final String A_zimbraPrefCalendarInitialCheckedCalendars =
  ...
  /**
   * If set to true, user is notified by email of changes made to her calendar by others via
   * delegated calendar access.
   */
  @ZAttr(id = 273)
  public static final String A_zimbraPrefCalendarNotifyDelegatedChanges =
      "zimbraPrefCalendarNotifyDelegatedChanges";

  /**
   * device information entered by the user for receiving reminders for appointments and tasks
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1307)
  public static final String A_zimbraPrefCalendarReminderDeviceInfo =
      "zimbraPrefCalendarReminderDeviceInfo";

  /**
   * Deprecated since: 6.0.0_BETA1. was added for Yahoo calendar, no longer used. Orig desc: When to
   * send the first reminder for an event.
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 573)
  public static final String A_zimbraPrefCalendarReminderDuration1 =
   ...
   */
  @ZAttr(id = 574)
  public static final String A_zimbraPrefCalendarReminderDuration2 =
      "zimbraPrefCalendarReminderDuration2";

  /**
   * RFC822 email address for receiving reminders for appointments and tasks
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 575)
   ...
   */
  @ZAttr(id = 682)
  public static final String A_zimbraPrefCalendarReminderFlashTitle =
      "zimbraPrefCalendarReminderFlashTitle";

  /**
   * Deprecated since: 6.0.0_BETA1. was added for Yahoo calendar, no longer used. Orig desc: The
   * mobile device (phone) the reminder goes to.
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 577)
  public static final String A_zimbraPrefCalendarReminderMobile =
      "zimbraPrefCalendarReminderMobile";

  /**
   * Deprecated since: 6.0.0_BETA1. was added for Yahoo calendar, no longer used. Orig desc: whether
   * or not email reminders for appointments and tasks are enabled
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 576)
  public static final String A_zimbraPrefCalendarReminderSendEmail =
      "zimbraPrefCalendarReminderSendEmail";

  /**
   * whether audible alert is enabled when appointment notification is played
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 667)
  public static final String A_zimbraPrefCalendarReminderSoundsEnabled =
      "zimbraPrefCalendarReminderSoundsEnabled";

  /**
   * Deprecated since: 6.0.0_BETA1. was added for Yahoo calendar, no longer used. Orig desc: Send a
   * reminder via YIM
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 578)
  public static final String A_zimbraPrefCalendarReminderYMessenger =
      "zimbraPrefCalendarReminderYMessenger";

  /**
   * If an invite is received from an organizer who does not have permission to invite this user to
   * a meeting, send an auto-decline reply. Note that
   * zimbraPrefCalendarAllowedTargetsForInviteDeniedAutoReply may further restrict who can receive
   * this reply.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 849)
  public static final String A_zimbraPrefCalendarSendInviteDeniedAutoReply =
   ...
   */
  @ZAttr(id = 1196)
  public static final String A_zimbraPrefCalendarShowDeclinedMeetings =
   ...
   */
  @ZAttr(id = 1022)
  public static final String A_zimbraPrefCalendarShowPastDueReminders =
      "zimbraPrefCalendarShowPastDueReminders";

  /**
   * calendar manual tentative accept reply signature id for account/identity/dataSource
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1203)
  public static final String A_zimbraPrefCalendarTentativeSignatureId =
   ...
   */
  @ZAttr(id = 813)
  public static final String A_zimbraPrefCalendarToasterEnabled =
  ...
  /**
   * time interval to display on calendar views. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1195)
  public static final String A_zimbraPrefCalendarViewTimeInterval =
  ...
  /**
   * If FALSE, chat features are disabled in the client and user presence is shown as offline to all
   * other users.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  ...
  /**
   * Deprecated since: 8.5.0. family mailbox feature is deprecated. Orig desc: zimbraId of visible
   * child accounts
   *
   * @since ZCS 5.0.0
   */
  ...
  /**
   * Deprecated since: 8.0.0. Since 8.0.0, the contact group can contain member references, but
   * member references are not searchable.. Orig desc: Disables autocomplete matching against the
   * members email address.
   *
   * @since ZCS 6.0.7
   */
  @ZAttr(id = 1090)
  public static final String A_zimbraPrefContactsDisableAutocompleteOnContactGroupMembers =
      "zimbraPrefContactsDisableAutocompleteOnContactGroupMembers";

  /**
   * Deprecated since: 8.0.0. deprecated now that Zimbra supports keeping member references in a
   * contact group. Orig desc: Expand the contact groups in Apple Address Book format to Zimbra
   * format over CardDAV.
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1102)
  public static final String A_zimbraPrefContactsExpandAppleContactGroups =
      "zimbraPrefContactsExpandAppleContactGroups";

  /**
   * Deprecated since: 6.0.5. We do not support cards view any more. See bug 47439. Orig desc:
   ...
   */
  @ZAttr(id = 1010)
  public static final String A_zimbraPrefConvReadingPaneLocation =
      "zimbraPrefConvReadingPaneLocation";

  /**
   * When displaying an invite in a conversation, show the day calendar immediately.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1394)
  ...
  @ZAttr(id = 144)
  public static final String A_zimbraPrefDedupeMessagesSentToSelf =
      "zimbraPrefDedupeMessagesSentToSelf";

  /**
   * Default calendar folder id. Current default calendar id is 10, as calendar folder with id 10,
   * is created for all users. Cos level change is blocked. So admin can not change value of this
   * attribute on cos level.
   *
   * @since ZCS 8.8.10
   */
  @ZAttr(id = 2994)
  ...
  /**
   * Which mailbox to save messages sent via sendAs/sendOnBehalfOf delegation to.
   *
   * @since ZCS 8.6.0,9.0.0
   */
  @ZAttr(id = 1651)
  public static final String A_zimbraPrefDelegatedSendSaveTarget =
      "zimbraPrefDelegatedSendSaveTarget";

  /** whether meeting invite emails are moved to Trash folder upon accept/decline */
  @ZAttr(id = 470)
  ...
  /**
   * Specifies the meaning of an external sender. &quot;ALL&quot; means users whose domain
   * doesn&#039;t match the recipient&#039;s or zimbraInternalSendersDomain. &quot;ALLNOTINAB&quot;
   * means &quot;ALL&quot; minus users who are in the recipient&#039;s address book.
   * &quot;INAB&quot; Users/Addresses whose domain doesn&#039;t match the recipient&#039;s domain or
   * zimbraInternalSendersDomain and which are present in recipient&#039;s address book.
   * &quot;INSD&quot; means users whose domain matches the specific domain
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1320)
   ...
   */
  @ZAttr(id = 134)
  public static final String A_zimbraPrefForwardIncludeOriginalText =
      "zimbraPrefForwardIncludeOriginalText";

  /** what format we reply/forward messages in (deprecatedSince 5.0 in identity) */
  @ZAttr(id = 413)
  public static final String A_zimbraPrefForwardReplyFormat = "zimbraPrefForwardReplyFormat";

  /** whether or not to use same format (text or html) of message we are replying to */
  @ZAttr(id = 218)
  public static final String A_zimbraPrefForwardReplyInOriginalFormat =
      "zimbraPrefForwardReplyInOriginalFormat";

  /** prefix character to use during forward/reply (deprecatedSince 5.0 in identity) */
  @ZAttr(id = 130)
  public static final String A_zimbraPrefForwardReplyPrefixChar =
   ...
   */
  @ZAttr(id = 1125)
  public static final String A_zimbraPrefForwardReplySignatureId =
  ...
  /** whether end-user wants auto-complete from GAL. Feature must also be enabled. */
  @ZAttr(id = 372)
  public static final String A_zimbraPrefGalAutoCompleteEnabled =
  ...
  /** default font color */
  @ZAttr(id = 260)
  public static final String A_zimbraPrefHtmlEditorDefaultFontColor =
      "zimbraPrefHtmlEditorDefaultFontColor";

  /** default font family */
  @ZAttr(id = 258)
  public static final String A_zimbraPrefHtmlEditorDefaultFontFamily =
      "zimbraPrefHtmlEditorDefaultFontFamily";

  /** default font size */
  @ZAttr(id = 259)
  public static final String A_zimbraPrefHtmlEditorDefaultFontSize =
  ...
  /**
   * whether end user choose to use IMAP feature. If it is set to TRUE, IMAP feature is available
   * only when zimbraImapEnabled is TRUE.
   *
   * @since ZCS 9.0.0
   */
  @ZAttr(id = 3086)
  ...
  @ZAttr(id = 241)
  public static final String A_zimbraPrefImapSearchFoldersEnabled =
      "zimbraPrefImapSearchFoldersEnabled";

  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: whether to login to the IM client automatically
   */
  @ZAttr(id = 488)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: IM buddy list sort order
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 705)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: Custom IM status messages
   *
   * @since ZCS 5.0.6
   */
  @ZAttr(id = 645)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: Flash IM icon on new messages
   */
  @ZAttr(id = 462)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: Flash title bar when a new IM arrives
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 679)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: whether to hide IM blocked buddies
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 707)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: whether to hide IM offline buddies
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 706)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: IM idle status
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 560)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: IM session idle timeout in minutes
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 559)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: Enable instant notifications
   */
  @ZAttr(id = 517)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: whether to log IM chats to the Chats folder
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 556)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: whether IM log chats is enabled
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 552)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: Notify for presence modifications
   */
  @ZAttr(id = 463)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: Notify for status change
   */
  @ZAttr(id = 464)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: whether to report IM idle status
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 558)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: whether sounds is enabled in IM
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 570)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra IM has been discontinued. Zimbra Chat feature uses a new set of
   * configuration attributes.. Orig desc: last used yahoo id
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 757)
  ...
  /**
   * Retention period of read messages in the Inbox folder. 0 means that all messages will be
   * retained. . Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit:
   * [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is
   * not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.0
  ...
  /**
   * Retention period of unread messages in the Inbox folder. 0 means that all messages will be
   * retained. . Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit:
   * [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is
   * not specified, the default is s(seconds).
   *
   ...
   */
  @ZAttr(id = 1338)
  public static final String A_zimbraPrefIncludeSharedItemsInSearch =
  ...
  /**
   * Retention period of messages in the Junk folder. 0 means that all messages will be retained.
   * This user-modifiable attribute works in conjunction with zimbraMailSpamLifetime, which is
   * admin-modifiable. The shorter duration is used. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.0
  ...
  /**
   * user locale preference, e.g. en_US Whenever the server looks for the user locale, it will first
   * look for zimbraPrefLocale, if it is not set then it will fallback to the current mechanism of
   * looking for zimbraLocale in the various places for a user. zimbraLocale is the non end-user
   * attribute that specifies which locale an object defaults to, it is not an end-user setting.
   */
  @ZAttr(id = 442)
  ...
  /**
   * a list of comma separated folder ids of all folders used to count for showing a new message
   * indicator icon for the account, useful in UIs managing multiple accounts: desktop and family
   * mailboxes.
   *
   * @since ZCS 6.0.5
   */
  @ZAttr(id = 1072)
  public static final String A_zimbraPrefMailFoldersCheckedForNewMsgIndicator =
  ...
  @ZAttr(id = 344)
  public static final String A_zimbraPrefMailLocalDeliveryDisabled =
      "zimbraPrefMailLocalDeliveryDisabled";

  /**
   * interval at which the web client polls the server for new messages. Must be in valid duration
   * format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s -
   * seconds, d - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 111)
  ...
  /**
   * whether web UI should always request read receipts for outgoing messages
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1217)
  public static final String A_zimbraPrefMailRequestReadReceipts =
   ...
   */
  @ZAttr(id = 1129)
  public static final String A_zimbraPrefMailSignatureContactId =
  ...
  /** mail signature style outlook|internet (deprecatedSince 5.0 in identity) */
  @ZAttr(id = 156)
  public static final String A_zimbraPrefMailSignatureStyle = "zimbraPrefMailSignatureStyle";

  /**
   * Deprecated since: 7.1.1. deprecated in favor of userCertificate and userSMIMECertificate. Orig
   * desc: user&#039;s S/MIME public keys (certificates)
   *
   * @since ZCS 7.1.0
   */
  @ZAttr(id = 1172)
  ...
  /**
   * Trusted sender email addresses or domains. External images in emails sent by trusted senders
   * are automatically loaded in the message view.
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1138)
   ...
   */
  @ZAttr(id = 749)
  public static final String A_zimbraPrefMandatorySpellCheckEnabled =
      "zimbraPrefMandatorySpellCheckEnabled";

  /**
   * whether and mark a message as read -1: Do not mark read 0: Mark read 1..n: Mark read after this
   * many seconds
   *
   * @since ZCS 5.0.6
   */
  ...
  /**
   * Account-level switch that enables message deduping. See zimbraMessageIdDedupeCacheSize for more
   * details.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1198)
  public static final String A_zimbraPrefMessageIdDedupingEnabled =
      "zimbraPrefMessageIdDedupingEnabled";

  /** whether client prefers text/html or text/plain */
  @ZAttr(id = 145)
  public static final String A_zimbraPrefMessageViewHtmlPreferred =
      "zimbraPrefMessageViewHtmlPreferred";

  /** RFC822 email address for email notifications */
  @ZAttr(id = 127)
  public static final String A_zimbraPrefNewMailNotificationAddress =
      "zimbraPrefNewMailNotificationAddress";

  /** whether or not new mail notification is enabled */
  @ZAttr(id = 126)
  public static final String A_zimbraPrefNewMailNotificationEnabled =
      "zimbraPrefNewMailNotificationEnabled";

  /** whether or not the client opens a new msg/conv in a new window (via dbl-click) */
  @ZAttr(id = 500)
  public static final String A_zimbraPrefOpenMailInNewWindow = "zimbraPrefOpenMailInNewWindow";

  /**
   * server remembers addresses to which notifications have been sent for this interval, and does
   * not send duplicate notifications in this interval. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 386)
  public static final String A_zimbraPrefOutOfOfficeCacheDuration =
      "zimbraPrefOutOfOfficeCacheDuration";

  /**
   * per RFC 3834 no out of office notifications are sent if recipients address is not directly
   * specified in the To/CC headers - for this check, we check to see if To/CC contained accounts
   * address, aliases, canonical address. But when external accounts are forwarded to Zimbra, and
   * you want notifications sent to messages that contain their external address in To/Cc, add those
   * address, then you can specify those external addresses here.
   */
  @ZAttr(id = 387)
  public static final String A_zimbraPrefOutOfOfficeDirectAddress =
   ...
   */
  @ZAttr(id = 1317)
  public static final String A_zimbraPrefOutOfOfficeExternalReply =
      "zimbraPrefOutOfOfficeExternalReply";

  /**
   * If TRUE, send zimbraPrefOutOfOfficeExternalReply to external senders. External senders are
   * specified by zimbraInternalSendersDomain and zimbraPrefExternalSendersType.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1318)
  public static final String A_zimbraPrefOutOfOfficeExternalReplyEnabled =
   ...
   */
  @ZAttr(id = 1334)
  public static final String A_zimbraPrefOutOfOfficeFreeBusyStatus =
      "zimbraPrefOutOfOfficeFreeBusyStatus";

  /** out of office notifications (if enabled) are sent only if current date is after this date */
  @ZAttr(id = 384)
  ...
  @ZAttr(id = 59)
  public static final String A_zimbraPrefOutOfOfficeReplyEnabled =
   ...
   */
  @ZAttr(id = 2132)
  public static final String A_zimbraPrefOutOfOfficeSpecificDomains =
      "zimbraPrefOutOfOfficeSpecificDomains";

  /**
   * when user has OOO message enabled, when they login into web client, whether to alert the user
   * that the OOO message is turned on and provide the ability to turn it off
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1245)
  public static final String A_zimbraPrefOutOfOfficeStatusAlertOnLogin =
      "zimbraPrefOutOfOfficeStatusAlertOnLogin";

  /**
   * If TRUE, OOO reply is not sent to external senders, when the user enables OOO for the account
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1576)
  public static final String A_zimbraPrefOutOfOfficeSuppressExternalReply =
      "zimbraPrefOutOfOfficeSuppressExternalReply";

  /** out of office notifications (if enabled) are sent only if current date is before this date */
  @ZAttr(id = 385)
   ...
   */
  @ZAttr(id = 2135)
  public static final String A_zimbraPrefPasswordRecoveryAddress =
   ...
   */
  @ZAttr(id = 2136)
  public static final String A_zimbraPrefPasswordRecoveryAddressStatus =
      "zimbraPrefPasswordRecoveryAddressStatus";

  /**
   * When messages are accessed via POP3: - keep: Leave DELE&#039;ed messages in Inbox. - read: Mark
   * RETR&#039;ed messages as read, and leave DELE&#039;ed messages in Inbox. - trash: Move
   * DELE&#039;ed messages to Trash, and mark them as read. - delete: Hard-delete DELE&#039;ed
   * messages. This is the straightforward POP3 implementation.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1165)
  ...
  /**
   * whether end user choose to use POP3 feature. If it is set to TRUE, POP3 feature is available
   * only when zimbraPop3Enabled is TRUE.
   *
   * @since ZCS 9.0.0
   */
  @ZAttr(id = 3087)
  ...
  /**
   * Deprecated since: 6.0.0_BETA2. deprecated in favor of zimbraPrefReadingPaneLocation and
   * zimbraPrefConvReadingPaneLocation. Orig desc: whether reading pane is shown by default
   */
  @ZAttr(id = 394)
  ...
  /**
   * Deprecated since: 6.0.8. Deprecated per bug 46988. This feature was never fully implemented..
   * Orig desc: address to put in reply-to header of read receipt messages, if it is not set, then
   * the compose identities primary email address is used.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 823)
   ...
   */
  @ZAttr(id = 133)
  public static final String A_zimbraPrefReplyIncludeOriginalText =
  ...
  /**
   * Retention period of messages in the Sent folder. 0 means that all messages will be retained. .
   * Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h -
   * hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified,
   * the default is s(seconds).
   *
   ...
   */
  @ZAttr(id = 759)
  public static final String A_zimbraPrefSharedAddrBookAutoCompleteEnabled =
  ...
  /**
   * show just the display name of email addresses in the message header area and compose pane
   *
   * @since ZCS 7.0.1
   */
  @ZAttr(id = 1173)
  ...
  /**
   * By default, new mail notifications are only displayed for new items placed in the inbox. To get
   * new mail notifications for items filtered to other folders as well, set this to TRUE
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1904)
  public static final String A_zimbraPrefShowAllNewMailNotifications =
  ...
  /**
   * show selection checkbox for selecting email, contact, voicemail items in a list view for batch
   * operations
   */
  @ZAttr(id = 471)
  ...
  /**
   * The name of the dictionary used for spell checking. If not set, the locale is used.
   *
   * @since ZCS 6.0.0_GA
   */
  @ZAttr(id = 1041)
  ...
  /**
   * If TRUE, the spell checker ignores words that contain only upper-case letters.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1207)
  ...
  /**
   * List of words to ignore when checking spelling. The word list of an account includes the words
   * specified for its cos and domain.
   *
   * @since ZCS 6.0.5
   */
  @ZAttr(id = 1073)
   ...
   */
  @ZAttr(id = 689)
  public static final String A_zimbraPrefStandardClientAccessibilityMode =
      "zimbraPrefStandardClientAccessibilityMode";

  /**
   * If true, Tab key inserts a tab into the editor body. If false, it moves focus.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1972)
   ...
   */
  @ZAttr(id = 1151)
  public static final String A_zimbraPrefTasksReadingPaneLocation =
  ...
  /**
   * Retention period of messages in the Trash folder. 0 means that all messages will be retained.
   * This user-modifiable attribute works in conjunction with zimbraMailTrashLifetime, which is
   * admin-modifiable. The shorter duration is used. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
  ...
  /**
   * Deprecated since: 5.0. no longer used in account or identity. Orig desc: TRUE if we this
   * identity should get settings from the default identity
   */
  @ZAttr(id = 410)
  public static final String A_zimbraPrefUseDefaultIdentitySettings =
  ...
  /**
   * When composing and sending mail, whether to use RFC 2231 MIME parameter value encoding. If set
   * to FALSE, then RFC 2047 style encoding is used.
   */
  @ZAttr(id = 395)
  public static final String A_zimbraPrefUseRfc2231 = "zimbraPrefUseRfc2231";

  /**
   * Whether to allow the send message Control-Enter shortcut in the web client UI
   *
   * @since ZCS 8.6.0,9.0.0
   */
  @ZAttr(id = 1650)
  ...
  @ZAttr(id = 236)
  public static final String A_zimbraPrefUseTimeZoneListInCalendar =
  ...
  /**
   * set of known keys corresponding to browsers used by the user for web client offline access
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1571)
  public static final String A_zimbraPrefWebClientOfflineBrowserKey =
      "zimbraPrefWebClientOfflineBrowserKey";

  /**
   * if replying/forwarding a message in this folder, use this identity (deprecatedSince 5.0 in
   * account)
   */
  @ZAttr(id = 409)
  ...
  /**
   * addresses that we will look at to see if we should use an identity (deprecatedSince 5.0 in
   * account)
   */
  @ZAttr(id = 407)
   ...
   */
  @ZAttr(id = 1952)
  public static final String A_zimbraPrefZmgPushNotificationEnabled =
   ...
   */
  @ZAttr(id = 3018)
  public static final String A_zimbraPreviousEphemeralBackendURL =
  ...
  /**
   * whether this instance of Zimbra is running ZCS or some other derivative product
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1392)
  ...
  /**
   * Deprecated since: 7.2.1. Deprecated per bug 74769. Orig desc: Content types that can be cached
   * by proxy servlet
   */
  @ZAttr(id = 303)
  public static final String A_zimbraProxyCacheableContentTypes =
  ...
  /**
   * Maximum allowed lifetime of public shares. A value of 0 indicates that there&#039;s no limit on
   * a public share&#039;s lifetime. . Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
  ...
  /**
   * The total size (in bytes) of the in-memory queue of conversations to be purged for each data
   * source
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2017)
  public static final String A_zimbraPurgedConversationsQueueSize =
  ...
  /**
   * Minimum duration of time between quota warnings.. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 485)
  ...
  /**
   * Expiry time for recovery email code verification. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.8.9
   */
  @ZAttr(id = 2140)
  public static final String A_zimbraRecoveryAccountCodeValidity =
   ...
   */
  @ZAttr(id = 2139)
  public static final String A_zimbraRecoveryAccountVerificationData =
  ...
  /**
   * how many seconds worth of committed redo ops to re-execute during crash recovery; related to
   * mysql parameter innodb_flush_log_at_trx_commit=0
   *
   * @since ZCS 6.0.0_BETA2
   */
  @ZAttr(id = 1009)
  public static final String A_zimbraRedoLogCrashRecoveryLookbackSec =
  ...
  /**
   * redo.log file rolls over when it goes over this size, even if it does not meet the minimum file
   * age requirement
   *
   * @since ZCS 5.0.17
   */
  @ZAttr(id = 1021)
  public static final String A_zimbraRedoLogRolloverHardMaxFileSizeKB =
  ...
  /**
   * This attribute is used to limit the amount of computation allowed when matching regex
   * expressions. For example as part of the IMAP LIST command. Set to a higher value if legitimate
   * IMAP list commands fail throwing TooManyAccessesToMatchTargetException.
   *
   * @since ZCS 8.0.8,8.5.0
   */
  @ZAttr(id = 1643)
  public static final String A_zimbraRegexMaxAccessesWhenMatching =
   ...
   */
  @ZAttr(id = 3014)
  public static final String A_zimbraRemoteImapSSLServerEnabled =
  ...
  @ZAttr(id = 338)
  public static final String A_zimbraRemoteManagementPrivateKeyPath =
  ...
  /**
   * Expiry time for password reset recovery code. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.8.9
   */
  @ZAttr(id = 2138)
  public static final String A_zimbraResetPasswordRecoveryCodeExpiry =
      "zimbraResetPasswordRecoveryCodeExpiry";

  /**
   * Custom response headers. For example, can be used to add a P3P header for user agents to
   * understand the sites privacy policy. Note: the value MUST be the entire header line (e.g.
   * X-Foo: Bar).
   *
   * @since ZCS 6.0.5
   */
  ...
  /**
   * on - accept_mutex flag &#039;on&#039; for the reverse proxy. This is default. off -
   * accept_mutex flag &#039;off&#039; for the reverse proxy. Turning it off will get much better
  ...
  /**
   * Allowed reverse proxy IP addresses. Lookup servlet will only generate authtokens if request was
   * made from one of these IP addresses
   *
   * @since ZCS 5.0.9
   */
  @ZAttr(id = 697)
  public static final String A_zimbraReverseProxyAdminIPAddress =
   ...
   */
  @ZAttr(id = 700)
  public static final String A_zimbraReverseProxyAdminPortAttribute =
      "zimbraReverseProxyAdminPortAttribute";

  /**
   * wait duration before nginx sending back the NO response for failed imap/pop3 reverse proxy
   * lookups. Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit:
   * [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is
   * not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 569)
  public static final String A_zimbraReverseProxyAuthWaitInterval =
      "zimbraReverseProxyAuthWaitInterval";

  /**
   * The servers to be included in the proxy lookup handlers list. Proxy will only use the servers
   * specified here to do the lookup. Leaving empty means using all the servers whose
   * zimbraReverseProxyLookupTarget is TRUE.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1379)
  public static final String A_zimbraReverseProxyAvailableLookupTargets =
      "zimbraReverseProxyAvailableLookupTargets";

  /**
   * time interval that an entry cached by NGINX will remain in the cache. Must be in valid duration
   * format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s -
   * seconds, d - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.10
  ...
  /**
   * time interval that NGINX proxy will wait for a cache result, before considering the result as a
   * cache miss. Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit:
   * [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is
   * not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 731)
  public static final String A_zimbraReverseProxyCacheFetchTimeout =
      "zimbraReverseProxyCacheFetchTimeout";

  /**
   * time interval that NGINX proxy will wait before attempting to re-establish a connection to a
   * memcache server that disconnected. Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 730)
  public static final String A_zimbraReverseProxyCacheReconnectInterval =
   ...
   */
  @ZAttr(id = 1200)
  public static final String A_zimbraReverseProxyClientCertMode =
      "zimbraReverseProxyClientCertMode";

  /**
   * Time interval after which NGINX mail proxy will disconnect while establishing an upstream
   * IMAP/POP connection. Must be in valid duration format: {digits}{time-unit}. digits: 0-9,
   * time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time
   * unit is not specified, the default is s(seconds).
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 797)
  public static final String A_zimbraReverseProxyConnectTimeout =
      "zimbraReverseProxyConnectTimeout";

  /**
   * The default realm that will be used by NGINX mail proxy, when the realm is not specified in
  ...
  /**
   * Control whether force the server side do the DNS lookup and send the result IP back to proxy.
   * If set false, the raw address configured (e.g. zimbraMailHost) is directly sent to proxy.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1384)
  public static final String A_zimbraReverseProxyDnsLookupInServerEnabled =
   ...
   */
  @ZAttr(id = 547)
  public static final String A_zimbraReverseProxyDomainNameAttribute =
   ...
   */
  @ZAttr(id = 545)
  public static final String A_zimbraReverseProxyDomainNameQuery =
   ...
   */
  @ZAttr(id = 546)
  public static final String A_zimbraReverseProxyDomainNameSearchBase =
      "zimbraReverseProxyDomainNameSearchBase";

  /**
   * the URL of customized proxy error handler. If set, when errors happen in proxy, proxy will
   * redirect to this URL with two paras - err: error code; up: the addr of upstream server
   * connecting to which the error happens
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1332)
  public static final String A_zimbraReverseProxyErrorHandlerURL =
      "zimbraReverseProxyErrorHandlerURL";

  /**
   * Whether nginx will match exact server version against the version received in the client
   * request (in ZM_AUTH_TOKEN). Defaults to on. Setting this to off will make nginx compare only
   * the major and minor server versions (eg. all 8.5.x will be treated same by nginx)
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1616)
  public static final String A_zimbraReverseProxyExactServerVersionCheck =
      "zimbraReverseProxyExactServerVersionCheck";

  /**
   * During migrations Nginx lookup handler rewrites non-qualified username to fully qualified
   * breaking proxy to external legacy mail platform. When zimbraReverseProxyUseExternalRoute is set
   * to TRUE and zimbraReverseProxyExternalRouteIncludeOriginalAuthusername is set to FALSE nginx
   * lookup handler drops the domain name from the userAccount and returns just the username.
   *
   * @since ZCS 8.0.5
   */
  @ZAttr(id = 1454)
  public static final String A_zimbraReverseProxyExternalRouteIncludeOriginalAuthusername =
      "zimbraReverseProxyExternalRouteIncludeOriginalAuthusername";

  /**
   * Control whether to generate per virtual hostname nginx configuration. This would be helpful
   * when multiple virtual host names are defined, but they are actually share the same
   * configuration (like ssl cert, client CA, ...). This attr has to be set as &quot;TRUE&quot; to
   * enable the features like cert per domain.
   *
   * @since ZCS 7.2.0
   */
  @ZAttr(id = 1374)
  public static final String A_zimbraReverseProxyGenConfigPerVirtualHostname =
   ...
   */
  @ZAttr(id = 632)
  public static final String A_zimbraReverseProxyHttpPortAttribute =
   ...
   */
  @ZAttr(id = 1359)
  public static final String A_zimbraReverseProxyHttpSSLPortAttribute =
   ...
   */
  @ZAttr(id = 719)
  public static final String A_zimbraReverseProxyImapEnabledCapability =
   ...
   */
  @ZAttr(id = 713)
  public static final String A_zimbraReverseProxyImapExposeVersionOnBanner =
      "zimbraReverseProxyImapExposeVersionOnBanner";

  /** attribute that contains imap bind port */
  @ZAttr(id = 479)
  public static final String A_zimbraReverseProxyImapPortAttribute =
   ...
   */
  @ZAttr(id = 643)
  public static final String A_zimbraReverseProxyImapSaslGssapiEnabled =
   ...
   */
  @ZAttr(id = 728)
  public static final String A_zimbraReverseProxyImapSaslPlainEnabled =
      "zimbraReverseProxyImapSaslPlainEnabled";

  /** attribute that contains imap bind port for SSL */
  @ZAttr(id = 480)
  public static final String A_zimbraReverseProxyImapSSLPortAttribute =
      "zimbraReverseProxyImapSSLPortAttribute";

  /**
   * on - on the plain IMAP port, starttls is allowed off - no starttls is offered on plain port
   * only - you have to use starttls before clear text login
   *
   * @since ZCS 5.0.5
   */
  @ZAttr(id = 641)
  public static final String A_zimbraReverseProxyImapStartTlsMode =
      "zimbraReverseProxyImapStartTlsMode";

  /**
   * Deprecated since: 8.0.0. deprecated in favor of local config &quot;imap_max_idle_time&quot;,
   * &quot;pop3_max_idle_time&quot;, &quot;imap_authenticated_max_idle_time&quot; in bug 59685. Orig
   * desc: Time interval after which NGINX mail proxy will disconnect an inactive IMAP/POP
   * connection. Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit:
   * [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is
   * not specified, the default is s(seconds).
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 735)
  public static final String A_zimbraReverseProxyInactivityTimeout =
      "zimbraReverseProxyInactivityTimeout";

  /**
   * Sets the upper limit on logins from a remote IP via IMAP to this proxy server after which login
   * is rejected with an IMAP bye response. This counter is cumulative for all users that appear to
   * the proxy to be logging in from the same IP address and IMAP/IMAPS protocol. If multiple users
   * appear to the proxy to be logging in from the same IP address (usual with NATing), then each of
   * the different users login will contribute to increasing the hit counter for the IP address and
   * IMAP combination, and when the counter eventually exceeds the limit, then the connections from
   * that IP address will be throttled for IMAP/IMAPS only. Therefore, all IMAP users from the same
   * IP will contribute to (and be affected by) this counter. If this value is set to 0, then the
   * value of zimbraReverseProxyIPLoginLimit will be used to determine possible throttling behavior
   * for the IMAP protocol.
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 2996)
  public static final String A_zimbraReverseProxyIPLoginImapLimit =
      "zimbraReverseProxyIPLoginImapLimit";

  /**
   * Sets the time-to-live for the hit counter for IP based IMAP login throttling. If time is set to
   * 3600 and limit is set to 1000, then it means that NGINX should not allow more than 1000 users
   * to log in via the proxy from the same IP, within the time interval of an hour. The semantics
   * for such a configuration would then be: allow maximum 1000 users per hour from any given IP
   * address.
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 2997)
  public static final String A_zimbraReverseProxyIPLoginImapLimitTime =
      "zimbraReverseProxyIPLoginImapLimitTime";

  /**
   * Sets the upper limit on logins from a remote IP via POP or IMAP to this proxy server after
   * which login is rejected with an appropriate protocol specific bye response. This counter is
   * cumulative for all users that appear to the proxy to be logging in from the same IP address. If
   * multiple users appear to the proxy to be logging in from the same IP address (usual with
   * NATing) and protocol, then each of the different users login will contribute to increasing the
   * hit counter for that IP address and protocol combination, and when the counter eventually
   * exceeds the limit, then the connections from that IP address will be throttled for that
   * protocol. Therefore, all users from the same IP will contribute to (and be affected by) this
   * counter. Logins using all protocols (POP3/POP3S/IMAP/IMAPS) will affect this counter but each
   * protocol will have it&#039;s own limit counter. If this value is set to 0, then no limiting
   * will take place for any IP unless it is overridden with zimbraReverseProxyIPLoginPop3Limit or
   * zimbraReverseProxyIPLoginImapLimit. Note: If the protocol specific configuration items
   * (zimbraReverseProxyIPLoginPop3Limit, zimbraReverseProxyIPLoginImapLimit) are set to a non-zero
   * positive value then this option will not apply to those protocols.
   *
   * @since ZCS 5.0.3
   */
  @ZAttr(id = 622)
  ...
  /**
   * Sets the time-to-live for the hit counter for IP based login throttling. If time is set to 3600
   * and limit is set to 1000, then it means that NGINX should not allow more than 1000 users to log
   * in via the proxy from the same IP, within the time interval of an hour. The semantics for such
   * a configuration would then be: allow maximum 1000 users per hour from any given IP address.
   *
   * @since ZCS 5.0.3
   */
  @ZAttr(id = 623)
  public static final String A_zimbraReverseProxyIPLoginLimitTime =
      "zimbraReverseProxyIPLoginLimitTime";

  /**
   * Sets the upper limit on logins from a remote IP via POP3 to this proxy server after which login
   * is rejected with an appropriate POP3 bye response. This counter is cumulative for all users
   * that appear to the proxy to be logging in from the same IP address for the POP3/POP3S protocol.
   * If multiple users appear to the proxy to be logging in from the same IP address (usual with
   * NATing), then each of the different users login will contribute to increasing the hit counter
   * for that IP address, and when the counter eventually exceeds the limit, then the connections
   * from that IP address will be throttled for POP3/POP3S. Therefore, all users from the same IP
   * will contribute to (and be affected by) this counter. If this value is set to 0, then the value
   * of zimbraReverseProxyIPLoginLimit will be used to determine possible throttling behavior for
   * the POP3 protocol.
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 2998)
  public static final String A_zimbraReverseProxyIPLoginPop3Limit =
      "zimbraReverseProxyIPLoginPop3Limit";

  /**
   * Sets the time-to-live for the hit counter for IP based POP3 login throttling. If time is set to
   * 3600 and limit is set to 1000, then it means that NGINX should not allow more than 1000 users
   * to log in via the proxy from the same IP, within the time interval of an hour. The semantics
   * for such a configuration would then be: allow maximum 1000 users per hour from any given IP
   * address.
   ...
   */
  @ZAttr(id = 2999)
  public static final String A_zimbraReverseProxyIPLoginPop3LimitTime =
      "zimbraReverseProxyIPLoginPop3LimitTime";

  /**
   * The error message with which a connection attempt from an IP address will be throttled, if the
   * connection count exceeds the configured limit
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 727)
  ...
  /**
   * Client IP/IPRange whitelist for exclusion from IP throttling. Value may be either an IP or an
   * IPRange in CIDR notation e.g:192.168.1.0/24. IPV6 is supported as well.
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 3000)
  public static final String A_zimbraReverseProxyIPThrottleWhitelist =
      "zimbraReverseProxyIPThrottleWhitelist";

  /**
   * Sets the time-to-live for mail_whitelist_ip_ttl in nginx. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 3007)
  public static final String A_zimbraReverseProxyIPThrottleWhitelistTime =
  ...
  /**
   * whether this server is a valid upstream and needs to be included in the upstream config of the
   * reverse proxy
   */
  @ZAttr(id = 504)
  ...
  @ZAttr(id = 474)
  public static final String A_zimbraReverseProxyMailHostAttribute =
  ...
  @ZAttr(id = 473)
  public static final String A_zimbraReverseProxyMailHostSearchBase =
   ...
   */
  @ZAttr(id = 1621)
  public static final String A_zimbraReverseProxyMailImapEnabled =
   ...
   */
  @ZAttr(id = 1622)
  public static final String A_zimbraReverseProxyMailImapsEnabled =
      "zimbraReverseProxyMailImapsEnabled";

  /**
   * whether to run proxy in HTTP, HTTPS, both, mixed, or redirect mode. See also related attributes
   * zimbraMailProxyPort and zimbraMailSSLProxyPort
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 685)
   ...
   */
  @ZAttr(id = 1623)
  public static final String A_zimbraReverseProxyMailPop3Enabled =
   ...
   */
  @ZAttr(id = 1624)
  public static final String A_zimbraReverseProxyMailPop3sEnabled =
      "zimbraReverseProxyMailPop3sEnabled";

  /**
   * whether NGINX mail proxy will pass upstream server errors back to the downstream email clients
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 736)
   ...
   */
  @ZAttr(id = 721)
  public static final String A_zimbraReverseProxyPop3EnabledCapability =
   ...
   */
  @ZAttr(id = 712)
  public static final String A_zimbraReverseProxyPop3ExposeVersionOnBanner =
      "zimbraReverseProxyPop3ExposeVersionOnBanner";

  /** attribute that contains pop3 bind port */
  @ZAttr(id = 477)
  public static final String A_zimbraReverseProxyPop3PortAttribute =
   ...
   */
  @ZAttr(id = 644)
  public static final String A_zimbraReverseProxyPop3SaslGssapiEnabled =
   ...
   */
  @ZAttr(id = 729)
  public static final String A_zimbraReverseProxyPop3SaslPlainEnabled =
      "zimbraReverseProxyPop3SaslPlainEnabled";

  /** attribute that contains pop3 bind port for SSL */
  @ZAttr(id = 478)
  public static final String A_zimbraReverseProxyPop3SSLPortAttribute =
      "zimbraReverseProxyPop3SSLPortAttribute";

  /**
   * on - on the plain POP3 port, starttls is allowed off - no starttls is offered on plain port
   * only - you have to use starttls before clear text login
   *
   * @since ZCS 5.0.5
   */
  @ZAttr(id = 642)
  public static final String A_zimbraReverseProxyPop3StartTlsMode =
  ...
  @ZAttr(id = 476)
  public static final String A_zimbraReverseProxyPortSearchBase =
   ...
   * that will enforce SSL usage on the client side. Note: the value MUST be the entire header line
   * (e.g. X-Foo: Bar, X-Zoo: &quot;Bar1; Bar2&quot;).
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1973)
  public static final String A_zimbraReverseProxyResponseHeaders =
      "zimbraReverseProxyResponseHeaders";

  /**
   * Time interval after which NGINX will fail over to the next route lookup handler, if a handler
   ...
   */
  @ZAttr(id = 745)
  public static final String A_zimbraReverseProxyRouteLookupTimeout =
      "zimbraReverseProxyRouteLookupTimeout";

  /**
   * Time interval (ms) given to mail route lookup handler to cache a failed response to route a
   * previous lookup request (after this time elapses, Proxy retries this host). Must be in valid
   * duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   ...
   */
  @ZAttr(id = 778)
  public static final String A_zimbraReverseProxyRouteLookupTimeoutCache =
  ...
  /**
   * Enable the use of Server Name Indication (SNI) TLS extension in the proxy. When set to TRUE,
   * and using SNI capable clients, there is no need for a separate IP address per domain
  ...
  /**
   * permitted ciphers for reverse proxy. Ciphers are in the formats supported by OpenSSL e.g.
   * ALL:!ADH:!EXPORT56:RC4+RSA:+HIGH:+MEDIUM:+LOW:+SSLv2:+EXP; if not set, default ciphers
   * permitted by nginx will apply
   *
   * @since ZCS 5.0.5
   */
  @ZAttr(id = 640)
  ...
  /**
   * SSL session cache size in megabytes. Need to have &#039;m&#039; (for megabytes) suffix at the
   * end
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 1680)
  public static final String A_zimbraReverseProxySSLSessionCacheSize =
      "zimbraReverseProxySSLSessionCacheSize";

  /**
   * SSL session timeout value for the proxy in minutes. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 1679)
  public static final String A_zimbraReverseProxySSLSessionTimeout =
      "zimbraReverseProxySSLSessionTimeout";

  /**
   * If set as TRUE, proxy will use SSL to connect to the upstream mail servers for web and mail
   * proxy. Note admin console proxy always use https no matter how this attr is set.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1360)
  public static final String A_zimbraReverseProxySSLToUpstreamEnabled =
      "zimbraReverseProxySSLToUpstreamEnabled";

  /**
   * Configure the default server block in &#039;nginx.conf.web.https?.default.template&#039; to
   * return a default HTTP response for all unconfigured host names. See also related attributes
   * &#039;zimbraVirtualHostname&#039; and &#039;zimbraVirtualIPAddress&#039;.
   *
   * @since ZCS 8.8.6
   */
  @ZAttr(id = 3020)
  public static final String A_zimbraReverseProxyStrictServerNameEnabled =
      "zimbraReverseProxyStrictServerNameEnabled";

  /**
   * The connect timeout is the time interval after which NGINX will disconnect while establishing
   * an upstream HTTP connection. Measured in seconds, should not be more than 75 seconds.
   *
   * @since ZCS 8.0.4
   */
  @ZAttr(id = 1440)
  public static final String A_zimbraReverseProxyUpstreamConnectTimeout =
      "zimbraReverseProxyUpstreamConnectTimeout";

  /**
   * The servers running mailbox with EWS functionality to be included in the &quot;ews&quot; block
   * in the nginx web proxy config file
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1595)
  public static final String A_zimbraReverseProxyUpstreamEwsServers =
      "zimbraReverseProxyUpstreamEwsServers";

  /**
   * Configures the &#039;upstream_fair_shm_size&#039; value used by Nginx to set the size of shared
   * memory for storing information about the busy-ness of backends. Values are in kilobytes.
   *
   * @since ZCS 8.8.1
   */
  @ZAttr(id = 3017)
  public static final String A_zimbraReverseProxyUpstreamFairShmSize =
      "zimbraReverseProxyUpstreamFairShmSize";

  /**
   * The pool of servers that are available to the proxy for handling IMAP sessions. If empty, the
   * NginxLookupExtension will select the mailbox server that hosts the account.
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 3008)
  public static final String A_zimbraReverseProxyUpstreamImapServers =
      "zimbraReverseProxyUpstreamImapServers";

  /**
   * The servers to be included in the login block in the nginx web proxy config file. The servers
   * configured here will only affect the proxy of login URL requests.
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1603)
  public static final String A_zimbraReverseProxyUpstreamLoginServers =
      "zimbraReverseProxyUpstreamLoginServers";

  /**
   * The read timeout for long polling support by proxy, e.g. ActiveSync for mobile devices. . Must
   * be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours,
   * m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the
   * default is s(seconds).
   *
   ...
   */
  @ZAttr(id = 1337)
  public static final String A_zimbraReverseProxyUpstreamPollingTimeout =
      "zimbraReverseProxyUpstreamPollingTimeout";

  /**
   * The read timeout for the response of upstream server, which determines how long nginx will wait
   * to get the response to a request. . Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 7.1.4
   */
  @ZAttr(id = 1335)
  public static final String A_zimbraReverseProxyUpstreamReadTimeout =
      "zimbraReverseProxyUpstreamReadTimeout";

  /**
   * The send timeout of transfering a request to the upstream server. If after this time the
   * upstream server doesn&#039;t take new data, proxy will close the connection. . Must be in valid
   * duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   ...
   */
  @ZAttr(id = 1336)
  public static final String A_zimbraReverseProxyUpstreamSendTimeout =
      "zimbraReverseProxyUpstreamSendTimeout";

  /**
   * Deprecated since: 8.5.0. Configuration for pre-login upstream is now handled via
   * zimbraReverseProxyUpstreamLoginServers. Post-login upstreams are now automatically configured
   * per-webapp based on what is present in zimbraServiceEnabled.. Orig desc: The servers to be
   * included in the &quot;upstream&quot; block in the nginx web proxy config file. The servers
   * configured here will only affect the proxy of pre-login requests. Leaving empty means using all
   * the servers whose zimbraReverseProxyLookupTarget is TRUE.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1378)
  public static final String A_zimbraReverseProxyUpstreamServers =
      "zimbraReverseProxyUpstreamServers";

  /**
   * There is a deployment scenario for migrations where all of the customers users are pointed at
   * the zimbra POP IMAP reverse proxy. We then want their connections proxied back to the legacy
   * system for not-yet-non-migrated users. If this attribute is TRUE, reverse proxy lookup servlet
   * should check to see if zimbraExternal* is set on the domain. If so it is used. If not, lookup
   * proceeds as usual.
   *
   * @since ZCS 5.0.12
   */
  @ZAttr(id = 779)
  public static final String A_zimbraReverseProxyUseExternalRoute =
      "zimbraReverseProxyUseExternalRoute";

  /**
   * Use external route configured on domain if account cannot be found. Also see
   * zimbraReverseProxyUseExternalRoute.
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1132)
  public static final String A_zimbraReverseProxyUseExternalRouteIfAccountNotExist =
      "zimbraReverseProxyUseExternalRouteIfAccountNotExist";

  /**
   * Limit how many times a user can login via the proxy. Setting limit to 100 and time to 3600
   * means: allow maximum 100 logins per hour for any user. As with the ip counterparts, the user
   * hit counter and timeout are cumulative for all protocols. Also, for a given users login, both
   * counters are checked in succession, with the IP counter being checked first. A login may be
   * rejected (throttled) because the IP is over-usage, or because the login name itself is
   * over-usage. A value of 0 indicates that no throttling will take place for any user.
   *
   * @since ZCS 5.0.3
   */
  @ZAttr(id = 624)
  public static final String A_zimbraReverseProxyUserLoginLimit =
      "zimbraReverseProxyUserLoginLimit";

  /**
   * Sets the time-to-live for the hit counter for per user login throttling.
   *
   * @since ZCS 5.0.3
   */
  @ZAttr(id = 625)
  public static final String A_zimbraReverseProxyUserLoginLimitTime =
   ...
   */
  @ZAttr(id = 572)
  public static final String A_zimbraReverseProxyUserNameAttribute =
      "zimbraReverseProxyUserNameAttribute";

  /**
   * The error message with which a login attempt by a user will be throttled, if the attempt count
   * exceeds the configured limit
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 726)
  public static final String A_zimbraReverseProxyUserThrottleMsg =
      "zimbraReverseProxyUserThrottleMsg";

  /**
   * Maximum number of connections that an NGINX Proxy worker process is allowed to handle
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 725)
  public static final String A_zimbraReverseProxyWorkerConnections =
   ...
   */
  @ZAttr(id = 724)
  public static final String A_zimbraReverseProxyWorkerProcesses =
   ...
   */
  @ZAttr(id = 2065)
  public static final String A_zimbraReverseProxyXmppBoshEnabled =
      "zimbraReverseProxyXmppBoshEnabled";

  /**
   * Hostname of the external XMPP server where XMPP over BOSH requests need to be proxied
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1959)
  public static final String A_zimbraReverseProxyXmppBoshHostname =
      "zimbraReverseProxyXmppBoshHostname";
   ...
   */
  @ZAttr(id = 1957)
  public static final String A_zimbraReverseProxyXmppBoshLocalHttpBindURL =
      "zimbraReverseProxyXmppBoshLocalHttpBindURL";

  /**
   * Port number of the external XMPP server where XMPP over BOSH requests need to be proxied
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1960)
  ...
  /**
   * Remote HTTP-BIND URL prefix for an external XMPP server where XMPP over BOSH requests need to
   * be proxied. This needs to be configured only if its different from
   * zimbraReverseProxyXmppBoshLocalHttpBindURL
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1958)
  public static final String A_zimbraReverseProxyXmppBoshRemoteHttpBindURL =
      "zimbraReverseProxyXmppBoshRemoteHttpBindURL";
  ...
  /**
   * the response timeout for an external XMPP/BOSH server. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2064)
  public static final String A_zimbraReverseProxyXmppBoshTimeout =
   ...
   */
  @ZAttr(id = 1785)
  public static final String A_zimbraReverseProxyZmlookupCachingEnabled =
      "zimbraReverseProxyZmlookupCachingEnabled";

  /**
   * whether or not to revoke app-specific passwords when the main password is changed
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1838)
  public static final String A_zimbraRevokeAppSpecificPasswordsOnPasswordChange =
  ...
  /**
   * The initial retry delay for the exponential backoff algorithm. Must be in valid duration
   * format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s -
   * seconds, d - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2069)
  public static final String A_zimbraScheduledTaskInitialRetryDelay =
      "zimbraScheduledTaskInitialRetryDelay";

  /**
   * The maximum number of times a scheduled task can be retried upon failure. A value of 0 means no
   * maximum
   *
   * @since ZCS 8.7.0,9.0.0
   */
  ...
  /**
   * The maximum retry delay for the exponential backoff algorithm, or 0 for no maximum. Must be in
   * valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   ...
   */
  @ZAttr(id = 2070)
  public static final String A_zimbraScheduledTaskMaxRetryDelay =
  ...
  /**
   * The algorithm for determining how long the task scheduler should delay a task attempt upon
   * failure
   *
   * @since ZCS 8.7.0,9.0.0
   */
  ...
  /**
   * Deprecated since: 5.0. deprecated in favor of the serverInherited flag. Orig desc: zimbraServer
   * attrs that get inherited from global config
   */
  @ZAttr(id = 62)
  ...
  /**
   * Deprecated since: 8.0.0. Manual publishing of shares by admin is no longer required since now
   * automated publishing of sharing info updates to LDAP is supported. Orig desc: items an account
   * or group has shared
   */
  @ZAttr(id = 357)
  ...
  /**
   * Maximum allowed lifetime of shares to internal users or groups. A value of 0 indicates that
   * there&#039;s no limit on an internal share&#039;s lifetime. . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.0.0
   ...
   */
  @ZAttr(id = 1343)
  public static final String A_zimbraShareNotificationMtaAuthAccount =
   ...
   */
  @ZAttr(id = 1344)
  public static final String A_zimbraShareNotificationMtaAuthPassword =
   ...
   */
  @ZAttr(id = 1346)
  public static final String A_zimbraShareNotificationMtaAuthRequired =
   ...
   */
  @ZAttr(id = 1345)
  public static final String A_zimbraShareNotificationMtaConnectionType =
   ...
   */
  @ZAttr(id = 1361)
  public static final String A_zimbraShareNotificationMtaEnabled =
      "zimbraShareNotificationMtaEnabled";

  /**
   * SMTP hostname for share notification MTA used for sending email notifications.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1341)
  public static final String A_zimbraShareNotificationMtaHostname =
      "zimbraShareNotificationMtaHostname";

  /**
   * SMTP port for share notification MTA used for sending email notifications.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1342)
  ...
  /**
   * Interval between successive executions of the task that publishes shared item updates to LDAP.
   * Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h -
   * hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified,
   * the default is s(seconds).
   *
   ...
   */
  @ZAttr(id = 1220)
  public static final String A_zimbraSharingUpdatePublishInterval =
   ...
   * If value is 0, the cache is disabled. The cache is particularly useful when significant use is
   * made of delegated administration. This cache can improve performance by avoiding recomputing
   * All Effective Rights of named entries like accounts frequently in a short period of time. All
   * Effective Rights are computations of the rights that named entries like accounts have -
   * although when used, they are checked separately. The longer the value of this setting is, the
   * more stale the view of the details is likely to be. For this reason, the maximum accepted value
   * is 30m. Larger values will be treated as being 30m . Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 1903)
  public static final String A_zimbraShortTermAllEffectiveRightsCacheExpiration =
      "zimbraShortTermAllEffectiveRightsCacheExpiration";

  /**
   * Maximum number of entries in the short term All Effective Rights cache. This cache can improve
   * performance by avoiding recomputing All Effective Rights of named entries like accounts
   * frequently in a short period of time. Can disable the cache be specifying a value of 0
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 1902)
  public static final String A_zimbraShortTermAllEffectiveRightsCacheSize =
      "zimbraShortTermAllEffectiveRightsCacheSize";

  /**
   * Maximum time an entry in the Grantee cache will be regarded as valid. If value is 0, the cache
   * is disabled. This cache can improve performance by avoiding recomputing details frequently in a
   * short period of time, for instance for each entry in search results. The cache is particularly
   * useful when significant use is made of delegated administration. Grantees objects provide a
   * view of what rights a grantee has - although those are checked separately. The longer the value
   * of this setting is, the more stale the view of the details is likely to be. For this reason,
   * the maximum accepted value is 30m. Larger values will be treated as being 30m . Must be in
   * valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m -
   * minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified, the default
   * is s(seconds).
   *
   ...
   */
  @ZAttr(id = 1901)
  public static final String A_zimbraShortTermGranteeCacheExpiration =
      "zimbraShortTermGranteeCacheExpiration";

  /**
   * Maximum number of entries in the short term Grantee cache. This cache can improve performance
   * by avoiding recomputing details frequently in a short period of time, for instance for each
   * entry in search results. Can disable the cache be specifying a value of 0
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 1900)
  ...
  /**
   * Whether edit header commands in admin sieve scripts are enabled or disabled. If TRUE, the
   * addheader, deleteheader and replaceheader commands will be executed during admin sieve script
   * execution.
   *
   * @since ZCS 8.8.4
   */
   ...
   */
  @ZAttr(id = 2096)
  public static final String A_zimbraSieveFeatureVariablesEnabled =
  ...
  /**
   * Whether the RFC compliant &#039;notify&#039; is used. If TRUE, ZCS parses the
   * &#039;notify&#039; action parameters based on the syntax defined by the RFC 5435 and 5436. If
   * FALSE, ZCS treats the &#039;notify&#039; action parameters with Zimbra specific format
   *
   * @since ZCS 8.7.8
   */
  @ZAttr(id = 2112)
  public static final String A_zimbraSieveNotifyActionRFCCompliant =
      "zimbraSieveNotifyActionRFCCompliant";

  /**
   * Deprecated since: 8.7.8. deprecated in favor of zimbraSieveRejectMailEnabled, which can be used
   * at account level. Orig desc: Whether to enable the Sieve &quot;reject&quot; action defined in
   * RFC 5429.
   *
   * @since ZCS 8.7.6
   */
  ...
  /**
   * Whether to enable the Sieve &quot;reject&quot; action defined in RFC 5429.
   *
   * @since ZCS 8.7.8
   */
  @ZAttr(id = 2111)
  ...
  /**
   * Whether the declaration of the Sieve extension feature is mandatory by the &#039;require&#039;
   * control. If TRUE, before ZCS evaluates a Sieve extension test or action, it checks the
   * corresponding capability string at &#039;require&#039; control; and if the capability string is
   * not declared in the &#039;require&#039;, the entire Sieve filter execution will be failed. If
   * FALSE, any Sieve extensions can be used without declaring the capability string in the
   * &#039;require&#039; control.
   *
   * @since ZCS 8.8.4
   */
  @ZAttr(id = 2120)
  public static final String A_zimbraSieveRequireControlEnabled =
  ...
  /** minimum number of signatures allowed on an account, this is only used in the client */
  @ZAttr(id = 523)
  ...
  /**
   * LDAP attribute(s) for public key lookup for S/MIME via external LDAP. Multiple attributes can
   * be separated by comma. All SMIME attributes are in the format of {config-name}:{value}. A
   * &#039;SMIME config&#039; is a set of SMIME attribute values with the same {config-name}.
   * Multiple SMIME configs can be configured on a domain or on globalconfig. Note: SMIME attributes
   * on domains do not inherited values from globalconfig, they are not domain-inherited attributes.
   * During SMIME public key lookup, if there are any SMIME config on the domain of the account,
   * they are used. SMIME configs on globalconfig will be used only when there is no SMIME config on
   * the domain. SMIME attributes cannot be modified directly with zmprov md/mcf commands. Use
   * zmprov gcsc/gdsc/mcsc/mdsc/rcsc/rdsc command instead.
   *
   * @since ZCS 7.1.0
   */
  @ZAttr(id = 1182)
  ...
  /**
   * LDAP bind DN for public key lookup for S/MIME via external LDAP. Can be empty for anonymous
   * bind. All SMIME attributes are in the format of {config-name}:{value}. A &#039;SMIME
   * config&#039; is a set of SMIME attribute values with the same {config-name}. Multiple SMIME
   * configs can be configured on a domain or on globalconfig. Note: SMIME attributes on domains do
   * not inherited values from globalconfig, they are not domain-inherited attributes. During SMIME
   * public key lookup, if there are any SMIME config on the domain of the account, they are used.
   * SMIME configs on globalconfig will be used only when there is no SMIME config on the domain.
   * SMIME attributes cannot be modified directly with zmprov md/mcf commands. Use zmprov
  ...
  /**
   * LDAP bind password for public key lookup for S/MIME via external LDAP. Can be empty for
   * anonymous bind. All SMIME attributes are in the format of {config-name}:{value}. A &#039;SMIME
   * config&#039; is a set of SMIME attribute values with the same {config-name}. Multiple SMIME
   * configs can be configured on a domain or on globalconfig. Note: SMIME attributes on domains do
   * not inherited values from globalconfig, they are not domain-inherited attributes. During SMIME
   * public key lookup, if there are any SMIME config on the domain of the account, they are used.
  ...
  /**
   * Whether or not to discover search base DNs if zimbraSMIMELdapSearchBase is not set. Allowed
   * values are TRUE or FALSE. If zimbraSMIMELdapSearchBase is set for a config, this attribute is
   * ignored for the config. If not set, default for the config is FALSE. In that case, if
   * zimbraSMIMELdapSearchBase is not set, the search will default to the rootDSE. If multiple DNs
   * are discovered, the ldap search will use them one by one until a hit is returned. All SMIME
   * attributes are in the format of {config-name}:{value}. A &#039;SMIME config&#039; is a set of
   * SMIME attribute values with the same {config-name}. Multiple SMIME configs can be configured on
   * a domain or on globalconfig. Note: SMIME attributes on domains do not inherited values from
   * globalconfig, they are not domain-inherited attributes. During SMIME public key lookup, if
   * there are any SMIME config on the domain of the account, they are used. SMIME configs on
   * globalconfig will be used only when there is no SMIME config on the domain. SMIME attributes
   * cannot be modified directly with zmprov md/mcf commands. Use zmprov
   * gcsc/gdsc/mcsc/mdsc/rcsc/rdsc command instead.
   *
   * @since ZCS 7.1.1
   */
  @ZAttr(id = 1209)
  public static final String A_zimbraSMIMELdapDiscoverSearchBaseEnabled =
      "zimbraSMIMELdapDiscoverSearchBaseEnabled";

  /**
   * LDAP search filter for public key lookup for S/MIME via external LDAP. Can contain the
   * following conversion variables for expansion: %n - search key with @ (or without, if no @ was
   * specified) %u - with @ removed e.g. (mail=%n) All SMIME attributes are in the format of
   * {config-name}:{value}. A &#039;SMIME config&#039; is a set of SMIME attribute values with the
   * same {config-name}. Multiple SMIME configs can be configured on a domain or on globalconfig.
   * Note: SMIME attributes on domains do not inherited values from globalconfig, they are not
   * domain-inherited attributes. During SMIME public key lookup, if there are any SMIME config on
   * the domain of the account, they are used. SMIME configs on globalconfig will be used only when
   * there is no SMIME config on the domain. SMIME attributes cannot be modified directly with
   * zmprov md/mcf commands. Use zmprov gcsc/gdsc/mcsc/mdsc/rcsc/rdsc command instead.
   *
   * @since ZCS 7.1.0
   */
  @ZAttr(id = 1181)
  ...
  /**
   * LDAP search base for public key lookup for S/MIME via external LDAP. All SMIME attributes are
   * in the format of {config-name}:{value}. A &#039;SMIME config&#039; is a set of SMIME attribute
   * values with the same {config-name}. Multiple SMIME configs can be configured on a domain or on
   * globalconfig. Note: SMIME attributes on domains do not inherited values from globalconfig, they
   * are not domain-inherited attributes. During SMIME public key lookup, if there are any SMIME
   * config on the domain of the account, they are used. SMIME configs on globalconfig will be used
   * only when there is no SMIME config on the domain. SMIME attributes cannot be modified directly
   * with zmprov md/mcf commands. Use zmprov gcsc/gdsc/mcsc/mdsc/rcsc/rdsc command instead.
   *
   * @since ZCS 7.1.0
   */
  @ZAttr(id = 1180)
  ...
  /**
   * Whether to use startTLS for public key lookup for S/MIME via external LDAP. All SMIME
   * attributes are in the format of {config-name}:{value}. A &#039;SMIME config&#039; is a set of
   * SMIME attribute values with the same {config-name}. Multiple SMIME configs can be configured on
   * a domain or on globalconfig. Note: SMIME attributes on domains do not inherited values from
   * globalconfig, they are not domain-inherited attributes. During SMIME public key lookup, if
  ...
  /**
   * LDAP URL(s) for public key lookup for S/MIME via external LDAP. Multiple URLs for error
   * fallback purpose can be separated by space. All SMIME attributes are in the format of
   * {config-name}:{value}. A &#039;SMIME config&#039; is a set of SMIME attribute values with the
   * same {config-name}. Multiple SMIME configs can be configured on a domain or on globalconfig.
   * Note: SMIME attributes on domains do not inherited values from globalconfig, they are not
   * domain-inherited attributes. During SMIME public key lookup, if there are any SMIME config on
   ...
   */
  @ZAttr(id = 2100)
  public static final String A_zimbraSmimePublicCertificateExtensions =
   ...
   */
  @ZAttr(id = 2099)
  public static final String A_zimbraSmimeUserCertificateExtensions =
  ...
  /**
   * If TRUE, the address for MAIL FROM in the SMTP session will always be set to the email address
   * of the account. If FALSE, the address will be the value of the Sender or From header in the
   * outgoing message, in that order.
   *
   * @since ZCS 6.0.5
   */
  @ZAttr(id = 1077)
  ...
  /**
   * If true, an X-Authenticated-User header will be added to messages sent via SendMsgRequest.
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 747)
  public static final String A_zimbraSmtpSendAddAuthenticatedUser =
  ...
  /** Whether X-Originating-IP will be added to messages sent via SendMsgRequest. */
  @ZAttr(id = 435)
  ...
  /**
   * If TRUE, enables support for GetVersionInfo for account SOAP requests. If FALSE,
   * GetVersionInfoRequest returns a SOAP fault.
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 708)
  ...
  /**
   * If TRUE, spam messages will be affected by user and admin mail filters instead of being
   * automatically filed into the Junk folder.
   *
   * @since ZCS 5.0.2
   */
  @ZAttr(id = 604)
  ...
  /**
   * Deprecated since: 4.5. Deprecated in favor of zimbraServiceEnabled. Orig desc: Whether to
  ...
  /** When user classifies a message as not spam forward message via SMTP to this account */
  @ZAttr(id = 245)
  public static final String A_zimbraSpamIsNotSpamAccount = "zimbraSpamIsNotSpamAccount";

  /** When user classifies a message as spam forward message via SMTP to this account */
  @ZAttr(id = 244)
  ...
  /**
   * Aliases of Trash folder. In case some IMAP clients use different folder names other than Trash,
   * the spam filter still special-cases those folders as if they are Trash.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1167)
  ...
  /**
   * Mail header name for flagging a message as not spam. If set, this takes precedence over
   * zimbraSpamHeader.
   *
   * @since ZCS 7.1.3
   */
  ...
  /**
   * regular expression for matching the value of zimbraSpamWhitelistHeader for flagging a message
   * as not spam
   *
   * @since ZCS 7.1.3
   */
  ...
  /**
   * The list of available dictionaries that can be used for spell checking.
   *
   * @since ZCS 6.0.0_GA
   */
  @ZAttr(id = 1042)
  ...
  /**
   * URL of the server running the spell checking service. Multi-valued attribute that allows
   * multiple spell check servers to be specified. If the request to the first server fails, a
   * request to the second server is sent and so on.
   */
  @ZAttr(id = 267)
  ...
  /**
   * Specifies the JedisPool size used by SSDBEphemeralStore. Higher pool sizes allow for more
   * simultaneous connections to SSDB. A value of 0 will cause the pool size to be unlimited.
   *
   * @since ZCS 8.7.6
   */
  @ZAttr(id = 3010)
  ...
  /**
   * Specifies the amount of time a thread will wait for a JedisPool resource. A value of 0 will
   * cause the thread to block indefinitely.. Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.7.6
  ...
  /** Public key of this server, used by other hosts to authorize this server to login. */
  @ZAttr(id = 262)
  ...
  /**
   * List of included cipher suites for Jetty. If any value is set only these ciphers will be used,
   * in effect superseding zimbraSSLExcludeCipherSuites. Order of selection is based on client
   * preference and default Java order since Java SSLEngine does not allow changing the preference
   * order.
   *
   * @since ZCS 8.5.0
   */
  ...
  /**
   * description of the custom tab in the Preferences page in HTML client in the format
   * {tab-name},{associated-URL}
   *
   * @since ZCS 7.1.3
   */
  @ZAttr(id = 1267)
  public static final String A_zimbraStandardClientCustomPrefTab =
      "zimbraStandardClientCustomPrefTab";

  /**
   * whether extra custom tabs in the Preferences page in HTML client are enabled
   *
   * @since ZCS 7.1.3
   */
  @ZAttr(id = 1266)
  public static final String A_zimbraStandardClientCustomPrefTabsEnabled =
      "zimbraStandardClientCustomPrefTabsEnabled";

  /**
   * Prefixes of thread names. Each value is a column in threads.csv that tracks the number of
   * threads whose name starts with the given prefix.
   *
   * @since ZCS 6.0.0_BETA1
   */
  @ZAttr(id = 792)
  ...
  /**
   * The maximum batch size for each ZimbraSync transaction. Default value of 0 means to follow
   * client requested size. If set to any positive integer, the value will be the maximum number of
   * items to sync even if client requests more. This setting affects all sync categories including
  ...
  /**
   * Deprecated since: 4.5.7. We now maintain all tables unconditionally. See bug 19145. Orig desc:
   * table maintenance will be performed if the number of rows grows by this factor
   */
  @ZAttr(id = 171)
  public static final String A_zimbraTableMaintenanceGrowthFactor =
      "zimbraTableMaintenanceGrowthFactor";

  /**
   * Deprecated since: 4.5.7. We now maintain all tables unconditionally. See bug 19145. Orig desc:
   * maximum number of rows required for database table maintenance
   */
  @ZAttr(id = 169)
  ...
  /**
   * Deprecated since: 4.5.7. We now maintain all tables unconditionally. See bug 19145. Orig desc:
   * minimum number of rows required for database table maintenance
   */
  @ZAttr(id = 168)
  ...
  /**
   * Deprecated since: 4.5.7. We now maintain all tables unconditionally. See bug 19145. Orig desc:
   * table maintenance operation that will be performed. Valid options: &quot;ANALYZE&quot;,
   * &quot;OPTIMIZE&quot;
   */
  @ZAttr(id = 170)
  public static final String A_zimbraTableMaintenanceOperation = "zimbraTableMaintenanceOperation";

  /** The registered name of the Zimbra Analyzer Extension for this account to use */
  @ZAttr(id = 393)
  public static final String A_zimbraTextAnalyzer = "zimbraTextAnalyzer";

  /**
   * Whether or not Jetty thread monitor is enabled. Used for debugging Jetty, not recommended for
   * extended use in production environment. Defaults to FALSE
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1583)
  ...
  /**
   * Hosts to ignore during IP based throttling. Account and command rate limits will still be
   * applied. Typically should list nginx hostname and any other mailbox servers which can proxy to
   * this server
   *
   * @since ZCS 8.0.0
   */
  ...
  /**
   * Hosts to whitelist during IP based throttling. Account and command rate limits will not be
   * applied. This should only be used for internal servers which cannot service end user traffic;
   * e.g. migration or monitoring hosts
   *
   * @since ZCS 8.0.5
   */
  @ZAttr(id = 1449)
  ...
  /** Deprecated since: 5.0. Deprecated as of bug 12416. Orig desc: Start date for daylight time */
  @ZAttr(id = 232)
  public static final String A_zimbraTimeZoneDaylightDtStart = "zimbraTimeZoneDaylightDtStart";

  /** Deprecated since: 5.0. Deprecated as of bug 12416. Orig desc: Offset in daylight time */
  @ZAttr(id = 233)
  public static final String A_zimbraTimeZoneDaylightOffset = "zimbraTimeZoneDaylightOffset";

  /**
   * Deprecated since: 5.0. Deprecated as of bug 12416. Orig desc: iCalendar recurrence rule for
   * onset of daylight time
   */
  @ZAttr(id = 234)
  public static final String A_zimbraTimeZoneDaylightRRule = "zimbraTimeZoneDaylightRRule";

  /** Deprecated since: 5.0. Deprecated as of bug 12416. Orig desc: Start date for standard time */
  @ZAttr(id = 229)
  public static final String A_zimbraTimeZoneStandardDtStart = "zimbraTimeZoneStandardDtStart";

  /** Deprecated since: 5.0. Deprecated as of bug 12416. Orig desc: Offset in standard time */
  @ZAttr(id = 230)
  public static final String A_zimbraTimeZoneStandardOffset = "zimbraTimeZoneStandardOffset";

  /**
   * Deprecated since: 5.0. Deprecated as of bug 12416. Orig desc: iCalendar recurrence rule for
   * onset of standard time
   */
  @ZAttr(id = 231)
   ...
   */
  @ZAttr(id = 1433)
  public static final String A_zimbraTouchJSErrorTrackingEnabled =
  ...
  /**
   * Lifetime of auth tokens provisioned for completing the 2nd stage of enabling two-factor
   * authentication. Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit:
   * [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is
   * not specified, the default is s(seconds).
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2026)
  public static final String A_zimbraTwoFactorAuthEnablementTokenLifetime =
      "zimbraTwoFactorAuthEnablementTokenLifetime";

  /**
   * Hash algorithm used in TOTP generation. SHA1 is the current accepted standard per RFC 6238.
   * Only consider changing this to another hashing function when working with authenticators that
   * deviate from this standard.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1825)
  public static final String A_zimbraTwoFactorAuthHashAlgorithm =
      "zimbraTwoFactorAuthHashAlgorithm";

  /**
   * Timestamp of the last time that two-factor authentication data was cleared on the COS. When
   * this timestamp exceeds the timestamp of the shared secret, the server knows to disable
   * two-factor authentication on the account and delete all associated data.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2058)
  ...
  /**
   * this attribute contains the timestamps of each of the consecutive second factor authentication
   * failures made on an account
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2061)
  public static final String A_zimbraTwoFactorAuthLockoutFailureTime =
      "zimbraTwoFactorAuthLockoutFailureTime";

  /**
   * number of consecutive failed second factor login attempts until an account is locked out
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2060)
  public static final String A_zimbraTwoFactorAuthLockoutMaxFailures =
   ...
   */
  @ZAttr(id = 1823)
  public static final String A_zimbraTwoFactorAuthNumScratchCodes =
   ...
   */
  @ZAttr(id = 1831)
  public static final String A_zimbraTwoFactorAuthScratchCodeEncoding =
  ...
  /**
   * Shared secret encoding. Keep at BASE32 for compatability with common TOTP clients.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1826)
  public static final String A_zimbraTwoFactorAuthSecretEncoding =
  ...
  /**
   * Lifetime of auth tokens provisioned for completing the 2nd stage of two-factor authentication.
   * Must be in valid duration format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h -
   * hours, m - minutes, s - seconds, d - days, ms - milliseconds. If time unit is not specified,
   * the default is s(seconds).
   *
   ...
   */
  @ZAttr(id = 2025)
  public static final String A_zimbraTwoFactorAuthTokenLifetime =
   ...
   */
  @ZAttr(id = 1949)
  public static final String A_zimbraTwoFactorAuthTrustedDevices =
   ...
   */
  @ZAttr(id = 1964)
  public static final String A_zimbraTwoFactorAuthTrustedDeviceTokenKey =
      "zimbraTwoFactorAuthTrustedDeviceTokenKey";

  /**
   * Lifetime of a trusted device token. Must be in valid duration format: {digits}{time-unit}.
   * digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d - days, ms -
   * milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 1947)
  public static final String A_zimbraTwoFactorAuthTrustedDeviceTokenLifetime =
      "zimbraTwoFactorAuthTrustedDeviceTokenLifetime";

  /**
   * Length of TOTP code required for two-factor authentication. Keep at 6 for compatability with
   * common TOTP clients.
   *
   * @since ZCS 8.7.0,9.0.0
   */
   ...
   */
  @ZAttr(id = 1827)
  public static final String A_zimbraTwoFactorScratchCodeLength =
      "zimbraTwoFactorScratchCodeLength";

  /**
   * length of time that a TOTP code is valid for. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 8.7.0,9.0.0
  ...
  /**
   * Determines the number of windows to check when trying to validate a TOTP code (NOW-n through
   * NOW+n). This number should typically be small, but a minimum value of 1 is usually necessary to
   * account for network latency and clock drift. See also: zimbraTwoFactorTimeWindowLength and
  ...
  /**
   * Time interval after which Zimbra version check detects a new version. Must be in valid duration
   * format: {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s -
   * seconds, d - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   *
   * @since ZCS 6.0.2
  ...
  /**
   * template used to construct the body of an Zimbra version check notification message
   *
   * @since ZCS 6.0.2
   */
  @ZAttr(id = 1066)
  public static final String A_zimbraVersionCheckNotificationBody =
      "zimbraVersionCheckNotificationBody";

  /**
   * email address to send mail to for the Zimbra version check notification message
   *
   * @since ZCS 6.0.2
   */
  @ZAttr(id = 1063)
  public static final String A_zimbraVersionCheckNotificationEmail =
   ...
   */
  @ZAttr(id = 1064)
  public static final String A_zimbraVersionCheckNotificationEmailFrom =
      "zimbraVersionCheckNotificationEmailFrom";

  /**
   * template used to construct the subject of an Zimbra version check notification message
   *
   * @since ZCS 6.0.2
   */
  @ZAttr(id = 1065)
  public static final String A_zimbraVersionCheckNotificationSubject =
      "zimbraVersionCheckNotificationSubject";

  /**
   * whether to send a notification message if Zimbra version check detects a new version
   *
   * @since ZCS 6.0.2
   */
  @ZAttr(id = 1062)
  public static final String A_zimbraVersionCheckSendNotifications =
  ...
  /**
   * Whether virtual user set/changed his password after an external virtual account for him is
   * provisioned. This attribute is applicable for accounts having zimbraIsExternalVirtualAccount
   * set to TRUE.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1414)
  public static final String A_zimbraVirtualAccountInitialPasswordSet =
      "zimbraVirtualAccountInitialPasswordSet";

  /**
   * An alias for this domain, used to determine default login domain based on URL client is
   * visiting
   */
  @ZAttr(id = 352)
  ...
  /**
   * Virtual IP address for this domain, used to determine domain based on an IP address and have
   * IP-based virtual hosts for the proxy. Consider using zimbraReverseProxySNIEnabled instead when
   * using SNI capable clients
   *
   * @since ZCS 5.0.0
   */
  @ZAttr(id = 562)
  ...
  /** Whether to block archive files that are password protected or encrypted */
  @ZAttr(id = 205)
  public static final String A_zimbraVirusBlockEncryptedArchive =
  ...
  /**
   * how often the virus definitions are updated. Must be in valid duration format:
   * {digits}{time-unit}. digits: 0-9, time-unit: [hmsd]|ms. h - hours, m - minutes, s - seconds, d
   * - days, ms - milliseconds. If time unit is not specified, the default is s(seconds).
   */
  @ZAttr(id = 191)
  public static final String A_zimbraVirusDefinitionsUpdateFrequency =
  ...
  /**
   * login URL for web client to send the user to upon failed login, auth expired, or no/invalid
   * auth
   */
  @ZAttr(id = 506)
  ...
  /**
   * regex for allowed client IP addresses for honoring zimbraWebClientLoginURL. If not set, all IP
   * addresses are allowed. If multiple values are set, an IP address is allowed as long as it
   * matches any one of the values.
   *
   * @since ZCS 7.1.5
   */
  @ZAttr(id = 1352)
  public static final String A_zimbraWebClientLoginURLAllowedIP =
      "zimbraWebClientLoginURLAllowedIP";

  /**
   * regex to be matched for allowed user agents for honoring zimbraWebClientLoginURL. If not set,
   * all UAs are allowed. If multiple values are set, an UA is allowed as long as it matches any one
   * of the values. e.g. &quot;.*Windows NT.*Firefox/3.*&quot; will match firefox 3 or later
   * browsers on Windows. &quot;.*MSIE.*Windows NT.*&quot; will match IE browsers on Windows.
   *
   * @since ZCS 7.0.0
   */
  @ZAttr(id = 1141)
  public static final String A_zimbraWebClientLoginURLAllowedUA =
      "zimbraWebClientLoginURLAllowedUA";

  /** logout URL for web client to send the user to upon explicit logging out */
  @ZAttr(id = 507)
  public static final String A_zimbraWebClientLogoutURL = "zimbraWebClientLogoutURL";

  /**
   * regex for allowed client IP addresses for honoring zimbraWebClientLogoutURL. If not set, all IP
   * addresses are allowed. If multiple values are set, an IP address is allowed as long as it
   * matches any one of the values.
   *
   * @since ZCS 7.1.5
   */
  @ZAttr(id = 1353)
  public static final String A_zimbraWebClientLogoutURLAllowedIP =
      "zimbraWebClientLogoutURLAllowedIP";

  /**
   * regex to be matched for allowed user agents for honoring zimbraWebClientLogoutURL. If not set,
   * all UAs are allowed. If multiple values are set, an UA is allowed as long as it matches any one
   * of the values. e.g. &quot;.*Windows NT.*Firefox/3.*&quot; will match firefox 3 or later
   * browsers on Windows. &quot;.*MSIE.*Windows NT.*&quot; will match IE browsers on Windows.
   *
   ...
   */
  @ZAttr(id = 1142)
  public static final String A_zimbraWebClientLogoutURLAllowedUA =
   ...
   */
  @ZAttr(id = 1339)
  public static final String A_zimbraWebClientMaxInputBufferLength =
      "zimbraWebClientMaxInputBufferLength";

  /**
   * limit for the number of days that the web client would use to sync any mail folder&#039;s data
   * for offline use
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1452)
  public static final String A_zimbraWebClientOfflineSyncMaxDays =
  ...
  /**
   * Whether the Stay Signed In checkbox should be disabled on the login screen
   *
   * @since ZCS 8.7.0
   */
  @ZAttr(id = 1687)
  public static final String A_zimbraWebClientStaySignedInDisabled =
      "zimbraWebClientStaySignedInDisabled";

  /**
   * Specify which help file&#039;s link should be displayed on the pull-down menu in the Ajax Web
   * client. The value is case-sensitive. When &quot;productHelp&quot; is specified, &quot;Product
   * Help&quot; menu item will available and link to the default help files stored in the same mail
   * server (http://[service URL]/help/[locale]/advanced/zimbra_user_help.htm) or URL specified in
   * skin or ZmMsg properties file (&quot;helpURI&quot;). When &quot;onlineHelp&quot; is specified,
   * &quot;Help Central Online&quot; menu item will be available to link to http://help.zimbra.com/.
   * When &quot;newFeatures&quot; is specified, &quot;New Features&quot; menu item will be available
   * to link to https://docs.zextras.com.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2012)
  ...
  /**
   * weclient URL to directly connect when making service to JS calls from mail server in split mode
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1445)
  ...
  /**
   * Deprecated since: 8.7.0. Zimbra no longer includes an XMPP server. Orig desc: Enable XMPP
   * support for IM
   */
  @ZAttr(id = 397)
  ...
  /**
   * List of Zimlets available to this COS Values can be prefixed with ! or + or - !: mandatory +
   * (or no prefix): enabled by default -: disabled by default
   */
  @ZAttr(id = 291)
   ...
   */
  @ZAttr(id = 1269)
  public static final String A_zimbraZimletDataSensitiveInMixedModeDisabled =
  ...
  /**
   * List of Zimlets available to this domain. Zimlets available to accounts in the domain is the
   * union of account/cos attribute zimbraZimletAvailableZimlets and this attribute. See
   * zimbraZimletAvailableZimlets for value format.
   *
   * @since ZCS 5.0.10
   */
  @ZAttr(id = 710)
  public static final String A_zimbraZimletDomainAvailableZimlets =
  ...
  /**
   * Whether to enable JSP compilation for Zimlets (i.e. for /zimlet webapp)
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1575)
  ...
  /** Server side object keyword used for indexing and search for this Zimlet */
  @ZAttr(id = 281)
  public static final String A_zimbraZimletKeyword = "zimbraZimletKeyword";

  /**
   * Whether to load zimlets synchronously in the web client. If set to TRUE, users are not allowed
   * to use the core app before zimlets are loaded. If set to FALSE, zimlets are loaded in the
   * background and users are allowed to use the core app before all zimlets finish loading.
   *
   * @since ZCS 7.2.0
   */
  @ZAttr(id = 1391)
   ...
   */
  @ZAttr(id = 2027)
  public static final String A_zimbraZimletUserPropertiesMaxNumEntries =
  ...
  /**
   * list of host:port for zookeeper servers; set to empty value to disable the use of zookeeper
   *
   * @since ZCS 8.5.0
   */
  @ZAttr(id = 1447)
