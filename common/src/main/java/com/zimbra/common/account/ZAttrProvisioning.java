...
public class ZAttrProvisioning {
  ...
  /**
   * email address of sender used to send emails about important infrastructure notifications
   *
   * @since ZCS 23.4.0
   */
  @ZAttr(id = 3127)
  ...
  /**
   * email address of recipients who will receive emails about important infrastructure
   * notifications
   *
   * @since ZCS 23.4.0
   */
  ...
  /**
   * Database mirrors for freshclam to use for virus and other updates. Defaults to ClamAV CDN.
   *
   * @since ZCS 8.7.0,9.0.0
   */
  @ZAttr(id = 2073)
   ...
   * If false, the raw address configured (e.g. zimbraMailHost) is directly sent to proxy, else the
   * translated IP will be sent back to the client.
   *
   * @since ZCS 8.0.0
   */
  @ZAttr(id = 1384)
  ...
  /**
   * whether to run proxy in HTTPS or redirect mode. See also related attributes zimbraMailProxyPort
   * and zimbraMailSSLProxyPort
   *
   * @since ZCS 5.0.7
   */
  @ZAttr(id = 685)
